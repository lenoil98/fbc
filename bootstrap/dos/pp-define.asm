...
.Lt_00CE:
.Lt_00CD:
cmp dword ptr [ebp-1112], -1
je .Lt_00E7
push 0
push -1
push dword ptr [ebp-1112]
push 1
call _fb_CHR
add esp, 8
push eax
...
mov eax, dword ptr [_LEX+213248]
mov ecx, dword ptr [_LEX+213248]
mov ebx, dword ptr [eax+4304]
mov dword ptr [ecx+4300], ebx
mov ebx, dword ptr [_LEX+213248]
mov ecx, dword ptr [ebp-8]
add dword ptr [ebx+4296], ecx
mov ecx, dword ptr [_LEX+213248]
mov dword ptr [ecx+4268], 4294967295
mov dword ptr [ebp-4], -1
.Lt_00ED:
mov eax, dword ptr [ebp-4]
pop ebx
