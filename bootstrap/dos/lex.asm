...
_LEXPUSHCTX:
.Lt_0068:
add dword ptr [_LEX+213248], 12544
.Lt_0069:
ret
.balign 16
...
mov ebx, dword ptr [_LEX+213248]
mov eax, dword ptr [_LEX+213248]
mov ecx, dword ptr [ebx-8268]
mov dword ptr [eax+4276], ecx
mov ecx, dword ptr [_LEX+213248]
mov eax, dword ptr [_LEX+213248]
mov ebx, dword ptr [ecx-8260]
mov dword ptr [eax+4284], ebx
mov ebx, dword ptr [_LEX+213248]
mov eax, dword ptr [_LEX+213248]
mov ecx, dword ptr [ebx-8256]
mov dword ptr [eax+4288], ecx
jmp .Lt_007C
.Lt_007D:
mov ecx, dword ptr [_LEX+213248]
mov dword ptr [ecx+4276], 1
mov ecx, dword ptr [_LEX+213248]
...
mov dword ptr [ecx+12520], ebx
mov ebx, dword ptr [_LEX+213248]
mov ecx, dword ptr [_LEX+213248]
mov eax, dword ptr [ebx-20]
mov dword ptr [ecx+12524], eax
jmp .Lt_0082
.Lt_0083:
mov eax, dword ptr [_LEX+213248]
mov dword ptr [eax+12520], 0
mov eax, dword ptr [_LEX+213248]
mov dword ptr [eax+12524], 0
.Lt_0082:
mov eax, dword ptr [_ENV+876]
test eax, eax
sete al
...
call _DZSTRALLOCATE
add esp, 8
mov dword ptr [_LEX+213252], 0
.Lt_0085:
.Lt_0084:
mov eax, dword ptr [_LEX+213248]
mov dword ptr [eax+12540], 0
...
.Lt_00E5:
mov eax, dword ptr [_LEX+213248]
cmp dword ptr [eax+4272], 9
sete bl
shr ebx, 1
sbb ebx, ebx
mov eax, dword ptr [_LEX+213248]
cmp dword ptr [eax+4272], 32
sete cl
shr ecx, 1
sbb ecx, ecx
or ebx, ecx
...
mov eax, dword ptr [_LEX+213248]
mov ebx, dword ptr [ebp+8]
mov ecx, dword ptr [eax+12540]
mov dword ptr [ebx+1056], ecx
mov ecx, dword ptr [_LEX+213248]
mov dword ptr [ecx+12540], 0
.Lt_02C7:
mov ecx, dword ptr [ebp+8]
...
mov ebx, dword ptr [_LEX+213248]
lea esi, [ebx+4324]
mov ebx, dword ptr [ecx+4320]
sub ebx, esi
add ebx, dword ptr [eax+12520]
dec ebx
mov eax, dword ptr [_LEX+213248]
mov dword ptr [eax+12524], ebx
mov ebx, dword ptr [ebp-4]
...
cmp dword ptr [_ENV+876], 0
jne .Lt_00A7
cmp dword ptr [_LEX+213252], 0
jne .Lt_00A9
mov dword ptr [_LEX+213252], -1
...
mov esi, eax
mov eax, dword ptr [_LEX+213248]
mov dword ptr [eax+4316], esi
mov esi, dword ptr [_LEX+213248]
lea eax, [esi+4324]
mov esi, dword ptr [_LEX+213248]
...
.Lt_00AB:
mov eax, dword ptr [_LEX+213248]
cmp dword ptr [eax+4316], 0
jle .Lt_00BC
cmp dword ptr [_ENV+552], 0
jne .Lt_00BE
mov eax, dword ptr [_LEX+213248]
mov esi, dword ptr [eax+4320]
...
jle .Lt_00CD
mov eax, dword ptr [_LEX+213248]
dec dword ptr [eax+4296]
cmp dword ptr [_ENV+552], 0
jne .Lt_00CF
mov eax, dword ptr [_LEX+213248]
inc dword ptr [eax+4300]
jmp .Lt_00CE
.Lt_00CF:
mov eax, dword ptr [_LEX+213248]
inc dword ptr [eax+4300]
...
je .Lt_00D2
mov eax, dword ptr [_LEX+213248]
dec dword ptr [eax+4316]
cmp dword ptr [_ENV+552], 0
jne .Lt_00D4
mov eax, dword ptr [_LEX+213248]
inc dword ptr [eax+4320]
jmp .Lt_00D3
.Lt_00D4:
mov eax, dword ptr [_LEX+213248]
inc dword ptr [eax+4320]
