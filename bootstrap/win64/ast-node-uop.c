...
struct $7ASTNODE* ASTNEWUOP( int64 OP$1, struct $7ASTNODE* O$1 )
{
	...
	goto label$144;
	label$70:;
	TMP$90$1 = *(int64*)((uint8*)O$1 + 8ll) & 31ll;
	label$144:;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$90$1 * 56ll)) != 2ll ) goto label$72;
	{
		goto label$56;
	}
	label$72:;
	label$71:;
	{
		...
		goto label$145;
		label$73:;
		TMP$91$2 = *(int64*)((uint8*)O$1 + 8ll) & 31ll;
		label$145:;
		...
		if( (TMP$92$2 - 4ull) > 20ull ) goto label$74;
		goto *tmp$105[TMP$92$2 - 4ull];
		label$74:;
	}
	...
	goto label$146;
	label$86:;
	TMP$93$1 = *(int64*)((uint8*)O$1 + 8ll) & 31ll;
	label$146:;
	DO_PROMOTE$1 = (int64)-(*(int64*)((uint8*)&ENV$ + 272ll) != 3ll) & (int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$93$1 * 56ll)) == 0ll);
	if( (*(int64*)((uint8*)O$1 + 8ll) & 511ll) != 1ll ) goto label$88;
	{
		if( OP$1 != 52ll ) goto label$90;
		{
			DO_PROMOTE$1 = 0ll;
		}
		goto label$89;
	...
	label$88:;
	label$87:;
	if( DO_PROMOTE$1 == 0ll ) goto label$92;
	{
		int64 TMP$94$2;
		int64 TMP$95$2;
		int64 TMP$96$2;
		if( (*(int64*)((uint8*)O$1 + 8ll) & 480ll) == 0ll ) goto label$93;
		TMP$94$2 = 24ll;
		goto label$147;
		label$93:;
		TMP$94$2 = *(int64*)((uint8*)O$1 + 8ll) & 31ll;
		label$147:;
		if( (*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$94$2 * 56ll)) + 32ll) & 480ll) == 0ll ) goto label$95;
		TMP$96$2 = 24ll;
		goto label$148;
		label$95:;
		if( (*(int64*)((uint8*)O$1 + 8ll) & 480ll) == 0ll ) goto label$94;
		TMP$95$2 = 24ll;
		goto label$149;
		label$94:;
		TMP$95$2 = *(int64*)((uint8*)O$1 + 8ll) & 31ll;
		label$149:;
		TMP$96$2 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$95$2 * 56ll)) + 32ll) & 31ll;
		label$148:;
		RANK$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$96$2 * 56ll)) + 24ll);
		...
		label$97:;
		{
			if( ((int64)-(INTRANK$1 < RANK$1) & (int64)-(RANK$1 < UINTRANK$1)) == 0ll ) goto label$99;
			{
	...
	{
		uint64 TMP$97$2;
		TMP$97$2 = (uint64)OP$1;
		goto label$101;
		label$102:;
		{
			int64 TMP$98$3;
			if( (*(int64*)((uint8*)O$1 + 8ll) & 480ll) == 0ll ) goto label$103;
			TMP$98$3 = 24ll;
			goto label$150;
			label$103:;
			TMP$98$3 = *(int64*)((uint8*)O$1 + 8ll) & 31ll;
			label$150:;
			if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$98$3 * 56ll)) == 0ll ) goto label$105;
			{
		...
		{
			int64 TMP$99$3;
			if( (*(int64*)((uint8*)O$1 + 8ll) & 480ll) == 0ll ) goto label$107;
			TMP$99$3 = 24ll;
			goto label$151;
			label$107:;
			TMP$99$3 = *(int64*)((uint8*)O$1 + 8ll) & 31ll;
			label$151:;
			if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$99$3 * 56ll)) != 0ll ) goto label$109;
			{
		...
		{
			int64 TMP$100$3;
			if( (DTYPE$1 & 480ll) == 0ll ) goto label$111;
			TMP$100$3 = 24ll;
			goto label$152;
			label$111:;
			TMP$100$3 = DTYPE$1 & 31ll;
			label$152:;
			if( ~(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$100$3 * 56ll)) + 16ll)) == 0ll ) goto label$113;
			{
				if( *(int64*)O$1 != 16ll ) goto label$115;
				{
					if( *(int64*)((uint8*)&AST$ + 464ll) != 0ll ) goto label$117;
					{
						int64 TMP$101$6;
						...
						goto label$153;
						label$118:;
						TMP$101$6 = DTYPE$1 & 31ll;
						label$153:;
						if( *(uint64*)((uint8*)O$1 + 40ll) <= (1ull << (((*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$101$6 * 56ll)) + 8ll) << (3ll & 63ll)) + -1ll) & 63ll)) ) goto label$120;
						{
		...
		{
			int64 TMP$102$3;
			if( (*(int64*)((uint8*)O$1 + 8ll) & 480ll) == 0ll ) goto label$122;
			TMP$102$3 = 24ll;
			goto label$154;
			label$122:;
			TMP$102$3 = *(int64*)((uint8*)O$1 + 8ll) & 31ll;
			label$154:;
			if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$102$3 * 56ll)) == 1ll ) goto label$124;
			{
		...
		{
			int64 TMP$103$3;
			if( (*(int64*)((uint8*)O$1 + 8ll) & 480ll) == 0ll ) goto label$126;
			TMP$103$3 = 24ll;
			goto label$155;
			label$126:;
			TMP$103$3 = *(int64*)((uint8*)O$1 + 8ll) & 31ll;
			label$155:;
			if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$103$3 * 56ll)) != 0ll ) goto label$128;
			{
		...
		{
			int64 TMP$104$3;
			if( (*(int64*)((uint8*)O$1 + 8ll) & 480ll) == 0ll ) goto label$130;
			TMP$104$3 = 24ll;
			goto label$156;
			label$130:;
			TMP$104$3 = *(int64*)((uint8*)O$1 + 8ll) & 31ll;
			label$156:;
			if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$104$3 * 56ll)) != 0ll ) goto label$132;
			{
		...
		if( (TMP$97$2 - 52ull) > 20ull ) goto label$100;
		goto *tmp$106[TMP$97$2 - 52ull];
		label$100:;
	}
	if( *(int64*)O$1 != 16ll ) goto label$135;
	{
	...
	label$135:;
	label$134:;
	if( OP$1 != 52ll ) goto label$137;
	{
		int64 vr$125 = ASTISRELATIONALBOP( O$1 );
		if( vr$125 == 0ll ) goto label$139;
		{
	...
	label$137:;
	label$136:;
	if( (*(int64*)((uint8*)&IR$ + 552ll) & 131072ll) == 0ll ) goto label$141;
	{
		int64 vr$130 = (*(tmp$41*)((uint8*)&IR$ + 48ll))( OP$1, DTYPE$1 );
		if( vr$130 != 0ll ) goto label$143;
		{
...
struct $6IRVREG* ASTLOADUOP( struct $7ASTNODE* N$1 )
{
	...
	if( O$1 != (struct $7ASTNODE*)0ull ) goto label$160;
	{
	...
	label$160:;
	label$159:;
	if( *(int64*)O$1 != 5ll ) goto label$162;
	{
	...
	V1$1 = vr$5;
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$164;
	{
		if( (*(int64*)((uint8*)N$1 + 48ll) & 1ll) == 0ll ) goto label$166;
		{
			struct $6IRVREG* vr$10 = (*(tmp$70*)((uint8*)&IR$ + 456ll))( *(int64*)((uint8*)O$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)O$1 + 16ll) );
			VR$1 = vr$10;
		...
		label$165:;
		(*(tmp$52*)((uint8*)&IR$ + 200ll))( OP$1, V1$1, VR$1 );
		if( VR$1 != (struct $6IRVREG*)0ull ) goto label$168;
		{
			VR$1 = V1$1;
		}
		label$168:;
...
static struct $7ASTNODE* HCONSTUOP( int64 OP$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, struct $7ASTNODE* L$1 )
{
	...
	goto label$169;
	label$17:;
	TMP$85$1 = *(int64*)((uint8*)L$1 + 8ll) & 31ll;
	label$169:;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$85$1 * 56ll)) != 1ll ) goto label$19;
	{
		D$1 = *(double*)((uint8*)L$1 + 40ll);
		{
			uint64 TMP$86$3;
			TMP$86$3 = (uint64)OP$1;
			goto label$21;
			label$22:;
			{
				D$1 = -D$1;
			...
			if( (TMP$86$3 - 54ull) > 18ull ) goto label$37;
			goto *tmp$107[TMP$86$3 - 54ull];
			label$20:;
		}
	...
	label$19:;
	{
		...
		goto label$170;
		label$38:;
		TMP$87$2 = *(int64*)((uint8*)L$1 + 8ll) & 31ll;
		label$170:;
		if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$87$2 * 56ll)) + 8ll) != 8ll ) goto label$40;
		{
			{
				uint64 TMP$88$4;
				...
				if( (TMP$88$4 - 52ull) > 5ull ) goto label$47;
		...
		{
			{
				...
				if( (TMP$89$4 - 52ull) > 5ull ) goto label$54;
				goto *tmp$109[TMP$89$4 - 52ull];
				label$48:;
			}
		}
		label$39:;
