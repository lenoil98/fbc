...
struct $7ASTNODE* CMATHFUNCT( $8FB_TOKEN TK$1, int64 ISASM$1 )
{
	...
	fb$result$1 = (struct $7ASTNODE*)0ull;
	{
		...
		goto label$85;
		label$86:;
		static const void* tmp$103[19ll] = {
			&&label$87,
			&&label$88,
			&&label$89,
			&&label$90,
		...
		if( (TMP$102$2 - 446ull) > 18ull ) goto label$85;
		goto *tmp$103[TMP$102$2 - 446ull];
		label$85:;
	}
	label$84:;
	return fb$result$1;
...
static struct $7ASTNODE* HLEN( struct $7ASTNODE* EXPR$1, int64* LGT$1 )
{
	...
	{
		int64 TMP$95$2;
		TMP$95$2 = *(int64*)((uint8*)EXPR$1 + 8ll) & 511ll;
		if( TMP$95$2 != 17ll ) goto label$37;
		label$38:;
		{
		...
		label$44:;
		{
			...
			label$46:;
			label$45:;
			uint16* vr$12 = HUNESCAPEW( *(uint16**)((uint8*)LITSYM$1 + 96ll) );
			int64 vr$13 = fb_WstrLen( (uint16*)vr$12 );
			*LGT$1 = vr$13;
		}
		goto label$36;
		label$43:;
		if( TMP$95$2 != 18ll ) goto label$47;
		label$48:;
		{
			int64 TMP$96$3;
			TMP$96$3 = 0ll;
			int64 vr$16 = ASTSIZEOF( EXPR$1, &TMP$96$3 );
			*LGT$1 = vr$16 + -1ll;
		}
		goto label$36;
		label$47:;
		if( TMP$95$2 != 20ll ) goto label$49;
		label$50:;
		{
			int64 TMP$97$3;
			struct $7ASTNODE* vr$19 = ASTNEWUOP( 73ll, EXPR$1 );
			LENEXPR$1 = vr$19;
			...
			label$51:;
			TMP$97$3 = 0ll;
			int64 vr$21 = ASTSIZEOF( EXPR$1, &TMP$97$3 );
			*LGT$1 = vr$21;
		}
		goto label$36;
		label$49:;
		{
			int64 TMP$98$3;
			TMP$98$3 = 0ll;
			int64 vr$24 = ASTSIZEOF( EXPR$1, &TMP$98$3 );
			*LGT$1 = vr$24;
		}
		label$53:;
		label$36:;
...
static struct $7ASTNODE* HLENSIZEOF( int64 TK$1, int64 ISASM$1 )
{
	...
	if( TK$1 != 463ll ) goto label$63;
	{
		...
		if( IS_FIXLENSTR$2 == 0ll ) goto label$65;
		{
			{
				int64 TMP$100$4;
				TMP$100$4 = DTYPE$1 & 511ll;
				if( TMP$100$4 == 4ll ) goto label$68;
				label$69:;
				if( TMP$100$4 == 17ll ) goto label$68;
				label$70:;
				if( TMP$100$4 != 18ll ) goto label$67;
				label$68:;
				{
					LGT$1 = LGT$1 - *(int64*)((uint8*)SYMB_DTYPETB$ + 232ll);
					LGT$1 = fb_D2L( (double)LGT$1 / (double)*(int64*)((uint8*)SYMB_DTYPETB$ + 232ll) );
				}
				goto label$66;
				label$67:;
				if( TMP$100$4 != 7ll ) goto label$71;
				label$72:;
				{
					LGT$1 = LGT$1 - *(int64*)((uint8*)SYMB_DTYPETB$ + 400ll);
					LGT$1 = fb_D2L( (double)LGT$1 / (double)*(int64*)((uint8*)SYMB_DTYPETB$ + 400ll) );
				}
				label$71:;
				label$66:;
			}
	...
	{
		if( TK$1 != 463ll ) goto label$80;
		{
			struct $7ASTNODE* vr$32 = HLEN( EXPR$1, &LGT$1 );
			EXPR$1 = vr$32;
			if( EXPR$1 != (struct $7ASTNODE*)0ull ) goto label$82;
			{
				struct $7ASTNODE* vr$33 = ASTNEWCONSTI( LGT$1, 8ll, (struct $8FBSYMBOL*)0ull );
				EXPR$1 = vr$33;
			}
			label$82:;
			label$81:;
		...
		label$80:;
		{
			int64 TMP$101$3;
			TMP$101$3 = 0ll;
			int64 vr$35 = ASTSIZEOF( EXPR$1, &TMP$101$3 );
			LGT$1 = vr$35;
			ASTDELTREE( EXPR$1 );
			struct $7ASTNODE* vr$36 = ASTNEWCONSTI( LGT$1, 8ll, (struct $8FBSYMBOL*)0ull );
			EXPR$1 = vr$36;
		}
		label$79:;
	}
