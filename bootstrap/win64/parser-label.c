...
int64 CLABEL( void )
{
	...
	fb$result$1 = 0ll;
	{
		...
		label$14:;
		{
			if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 1048576ll) != 0ll ) goto label$16;
			{
			...
			label$16:;
			{
				...
				struct $8FBSYMBOL* vr$4 = SYMBADDLABEL( vr$3, 68ll );
				L$1 = vr$4;
				if( L$1 != (struct $8FBSYMBOL*)0ull ) goto label$18;
				{
		...
		label$19:;
		{
			...
			if( vr$6 != 258ll ) goto label$21;
			{
				CHAIN_$1 = *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8520ll) + 2088ll);
				struct $8FBSYMBOL* vr$9 = SYMBFINDBYCLASS( CHAIN_$1, 3ll );
				if( vr$9 == (struct $8FBSYMBOL*)0ull ) goto label$23;
				{
					goto label$11;
				}
				label$23:;
				...
				struct $8FBSYMBOL* vr$11 = SYMBADDLABEL( vr$10, 68ll );
				L$1 = vr$11;
				if( L$1 != (struct $8FBSYMBOL*)0ull ) goto label$25;
				{
					ERRREPORT( 4ll, 0ll, (uint8*)0ull );
				}
				label$25:;
		...
		if( TMP$94$2 > 3ull ) goto label$12;
		goto *tmp$95[TMP$94$2 - 0ull];
		label$12:;
	}
	if( L$1 == (struct $8FBSYMBOL*)0ull ) goto label$27;
	{
		struct $7ASTNODE* vr$12 = ASTNEWLABEL( L$1, -1ll );
		ASTADD( vr$12 );
