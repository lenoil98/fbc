...
void ASTGOSUBADDINIT( struct $8FBSYMBOL* PROC$1 )
{
	...
	*(int64*)((uint8*)&tmp$94$1 + 48ll) = 1ll;
	*(int64*)((uint8*)&tmp$94$1 + 56ll) = 0ll;
	*(int64*)((uint8*)&tmp$94$1 + 64ll) = 0ll;
	...
	label$13:;
	label$12:;
	if( (((int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 0ll) | (int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 3ll)) & (int64)-(*(int64*)((uint8*)&ENV$ + 400ll) == 0ll)) == 0ll ) goto label$15;
	{
		DTYPE$1 = 8ll;
	}
	goto label$14;
...
void ASTGOSUBADDJMP( struct $8FBSYMBOL* PROC$1, struct $8FBSYMBOL* L$1 )
{
	...
	if( (((int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 0ll) | (int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 3ll)) & (int64)-(*(int64*)((uint8*)&ENV$ + 400ll) == 0ll)) == 0ll ) goto label$19;
	{
...
void ASTGOSUBADDJUMPPTR( struct $8FBSYMBOL* PROC$1, struct $7ASTNODE* JUMPTB$1, struct $8FBSYMBOL* EXITLABEL$1 )
{
	...
	struct $8FBSYMBOL* LABEL$1;
	ASTGOSUBADDINIT( PROC$1 );
	if( (((int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 0ll) | (int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 3ll)) & (int64)-(*(int64*)((uint8*)&ENV$ + 400ll) == 0ll)) == 0ll ) goto label$23;
	{
		struct $7ASTNODE* vr$7 = ASTBUILDVARINC( *(struct $8FBSYMBOL**)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)PROC$1 + 208ll) + 120ll), 1ll );
		ASTADD( vr$7 );
...
int64 ASTGOSUBADDRETURN( struct $8FBSYMBOL* PROC$1, struct $8FBSYMBOL* L$1 )
{
	...
	struct $8FBSYMBOL* LABEL$1;
	ASTGOSUBADDINIT( PROC$1 );
	if( (((int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 0ll) | (int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 3ll)) & (int64)-(*(int64*)((uint8*)&ENV$ + 400ll) == 0ll)) == 0ll ) goto label$27;
	{
		...
		label$29:;
		{
			struct $7ASTNODE* vr$17 = ASTNEWCONSTI( *(int64*)((uint8*)&ENV$ + 544ll), 8ll, (struct $8FBSYMBOL*)0ull );
		...
		if( *(int64*)((uint8*)&ENV$ + 312ll) == 0ll ) goto label$31;
		{
			...
			RTLERRORTHROW( vr$24, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8552ll), (uint8*)((uint8*)&ENV$ + 560ll) );
		}
		label$31:;
		label$30:;
		fb$result$1 = -1ll;
	...
	label$27:;
	{
		...
		label$33:;
		{
			...
			if( *(int64*)((uint8*)&ENV$ + 312ll) == 0ll ) goto label$35;
			{
				...
				RTLERRORTHROW( vr$44, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8552ll), (uint8*)((uint8*)&ENV$ + 560ll) );
			}
			label$35:;
			label$34:;
			fb$result$1 = -1ll;
...
void ASTGOSUBADDEXIT( struct $8FBSYMBOL* PROC$1 )
{
	...
	{
		if( (((int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 0ll) | (int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 3ll)) & (int64)-(*(int64*)((uint8*)&ENV$ + 400ll) == 0ll)) != 0ll ) goto label$41;
		{
			struct $7ASTNODE* vr$10 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)PROC$1 + 208ll) + 120ll), 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
