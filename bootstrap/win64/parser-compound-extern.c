...
void CEXTERNSTMTBEGIN( void )
{
	...
	int64 MANGLING$1;
	uint8* LITSTR$1;
	if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 8ll) != 0ll ) goto label$13;
	{
	...
	label$16:;
	{
		...
		fb_StrInit( (void*)&TMP$95$2, -1ll, (void*)vr$5, -1ll, 0 );
		int32 vr$8 = fb_StrCompare( (void*)&TMP$95$2, -1ll, (void*)"c", 2ll );
		...
		goto label$18;
		label$19:;
		int32 vr$11 = fb_StrCompare( (void*)&TMP$95$2, -1ll, (void*)"windows", 8ll );
		...
		goto label$18;
		label$21:;
		int32 vr$14 = fb_StrCompare( (void*)&TMP$95$2, -1ll, (void*)"windows-ms", 11ll );
		...
		goto label$18;
		label$23:;
		int32 vr$17 = fb_StrCompare( (void*)&TMP$95$2, -1ll, (void*)"c++", 4ll );
		...
		goto label$18;
		label$25:;
		int32 vr$20 = fb_StrCompare( (void*)&TMP$95$2, -1ll, (void*)"rtlib", 6ll );
	...
	STK$1 = vr$23;
	*($11FB_MANGLING*)((uint8*)STK$1 + 24ll) = *($11FB_MANGLING*)((uint8*)&PARSER$ + 200ll);
	*($11FB_MANGLING*)((uint8*)&PARSER$ + 200ll) = MANGLING$1;
	label$11:;
}
...
void CEXTERNSTMTEND( void )
{
	...
	LEXSKIPTOKEN( 2048ll );
	LEXSKIPTOKEN( 2048ll );
	*($11FB_MANGLING*)((uint8*)&PARSER$ + 200ll) = *($11FB_MANGLING*)((uint8*)STK$1 + 24ll);
	CCOMPSTMTPOP( STK$1 );
	label$31:;
}
