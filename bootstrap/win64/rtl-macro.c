...
static void HADDMACRO( struct $15FB_RTL_MACRODEF* MACDEF$1 )
{
	...
	__builtin_memset( &LASTPARAM$1, 0, 8ll );
	{
		...
		I$2 = 0ll;
		int64 TMP$190$2;
		TMP$190$2 = *(int64*)((uint8*)MACDEF$1 + 16ll) + -1ll;
		goto label$12;
		label$15:;
		{
			FLAGS$1 = FLAGS$1 | 8ll;
		...
		I$2 = I$2 + 1ll;
		label$12:;
		if( I$2 <= TMP$190$2 ) goto label$15;
		label$14:;
	}
	...
	if( ADDBODY$1 == 0ll ) goto label$27;
	{
		...
		if( *(int64*)PTK$2 == -1ll ) goto label$29;
		{
			...
			label$30:;
			{
				$14FB_DEFTOK_TYPE TMP$191$4;
				TMP$191$4 = *($14FB_DEFTOK_TYPE*)PTK$2;
				if( TMP$191$4 == 0ll ) goto label$34;
				label$35:;
				if( TMP$191$4 != 1ll ) goto label$33;
				label$34:;
				{
				...
				goto label$32;
				label$33:;
				if( TMP$191$4 != 2ll ) goto label$36;
				label$37:;
				{
