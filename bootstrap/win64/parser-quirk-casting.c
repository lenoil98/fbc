...
struct $7ASTNODE* CTYPECONVEXPR( $8FB_TOKEN TK$1, int64 ISASM$1 )
{
	...
	OP$1 = -1ll;
	{
		...
		if( (TMP$94$2 - 399ull) > 14ull ) goto label$12;
		goto *tmp$95[TMP$94$2 - 399ull];
		label$12:;
	}
	...
	label$29:;
	LEXSKIPTOKEN( 2048ll );
	if( ((int64)-(TK$1 == 404ll) | (int64)-(TK$1 == 405ll)) == 0ll ) goto label$34;
	{
		...
		if( vr$4 == 0ll ) goto label$36;
		{
			...
			LGT$3 = vr$6;
			$11FB_DATATYPE vr$8 = HINTEGERTYPEFROMBITSIZE( LGT$3, (int64)-(TK$1 == 405ll) );
			DTYPE$1 = vr$8;
	...
	struct $7ASTNODE* vr$18 = ASTNEWCONV( DTYPE$1, (struct $8FBSYMBOL*)0ull, EXPR$1, 2ll, &ERRMSG$1 );
	EXPR$1 = vr$18;
...
struct $7ASTNODE* CANONTYPE( void )
{
	...
	if( IS_EXPLICIT$1 == 0ll ) goto label$59;
	{
		...
		TMP$97$2 = 0ll;
		TMP$96$2 = 0ll;
		int64 vr$6 = CSYMBOLTYPE( &DTYPE$1, &SUBTYPE$1, &TMP$96$2, &TMP$97$2, 1ll );
	...
	label$59:;
	{
		SUBTYPE$1 = *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 312ll);
		DTYPE$1 = *(int64*)((uint8*)&PARSER$ + 304ll);
		...
		{
			int64 TMP$98$3;
			TMP$98$3 = DTYPE$1 & 511ll;
			if( TMP$98$3 == 0ll ) goto label$66;
			label$67:;
			if( TMP$98$3 != 23ll ) goto label$65;
			label$66:;
			{
				ERRREPORT( 71ll, 0ll, (uint8*)0ull );
				DTYPE$1 = 8ll;
	...
	{
		struct $8FBSYMBOL* vr$10 = SYMBGETCOMPCTORHEAD( SUBTYPE$1 );
		if( vr$10 == (struct $8FBSYMBOL*)0ull ) goto label$75;
		{
			struct $7ASTNODE* vr$11 = CCTORCALL( SUBTYPE$1 );
			fb$result$1 = vr$11;
			goto label$57;
		}
		label$75:;
	...
	label$73:;
	label$72:;
	struct $8FBSYMBOL* vr$12 = SYMBADDTEMPVAR( DTYPE$1, SUBTYPE$1 );
	SYM$1 = vr$12;
	struct $7ASTNODE* vr$13 = CINITIALIZER( SYM$1, 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	INITREE$1 = vr$13;
