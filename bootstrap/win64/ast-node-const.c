...
int64 ASTCONSTGEZERO( struct $7ASTNODE* N$1 )
{
	...
	label$23:;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$85$1 * 56ll)) != 1ll ) goto label$20;
	{
		fb$result$1 = (int64)-(*(double*)((uint8*)N$1 + 40ll) >= 0x0p+0);
	}
	goto label$19;
	...
	label$24:;
	if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$86$1 * 56ll)) + 16ll) == 0ll ) goto label$21;
	{
		fb$result$1 = (int64)-(*(int64*)((uint8*)N$1 + 40ll) >= 0ll);
	}
	goto label$19;
...
struct $7ASTNODE* ASTNEWCONST( union $7FBVALUE* V$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	goto label$48;
	label$45:;
	TMP$87$1 = DTYPE$1 & 31ll;
	label$48:;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$87$1 * 56ll)) != 1ll ) goto label$47;
	{
...
struct $7ASTNODE* ASTNEWCONSTZ( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	struct $8FBSYMBOL* FLD$1;
	{
		...
		label$59:;
		{
			...
			label$65:;
			if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$89$3 * 56ll)) != 1ll ) goto label$64;
			{
		...
		if( TMP$88$2 > 20ull ) goto label$59;
		goto *tmp$90[TMP$88$2 - 0ull];
		label$51:;
	}
	label$50:;
	return fb$result$1;
...
struct $6IRVREG* ASTLOADCONST( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$69;
	{
		...
		label$73:;
		if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$91$2 * 56ll)) != 1ll ) goto label$72;
		{
			struct $6IRVREG* vr$8 = (*(tmp$72*)((uint8*)&IR$ + 472ll))( DTYPE$1, *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), *(double*)((uint8*)N$1 + 40ll) );
			fb$result$1 = vr$8;
		}
		goto label$71;
		label$72:;
		{
			struct $6IRVREG* vr$11 = (*(tmp$71*)((uint8*)&IR$ + 464ll))( DTYPE$1, *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), *(int64*)((uint8*)N$1 + 40ll) );
			fb$result$1 = vr$11;
		}
		label$71:;
	}
...
FBSTRING* ASTCONSTFLUSHTOSTR( struct $7ASTNODE* N$1 )
{
	...
	label$86:;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$92$1 * 56ll)) != 1ll ) goto label$80;
	{
	...
	label$87:;
	if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$93$1 * 56ll)) + 16ll) == 0ll ) goto label$84;
	{
...
uint16* ASTCONSTFLUSHTOWSTR( struct $7ASTNODE* N$1 )
{
	...
	label$98:;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$94$1 * 56ll)) != 1ll ) goto label$92;
	{
		...
		label$94:;
		{
			...
			TMP$96$3 = vr$12;
			fb_WstrAssign( (uint16*)W$1, 65ll, (uint16*)TMP$96$3 );
			fb_WstrDelete( (uint16*)TMP$96$3 );
		}
		label$93:;
	}
	goto label$91;
	...
	if( (*(int64*)((uint8*)N$1 + 8ll) & 511ll) != 1ll ) goto label$95;
	{
		...
		TMP$97$2 = vr$17;
		fb_WstrAssign( (uint16*)W$1, 65ll, (uint16*)TMP$97$2 );
		fb_WstrDelete( (uint16*)TMP$97$2 );
	}
	goto label$91;
	label$95:;
	...
	goto label$99;
	label$97:;
	TMP$98$1 = *(int64*)((uint8*)N$1 + 8ll) & 31ll;
	label$99:;
	if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$98$1 * 56ll)) + 16ll) == 0ll ) goto label$96;
	{
		uint16* TMP$99$2;
	...
	label$96:;
	{
		...
		TMP$100$2 = vr$26;
		fb_WstrAssign( (uint16*)W$1, 65ll, (uint16*)TMP$100$2 );
		fb_WstrDelete( (uint16*)TMP$100$2 );
	}
	label$91:;
	ASTDELNODE( N$1 );
...
int64 ASTCONSTGETASINT64( struct $7ASTNODE* N$1 )
{
	...
	label$105:;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$101$1 * 56ll)) != 1ll ) goto label$104;
	{
...
double ASTCONSTGETASDOUBLE( struct $7ASTNODE* N$1 )
{
	...
	label$113:;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$102$1 * 56ll)) != 1ll ) goto label$110;
	{
	...
	label$114:;
	if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$103$1 * 56ll)) + 16ll) == 0ll ) goto label$111;
	{
...
struct $7ASTNODE* ASTCONVERTRAWCONSTI( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, struct $7ASTNODE* L$1 )
{
	...
	goto label$126;
	label$124:;
	TMP$105$1 = *(int64*)((uint8*)L$1 + 8ll) & 31ll;
	label$126:;
	if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$105$1 * 56ll)) + 16ll) == 0ll ) goto label$125;
	TMP$106$1 = 13ll;
	goto label$127;
	label$125:;
	TMP$106$1 = 14ll;
	label$127:;
	*(int64*)((uint8*)L$1 + 8ll) = TMP$106$1;
