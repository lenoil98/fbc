...
struct $7ASTNODE* RTLARRAYCLEAR( struct $7ASTNODE* ARRAYEXPR$1 )
{
	...
	if( ((int64)-(CTOR$1 != (struct $8FBSYMBOL*)0ull) | (int64)-(DTOR$1 != (struct $8FBSYMBOL*)0ull)) == 0ll ) goto label$50;
	{
		...
		struct $8FBSYMBOL* vr$13 = RTLPROCLOOKUP( (uint8*)"fb_ArrayClearObj", 123ll );
	...
	{
		struct $8FBSYMBOL* vr$20 = RTLPROCLOOKUP( (uint8*)"fb_ArrayDestructStr", 121ll );
	...
	label$57:;
	{
		struct $8FBSYMBOL* vr$23 = RTLPROCLOOKUP( (uint8*)"fb_ArrayClear", 122ll );
...
struct $7ASTNODE* RTLARRAYERASE( struct $7ASTNODE* ARRAYEXPR$1, int64 IS_DYNAMIC$1, int64 CHECK_ACCESS$1 )
{
	...
	if( ((int64)-(CTOR$1 != (struct $8FBSYMBOL*)0ull) | (int64)-(DTOR$1 != (struct $8FBSYMBOL*)0ull)) == 0ll ) goto label$69;
	{
		...
		{
			struct $8FBSYMBOL* vr$13 = RTLPROCLOOKUP( (uint8*)"fb_ArrayEraseObj", 125ll );
			struct $7ASTNODE* vr$14 = ASTNEWCALL( vr$13, (struct $7ASTNODE*)0ull );
			PROC$1 = vr$14;
		}
		goto label$70;
		label$71:;
		{
			struct $8FBSYMBOL* vr$15 = RTLPROCLOOKUP( (uint8*)"fb_ArrayDestructObj", 120ll );
	...
	if( DTYPE$1 != 17ll ) goto label$80;
	{
		...
		{
			struct $8FBSYMBOL* vr$22 = RTLPROCLOOKUP( (uint8*)"fb_ArrayStrErase", 126ll );
		...
		label$82:;
		{
			struct $8FBSYMBOL* vr$24 = RTLPROCLOOKUP( (uint8*)"fb_ArrayDestructStr", 121ll );
	...
	label$80:;
	{
		...
		label$86:;
		label$85:;
		struct $8FBSYMBOL* vr$27 = RTLPROCLOOKUP( (uint8*)"fb_ArrayErase", 124ll );
...
struct $7ASTNODE* RTLARRAYREDIM( struct $7ASTNODE* ARRAYEXPR$1, int64 DIMENSIONS$1, struct $7FBARRAYIP7ASTNODEE* EXPRTB$1, int64 DOPRESERVE$1, int64 DOCLEAR$1 )
{
	...
	if( ((int64)-(CTOR$1 == (struct $8FBSYMBOL*)0ull) & (int64)-(DTOR$1 == (struct $8FBSYMBOL*)0ull)) == 0ll ) goto label$96;
	{
		...
		{
			struct $8FBSYMBOL* vr$10 = RTLPROCLOOKUP( (uint8*)"fb_ArrayRedimEx", 127ll );
			F$1 = vr$10;
		}
		goto label$97;
		label$98:;
		{
			struct $8FBSYMBOL* vr$11 = RTLPROCLOOKUP( (uint8*)"fb_ArrayRedimPresvEx", 129ll );
			F$1 = vr$11;
		}
		label$97:;
	}
	...
	label$96:;
	{
		...
		{
			struct $8FBSYMBOL* vr$12 = RTLPROCLOOKUP( (uint8*)"fb_ArrayRedimObj", 128ll );
			F$1 = vr$12;
		}
		goto label$99;
		label$100:;
		{
			struct $8FBSYMBOL* vr$13 = RTLPROCLOOKUP( (uint8*)"fb_ArrayRedimPresvObj", 130ll );
			F$1 = vr$13;
		}
		label$99:;
	}
	...
	label$115:;
	{
		...
		label$120:;
		{
			...
			if( vr$41 != (struct $7ASTNODE*)0ull ) goto label$124;
			{
				goto label$94;
			}
			label$124:;
			...
			if( (*(int64*)((uint8*)EXPR$1 + 8ll) & 511ll) == 8ll ) goto label$126;
			{
			...
			if( vr$50 != (struct $7ASTNODE*)0ull ) goto label$128;
			{
				goto label$94;
			}
			label$128:;
		...
		I$2 = I$2 + 1ll;
		label$117:;
		if( I$2 <= TMP$114$2 ) goto label$120;
		label$119:;
	}
...
struct $7ASTNODE* RTLARRAYREDIMTO( struct $7ASTNODE* DSTEXPR$1, struct $7ASTNODE* SRCEXPR$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	struct $8FBSYMBOL* vr$3 = RTLPROCLOOKUP( (uint8*)"fb_ArrayRedimTo", 131ll );
	...
	if( vr$6 != (struct $7ASTNODE*)0ull ) goto label$134;
	{
		goto label$130;
	}
	label$134:;
	...
	if( vr$14 != (struct $7ASTNODE*)0ull ) goto label$140;
	{
		goto label$130;
	}
	label$140:;
...
struct $7ASTNODE* RTLARRAYBOUND( struct $7ASTNODE* ARRAYEXPR$1, struct $7ASTNODE* DIMEXPR$1, int64 ISLBOUND$1 )
{
	...
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_ArrayLBound", 132ll );
	TMP$115$1 = vr$1;
	goto label$148;
	label$143:;
	struct $8FBSYMBOL* vr$2 = RTLPROCLOOKUP( (uint8*)"fb_ArrayUBound", 133ll );
	TMP$115$1 = vr$2;
	label$148:;
	struct $7ASTNODE* vr$3 = ASTNEWCALL( TMP$115$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$3;
	...
	if( vr$5 != (struct $7ASTNODE*)0ull ) goto label$147;
	{
		goto label$142;
	}
	label$147:;
...
struct $7ASTNODE* RTLARRAYBOUNDSCHECK( struct $7ASTNODE* IDX$1, struct $7ASTNODE* LB$1, struct $7ASTNODE* RB$1, int64 LINENUM$1, uint8* MODULE$1 )
{
	...
	{
		struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_ArraySngBoundChk", 134ll );
		F$1 = vr$1;
	}
	goto label$151;
	label$152:;
	{
		struct $8FBSYMBOL* vr$2 = RTLPROCLOOKUP( (uint8*)"fb_ArrayBoundChk", 135ll );
		F$1 = vr$2;
	}
	label$151:;
	...
	if( vr$5 != (struct $7ASTNODE*)0ull ) goto label$154;
	{
		goto label$150;
	}
	label$154:;
	...
	if( LB$1 == (struct $7ASTNODE*)0ull ) goto label$156;
	{
		...
		if( vr$6 != (struct $7ASTNODE*)0ull ) goto label$158;
		{
			goto label$150;
		}
		label$158:;
	...
	if( vr$7 != (struct $7ASTNODE*)0ull ) goto label$160;
	{
		goto label$150;
	}
	label$160:;
	...
	if( vr$9 != (struct $7ASTNODE*)0ull ) goto label$162;
	{
		goto label$150;
	}
	label$162:;
	...
	if( vr$11 != (struct $7ASTNODE*)0ull ) goto label$164;
	{
		goto label$150;
	}
	label$164:;
...
static void HCHECKDTOR( struct $8FBSYMBOL* DTOR$1, int64 CHECK_ACCESS$1, int64 IS_ERASE$1 )
{
	...
	if( *(int64*)((uint8*)DTOR$1 + 152ll) == 3ll ) goto label$41;
	{
		...
		TMP$113$2 = 172ll;
		label$167:;
		ERRREPORT( TMP$113$2, 0ll, (uint8*)0ull );
	}
	label$41:;
	label$40:;
	label$33:;
