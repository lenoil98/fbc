...
struct $7ASTNODE* CINITIALIZER( struct $8FBSYMBOL* SYM$1, $9FB_INIOPT OPTIONS$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	if( ((int64)-((*(int64*)((uint8*)SYM$1 + 8ll) & 16388ll) != 0ll) | (int64)-((*(int64*)((uint8*)SYM$1 + 8ll) & 8ll) != 0ll)) == 0ll ) goto label$142;
	{
	...
	label$142:;
	label$141:;
	if( *(int64*)SYM$1 != 1ll ) goto label$144;
	{
	...
	*(struct $7ASTNODE**)((uint8*)&CTX$1 + 48ll) = (struct $7ASTNODE*)0ull;
	...
	struct $7ASTNODE* vr$14 = ASTTYPEINIBEGIN( *(int64*)((uint8*)&CTX$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)&CTX$1 + 16ll), IS_LOCAL$1, *(int64*)((uint8*)SYM$1 + 88ll) );
	*(struct $7ASTNODE**)((uint8*)&CTX$1 + 32ll) = vr$14;
	int64 vr$15 = TYPEHASCTOR( *(int64*)((uint8*)&CTX$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)&CTX$1 + 16ll) );
	if( vr$15 == 0ll ) goto label$146;
	{
		*($9FB_INIOPT*)((uint8*)&CTX$1 + 40ll) = *(int64*)((uint8*)&CTX$1 + 40ll) | 2ll;
	}
	label$146:;
	label$145:;
	if( ((int64)-(*(int64*)*(struct $8FBSYMBOL**)&CTX$1 == 1ll) | (int64)-(*(int64*)*(struct $8FBSYMBOL**)&CTX$1 == 12ll)) == 0ll ) goto label$148;
	{
		int64 vr$23 = HARRAYINIT( &CTX$1, 0ll );
		OK$1 = vr$23;
	}
	goto label$147;
	label$148:;
	{
		if( (*(int64*)((uint8*)&CTX$1 + 8ll) & 511ll) != 20ll ) goto label$150;
		{
			int64 vr$26 = HUDTINIT( &CTX$1 );
			OK$1 = vr$26;
		}
		goto label$149;
		label$150:;
		{
			int64 vr$28 = HELMINIT( &CTX$1, 0ll );
			OK$1 = vr$28;
		}
		label$149:;
	}
	...
	if( OK$1 == 0ll ) goto label$151;
	TMP$96$1 = *(struct $7ASTNODE**)((uint8*)&CTX$1 + 32ll);
	goto label$152;
	label$151:;
	TMP$96$1 = (struct $7ASTNODE*)0ull;
	label$152:;
	fb$result$1 = TMP$96$1;
	label$140:;
	return fb$result$1;
}
...
static int64 HDOASSIGN( struct $10FB_INITCTX* CTX$1, struct $7ASTNODE* EXPR$1, int64 NO_FAKE$1 )
{
	...
	{
		struct $7ASTNODE* vr$6 = ASTNEWCONV( *(int64*)((uint8*)CTX$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 16ll), EXPR$1, 0ll, (int64*)0ull );
		EXPR$1 = vr$6;
...
static int64 HELMINIT( struct $10FB_INITCTX* CTX$1, int64 NO_FAKE$1 )
{
	...
	int64 OLD_DTYPE$1;
	fb$result$1 = 0ll;
	OLDSYM$1 = *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 312ll);
	OLD_DTYPE$1 = *(int64*)((uint8*)&PARSER$ + 304ll);
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 312ll) = *(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)CTX$1 + 64ll);
	*(int64*)((uint8*)&PARSER$ + 304ll) = *(int64*)((uint8*)*(struct $8FBSYMBOL**)CTX$1 + 56ll) & 511ll;
	...
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 312ll) = OLDSYM$1;
	*(int64*)((uint8*)&PARSER$ + 304ll) = OLD_DTYPE$1;
...
static int64 HARRAYINIT( struct $10FB_INITCTX* CTX$1, int64 NO_FAKE$1 )
{
	...
	if( vr$1 != 123ll ) goto label$29;
	{
		...
		*(int64*)((uint8*)CTX$1 + 24ll) = *(int64*)((uint8*)CTX$1 + 24ll) + 1ll;
		...
		if( *(int64*)((uint8*)CTX$1 + 24ll) < *(int64*)((uint8*)*(struct $8FBSYMBOL**)CTX$1 + 104ll) ) goto label$31;
		{
			...
			TMP$94$3 = 63ll;
			label$153:;
			ERRREPORT( TMP$94$3, 0ll, (uint8*)0ull );
	...
	label$41:;
	{
		...
		label$45:;
		{
			...
			{
				int64 vr$47 = HUDTINIT( CTX$1 );
				if( vr$47 != 0ll ) goto label$51;
				{
					goto label$27;
				}
				label$51:;
			...
			label$49:;
			{
				int64 vr$48 = HELMINIT( CTX$1, NO_FAKE$1 );
				if( vr$48 != 0ll ) goto label$53;
				{
					goto label$27;
				}
				label$53:;
	...
	label$43:;
	int64 vr$53 = HMATCH( 44ll, 0ll );
	if( vr$53 != 0ll ) goto label$41;
	label$42:;
	if( ELEMENTS$1 != -1ll ) goto label$57;
	{
		...
		int64 vr$67 = SYMBCHECKARRAYSIZE( *(int64*)((uint8*)*(struct $8FBSYMBOL**)CTX$1 + 104ll), *(struct $10FBARRAYDIM**)((uint8*)*(struct $8FBSYMBOL**)CTX$1 + 112ll), *(int64*)((uint8*)*(struct $8FBSYMBOL**)CTX$1 + 80ll), (int64)-((*(int64*)((uint8*)*(struct $8FBSYMBOL**)CTX$1 + 8ll) & 3ll) == 0ll) );
		if( vr$67 != 0ll ) goto label$59;
		{
	...
	{
		int64 vr$74 = SYMBCALCARRAYELEMENTS( *(struct $8FBSYMBOL**)CTX$1, *(int64*)((uint8*)CTX$1 + 24ll) + 1ll );
		ELEMENTS$1 = ELEMENTS$1 * vr$74;
		struct $8FBSYMBOL* CTOR$2;
		CTOR$2 = (struct $8FBSYMBOL*)0ull;
		if( (*(int64*)((uint8*)CTX$1 + 40ll) & 2ll) == 0ll ) goto label$63;
		{
			struct $8FBSYMBOL* vr$79 = SYMBGETCOMPDEFCTOR( *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 16ll) );
			CTOR$2 = vr$79;
			...
			label$65:;
			{
				int64 vr$80 = SYMBCHECKACCESS( CTOR$2 );
				if( vr$80 != 0ll ) goto label$67;
				{
		...
		{
			int64 PAD_LGT$3;
			if( (*(int64*)((uint8*)*(struct $8FBSYMBOL**)CTX$1 + 8ll) & 262144ll) == 0ll ) goto label$71;
			{
				PAD_LGT$3 = *(int64*)((uint8*)&ENV$ + 544ll);
			}
			goto label$70;
			label$71:;
			{
				{
					uint64 TMP$95$5;
					TMP$95$5 = (uint64)(*(int64*)((uint8*)CTX$1 + 8ll) & 511ll);
					goto label$73;
					label$74:;
					{
					...
					label$75:;
					{
						int64 vr$94 = SYMBCALCLEN( *(int64*)((uint8*)CTX$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 16ll) );
						PAD_LGT$3 = vr$94;
					}
					goto label$72;
					label$73:;
					static const void* tmp$97[15ll] = {
						&&label$74,
						&&label$75,
						&&label$75,
						&&label$74,
					...
					if( (TMP$95$5 - 4ull) > 14ull ) goto label$75;
					goto *tmp$97[TMP$95$5 - 4ull];
					label$72:;
				}
			}
			label$70:;
	...
	label$61:;
	label$60:;
	if( ISARRAY$1 == 0ll ) goto label$77;
	{
		ASTTYPEINISCOPEEND( *(struct $7ASTNODE**)((uint8*)CTX$1 + 32ll), *(struct $8FBSYMBOL**)CTX$1 );
		int64 vr$104 = LEXGETTOKEN( 0ll );
		if( vr$104 == 125ll ) goto label$79;
		{
...
static int64 HUDTINIT( struct $10FB_INITCTX* CTX$1 )
{
	...
	if( (*(int64*)((uint8*)CTX$1 + 40ll) & 2ll) == 0ll ) goto label$83;
	{
		struct $7ASTNODE* EXPR$2;
		OLDSUBTYPE$1 = *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 312ll);
		OLDDTYPE$1 = *(int64*)((uint8*)&PARSER$ + 304ll);
		*(int64*)((uint8*)&PARSER$ + 304ll) = *(int64*)((uint8*)CTX$1 + 8ll);
		*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 312ll) = *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 16ll);
		struct $7ASTNODE* vr$6 = CEXPRESSION(  );
		EXPR$2 = vr$6;
		*(int64*)((uint8*)&PARSER$ + 304ll) = OLDDTYPE$1;
		*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 312ll) = OLDSUBTYPE$1;
		if( EXPR$2 != (struct $7ASTNODE*)0ull ) goto label$85;
		{
			ERRREPORT( 9ll, 0ll, (uint8*)0ull );
		...
		label$85:;
		label$84:;
		if( *(int64*)*(struct $8FBSYMBOL**)CTX$1 != 4ll ) goto label$87;
		{
			if( *(int64*)((uint8*)*(struct $8FBSYMBOL**)CTX$1 + 96ll) != 2ll ) goto label$89;
			{
				if( ((int64)-((*(int64*)((uint8*)EXPR$2 + 8ll) & 511ll) == (*(int64*)((uint8*)CTX$1 + 8ll) & 511ll)) & (int64)-(*(struct $8FBSYMBOL**)((uint8*)EXPR$2 + 16ll) == *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 16ll))) == 0ll ) goto label$91;
				{
					REC_CNT$1 = REC_CNT$1 + -1ll;
					int64 vr$22 = HDOASSIGN( CTX$1, EXPR$2, 0ll );
					fb$result$1 = vr$22;
					goto label$81;
				}
				label$91:;
		...
		EXPR$2 = vr$26;
		if( EXPR$2 != (struct $7ASTNODE*)0ull ) goto label$93;
		{
			REC_CNT$1 = REC_CNT$1 + -1ll;
			goto label$81;
		}
		label$93:;
		label$92:;
		if( IS_CTORCALL$2 == 0ll ) goto label$95;
		{
			REC_CNT$1 = REC_CNT$1 + -1ll;
			struct $7ASTNODE* vr$33 = ASTTYPEINIADDCTORCALL( *(struct $7ASTNODE**)((uint8*)CTX$1 + 32ll), *(struct $8FBSYMBOL**)CTX$1, EXPR$2, *(int64*)((uint8*)CTX$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 16ll) );
			fb$result$1 = (int64)-(vr$33 != (struct $7ASTNODE*)0ull);
			goto label$81;
		}
		goto label$94;
		label$95:;
		{
			REC_CNT$1 = REC_CNT$1 + -1ll;
			int64 vr$36 = HDOASSIGN( CTX$1, EXPR$2, 0ll );
			fb$result$1 = vr$36;
			goto label$81;
		}
		label$94:;
	...
	if( vr$37 == 40ll ) goto label$97;
	{
		if( REC_CNT$1 > 1ll ) goto label$99;
		{
			REC_CNT$1 = REC_CNT$1 + -1ll;
			int64 vr$39 = HELMINIT( CTX$1, 0ll );
			fb$result$1 = vr$39;
			goto label$81;
		}
		label$99:;
		label$98:;
		int64 vr$40 = LEXGETLOOKAHEAD( 1ll, 0ll );
		COMMA$1 = (int64)-(vr$40 == 44ll);
		PARENTH$1 = 0ll;
	}
	goto label$96;
	label$97:;
	...
	label$96:;
	struct $8FBSYMBOL* vr$45 = SYMBUDTGETFIRSTFIELD( *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 16ll) );
	FIRST$1 = vr$45;
	FLD$1 = FIRST$1;
	LGT$1 = 0ll;
	...
	*(int64*)((uint8*)CTX$1 + 24ll) = -1ll;
	label$100:;
	{
		if( FLD$1 != (struct $8FBSYMBOL*)0ull ) goto label$104;
		{
		...
		*(int64*)((uint8*)*(struct $7ASTNODE**)((uint8*)CTX$1 + 32ll) + 40ll) = BASEOFS$1 + *(int64*)((uint8*)FLD$1 + 88ll);
		int64 vr$58 = SYMBCHECKACCESS( FLD$1 );
		if( vr$58 != 0ll ) goto label$110;
		{
		...
		*($9FB_INIOPT*)((uint8*)CTX$1 + 40ll) = *(int64*)((uint8*)CTX$1 + 40ll) & -3ll;
		int64 vr$63 = SYMBHASCTOR( FLD$1 );
		if( vr$63 == 0ll ) goto label$112;
		{
			*($9FB_INIOPT*)((uint8*)CTX$1 + 40ll) = *(int64*)((uint8*)CTX$1 + 40ll) | 2ll;
		}
		label$112:;
		label$111:;
		int64 vr$67 = HARRAYINIT( CTX$1, -1ll );
		if( vr$67 != 0ll ) goto label$114;
		{
			if( ((int64)-(FLD$1 != FIRST$1) | (int64)-(*(struct $7ASTNODE**)((uint8*)CTX$1 + 48ll) == (struct $7ASTNODE*)0ull)) == 0ll ) goto label$116;
			{
				ERRREPORT( 24ll, -1ll, (uint8*)0ull );
				REC_CNT$1 = REC_CNT$1 + -1ll;
				goto label$81;
			...
			struct $7ASTNODE* vr$77 = ASTBUILDIMPLICITCTORCALLEX( *(struct $8FBSYMBOL**)CTX$1, EXPR$3, -1ll, &IS_CTORCALL$3 );
			EXPR$3 = vr$77;
			if( EXPR$3 != (struct $7ASTNODE*)0ull ) goto label$118;
			{
				REC_CNT$1 = REC_CNT$1 + -1ll;
				goto label$81;
			}
			label$118:;
			label$117:;
			if( PARENTH$1 == 0ll ) goto label$120;
			{
				int64 vr$79 = LEXGETTOKEN( 0ll );
				if( vr$79 == 41ll ) goto label$122;
				{
			...
			label$119:;
			REC_CNT$1 = REC_CNT$1 + -1ll;
			if( IS_CTORCALL$3 == 0ll ) goto label$124;
			{
				struct $7ASTNODE* vr$86 = ASTTYPEINIADDCTORCALL( *(struct $7ASTNODE**)((uint8*)CTX$1 + 32ll), *(struct $8FBSYMBOL**)CTX$1, EXPR$3, *(int64*)((uint8*)CTX$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 16ll) );
				fb$result$1 = (int64)-(vr$86 != (struct $7ASTNODE*)0ull);
				goto label$81;
			}
			goto label$123;
			label$124:;
			{
				int64 vr$88 = HDOASSIGN( CTX$1, EXPR$3, 0ll );
				fb$result$1 = vr$88;
				goto label$81;
			}
			label$123:;
		...
		FLD$1 = vr$91;
		if( REC_CNT$1 <= 1ll ) goto label$126;
		{
			if( COMMA$1 == 0ll ) goto label$128;
			{
				if( FLD$1 != (struct $8FBSYMBOL*)0ull ) goto label$130;
				{
					goto label$101;
				}
				label$130:;
		...
		label$126:;
		label$125:;
		int64 vr$92 = HMATCH( 44ll, 0ll );
		if( vr$92 != 0ll ) goto label$132;
		{
			goto label$101;
		}
		label$132:;
	...
	goto label$100;
	label$101:;
	if( PARENTH$1 == 0ll ) goto label$134;
	{
		int64 vr$93 = LEXGETTOKEN( 0ll );
		if( vr$93 == 41ll ) goto label$136;
		{
			ERRREPORT( 7ll, 0ll, (uint8*)0ull );
			HSKIPUNTIL( 41ll, -1ll, 0ll, 0ll );
		}
	...
	__builtin_memcpy( CTX$1, &OLD_CTX$1, 56 );
	int64 SYM_LEN$1;
	int64 vr$99 = SYMBCALCLEN( *(int64*)((uint8*)CTX$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 16ll) );
	SYM_LEN$1 = vr$99;
