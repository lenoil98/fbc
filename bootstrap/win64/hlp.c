...
uint8* HHEXUINT( uint64 VALUE$1 )
{
	...
	label$14:;
	{
		*P$1 = (uint8)*(int64*)((uint8*)HEXTB$1 + ((int64)(VALUE$1 & 15ull) << (3ll & 63ll)));
		LGT$1 = LGT$1 + 1ll;
	...
	{
		{
			...
			goto label$70;
			label$71:;
			static const void* tmp$123[123ll] = {
				&&label$72,
				&&label$74,
				&&label$74,
				&&label$74,
			...
			if( TMP$122$3 > 122ull ) goto label$74;
			goto *tmp$123[TMP$122$3 - 0ull];
			label$70:;
		}
		P$1 = (uint8*)((uint8*)P$1 + 1ll);
	}
...
FBSTRING* HSTRIPPATH( uint8* FILENAME$1 )
{
	...
	label$91:;
	{
		...
		*(int64*)((uint8*)P$1 + 8ll) = vr$8;
		if( ((int64)-(*(int64*)P$1 == 0ll) | ((int64)-(*(int64*)((uint8*)P$1 + 8ll) > 0ll) & (int64)-(*(int64*)((uint8*)P$1 + 8ll) < *(int64*)P$1))) == 0ll ) goto label$95;
		{
...
FBSTRING* HSTRIPFILENAME( uint8* FILENAME$1 )
{
	...
	__FB_STATIC_ASSERT( sizeof( struct $8FBARRAY1Iu7INTEGERE ) == 72 );
	static struct $8FBARRAY1Iu7INTEGERE tmp$128$1 = { (int64*)((uint8*)P$1 + -8ll), (int64*)P$1, 16ll, 8ll, 1ll, 49ll, { { 2ll, 1ll, 2ll } } };
	LP$1 = 0ll;
	label$102:;
	{
		FBSTRING* vr$1 = fb_StrAllocTempDescZEx( (uint8*)"\x5C", 1ll );
		...
		*(int64*)P$1 = vr$4;
		...
		int64 vr$8 = fb_StrInstr( LP$1 + 1ll, (FBSTRING*)vr$6, (FBSTRING*)vr$5 );
		*(int64*)((uint8*)P$1 + 8ll) = vr$8;
		if( ((int64)-(*(int64*)P$1 == 0ll) | ((int64)-(*(int64*)((uint8*)P$1 + 8ll) > 0ll) & (int64)-(*(int64*)((uint8*)P$1 + 8ll) < *(int64*)P$1))) == 0ll ) goto label$106;
		{
			P_FOUND$1 = *(int64*)((uint8*)P$1 + 8ll);
		}
		goto label$105;
...
void HREPLACESLASH( uint8* S$1, int64 CHAR$1 )
{
	label$125:;
	{
		...
		I$2 = I$2 + 1ll;
		label$127:;
		if( I$2 <= TMP$129$2 ) goto label$130;
		label$129:;
	}
	label$126:;
}
...
FBSTRING* PATHSTRIPDIV( FBSTRING* PATH$1 )
{
	...
	if( LENGTH$1 <= 0ll ) goto label$136;
	{
		...
		{
			uint8 TMP$130$3;
			TMP$130$3 = *(uint8*)((uint8*)*(uint8**)PATH$1 + LENGTH$1);
			if( (uint64)(int64)TMP$130$3 == 47ull ) goto label$139;
			label$140:;
			if( (uint64)(int64)TMP$130$3 != 92ull ) goto label$138;
			label$139:;
			{
...
int64 PATHISABSOLUTE( uint8* PATH$1 )
{
	...
	if( (int64)*(uint8*)PATH$1 == 0ll ) goto label$144;
	{
		{
			uint8 TMP$131$3;
			TMP$131$3 = *(uint8*)((uint8*)PATH$1 + 1ll);
			if( (uint64)(int64)TMP$131$3 != 58ull ) goto label$146;
			label$147:;
			{
				fb$result$1 = -1ll;
			}
			goto label$145;
			label$146:;
			if( (uint64)(int64)TMP$131$3 != 92ull ) goto label$148;
			label$149:;
			{
...
FBSTRING* HCURDIR( void )
{
	...
	fb_StrAssign( (void*)&TMP$133$1, -1ll, (void*)vr$2, -1ll, 0 );
	FBSTRING* vr$5 = PATHSTRIPDIV( &TMP$133$1 );
	fb_StrAssign( (void*)&fb$result$1, -1ll, (void*)vr$5, -1ll, 0 );
	fb_StrDelete( (FBSTRING*)&TMP$133$1 );
	label$174:;
...
FBSTRING* PATHSTRIPCURDIR( FBSTRING* PATH$1 )
{
	...
	FBSTRING* vr$4 = fb_StrConcat( &TMP$134$1, (void*)vr$1, -1ll, (void*)"\x5C", 2ll );
...
int64 HISVALIDSYMBOLNAME( uint8* SYM$1 )
{
	...
	TMP$137$1 = (int64)-((uint64)(int64)*SYM$1 <= 122ull);
	goto label$203;
	label$185:;
	TMP$137$1 = 0ll;
	label$203:;
	if( TMP$137$1 != 0ll ) goto label$187;
	if( (uint64)(int64)*SYM$1 > 90ull ) goto label$186;
	TMP$139$1 = (int64)-((uint64)(int64)*SYM$1 >= 65ull);
	goto label$205;
	label$186:;
	TMP$139$1 = 0ll;
	label$205:;
	TMP$140$1 = (int64)-(TMP$139$1 != 0ll);
	goto label$204;
	label$187:;
	TMP$140$1 = -1ll;
	label$204:;
	if( TMP$140$1 != 0ll ) goto label$188;
	TMP$142$1 = (int64)-((uint64)(int64)*SYM$1 == 95ull);
	goto label$206;
	label$188:;
	TMP$142$1 = -1ll;
	label$206:;
	if( TMP$142$1 != 0ll ) goto label$190;
	{
		goto label$180;
		label$190:;
	}
	{
		...
		label$194:;
		{
			...
			TMP$144$3 = (int64)-((uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) <= 122ull);
			goto label$207;
			label$195:;
			TMP$144$3 = 0ll;
			label$207:;
			if( TMP$144$3 != 0ll ) goto label$197;
			if( (uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) > 90ull ) goto label$196;
			TMP$145$3 = (int64)-((uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) >= 65ull);
			goto label$209;
			label$196:;
			TMP$145$3 = 0ll;
			label$209:;
			TMP$146$3 = (int64)-(TMP$145$3 != 0ll);
			goto label$208;
			label$197:;
			TMP$146$3 = -1ll;
			label$208:;
			if( TMP$146$3 != 0ll ) goto label$198;
			TMP$147$3 = (int64)-((uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) == 95ull);
			goto label$210;
			label$198:;
			TMP$147$3 = -1ll;
			label$210:;
			if( TMP$147$3 != 0ll ) goto label$200;
			if( (uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) > 57ull ) goto label$199;
			TMP$148$3 = (int64)-((uint64)(int64)*(uint8*)((uint8*)SYM$1 + I$2) >= 48ull);
			goto label$212;
			label$199:;
			TMP$148$3 = 0ll;
			label$212:;
			TMP$149$3 = (int64)-(TMP$148$3 != 0ll);
			goto label$211;
			label$200:;
			TMP$149$3 = -1ll;
			label$211:;
			if( TMP$149$3 != 0ll ) goto label$202;
			{
				goto label$180;
				label$202:;
			}
		...
		I$2 = I$2 + 1ll;
		label$191:;
		if( I$2 <= TMP$143$2 ) goto label$194;
		label$193:;
	}
	fb$result$1 = -1ll;
	label$180:;
...
static int64 HFINDEXTBEGIN( FBSTRING* PATH$1 )
{
	...
	label$75:;
	{
		...
		label$80:;
		{
			{
				uint8 TMP$124$4;
				TMP$124$4 = *(uint8*)((uint8*)*(uint8**)PATH$1 + I$2);
				if( (uint64)(int64)TMP$124$4 != 46ull ) goto label$82;
				label$83:;
				{
					fb$result$1 = I$2;
					goto label$76;
				...
				goto label$81;
				label$82:;
				if( (uint64)(int64)TMP$124$4 == 92ull ) goto label$85;
				label$86:;
				if( (uint64)(int64)TMP$124$4 != 47ull ) goto label$84;
				label$85:;
				{
					goto label$79;
				}
