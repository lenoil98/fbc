...
struct $6IRVREG* ASTLOADBRANCH( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$19;
	{
		...
		{
			{
				...
				if( TMP$84$4 != 104ll ) goto label$23;
				label$24:;
				{
					(*(tmp$53*)((uint8*)&IR$ + 280ll))( VR$1 );
				}
				goto label$22;
				label$23:;
				if( TMP$84$4 != 101ll ) goto label$25;
				label$26:;
				{
					(*(tmp$46*)((uint8*)&IR$ + 144ll))( 0ll );
				}
				goto label$22;
				label$25:;
				{
		...
		label$21:;
		{
			(*(tmp$57*)((uint8*)&IR$ + 288ll))( *(int64*)((uint8*)N$1 + 40ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 56ll) );
		}
		label$20:;
	}
	label$19:;
...
struct $6IRVREG* ASTLOADJMPTB( struct $7ASTNODE* N$1 )
{
	...
	{
		(*(tmp$58*)((uint8*)&IR$ + 296ll))( V1$1, *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll), *(uint64**)((uint8*)N$1 + 40ll), *(struct $8FBSYMBOL***)((uint8*)N$1 + 48ll), *(int64*)((uint8*)N$1 + 56ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 64ll), *(uint64*)((uint8*)N$1 + 72ll), *(uint64*)((uint8*)N$1 + 80ll) );
	}
	label$39:;
	label$38:;
...
struct $7ASTNODE* ASTBUILDJMPTB( struct $8FBSYMBOL* TEMPVAR$1, uint64* VALUES1$1, struct $8FBSYMBOL** LABELS1$1, int64 LABELCOUNT$1, struct $8FBSYMBOL* DEFLABEL$1, uint64 BIAS$1, uint64 SPAN$1 )
{
	...
	{
		$10FB_BACKEND TMP$87$2;
		TMP$87$2 = *($10FB_BACKEND*)((uint8*)&ENV$ + 208ll);
		if( TMP$87$2 == 0ll ) goto label$46;
		label$47:;
		if( TMP$87$2 != 2ll ) goto label$45;
		label$46:;
		{
	...
	if( *(int64*)((uint8*)&ENV$ + 208ll) != 0ll ) goto label$51;
	{
		...
		struct $8FBSYMBOL* vr$5 = SYMBADDVAR( (uint8*)vr$4, (uint8*)0ull, 32ll, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$86$1, 1ll, 0ll );
		TBSYM$1 = vr$5;
		*($12FB_SYMBSTATS*)((uint8*)TBSYM$1 + 24ll) = *(int64*)((uint8*)TBSYM$1 + 24ll) | 32768ll;
		...
		TREE$1 = vr$14;
		struct $7ASTNODE* vr$15 = ASTNEWCONSTI( *(int64*)((uint8*)&ENV$ + 544ll), DTYPE$1, (struct $8FBSYMBOL*)0ull );
...
static int64 HPRECALCBIASOFFSET( uint64 BIAS$1, int64 DTYPE$1 )
{
	...
	*(int64*)((uint8*)&AST$ + 464ll) = *(int64*)((uint8*)&AST$ + 464ll) + 1ll;
	...
	T$1 = vr$3;
	struct $7ASTNODE* vr$4 = ASTNEWCONSTI( *(int64*)((uint8*)&ENV$ + 544ll), DTYPE$1, (struct $8FBSYMBOL*)0ull );
