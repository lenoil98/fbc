...
struct $7ASTNODE* CEQINPARENSONLYEXPR( void )
{
	...
	EQINPARENSONLY$1 = (int64)-((*(int64*)((uint8*)&PARSER$ + 296ll) & 256ll) != 0ll);
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 296ll) = *(int64*)((uint8*)&PARSER$ + 296ll) | 256ll;
	}
	goto label$12;
	label$13:;
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 296ll) = *(int64*)((uint8*)&PARSER$ + 296ll) & -257ll;
	}
	label$12:;
...
struct $7ASTNODE* CGTINPARENSONLYEXPR( void )
{
	...
	GTINPARENSONLY$1 = (int64)-((*(int64*)((uint8*)&PARSER$ + 296ll) & 512ll) != 0ll);
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 296ll) = *(int64*)((uint8*)&PARSER$ + 296ll) | 512ll;
	}
	goto label$18;
	label$19:;
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 296ll) = *(int64*)((uint8*)&PARSER$ + 296ll) & -513ll;
	}
	label$18:;
	struct $7ASTNODE* vr$5 = CEXPRESSION(  );
	EXPR$1 = vr$5;
...
struct $7ASTNODE* CPARENTEXPRESSION( void )
{
	...
	*(int64*)((uint8*)&PARSER$ + 288ll) = *(int64*)((uint8*)&PARSER$ + 288ll) + 1ll;
	int64 IS_OPT$1;
	IS_OPT$1 = (int64)-((*(int64*)((uint8*)&PARSER$ + 296ll) & 1ll) != 0ll);
	goto label$27;
	{
	...
	EQINPARENSONLY$1 = (int64)-((*(int64*)((uint8*)&PARSER$ + 296ll) & 256ll) != 0ll);
	GTINPARENSONLY$1 = (int64)-((*(int64*)((uint8*)&PARSER$ + 296ll) & 512ll) != 0ll);
	IDXINPARENSONLY$1 = (int64)-((*(int64*)((uint8*)&PARSER$ + 296ll) & 4096ll) != 0ll);
	goto label$29;
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 296ll) = *(int64*)((uint8*)&PARSER$ + 296ll) | 256ll;
	}
	...
	label$45:;
	{
		if( ((int64)-(IS_OPT$1 == 0ll) | (int64)-(*(int64*)((uint8*)&PARSER$ + 288ll) == 0ll)) == 0ll ) goto label$47;
		{
...
struct $7ASTNODE* CATOM( struct $8FBSYMBOL* BASE_PARENT$1, struct $10FBSYMCHAIN* CHAIN_$1 )
{
	...
	label$169:;
	{
		...
		label$176:;
		{
			...
			{
				struct $7ASTNODE* vr$7 = HCHECKID( BASE_PARENT$1, *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8520ll) + 2088ll) );
				fb$result$1 = vr$7;
				goto label$168;
			}
			label$178:;
		...
		label$181:;
		{
			...
			if( *(struct $13FB_CMPSTMTSTK**)((uint8*)&PARSER$ + 104ll) == (struct $13FB_CMPSTMTSTK*)0ull ) goto label$185;
			{
				...
				if( vr$11 == 46ll ) goto label$187;
				{
					struct $7ASTNODE* vr$14 = CWITHVARIABLE( (int64)-((*(int64*)((uint8*)&PARSER$ + 296ll) & 2ll) != 0ll) );
					fb$result$1 = vr$14;
					goto label$168;
				}
				label$187:;
		...
		if( TMP$100$2 > 6ull ) goto label$171;
		goto *tmp$101[TMP$100$2 - 0ull];
		label$171:;
	}
	fb$result$1 = (struct $7ASTNODE*)0ull;
	label$168:;
...
static struct $7ASTNODE* HFINDID_QB( struct $8FBSYMBOL* BASE_PARENT$1, struct $10FBSYMCHAIN* CHAIN_$1 )
{
	...
	label$50:;
	{
				...
				if( (*(int64*)((uint8*)SYM$2 + 8ll) & 1048576ll) == 0ll ) goto label$59;
				{
					if( *(int64*)SYM$2 != 1ll ) goto label$61;
					{
						if( DEFDTYPE$1 != 17ll ) goto label$63;
						{
							{
								uint64 TMP$94$8;
								TMP$94$8 = (uint64)(*(int64*)((uint8*)SYM$2 + 56ll) & 511ll);
								goto label$65;
								label$66:;
								{
								}
								...
								if( (TMP$94$8 - 4ull) > 14ull ) goto label$67;
								goto *tmp$102[TMP$94$8 - 4ull];
								label$64:;
							}
						}
						goto label$62;
				...
				{
					{
						...
						if( (TMP$95$6 - 1ull) > 5ull ) goto label$70;
		...
		label$54:;
		{
			label$86:;
			{
				...
				if( SUFFIX$1 != 17ll ) goto label$90;
				{
					{
						uint64 TMP$96$6;
						TMP$96$6 = (uint64)(*(int64*)((uint8*)SYM$2 + 56ll) & 511ll);
						goto label$92;
						label$93:;
						{
							IS_MATCH$4 = -1ll;
						...
						if( (TMP$96$6 - 4ull) > 14ull ) goto label$94;
						goto *tmp$104[TMP$96$6 - 4ull];
						label$91:;
					}
				}
				goto label$89;
				...
				{
					{
						...
						if( (TMP$97$6 - 1ull) > 5ull ) goto label$97;
						goto *tmp$105[TMP$97$6 - 1ull];
						label$97:;
					}
				}
				goto label$95;
				label$96:;
				{
					...
					{
						if( *(int64*)((uint8*)SYM$2 + 96ll) != 476ll ) goto label$110;
						{
		...
		{
			struct $7ASTNODE* vr$43 = _Z11CVARIABLEEXP8FBSYMBOLu7INTEGER( VAR_SYM$2, (int64)-((*(int64*)((uint8*)&PARSER$ + 296ll) & 2ll) != 0ll) );
			fb$result$1 = vr$43;
			goto label$49;
		}
		label$114:;
		...
		{
			{
				...
				label$129:;
				{
					struct $7ASTNODE* vr$8 = _Z11CVARIABLEEXP10FBSYMCHAINu7INTEGER( CHAIN_$1, (int64)-((*(int64*)((uint8*)&PARSER$ + 296ll) & 2ll) != 0ll) );
					fb$result$1 = vr$8;
					goto label$116;
				}
				goto label$125;
				label$130:;
				{
					struct $7ASTNODE* vr$11 = CIMPLICITDATAMEMBER( BASE_PARENT$1, CHAIN_$1, (int64)-((*(int64*)((uint8*)&PARSER$ + 296ll) & 2ll) != 0ll), OPTIONS$1 );
					fb$result$1 = vr$11;
					goto label$116;
				}
				goto label$125;
				...
				goto label$125;
				label$126:;
				static const void* tmp$106[13ll] = {
					&&label$129,
					&&label$127,
					&&label$128,
					&&label$125,
				...
				if( (TMP$98$4 - 1ull) > 12ull ) goto label$125;
				goto *tmp$106[TMP$98$4 - 1ull];
				label$125:;
			}
			SYM$2 = *(struct $8FBSYMBOL**)((uint8*)SYM$2 + 280ll);
		}
...
static struct $7ASTNODE* HBASEMEMBERACCESS( void )
{
	...
	if( (*(int64*)((uint8*)PROC$1 + 16ll) & 2ll) != 0ll ) goto label$143;
	{
...
static struct $7ASTNODE* HCHECKID( struct $8FBSYMBOL* BASE_PARENT$1, struct $10FBSYMCHAIN* CHAIN_$1 )
{
	...
	label$156:;
	label$155:;
	if( (*(int64*)((uint8*)&PARSER$ + 296ll) & 1024ll) == 0ll ) goto label$160;
	{
		FBSTRING TMP$99$2;
		...
		fb_StrAssign( (void*)&TMP$99$2, -1ll, (void*)vr$6, -1ll, 0 );
		struct $7ASTNODE* vr$8 = ASTNEWCONSTSTR( (uint8*)*(uint8**)&TMP$99$2 );
		EXPR$1 = vr$8;
		fb_StrDelete( (FBSTRING*)&TMP$99$2 );
		LEXSKIPTOKEN( 0ll );
		fb$result$1 = EXPR$1;
		goto label$154;
	}
	...
	label$166:;
	label$165:;
	struct $7ASTNODE* vr$13 = _Z11CVARIABLEEXP10FBSYMCHAINu7INTEGER( (struct $10FBSYMCHAIN*)0ull, (int64)-((*(int64*)((uint8*)&PARSER$ + 296ll) & 2ll) != 0ll) );
	fb$result$1 = vr$13;
	goto label$154;
	label$154:;
	return fb$result$1;
