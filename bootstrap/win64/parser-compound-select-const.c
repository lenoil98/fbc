...
void CSELCONSTSTMTBEGIN( void )
{
	...
	goto label$45;
	label$20:;
	TMP$95$1 = (*(int64*)((uint8*)EXPR$1 + 8ll) & 511ll) & 31ll;
	label$45:;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$95$1 * 56ll)) == 0ll ) goto label$22;
	{
		ASTDELTREE( EXPR$1 );
	...
	label$22:;
	{
		{
			int64 TMP$96$3;
			TMP$96$3 = *(int64*)((uint8*)EXPR$1 + 8ll) & 511ll;
			if( TMP$96$3 == 4ll ) goto label$25;
			label$26:;
			if( TMP$96$3 != 7ll ) goto label$24;
			label$25:;
			{
	...
	if( DTYPE$1 == 9ll ) goto label$32;
	{
		...
		label$46:;
		if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$97$2 * 56ll)) + 8ll) > *(int64*)((uint8*)SYMB_DTYPETB$ + 512ll) ) goto label$35;
		{
	...
	label$31:;
	{
		...
		label$38:;
		{
			...
			label$47:;
			DTYPE$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$98$3 * 56ll)) + 32ll);
		}
		label$37:;
		label$36:;
	}
...
void CSELCONSTSTMTEND( struct $13FB_CMPSTMTSTK* STK$1 )
{
	...
	if( *(int64*)&CTX$ <= *(int64*)((uint8*)STK$1 + 48ll) ) goto label$98;
	{
		...
		ADJUST_BIAS$2 = *(uint64*)((uint8*)((uint8*)&CTX$ + (*(int64*)((uint8*)STK$1 + 48ll) << (3ll & 63ll))) + 8ll);
		{
			...
			I$3 = I$3 + 1ll;
			label$99:;
			if( I$3 <= TMP$100$3 ) goto label$102;
			label$101:;
		}
