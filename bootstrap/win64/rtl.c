...
static struct $8FBSYMBOL* RTLLOOKUPTB$[366];
...
static struct $8FBARRAY1IP8FBSYMBOLE tmp$85$ = { (struct $8FBSYMBOL**)RTLLOOKUPTB$, (struct $8FBSYMBOL**)RTLLOOKUPTB$, 2928ll, 8ll, 1ll, 49ll, { { 366ll, 0ll, 365ll } } };
...
void RTLEND( void )
{
	...
	fb_ArrayClear( (struct $7FBARRAYIvE*)&tmp$85$ );
	label$13:;
}
...
void RTLADDINTRINSICPROCS( struct $14FB_RTL_PROCDEF* PROCDEF$1 )
{
	...
	label$16:;
	{
		...
		{
			CALLCONV$1 = *(int64*)((uint8*)&ENV$ + 504ll);
		}
		label$22:;
		label$21:;
		int64 DOADD$2;
		...
		{
			DOADD$2 = (int64)-((*(int64*)((uint8*)&ENV$ + 1248ll) & 1ll) != 0ll);
		}
		label$24:;
		label$23:;
		...
		if( DOADD$2 == 0ll ) goto label$36;
		{
			...
			PROC$3 = vr$20;
			{
				...
				I$4 = 0ll;
				int64 TMP$86$4;
				TMP$86$4 = *(int64*)((uint8*)PROCDEF$1 + 48ll) + -1ll;
				goto label$37;
				label$40:;
				{
					{
						int64 TMP$94$6;
						struct $15FB_RTL_PARAMDEF* TMP$87$6;
						TMP$87$6 = (struct $15FB_RTL_PARAMDEF*)((uint8*)((uint8*)PROCDEF$1 + (I$4 * 40ll)) + 56ll);
						struct $8FBSYMBOL* SUBTYPE$6;
						SUBTYPE$6 = (struct $8FBSYMBOL*)0ull;
						int64 DTYPE$6;
						struct $7ASTNODE* PARAM_OPTVAL$6;
						if( *(int64*)((uint8*)TMP$87$6 + 16ll) == 0ll ) goto label$42;
						{
							{
								uint64 TMP$88$8;
								TMP$88$8 = (uint64)(*(int64*)TMP$87$6 & 511ll);
								goto label$44;
								label$45:;
								{
								...
								label$46:;
								{
									struct $7ASTNODE* vr$33 = ASTNEWCONSTF( (double)*(int64*)((uint8*)TMP$87$6 + 24ll), *(int64*)TMP$87$6 );
								...
								label$47:;
								{
									...
									INNER_PROC$9 = vr$34;
									{
										...
										FUNC_ARG$10 = 0ll;
										int64 TMP$89$10;
										TMP$89$10 = *(int64*)((uint8*)TMP$87$6 + 24ll) + -1ll;
										goto label$48;
										label$51:;
										{
											I$4 = I$4 + 1ll;
											{
												int64 TMP$92$12;
												struct $15FB_RTL_PARAMDEF* TMP$90$12;
												TMP$90$12 = (struct $15FB_RTL_PARAMDEF*)((uint8*)((uint8*)PROCDEF$1 + (I$4 * 40ll)) + 56ll);
												if( *(int64*)((uint8*)TMP$90$12 + 16ll) == 0ll ) goto label$53;
												{
													{
														uint64 TMP$91$14;
														TMP$91$14 = (uint64)(*(int64*)TMP$90$12 & 511ll);
														goto label$55;
														label$56:;
														{
														...
														label$57:;
														{
															struct $7ASTNODE* vr$48 = ASTNEWCONSTF( (double)*(int64*)((uint8*)TMP$90$12 + 24ll), *(int64*)TMP$90$12 );
															INNER_PARAM_OPTVAL$9 = vr$48;
														}
														goto label$54;
														label$58:;
														{
															struct $7ASTNODE* vr$51 = ASTNEWCONSTI( *(int64*)((uint8*)TMP$90$12 + 24ll), *(int64*)TMP$90$12, (struct $8FBSYMBOL*)0ull );
														...
														if( (TMP$91$14 - 15ull) > 2ull ) goto label$58;
														goto *tmp$97[TMP$91$14 - 15ull];
														label$54:;
													}
												}
												goto label$52;
												...
												label$52:;
												if( *(int64*)((uint8*)TMP$90$12 + 8ll) != 3ll ) goto label$59;
												TMP$92$12 = -1ll;
												goto label$82;
												label$59:;
												TMP$92$12 = 0ll;
												label$82:;
												struct $8FBSYMBOL* vr$55 = SYMBADDPROCPARAM( INNER_PROC$9, (uint8*)0ull, *(int64*)TMP$90$12, (struct $8FBSYMBOL*)0ull, TMP$92$12, *(int64*)((uint8*)TMP$90$12 + 8ll), 0ll, 0ll );
												PARAM$1 = vr$55;
										...
										label$48:;
										if( FUNC_ARG$10 <= TMP$89$10 ) goto label$51;
										label$50:;
									}
									I$4 = I$4 + 1ll;
									{
										struct $15FB_RTL_PARAMDEF* TMP$93$10;
										TMP$93$10 = (struct $15FB_RTL_PARAMDEF*)((uint8*)((uint8*)PROCDEF$1 + (I$4 * 40ll)) + 56ll);
										struct $8FBSYMBOL* vr$62 = SYMBADDPROCPTR( INNER_PROC$9, *(int64*)TMP$93$10, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, *(int64*)((uint8*)&ENV$ + 504ll) );
										SUBTYPE$6 = vr$62;
									}
								...
								label$60:;
								{
									struct $7ASTNODE* vr$65 = ASTNEWCONSTI( *(int64*)((uint8*)TMP$87$6 + 24ll), *(int64*)TMP$87$6, (struct $8FBSYMBOL*)0ull );
									PARAM_OPTVAL$6 = vr$65;
								}
								goto label$43;
								label$44:;
								static const void* tmp$98[40ll] = {
									&&label$46,
									&&label$46,
									&&label$45,
									&&label$60,
								...
								if( (TMP$88$8 - 15ull) > 39ull ) goto label$60;
								goto *tmp$98[TMP$88$8 - 15ull];
								label$43:;
							}
						}
						goto label$41;
						...
						label$62:;
						label$61:;
						if( *(int64*)((uint8*)TMP$87$6 + 8ll) != 3ll ) goto label$63;
						TMP$94$6 = -1ll;
						goto label$83;
						label$63:;
						TMP$94$6 = 0ll;
						label$83:;
						struct $8FBSYMBOL* vr$69 = SYMBADDPROCPARAM( PROC$3, (uint8*)0ull, DTYPE$6, SUBTYPE$6, TMP$94$6, *(int64*)((uint8*)TMP$87$6 + 8ll), 0ll, 0ll );
						PARAM$1 = vr$69;
			...
			if( (*(int64*)((uint8*)PROCDEF$1 + 40ll) & 128ll) == 0ll ) goto label$69;
			{
				if( *(int64*)((uint8*)&ENV$ + 272ll) != 3ll ) goto label$71;
				{
					...
					FBSTRING* vr$82 = fb_StrConcat( &TMP$96$5, (void*)"__", 3ll, (void*)PNAME$3, 0ll );
...
struct $8FBSYMBOL* RTLPROCLOOKUP( uint8* PNAME$1, int64 PIDX$1 )
{
	...
	if( *(struct $8FBSYMBOL**)((uint8*)RTLLOOKUPTB$ + (PIDX$1 << (3ll & 63ll))) != (struct $8FBSYMBOL*)0ull ) goto label$87;
	{
		...
		if( CHAIN_$1 != (struct $10FBSYMCHAIN*)0ull ) goto label$89;
		{
			if( *(int64*)((uint8*)&ENV$ + 272ll) != 3ll ) goto label$91;
			{
				...
				FBSTRING* vr$6 = fb_StrConcat( &TMP$99$4, (void*)"__", 3ll, (void*)PNAME$1, 0ll );
				...
				if( CHAIN_$1 != (struct $10FBSYMCHAIN*)0ull ) goto label$93;
				{
					...
					*(struct $8FBSYMBOL**)((uint8*)RTLLOOKUPTB$ + (PIDX$1 << (3ll & 63ll))) = (struct $8FBSYMBOL*)0ull;
				}
				goto label$92;
				label$93:;
				{
					*(struct $8FBSYMBOL**)((uint8*)RTLLOOKUPTB$ + (PIDX$1 << (3ll & 63ll))) = *(struct $8FBSYMBOL**)CHAIN_$1;
				}
				label$92:;
			}
			goto label$90;
	...
	label$87:;
	label$86:;
	fb$result$1 = *(struct $8FBSYMBOL**)((uint8*)RTLLOOKUPTB$ + (PIDX$1 << (3ll & 63ll)));
	label$85:;
	return fb$result$1;
}
...
int64 RTLCALCEXPRLEN( struct $7ASTNODE* EXPR$1 )
{
	...
	DTYPE$1 = *(int64*)((uint8*)EXPR$1 + 8ll) & 511ll;
	{
		...
		if( (TMP$100$2 - 4ull) > 14ull ) goto label$109;
		goto *tmp$101[TMP$100$2 - 4ull];
		label$106:;
	}
	label$105:;
	return fb$result$1;
	...
	__builtin_memset( &S$1, 0, 8ll );
	{
		...
		label$121:;
		{
			...
			label$123:;
			{
				...
				label$125:;
				{
					fb$result$1 = *(int64*)((uint8*)S$1 + 80ll) / *(int64*)((uint8*)SYMB_DTYPETB$ + 400ll);
				}
				label$124:;
			}
			label$122:;
		...
		goto label$113;
		label$114:;
		static const void* tmp$104[17ll] = {
			&&label$115,
			&&label$115,
			&&label$116,
			&&label$126,
		...
		if( (TMP$103$2 - 2ull) > 16ull ) goto label$126;
		goto *tmp$104[TMP$103$2 - 2ull];
		label$113:;
	}
	label$111:;
	return fb$result$1;
