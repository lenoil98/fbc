...
typedef int64 (*tmp$93)( struct $8REGCLASS*, struct $6IRVREG*, struct $6IRVREG*, uint64 );
typedef int64 (*tmp$94)( struct $8REGCLASS*, int64, struct $6IRVREG*, struct $6IRVREG* );
typedef void (*tmp$95)( struct $8REGCLASS*, int64 );
typedef int64 (*tmp$96)( struct $8REGCLASS*, int64 );
typedef void (*tmp$97)( struct $8REGCLASS*, int64, struct $6IRVREG*, struct $6IRVREG* );
typedef int64 (*tmp$98)( struct $8REGCLASS* );
typedef struct $6IRVREG* (*tmp$99)( struct $8REGCLASS*, int64, struct $6IRVREG** );
typedef void (*tmp$100)( struct $8REGCLASS* );
struct $7REG_REG;
struct $7REG_REG {
	int64 NUM;
...
{
	label$10:;
	*(int64*)((uint8*)REMAPTB$ + 56ll) = *(int64*)((uint8*)REMAPTB$ + (*(int64*)((uint8*)&ENV$ + 496ll) << (3ll & 63ll)));
	label$11:;
}
...
void EDBGEMITHEADER( uint8* FILENAME$1 )
{
	...
	*(uint8**)((uint8*)&CTX$ + 320ll) = (uint8*)0ull;
	...
	(*(tmp$110*)((uint8*)&EMIT$ + 440ll))( 3ll, 0ll );
	HLABEL( (uint8*)*(uint8**)&LNAME$1 );
	{
		...
		label$31:;
		{
			HEMITSTABS( 128ll, *(uint8**)((uint8*)STABSTB$ + (I$2 << (3ll & 63ll))), 0ll, 0ll, (uint8*)"0" );
...
void EDBGSCOPEBEGIN( struct $8FBSYMBOL* S$1 )
{
	...
	label$67:;
	label$66:;
	*(int64*)((uint8*)S$1 + 128ll) = *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8552ll);
...
void EDBGSCOPEEND( struct $8FBSYMBOL* S$1 )
{
	...
	label$71:;
	label$70:;
	*(int64*)((uint8*)S$1 + 136ll) = *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8552ll);
	struct $8FBSYMBOL* vr$2 = SYMBADDLABEL( (uint8*)0ull, 4ll );
...
static FBSTRING* HGETDATATYPE( struct $8FBSYMBOL* SYM$1, int64 REQUESTEDDIMTBELEMENTS$1 )
{
	...
	DTYPE$1 = DTYPE$1 & -513ll;
	{
		...
		label$165:;
		{
			FBSTRING* vr$101 = fb_LongintToStr( *(int64*)((uint8*)REMAPTB$ + (DTYPE$1 << (3ll & 63ll))) );
