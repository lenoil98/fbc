...
int64 CCOMPOUNDSTMT( void )
{
	...
	{
		if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8520ll) + 16ll) == 2147483648ll ) goto label$21;
		{
			fb$result$1 = 0ll;
			goto label$17;
		}
	...
	label$18:;
	{
		...
		if( (TMP$95$2 - 266ull) > 74ull ) goto label$61;
		goto *tmp$96[TMP$95$2 - 266ull];
		label$22:;
	}
	fb$result$1 = -1ll;
	label$17:;
...
void CENDSTATEMENT( void )
{
	...
	LEXSKIPTOKEN( 2048ll );
	{
		...
		if( (TMP$97$2 - 256ull) > 84ull ) goto label$67;
		goto *tmp$98[TMP$97$2 - 256ull];
		label$64:;
	}
...
void CEXITSTATEMENT( void )
{
	...
	TK$1 = vr$0;
	{
		...
		label$78:;
		{
			...
			if( vr$1 != 44ll ) goto label$82;
			{
				LEXSKIPTOKEN( 0ll );
				int64 vr$2 = LEXGETTOKEN( 0ll );
				if( vr$2 == 281ll ) goto label$84;
				{
		...
		label$87:;
		{
			...
			if( vr$5 != 44ll ) goto label$91;
			{
				LEXSKIPTOKEN( 0ll );
				int64 vr$6 = LEXGETTOKEN( 0ll );
				if( vr$6 == 278ll ) goto label$93;
				{
		...
		label$96:;
		{
			...
			if( vr$9 != 44ll ) goto label$100;
			{
				LEXSKIPTOKEN( 0ll );
				int64 vr$10 = LEXGETTOKEN( 0ll );
				if( vr$10 == 273ll ) goto label$102;
				{
		...
		label$105:;
		{
			...
			if( vr$13 != 44ll ) goto label$109;
			{
				LEXSKIPTOKEN( 0ll );
				int64 vr$14 = LEXGETTOKEN( 0ll );
				if( vr$14 == 270ll ) goto label$111;
				{
		...
		label$114:;
		{
			...
			if( LABEL$1 != (struct $8FBSYMBOL*)0ull ) goto label$118;
			{
				...
				__builtin_memset( &ERRMSG$4, 0, 8ll );
				{
					...
					if( (TMP$100$5 - 345ull) > 5ull ) goto label$126;
					goto *tmp$102[TMP$100$5 - 345ull];
					label$119:;
				}
			...
			ERRNUM$3 = 0ll;
			{
				...
				TMP$101$4 = (uint64)vr$19;
				goto label$128;
				label$129:;
				{
					if( (*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 56ll) & 511ll) != 0ll ) goto label$131;
					{
						if( (*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 16ll) & 60ll) == 0ll ) goto label$133;
						{
							ERRNUM$3 = 253ll;
						}
						label$133:;
				...
				label$134:;
				{
					if( (*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 56ll) & 511ll) == 0ll ) goto label$136;
					{
						if( (*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 16ll) & 60ll) == 0ll ) goto label$138;
						{
							ERRNUM$3 = 254ll;
						}
						goto label$137;
						label$138:;
						{
							int64 vr$28 = HCHECKFORCTORRESULT(  );
							ERRNUM$3 = vr$28;
						}
						label$137:;
					}
				...
				label$139:;
				{
					if( (*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 16ll) & 32ll) == 0ll ) goto label$141;
					{
						int64 vr$31 = HCHECKFORCTORRESULT(  );
						ERRNUM$3 = vr$31;
					}
					goto label$140;
					label$141:;
				...
				label$142:;
				{
					if( (*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 16ll) & 16ll) == 0ll ) goto label$144;
					{
						int64 vr$34 = HCHECKFORCTORRESULT(  );
						ERRNUM$3 = vr$34;
					}
					goto label$143;
					label$144:;
				...
				label$145:;
				{
					if( (*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 16ll) & 4ll) != 0ll ) goto label$147;
					{
						ERRNUM$3 = 165ll;
					}
					label$147:;
				...
				label$148:;
				{
					if( (*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 16ll) & 8ll) != 0ll ) goto label$150;
					{
						ERRNUM$3 = 166ll;
					}
					label$150:;
				...
				if( (TMP$101$4 - 345ull) > 5ull ) goto label$127;
				goto *tmp$103[TMP$101$4 - 345ull];
				label$127:;
			}
		...
		goto label$76;
		label$77:;
		static const void* tmp$104[81ll] = {
			&&label$105,
			&&label$153,
			&&label$153,
			&&label$96,
		...
		if( (TMP$99$2 - 270ull) > 80ull ) goto label$153;
		goto *tmp$104[TMP$99$2 - 270ull];
		label$76:;
	}
...
void CCONTINUESTATEMENT( void )
{
	...
	LEXSKIPTOKEN( 2048ll );
	{
		...
		label$158:;
		{
			...
			label$161:;
			int64 vr$1 = LEXGETTOKEN( 0ll );
			if( vr$1 != 44ll ) goto label$162;
			{
				LEXSKIPTOKEN( 0ll );
				int64 vr$2 = LEXGETTOKEN( 0ll );
				if( vr$2 == 281ll ) goto label$164;
				{
					ERRREPORT( 243ll, 0ll, (uint8*)0ull );
					HSKIPUNTIL( -1ll, 0ll, 0ll, 0ll );
					goto label$155;
		...
		label$167:;
		{
			...
			label$170:;
			int64 vr$5 = LEXGETTOKEN( 0ll );
			if( vr$5 != 44ll ) goto label$171;
			{
				LEXSKIPTOKEN( 0ll );
				int64 vr$6 = LEXGETTOKEN( 0ll );
				if( vr$6 == 278ll ) goto label$173;
				{
					ERRREPORT( 244ll, 0ll, (uint8*)0ull );
					HSKIPUNTIL( -1ll, 0ll, 0ll, 0ll );
					goto label$155;
		...
		label$176:;
		{
			...
			label$179:;
			int64 vr$9 = LEXGETTOKEN( 0ll );
			if( vr$9 != 44ll ) goto label$180;
			{
				LEXSKIPTOKEN( 0ll );
				int64 vr$10 = LEXGETTOKEN( 0ll );
				if( vr$10 == 273ll ) goto label$182;
				{
					ERRREPORT( 245ll, 0ll, (uint8*)0ull );
					HSKIPUNTIL( -1ll, 0ll, 0ll, 0ll );
					goto label$155;
		...
		if( (TMP$105$2 - 273ull) > 8ull ) goto label$185;
		goto *tmp$106[TMP$105$2 - 273ull];
		label$156:;
	}
	ASTSCOPEBREAK( LABEL$1 );
	label$155:;
...
int64 CCOMPSTMTCHECK( void )
{
	...
	label$201:;
	{
		...
		label$211:;
		{
			{
				uint64 TMP$109$4;
				TMP$109$4 = *(uint64*)((uint8*)STK$1 + 24ll);
				goto label$213;
				label$214:;
				{
					ERRMSG$1 = 125ll;
				...
				if( (TMP$109$4 - 345ull) > 5ull ) goto label$212;
				goto *tmp$110[TMP$109$4 - 345ull];
				label$212:;
			}
		}
		goto label$203;
		...
		goto label$203;
		label$204:;
		static const void* tmp$111[81ll] = {
			&&label$205,
			&&label$203,
			&&label$203,
			&&label$203,
		...
		if( (TMP$108$2 - 266ull) > 80ull ) goto label$203;
		goto *tmp$111[TMP$108$2 - 266ull];
		label$203:;
	}
	...
	*(struct $7ASTNODE**)((uint8*)STK$1 + 16ll) = (struct $7ASTNODE*)0ull;
	{
		...
		goto label$225;
		label$226:;
		static const void* tmp$113[77ll] = {
			&&label$229,
			&&label$225,
			&&label$225,
			&&label$230,
		...
		if( (TMP$112$2 - 270ull) > 76ull ) goto label$225;
		goto *tmp$113[TMP$112$2 - 270ull];
		label$225:;
	}
		...
		if( SHOWERROR$1 == 0ll ) goto label$240;
		{
			...
			label$242:;
			{
				static int64 ERRMSG$4;
				{
					...
					goto label$243;
					label$244:;
					static const void* tmp$115[81ll] = {
						&&label$248,
						&&label$243,
						&&label$243,
						&&label$243,
					...
					if( (TMP$114$5 - 266ull) > 80ull ) goto label$243;
					goto *tmp$115[TMP$114$5 - 266ull];
					label$243:;
				}
				ERRREPORT( ERRMSG$4, 0ll, (uint8*)0ull );
			}
...
void CCOMPSTMTPOP( struct $13FB_CMPSTMTSTK* STK$1 )
{
	label$255:;
	{
		...
		goto label$257;
		label$258:;
		static const void* tmp$117[77ll] = {
			&&label$261,
			&&label$257,
			&&label$257,
			&&label$262,
		...
		if( (TMP$116$2 - 270ull) > 76ull ) goto label$257;
		goto *tmp$117[TMP$116$2 - 270ull];
		label$257:;
	}
...
int64 CCOMPSTMTISALLOWED( $15FB_CMPSTMT_MASK ALLOWMASK$1 )
{
	...
	label$272:;
	label$271:;
	if( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) == *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1232ll) ) goto label$274;
	{
		ERRMSG$1 = 61ll;
	}
	goto label$273;
	label$274:;
	{
		if( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 197024ll) != (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 196704ll) ) goto label$276;
		{
...
static int64 HCHECKFORCTORRESULT( void )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$68:;
	if( (*(int64*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 208ll) + 96ll) & 1ll) == 0ll ) goto label$71;
	{
		int64 vr$4 = SYMBHASCTOR( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) );
		if( (vr$4 & (int64)-((*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 16ll) & 2048ll) == 0ll)) == 0ll ) goto label$73;
		{
			fb$result$1 = 180ll;
			goto label$69;
		}
...
static void CCOMPOUNDEND( void )
{
	label$186:;
	{
		...
		goto label$188;
		label$189:;
		static const void* tmp$118[85ll] = {
			&&label$190,
			&&label$198,
			&&label$197,
			&&label$198,
		...
		if( (TMP$107$2 - 266ull) > 84ull ) goto label$198;
		goto *tmp$118[TMP$107$2 - 266ull];
		label$188:;
	}
	label$187:;
}
