...
struct $7ASTNODE* RTLINITAPP( struct $7ASTNODE* ARGC$1, struct $7ASTNODE* ARGV$1 )
{
	...
	{
		{
			$13FB_COMPTARGET TMP$181$3;
			TMP$181$3 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 216ll);
			if( TMP$181$3 == 0ll ) goto label$38;
			label$39:;
			if( TMP$181$3 != 1ll ) goto label$37;
			label$38:;
			{
				if( *(int64*)((uint8*)&ENV$ + 360ll) == 0ll ) goto label$41;
				{
		...
		{
			struct $8FBSYMBOL* vr$2 = RTLPROCLOOKUP( (uint8*)"fb___main", 141ll );
	...
	label$35:;
	label$34:;
	struct $8FBSYMBOL* vr$4 = RTLPROCLOOKUP( (uint8*)"fb_Init", 139ll );
	...
	{
		struct $8FBSYMBOL* vr$8 = RTLPROCLOOKUP( (uint8*)"fb_InitSignals", 140ll );
...
int64 RTLEXITAPP( struct $7ASTNODE* ERRLEVEL$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	fb$result$1 = 0ll;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_End", 142ll );
...
struct $7ASTNODE* RTLATEXIT( struct $7ASTNODE* PROCEXPR$1 )
{
	...
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_atexit", 143ll );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$2;
...
static int64 RTLX86CPUCHECK( void )
{
	...
	struct $8FBSYMBOL* vr$6 = RTLPROCLOOKUP( (uint8*)"fb_CpuDetect", 138ll );
	...
	FBSTRING* vr$17 = fb_StrConcat( &TMP$177$1, (void*)"This program requires at least a ", 34ll, (void*)&FAMILYSTR$1, -1ll );
	__builtin_memset( &TMP$178$1, 0, 24ll );
	FBSTRING* vr$20 = fb_StrConcat( &TMP$178$1, (void*)vr$17, -1ll, (void*)" to run.", 9ll );
	fb_StrAssign( (void*)&TMP$179$1, -1ll, (void*)vr$20, -1ll, 0 );
	struct $8FBSYMBOL* vr$22 = SYMBALLOCSTRCONST( (uint8*)*(uint8**)&TMP$179$1, -1ll );
	S$1 = vr$22;
	...
	struct $8FBSYMBOL* vr$26 = RTLPROCLOOKUP( (uint8*)"fb_End", 142ll );
	...
	{
		struct $8FBSYMBOL* vr$32 = RTLPROCLOOKUP( (uint8*)"fb_CpuDetect", 138ll );
		...
		struct $8FBSYMBOL* vr$42 = RTLPROCLOOKUP( (uint8*)"fb_End", 142ll );
...
static int64 HTHREADCALL_CB( struct $8FBSYMBOL* SYM$1 )
{
	...
	label$59:;
	label$58:;
	int64 vr$1 = HMULTITHREAD_CB( SYM$1 );
	fb$result$1 = vr$1;
	goto label$57;
	label$57:;
	return fb$result$1;
