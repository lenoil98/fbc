...
struct $7ASTNODE* CEXPRESSIONWITHNIDXARRAY( int64 ALLOW_NIDXARRAY$1 )
{
	...
	OLDCHECKARRAY$1 = (int64)-((*(int64*)((uint8*)&PARSER$ + 296ll) & 2ll) != 0ll);
	...
	{
		{
			...
			goto label$29;
			label$30:;
			static const void* tmp$96[2ll] = {
				&&label$31,
				&&label$32,
			};
			if( (TMP$95$3 - 290ull) > 1ull ) goto label$33;
			goto *tmp$96[TMP$95$3 - 290ull];
			label$29:;
		}
	...
	{
		{
			...
			if( (TMP$97$3 - 292ull) > 2ull ) goto label$52;
			goto *tmp$98[TMP$97$3 - 292ull];
			label$47:;
		}
		int64 vr$3 = LEXGETLOOKAHEAD( 1ll, 0ll );
		int64 vr$4 = HISASSIGNTOKEN( vr$3 );
	...
	{
		{
			uint64 TMP$99$3;
			int64 vr$2 = LEXGETTOKEN( 0ll );
			TMP$99$3 = (uint64)vr$2;
			goto label$97;
			label$98:;
			{
				*(int64*)((uint8*)&PARSER$ + 320ll) = (int64)-(*(int64*)((uint8*)&PARSER$ + 288ll) == 0ll);
				if( (*(int64*)((uint8*)&PARSER$ + 296ll) & 256ll) == 0ll ) goto label$100;
				{
					goto label$94;
				}
				label$100:;
			...
			label$101:;
			{
				if( (*(int64*)((uint8*)&PARSER$ + 296ll) & 512ll) == 0ll ) goto label$103;
				{
					goto label$94;
				}
				label$103:;
			...
			if( (TMP$99$3 - 299ull) > 5ull ) goto label$108;
			goto *tmp$100[TMP$99$3 - 299ull];
			label$96:;
		}
		LEXSKIPTOKEN( 0ll );
...
struct $7ASTNODE* CISEXPRESSION( void )
{
	...
	TMP$102$1 = 0ll;
	TMP$101$1 = 0ll;
	int64 vr$14 = CSYMBOLTYPE( &DTYPE$1, &SUBTYPE$1, &TMP$101$1, &TMP$102$1, 1ll );
	...
	label$125:;
	struct $7ASTNODE* EXPR$1;
	struct $7ASTNODE* vr$25 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)*(struct $12FB_STRUCTEXT**)((uint8*)SUBTYPE$1 + 240ll) + 296ll), 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	EXPR$1 = vr$25;
	...
	{
		{
			...
			int64 vr$2 = LEXGETTOKEN( 0ll );
			TMP$103$3 = vr$2;
			if( TMP$103$3 != 43ll ) goto label$155;
			label$156:;
			{
				OP$1 = 28ll;
			}
			goto label$154;
			label$155:;
			if( TMP$103$3 != 45ll ) goto label$157;
			label$158:;
			{
				OP$1 = 29ll;
			}
	...
	{
		{
			...
			int64 vr$2 = LEXGETTOKEN( 0ll );
			TMP$104$3 = vr$2;
			if( TMP$104$3 != 297ll ) goto label$174;
			label$175:;
			{
				OP$1 = 41ll;
			}
			goto label$173;
			label$174:;
			if( TMP$104$3 != 298ll ) goto label$176;
			label$177:;
			{
				OP$1 = 42ll;
			}
	...
	{
		{
			...
			int64 vr$2 = LEXGETTOKEN( 0ll );
			TMP$105$3 = vr$2;
			if( TMP$105$3 != 42ll ) goto label$223;
			label$224:;
			{
				OP$1 = 30ll;
			}
			goto label$222;
			label$223:;
			if( TMP$105$3 != 47ll ) goto label$225;
			label$226:;
			{
				OP$1 = 31ll;
			}
