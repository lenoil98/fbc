...
struct $7ASTNODE* _Z19ASTBUILDVARDTORCALLP8FBSYMBOLu7INTEGER( struct $8FBSYMBOL* S$1, int64 CHECK_ACCESS$1 )
{
	...
	label$38:;
	{
		{
			int64 TMP$94$3;
			TMP$94$3 = *(int64*)((uint8*)S$1 + 56ll) & 511ll;
			if( TMP$94$3 != 17ll ) goto label$40;
			label$41:;
			{
			...
			goto label$39;
			label$40:;
			if( TMP$94$3 != 39ll ) goto label$42;
			label$43:;
			{
			...
			label$42:;
			{
				...
				if( vr$13 == 0ll ) goto label$46;
				{
					...
					{
						struct $8FBSYMBOL* vr$15 = SYMBGETCOMPDTOR( *(struct $8FBSYMBOL**)((uint8*)S$1 + 64ll) );
...
struct $7ASTNODE* ASTBUILDDTORCALL( struct $8FBSYMBOL* SYM$1, struct $7ASTNODE* THISEXPR$1, int64 IGNORE_VIRTUAL$1 )
{
	...
	struct $8FBSYMBOL* vr$1 = SYMBGETCOMPDTOR( SYM$1 );
	DTOR$1 = vr$1;
...
struct $7ASTNODE* ASTBUILDIMPLICITCTORCALL( struct $8FBSYMBOL* SUBTYPE$1, struct $7ASTNODE* EXPR$1, $12FB_PARAMMODE ARG_MODE$1, int64* IS_CTORCALL$1 )
{
	...
	struct $8FBSYMBOL* vr$2 = SYMBFINDCTOROVLPROC( SUBTYPE$1, EXPR$1, ARG_MODE$1, ($9FB_ERRMSG*)&ERR_NUM$1 );
	PROC$1 = vr$2;
	...
	if( CNT$1 <= 0ll ) goto label$148;
	{
		...
		label$150:;
		{
			DTYPE$1 = (((DTYPE$1 & 31ll) | ((DTYPE$1 & 480ll) + -32ll)) | (((DTYPE$1 & 261632ll) >> (1ll & 63ll)) & 261632ll)) | (DTYPE$1 & 32505856ll);
			{
				...
				label$166:;
				TMP$96$4 = TMP$95$4;
				if( TMP$96$4 == 0ll ) goto label$160;
				label$161:;
				if( TMP$96$4 != 23ll ) goto label$159;
				label$160:;
				{
				...
				goto label$158;
				label$159:;
				if( TMP$96$4 != 22ll ) goto label$162;
				label$163:;
				{
...
struct $7ASTNODE* ASTBUILDARRAYDESCINITREE( struct $8FBSYMBOL* DESC$1, struct $8FBSYMBOL* ARRAY$1, struct $7ASTNODE* ARRAY_EXPR$1 )
{
	...
	goto label$187;
	label$175:;
	TMP$97$1 = *(int64*)((uint8*)ARRAY$1 + 120ll);
	label$187:;
	struct $7ASTNODE* vr$36 = ASTNEWCONSTI( TMP$97$1, 8ll, (struct $8FBSYMBOL*)0ull );
	...
	ASTTYPEINIADDASSIGN( TREE$1, vr$38, ELM$1, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	ELM$1 = *(struct $8FBSYMBOL**)((uint8*)ELM$1 + 312ll);
	ASTTYPEINIADDASSIGN( TREE$1, ARRAY_EXPR$1, ELM$1, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	ELM$1 = *(struct $8FBSYMBOL**)((uint8*)ELM$1 + 312ll);
	...
	TMP$98$1 = vr$43;
	label$188:;
	struct $7ASTNODE* vr$44 = ASTNEWCONSTI( TMP$98$1, 8ll, (struct $8FBSYMBOL*)0ull );
	ASTTYPEINIADDASSIGN( TREE$1, vr$44, ELM$1, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	ELM$1 = *(struct $8FBSYMBOL**)((uint8*)ELM$1 + 312ll);
	struct $7ASTNODE* vr$47 = ASTNEWCONSTI( *(int64*)((uint8*)ARRAY$1 + 80ll), 8ll, (struct $8FBSYMBOL*)0ull );
	ASTTYPEINIADDASSIGN( TREE$1, vr$47, ELM$1, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	ELM$1 = *(struct $8FBSYMBOL**)((uint8*)ELM$1 + 312ll);
	...
	ASTTYPEINIADDASSIGN( TREE$1, vr$51, ELM$1, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	ELM$1 = *(struct $8FBSYMBOL**)((uint8*)ELM$1 + 312ll);
	FLAGS$1 = FLAGS$1 | (MAX_DIMENSIONS$1 & 15ll);
	struct $7ASTNODE* vr$55 = ASTNEWCONSTI( FLAGS$1, 8ll, (struct $8FBSYMBOL*)0ull );
	ASTTYPEINIADDASSIGN( TREE$1, vr$55, ELM$1, 2147483648ll, (struct $8FBSYMBOL*)0ull );
	ELM$1 = *(struct $8FBSYMBOL**)((uint8*)ELM$1 + 312ll);
	...
	{
		{
			...
			I$3 = 0ll;
			int64 TMP$99$3;
			TMP$99$3 = *(int64*)((uint8*)ARRAY$1 + 104ll) + -1ll;
			goto label$181;
			label$184:;
			{
				ELM$1 = DIMTB$1;
				...
				ASTTYPEINIADDASSIGN( TREE$1, vr$71, ELM$1, 2147483648ll, (struct $8FBSYMBOL*)0ull );
				ELM$1 = *(struct $8FBSYMBOL**)((uint8*)ELM$1 + 312ll);
				...
				ASTTYPEINIADDASSIGN( TREE$1, vr$76, ELM$1, 2147483648ll, (struct $8FBSYMBOL*)0ull );
				ELM$1 = *(struct $8FBSYMBOL**)((uint8*)ELM$1 + 312ll);
				...
				ASTTYPEINIADDASSIGN( TREE$1, vr$81, ELM$1, 2147483648ll, (struct $8FBSYMBOL*)0ull );
				ASTTYPEINISCOPEEND( TREE$1, DIMTBFIELD$1 );
			}
			label$182:;
			I$3 = I$3 + 1ll;
			label$181:;
			if( I$3 <= TMP$99$3 ) goto label$184;
			label$183:;
		}
	}
	goto label$179;
...
struct $7ASTNODE* ASTBUILDARRAYBOUND( struct $7ASTNODE* ARRAYEXPR$1, struct $7ASTNODE* DIMEXPR$1, int64 TK$1 )
{
	...
	DIMEXPR$1 = vr$1;
	ERRPOPPARAMLOCATION(  );
	struct $7ASTNODE* vr$3 = HCONSTBOUND( ARRAYEXPR$1, DIMEXPR$1, (int64)-(TK$1 == 493ll) );
	EXPR$1 = vr$3;
	if( EXPR$1 != (struct $7ASTNODE*)0ull ) goto label$215;
	{
		struct $7ASTNODE* vr$5 = RTLARRAYBOUND( ARRAYEXPR$1, DIMEXPR$1, (int64)-(TK$1 == 493ll) );
		EXPR$1 = vr$5;
	}
	label$215:;
	label$214:;
...
static struct $7ASTNODE* HCONSTBOUND( struct $7ASTNODE* ARRAYEXPR$1, struct $7ASTNODE* DIMEXPR$1, int64 IS_LBOUND$1 )
{
	...
	fb$result$1 = (struct $7ASTNODE*)0ull;
	{
		...
		TMP$100$2 = *($13AST_NODECLASS*)ARRAYEXPR$1;
		if( TMP$100$2 == 17ll ) goto label$193;
		label$194:;
		if( TMP$100$2 != 19ll ) goto label$192;
		label$193:;
		{
		}
		goto label$191;
	...
	label$203:;
	{
		if( DIMENSION$1 != -1ll ) goto label$209;
		{
			...
			goto label$220;
			label$210:;
			TMP$101$3 = *(int64*)((uint8*)ARRAY$1 + 104ll);
			label$220:;
			BOUND$1 = TMP$101$3;
		}
		goto label$208;
