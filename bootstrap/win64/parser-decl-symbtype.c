...
int64 HISCONSTINRANGE( int64 DTYPE$1, int64 VALUE$1, int64 TODTYPE$1 )
{
	...
	static struct $8FBARRAY1I11RANGEVALUESE tmp$95$1 = { (struct $11RANGEVALUES*)RANGE$1, (struct $11RANGEVALUES*)RANGE$1, 216ll, 24ll, 1ll, 49ll, { { 9ll, 0ll, 8ll } } };
	struct $11RANGEVALUES* R$1;
	if( (TODTYPE$1 & 480ll) == 0ll ) goto label$18;
	TMP$96$1 = 24ll;
	goto label$36;
	label$18:;
	TMP$96$1 = TODTYPE$1 & 31ll;
	label$36:;
	R$1 = (struct $11RANGEVALUES*)((uint8*)RANGE$1 + (*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$96$1 * 56ll)) + 40ll) * 24ll));
	...
	label$37:;
	if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$97$1 * 56ll)) + 16ll) == 0ll ) goto label$21;
	{
		int64 TMP$98$2;
		...
		goto label$38;
		label$22:;
		TMP$98$2 = TODTYPE$1 & 31ll;
		label$38:;
		if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$98$2 * 56ll)) + 16ll) == 0ll ) goto label$24;
		{
		...
		label$24:;
		{
			...
			goto label$40;
			label$26:;
			TMP$100$3 = TODTYPE$1 & 31ll;
			label$40:;
			if( ((int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$99$3 * 56ll)) + 40ll) == 7ll) & (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$100$3 * 56ll)) + 40ll) == 8ll)) == 0ll ) goto label$28;
			{
	...
	label$21:;
	{
		...
		goto label$41;
		label$29:;
		TMP$101$2 = TODTYPE$1 & 31ll;
		label$41:;
		if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$101$2 * 56ll)) + 16ll) == 0ll ) goto label$31;
		{
			int64 TMP$102$3;
			int64 TMP$103$3;
			...
			goto label$42;
			label$32:;
			TMP$102$3 = DTYPE$1 & 31ll;
			label$42:;
			if( (TODTYPE$1 & 480ll) == 0ll ) goto label$33;
			TMP$103$3 = 24ll;
			goto label$43;
			label$33:;
			TMP$103$3 = TODTYPE$1 & 31ll;
			label$43:;
			if( ((int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$102$3 * 56ll)) + 40ll) == 8ll) & (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$103$3 * 56ll)) + 40ll) == 7ll)) == 0ll ) goto label$35;
			{
...
struct $7ASTNODE* CTYPEOREXPRESSION( int64 TK$1, int64* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1, int64* LGT$1, int64* IS_FIXLENSTR$1 )
{
	...
	if( ((int64)-(vr$2 == 265ll) & (int64)-(vr$4 == 41ll)) == 0ll ) goto label$99;
	{
		...
		CHAIN_$2 = *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8520ll) + 2088ll);
	...
	*IS_FIXLENSTR$1 = 0ll;
	...
	label$189:;
	{
		...
		ISUNSIGNED$1 = vr$9;
		{
			...
			if( (TMP$128$3 - 345ull) > 27ull ) goto label$196;
		...
		{
			{
				...
				if( TMP$129$4 == 4ll ) goto label$230;
				label$231:;
				if( TMP$129$4 != 7ll ) goto label$229;
				label$230:;
				{
					*LGT$1 = 0ll;
				}
				...
				label$229:;
				{
					...
					label$340:;
					*LGT$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$130$5 * 56ll)) + 8ll);
				}
				label$232:;
				label$228:;
			}
		...
		label$227:;
		{
			...
			if( CHECK_ID$3 == 0ll ) goto label$239;
			{
				...
				TMP$131$4 = 50ll;
				label$341:;
				struct $10FBSYMCHAIN* vr$66 = CIDENTIFIER( &BASE_PARENT$3, TMP$131$4 );
				CHAIN_$3 = vr$66;
			}
			label$239:;
			label$238:;
				...
				{
					{
						...
						if( TMP$132$6 == 2ll ) goto label$247;
						label$248:;
						if( TMP$132$6 == 1ll ) goto label$247;
						label$249:;
						if( TMP$132$6 != 12ll ) goto label$246;
						label$247:;
						{
					...
					{
						{
							...
							if( TMP$133$7 != 10ll ) goto label$257;
							label$258:;
							{
								LEXSKIPTOKEN( 2048ll );
								*DTYPE$1 = 20ll;
							...
							goto label$256;
							label$257:;
							if( TMP$133$7 != 9ll ) goto label$259;
							label$260:;
							{
								LEXSKIPTOKEN( 2048ll );
								*DTYPE$1 = 10ll;
							...
							goto label$256;
							label$259:;
							if( TMP$133$7 != 13ll ) goto label$261;
							label$262:;
							{
								LEXSKIPTOKEN( 2048ll );
		...
		{
			{
				...
				if( (TMP$135$4 - 2ull) > 11ull ) goto label$285;
		...
		*IS_FIXLENSTR$1 = -1ll;
		{
			...
			label$294:;
			{
				...
				label$344:;
				if( TMP$138$4 != 7ll ) goto label$299;
				{
			...
			if( (TMP$137$3 - 4ull) > 13ull ) goto label$300;
		...
		{
			{
				...
				label$312:;
				{
					LEXSKIPTOKEN( 2048ll );
					{
						...
						TMP$140$6 = vr$143;
						if( TMP$140$6 == 373ll ) goto label$315;
						label$316:;
						if( TMP$140$6 != 374ll ) goto label$314;
						label$315:;
						{
				...
				if( (TMP$139$4 - 335ull) > 39ull ) goto label$323;
	...
	if( PTR_CNT$1 <= 0ll ) goto label$325;
	{
		...
		label$345:;
		*LGT$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$141$2 * 56ll)) + 8ll);
	}
	goto label$324;
	label$325:;
	{
		...
		label$346:;
		if( TMP$142$2 != 23ll ) goto label$329;
		{
		...
		{
			{
				...
				if( TMP$143$4 == 4ll ) goto label$335;
				label$336:;
				if( TMP$143$4 != 7ll ) goto label$334;
				label$335:;
				{
					int64 TMP$144$5;
					...
					label$347:;
					*LGT$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$144$5 * 56ll)) + 8ll);
				}
				label$334:;
				label$333:;
			}
		...
		{
			{
				...
				goto label$151;
				label$168:;
				int32 vr$33 = fb_StrCompare( (void*)&TMP$119$4, -1ll, (void*)"__builtin_va_list", 18ll );
				if( (int64)vr$33 == 0ll ) goto label$175;
				label$176:;
				int32 vr$36 = fb_StrCompare( (void*)&TMP$119$4, -1ll, (void*)"__builtin_va_list[]", 20ll );
				...
				{
					{
						int64 TMP$127$6;
						TMP$127$6 = *DTYPE$1;
						if( TMP$127$6 != 0ll ) goto label$178;
						label$179:;
						{
						...
						goto label$177;
						label$178:;
						if( TMP$127$6 != 20ll ) goto label$180;
						label$181:;
						{
							*DTYPE$1 = (*DTYPE$1 & -32505857ll) | 19922944ll;
				...
				goto label$151;
				label$174:;
				int32 vr$58 = fb_StrCompare( (void*)&TMP$119$4, -1ll, (void*)"", 1ll );
