...
void CSELECTSTMTBEGIN( void )
{
	...
	label$29:;
	{
		int64 TMP$97$2;
		{
			...
			label$47:;
			TMP$96$3 = TMP$95$3;
			if( TMP$96$3 == 18ll ) goto label$33;
			label$34:;
			if( TMP$96$3 != 4ll ) goto label$32;
			label$33:;
			{
				DTYPE$1 = 17ll;
			}
		...
		OPTIONS$1 = 0ll;
		if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 2ll) != 0ll ) goto label$36;
		{
		...
		if( TMP$97$2 == 7ll ) goto label$39;
		{
			...
			label$49:;
			if( TMP$98$3 == 17ll ) goto label$42;
			{
...
void CSELECTSTMTNEXT( void )
{
	...
	*(int64*)&CTX$ = *(int64*)&CTX$ + CNT$1;
	...
	IL$1 = vr$26;
	{
		...
		I$1 = I$1 + 1ll;
		label$96:;
		if( I$1 <= TMP$102$2 ) goto label$99;
		label$98:;
	}
	*(int64*)&CTX$ = *(int64*)&CTX$ - CNT$1;
...
static void HCASEEXPRESSION( struct $9FBCASECTX* CASECTX$1, struct $8FBSYMBOL* SYM$1 )
{
	...
	*(struct $7ASTNODE**)((uint8*)CASECTX$1 + 16ll) = vr$7;
	if( *(struct $7ASTNODE**)((uint8*)CASECTX$1 + 16ll) != (struct $7ASTNODE*)0ull ) goto label$55;
	{
		...
		goto label$120;
		label$56:;
		TMP$99$2 = *(int64*)((uint8*)SYM$1 + 56ll) & 511ll;
		label$120:;
		struct $7ASTNODE* vr$14 = ASTNEWCONSTZ( TMP$99$2, (struct $8FBSYMBOL*)0ull );
