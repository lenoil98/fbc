...
FBSTRING* HREPLACE( uint8* ORGTEXT$1, uint8* OLDTEXT$1, uint8* NEWTEXT$1 )
{
	...
	label$112:;
	{
		...
		FBSTRING* vr$12 = fb_StrConcat( &TMP$84$2, (void*)&TEXT$1, -1ll, (void*)NEWTEXT$1, 0ll );
...
uint8* HREPLACECHAR( uint8* ORGTEXT$1, int64 OLDCHAR$1, int64 NEWCHAR$1 )
{
	...
	label$124:;
	{
		...
		I$2 = I$2 + 1ll;
		label$126:;
		if( I$2 <= TMP$87$2 ) goto label$129;
		label$128:;
	}
			...
			SRC$1 = (uint8*)((uint8*)SRC$1 + 1ll);
			{
				...
				label$154:;
				{
					...
					label$159:;
					{
						...
						if( (TMP$88$6 - 66ull) > 45ull ) goto label$161;
						goto *tmp$89[TMP$88$6 - 66ull];
						label$161:;
					}
				}
				goto label$142;
			...
			*DST$1 = (uint16)(uint16)27u;
			...
			SRC$1 = (uint16*)((uint8*)SRC$1 + 2ll);
			{
				...
				label$245:;
				{
					...
					label$250:;
					{
						...
						if( (TMP$90$6 - 66ull) > 45ull ) goto label$252;
						goto *tmp$92[TMP$90$6 - 66ull];
						label$252:;
					}
				}
				goto label$233;
			...
			if( ISNUMBER$1 == 0ll ) goto label$306;
			{
				...
				*DST$1 = (uint16)(uint16)LGT$1;
				...
				TMP$91$4 = vr$85;
				fb_WstrAssign( DST$1, 0ll, (uint16*)TMP$91$4 );
				fb_WstrDelete( (uint16*)TMP$91$4 );
	...
	if( LGT$1 <= 0ll ) goto label$354;
	{
		if( (int64)*TEXT$1 != 92ll ) goto label$356;
		{
			...
			CHAR$1 = (uint64)*TEXT$1;
			{
				...
				if( (TMP$102$4 - 34ull) > 84ull ) goto label$357;
	...
	if( LGT$1 <= 0ll ) goto label$363;
	{
		if( (int64)*TEXT$1 != 92ll ) goto label$365;
		{
			...
			CHAR$1 = (uint64)*TEXT$1;
			{
				...
				goto label$366;
				label$367:;
				static const void* tmp$105[85ll] = {
					&&label$368,
					&&label$366,
					&&label$366,
					&&label$366,
				...
				if( (TMP$104$4 - 34ull) > 84ull ) goto label$366;
				goto *tmp$105[TMP$104$4 - 34ull];
				label$366:;
			}
		}
		label$365:;
...
uint8* HESCAPEW( uint16* TEXT$1 )
{
	...
	if( SRC$1 >= SRC_END$1 ) goto label$384;
	{
		...
		label$385:;
		{
			...
			I$1 = I$1 + 1ll;
			label$399:;
			if( I$1 <= TMP$107$3 ) goto label$402;
			label$401:;
		}
	}
	goto label$383;
...
uint16* HUNESCAPEW( uint16* TEXT$1 )
{
	uint16* fb$result$1;
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$420:;
...
int64 HSTR2TOK( uint8* TXT$1, struct $7FBARRAYI8FBSTRINGE* RES$1 )
{
	...
	if( (int64)*S$1 == 0ll ) goto label$475;
	{
		...
		label$479:;
		{
			...
			FBSTRING* vr$28 = fb_StrConcat( &TMP$113$3, (void*)((T$1 * 24ll) + *(int64*)RES$1), -1ll, (void*)vr$21, -1ll );
...
static int64 HREMAPCHAR( int64 CHAR$1 )
{
	...
	label$339:;
	{
		...
		goto label$341;
		label$342:;
		static const void* tmp$115[22ll] = {
			&&label$347,
			&&label$346,
			&&label$350,
			&&label$350,
		...
		if( (TMP$93$2 - 97ull) > 21ull ) goto label$350;
		goto *tmp$115[TMP$93$2 - 97ull];
		label$341:;
	}
	label$340:;
	return fb$result$1;
