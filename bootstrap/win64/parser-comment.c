...
int64 CCOMMENT( $8LEXCHECK LEXFLAGS$1 )
{
	...
	label$10:;
	{
		...
		TMP$94$2 = vr$1;
		if( TMP$94$2 == 259ll ) goto label$14;
		label$15:;
		if( TMP$94$2 != 260ll ) goto label$13;
		label$14:;
		{
			...
			if( vr$2 != 260ll ) goto label$17;
			{
				...
				{
					if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8520ll) + 2104ll) == 0ll ) goto label$21;
					{
						fb$result$1 = 0ll;
						goto label$11;
					}
...
static void CDIRECTIVE( void )
{
	...
	static int64 ISONCE$1;
	{
		...
		label$29:;
		{
			if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 16777216ll) != 0ll ) goto label$31;
			{
			...
			label$31:;
			{
				...
				*(int64*)((uint8*)&ENV$ + 1360ll) = -1ll;
				if( *(int64*)((uint8*)&ENV$ + 1144ll) <= 0ll ) goto label$33;
				{
					FBSTRING TMP$97$5;
					__builtin_memset( &TMP$97$5, 0, 24ll );
					fb_StrAssign( (void*)&TMP$97$5, -1ll, (void*)"'$dynamic", 10ll, 0 );
		...
		label$34:;
		{
			if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 16777216ll) != 0ll ) goto label$36;
			{
				ERRREPORTNOTALLOWED( 16777216ll, 146ll, (uint8*)0ull );
			}
			goto label$35;
			label$36:;
			{
				...
				*(int64*)((uint8*)&ENV$ + 1360ll) = 0ll;
				if( *(int64*)((uint8*)&ENV$ + 1144ll) <= 0ll ) goto label$38;
				{
					FBSTRING TMP$99$5;
					__builtin_memset( &TMP$99$5, 0, 24ll );
					fb_StrAssign( (void*)&TMP$99$5, -1ll, (void*)"'$static", 9ll, 0 );
		...
		label$39:;
		{
			if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 16777216ll) != 0ll ) goto label$41;
			{
				ERRREPORTNOTALLOWED( 16777216ll, 146ll, (uint8*)0ull );
			}
			goto label$40;
		...
		{
			{
				...
				TMP$101$4 = vr$17;
				if( TMP$101$4 == 1ll ) goto label$53;
				label$54:;
				if( TMP$101$4 != 2ll ) goto label$52;
				label$53:;
				{
					if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 16777216ll) == 0ll ) goto label$56;
					{
						ERRREPORT( 17ll, 0ll, (uint8*)0ull );
					}
					label$56:;
					...
					if( vr$19 == 0ll ) goto label$59;
					{
						...
						if( vr$21 != 4ll ) goto label$63;
						{
							...
							label$65:;
							{
								...
								if( *(int64*)((uint8*)&ENV$ + 1144ll) <= 0ll ) goto label$67;
								{
									FBSTRING TMP$105$9;
									FBSTRING TMP$106$9;
									FBSTRING TMP$107$9;
									...
									FBSTRING* vr$27 = fb_StrConcat( &TMP$105$9, (void*)"'$lang: \x22", 10ll, (void*)vr$24, -1ll );
									__builtin_memset( &TMP$106$9, 0, 24ll );
									FBSTRING* vr$30 = fb_StrConcat( &TMP$106$9, (void*)vr$27, -1ll, (void*)"\x22", 2ll );
									fb_StrAssign( (void*)&TMP$107$9, -1ll, (void*)vr$30, -1ll, 0 );
									LEXPPONLYEMITTEXT( &TMP$107$9 );
									fb_StrDelete( (FBSTRING*)&TMP$107$9 );
								}
								label$67:;
								label$66:;
							}
		...
		goto label$27;
		label$28:;
		static const void* tmp$109[11ll] = {
			&&label$34,
			&&label$50,
			&&label$50,
			&&label$50,
		...
		if( (TMP$95$2 - 307ull) > 10ull ) goto label$50;
		goto *tmp$109[TMP$95$2 - 307ull];
		label$27:;
	}
	label$68:;
	{
		{
			...
			TMP$108$3 = vr$34;
			if( TMP$108$3 == 257ll ) goto label$73;
			label$74:;
			if( TMP$108$3 != 256ll ) goto label$72;
			label$73:;
			{
				goto label$69;
			}
