...
void DZSTRASSIGNW( struct $8DZSTRING* DST$1, uint16* SRC$1 )
{
	...
	int64 vr$0 = fb_WstrLen( (uint16*)SRC$1 );
	TMP$85$1 = vr$0;
	goto label$47;
	label$38:;
	TMP$85$1 = 0ll;
...
void DZSTRCONCATASSIGNW( struct $8DZSTRING* DST$1, uint16* SRC$1 )
{
	...
	{
		fb_WstrAssignToA( (void*)((uint8*)*(uint8**)DST$1 + DST_LEN$1), 0ll, (uint16*)SRC$1, 0 );
	}
	label$72:;
	label$71:;
	label$67:;
...
void DWSTRASSIGN( struct $8DWSTRING* DST$1, uint16* SRC$1 )
{
	...
	{
		fb_WstrAssign( *(uint16**)DST$1, 0ll, (uint16*)SRC$1 );
	}
	label$104:;
	label$103:;
	label$95:;
...
void DWSTRCONCATASSIGN( struct $8DWSTRING* DST$1, uint16* SRC$1 )
{
	...
	{
		fb_WstrAssign( (uint16*)((uint8*)*(uint16**)DST$1 + (DST_LEN$1 << (1ll & 63ll))), 0ll, (uint16*)SRC$1 );
	}
	label$134:;
	label$133:;
	label$129:;
