...
void CASMCODE( void )
{
	...
	label$26:;
	{
		...
		THISTOK$1 = vr$0;
		{
			...
			goto label$29;
			label$30:;
			static const void* tmp$705[85ll] = {
				&&label$31,
				&&label$31,
				&&label$29,
				&&label$31,
			...
			if( (TMP$696$3 - 256ull) > 84ull ) goto label$29;
			goto *tmp$705[TMP$696$3 - 256ull];
			label$29:;
		}
		...
		DOSKIP$1 = 0ll;
		{
			...
			label$34:;
			{
				...
				fb_StrAssign( (void*)&TMP$698$4, -1ll, (void*)vr$8, -1ll, 0 );
				int64 vr$10 = HISASMKEYWORD( (uint8*)*(uint8**)&TMP$698$4 );
				TMP$699$4 = (int64)-(vr$10 == 0ll);
				fb_StrDelete( (FBSTRING*)&TMP$698$4 );
				if( TMP$699$4 == 0ll ) goto label$41;
				{
					...
					if( CHAIN_$1 == (struct $10FBSYMCHAIN*)0ull ) goto label$43;
					{
						...
						{
							{
								$12FB_SYMBCLASS TMP$700$8;
								TMP$700$8 = *($12FB_SYMBCLASS*)S$6;
								if( TMP$700$8 == 3ll ) goto label$49;
								label$50:;
								if( TMP$700$8 != 7ll ) goto label$48;
								label$49:;
								{
									SYM$1 = S$6;
									goto label$43;
								...
								goto label$47;
								label$48:;
								if( TMP$700$8 != 2ll ) goto label$51;
								label$52:;
								{
								...
								goto label$47;
								label$51:;
								if( TMP$700$8 != 1ll ) goto label$53;
								label$54:;
								{
			...
			label$60:;
			{
				...
				if( EXPR$1 == (struct $7ASTNODE*)0ull ) goto label$62;
				{
					...
					if( LITSYM$5 == (struct $8FBSYMBOL*)0ull ) goto label$64;
					{
						...
						{
							FBSTRING TMP$702$7;
							__builtin_memset( &TMP$702$7, 0, 24ll );
							FBSTRING* vr$33 = fb_StrConcat( &TMP$702$7, (void*)TEXT$1, 1025ll, *(void**)((uint8*)LITSYM$5 + 96ll), 0ll );
						...
						label$66:;
						{
							...
							TMP$703$7 = vr$35;
							fb_WstrAssignToA( (void*)TEXT$1, 1025ll, (uint16*)TMP$703$7, 0 );
							fb_WstrDelete( (uint16*)TMP$703$7 );
						}
						label$65:;
						__builtin_memset( &TMP$704$6, 0, 24ll );
						FBSTRING* vr$38 = fb_StrConcat( &TMP$704$6, (void*)TEXT$1, 1025ll, (void*)"\x22", 2ll );
			...
			if( TMP$697$3 > 4ull ) goto label$32;
			goto *tmp$706[TMP$697$3 - 0ull];
			label$32:;
		}
...
int64 CASMBLOCK( void )
{
	...
	if( vr$3 == 0ll ) goto label$94;
	{
		if( *(int64*)((uint8*)&ENV$ + 296ll) == 0ll ) goto label$96;
		{
			...
			{
				struct $7ASTNODE* vr$5 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 25056ll) );
				ASTADD( vr$5 );
	...
	label$103:;
	{
		...
		{
			struct $7ASTNODE* vr$11 = ASTNEWDBG( 113ll, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8552ll), *(uint8**)((uint8*)&ENV$ + 824ll) );
			ASTADD( vr$11 );
		}
		label$107:;
		label$106:;
		...
		if( *(int64*)((uint8*)&ENV$ + 296ll) == 0ll ) goto label$109;
		{
			...
			{
				struct $7ASTNODE* vr$13 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 25056ll) );
				ASTADD( vr$13 );
				DZSTRRESET( (struct $8DZSTRING*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 25056ll) );
			}
			label$111:;
		...
		label$108:;
		{
			...
			TMP$707$3 = vr$16;
			if( TMP$707$3 != 257ll ) goto label$113;
			label$114:;
			{
			...
			goto label$112;
			label$113:;
			if( TMP$707$3 != 256ll ) goto label$117;
			label$118:;
			{
				goto label$104;
			}
			goto label$112;
			label$117:;
			if( TMP$707$3 != 340ll ) goto label$119;
			label$120:;
			{
				goto label$104;
			}
