...
void RTLERRORTHROW( struct $7ASTNODE* ERREXPR$1, int64 LINENUM$1, uint8* MODULE$1 )
{
	...
	struct $8FBSYMBOL* NXTLABEL$1;
	struct $8FBSYMBOL* RESLABEL$1;
	struct $8FBSYMBOL* vr$0 = RTLPROCLOOKUP( (uint8*)"fb_ErrorThrowEx", 292ll );
...
void RTLERRORSETHANDLER( struct $7ASTNODE* NEWHANDLER$1, int64 SAVECURRENT$1 )
{
	...
	struct $8FBSYMBOL* vr$0 = RTLPROCLOOKUP( (uint8*)"fb_ErrorSetHandler", 293ll );
	struct $7ASTNODE* vr$1 = ASTNEWCALL( vr$0, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$1;
	...
	{
		if( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) == *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1232ll) ) goto label$49;
		{
			{
				struct $10FB_PROCERR* TMP$115$4;
				TMP$115$4 = (struct $10FB_PROCERR*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 208ll) + 56ll);
				if( *(struct $8FBSYMBOL**)TMP$115$4 != (struct $8FBSYMBOL*)0ull ) goto label$51;
				{
					struct $8FBSYMBOL* vr$7 = SYMBADDTEMPVAR( 32ll, (struct $8FBSYMBOL*)0ull );
					*(struct $8FBSYMBOL**)TMP$115$4 = vr$7;
					struct $7ASTNODE* vr$10 = ASTNEWVAR( *(struct $8FBSYMBOL**)TMP$115$4, 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
					EXPR$1 = vr$10;
...
struct $7ASTNODE* RTLERRORGETNUM( void )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$54:;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_ErrorGetNum", 294ll );
...
void RTLERRORSETNUM( struct $7ASTNODE* ERREXPR$1 )
{
	label$56:;
	struct $7ASTNODE* PROC$1;
	struct $8FBSYMBOL* vr$0 = RTLPROCLOOKUP( (uint8*)"fb_ErrorSetNum", 295ll );
	struct $7ASTNODE* vr$1 = ASTNEWCALL( vr$0, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$1;
...
void RTLERRORRESUME( int64 ISNEXT$1 )
{
	...
	{
		struct $8FBSYMBOL* vr$0 = RTLPROCLOOKUP( (uint8*)"fb_ErrorResume", 296ll );
		F$1 = vr$0;
	}
	goto label$62;
	label$63:;
	{
		struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_ErrorResumeNext", 297ll );
		F$1 = vr$1;
	}
	label$62:;
...
struct $7ASTNODE* RTLERRORSETMODNAME( struct $8FBSYMBOL* SYM$1, struct $7ASTNODE* MODNAME$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	struct $7ASTNODE* EXPR$1;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_ErrorSetModName", 298ll );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$2;
	...
	{
		{
			...
			*(struct $8FBSYMBOL**)((uint8*)TMP$116$3 + 8ll) = vr$7;
			struct $7ASTNODE* vr$10 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)TMP$116$3 + 8ll), 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
			EXPR$1 = vr$10;
			struct $7ASTNODE* vr$11 = ASTNEWASSIGN( EXPR$1, PROC$1, 0ll );
			fb$result$1 = vr$11;
		}
...
struct $7ASTNODE* RTLERRORSETFUNCNAME( struct $8FBSYMBOL* SYM$1, struct $7ASTNODE* FUNCNAME$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	struct $7ASTNODE* EXPR$1;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_ErrorSetFuncName", 299ll );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$2;
	...
	{
		{
			...
			struct $8FBSYMBOL* vr$7 = SYMBADDTEMPVAR( 36ll, (struct $8FBSYMBOL*)0ull );
			*(struct $8FBSYMBOL**)((uint8*)TMP$117$3 + 16ll) = vr$7;
			struct $7ASTNODE* vr$10 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)TMP$117$3 + 16ll), 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
			EXPR$1 = vr$10;
			struct $7ASTNODE* vr$11 = ASTNEWASSIGN( EXPR$1, PROC$1, 0ll );
			fb$result$1 = vr$11;
		}
...
static struct $7ASTNODE* HERRORTHROW( struct $8FBSYMBOL* RESLABEL$1, struct $8FBSYMBOL* NXTLABEL$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	struct $7ASTNODE* PARAM$1;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_ErrorThrowAt", 291ll );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$2;
	struct $7ASTNODE* vr$4 = ASTNEWCONSTI( *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8552ll), 8ll, (struct $8FBSYMBOL*)0ull );
	ASTNEWARG( PROC$1, vr$4, 2147483648ll, -1ll );
	struct $7ASTNODE* vr$6 = ASTNEWCONSTSTR( (uint8*)((uint8*)&ENV$ + 560ll) );
