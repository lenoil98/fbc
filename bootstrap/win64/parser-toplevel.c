...
void CPROGRAM( void )
{
	...
	label$26:;
	{
		...
		label$38:;
		label$37:;
		struct $7ASTNODE* vr$9 = ASTNEWDBG( 113ll, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8552ll), *(uint8**)((uint8*)&ENV$ + 824ll) );
		ASTADD( vr$9 );
		CLABEL(  );
		CSTATEMENT(  );
		CCOMMENT( 0ll );
		int64 vr$10 = FBSHOULDCONTINUE(  );
		...
		label$40:;
		label$39:;
		if( *(int64*)((uint8*)&ENV$ + 296ll) == 0ll ) goto label$42;
		{
			if( *(int64*)((uint8*)&ENV$ + 1224ll) != 0ll ) goto label$44;
			{
		...
		label$41:;
		{
			...
			TMP$94$3 = vr$11;
			if( TMP$94$3 != 257ll ) goto label$46;
			label$47:;
			{
				LEXSKIPTOKEN( 0ll );
			}
			goto label$45;
			label$46:;
			if( TMP$94$3 != 256ll ) goto label$48;
			label$49:;
			{
			}
			goto label$45;
		...
		int64 vr$12 = FBSHOULDCONTINUE(  );
		if( vr$12 != 0ll ) goto label$52;
		{
			goto label$25;
		}
		label$52:;
		label$51:;
		struct $7ASTNODE* vr$13 = ASTNEWDBG( 114ll, 0ll, (uint8*)0ull );
		ASTADD( vr$13 );
		*(int64*)((uint8*)&PARSER$ + 56ll) = *(int64*)((uint8*)&PARSER$ + 56ll) + 1ll;
	}
	label$28:;
	int64 vr$15 = LEXGETTOKEN( 0ll );
	if( vr$15 != 256ll ) goto label$26;
	label$27:;
	if( *(int64*)((uint8*)&PP$ + 384ll) == STARTLEVEL$1 ) goto label$54;
	{
	...
	label$53:;
	LEXSKIPTOKEN( 0ll );
	if( *(int64*)((uint8*)&ENV$ + 1224ll) != 0ll ) goto label$56;
	{
		CCOMPSTMTCHECK(  );
	}
	label$56:;
...
void HSKIPUNTIL( int64 TOKEN$1, int64 DOEAT$1, $8LEXCHECK FLAGS$1, int64 STOP_ON_COMMA$1 )
{
	...
	{
		{
			...
			label$65:;
			{
				if( TOKEN$1 == 257ll ) goto label$67;
				{
					goto label$60;
				}
				label$67:;
			...
			label$73:;
			{
				if( PRNTCNT$1 <= 0ll ) goto label$75;
				{
					PRNTCNT$1 = PRNTCNT$1 + -1ll;
				}
				goto label$74;
			...
			label$78:;
			{
				if( PRNTCNT$1 <= 0ll ) goto label$80;
				{
					PRNTCNT$1 = PRNTCNT$1 + -1ll;
				}
				goto label$79;
				label$80:;
				{
					if( TOKEN$1 != 125ll ) goto label$82;
					{
						goto label$60;
					}
					label$82:;
			...
			label$83:;
			{
				if( ((int64)-(TOKEN$1 == 44ll) | STOP_ON_COMMA$1) == 0ll ) goto label$85;
				{
					if( PRNTCNT$1 != 0ll ) goto label$87;
					{
						goto label$60;
					}
					label$87:;
			...
			goto label$62;
			label$63:;
			static const void* tmp$96[221ll] = {
				&&label$69,
				&&label$73,
				&&label$88,
				&&label$88,
			...
			if( (TMP$95$3 - 40ull) > 220ull ) goto label$88;
			goto *tmp$96[TMP$95$3 - 40ull];
			label$62:;
		}
	...
	goto label$59;
	label$60:;
	if( DOEAT$1 == 0ll ) goto label$92;
	{
		int64 vr$9 = LEXGETTOKEN( FLAGS$1 );
		if( TOKEN$1 != vr$9 ) goto label$94;
		{
			LEXSKIPTOKEN( FLAGS$1 );
		}
		label$94:;
...
void HSKIPCOMPOUND( int64 FOR_TOKEN$1, int64 UNTIL_TOKEN$1, $8LEXCHECK FLAGS$1 )
{
	...
	if( UNTIL_TOKEN$1 != -1ll ) goto label$98;
	{
	...
	{
		{
			...
			TMP$97$3 = vr$2;
			if( TMP$97$3 != 256ll ) goto label$103;
			label$104:;
			{
				goto label$96;
			}
			goto label$102;
			label$103:;
			if( TMP$97$3 != 257ll ) goto label$105;
			label$106:;
			{
				ISCOMMENT$1 = 0ll;
			}
			goto label$102;
			label$105:;
			if( TMP$97$3 == 259ll ) goto label$108;
			label$109:;
			if( TMP$97$3 != 260ll ) goto label$107;
			label$108:;
			{
				ISCOMMENT$1 = -1ll;
			}
			goto label$102;
			label$107:;
			if( TMP$97$3 != 340ll ) goto label$110;
			label$111:;
			{
				if( ISCOMMENT$1 != 0ll ) goto label$113;
				{
					int64 vr$3 = LEXGETLOOKAHEAD( 1ll, FLAGS$1 );
					if( vr$3 != UNTIL_TOKEN$1 ) goto label$115;
					{
						LEXSKIPTOKEN( FLAGS$1 );
						if( CNT$1 <= 0ll ) goto label$117;
						{
							CNT$1 = CNT$1 + -1ll;
						}
						label$117:;
						label$116:;
						if( CNT$1 != 0ll ) goto label$119;
						{
							goto label$100;
						}
						label$119:;
			...
			goto label$102;
			label$110:;
			if( TMP$97$3 != FOR_TOKEN$1 ) goto label$120;
			label$121:;
			{
				if( ISCOMMENT$1 != 0ll ) goto label$123;
				{
					CNT$1 = CNT$1 + 1ll;
				}
				label$123:;
...
struct $7ASTNODE* HMATCHEXPR( int64 DTYPE$1 )
{
	...
	if( EXPR$1 != (struct $7ASTNODE*)0ull ) goto label$127;
	{
		...
		if( DTYPE$1 != 2147483648ll ) goto label$129;
		{
...
static void HEMITCURRENTLINETEXT( void )
{
	...
	if( N$1 == (struct $7ASTNODE*)0ull ) goto label$19;
	{
		if( *(int64*)N$1 != 30ll ) goto label$21;
		{
			...
			{
				struct $7ASTNODE* vr$4 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 25056ll) );
