...
void CSCOPESTMTBEGIN( void )
{
	...
	if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 2ll) != 0ll ) goto label$13;
	{
	...
	*(int64*)((uint8*)STK$1 + 24ll) = (int64)-((*(int64*)((uint8*)&PARSER$ + 296ll) & 8ll) != 0ll);
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 296ll) = *(int64*)((uint8*)&PARSER$ + 296ll) | 8ll;
	}
	goto label$16;
	label$17:;
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 296ll) = *(int64*)((uint8*)&PARSER$ + 296ll) & -9ll;
	}
	label$16:;
	label$11:;
}
