	...
	label$60:;
	{
		...
		SYM$2 = *(struct $8FBSYMBOL**)CHAIN_$1;
		{
			...
			label$69:;
			{
				{
					int64 TMP$97$5;
					TMP$97$5 = *(int64*)((uint8*)SYM$2 + 56ll) & 511ll;
					if( TMP$97$5 != 20ll ) goto label$71;
					label$72:;
					{
					...
					goto label$70;
					label$71:;
					if( TMP$97$5 != 10ll ) goto label$75;
					label$76:;
					{
						SYM$2 = *(struct $8FBSYMBOL**)((uint8*)SYM$2 + 64ll);
					}
			...
			if( (TMP$96$3 - 8ull) > 5ull ) goto label$78;
			goto *tmp$101[TMP$96$3 - 8ull];
			label$63:;
		}
		...
		label$97:;
		{
			...
			if( TMP$98$3 > 5ull ) goto label$107;
			goto *tmp$102[TMP$98$3 - 0ull];
			label$99:;
		}
		...
		{
			{
				$12FB_SYMBCLASS TMP$99$4;
				TMP$99$4 = *($12FB_SYMBCLASS*)PARENT$1;
				if( TMP$99$4 == 10ll ) goto label$122;
				label$123:;
				if( TMP$99$4 != 11ll ) goto label$121;
				label$122:;
				{
			...
			if( CHAIN_$1 == (struct $10FBSYMCHAIN*)0ull ) goto label$141;
			{
				if( *(struct $10FBSYMCHAIN**)((uint8*)CHAIN_$1 + 8ll) == (struct $10FBSYMCHAIN*)0ull ) goto label$143;
				{
					if( *(int64*)((uint8*)CHAIN_$1 + 16ll) == 0ll ) goto label$145;
					{
						...
						TMP$100$6 = (int64)-(NS$6 != PARENT$1);
						goto label$149;
						label$146:;
						TMP$100$6 = (int64)-(NS$6 != NS2$6);
						label$149:;
						if( TMP$100$6 == 0ll ) goto label$148;
						{
	...
	if( CHAIN_$1 == (struct $10FBSYMCHAIN*)0ull ) goto label$159;
	{
		SYM$1 = *(struct $8FBSYMBOL**)CHAIN_$1;
		{
			...
			label$166:;
			{
				{
					int64 TMP$104$5;
					TMP$104$5 = *(int64*)((uint8*)SYM$1 + 56ll) & 511ll;
					if( TMP$104$5 != 20ll ) goto label$168;
					label$169:;
					{
					...
					goto label$167;
					label$168:;
					if( TMP$104$5 != 10ll ) goto label$172;
					label$173:;
					{
						SYM$1 = *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 64ll);
					}
			...
			if( (TMP$103$3 - 8ull) > 5ull ) goto label$175;
			goto *tmp$107[TMP$103$3 - 8ull];
			label$160:;
		}
		...
		label$188:;
		{
			...
			if( TMP$105$3 > 5ull ) goto label$196;
			goto *tmp$108[TMP$105$3 - 0ull];
			label$190:;
		}
			...
			if( CHAIN_$1 == (struct $10FBSYMCHAIN*)0ull ) goto label$210;
			{
				if( *(struct $10FBSYMCHAIN**)((uint8*)CHAIN_$1 + 8ll) == (struct $10FBSYMCHAIN*)0ull ) goto label$212;
				{
					if( *(int64*)((uint8*)CHAIN_$1 + 16ll) == 0ll ) goto label$214;
					{
						...
						TMP$106$6 = (int64)-(NS$6 != PARENT$1);
						goto label$218;
						label$215:;
						TMP$106$6 = (int64)-(NS$6 != NS2$6);
						label$218:;
						if( TMP$106$6 == 0ll ) goto label$217;
						{
							ERRREPORT( 255ll, 0ll, (uint8*)0ull );
						}
						label$217:;
...
void CCURRENTPARENTID( void )
{
	...
	label$221:;
	{
		$12FB_SYMBCLASS TMP$109$2;
		TMP$109$2 = *($12FB_SYMBCLASS*)S$1;
		if( TMP$109$2 != 8ll ) goto label$224;
		label$225:;
		{
		...
		goto label$223;
		label$224:;
		if( TMP$109$2 != 11ll ) goto label$228;
		label$229:;
		{
...
static void HSKIPSYMBOL( void )
{
	...
	label$12:;
	{
		...
		label$15:;
		{
			...
			if( TMP$94$3 > 2ull ) goto label$20;
			goto *tmp$110[TMP$94$3 - 0ull];
			label$17:;
		}
	}
	label$14:;
...
static struct $10FBSYMCHAIN* HGLOBALID( $8FB_IDOPT OPTIONS$1 )
{
	...
	LEXSKIPTOKEN( 64ll );
	{
		...
		TMP$95$2 = vr$4;
		if( TMP$95$2 == 0ll ) goto label$33;
		label$34:;
		if( TMP$95$2 != 2ll ) goto label$32;
		label$33:;
		{
		}
		goto label$31;
