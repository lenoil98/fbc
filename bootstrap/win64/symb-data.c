...
void SYMBDATAINIT( void )
{
	...
	{
		*(int64*)((uint8*)&ENV$ + 544ll) = 8ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 456ll) = 8ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 512ll) = 8ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 568ll) = 8ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 960ll) = 24ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 1352ll) = 8ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 488ll) = 7ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 544ll) = 8ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 600ll) = 7ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 1384ll) = 8ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 472ll) = 81ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 528ll) = 86ll;
	}
	goto label$12;
	label$13:;
	{
		*(int64*)((uint8*)&ENV$ + 544ll) = 4ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 456ll) = 4ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 512ll) = 4ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 568ll) = 4ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 960ll) = 12ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 1352ll) = 4ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 488ll) = 5ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 544ll) = 6ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 600ll) = 5ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 1384ll) = 6ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 472ll) = 41ll;
		*(int64*)((uint8*)SYMB_DTYPETB$ + 528ll) = 46ll;
	}
	label$12:;
	*($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + 392ll) = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (*(int64*)((uint8*)&ENV$ + 496ll) * 56ll));
	*(int64*)((uint8*)SYMB_DTYPETB$ + 400ll) = *(int64*)(((uint8*)SYMB_DTYPETB$ + (*(int64*)((uint8*)&ENV$ + 496ll) * 56ll)) + 8ll);
	*(int64*)((uint8*)SYMB_DTYPETB$ + 408ll) = *(int64*)(((uint8*)SYMB_DTYPETB$ + (*(int64*)((uint8*)&ENV$ + 496ll) * 56ll)) + 16ll);
	*($11FB_DATATYPE*)((uint8*)SYMB_DTYPETB$ + 424ll) = *($11FB_DATATYPE*)(((uint8*)SYMB_DTYPETB$ + (*(int64*)((uint8*)&ENV$ + 496ll) * 56ll)) + 32ll);
	...
	struct $8FBARRAY1I11FB_DATATYPEE tmp$109$1;
	*($11FB_DATATYPE**)&tmp$109$1 = ($11FB_DATATYPE*)RANK$1;
	*($11FB_DATATYPE**)((uint8*)&tmp$109$1 + 8ll) = ($11FB_DATATYPE*)RANK$1;
	*(int64*)((uint8*)&tmp$109$1 + 16ll) = 120ll;
	*(int64*)((uint8*)&tmp$109$1 + 24ll) = 8ll;
	*(int64*)((uint8*)&tmp$109$1 + 32ll) = 1ll;
	*(int64*)((uint8*)&tmp$109$1 + 40ll) = 49ll;
	*(int64*)((uint8*)&tmp$109$1 + 48ll) = 15ll;
	*(int64*)((uint8*)&tmp$109$1 + 56ll) = 0ll;
	*(int64*)((uint8*)&tmp$109$1 + 64ll) = 14ll;
		...
		{
			{
				...
				label$21:;
				{
					*($11FB_DATATYPE*)(((uint8*)RANK$1 + (DTYPE2$1 << (3ll & 63ll))) + -16ll) = DTYPE2$1;
				}
				label$19:;
				...
				{
					{
						...
						label$29:;
						{
							$11FB_DATATYPE vr$13 = CLOSESTTYPE( DTYPE1$1, *($11FB_DATATYPE*)((uint8*)RANK$1 + (I$1 << (3ll & 63ll))), *($11FB_DATATYPE*)((uint8*)RANK$1 + (J$1 << (3ll & 63ll))) );
							if( vr$13 != *(int64*)((uint8*)RANK$1 + (J$1 << (3ll & 63ll))) ) goto label$31;
							{
								{
									$11FB_DATATYPE TMP$110$9;
									TMP$110$9 = *($11FB_DATATYPE*)((uint8*)RANK$1 + (I$1 << (3ll & 63ll)));
									*($11FB_DATATYPE*)((uint8*)RANK$1 + (I$1 << (3ll & 63ll))) = *($11FB_DATATYPE*)((uint8*)RANK$1 + (J$1 << (3ll & 63ll)));
									*($11FB_DATATYPE*)((uint8*)RANK$1 + (J$1 << (3ll & 63ll))) = TMP$110$9;
								}
							}
							label$31:;
							label$30:;
			...
			}
			{
				...
				label$35:;
				{
					DTYPE2$1 = *($11FB_DATATYPE*)((uint8*)RANK$1 + (I$1 << (3ll & 63ll)));
					*(int64*)(((uint8*)SYMB_DTYPEMATCHTB$ + (((DTYPE1$1 << (4ll & 63ll)) + DTYPE2$1) << (3ll & 63ll))) + -136ll) = I$1;
				}
				label$33:;
				I$1 = I$1 + 1ll;
				label$32:;
...
void TYPEMAX( int64 LDTYPE$1, struct $8FBSYMBOL* LSUBTYPE$1, int64 RDTYPE$1, struct $8FBSYMBOL* RSUBTYPE$1, int64* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1 )
{
	...
	label$52:;
	DTYPE1$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$111$1 * 56ll)) + 32ll);
	if( (RDTYPE$1 & 480ll) == 0ll ) goto label$41;
	TMP$112$1 = 24ll;
	goto label$53;
	label$41:;
	TMP$112$1 = RDTYPE$1 & 31ll;
	label$53:;
	DTYPE2$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$112$1 * 56ll)) + 32ll);
	...
	goto label$54;
	label$45:;
	TMP$113$1 = DTYPE1$1 & 31ll;
	label$54:;
	if( (DTYPE2$1 & 480ll) == 0ll ) goto label$46;
	TMP$114$1 = 24ll;
	goto label$55;
	label$46:;
	TMP$114$1 = DTYPE2$1 & 31ll;
	label$55:;
	if( ((int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$113$1 * 56ll)) == 0ll) & (int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$114$1 * 56ll)) == 0ll)) == 0ll ) goto label$44;
	{
		int64 TMP$115$2;
		int64 TMP$116$2;
		...
		goto label$56;
		label$47:;
		TMP$115$2 = DTYPE1$1 & 31ll;
		label$56:;
		if( (DTYPE2$1 & 480ll) == 0ll ) goto label$48;
		TMP$116$2 = 24ll;
		goto label$57;
		label$48:;
		TMP$116$2 = DTYPE2$1 & 31ll;
		label$57:;
		if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$115$2 * 56ll)) + 24ll) <= *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$116$2 * 56ll)) + 24ll) ) goto label$50;
		{
			*DTYPE$1 = LDTYPE$1;
			*SUBTYPE$1 = LSUBTYPE$1;
		}
...
int64 TYPETOSIGNED( int64 DTYPE$1 )
{
	...
	label$61:;
	{
		...
		label$68:;
		{
			int64 vr$4 = TYPETOSIGNED( *(int64*)((uint8*)&ENV$ + 496ll) );
			fb$result$1 = vr$4;
			goto label$59;
		}
		goto label$63;
		...
		label$70:;
		{
			if( *(int64*)((uint8*)&ENV$ + 544ll) != 8ll ) goto label$72;
			{
				ND$1 = 13ll;
			}
			goto label$71;
		...
		goto label$63;
		label$64:;
		static const void* tmp$119[22ll] = {
			&&label$65,
			&&label$65,
			&&label$74,
			&&label$66,
		...
		if( (TMP$118$2 - 3ull) > 21ull ) goto label$74;
		goto *tmp$119[TMP$118$2 - 3ull];
		label$63:;
	}
...
int64 TYPETOUNSIGNED( int64 DTYPE$1 )
{
	...
	goto label$92;
	label$78:;
	TMP$120$1 = DTYPE$1 & 31ll;
	label$92:;
	DT$1 = TMP$120$1;
	int64 ND$1;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (DT$1 * 56ll)) == 0ll ) goto label$80;
	{
		fb$result$1 = DTYPE$1;
		goto label$77;
	}
	...
	label$79:;
	{
		...
		label$87:;
		{
			if( *(int64*)((uint8*)&ENV$ + 544ll) != 8ll ) goto label$89;
			{
				ND$1 = 14ll;
			}
			goto label$88;
		...
		goto label$81;
		label$82:;
		static const void* tmp$122[23ll] = {
			&&label$83,
			&&label$91,
			&&label$91,
			&&label$84,
		...
		if( (TMP$121$2 - 2ull) > 22ull ) goto label$91;
		goto *tmp$122[TMP$121$2 - 2ull];
		label$81:;
	}
	fb$result$1 = (DTYPE$1 & -512ll) | (ND$1 & 511ll);
	label$77:;
...
int64 TYPEHASCTOR( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	label$93:;
	{
		...
		label$99:;
		TMP$124$2 = TMP$123$2;
		if( TMP$124$2 != 20ll ) goto label$97;
		label$98:;
		{
...
int64 TYPEHASDEFCTOR( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	label$100:;
	{
		...
		label$106:;
		TMP$126$2 = TMP$125$2;
		if( TMP$126$2 != 20ll ) goto label$104;
		label$105:;
		{
...
int64 TYPEHASDTOR( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	label$107:;
	{
		...
		label$113:;
		TMP$128$2 = TMP$127$2;
		if( TMP$128$2 != 20ll ) goto label$111;
		label$112:;
		{
			struct $8FBSYMBOL* vr$3 = SYMBGETCOMPDTOR( SUBTYPE$1 );
			fb$result$1 = (int64)-(vr$3 != (struct $8FBSYMBOL*)0ull);
		}
		label$111:;
		label$110:;
...
int64 TYPEISTRIVIAL( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	{
		int64 TMP$129$2;
		TMP$129$2 = DTYPE$1 & 511ll;
		if( TMP$129$2 != 17ll ) goto label$119;
		label$120:;
		{
			fb$result$1 = 0ll;
		}
		goto label$118;
		label$119:;
		if( TMP$129$2 != 20ll ) goto label$121;
		label$122:;
		{
...
int64 TYPEHASFWDREFINSIGNATURE( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	{
		int64 TMP$130$2;
		TMP$130$2 = DTYPE$1 & 31ll;
		if( TMP$130$2 != 23ll ) goto label$126;
		label$127:;
		{
			fb$result$1 = -1ll;
		}
		goto label$125;
		label$126:;
		if( TMP$130$2 != 22ll ) goto label$128;
		label$129:;
		{
...
$11FB_DATATYPE CLOSESTTYPE( $11FB_DATATYPE DTYPE$1, $11FB_DATATYPE DTYPE1$1, $11FB_DATATYPE DTYPE2$1 )
{
	...
	label$196:;
	SAMECLASS1$1 = (int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$131$1 * 56ll)) == *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$132$1 * 56ll)));
	int64 SAMECLASS2$1;
	if( (DTYPE2$1 & 480ll) == 0ll ) goto label$157;
	TMP$133$1 = 24ll;
	goto label$197;
	label$157:;
	TMP$133$1 = DTYPE2$1 & 31ll;
	label$197:;
	...
	label$198:;
	SAMECLASS2$1 = (int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$133$1 * 56ll)) == *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$134$1 * 56ll)));
	...
	label$200:;
	LARGER1$1 = (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$135$1 * 56ll)) + 8ll) >= *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$136$1 * 56ll)) + 8ll));
	int64 LARGER2$1;
	if( (DTYPE2$1 & 480ll) == 0ll ) goto label$165;
	TMP$137$1 = 24ll;
	goto label$201;
	label$165:;
	TMP$137$1 = DTYPE2$1 & 31ll;
	label$201:;
	...
	label$202:;
	LARGER2$1 = (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$137$1 * 56ll)) + 8ll) >= *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$138$1 * 56ll)) + 8ll));
	...
	label$204:;
	SIZEDIFF1$1 = __builtin_llabs( (*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$139$1 * 56ll)) + 8ll) - *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$140$1 * 56ll)) + 8ll)) );
	int64 SIZEDIFF2$1;
	if( (DTYPE2$1 & 480ll) == 0ll ) goto label$173;
	TMP$141$1 = 24ll;
	goto label$205;
	label$173:;
	TMP$141$1 = DTYPE2$1 & 31ll;
	label$205:;
	...
	label$206:;
	SIZEDIFF2$1 = __builtin_llabs( (*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$141$1 * 56ll)) + 8ll) - *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$142$1 * 56ll)) + 8ll)) );
	...
	label$208:;
	SAMESIGN1$1 = (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$143$1 * 56ll)) + 16ll) == *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$144$1 * 56ll)) + 16ll));
	int64 SAMESIGN2$1;
	if( (DTYPE2$1 & 480ll) == 0ll ) goto label$181;
	TMP$145$1 = 24ll;
	goto label$209;
	label$181:;
	TMP$145$1 = DTYPE2$1 & 31ll;
	label$209:;
	if( (DTYPE$1 & 480ll) == 0ll ) goto label$182;
	TMP$146$1 = 24ll;
	goto label$210;
	label$182:;
	TMP$146$1 = DTYPE$1 & 31ll;
	label$210:;
	SAMESIGN2$1 = (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$145$1 * 56ll)) + 16ll) == *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$146$1 * 56ll)) + 16ll));
...
$22FB_OVLPROC_MATCH_SCORE TYPECALCMATCH( int64 LDTYPE$1, struct $8FBSYMBOL* LSUBTYPE$1, int64 LPARAMMODE$1, int64 RDTYPE$1, struct $8FBSYMBOL* RSUBTYPE$1 )
{
	...
	{
		fb$result$1 = CONST_MATCHES$1 + 52ll;
		goto label$212;
	}
	label$220:;
	label$219:;
	...
	if( LDT$1 == RDT$1 ) goto label$222;
	{
		...
		goto label$240;
		label$225:;
		TMP$149$2 = LDT$1 & 31ll;
		label$240:;
		if( (RDT$1 & 480ll) == 0ll ) goto label$226;
		TMP$150$2 = 24ll;
		goto label$241;
		label$226:;
		TMP$150$2 = RDT$1 & 31ll;
		label$241:;
		if( (((int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$147$2 * 56ll)) == 0ll) & (int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$148$2 * 56ll)) == 0ll)) & (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$149$2 * 56ll)) + 8ll) == *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$150$2 * 56ll)) + 8ll))) == 0ll ) goto label$228;
		{
			fb$result$1 = -(*(int64*)(((uint8*)SYMB_DTYPEMATCHTB$ + (((LDT$1 << (4ll & 63ll)) + RDT$1) << (3ll & 63ll))) + -136ll)) + 26ll;
			goto label$212;
		}
		label$228:;
		label$227:;
	...
	label$221:;
	{
		...
		label$231:;
		{
			...
			{
				int64 vr$44 = SYMBGETUDTBASELEVEL( RSUBTYPE$1, LSUBTYPE$1 );
				if( vr$44 <= 0ll ) goto label$235;
				{
					fb$result$1 = 26ll;
					goto label$212;
				}
		...
		label$237:;
		{
			int64 TMP$151$3;
			TMP$151$3 = 0ll;
			$22FB_OVLPROC_MATCH_SCORE vr$46 = SYMBCALCPROCMATCH( LSUBTYPE$1, RSUBTYPE$1, &TMP$151$3 );
			fb$result$1 = vr$46;
			goto label$212;
		}
		label$236:;
