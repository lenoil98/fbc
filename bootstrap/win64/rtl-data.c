...
int64 RTLDATAREAD( struct $7ASTNODE* VAREXPR$1 )
{
	...
	DTYPE$1 = *(int64*)((uint8*)VAREXPR$1 + 8ll) & 511ll;
	{
		...
		label$19:;
		{
			struct $8FBSYMBOL* vr$5 = RTLPROCLOOKUP( (uint8*)"fb_DataReadStr", 145ll );
			F$1 = vr$5;
			ARGS$1 = 3ll;
		}
		goto label$17;
		label$20:;
		{
			struct $8FBSYMBOL* vr$6 = RTLPROCLOOKUP( (uint8*)"fb_DataReadWstr", 146ll );
			F$1 = vr$6;
			ARGS$1 = 2ll;
		}
		goto label$17;
		label$21:;
		{
			struct $8FBSYMBOL* vr$7 = RTLPROCLOOKUP( (uint8*)"fb_DataReadBool", 147ll );
			F$1 = vr$7;
		}
		goto label$17;
		label$22:;
		{
			{
				...
				label$53:;
				TMP$103$4 = *(uint64*)(((uint8*)SYMB_DTYPETB$ + (TMP$102$4 * 56ll)) + 40ll);
				goto label$25;
				label$26:;
				{
					struct $8FBSYMBOL* vr$11 = RTLPROCLOOKUP( (uint8*)"fb_DataReadByte", 148ll );
					F$1 = vr$11;
				}
				goto label$24;
				label$27:;
				{
					struct $8FBSYMBOL* vr$12 = RTLPROCLOOKUP( (uint8*)"fb_DataReadUByte", 152ll );
					F$1 = vr$12;
				}
				goto label$24;
				label$28:;
				{
					struct $8FBSYMBOL* vr$13 = RTLPROCLOOKUP( (uint8*)"fb_DataReadShort", 149ll );
					F$1 = vr$13;
				}
				goto label$24;
				label$29:;
				{
					struct $8FBSYMBOL* vr$14 = RTLPROCLOOKUP( (uint8*)"fb_DataReadUShort", 153ll );
					F$1 = vr$14;
				}
				goto label$24;
				label$30:;
				{
					struct $8FBSYMBOL* vr$15 = RTLPROCLOOKUP( (uint8*)"fb_DataReadInt", 150ll );
					F$1 = vr$15;
				}
				goto label$24;
				label$31:;
				{
					struct $8FBSYMBOL* vr$16 = RTLPROCLOOKUP( (uint8*)"fb_DataReadUInt", 154ll );
					F$1 = vr$16;
				}
				goto label$24;
				label$32:;
				{
					struct $8FBSYMBOL* vr$17 = RTLPROCLOOKUP( (uint8*)"fb_DataReadLongint", 151ll );
					F$1 = vr$17;
				}
				goto label$24;
				label$33:;
				{
					struct $8FBSYMBOL* vr$18 = RTLPROCLOOKUP( (uint8*)"fb_DataReadULongint", 155ll );
					F$1 = vr$18;
				}
				goto label$24;
				label$25:;
				...
				if( (TMP$103$4 - 1ull) > 7ull ) goto label$24;
				goto *tmp$104[TMP$103$4 - 1ull];
				label$24:;
			}
		}
		goto label$17;
		label$34:;
		{
			struct $8FBSYMBOL* vr$19 = RTLPROCLOOKUP( (uint8*)"fb_DataReadSingle", 156ll );
			F$1 = vr$19;
		}
		goto label$17;
		label$35:;
		{
			struct $8FBSYMBOL* vr$20 = RTLPROCLOOKUP( (uint8*)"fb_DataReadDouble", 157ll );
			F$1 = vr$20;
		}
		goto label$17;
		label$36:;
		...
		goto label$17;
		label$18:;
		static const void* tmp$105[24ll] = {
			&&label$21,
			&&label$22,
			&&label$22,
			&&label$19,
		...
		if( (TMP$101$2 - 1ull) > 23ull ) goto label$37;
		goto *tmp$105[TMP$101$2 - 1ull];
		label$17:;
	}
...
int64 RTLDATARESTORE( struct $8FBSYMBOL* LABEL$1, struct $7ASTNODE* AFTERNODE$1 )
{
	...
	fb$result$1 = 0ll;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_DataRestore", 144ll );
