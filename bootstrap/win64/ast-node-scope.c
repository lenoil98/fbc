...
struct $7ASTNODE* ASTSCOPEBEGIN( void )
{
	...
	if( *(uint64*)((uint8*)&PARSER$ + 192ll) < 128ull ) goto label$13;
	{
	...
	*(uint64*)((uint8*)&PARSER$ + 192ll) = *(uint64*)((uint8*)&PARSER$ + 192ll) + 1ull;
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 216ll) = S$1;
...
void ASTSCOPEBREAK( struct $8FBSYMBOL* TARGET$1 )
{
	...
	*(struct $7ASTNODE**)((uint8*)N$1 + 40ll) = *(struct $7ASTNODE**)((uint8*)&AST$ + 264ll);
	*(int64*)((uint8*)N$1 + 48ll) = *(int64*)((uint8*)&PARSER$ + 192ll);
	*(int64*)((uint8*)N$1 + 56ll) = *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8552ll);
...
void ASTSCOPEEND( struct $7ASTNODE* N$1 )
{
	...
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 216ll) = *(struct $8FBSYMBOL**)((uint8*)*(struct $7ASTNODE**)((uint8*)&AST$ + 264ll) + 24ll);
	*(uint64*)((uint8*)&PARSER$ + 192ll) = *(uint64*)((uint8*)&PARSER$ + 192ll) + 18446744073709551615ull;
	...
	label$163:;
	{
		...
		if( S$1 == (struct $8FBSYMBOL*)0ull ) goto label$169;
		{
			if( ((int64)-(*(int64*)S$1 == 1ll) & (int64)-((*(int64*)((uint8*)S$1 + 8ll) & 3ll) == 0ll)) == 0ll ) goto label$171;
			{
				...
				{
					(*(tmp$43*)((uint8*)&IR$ + 72ll))( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll), S$1 );
				}
				goto label$172;
				label$173:;
				{
...
struct $6IRVREG* ASTLOADSCOPEBEGIN( struct $7ASTNODE* N$1 )
{
	...
	struct $8FBSYMBOL* S$1;
	S$1 = *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll);
	*(int64*)((uint8*)S$1 + 160ll) = *(int64*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 208ll) + 16ll);
...
struct $6IRVREG* ASTLOADSCOPEEND( struct $7ASTNODE* N$1 )
{
	...
	label$181:;
	label$180:;
	*(int64*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 208ll) + 16ll) = *(int64*)((uint8*)S$1 + 160ll);
	fb$result$1 = (struct $6IRVREG*)0ull;
	label$179:;
	return fb$result$1;
}
...
struct $8FBSYMBOL* ASTTEMPSCOPEBEGIN( struct $8FBSYMBOL** LASTSCP$1, struct $7ASTNODE* BACKNODE$1 )
{
	...
	SCP$1 = vr$1;
	*LASTSCP$1 = *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 216ll);
	*(uint64*)((uint8*)&PARSER$ + 192ll) = *(uint64*)((uint8*)&PARSER$ + 192ll) + 1ull;
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 216ll) = SCP$1;
...
void ASTTEMPSCOPEEND( struct $8FBSYMBOL* SCP$1, struct $8FBSYMBOL* LASTSCP$1 )
{
	...
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 216ll) = LASTSCP$1;
	*(uint64*)((uint8*)&PARSER$ + 192ll) = *(uint64*)((uint8*)&PARSER$ + 192ll) + 18446744073709551615ull;
...
static void HBRANCHERROR( int64 ERRNUM$1, struct $7ASTNODE* N$1, struct $8FBSYMBOL* S$1 )
{
	...
	SHOWERROR$1 = *(int64*)((uint8*)&ENV$ + 376ll);
	*(int64*)((uint8*)&ENV$ + 376ll) = 0ll;
	if( *(uint8**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 32ll) == (uint8*)0ull ) goto label$33;
	{
		...
		FBSTRING* vr$6 = fb_StrConcat( &TMP$95$2, (void*)"to label: ", 11ll, *(void**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 32ll), 0ll );
...
static void HBRANCHWARNING( int64 ERRNUM$1, struct $7ASTNODE* N$1, struct $8FBSYMBOL* S$1 )
{
	...
	*(int64*)((uint8*)&ENV$ + 376ll) = 0ll;
	if( *(uint8**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 32ll) == (uint8*)0ull ) goto label$44;
	{
		...
		FBSTRING* vr$6 = fb_StrConcat( &TMP$102$2, (void*)"to label: ", 11ll, *(void**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 32ll), 0ll );
		fb_StrAssign( (void*)&MSG$1, -1ll, (void*)vr$6, -1ll, 0 );
	...
	if( S$1 == (struct $8FBSYMBOL*)0ull ) goto label$48;
	{
		...
		FBSTRING* vr$10 = fb_StrConcat( &TMP$104$2, (void*)&MSG$1, -1ll, *(void**)((uint8*)S$1 + 32ll), 0ll );
...
static void HDELLOCALS( struct $7ASTNODE* N$1, int64 CHECK_BACKWARD$1 )
{
	...
	label$113:;
	{
		...
		TMP$105$2 = (int64)-(LABEL_STMT$1 < *(int64*)((uint8*)BLK$1 + 56ll));
		goto label$200;
		label$118:;
		TMP$105$2 = 0ll;
		label$200:;
		if( TMP$105$2 == 0ll ) goto label$120;
		{
...
static int64 HCHECKBRANCH( struct $7ASTNODE* PROC$1, struct $7ASTNODE* N$1 )
{
	...
	TMP$106$1 = (int64)-(LABEL_STMT$1 < *(int64*)((uint8*)BRANCH_PARENT$1 + 56ll));
	goto label$201;
	label$135:;
	TMP$106$1 = 0ll;
	label$201:;
	if( TMP$106$1 == 0ll ) goto label$137;
	{
