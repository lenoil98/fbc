...
struct $7ASTNODE* RTLWSTRCONCAT( struct $7ASTNODE* STR1$1, int64 SDTYPE1$1, struct $7ASTNODE* STR2$1, int64 SDTYPE2$1 )
{
	...
	if( (SDTYPE1$1 & 511ll) == (SDTYPE2$1 & 511ll) ) goto label$61;
	{
		...
		goto label$69;
		label$62:;
		TMP$288$2 = SDTYPE1$1 & 31ll;
		label$69:;
		if( TMP$288$2 != 7ll ) goto label$64;
		{
...
struct $7ASTNODE* RTLWSTRASSIGNAW( struct $7ASTNODE* DST$1, int64 DDTYPE$1, struct $7ASTNODE* SRC$1, int64 IS_INI$1 )
{
	...
	TMP$289$1 = vr$2;
	label$111:;
	struct $7ASTNODE* vr$3 = ASTNEWCALL( TMP$289$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$3;
...
struct $7ASTNODE* RTLSTRASSIGN( struct $7ASTNODE* DST$1, struct $7ASTNODE* SRC$1, int64 IS_INI$1 )
{
	...
	TMP$290$1 = vr$8;
	label$128:;
	struct $7ASTNODE* vr$9 = ASTNEWCALL( TMP$290$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$9;
...
struct $7ASTNODE* RTLSTRALLOCTMPDESC( struct $7ASTNODE* STREXPR$1 )
{
	...
	DTYPE$1 = *(int64*)((uint8*)STREXPR$1 + 8ll) & 511ll;
	{
		...
		goto label$155;
		label$156:;
		static const void* tmp$292[15ll] = {
			&&label$157,
			&&label$155,
			&&label$155,
			&&label$155,
		...
		if( (TMP$291$2 - 4ull) > 14ull ) goto label$155;
		goto *tmp$292[TMP$291$2 - 4ull];
		label$155:;
	}
	fb$result$1 = PROC$1;
	label$154:;
...
struct $7ASTNODE* RTLTOSTR( struct $7ASTNODE* EXPR$1, int64 PAD$1 )
{
	...
	if( *(int64*)EXPR$1 != 16ll ) goto label$186;
	{
		...
		label$188:;
		{
			if( PAD$1 == 0ll ) goto label$190;
			{
				...
				goto label$237;
				label$191:;
				TMP$293$4 = (*(int64*)((uint8*)EXPR$1 + 8ll) & 511ll) & 31ll;
				label$237:;
				if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$293$4 * 56ll)) + 16ll) == 0ll ) goto label$193;
				{
	...
	if( DTYPE$1 != 7ll ) goto label$197;
	{
		...
		if( LITSYM$1 == (struct $8FBSYMBOL*)0ull ) goto label$199;
		{
			if( *(int64*)((uint8*)&ENV$ + 528ll) == 0ll ) goto label$201;
			{
				...
				fb_StrAssign( (void*)&TMP$295$4, -1ll, (void*)vr$28, -1ll, 0 );
				struct $8FBSYMBOL* vr$30 = SYMBALLOCSTRCONST( (uint8*)*(uint8**)&TMP$295$4, (*(int64*)((uint8*)LITSYM$1 + 80ll) / *(int64*)((uint8*)SYMB_DTYPETB$ + 400ll)) + -1ll );
				LITSYM$1 = vr$30;
	...
	DTYPE$1 = *(int64*)((uint8*)EXPR$1 + 8ll) & 511ll;
	{
		...
		goto label$238;
		label$202:;
		TMP$296$2 = (*(int64*)((uint8*)EXPR$1 + 8ll) & 511ll) & 31ll;
		label$238:;
		TMP$297$2 = *(uint64*)((uint8*)SYMB_DTYPETB$ + (TMP$296$2 * 56ll));
		goto label$204;
		label$205:;
		{
				...
				{
					{
						...
						goto label$239;
						label$216:;
						TMP$298$6 = DTYPE$1 & 31ll;
						label$239:;
						TMP$299$6 = *(uint64*)(((uint8*)SYMB_DTYPETB$ + (TMP$298$6 * 56ll)) + 40ll);
						goto label$218;
						label$219:;
						{
						...
						if( (TMP$299$6 - 2ull) > 6ull ) goto label$225;
						goto *tmp$306[TMP$299$6 - 2ull];
						label$217:;
					}
				}
				label$215:;
		...
		goto label$203;
		label$204:;
		static const void* tmp$307[4ll] = {
			&&label$205,
			&&label$227,
			&&label$232,
			&&label$233,
		};
		if( TMP$297$2 > 3ull ) goto label$234;
		goto *tmp$307[TMP$297$2 - 0ull];
		label$203:;
	}
...
struct $7ASTNODE* RTLTOWSTR( struct $7ASTNODE* EXPR$1 )
{
	...
	if( DTYPE$1 != 4ll ) goto label$251;
	{
		...
		if( LITSYM$1 == (struct $8FBSYMBOL*)0ull ) goto label$253;
		{
			if( *(int64*)((uint8*)&ENV$ + 528ll) == 0ll ) goto label$255;
			{
				...
				TMP$308$4 = vr$11;
				struct $8FBSYMBOL* vr$12 = SYMBALLOCWSTRCONST( TMP$308$4, *(int64*)((uint8*)LITSYM$1 + 80ll) + -1ll );
				LITSYM$1 = vr$12;
				fb_WstrDelete( (uint16*)TMP$308$4 );
	...
	DTYPE$1 = *(int64*)((uint8*)EXPR$1 + 8ll) & 511ll;
	{
		...
		goto label$285;
		label$256:;
		TMP$309$2 = (*(int64*)((uint8*)EXPR$1 + 8ll) & 511ll) & 31ll;
		label$285:;
		TMP$310$2 = *(uint64*)((uint8*)SYMB_DTYPETB$ + (TMP$309$2 * 56ll));
		goto label$258;
		label$259:;
		{
				...
				{
					{
						...
						goto label$286;
						label$270:;
						TMP$311$6 = DTYPE$1 & 31ll;
						label$286:;
						TMP$312$6 = *(uint64*)(((uint8*)SYMB_DTYPETB$ + (TMP$311$6 * 56ll)) + 40ll);
						goto label$272;
						label$273:;
						{
						...
						if( (TMP$312$6 - 2ull) > 6ull ) goto label$276;
						goto *tmp$313[TMP$312$6 - 2ull];
						label$271:;
					}
				}
				label$269:;
		...
		goto label$257;
		label$258:;
		static const void* tmp$314[4ll] = {
			&&label$259,
			&&label$277,
			&&label$280,
			&&label$281,
		};
		if( TMP$310$2 > 3ull ) goto label$282;
		goto *tmp$314[TMP$310$2 - 0ull];
		label$257:;
	}
...
struct $7ASTNODE* RTLSTRTOVAL( struct $7ASTNODE* EXPR$1, int64 TO_DTYPE$1 )
{
	...
	label$289:;
	{
		...
		goto label$310;
		label$291:;
		TMP$315$2 = TO_DTYPE$1 & 31ll;
		label$310:;
		TMP$316$2 = (uint64)TMP$315$2;
		goto label$293;
		label$294:;
		{
		...
		{
			{
				...
				goto label$311;
				label$297:;
				TMP$317$4 = TO_DTYPE$1 & 31ll;
				label$311:;
				TMP$318$4 = *(uint64*)(((uint8*)SYMB_DTYPETB$ + (TMP$317$4 * 56ll)) + 40ll);
				goto label$299;
				label$300:;
				{
				...
				if( (TMP$318$4 - 1ull) > 7ull ) goto label$298;
				goto *tmp$319[TMP$318$4 - 1ull];
				label$298:;
			}
		}
		goto label$292;
		...
		goto label$292;
		label$293:;
		static const void* tmp$320[24ll] = {
			&&label$295,
			&&label$296,
			&&label$296,
			&&label$305,
		...
		if( (TMP$316$2 - 1ull) > 23ull ) goto label$305;
		goto *tmp$320[TMP$316$2 - 1ull];
		label$292:;
	}
...
int64 RTLSTRLRSET( struct $7ASTNODE* DSTEXPR$1, struct $7ASTNODE* SRCEXPR$1, int64 IS_RSET$1 )
{
	...
	if( (*(int64*)((uint8*)DSTEXPR$1 + 8ll) & 511ll) == 7ll ) goto label$341;
	{
		...
		TMP$321$2 = vr$4;
		label$348:;
		struct $7ASTNODE* vr$5 = ASTNEWCALL( TMP$321$2, (struct $7ASTNODE*)0ull );
		PROC$1 = vr$5;
	}
	goto label$340;
	label$341:;
	{
		...
		TMP$322$2 = vr$7;
		label$349:;
		struct $7ASTNODE* vr$8 = ASTNEWCALL( TMP$322$2, (struct $7ASTNODE*)0ull );
		PROC$1 = vr$8;
	}
	label$340:;
...
struct $7ASTNODE* RTLSTRFILL( struct $7ASTNODE* EXPR1$1, struct $7ASTNODE* EXPR2$1 )
{
	...
	{
		int64 TMP$323$2;
		TMP$323$2 = *(int64*)((uint8*)EXPR2$1 + 8ll) & 511ll;
		if( TMP$323$2 == 17ll ) goto label$354;
		label$355:;
		if( TMP$323$2 == 18ll ) goto label$354;
		label$356:;
		if( TMP$323$2 != 4ll ) goto label$353;
		label$354:;
		{
...
struct $7ASTNODE* RTLSTRCHR( int64 ARGS$1, struct $7FBARRAYIP7ASTNODEE* EXPRTB$1, int64 IS_WSTR$1 )
{
	...
	label$394:;
	{
		...
		label$399:;
		{
			...
			goto label$410;
			label$400:;
			TMP$325$3 = (*(int64*)((uint8*)EXPR$1 + 8ll) & 511ll) & 31ll;
			label$410:;
			if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$325$3 * 56ll)) < 2ll ) goto label$402;
			{
				FBSTRING TMP$327$4;
				FBSTRING TMP$328$4;
				...
				FBSTRING* vr$25 = fb_StrConcat( &TMP$327$4, (void*)"at parameter: ", 15ll, (void*)vr$22, -1ll );
				fb_StrAssign( (void*)&TMP$328$4, -1ll, (void*)vr$25, -1ll, 0 );
				ERRREPORTEX( 58ll, (uint8*)*(uint8**)&TMP$328$4, 0ll, 1ll, (uint8*)0ull );
				fb_StrDelete( (FBSTRING*)&TMP$328$4 );
				goto label$391;
			}
			label$402:;
			label$401:;
			{
				...
				label$405:;
				{
					...
					FBSTRING* vr$33 = fb_StrConcat( &TMP$330$5, (void*)"at parameter: ", 15ll, (void*)vr$30, -1ll );
					fb_StrAssign( (void*)&TMP$331$5, -1ll, (void*)vr$33, -1ll, 0 );
					ERRREPORTEX( 58ll, (uint8*)*(uint8**)&TMP$331$5, 0ll, 1ll, (uint8*)0ull );
					fb_StrDelete( (FBSTRING*)&TMP$331$5 );
					goto label$391;
				}
				goto label$403;
				label$406:;
				...
				if( (TMP$329$4 - 4ull) > 4ull ) goto label$407;
				goto *tmp$332[TMP$329$4 - 4ull];
				label$403:;
			}
		...
		I$2 = I$2 + 1ll;
		label$396:;
		if( I$2 <= TMP$324$2 ) goto label$399;
		label$398:;
	}
	fb$result$1 = PROC$1;
	label$391:;
...
static struct $8FBSYMBOL* HEVALASCCASE( struct $8FBSYMBOL* LITERAL$1, int64 IS_LCASE$1 )
{
	...
	if( (*(int64*)((uint8*)LITERAL$1 + 56ll) & 511ll) != 7ll ) goto label$505;
	{
		...
		label$506:;
		{
			...
			I$3 = I$3 + 1ll;
			label$508:;
			if( I$3 <= TMP$337$3 ) goto label$511;
			label$510:;
		}
	...
	label$505:;
	{
		...
		label$514:;
		{
			...
			I$3 = I$3 + 1ll;
			label$516:;
			if( I$3 <= TMP$338$3 ) goto label$519;
			label$518:;
		}
