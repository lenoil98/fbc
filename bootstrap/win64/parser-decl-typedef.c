...
static void HADDFORWARDREF( uint8*, uint8*, int64*, struct $8FBSYMBOL**, int64*, int64* );
static void HADDTYPEDEF( uint8*, uint8*, int64, struct $8FBSYMBOL*, int64, int64 );
...
void CTYPEDEFMULTDECL( void )
{
	...
	label$78:;
	{
		...
		uint8* vr$10 = HREADID(  );
		PID$2 = vr$10;
		HADDTYPEDEF( PID$2, PFWDNAME$1, DTYPE$1, SUBTYPE$1, LGT$1, IS_FIXLENSTR$1 );
	}
	label$80:;
	int64 vr$11 = HMATCH( 44ll, 0ll );
	if( vr$11 != 0ll ) goto label$78;
	label$79:;
	label$75:;
}

void CTYPEDEFSINGLEDECL( uint8* PID$1 )
{
	label$81:;
	int64 vr$0 = CCOMPSTMTISALLOWED( 9ll );
	if( vr$0 != 0ll ) goto label$84;
	{
		HSKIPUNTIL( -1ll, 0ll, 0ll, 0ll );
		goto label$82;
	}
	...
	label$85:;
	{
		...
		PFWDNAME$2 = vr$10;
		HADDTYPEDEF( PID$1, PFWDNAME$2, DTYPE$2, SUBTYPE$2, LGT$2, IS_FIXLENSTR$2 );
		int64 vr$11 = HMATCH( 44ll, 0ll );
		if( vr$11 != 0ll ) goto label$91;
		{
			goto label$86;
		}
		label$91:;
	...
	{
		{
			...
			label$17:;
			{
				LEXSKIPTOKEN( 2048ll );
				{
					...
					TMP$95$5 = vr$1;
					if( TMP$95$5 == 373ll ) goto label$20;
					label$21:;
					if( TMP$95$5 != 374ll ) goto label$19;
					label$20:;
					{
			...
			if( (TMP$94$3 - 335ull) > 39ull ) goto label$28;
			goto *tmp$98[TMP$94$3 - 335ull];
			label$15:;
		}
	}
	label$14:;
...
static uint8* HREADTYPE( int64* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1, int64* LGT$1, int64* IS_FIXLENSTR$1 )
{
	...
	label$31:;
	{
		...
		TMP$96$2 = vr$2;
		if( TMP$96$2 == 0ll ) goto label$35;
		label$36:;
		if( TMP$96$2 != 2ll ) goto label$34;
		label$35:;
		{
...
static void HADDFORWARDREF( uint8* PID$1, uint8* PFWDNAME$1, int64* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1, int64* LGT$1, int64* IS_FIXLENSTR$1 )
{
	label$38:;
	int64 PTRCOUNT$1;
	...
	label$41:;
	{
		...
		*LGT$1 = -1ll;
		...
		{
			struct $8FBSYMBOL* vr$16 = SYMBLOOKUPBYNAMEANDCLASS( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 197024ll), (uint8*)PFWDNAME$1, 14ll, -1ll, 0ll );
			*SUBTYPE$1 = vr$16;
			if( *SUBTYPE$1 != (struct $8FBSYMBOL*)0ull ) goto label$45;
			{
				ERRREPORT( 4ll, 0ll, (uint8*)0ull );
				uint8* vr$19 = SYMBUNIQUELABEL(  );
				struct $8FBSYMBOL* vr$20 = SYMBADDFWDREF( vr$19 );
				*SUBTYPE$1 = vr$20;
			}
			label$45:;
			label$44:;
...
static void HADDTYPEDEF( uint8* PID$1, uint8* PFWDNAME$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int64 LGT$1, int64 IS_FIXLENSTR$1 )
{
	label$46:;
	if( PFWDNAME$1 == (uint8*)0ull ) goto label$49;
	{
		HADDFORWARDREF( PID$1, PFWDNAME$1, &DTYPE$1, &SUBTYPE$1, &LGT$1, &IS_FIXLENSTR$1 );
	}
	label$49:;
	label$48:;
	...
	TYPEDEF$1 = vr$4;
	if( TYPEDEF$1 == (struct $8FBSYMBOL*)0ull ) goto label$51;
	{
		if( IS_FIXLENSTR$1 == 0ll ) goto label$53;
		{
	...
	label$51:;
	{
		...
		struct $8FBSYMBOL* vr$8 = SYMBLOOKUPBYNAMEANDCLASS( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 197024ll), (uint8*)PID$1, 13ll, 0ll, 0ll );
		SYM$2 = vr$8;
		if( SYM$2 == (struct $8FBSYMBOL*)0ull ) goto label$55;
		{
			if( *(int64*)((uint8*)SYM$2 + 56ll) != DTYPE$1 ) goto label$57;
			{
				if( *(struct $8FBSYMBOL**)((uint8*)SYM$2 + 64ll) != SUBTYPE$1 ) goto label$59;
				{
					ISDUP$2 = 0ll;
				}
				label$59:;
...
static uint8* HREADID( void )
{
	...
	CCURRENTPARENTID(  );
	{
		...
		label$66:;
		{
			if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 524288ll) == 0ll ) goto label$68;
			{
				if( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 197024ll) == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 196704ll) ) goto label$70;
				{
					if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8520ll) + 2096ll) <= 0ll ) goto label$72;
					{
		...
		if( TMP$97$2 > 2ull ) goto label$73;
		goto *tmp$99[TMP$97$2 - 0ull];
		label$64:;
	}
