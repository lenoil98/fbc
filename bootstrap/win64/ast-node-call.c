...
struct $6IRVREG* ASTLOADCALL( struct $7ASTNODE* N$1 )
{
	...
	if( ((int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 0ll) & (int64)-((*(int64*)((uint8*)&ENV$ + 520ll) & 32ll) != 0ll)) == 0ll ) goto label$33;
	{
		...
		if( BYTESTOALIGN$1 <= 0ll ) goto label$39;
		{
			...
			{
				(*(tmp$46*)((uint8*)&IR$ + 272ll))( BYTESTOALIGN$1 );
			}
			label$41:;
			label$40:;
	...
	if( ARG$1 == (struct $7ASTNODE*)0ull ) goto label$43;
	{
		...
		{
			(*(tmp$48*)((uint8*)&IR$ + 168ll))( *(struct $8FBSYMBOL**)((uint8*)ARG$1 + 24ll), V1$1, *(int64*)((uint8*)ARG$1 + 48ll), RECLEVEL$1 );
		}
		label$49:;
		label$48:;
	...
	if( vr$38 == 0ll ) goto label$51;
	{
		...
		if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$55;
		{
			...
			V1$1 = vr$52;
			(*(tmp$48*)((uint8*)&IR$ + 168ll))( (struct $8FBSYMBOL*)0ull, V1$1, 0ll, RECLEVEL$1 );
		}
		label$55:;
		label$54:;
	...
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$59;
	{
		...
		label$61:;
		{
			...
			label$62:;
			struct $6IRVREG* vr$61 = (*(tmp$70*)((uint8*)&IR$ + 456ll))( *(int64*)((uint8*)PROC$1 + 160ll), *(struct $8FBSYMBOL**)((uint8*)PROC$1 + 168ll) );
			VR$1 = vr$61;
	...
	if( L$1 == (struct $7ASTNODE*)0ull ) goto label$67;
	{
		...
		{
			(*(tmp$56*)((uint8*)&IR$ + 264ll))( PROC$1, V1$1, VR$1, BYTESTOPOP$1, RECLEVEL$1 );
		}
		label$69:;
		label$68:;
	}
	...
	label$67:;
	{
		...
		{
			(*(tmp$55*)((uint8*)&IR$ + 256ll))( PROC$1, BYTESTOPOP$1, VR$1, RECLEVEL$1 );
		}
		label$71:;
		label$70:;
	}
...
int64 ASTISBYREFRESULTDEREF( struct $7ASTNODE* EXPR$1 )
{
	...
	TMP$85$1 = 0ll;
	label$115:;
	if( TMP$85$1 == 0ll ) goto label$112;
	{
