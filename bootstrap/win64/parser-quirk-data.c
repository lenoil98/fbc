	...
	fb$result$1 = 0ll;
	{
		...
		label$14:;
		{
			...
			SYM$3 = (struct $8FBSYMBOL*)0ull;
			{
				...
				TMP$95$4 = vr$1;
				if( TMP$95$4 == 0ll ) goto label$17;
				label$18:;
				if( TMP$95$4 == 2ll ) goto label$17;
				label$19:;
				if( TMP$95$4 != 3ll ) goto label$16;
				label$17:;
				{
		...
		label$34:;
		{
			if( *(int64*)((uint8*)&ENV$ + 272ll) == 3ll ) goto label$36;
			{
				...
				label$38:;
				label$37:;
				if( *(uint64*)((uint8*)&PARSER$ + 192ll) <= 0ull ) goto label$40;
				{
					if( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) == *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1232ll) ) goto label$42;
					{
			...
			label$36:;
			{
				if( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) == *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1232ll) ) goto label$44;
				{
					ERRREPORT( 61ll, 0ll, (uint8*)0ull );
					HSKIPUNTIL( -1ll, 0ll, 0ll, 0ll );
					fb$result$1 = 0ll;
				...
				label$47:;
				{
					...
					if( ISCONST$5 != 0ll ) goto label$53;
					{
						...
						label$55:;
						{
							{
								int64 TMP$96$8;
								TMP$96$8 = *(int64*)((uint8*)EXPR$3 + 8ll) & 511ll;
								if( TMP$96$8 == 4ll ) goto label$58;
								label$59:;
								if( TMP$96$8 != 7ll ) goto label$57;
								label$58:;
								{
				...
				label$64:;
				{
					...
					label$67:;
					{
						FBSTRING TMP$98$6;
						{
							...
							goto label$70;
							label$71:;
							static const void* tmp$100[252ll] = {
								&&label$73,
								&&label$70,
								&&label$70,
								&&label$70,
							...
							if( (TMP$97$7 - 9ull) > 251ull ) goto label$70;
							goto *tmp$100[TMP$97$7 - 9ull];
							label$70:;
						}
						uint8* vr$27 = LEXGETTEXT(  );
						__builtin_memset( &TMP$98$6, 0, 24ll );
						FBSTRING* vr$31 = fb_StrConcat( &TMP$98$6, (void*)&TEXT$4, -1ll, (void*)vr$27, 0ll );
