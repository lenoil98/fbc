	...
	*(struct $7REG_REG**)((uint8*)THIS_$1 + 264ll) = (struct $7REG_REG*)0ull;
	{
		...
		label$41:;
		{
			...
			*(uint64*)((uint8*)((uint8*)((uint8*)THIS_$1 + 256ll) + (N$1 << (3ll & 63ll))) + 216ll) = 0ull;
...
static int64 REGALLOCATE( struct $8REGCLASS* THIS_$1, struct $6IRVREG* VREG$1, struct $6IRVREG* VAUXPARENT$1, uint64 SIZE$1 )
{
	...
	if( R$1 != -1ll ) goto label$57;
	{
		...
		R$1 = vr$9;
		(*(tmp$45*)((uint8*)&IR$ + 536ll))( *(struct $6IRVREG**)((uint8*)((uint8*)THIS_$1 + (R$1 << (3ll & 63ll))) + 128ll), *(struct $6IRVREG**)((uint8*)((uint8*)THIS_$1 + (R$1 << (3ll & 63ll))) + 192ll) );
	...
	*(struct $6IRVREG**)((uint8*)((uint8*)THIS_$1 + (R$1 << (3ll & 63ll))) + 192ll) = VAUXPARENT$1;
	uint64 vr$23 = (*(tmp$77*)((uint8*)&IR$ + 520ll))( VREG$1 );
...
static int64 REGALLOCATEREG( struct $8REGCLASS* THIS_$1, int64 R$1, struct $6IRVREG* VREG$1, struct $6IRVREG* VAUXPARENT$1 )
{
	...
	*(struct $6IRVREG**)((uint8*)((uint8*)THIS_$1 + (R$1 << (3ll & 63ll))) + 128ll) = VREG$1;
	*(struct $6IRVREG**)((uint8*)((uint8*)THIS_$1 + (R$1 << (3ll & 63ll))) + 192ll) = VAUXPARENT$1;
	uint64 vr$13 = (*(tmp$77*)((uint8*)&IR$ + 520ll))( VREG$1 );
...
static int64 REGENSURE( struct $8REGCLASS* THIS_$1, struct $6IRVREG* VREG$1, struct $6IRVREG* VAUXPARENT$1, uint64 SIZE$1 )
{
	...
	if( R$1 != -1ll ) goto label$68;
	{
		...
		R$1 = vr$2;
		(*(tmp$52*)((uint8*)&IR$ + 528ll))( R$1, VREG$1, VAUXPARENT$1 );
	}
	label$68:;
	label$67:;
	fb$result$1 = R$1;
...
static void REGFREE( struct $8REGCLASS* THIS_$1, int64 R$1 )
{
	...
	if( (*(int64*)((uint8*)THIS_$1 + 272ll) & (1ll << (R$1 & 63ll))) != 0ll ) goto label$74;
	{
		...
		*(uint64*)((uint8*)((uint8*)((uint8*)THIS_$1 + 256ll) + (R$1 << (3ll & 63ll))) + 216ll) = 0ull;
		REGPUSH( THIS_$1, R$1 );
	}
	label$74:;
	label$73:;
...
static void REGINITCLASS( struct $8REGCLASS* THIS_$1, struct $7FBARRAYI12REG_SIZEMASKE* SIZETB$1 )
{
	...
	*(tmp$84*)THIS_$1 = (tmp$84)&REGENSURE;
	*(tmp$84*)((uint8*)THIS_$1 + 8ll) = (tmp$84)&REGALLOCATE;
	*(tmp$85*)((uint8*)THIS_$1 + 16ll) = (tmp$85)&REGALLOCATEREG;
	*(tmp$86*)((uint8*)THIS_$1 + 24ll) = (tmp$86)&REGFREE;
	*(tmp$87*)((uint8*)THIS_$1 + 32ll) = (tmp$87)&REGISFREE;
	*(tmp$88*)((uint8*)THIS_$1 + 40ll) = (tmp$88)&REGSETOWNER;
	*(tmp$89*)((uint8*)THIS_$1 + 48ll) = (tmp$89)&REGGETMAXREGS;
	*(tmp$89*)((uint8*)THIS_$1 + 56ll) = (tmp$89)&REGGETFIRST;
	*(tmp$87*)((uint8*)THIS_$1 + 64ll) = (tmp$87)&REGGETNEXT;
	*(tmp$90*)((uint8*)THIS_$1 + 72ll) = (tmp$90)&REGGETVREG;
	*(tmp$87*)((uint8*)THIS_$1 + 80ll) = (tmp$87)&REGGETREALREG;
	*(tmp$91*)((uint8*)THIS_$1 + 88ll) = (tmp$91)&REGCLEAR;
	*(tmp$91*)((uint8*)THIS_$1 + 96ll) = (tmp$91)&REGDUMP;
	label$94:;
}
...
static void SREGINITCLASS( struct $8REGCLASS* THIS_$1, struct $7FBARRAYI12REG_SIZEMASKE* SIZETB$1 )
{
	label$201:;
	SREGCLEAR( THIS_$1 );
	*(tmp$84*)THIS_$1 = (tmp$84)&SREGENSURE;
	*(tmp$84*)((uint8*)THIS_$1 + 8ll) = (tmp$84)&SREGALLOCATE;
	*(tmp$85*)((uint8*)THIS_$1 + 16ll) = (tmp$85)&SREGALLOCATEREG;
	*(tmp$86*)((uint8*)THIS_$1 + 24ll) = (tmp$86)&SREGFREE;
	*(tmp$87*)((uint8*)THIS_$1 + 32ll) = (tmp$87)&SREGISFREE;
	*(tmp$88*)((uint8*)THIS_$1 + 40ll) = (tmp$88)&SREGSETOWNER;
	*(tmp$89*)((uint8*)THIS_$1 + 48ll) = (tmp$89)&SREGGETMAXREGS;
	*(tmp$89*)((uint8*)THIS_$1 + 56ll) = (tmp$89)&SREGGETFIRST;
	*(tmp$87*)((uint8*)THIS_$1 + 64ll) = (tmp$87)&SREGGETNEXT;
	*(tmp$90*)((uint8*)THIS_$1 + 72ll) = (tmp$90)&SREGGETVREG;
	*(tmp$87*)((uint8*)THIS_$1 + 80ll) = (tmp$87)&SREGGETREALREG;
	*(tmp$91*)((uint8*)THIS_$1 + 88ll) = (tmp$91)&SREGCLEAR;
	*(tmp$91*)((uint8*)THIS_$1 + 96ll) = (tmp$91)&SREGDUMP;
	label$202:;
}
