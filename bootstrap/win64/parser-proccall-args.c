...
{
	label$10:;
	LISTINIT( (struct $5TLIST*)((uint8*)&PARSER$ + 224ll), 128ll, 24ll, 6ll );
	label$11:;
}
...
{
	label$12:;
	LISTEND( (struct $5TLIST*)((uint8*)&PARSER$ + 224ll) );
	label$13:;
}
...
struct $7ASTNODE* CPROCARGLIST( struct $8FBSYMBOL* BASE_PARENT$1, struct $8FBSYMBOL* PROC$1, struct $7ASTNODE* PTREXPR$1, struct $16FB_CALL_ARG_LIST* ARG_LIST$1, $12FB_PARSEROPT OPTIONS$1 )
{
	...
	if( vr$5 != 0ll ) goto label$143;
	{
		...
		TMP$97$2 = 202ll;
		label$192:;
		ERRREPORTEX( TMP$97$2, (uint8*)vr$6, 0ll, 1ll, (uint8*)0ull );
	...
	if( (*(int64*)((uint8*)PROC$1 + 16ll) & 2ll) == 0ll ) goto label$146;
	{
		...
		{
			if( ((int64)-(BASE_PARENT$1 != (struct $8FBSYMBOL*)0ull) | (int64)-((*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 16ll) & 2ll) == 0ll)) == 0ll ) goto label$150;
			{
			...
			label$150:;
			label$149:;
			struct $11FB_CALL_ARG* vr$20 = SYMBALLOCOVLCALLARG( (struct $5TLIST*)((uint8*)&PARSER$ + 224ll), ARG_LIST$1, -1ll );
			ARG$1 = vr$20;
			struct $7ASTNODE* vr$23 = ASTBUILDVARFIELD( *(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 136ll) + 104ll), (struct $8FBSYMBOL*)0ull, 0ll );
	...
	label$146:;
	{
		if( (OPTIONS$1 & 64ll) == 0ll ) goto label$152;
		{
			...
			*(struct $11FB_CALL_ARG**)((uint8*)ARG_LIST$1 + 8ll) = *(struct $11FB_CALL_ARG**)((uint8*)ARG$1 + 16ll);
			...
			LISTDELNODE( (struct $5TLIST*)((uint8*)&PARSER$ + 224ll), (void*)ARG$1 );
		}
		label$152:;
		label$151:;
	}
...
static int64 HPROCARG( struct $8FBSYMBOL* PROC$1, struct $8FBSYMBOL* PARAM$1, int64 ARGNUM$1, struct $7ASTNODE** EXPR$1, int64* AMODE$1, int64* HAVE_EQ_OUTSIDE_PARENS$1, $12FB_PARSEROPT OPTIONS$1 )
{
	...
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 312ll) = *(struct $8FBSYMBOL**)((uint8*)PARAM$1 + 64ll);
	*(int64*)((uint8*)&PARSER$ + 304ll) = *(int64*)((uint8*)PARAM$1 + 56ll) & 511ll;
	*(int64*)((uint8*)&PARSER$ + 320ll) = 0ll;
	struct $7ASTNODE* vr$9 = CEXPRESSION(  );
	*EXPR$1 = vr$9;
	*HAVE_EQ_OUTSIDE_PARENS$1 = *HAVE_EQ_OUTSIDE_PARENS$1 | *(int64*)((uint8*)&PARSER$ + 320ll);
	goto label$19;
	{
...
static struct $7ASTNODE* HOVLPROCARGLIST( struct $8FBSYMBOL* BASE_PARENT$1, struct $8FBSYMBOL* PROC$1, struct $16FB_CALL_ARG_LIST* ARG_LIST$1, $12FB_PARSEROPT OPTIONS$1 )
{
	...
	TMP$94$1 = *(struct $11FB_CALL_ARG**)((uint8*)*(struct $11FB_CALL_ARG**)((uint8*)ARG_LIST$1 + 8ll) + 16ll);
	goto label$193;
	label$112:;
	TMP$94$1 = *(struct $11FB_CALL_ARG**)((uint8*)ARG_LIST$1 + 8ll);
	label$193:;
	struct $8FBSYMBOL* vr$25 = SYMBFINDCLOSESTOVLPROC( PROC$1, ARGS$1, TMP$94$1, &ERR_NUM$1, LKUP_OPTIONS$1 );
	OVLPROC$1 = vr$25;
	if( OVLPROC$1 != (struct $8FBSYMBOL*)0ull ) goto label$114;
	{
		SYMBFREEOVLCALLARGS( (struct $5TLIST*)((uint8*)&PARSER$ + 224ll), ARG_LIST$1 );
	...
	if( vr$28 != 0ll ) goto label$118;
	{
		...
		TMP$95$2 = 202ll;
		label$194:;
		ERRREPORTEX( TMP$95$2, (uint8*)vr$29, 0ll, 1ll, (uint8*)0ull );
	...
	if( (*(int64*)((uint8*)PROC$1 + 16ll) & 2ll) == 0ll ) goto label$121;
	{
		...
		{
			if( ((int64)-(BASE_PARENT$1 != (struct $8FBSYMBOL*)0ull) | (int64)-((*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 16ll) & 2ll) == 0ll)) == 0ll ) goto label$125;
			{
				ERRREPORT( 214ll, -1ll, (uint8*)0ull );
			...
			label$125:;
			label$124:;
			struct $11FB_CALL_ARG* vr$43 = SYMBALLOCOVLCALLARG( (struct $5TLIST*)((uint8*)&PARSER$ + 224ll), ARG_LIST$1, -1ll );
			ARG$1 = vr$43;
			struct $7ASTNODE* vr$46 = ASTBUILDVARFIELD( *(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 136ll) + 104ll), (struct $8FBSYMBOL*)0ull, 0ll );
	...
	ARG$1 = *(struct $11FB_CALL_ARG**)((uint8*)ARG_LIST$1 + 8ll);
	{
		...
		I$1 = I$1 + 1ll;
		label$128:;
		if( I$1 <= TMP$96$2 ) goto label$131;
		label$130:;
	}
	PARAMS$1 = (int64)*(int16*)((uint8*)PROC$1 + 120ll);
	label$134:;
