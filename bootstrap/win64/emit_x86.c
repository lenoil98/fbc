...
uint8* HGETREGNAME( int64 DTYPE$1, int64 REG$1 )
{
	...
	label$116:;
	{
		...
		label$118:;
		TB$2 = *(int64*)((uint8*)DTYPETB$ + (TMP$145$2 * 24ll));
	...
	label$142:;
	{
		...
		label$146:;
		{
			...
			if( ADDPREFIX$1 == 0ll ) goto label$148;
			{
				...
				FBSTRING* vr$6 = fb_StrConcat( &TMP$156$4, (void*)OPERAND$1, -1ll, (void*)" [", 3ll );
			...
			if( IDX_OP$3 == (uint8*)0ull ) goto label$152;
			{
				...
				FBSTRING* vr$13 = fb_StrConcat( &TMP$158$4, (void*)OPERAND$1, -1ll, (void*)IDX_OP$3, 0ll );
			...
			if( OFS$1 <= 0ll ) goto label$156;
			{
				...
				{
					FBSTRING TMP$159$5;
					__builtin_memset( &TMP$159$5, 0, 24ll );
					FBSTRING* vr$19 = fb_StrConcat( &TMP$159$5, (void*)OPERAND$1, -1ll, (void*)"+", 2ll );
				...
				FBSTRING* vr$23 = fb_StrConcat( &TMP$160$4, (void*)OPERAND$1, -1ll, (void*)vr$20, -1ll );
			...
			if( OFS$1 >= 0ll ) goto label$159;
			{
				...
				FBSTRING* vr$27 = fb_StrConcat( &TMP$161$4, (void*)OPERAND$1, -1ll, (void*)vr$24, -1ll );
			...
			label$159:;
			{
				...
				{
					FBSTRING TMP$162$5;
					__builtin_memset( &TMP$162$5, 0, 24ll );
					FBSTRING* vr$30 = fb_StrConcat( &TMP$162$5, (void*)OPERAND$1, -1ll, (void*)"0", 2ll );
			...
			FBSTRING* vr$33 = fb_StrConcat( &TMP$164$3, (void*)OPERAND$1, -1ll, (void*)"]", 2ll );
		...
		label$162:;
		{
			...
			FBSTRING* vr$38 = fb_StrConcat( &TMP$166$3, (void*)OPERAND$1, -1ll, (void*)vr$35, 0ll );
			...
			if( *(int64*)((uint8*)VREG$1 + 64ll) == 0ll ) goto label$164;
			{
				...
				FBSTRING* vr$42 = fb_StrConcat( &TMP$168$4, (void*)OPERAND$1, -1ll, (void*)" + ", 4ll );
				...
				FBSTRING* vr$47 = fb_StrConcat( &TMP$169$4, (void*)OPERAND$1, -1ll, (void*)vr$44, -1ll );
...
void OUTP( uint8* S$1 )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 296ll) == 0ll ) goto label$187;
	{
		...
		FBSTRING* vr$2 = fb_StrConcat( &TMP$172$2, (void*)&OSTR$1, -1ll, (void*)S$1, 0ll );
...
void HBRANCH( uint8* MNEMONIC$1, uint8* LABEL$1 )
{
	...
	FBSTRING* vr$2 = fb_StrConcat( &TMP$175$1, (void*)&OSTR$1, -1ll, (void*)LABEL$1, 0ll );
	fb_StrAssign( (void*)&OSTR$1, -1ll, (void*)vr$2, -1ll, 0 );
...
void HPUSH( uint8* RNAME$1 )
{
	...
	FBSTRING* vr$2 = fb_StrConcat( &TMP$177$1, (void*)&OSTR$1, -1ll, (void*)RNAME$1, 0ll );
	fb_StrAssign( (void*)&OSTR$1, -1ll, (void*)vr$2, -1ll, 0 );
	OUTP( (uint8*)*(uint8**)&OSTR$1 );
	label$191:;
}
...
void HPOP( uint8* RNAME$1 )
{
	...
	FBSTRING* vr$2 = fb_StrConcat( &TMP$179$1, (void*)&OSTR$1, -1ll, (void*)RNAME$1, 0ll );
	fb_StrAssign( (void*)&OSTR$1, -1ll, (void*)vr$2, -1ll, 0 );
	OUTP( (uint8*)*(uint8**)&OSTR$1 );
	label$193:;
}
...
void HMOV( uint8* DNAME$1, uint8* SNAME$1 )
{
	...
	FBSTRING* vr$2 = fb_StrConcat( &TMP$181$1, (void*)&OSTR$1, -1ll, (void*)DNAME$1, 0ll );
	fb_StrAssign( (void*)&OSTR$1, -1ll, (void*)vr$2, -1ll, 0 );
	fb_StrConcatAssign( (void*)&OSTR$1, -1ll, (void*)", ", 3ll, 0 );
	__builtin_memset( &TMP$182$1, 0, 24ll );
	FBSTRING* vr$5 = fb_StrConcat( &TMP$182$1, (void*)&OSTR$1, -1ll, (void*)SNAME$1, 0ll );
...
void EMITVARINIF( int64 DTYPE$1, double VALUE$1 )
{
	...
	FBSTRING* vr$11 = fb_StrConcat( &TMP$927$1, (void*)vr$8, -1ll, (void*)"\x0D\x0A", 3ll );
...
void EMITVARINIPAD( int64 BYTES$1 )
{
	...
	FBSTRING* vr$10 = fb_StrConcat( &TMP$939$1, (void*)vr$7, -1ll, (void*)"\x0D\x0A", 3ll );
...
void EMITFBCTINFSTRING( uint8* S$1 )
{
	...
	uint8* vr$0 = (*(tmp$103*)((uint8*)&EMIT$ + 448ll))( 4ll );
...
int64 EMITGASX86_CTOR( void )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$1724:;
	static struct $9EMIT_VTBL _VTBL$1 = { (tmp$39)&_INIT, (tmp$38)&_END, (tmp$40)&_GETOPTIONVALUE, (tmp$39)&_OPEN, (tmp$38)&_CLOSE, (tmp$41)&_ISREGPRESERVED, (tmp$41)&_GETFREEPRESERVEDREG, (tmp$100)&_GETRESULTREG, (tmp$44)&_PROCGETFRAMEREGNAME, (tmp$42)&_PROCBEGIN, (tmp$42)&_PROCEND, (tmp$43)&_PROCHEADER, (tmp$101)&_PROCFOOTER, (tmp$43)&_PROCALLOCARG, (tmp$43)&_PROCALLOCLOCAL, (tmp$42)&_PROCALLOCSTATICVARS, (tmp$42)&_SCOPEBEGIN, (tmp$42)&_SCOPEEND, (tmp$102)&_SETSECTION, (tmp$103)&_GETTYPESTRING, (tmp$104)&_GETSECTIONSTRING };
...
static void HXCHG( uint8* DNAME$1, uint8* SNAME$1 )
{
	...
	FBSTRING* vr$2 = fb_StrConcat( &TMP$184$1, (void*)&OSTR$1, -1ll, (void*)DNAME$1, 0ll );
	fb_StrAssign( (void*)&OSTR$1, -1ll, (void*)vr$2, -1ll, 0 );
	fb_StrConcatAssign( (void*)&OSTR$1, -1ll, (void*)", ", 3ll, 0 );
	__builtin_memset( &TMP$185$1, 0, 24ll );
	FBSTRING* vr$5 = fb_StrConcat( &TMP$185$1, (void*)&OSTR$1, -1ll, (void*)SNAME$1, 0ll );
	fb_StrAssign( (void*)&OSTR$1, -1ll, (void*)vr$5, -1ll, 0 );
	OUTP( (uint8*)*(uint8**)&OSTR$1 );
	label$197:;
}
...
static void HPUBLIC( uint8* LABEL$1, int64 ISEXPORT$1 )
{
	...
	FBSTRING* vr$2 = fb_StrConcat( &TMP$191$1, (void*)&OSTR$1, -1ll, (void*)LABEL$1, 0ll );
	fb_StrAssign( (void*)&OSTR$1, -1ll, (void*)vr$2, -1ll, 0 );
	fb_StrConcatAssign( (void*)&OSTR$1, -1ll, (void*)"\x0D\x0A", 3ll, 0 );
	OUTEX( (uint8*)*(uint8**)&OSTR$1, 0ll );
	label$201:;
...
static void HINITREGTB( void )
{
	...
	static struct $8FBARRAY1I12REG_SIZEMASKE tmp$195$1 = { ($12REG_SIZEMASK*)INT_BITSMASK$1, ($12REG_SIZEMASK*)INT_BITSMASK$1, 48ll, 8ll, 1ll, 49ll, { { 6ll, 0ll, 5ll } } };
	struct $8REGCLASS* vr$3 = REGNEWCLASS( 0ll, 6ll, (struct $7FBARRAYI12REG_SIZEMASKE*)&tmp$195$1, 0ll );
	*(struct $8REGCLASS**)((uint8*)&EMIT$ + 16ll) = vr$3;
	static $12REG_SIZEMASK FLT_BITSMASK$1[7] = { 12ll, 12ll, 12ll, 12ll, 12ll, 12ll, 12ll };
	static struct $8FBARRAY1I12REG_SIZEMASKE tmp$196$1 = { ($12REG_SIZEMASK*)FLT_BITSMASK$1, ($12REG_SIZEMASK*)FLT_BITSMASK$1, 56ll, 8ll, 1ll, 49ll, { { 7ll, 0ll, 6ll } } };
	if( *(int64*)((uint8*)&ENV$ + 232ll) != 1ll ) goto label$209;
	{
		struct $8REGCLASS* vr$4 = REGNEWCLASS( 1ll, 7ll, (struct $7FBARRAYI12REG_SIZEMASKE*)&tmp$196$1, 0ll );
		*(struct $8REGCLASS**)((uint8*)&EMIT$ + 24ll) = vr$4;
		{
			...
			label$213:;
			{
				...
				FBSTRING* vr$8 = fb_StrConcat( &TMP$198$4, (void*)"xmm", 4ll, (void*)vr$5, -1ll );
	...
	label$209:;
	{
		struct $8REGCLASS* vr$12 = REGNEWCLASS( 1ll, 7ll, (struct $7FBARRAYI12REG_SIZEMASKE*)&tmp$196$1, -1ll );
...
static void HEMITVARBSS( struct $8FBSYMBOL* S$1 )
{
	...
	FBSTRING* vr$9 = fb_StrConcat( &TMP$201$1, (void*)&OSTR$1, -1ll, (void*)vr$6, 0ll );
...
static void HEMITVARCONST( struct $8FBSYMBOL* S$1 )
{
	...
	DTYPE$1 = *(int64*)((uint8*)S$1 + 56ll) & 511ll;
	{
		...
		label$240:;
		{
			...
			FBSTRING* vr$6 = fb_StrConcat( &TMP$206$3, (void*)&STEXT$1, -1ll, (void*)vr$3, 0ll );
		...
		label$241:;
		{
			FBSTRING TMP$209$3;
			fb_StrAssign( (void*)&STEXT$1, -1ll, (void*)"\x22", 2ll, 0 );
			uint8* vr$8 = HESCAPEW( *(uint16**)((uint8*)S$1 + 96ll) );
		...
		if( (TMP$204$2 - 4ull) > 3ull ) goto label$246;
		goto *tmp$991[TMP$204$2 - 4ull];
		label$238:;
	}
...
static void HEMITEXPORT( struct $8FBSYMBOL* S$1 )
{
	...
	if( (*(int64*)((uint8*)S$1 + 8ll) & 256ll) == 0ll ) goto label$264;
	{
		...
		FBSTRING* vr$10 = fb_StrConcat( &TMP$219$2, (void*)vr$7, -1ll, (void*)"\x22\x0D\x0A", 4ll );
	...
	if( (*(int64*)((uint8*)PROC$1 + 16ll) & 128ll) != 0ll ) goto label$329;
	{
		...
		if( *(int64*)((uint8*)&ENV$ + 216ll) != 3ll ) goto label$337;
		{
			if( *(int64*)((uint8*)&ENV$ + 360ll) == 0ll ) goto label$339;
			{
				...
				FBSTRING* vr$34 = fb_StrConcat( &TMP$268$4, (void*)vr$31, -1ll, (void*)"\x0D\x0A", 3ll );
...
static void HDESTROYFRAME( struct $8FBSYMBOL* PROC$1, int64 BYTESTOPOP$1 )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 216ll) != 2ll ) goto label$361;
	{
		...
		FBSTRING* vr$38 = fb_StrConcat( &TMP$287$2, (void*)vr$35, -1ll, (void*)"\x0D\x0A", 3ll );
...
static void _EMITLIT( uint8* S$1 )
{
	...
	FBSTRING* vr$3 = fb_StrConcat( &TMP$289$1, (void*)S$1, 0ll, (void*)"\x0D\x0A", 3ll );
...
static void _EMITJMPTB( struct $8FBSYMBOL* TBSYM$1, uint64* VALUES1$1, struct $8FBSYMBOL** LABELS1$1, int64 LABELCOUNT$1, struct $8FBSYMBOL* DEFLABEL$1, uint64 BIAS$1, uint64 SPAN$1 )
{
	...
	FBSTRING* vr$13 = fb_StrConcat( &TMP$291$1, (void*)vr$10, -1ll, (void*)"\x0D\x0A", 3ll );
...
static void _PROCFOOTER( struct $8FBSYMBOL* PROC$1, int64 BYTESTOPOP$1, struct $8FBSYMBOL* INITLABEL$1, struct $8FBSYMBOL* EXITLABEL$1 )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 216ll) != 2ll ) goto label$1672;
	{
		...
		FBSTRING* vr$18 = fb_StrConcat( &TMP$959$2, (void*)vr$15, -1ll, (void*)"\x0D\x0A", 3ll );
