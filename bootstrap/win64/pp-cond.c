...
void PPCONDIF( void )
{
	...
	ISTRUE$1 = 0ll;
	{
		...
		{
			LEXSKIPTOKEN( 2050ll );
			struct $10FBSYMCHAIN* vr$2 = CIDENTIFIER( &BASE_PARENT$1, 0ll );
			if( vr$2 == (struct $10FBSYMCHAIN*)0ull ) goto label$31;
			{
				ISTRUE$1 = -1ll;
			}
			label$31:;
		...
		label$32:;
		{
			...
			if( vr$4 != (struct $10FBSYMCHAIN*)0ull ) goto label$34;
			{
				ISTRUE$1 = -1ll;
			}
			label$34:;
		...
		if( (TMP$95$2 - 266ull) > 2ull ) goto label$27;
		goto *tmp$96[TMP$95$2 - 266ull];
		label$27:;
	}
	*(int64*)((uint8*)&PP$ + 384ll) = *(int64*)((uint8*)&PP$ + 384ll) + 1ll;
	if( *(int64*)((uint8*)&PP$ + 384ll) <= 64ll ) goto label$37;
	{
	...
	label$37:;
	label$36:;
	*(int64*)(((uint8*)PPTB$ + (*(int64*)((uint8*)&PP$ + 384ll) << (4ll & 63ll))) + -16ll) = ISTRUE$1;
	*(int64*)(((uint8*)PPTB$ + (*(int64*)((uint8*)&PP$ + 384ll) << (4ll & 63ll))) + -8ll) = 0ll;
	if( ISTRUE$1 != 0ll ) goto label$39;
	{
		PPSKIP(  );
	}
	label$39:;
...
void PPCONDELSE( void )
{
	...
	int64 ISTRUE$1;
	ISTRUE$1 = 0ll;
	if( *(int64*)((uint8*)&PP$ + 384ll) != 0ll ) goto label$43;
	{
	...
	label$43:;
	label$42:;
	if( *(int64*)(((uint8*)PPTB$ + (*(int64*)((uint8*)&PP$ + 384ll) << (4ll & 63ll))) + -8ll) <= 0ll ) goto label$45;
	{
	...
	if( vr$1 != 270ll ) goto label$47;
	{
		LEXSKIPTOKEN( 2048ll );
		int64 vr$2 = PPEXPRESSION(  );
		ISTRUE$1 = vr$2;
		if( *(int64*)(((uint8*)PPTB$ + (*(int64*)((uint8*)&PP$ + 384ll) << (4ll & 63ll))) + -16ll) == 0ll ) goto label$49;
		{
			PPSKIP(  );
			goto label$41;
		}
	...
	{
		LEXSKIPTOKEN( 2048ll );
		*(int64*)(((uint8*)PPTB$ + (*(int64*)((uint8*)&PP$ + 384ll) << (4ll & 63ll))) + -8ll) = *(int64*)(((uint8*)PPTB$ + (*(int64*)((uint8*)&PP$ + 384ll) << (4ll & 63ll))) + -8ll) + 1ll;
		*(int64*)(((uint8*)PPTB$ + (*(int64*)((uint8*)&PP$ + 384ll) << (4ll & 63ll))) + -16ll) = ~(*(int64*)(((uint8*)PPTB$ + (*(int64*)((uint8*)&PP$ + 384ll) << (4ll & 63ll))) + -16ll));
	}
	label$46:;
	if( *(int64*)(((uint8*)PPTB$ + (*(int64*)((uint8*)&PP$ + 384ll) << (4ll & 63ll))) + -16ll) != 0ll ) goto label$51;
	{
		PPSKIP(  );
	}
	label$51:;
...
void PPCONDENDIF( void )
{
	label$52:;
	LEXSKIPTOKEN( 2048ll );
	if( *(int64*)((uint8*)&PP$ + 384ll) <= 0ll ) goto label$55;
	{
		*(int64*)((uint8*)&PP$ + 384ll) = *(int64*)((uint8*)&PP$ + 384ll) + -1ll;
	}
	goto label$54;
...
static int64 PPEXPRESSION( void )
{
	...
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 296ll) = *(int64*)((uint8*)&PARSER$ + 296ll) | 1024ll;
	}
	goto label$16;
	label$17:;
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 296ll) = *(int64*)((uint8*)&PARSER$ + 296ll) & -1025ll;
	}
	label$16:;
...
static void PPSKIP( void )
{
	...
	*(int64*)((uint8*)&PP$ + 392ll) = -1ll;
	...
	{
		if( *(int64*)((uint8*)&ENV$ + 1224ll) != 0ll ) goto label$65;
		{
			struct $7ASTNODE* vr$1 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 25056ll) );
			ASTADD( vr$1 );
	...
	{
		{
			...
			TMP$97$3 = vr$5;
			if( TMP$97$3 != 35ll ) goto label$72;
			label$73:;
			{
				LEXSKIPTOKEN( 256ll );
				{
					...
					{
						{
							if( IFLEVEL$1 != *(int64*)((uint8*)&PP$ + 384ll) ) goto label$79;
							label$80:;
							{
							...
							goto label$78;
							label$79:;
							if( IFLEVEL$1 != 0ll ) goto label$81;
							label$82:;
							{
								ERRREPORT( 44ll, 0ll, (uint8*)0ull );
							}
					...
					{
						{
							if( IFLEVEL$1 != *(int64*)((uint8*)&PP$ + 384ll) ) goto label$85;
							label$86:;
							{
								*(int64*)((uint8*)&PP$ + 392ll) = 0ll;
								PPCONDENDIF(  );
							...
							goto label$84;
							label$85:;
							if( IFLEVEL$1 != 0ll ) goto label$87;
							label$88:;
							{
								ERRREPORT( 44ll, 0ll, (uint8*)0ull );
							}
					...
					if( (TMP$98$5 - 266ull) > 20ull ) goto label$91;
			...
			goto label$71;
			label$72:;
			if( TMP$97$3 != 256ll ) goto label$92;
			label$93:;
			{
