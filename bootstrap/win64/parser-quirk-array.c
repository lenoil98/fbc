...
struct $7ASTNODE* CARRAYFUNCT( $8FB_TOKEN TK$1 )
{
	...
	{
		if( TK$1 == 493ll ) goto label$95;
		label$96:;
		if( TK$1 != 494ll ) goto label$94;
		label$95:;
		{
			LEXSKIPTOKEN( 2048ll );
...
static int64 HSCOPEDSWAP( void )
{
	...
	int64 vr$38 = ASTCHECKASSIGN( L$1, R$1 );
	int64 vr$40 = ASTCHECKASSIGN( R$1, L$1 );
	...
	label$114:;
	USE_PUSHPOP$1 = USE_PUSHPOP$1 & (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$95$1 * 56ll)) + 8ll) == *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$96$1 * 56ll)) + 8ll));
	...
	goto label$116;
	label$80:;
	TMP$98$1 = RDTYPE$1 & 31ll;
	label$116:;
	USE_PUSHPOP$1 = USE_PUSHPOP$1 & (int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$97$1 * 56ll)) == *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$98$1 * 56ll)));
	if( *(int64*)L$1 != 19ll ) goto label$81;
	TMP$99$1 = (int64)-(*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)L$1 + 24ll) + 192ll) > 0ll);
	goto label$117;
	label$81:;
	TMP$99$1 = 0ll;
	label$117:;
	...
	TMP$100$1 = (int64)-(*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)R$1 + 24ll) + 192ll) > 0ll);
	goto label$118;
	label$82:;
	TMP$100$1 = 0ll;
	label$118:;
