...
struct $7ASTNODE* ASTFINDFIRSTCODE( struct $7ASTNODE* PROC$1 )
{
	...
	{
		{
			$13AST_NODECLASS TMP$96$3;
			TMP$96$3 = *($13AST_NODECLASS*)I$1;
			if( TMP$96$3 == 0ll ) goto label$93;
			label$94:;
			if( TMP$96$3 == 21ll ) goto label$93;
			label$95:;
			if( TMP$96$3 == 24ll ) goto label$93;
			label$96:;
			if( TMP$96$3 == 27ll ) goto label$93;
			label$97:;
			if( TMP$96$3 == 29ll ) goto label$93;
			label$98:;
			if( TMP$96$3 != 30ll ) goto label$92;
			label$93:;
			{
			}
			goto label$91;
...
void ASTPROCBEGIN( struct $8FBSYMBOL* SYM$1, int64 ISMAIN$1 )
{
	...
	*(uint8**)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)SYM$1 + 208ll) + 48ll) = *(uint8**)((uint8*)&ENV$ + 824ll);
	...
	*(struct $7ASTNODE**)((uint8*)&AST$ + 264ll) = N$1;
	...
	TMP$97$1 = 1ll;
	label$110:;
	*(uint64*)((uint8*)&PARSER$ + 192ll) = (uint64)TMP$97$1;
	...
	*(int64*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)SYM$1 + 208ll) + 104ll) = *(int64*)((uint8*)&PARSER$ + 56ll);
	if( (*(int64*)((uint8*)SYM$1 + 24ll) & 4096ll) == 0ll ) goto label$108;
	{
		...
		*(struct $7ASTNODE**)((uint8*)&ENV$ + 1240ll) = vr$38;
	}
	goto label$107;
	label$108:;
	if( ((int64)-((*(int64*)((uint8*)SYM$1 + 16ll) & 8ll) != 0ll) & ENABLE_IMPLICIT_CODE$1) == 0ll ) goto label$109;
	{
		struct $7ASTNODE* vr$45 = HINITVPTR( *(struct $8FBSYMBOL**)*(struct $8FBHASHTB**)((uint8*)SYM$1 + 248ll), SYM$1 );
		ASTADD( vr$45 );
	}
	label$109:;
	label$107:;
	struct $7ASTNODE* vr$47 = ASTNEWLABEL( *(struct $8FBSYMBOL**)((uint8*)N$1 + 64ll), -1ll );
	ASTADD( vr$47 );
	label$101:;
}
...
int64 ASTPROCEND( int64 CALLRTEXIT$1 )
{
	...
	*(int64*)((uint8*)N$1 + 56ll) = *(int64*)((uint8*)&PARSER$ + 56ll);
	...
	ASTADD( vr$19 );
	int64 vr$21 = SYMBCHECKLABELS( *(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 104ll) );
	...
	if( RES$1 == 0ll ) goto label$148;
	{
		...
		{
			int64 vr$28 = ASTSCOPEUPDBREAKLIST( N$1 );
			RES$1 = vr$28;
		}
		label$152:;
		label$151:;
		...
		{
			struct $7ASTNODE* vr$30 = HCALLPROFILER( HEAD_NODE$2 );
			HEAD_NODE$2 = vr$30;
			struct $7ASTNODE* vr$31 = HCHECKERRHND( HEAD_NODE$2, SYM$1 );
			HEAD_NODE$2 = vr$31;
		}
		label$154:;
		label$153:;
		...
		{
			if( (*(int64*)((uint8*)SYM$1 + 56ll) & 511ll) == 0ll ) goto label$162;
			{
				struct $7ASTNODE* vr$35 = HMAYBECALLRESULTCTOR( HEAD_NODE$2, SYM$1 );
				HEAD_NODE$2 = vr$35;
	...
	label$148:;
	label$147:;
	(*(tmp$42*)((uint8*)&IR$ + 64ll))( SYM$1 );
	DO_FLUSH$1 = 0ll;
	int64 vr$36 = ERRGETCOUNT(  );
	if( (RES$1 & (int64)-(vr$36 == 0ll)) == 0ll ) goto label$164;
	{
		*($12FB_SYMBSTATS*)((uint8*)SYM$1 + 24ll) = *(int64*)((uint8*)SYM$1 + 24ll) | 128ll;
		if( REC_CNT$1 != 1ll ) goto label$166;
		{
			...
			{
				int64 vr$46 = SYMBPROCHASFWDREFINSIGNATURE( SYM$1 );
				if( ((int64)-((*(int64*)((uint8*)SYM$1 + 8ll) & 64ll) == 0ll) & (~vr$46 | (int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 0ll))) == 0ll ) goto label$170;
				{
					DO_FLUSH$1 = -1ll;
				}
				goto label$169;
	...
	{
		if( *(int64*)((uint8*)&ENV$ + 208ll) != 0ll ) goto label$174;
		{
	...
	label$172:;
	label$171:;
	if( DO_FLUSH$1 == 0ll ) goto label$176;
	{
		if( *(int64*)((uint8*)N$1 + 96ll) != 0ll ) goto label$178;
		{
			HPROCFLUSH( N$1, -1ll );
		}
		goto label$177;
	...
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) = *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1232ll);
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 216ll) = *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 1232ll);
	REC_CNT$1 = REC_CNT$1 + -1ll;
	fb$result$1 = RES$1;
	label$140:;
	return fb$result$1;
...
struct $8FBSYMBOL* ASTPROCADDSTATICINSTANCE( struct $8FBSYMBOL* SYM$1 )
{
	...
	DTORLIST$1 = *(struct $5TLIST**)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 208ll) + 88ll);
	if( DTORLIST$1 != (struct $5TLIST*)0ull ) goto label$328;
	{
		void* vr$3 = XCALLOCATE( 64 );
		DTORLIST$1 = (struct $5TLIST*)vr$3;
		*(struct $5TLIST**)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) + 208ll) + 88ll) = DTORLIST$1;
...
void ASTPROCADDGLOBALINSTANCE( struct $8FBSYMBOL* SYM$1, struct $7ASTNODE* INITREE$1, int64 CALL_DTOR$1 )
{
	...
	*($12FB_SYMBSTATS*)((uint8*)SYM$1 + 24ll) = *(int64*)((uint8*)SYM$1 + 24ll) | 8388608ll;
	if( INITREE$1 == (struct $7ASTNODE*)0ull ) goto label$332;
	{
		*(int64*)((uint8*)&AST$ + 216ll) = *(int64*)((uint8*)&AST$ + 216ll) + 1ll;
	}
	label$332:;
	label$331:;
	if( CALL_DTOR$1 == 0ll ) goto label$334;
	{
...
static void HPROCFLUSH( struct $7ASTNODE* P$1, int64 DOEMIT$1 )
{
	...
	*(int64*)((uint8*)&AST$ + 272ll) = DOEMIT$1;
	...
	TMP$95$1 = 1ll;
	label$354:;
	*(uint64*)((uint8*)&PARSER$ + 192ll) = (uint64)TMP$95$1;
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) = SYM$1;
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 216ll) = SYM$1;
	SYMBNESTBEGIN( SYM$1, 0ll );
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$30;
	{
		*($12FB_SYMBSTATS*)((uint8*)SYM$1 + 24ll) = *(int64*)((uint8*)SYM$1 + 24ll) | 16777216ll;
		(*(tmp$43*)((uint8*)&IR$ + 152ll))( SYM$1, *(struct $8FBSYMBOL**)((uint8*)P$1 + 64ll) );
	...
	{
		(*(tmp$47*)((uint8*)&IR$ + 160ll))( SYM$1, *(struct $8FBSYMBOL**)((uint8*)P$1 + 64ll), *(struct $8FBSYMBOL**)((uint8*)P$1 + 72ll) );
		(*(tmp$42*)((uint8*)&IR$ + 112ll))( *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 104ll) );
	}
	label$34:;
	label$33:;
	SYMBDELSYMBOLTB( (struct $10FBSYMBOLTB*)((uint8*)SYM$1 + 96ll), 0ll );
...
static struct $7ASTNODE* HCHECKERRHND( struct $7ASTNODE* HEAD_NODE$1, struct $8FBSYMBOL* SYM$1 )
{
	...
	{
		struct $7ASTNODE* vr$2 = ASTNEWCONSTSTR( (uint8*)((uint8*)&ENV$ + 560ll) );
	...
	label$113:;
	{
		...
		if( *(struct $8FBSYMBOL**)((uint8*)TMP$99$2 + 16ll) == (struct $8FBSYMBOL*)0ull ) goto label$116;
		{
			struct $7ASTNODE* vr$14 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)TMP$99$2 + 16ll), 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
		...
		label$116:;
		label$115:;
		if( *(struct $8FBSYMBOL**)((uint8*)TMP$99$2 + 8ll) == (struct $8FBSYMBOL*)0ull ) goto label$118;
		{
			struct $7ASTNODE* vr$19 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)TMP$99$2 + 8ll), 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
		...
		label$118:;
		label$117:;
		if( *(struct $8FBSYMBOL**)TMP$99$2 == (struct $8FBSYMBOL*)0ull ) goto label$120;
		{
			struct $7ASTNODE* vr$24 = ASTNEWVAR( *(struct $8FBSYMBOL**)TMP$99$2, 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
...
static struct $7ASTNODE* HCALLPROFILER( struct $7ASTNODE* HEAD_NODE$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$133:;
	if( *(int64*)((uint8*)&ENV$ + 360ll) == 0ll ) goto label$136;
	{
...
static int64 HDECLVARSFORPROCPARAMS( struct $8FBSYMBOL* PROC$1 )
{
	...
	fb$result$1 = 0ll;
	if( (*(int64*)((uint8*)PROC$1 + 56ll) & 511ll) != 20ll ) goto label$182;
	{
	...
	label$181:;
	I$1 = 1ll;
	if( *(int64*)((uint8*)PROC$1 + 152ll) != 4ll ) goto label$183;
	TMP$100$1 = *(struct $8FBSYMBOL**)((uint8*)PROC$1 + 144ll);
	goto label$355;
	label$183:;
	TMP$100$1 = *(struct $8FBSYMBOL**)((uint8*)PROC$1 + 136ll);
	label$355:;
	P$1 = TMP$100$1;
	label$184:;
	if( P$1 == (struct $8FBSYMBOL*)0ull ) goto label$185;
	{
		struct $8FBSYMBOL* TMP$101$2;
		if( *(int64*)((uint8*)P$1 + 96ll) == 4ll ) goto label$187;
		{
			struct $8FBSYMBOL* vr$7 = SYMBADDVARFORPARAM( P$1 );
			*(struct $8FBSYMBOL**)((uint8*)P$1 + 104ll) = vr$7;
			if( *(struct $8FBSYMBOL**)((uint8*)P$1 + 104ll) != (struct $8FBSYMBOL*)0ull ) goto label$189;
			{
		...
		label$187:;
		label$186:;
		if( *(int64*)((uint8*)PROC$1 + 152ll) != 4ll ) goto label$190;
		TMP$101$2 = *(struct $8FBSYMBOL**)((uint8*)P$1 + 304ll);
		goto label$356;
		label$190:;
		TMP$101$2 = *(struct $8FBSYMBOL**)((uint8*)P$1 + 312ll);
		label$356:;
		P$1 = TMP$101$2;
		I$1 = I$1 + 1ll;
	}
...
static void HLOADPROCRESULT( struct $8FBSYMBOL* PROC$1 )
{
	...
	S$1 = vr$0;
	if( ((int64)-((*(int64*)((uint8*)PROC$1 + 56ll) & 511ll) == 17ll) & (int64)-((*(int64*)((uint8*)PROC$1 + 16ll) & 2048ll) == 0ll)) == 0ll ) goto label$194;
	{
		struct $7ASTNODE* vr$8 = ASTNEWVAR( S$1, 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
		struct $7ASTNODE* vr$9 = RTLSTRALLOCTMPRESULT( vr$8 );
		N$1 = vr$9;
		if( (((int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 1ll) | (int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 2ll)) | (int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 3ll)) == 0ll ) goto label$196;
		{
...
static int64 HMODLEVELISEMPTY( struct $7ASTNODE* P$1 )
{
	...
	struct $7ASTNODE* NXT$1;
	N$1 = *(struct $7ASTNODE**)((uint8*)P$1 + 112ll);
	if( N$1 != (struct $7ASTNODE*)0ull ) goto label$200;
	{
		fb$result$1 = -1ll;
		goto label$198;
	}
	label$200:;
	label$199:;
	if( *(int64*)N$1 == 21ll ) goto label$202;
	{
		fb$result$1 = 0ll;
		goto label$198;
	}
	...
	label$204:;
	label$203:;
	if( *(int64*)N$1 == 21ll ) goto label$206;
	{
		fb$result$1 = 0ll;
		goto label$198;
	}
	...
	label$205:;
	N$1 = *(struct $7ASTNODE**)((uint8*)N$1 + 136ll);
	if( N$1 != (struct $7ASTNODE*)0ull ) goto label$208;
	{
		fb$result$1 = -1ll;
		goto label$198;
	}
...
static struct $7ASTNODE* HCALLCTORLIST( int64 IS_CTOR$1, struct $8FBSYMBOL* THIS_$1, struct $8FBSYMBOL* FLD$1 )
{
	...
	label$219:;
	if( IS_CTOR$1 == 0ll ) goto label$221;
	TMP$102$1 = 1ll;
	goto label$357;
	label$221:;
	TMP$102$1 = -1ll;
	label$357:;
	struct $7ASTNODE* vr$40 = ASTBUILDVARINC( ITER$1, TMP$102$1 );
...
static struct $7ASTNODE* HCALLFIELDCTOR( struct $8FBSYMBOL* THIS_$1, struct $8FBSYMBOL* FLD$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$222:;
	if( (*(int64*)((uint8*)FLD$1 + 8ll) & 4ll) == 0ll ) goto label$225;
	{
		goto label$223;
	}
	label$225:;
	label$224:;
	if( (*(int64*)((uint8*)FLD$1 + 24ll) & 2048ll) == 0ll ) goto label$227;
	{
		goto label$223;
	}
	label$227:;
	...
	if( vr$5 == 0ll ) goto label$229;
	{
		if( *(int64*)((uint8*)FLD$1 + 104ll) != 0ll ) goto label$231;
		{
	...
	label$229:;
	label$228:;
	if( *(int64*)((uint8*)FLD$1 + 192ll) <= 0ll ) goto label$233;
	{
...
static struct $7ASTNODE* HCLEARUNIONFIELDS( struct $8FBSYMBOL* THIS_$1, struct $8FBSYMBOL* BASE_FLD$1, struct $8FBSYMBOL** PFINALFIELD$1 )
{
	...
	label$236:;
	{
		...
		if( LGT$1 <= BYTES$1 ) goto label$240;
		{
			BYTES$1 = LGT$1;
		}
		label$240:;
	...
	label$238:;
	if( FLD$1 == (struct $8FBSYMBOL*)0ull ) goto label$241;
	TMP$103$1 = (int64)-((struct $8FBSYMBOL*)(int64)-(*(int64*)FLD$1 == 12ll) != (struct $8FBSYMBOL*)0ull);
	goto label$358;
	label$241:;
	TMP$103$1 = 0ll;
	label$358:;
	if( TMP$103$1 == 0ll ) goto label$242;
	TMP$104$1 = (int64)-((*(int64*)((uint8*)FLD$1 + 24ll) & 16777216ll) != 0ll);
	goto label$359;
	label$242:;
	TMP$104$1 = 0ll;
	label$359:;
	if( TMP$104$1 != 0ll ) goto label$236;
	label$237:;
	*PFINALFIELD$1 = FLD$1;
...
static struct $7ASTNODE* HINITDYNAMICARRAYFIELD( struct $8FBSYMBOL* THIS_$1, struct $8FBSYMBOL* FLD$1 )
{
	...
	struct $8FBARRAY2IP7ASTNODEE tmp$105$1;
	*(struct $7ASTNODE***)&tmp$105$1 = (struct $7ASTNODE**)EXPRTB$1;
	*(struct $7ASTNODE***)((uint8*)&tmp$105$1 + 8ll) = (struct $7ASTNODE**)EXPRTB$1;
	*(int64*)((uint8*)&tmp$105$1 + 16ll) = 128ll;
	*(int64*)((uint8*)&tmp$105$1 + 24ll) = 8ll;
	*(int64*)((uint8*)&tmp$105$1 + 32ll) = 2ll;
	*(int64*)((uint8*)&tmp$105$1 + 40ll) = 50ll;
	*(int64*)((uint8*)&tmp$105$1 + 48ll) = 8ll;
	*(int64*)((uint8*)&tmp$105$1 + 56ll) = 0ll;
	*(int64*)((uint8*)&tmp$105$1 + 64ll) = 7ll;
	*(int64*)((uint8*)&tmp$105$1 + 72ll) = 2ll;
	*(int64*)((uint8*)&tmp$105$1 + 80ll) = 0ll;
	*(int64*)((uint8*)&tmp$105$1 + 88ll) = 1ll;
	...
	label$245:;
	{
		*(struct $7ASTNODE**)((uint8*)EXPRTB$1 + (DIMENSIONS$1 << (4ll & 63ll))) = *(struct $7ASTNODE**)((uint8*)N$1 + 112ll);
		*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) = (struct $7ASTNODE*)0ull;
		N$1 = *(struct $7ASTNODE**)((uint8*)N$1 + 120ll);
		*(struct $7ASTNODE**)(((uint8*)EXPRTB$1 + (DIMENSIONS$1 << (4ll & 63ll))) + 8ll) = *(struct $7ASTNODE**)((uint8*)N$1 + 112ll);
		*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) = (struct $7ASTNODE*)0ull;
		N$1 = *(struct $7ASTNODE**)((uint8*)N$1 + 120ll);
		DIMENSIONS$1 = DIMENSIONS$1 + 1ll;
	}
	label$247:;
	if( N$1 != (struct $7ASTNODE*)0ull ) goto label$245;
	label$246:;
	ASTDELTREE( BOUNDSTYPEINI$1 );
	struct $7ASTNODE* vr$20 = ASTBUILDVARFIELD( THIS_$1, FLD$1, 0ll );
	struct $7ASTNODE* vr$21 = RTLARRAYREDIM( vr$20, DIMENSIONS$1, (struct $7FBARRAYIP7ASTNODEE*)&tmp$105$1, 0ll, (int64)-((*(int64*)((uint8*)FLD$1 + 24ll) & 2048ll) == 0ll) );
	fb$result$1 = vr$21;
	label$244:;
	return fb$result$1;
}
...
static struct $7ASTNODE* HCALLFIELDCTORS( struct $8FBSYMBOL* PARENT$1, struct $8FBSYMBOL* PROC$1 )
{
	...
	label$250:;
	if( FLD$1 == (struct $8FBSYMBOL*)0ull ) goto label$251;
	{
		if( *(int64*)FLD$1 != 12ll ) goto label$253;
		{
			if( FLD$1 == *(struct $8FBSYMBOL**)((uint8*)PARENT$1 + 176ll) ) goto label$255;
			{
				if( (*(int64*)((uint8*)FLD$1 + 24ll) & 16777216ll) == 0ll ) goto label$257;
				{
				...
				label$257:;
				{
					if( *(struct $7ASTNODE**)((uint8*)FLD$1 + 96ll) != (struct $7ASTNODE*)0ull ) goto label$259;
					{
					...
					goto label$258;
					label$259:;
					if( (*(int64*)((uint8*)FLD$1 + 8ll) & 4ll) == 0ll ) goto label$260;
					{
...
static struct $7ASTNODE* HCALLBASECTOR( struct $8FBSYMBOL* PARENT$1, struct $8FBSYMBOL* PROC$1 )
{
	...
	if( BASE_$1 != (struct $8FBSYMBOL*)0ull ) goto label$264;
	{
		goto label$262;
	}
	label$264:;
	...
	if( INITREE$1 == (struct $7ASTNODE*)0ull ) goto label$266;
	{
	...
	DEFCTOR$1 = vr$11;
	if( DEFCTOR$1 == (struct $8FBSYMBOL*)0ull ) goto label$268;
	{
		int64 vr$12 = SYMBCHECKACCESS( DEFCTOR$1 );
		if( vr$12 != 0ll ) goto label$270;
		{
	...
	if( vr$13 == (struct $8FBSYMBOL*)0ull ) goto label$271;
	{
...
static struct $7ASTNODE* HINITVPTR( struct $8FBSYMBOL* PARENT$1, struct $8FBSYMBOL* PROC$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$272:;
	if( (*(int64*)((uint8*)PARENT$1 + 24ll) & 4194304ll) != 0ll ) goto label$275;
	{
		goto label$273;
	}
	label$275:;
	...
	struct $8FBSYMBOL* THIS_$1;
	THIS_$1 = *(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)PROC$1 + 136ll) + 104ll);
	struct $7ASTNODE* vr$8 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)*(struct $12FB_STRUCTEXT**)((uint8*)PARENT$1 + 240ll) + 288ll), *(int64*)((uint8*)&ENV$ + 544ll) << (1ll & 63ll), 2147483648ll, (struct $8FBSYMBOL*)0ull );
...
static void HCALLCTORS( struct $7ASTNODE* N$1, struct $8FBSYMBOL* SYM$1 )
{
	...
	N$1 = vr$7;
	if( N$1 == (struct $7ASTNODE*)0ull ) goto label$279;
	{
...
{
	label$280:;
	if( (*(int64*)((uint8*)FLD$1 + 8ll) & 4ll) == 0ll ) goto label$283;
	{
	...
	goto label$282;
	label$283:;
	if( *(int64*)((uint8*)FLD$1 + 104ll) != 0ll ) goto label$284;
	{
		if( (*(int64*)((uint8*)FLD$1 + 56ll) & 511ll) != 17ll ) goto label$286;
		{
			struct $7ASTNODE* vr$7 = ASTBUILDVARFIELD( THIS_$1, FLD$1, 0ll );
	...
	label$284:;
	{
		if( (*(int64*)((uint8*)FLD$1 + 56ll) & 511ll) != 17ll ) goto label$289;
		{
...
static void HCALLFIELDDTORS( struct $8FBSYMBOL* PARENT$1, struct $8FBSYMBOL* PROC$1 )
{
	...
	label$293:;
	if( FLD$1 == (struct $8FBSYMBOL*)0ull ) goto label$294;
	{
		if( *(int64*)FLD$1 != 12ll ) goto label$296;
		{
			if( (((int64)-((*(int64*)((uint8*)FLD$1 + 8ll) & 8192ll) == 0ll) & (int64)-(FLD$1 != *(struct $8FBSYMBOL**)((uint8*)PARENT$1 + 176ll))) & (int64)-((*(int64*)((uint8*)FLD$1 + 8ll) & 262144ll) == 0ll)) == 0ll ) goto label$298;
			{
...
static void HCALLBASEDTOR( struct $8FBSYMBOL* PARENT$1, struct $8FBSYMBOL* PROC$1 )
{
	...
	struct $8FBSYMBOL* THIS_$1;
	BASE_$1 = *(struct $8FBSYMBOL**)((uint8*)PARENT$1 + 176ll);
	if( BASE_$1 != (struct $8FBSYMBOL*)0ull ) goto label$302;
	{
		goto label$300;
	}
	label$302:;
	label$301:;
	struct $8FBSYMBOL* vr$2 = SYMBGETCOMPDTOR( *(struct $8FBSYMBOL**)((uint8*)BASE_$1 + 64ll) );
	DTOR$1 = vr$2;
	if( DTOR$1 != (struct $8FBSYMBOL*)0ull ) goto label$304;
	{
		goto label$300;
	}
	label$304:;
	...
	if( vr$3 != 0ll ) goto label$306;
	{
		ERRREPORT( 208ll, 0ll, (uint8*)0ull );
	}
	label$306:;
	label$305:;
	if( (*(int64*)((uint8*)DTOR$1 + 16ll) & 512ll) == 0ll ) goto label$308;
	{
		goto label$300;
	}
	label$308:;
...
{
	label$313:;
	if( (*(int64*)((uint8*)SYM$1 + 8ll) & 4ll) == 0ll ) goto label$316;
	{
	...
	label$316:;
	{
		if( *(int64*)((uint8*)SYM$1 + 104ll) != 0ll ) goto label$318;
		{
...
static void HGENSTATICINSTANCESDTORS( struct $8FBSYMBOL* PROC$1 )
{
	...
	if( DTORLIST$1 != (struct $5TLIST*)0ull ) goto label$322;
	{
		goto label$320;
	}
	label$322:;
	...
	label$323:;
	if( WRAP$1 == (struct $14FB_DTORWRAPPER*)0ull ) goto label$324;
	{
...
static void HGLOBCTORBEGIN( int64 IS_CTOR$1 )
{
	...
	TMP$106$1 = (uint8*)"_GLOBAL__I";
	goto label$360;
	label$337:;
	TMP$106$1 = (uint8*)"_GLOBAL__D";
	label$360:;
	uint8* vr$0 = SYMBUNIQUELABEL(  );
	struct $8FBSYMBOL* vr$1 = SYMBPREADDPROC( (uint8*)0ull );
	struct $8FBSYMBOL* vr$2 = SYMBADDPROC( vr$1, (uint8*)vr$0, (uint8*)TMP$106$1, 0ll, (struct $8FBSYMBOL*)0ull, 64ll, 0ll, 3ll, 4ll );
	PROC$1 = vr$2;
	if( IS_CTOR$1 == 0ll ) goto label$339;
	{
...
static void HGENGLOBALINSTANCESCTOR( void )
{
	...
	struct $8FBSYMBOL* SYM$1;
	if( *(int64*)((uint8*)&AST$ + 216ll) <= 0ll ) goto label$343;
	{
		HGLOBCTORBEGIN( -1ll );
		void* vr$1 = LISTGETHEAD( (struct $5TLIST*)((uint8*)&AST$ + 152ll) );
		INST$1 = (struct $15FB_GLOBINSTANCE*)vr$1;
		label$344:;
		if( INST$1 == (struct $15FB_GLOBINSTANCE*)0ull ) goto label$345;
		{
			if( *(struct $7ASTNODE**)((uint8*)INST$1 + 8ll) == (struct $7ASTNODE*)0ull ) goto label$347;
			{
	...
	label$343:;
	label$342:;
	if( *(int64*)((uint8*)&AST$ + 224ll) <= 0ll ) goto label$349;
	{
		HGLOBCTORBEGIN( 0ll );
		...
		{
			if( *(int64*)((uint8*)INST$1 + 16ll) == 0ll ) goto label$353;
			{
