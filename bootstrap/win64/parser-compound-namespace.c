...
void CNAMESPACESTMTBEGIN( void )
{
	...
	int64 LEVELS$1;
	if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 4ll) != 0ll ) goto label$17;
	{
	...
	PALIAS$1 = (uint8*)0ull;
	{
		...
		if( (TMP$94$2 - 256ull) > 4ull ) goto label$20;
		goto *tmp$96[TMP$94$2 - 256ull];
		label$20:;
	}
	LEVELS$1 = 0ll;
	label$23:;
...
void CUSINGSTMT( void )
{
	label$64:;
	struct $8FBSYMBOL* SYM$1;
	if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 4ll) != 0ll ) goto label$67;
	{
		ERRREPORTNOTALLOWED( 4ll, 146ll, (uint8*)0ull );
		HSKIPUNTIL( -1ll, 0ll, 0ll, 0ll );
		goto label$65;
