...
void CTYPEDECL( $13FB_SYMBATTRIB ATTRIB$1 )
{
	...
	CHECKID$1 = -1ll;
	{
		...
		if( TMP$104$2 > 2ull ) goto label$276;
	...
	if( CHECKID$1 == 0ll ) goto label$278;
	{
		...
		if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 524288ll) == 0ll ) goto label$280;
		{
			...
			{
				if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8520ll) + 2096ll) <= 0ll ) goto label$284;
				{
...
static uint8* HFIELDID( struct $8FBSYMBOL* PARENT$1 )
{
	...
	static uint8 ID$1[129];
	{
		...
		TMP$96$2 = vr$1;
		if( TMP$96$2 == 0ll ) goto label$130;
		label$131:;
		if( TMP$96$2 == 1ll ) goto label$130;
		label$132:;
		if( TMP$96$2 != 2ll ) goto label$129;
		label$130:;
		{
			if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8520ll) + 16ll) == 2147483648ll ) goto label$134;
			{
				ERRREPORT( 17ll, 0ll, (uint8*)0ull );
			}
			label$134:;
			label$133:;
			if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8520ll) + 2096ll) <= 0ll ) goto label$136;
			{
				ERRREPORT( 90ll, 0ll, (uint8*)0ull );
			}
			label$136:;
...
static struct $8FBSYMBOL* HTYPEADD( struct $8FBSYMBOL* PARENT$1, uint8* ID$1, uint8* ID_ALIAS$1, int64 ISUNION$1, int64 ALIGN$1, int64 BASEDTYPE$1, struct $8FBSYMBOL* BASESUBTYPE$1, int64 BASESTRINGTYPE$1 )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 296ll) == 0ll ) goto label$171;
	{
		...
		{
			struct $7ASTNODE* vr$17 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 25056ll) );
			ASTADD( vr$17 );
	...
	label$177:;
	{
		...
		TMP$99$2 = 336ll;
		label$355:;
		if( vr$25 == TMP$99$2 ) goto label$180;
		{
			ERRREPORT( 19ll, 0ll, (uint8*)0ull );
			HSKIPUNTIL( -1ll, 0ll, 0ll, 0ll );
		}
	...
	{
		{
			...
			label$202:;
			{
				...
				label$203:;
				{
					...
					TMP$101$5 = vr$4;
					if( TMP$101$5 != 378ll ) goto label$206;
					label$207:;
					{
						ATTRIB$1 = 0ll;
					}
					goto label$205;
					label$206:;
					if( TMP$101$5 != 379ll ) goto label$208;
					label$209:;
					{
						ATTRIB$1 = 2097152ll;
					}
					goto label$205;
					label$208:;
					if( TMP$101$5 != 380ll ) goto label$210;
					label$211:;
					{
						ATTRIB$1 = 4194304ll;
					}
			...
			{
				{
					...
					TMP$102$5 = vr$6;
					if( TMP$102$5 == 376ll ) goto label$220;
					label$221:;
					if( TMP$102$5 == 40ll ) goto label$220;
					label$222:;
					if( TMP$102$5 != 258ll ) goto label$219;
					label$220:;
					{
			...
			{
				{
					...
					goto label$225;
					label$226:;
					static const void* tmp$108[236ll] = {
						&&label$227,
						&&label$227,
						&&label$237,
						&&label$227,
					...
					if( (TMP$103$5 - 256ull) > 235ull ) goto label$240;
					goto *tmp$108[TMP$103$5 - 256ull];
					label$225:;
				}
			}
			goto label$200;
			...
			if( (TMP$100$3 - 256ull) > 124ull ) goto label$247;
			goto *tmp$109[TMP$100$3 - 256ull];
			label$200:;
		}
		CCOMMENT( 0ll );
		if( *(int64*)((uint8*)&ENV$ + 296ll) == 0ll ) goto label$249;
		{
			...
			{
				struct $7ASTNODE* vr$39 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 25056ll) );
				ASTADD( vr$39 );
				DZSTRRESET( (struct $8DZSTRING*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 25056ll) );
			}
			label$251:;
