...
void ERRREPORTEX( int64 ERRNUM$1, uint8* MSGEX$1, int64 LINENUM$1, $12FB_ERRMSGOPT OPTIONS$1, uint8* CUSTOMTEXT$1 )
{
	...
	if( LINENUM$1 != 0ll ) goto label$68;
	{
		...
		label$70:;
		label$69:;
		if( *(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) == (struct $9LEX_TKCTX*)0ull ) goto label$72;
		{
			LINENUM$1 = *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8552ll);
		}
		label$72:;
		label$71:;
...
void ERRREPORTWARNEX( int64 MSGNUM$1, uint8* MSGEX$1, int64 LINENUM$1, $12FB_ERRMSGOPT OPTIONS$1, uint8* CUSTOMTEXT$1 )
{
	...
	if( LINENUM$1 <= 0ll ) goto label$110;
	{
		...
		FBSTRING* vr$13 = fb_StrConcat( &TMP$482$2, (void*)"(", 2ll, (void*)vr$10, -1ll );
		__builtin_memset( &TMP$483$2, 0, 24ll );
		FBSTRING* vr$16 = fb_StrConcat( &TMP$483$2, (void*)vr$13, -1ll, (void*)")", 2ll );
	...
	FBSTRING* vr$23 = fb_StrConcat( &TMP$487$1, (void*)" warning ", 10ll, (void*)vr$20, -1ll );
	__builtin_memset( &TMP$488$1, 0, 24ll );
	FBSTRING* vr$26 = fb_StrConcat( &TMP$488$1, (void*)vr$23, -1ll, (void*)"(", 2ll );
	__builtin_memset( &TMP$489$1, 0, 24ll );
	FBSTRING* vr$29 = fb_StrConcat( &TMP$489$1, (void*)vr$26, -1ll, (void*)vr$19, -1ll );
	__builtin_memset( &TMP$490$1, 0, 24ll );
	FBSTRING* vr$32 = fb_StrConcat( &TMP$490$1, (void*)vr$29, -1ll, (void*)"): ", 4ll );
...
{
	label$122:;
	ERRREPORTWARNEX( MSGNUM$1, MSGEX$1, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 426496ll) + 8552ll), OPTIONS$1, CUSTOMTEXT$1 );
	label$123:;
}
...
static void HPRINTERRMSG( int64 ERRNUM$1, uint8* MSGEX$1, $12FB_ERRMSGOPT OPTIONS$1, int64 LINENUM$1, int64 SHOWERROR$1, uint8* CUSTOMTEXT$1 )
{
	...
	if( ERRNUM$1 < 0ll ) goto label$41;
	{
		...
		FBSTRING* vr$15 = fb_StrConcat( &TMP$469$2, (void*)" ", 2ll, (void*)vr$12, -1ll );
		__builtin_memset( &TMP$470$2, 0, 24ll );
		FBSTRING* vr$18 = fb_StrConcat( &TMP$470$2, (void*)vr$15, -1ll, (void*)": ", 3ll );
		__builtin_memset( &TMP$471$2, 0, 24ll );
		FBSTRING* vr$21 = fb_StrConcat( &TMP$471$2, (void*)vr$18, -1ll, (void*)MSG$1, 0ll );
		...
		if( SHOWERROR$1 == 0ll ) goto label$56;
		{
			...
			if( vr$38 <= 0ll ) goto label$58;
			{
				if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 256ll) == 0ll ) goto label$60;
				{
					...
					FBSTRING* vr$42 = fb_StrConcat( &TMP$476$5, (void*)" in '", 6ll, (void*)&LN$3, -1ll );
					__builtin_memset( &TMP$477$5, 0, 24ll );
					FBSTRING* vr$45 = fb_StrConcat( &TMP$477$5, (void*)vr$42, -1ll, (void*)"'", 2ll );
	...
	{
		{
			...
			TMP$478$3 = vr$3;
			if( TMP$478$3 <= 32ll ) goto label$83;
			label$84:;
			if( TMP$478$3 == 257ll ) goto label$83;
			label$85:;
			if( TMP$478$3 != 256ll ) goto label$82;
			label$83:;
			{
			}
			goto label$81;
...
static FBSTRING* GETNOTALLOWEDMSG( $11FB_LANG_OPT OPT$1, uint8* MSGEX$1 )
{
	...
	FBSTRING* vr$16 = fb_StrConcat( &TMP$492$1, (void*)&MSG$1, -1ll, (void*)vr$12, 0ll );
...
static uint8* HMAKEPARAMDESC( uint8* MSGEX$1 )
{
	...
	if( MSGEX$1 == (uint8*)0ull ) goto label$141;
	{
		...
		FBSTRING* vr$8 = fb_StrConcat( &TMP$493$2, (void*)MSGEX$1, 0ll, (void*)" ", 2ll );
	...
	if( PNUM$1 <= 0ll ) goto label$143;
	{
		...
		if( PID$1 == (uint8*)0ull ) goto label$156;
		{
			...
			if( vr$16 <= 0ll ) goto label$158;
			{
				...
				FBSTRING* vr$19 = fb_StrConcat( &TMP$497$4, (void*)&DESC$1, -1ll, (void*)PID$1, 0ll );
	...
	if( PROC$1 == (struct $8FBSYMBOL*)0ull ) goto label$160;
	{
		...
		if( SHOWNAME$2 == 0ll ) goto label$171;
		{
			...
			if( PNAME$1 == (uint8*)0ull ) goto label$179;
			{
				...
				FBSTRING* vr$39 = fb_StrConcat( &TMP$500$4, (void*)&DESC$1, -1ll, (void*)PNAME$1, 0ll );
	...
	label$160:;
	{
		...
		FBSTRING* vr$44 = fb_StrConcat( &TMP$501$2, (void*)&DESC$1, -1ll, (void*)vr$41, 0ll );
