...
struct $7ASTNODE* CMETHODCALL( struct $8FBSYMBOL* SYM$1, struct $7ASTNODE* THISEXPR$1, $12FB_PARSEROPT OPTIONS$1 )
{
	...
	LEXSKIPTOKEN( 4096ll );
	if( (*(int64*)((uint8*)&PARSER$ + 296ll) & 4ll) == 0ll ) goto label$39;
	{
...
struct $7ASTNODE* CCTORCALL( struct $8FBSYMBOL* SYM$1 )
{
	...
	*(struct $11FB_CALL_ARG**)((uint8*)&ARG_LIST$1 + 16ll) = (struct $11FB_CALL_ARG*)0ull;
	...
	struct $11FB_CALL_ARG* vr$7 = SYMBALLOCOVLCALLARG( (struct $5TLIST*)((uint8*)&PARSER$ + 224ll), &ARG_LIST$1, 0ll );
	ARG$1 = vr$7;
	...
	*($12FB_PARAMMODE*)((uint8*)ARG$1 + 8ll) = -1ll;
	...
	struct $7ASTNODE* vr$14 = CPROCARGLIST( (struct $8FBSYMBOL*)0ull, vr$13, (struct $7ASTNODE*)0ull, &ARG_LIST$1, TMP$96$1 | 80ll );
	PROCEXPR$1 = vr$14;
