...
struct $7ASTNODE* RTLTHREADCALL( struct $7ASTNODE* CALLEXPR$1 )
{
	...
	*(int64*)((uint8*)&ARGMODE$1 + 40ll) = 17ll;
	...
	label$93:;
	{
		...
		I$2 = I$2 + 1ll;
		label$94:;
		if( I$2 <= TMP$92$2 ) goto label$97;
		label$96:;
	}
	ASTDELTREE( CALLEXPR$1 );
	struct $7ASTNODE* EXPR$1;
	struct $8FBSYMBOL* vr$34 = RTLPROCLOOKUP( (uint8*)"fb_ThreadCall", 365ll );
	...
	{
		PROCMODE_FB$1 = *(int64*)((uint8*)&ENV$ + 504ll);
		label$103:;
	}
	...
	TMP$94$1 = *(struct $8FBSYMBOL**)((uint8*)PROC$1 + 144ll);
	goto label$137;
	label$113:;
	TMP$94$1 = *(struct $8FBSYMBOL**)((uint8*)PROC$1 + 136ll);
	label$137:;
	PARAM$1 = TMP$94$1;
	{
		int64 I$2;
		...
		label$117:;
		{
			...
			TMP$96$3 = *(struct $8FBSYMBOL**)((uint8*)PARAM$1 + 304ll);
			goto label$138;
			label$135:;
			TMP$96$3 = *(struct $8FBSYMBOL**)((uint8*)PARAM$1 + 312ll);
			label$138:;
			PARAM$1 = TMP$96$3;
		}
		label$115:;
		I$2 = I$2 + 1ll;
		label$114:;
		if( I$2 <= TMP$95$2 ) goto label$117;
		label$116:;
	}
...
static int64 HTHREADCALLMAPTYPE( struct $8FBSYMBOL* SYM$1, int64 UDT$1 )
{
	...
	if( vr$4 == 0ll ) goto label$13;
	{
		...
		TMP$85$2 = 13ll;
		label$139:;
		fb$result$1 = TMP$85$2;
		goto label$11;
	}
	label$13:;
	label$12:;
	if( *(int64*)SYM$1 != 12ll ) goto label$15;
	TMP$86$1 = (int64)-(*(int64*)((uint8*)SYM$1 + 192ll) > 0ll);
	goto label$140;
	label$15:;
	TMP$86$1 = 0ll;
	label$140:;
		...
		{
			{
				...
				label$142:;
				TMP$89$4 = *(uint64*)(((uint8*)SYMB_DTYPETB$ + (TMP$88$4 * 56ll)) + 40ll);
				goto label$50;
				label$51:;
				{
					fb$result$1 = 2ll;
				...
				if( (TMP$89$4 - 1ull) > 9ull ) goto label$61;
				goto *tmp$97[TMP$89$4 - 1ull];
				label$49:;
			}
		}
		goto label$20;
