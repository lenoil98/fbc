...
void CDEFDECL( void )
{
	...
	int64 ICHAR$1;
	int64 ECHAR$1;
	if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 4194304ll) != 0ll ) goto label$13;
	{
	...
	TMP$94$1 = 8ll;
	label$43:;
	int64 vr$1 = CCOMPSTMTISALLOWED( TMP$94$1 );
	...
	DTYPE$1 = 2147483648ll;
	{
		...
		if( (TMP$95$2 - 321ull) > 12ull ) goto label$17;
		goto *tmp$96[TMP$95$2 - 321ull];
		label$17:;
	}
	LEXSKIPTOKEN( 2048ll );
	label$32:;
