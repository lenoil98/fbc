...
int64 ASTCHECKASSIGN( struct $7ASTNODE* L$1, struct $7ASTNODE* R$1 )
{
	...
	label$133:;
	LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$94$1 * 56ll));
	...
	label$134:;
	RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$95$1 * 56ll));
	...
	{
		int64 vr$21 = HCHECKUDTOPS( L$1, LDCLASS$1, &R$1, RDCLASS$1, -1ll );
	...
	if( ((int64)-(LDTYPE$1 == 7ll) | (int64)-(RDTYPE$1 == 7ll)) == 0ll ) goto label$98;
	{
		if( LDTYPE$1 == RDTYPE$1 ) goto label$100;
		{
			...
			label$135:;
			LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$96$3 * 56ll));
			...
			label$136:;
			RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$97$3 * 56ll));
			if( (LDFULL$1 & 480ll) == 0ll ) goto label$107;
			TMP$98$3 = 24ll;
			goto label$137;
			label$107:;
			TMP$98$3 = LDFULL$1 & 31ll;
			label$137:;
			LDTYPE$1 = TMP$98$3;
	...
	if( ((int64)-(LDTYPE$1 == 4ll) | (int64)-(RDTYPE$1 == 4ll)) == 0ll ) goto label$109;
	{
		...
		label$139:;
		LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$100$2 * 56ll));
		...
		label$140:;
		RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$101$2 * 56ll));
		if( (LDFULL$1 & 480ll) == 0ll ) goto label$116;
		TMP$102$2 = 24ll;
		goto label$141;
		label$116:;
		TMP$102$2 = LDFULL$1 & 31ll;
		label$141:;
		LDTYPE$1 = TMP$102$2;
...
struct $7ASTNODE* ASTNEWASSIGN( struct $7ASTNODE* L$1, struct $7ASTNODE* R$1, $9AST_OPOPT OPTIONS$1 )
{
	...
	label$265:;
	LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$105$1 * 56ll));
	...
	goto label$267;
	label$166:;
	TMP$107$1 = RDTYPE$1 & 31ll;
	label$267:;
	RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$107$1 * 56ll));
	if( (OPTIONS$1 & 32ll) != 0ll ) goto label$168;
	{
		...
		CHECK_LETOP$2 = -1ll;
		{
			...
			goto label$169;
			label$170:;
			static const void* tmp$123[1ll] = {
				&&label$171,
			};
			if( (TMP$108$3 - 20ull) > 0ull ) goto label$169;
			goto *tmp$123[TMP$108$3 - 20ull];
			label$169:;
		}
	...
	label$269:;
	RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$110$1 * 56ll));
	...
	if( ((int64)-(LDTYPE$1 == 20ll) | (int64)-(RDTYPE$1 == 20ll)) == 0ll ) goto label$204;
	{
		...
		goto label$271;
		label$216:;
		TMP$112$2 = LDTYPE$1 & 31ll;
		label$271:;
		LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$112$2 * 56ll));
	...
	if( ((int64)-(LDTYPE$1 == 7ll) | (int64)-(RDTYPE$1 == 7ll)) == 0ll ) goto label$217;
	{
		...
		label$219:;
		{
			...
			label$272:;
			LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$113$3 * 56ll));
			...
			label$273:;
			RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$114$3 * 56ll));
			if( (LDFULL$1 & 480ll) == 0ll ) goto label$228;
			TMP$115$3 = 24ll;
			goto label$274;
			label$228:;
			TMP$115$3 = LDFULL$1 & 31ll;
			label$274:;
			LDTYPE$1 = TMP$115$3;
	...
	if( ((int64)-(LDTYPE$1 == 4ll) | (int64)-(RDTYPE$1 == 4ll)) == 0ll ) goto label$230;
	{
		...
		label$276:;
		LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$117$2 * 56ll));
		...
		label$277:;
		RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$118$2 * 56ll));
		if( (LDFULL$1 & 480ll) == 0ll ) goto label$237;
		TMP$119$2 = 24ll;
		goto label$278;
		label$237:;
		TMP$119$2 = LDFULL$1 & 31ll;
		label$278:;
		LDTYPE$1 = TMP$119$2;
	...
	if( ((int64)-(LDTYPE$1 != RDTYPE$1) | (int64)-(*(struct $8FBSYMBOL**)((uint8*)L$1 + 16ll) != *(struct $8FBSYMBOL**)((uint8*)R$1 + 16ll))) == 0ll ) goto label$245;
	{
		if( RDCLASS$1 == 2ll ) goto label$247;
		{
			if( *(int64*)R$1 != 16ll ) goto label$249;
			{
				...
				TMP$121$4 = 0ll;
				label$280:;
				struct $7ASTNODE* vr$144 = ASTNEWCONV( LDFULL$1, LSUBTYPE$1, R$1, TMP$121$4, (int64*)0ull );
				R$1 = vr$144;
			...
			if( *(int64*)((uint8*)&ENV$ + 208ll) != 0ll ) goto label$254;
			{
				if( ((int64)-(LDCLASS$1 == 1ll) | (int64)-(RDCLASS$1 == 1ll)) == 0ll ) goto label$256;
				{
					...
					{
						DOCONV$3 = (int64)-((*(int64*)((uint8*)&IR$ + 552ll) & 1ll) != 0ll);
					}
					label$258:;
					label$257:;
				}
			...
			if( DOCONV$3 == 0ll ) goto label$260;
			{
				...
				TMP$122$4 = 0ll;
				label$281:;
				struct $7ASTNODE* vr$152 = ASTNEWCONV( LDFULL$1, *(struct $8FBSYMBOL**)((uint8*)L$1 + 16ll), R$1, TMP$122$4, (int64*)0ull );
				R$1 = vr$152;
...
struct $6IRVREG* ASTLOADASSIGN( struct $7ASTNODE* N$1 )
{
	...
	{
		(*(tmp$45*)((uint8*)&IR$ + 208ll))( VR$1, VS$1 );
	}
	label$289:;
	label$288:;
	ASTDELNODE( L$1 );
...
static int64 HCHECKSTRINGOPS( struct $7ASTNODE* L$1, $12FB_DATACLASS LDCLASS$1, struct $7ASTNODE* R$1, $12FB_DATACLASS RDCLASS$1 )
{
	...
	{
		int64 TMP$85$2;
		TMP$85$2 = *(int64*)((uint8*)OTHER$1 + 8ll) & 511ll;
		if( TMP$85$2 == 4ll ) goto label$16;
		label$17:;
		if( TMP$85$2 != 7ll ) goto label$15;
		label$16:;
		{
		}
		goto label$14;
...
static int64 HCHECKWSTRINGOPS( struct $7ASTNODE* L$1, int64* LDFULL$1, struct $7ASTNODE* R$1, int64* RDFULL$1, int64* IS_ZSTR$1 )
{
	...
	if( LDTYPE$1 != 7ll ) goto label$42;
	{
		...
		label$44:;
		label$43:;
		*LDFULL$1 = (*LDFULL$1 & -512ll) | (*(int64*)((uint8*)&ENV$ + 496ll) & 511ll);
	}
	goto label$41;
	label$42:;
	{
		...
		label$46:;
		label$45:;
		*RDFULL$1 = (*RDFULL$1 & -512ll) | (*(int64*)((uint8*)&ENV$ + 496ll) & 511ll);
	}
	label$41:;
	fb$result$1 = -1ll;
	label$34:;
...
static int64 HCHECKZSTRINGOPS( struct $7ASTNODE* L$1, int64* LDFULL$1, struct $7ASTNODE* R$1, int64* RDFULL$1 )
{
	...
	goto label$292;
	label$49:;
	TMP$88$1 = *LDFULL$1 & 31ll;
	label$292:;
	if( TMP$88$1 != 4ll ) goto label$51;
	{
...
static int64 HCHECKCONSTANDPOINTEROPS( struct $7ASTNODE* L$1, $11FB_DATATYPE LDTYPE$1, struct $7ASTNODE* R$1, $11FB_DATATYPE RDTYPE$1 )
{
	...
	fb$result$1 = 0ll;
	TMP$89$1 = 0ll;
	int64 vr$4 = SYMBCHECKCONSTASSIGNTOPLEVEL( LDTYPE$1, RDTYPE$1, *(struct $8FBSYMBOL**)((uint8*)L$1 + 16ll), *(struct $8FBSYMBOL**)((uint8*)R$1 + 16ll), 0ll, &TMP$89$1 );
	...
	if( (LDTYPE$1 & 480ll) == 0ll ) goto label$67;
	{
		...
		goto label$293;
		label$68:;
		TMP$90$2 = RDTYPE$1 & 31ll;
		label$293:;
		if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$90$2 * 56ll)) != 1ll ) goto label$70;
		{
			goto label$63;
		}
		label$70:;
	...
	if( (RDTYPE$1 & 480ll) == 0ll ) goto label$79;
	{
		...
		goto label$294;
		label$80:;
		TMP$91$2 = LDTYPE$1 & 31ll;
		label$294:;
		if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$91$2 * 56ll)) != 1ll ) goto label$82;
		{
			goto label$63;
		}
		label$82:;
...
static struct $7ASTNODE* HSHALLOWCOPY( struct $7ASTNODE* L$1, struct $7ASTNODE* R$1, int64 OPTIONS$1 )
{
	...
	{
		BYTESTOCOPY$1 = BYTESTOCOPY$1 - *(int64*)((uint8*)&ENV$ + 544ll);
		...
		label$152:;
		label$151:;
		struct $7ASTNODE* vr$19 = _Z19ASTBUILDDEREFADDROFP7ASTNODExu7INTEGERP8FBSYMBOLS3_( L$1, *(int64*)((uint8*)&ENV$ + 544ll), 2ll, (struct $8FBSYMBOL*)0ull, (struct $8FBSYMBOL*)0ull );
		L$1 = vr$19;
		struct $7ASTNODE* vr$20 = _Z19ASTBUILDDEREFADDROFP7ASTNODExu7INTEGERP8FBSYMBOLS3_( R$1, *(int64*)((uint8*)&ENV$ + 544ll), 2ll, (struct $8FBSYMBOL*)0ull, (struct $8FBSYMBOL*)0ull );
		R$1 = vr$20;
	}
	label$150:;
	label$149:;
