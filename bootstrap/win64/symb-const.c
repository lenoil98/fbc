...
struct $8FBSYMBOL* SYMBREUSEORADDCONST( uint8* ID$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, union $7FBVALUE* VALUE$1, $13FB_SYMBATTRIB ATTRIB$1 )
{
	...
	if( SYM$1 != (struct $8FBSYMBOL*)0ull ) goto label$17;
	{
		...
		if( ((int64)-(*(int64*)((uint8*)SYM$1 + 56ll) == DTYPE$1) & (int64)-(*(struct $8FBSYMBOL**)((uint8*)SYM$1 + 64ll) == SUBTYPE$1)) == 0ll ) goto label$21;
		{
			{
				int64 TMP$84$4;
				TMP$84$4 = DTYPE$1 & 511ll;
				if( TMP$84$4 == 17ll ) goto label$24;
				label$25:;
				if( TMP$84$4 == 4ll ) goto label$24;
				label$26:;
				if( TMP$84$4 != 7ll ) goto label$23;
				label$24:;
				{
				...
				goto label$22;
				label$23:;
				if( TMP$84$4 == 15ll ) goto label$28;
				label$29:;
				if( TMP$84$4 != 16ll ) goto label$27;
				label$28:;
				{
...
struct $8FBSYMBOL* SYMBALLOCFLOATCONST( double VALUE$1, int64 DTYPE$1 )
{
	...
	struct $8FBSYMBOL* vr$5 = HALLOCINTORFLOATCONST( &TMP$88$1, DTYPE$1 );
	fb$result$1 = vr$5;
...
struct $8FBSYMBOL* SYMBALLOCINTCONST( int64 VALUE$1, int64 DTYPE$1 )
{
	...
	label$46:;
	if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$90$1 * 56ll)) + 8ll) != 8ll ) goto label$45;
	{
...
struct $8FBSYMBOL* SYMBALLOCSTRCONST( uint8* SNAME$1, int64 STRLENGTH$1 )
{
	...
	if( INTERNALSTRLEN$1 > 122ll ) goto label$52;
	{
		...
		FBSTRING* vr$4 = fb_StrConcat( &TMP$93$2, (void*)ID$1, 134ll, (void*)SNAME$1, 0ll );
	...
	struct $8FBSYMBOL* vr$10 = SYMBADDVAR( (uint8*)ID$1, (uint8*)ID_ALIAS$1, 4ll, (struct $8FBSYMBOL*)0ull, STRSIZE$1, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$91$1, 3073ll, 137ll );
	S$1 = vr$10;
...
struct $8FBSYMBOL* SYMBALLOCWSTRCONST( uint16* SNAME$1, int64 STRLENGTH$1 )
{
	...
	if( (INTERNALSTRLEN$1 << (3ll & 63ll)) > 122ll ) goto label$60;
	{
		...
		FBSTRING* vr$6 = fb_StrConcat( &TMP$96$2, (void*)ID$1, 134ll, (void*)vr$3, 0ll );
	...
	int64 STRSIZE$1;
	STRSIZE$1 = (STRLENGTH$1 + 1ll) * *(int64*)((uint8*)SYMB_DTYPETB$ + 400ll);
	struct $8FBSYMBOL* vr$13 = SYMBADDVAR( (uint8*)ID$1, (uint8*)ID_ALIAS$1, 7ll, (struct $8FBSYMBOL*)0ull, STRSIZE$1, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$94$1, 3073ll, 137ll );
	S$1 = vr$13;
...
FBSTRING* SYMBGETCONSTVALUEASSTR( struct $8FBSYMBOL* S$1 )
{
	...
	{
		int64 TMP$97$2;
		TMP$97$2 = *(int64*)((uint8*)S$1 + 56ll) & 511ll;
		if( TMP$97$2 == 17ll ) goto label$71;
		label$72:;
		if( TMP$97$2 == 18ll ) goto label$71;
		label$73:;
		if( TMP$97$2 != 4ll ) goto label$70;
		label$71:;
		{
		...
		goto label$69;
		label$70:;
		if( TMP$97$2 != 16ll ) goto label$74;
		label$75:;
		{
		...
		goto label$69;
		label$74:;
		if( TMP$97$2 != 15ll ) goto label$76;
		label$77:;
		{
		...
		label$76:;
		{
			...
			goto label$82;
			label$79:;
			TMP$98$3 = *(int64*)((uint8*)S$1 + 56ll) & 31ll;
			label$82:;
			if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$98$3 * 56ll)) + 16ll) == 0ll ) goto label$81;
			{
...
static struct $8FBSYMBOL* HALLOCINTORFLOATCONST( FBSTRING* SVALUE$1, int64 DTYPE$1 )
{
	...
	*(int64*)((uint8*)&tmp$85$1 + 40ll) = 49ll;
	*(int64*)((uint8*)&tmp$85$1 + 48ll) = 1ll;
	*(int64*)((uint8*)&tmp$85$1 + 56ll) = 0ll;
	*(int64*)((uint8*)&tmp$85$1 + 64ll) = 0ll;
	fb$result$1 = (struct $8FBSYMBOL*)0ull;
	fb_StrAssign( (void*)ID$1, 134ll, (void*)"{fbnc}", 7ll, 0 );
	__builtin_memset( &TMP$87$1, 0, 24ll );
	FBSTRING* vr$6 = fb_StrConcat( &TMP$87$1, (void*)ID$1, 134ll, (void*)SVALUE$1, -1ll );
	fb_StrAssign( (void*)ID$1, 134ll, (void*)vr$6, -1ll, 0 );
	struct $8FBSYMBOL* S$1;
	...
	label$37:;
	uint8* vr$10 = SYMBUNIQUEID( (boolean)0ll );
	struct $8FBSYMBOL* vr$11 = SYMBADDVAR( (uint8*)ID$1, (uint8*)vr$10, DTYPE$1, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$85$1, 3073ll, 137ll );
	S$1 = vr$11;
