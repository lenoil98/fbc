...
int64 COPERATOR( int64 IS_OVERLOAD$1 )
{
	...
	TK$1 = vr$1;
	{
		...
		label$41:;
		{
			...
			LEXSKIPTOKEN( 2048ll );
			{
				...
				goto label$44;
				label$45:;
				static const void* tmp$98[400ll] = {
					&&label$70,
					&&label$85,
					&&label$85,
					&&label$85,
				...
				if( (TMP$95$4 - 64ull) > 399ull ) goto label$85;
				goto *tmp$98[TMP$95$4 - 64ull];
				label$44:;
			}
			fb$result$1 = OP$1;
			goto label$21;
		...
		goto label$22;
		label$23:;
		static const void* tmp$99[426ll] = {
			&&label$40,
			&&label$86,
			&&label$86,
			&&label$86,
		...
		if( (TMP$94$2 - 38ull) > 425ull ) goto label$86;
		goto *tmp$99[TMP$94$2 - 38ull];
		label$22:;
	}
	LEXSKIPTOKEN( 2048ll );
	...
	{
		OP$1 = *(int64*)(((uint8*)AST_OPTB$ + (OP$1 << (5ll & 63ll))) + 24ll);
	}
	label$90:;
	label$89:;
	fb$result$1 = OP$1;
...
void CASSIGNMENT( struct $7ASTNODE* L$1 )
{
	...
	label$97:;
	LEXSKIPTOKEN( 0ll );
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 312ll) = *(struct $8FBSYMBOL**)((uint8*)L$1 + 16ll);
	*(int64*)((uint8*)&PARSER$ + 304ll) = *(int64*)((uint8*)L$1 + 8ll) & 511ll;
	struct $7ASTNODE* R$1;
...
int64 CASSIGNMENTORPTRCALL( void )
{
	...
	label$142:;
	label$141:;
	if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 262144ll) != 0ll ) goto label$150;
	{
	...
	if( EXPR$1 == (struct $7ASTNODE*)0ull ) goto label$177;
	{
		{
			int64 TMP$109$3;
			TMP$109$3 = *(int64*)((uint8*)EXPR$1 + 8ll) & 511ll;
			if( TMP$109$3 != 20ll ) goto label$179;
			label$180:;
			{
...
static void HREPORTLETERROR( int64 ERRNUM$1, int64 ELMNUM$1 )
{
	...
	FBSTRING* vr$4 = fb_StrConcat( &TMP$106$1, (void*)"at the ", 8ll, (void*)vr$1, 0ll );
	__builtin_memset( &TMP$107$1, 0, 24ll );
	FBSTRING* vr$7 = fb_StrConcat( &TMP$107$1, (void*)vr$4, -1ll, (void*)" element of LET()", 18ll );
	fb_StrAssign( (void*)&TMP$108$1, -1ll, (void*)vr$7, -1ll, 0 );
	ERRREPORTEX( ERRNUM$1, (uint8*)*(uint8**)&TMP$108$1, 0ll, 1ll, (uint8*)0ull );
	fb_StrDelete( (FBSTRING*)&TMP$108$1 );
	label$128:;
}
