...
void IRINIT( void )
{
	label$10:;
	{
		...
		label$14:;
		{
			__builtin_memcpy( (struct $7IR_VTBL*)((uint8*)&IR$ + 8ll), &IRHLC_VTBL$, 544 );
		}
		goto label$12;
		label$13:;
		...
		label$16:;
		{
			__builtin_memcpy( (struct $7IR_VTBL*)((uint8*)&IR$ + 8ll), &IRLLVM_VTBL$, 544 );
		}
		goto label$12;
		label$15:;
		...
		label$18:;
		{
			__builtin_memcpy( (struct $7IR_VTBL*)((uint8*)&IR$ + 8ll), &IRGAS64_VTBL$, 544 );
		}
		goto label$12;
		label$17:;
		{
			__builtin_memcpy( (struct $7IR_VTBL*)((uint8*)&IR$ + 8ll), &IRTAC_VTBL$, 544 );
		}
		label$19:;
		label$12:;
	}
...
void IRHLEMITPUSHARG( struct $8FBSYMBOL* PARAM$1, struct $6IRVREG* VR$1, int64 UDTLEN$1, int64 LEVEL$1 )
{
	label$30:;
