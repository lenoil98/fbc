...
void SYMBINITSYMBOLS( void )
{
	...
	*(uint16*)((uint8*)&SYMB$ + 196776ll) = (uint16)0u;
	{
		struct $13FBS_NAMESPACE* TMP$97$2;
		TMP$97$2 = (struct $13FBS_NAMESPACE*)((uint8*)&SYMB$ + 196800ll);
		*(struct $8FBSYMBOL**)TMP$97$2 = (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 196704ll);
		*(struct $8FBSYMBOL**)((uint8*)TMP$97$2 + 8ll) = (struct $8FBSYMBOL*)0ull;
		*(struct $8FBSYMBOL**)((uint8*)TMP$97$2 + 16ll) = (struct $8FBSYMBOL*)0ull;
		*(struct $8FBSYMBOL**)((uint8*)TMP$97$2 + 24ll) = (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 196704ll);
		*(struct $8FBHASHTB**)((uint8*)TMP$97$2 + 56ll) = (struct $8FBHASHTB*)0ull;
		*(struct $8FBHASHTB**)((uint8*)TMP$97$2 + 64ll) = (struct $8FBHASHTB*)0ull;
		{
			HASHINIT( (struct $5THASH*)((uint8*)TMP$97$2 + 32ll), 8000ll, 0ll );
		}
		goto label$12;
		label$13:;
		{
			memset( (void*)((uint8*)TMP$97$2 + 32ll), 0, 24ull );
		}
		label$12:;
		void* vr$17 = LISTNEWNODE( (struct $5TLIST*)((uint8*)&SYMB$ + 197272ll) );
		*(struct $13FBNAMESPC_EXT**)((uint8*)TMP$97$2 + 72ll) = (struct $13FBNAMESPC_EXT*)vr$17;
	}
...
int64 SYMBCANDUPLICATE( struct $8FBSYMBOL* HEAD_SYM$1, struct $8FBSYMBOL* S$1 )
{
	...
	fb$result$1 = 0ll;
	{
			...
			{
				{
					...
					if( (TMP$99$5 - 5ull) > 8ull ) goto label$39;
					goto *tmp$104[TMP$99$5 - 5ull];
					label$39:;
				}
		...
		label$42:;
		{
			...
			{
				{
					$12FB_SYMBCLASS TMP$100$5;
					TMP$100$5 = *($12FB_SYMBCLASS*)HEAD_SYM$1;
					if( TMP$100$5 == 5ll ) goto label$48;
					label$49:;
					if( TMP$100$5 == 8ll ) goto label$48;
					label$50:;
					if( TMP$100$5 == 14ll ) goto label$48;
					label$51:;
					if( TMP$100$5 != 11ll ) goto label$47;
					label$48:;
					{
						goto label$31;
					}
					goto label$46;
					label$47:;
					if( TMP$100$5 != 10ll ) goto label$52;
					label$53:;
					{
			...
			{
				{
					...
					if( (TMP$101$5 - 3ull) > 11ull ) goto label$81;
					goto *tmp$105[TMP$101$5 - 3ull];
					label$60:;
				}
				HEAD_SYM$1 = *(struct $8FBSYMBOL**)((uint8*)HEAD_SYM$1 + 280ll);
			}
			...
			{
				{
					...
					if( (TMP$102$5 - 1ull) > 13ull ) goto label$117;
					goto *tmp$106[TMP$102$5 - 1ull];
					label$86:;
				}
				HEAD_SYM$1 = *(struct $8FBSYMBOL**)((uint8*)HEAD_SYM$1 + 280ll);
			}
			...
			{
				{
					...
					if( (TMP$103$5 - 5ull) > 6ull ) goto label$122;
					goto *tmp$107[TMP$103$5 - 5ull];
					label$122:;
				}
				HEAD_SYM$1 = *(struct $8FBSYMBOL**)((uint8*)HEAD_SYM$1 + 280ll);
			}
		...
		goto label$32;
		label$33:;
		static const void* tmp$108[14ll] = {
			&&label$82,
			&&label$56,
			&&label$56,
			&&label$128,
		...
		if( (TMP$98$2 - 1ull) > 13ull ) goto label$32;
		goto *tmp$108[TMP$98$2 - 1ull];
		label$32:;
	}
	fb$result$1 = -1ll;
	label$31:;
		...
		if( CHAIN_$1 == (struct $10FBSYMCHAIN*)0ull ) goto label$303;
		{
			...
			label$304:;
			{
				if( *(int64*)SYM$1 != 1ll ) goto label$308;
				{
					{
						int64 TMP$110$6;
						TMP$110$6 = *(int64*)((uint8*)SYM$1 + 56ll) & 511ll;
						if( TMP$110$6 == 17ll ) goto label$311;
						label$312:;
						if( TMP$110$6 == 18ll ) goto label$311;
						label$313:;
						if( TMP$110$6 != 4ll ) goto label$310;
						label$311:;
						{
							goto label$314;
						}
					...
					{
						{
							...
							TMP$111$7 = *($11FB_DATATYPE*)((uint8*)SYM$1 + 56ll);
							if( TMP$111$7 == 17ll ) goto label$341;
							label$342:;
							if( TMP$111$7 == 18ll ) goto label$341;
							label$343:;
							if( TMP$111$7 != 4ll ) goto label$340;
							label$341:;
							{
								goto label$344;
							}
...
void SYMBDELSYMBOL( struct $8FBSYMBOL* S$1, int64 IS_TBDEL$1 )
{
	label$399:;
	{
		...
		goto label$401;
		label$402:;
		static const void* tmp$113[16ll] = {
			&&label$403,
			&&label$404,
			&&label$405,
			&&label$413,
		...
		if( (TMP$112$2 - 1ull) > 15ull ) goto label$413;
		goto *tmp$113[TMP$112$2 - 1ull];
		label$401:;
	}
	label$400:;
}
...
struct $8FBSYMBOL* SYMBCLONESYMBOL( struct $8FBSYMBOL* S$1 )
{
	...
	struct $8FBSYMBOL* ARRAYSUBTYPE$1;
	{
		...
		goto label$416;
		label$417:;
		static const void* tmp$115[10ll] = {
			&&label$419,
			&&label$420,
			&&label$418,
			&&label$425,
		...
		if( (TMP$114$2 - 1ull) > 9ull ) goto label$425;
		goto *tmp$115[TMP$114$2 - 1ull];
		label$416:;
	}
	label$415:;
	return fb$result$1;
...
int64 SYMBISARRAY( struct $8FBSYMBOL* SYM$1 )
{
	...
	label$456:;
	{
		...
		TMP$116$2 = *($12FB_SYMBCLASS*)SYM$1;
		if( TMP$116$2 == 1ll ) goto label$460;
		label$461:;
		if( TMP$116$2 != 12ll ) goto label$459;
		label$460:;
		{
...
int64 SYMBISSTRING( int64 DTYPE$1 )
{
	...
	label$463:;
	{
		...
		goto label$465;
		label$466:;
		static const void* tmp$118[15ll] = {
			&&label$467,
			&&label$468,
			&&label$468,
			&&label$467,
		...
		if( (TMP$117$2 - 4ull) > 14ull ) goto label$468;
		goto *tmp$118[TMP$117$2 - 4ull];
		label$465:;
	}
	label$464:;
	return fb$result$1;
...
$19FB_CVA_LIST_TYPEDEF SYMBGETVALISTTYPE( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	if( ((DTYPE$1 & 32505856ll) >> (20ll & 63ll)) != 19ll ) goto label$472;
	{
		{
			int64 TMP$119$3;
			TMP$119$3 = DTYPE$1 & 31ll;
			if( TMP$119$3 != 0ll ) goto label$474;
			label$475:;
			{
			...
			goto label$473;
			label$474:;
			if( TMP$119$3 != 20ll ) goto label$478;
			label$479:;
			{
			...
			label$478:;
			{
				...
				goto label$496;
				label$483:;
				TMP$120$4 = DTYPE$1 & 31ll;
				label$496:;
				if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$120$4 * 56ll)) != 0ll ) goto label$485;
				{
	...
	if( SUBTYPE$1 == (struct $8FBSYMBOL*)0ull ) goto label$488;
	{
		{
			int64 TMP$121$3;
			TMP$121$3 = *(int64*)((uint8*)SUBTYPE$1 + 56ll) & 31ll;
			if( TMP$121$3 != 0ll ) goto label$490;
			label$491:;
			{
			...
			goto label$489;
			label$490:;
			if( TMP$121$3 != 20ll ) goto label$494;
			label$495:;
			{
				fb$result$1 = ((int64)*(int32*)((uint8*)SUBTYPE$1 + 208ll) & 15728640ll) >> (20ll & 63ll);
			}
...
FBSTRING* SYMBTYPETOSTR( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int64 LENGTH$1, int64 IS_FIXLENSTR$1 )
{
	...
	label$503:;
	{
		...
		label$507:;
		{
			...
			FBSTRING* vr$18 = fb_StrConcat( &TMP$124$3, (void*)&S$1, -1ll, *(void**)((uint8*)SUBTYPE$1 + 32ll), 0ll );
		...
		label$508:;
		{
			...
			FBSTRING* vr$24 = fb_StrConcat( &TMP$125$3, (void*)&S$1, -1ll, *(void**)(((uint8*)SYMB_DTYPETB$ + (DTYPEONLY$1 * 56ll)) + 48ll), 0ll );
		...
		label$523:;
		{
			...
			FBSTRING* vr$43 = fb_StrConcat( &TMP$129$3, (void*)&S$1, -1ll, *(void**)(((uint8*)SYMB_DTYPETB$ + (DTYPEONLY$1 * 56ll)) + 48ll), 0ll );
			fb_StrAssign( (void*)&S$1, -1ll, (void*)vr$43, -1ll, 0 );
		}
		goto label$505;
		label$506:;
		static const void* tmp$132[20ll] = {
			&&label$508,
			&&label$523,
			&&label$523,
			&&label$508,
		...
		if( (TMP$123$2 - 4ull) > 19ull ) goto label$523;
		goto *tmp$132[TMP$123$2 - 4ull];
		label$505:;
	}
	{
		int64 I$2;
...
void SYMBSETDEFTYPE( int64 ICHAR$1, int64 ECHAR$1, int64 DTYPE$1 )
{
	...
	label$546:;
	{
		...
		I$1 = I$1 + 1ll;
		label$548:;
		if( I$1 <= TMP$136$2 ) goto label$551;
		label$550:;
	}
	label$539:;
}
...
int64 SYMBCALCLEN( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	DTYPE$1 = TMP$137$1;
	{
		...
		label$569:;
		{
			...
			goto label$572;
			label$570:;
			TMP$139$3 = DTYPE$1 & 31ll;
			label$572:;
			fb$result$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$139$3 * 56ll)) + 8ll);
		}
		goto label$565;
		label$566:;
		static const void* tmp$140[3ll] = {
			&&label$567,
			&&label$569,
			&&label$568,
		};
		if( (TMP$138$2 - 18ull) > 2ull ) goto label$569;
		goto *tmp$140[TMP$138$2 - 18ull];
		label$565:;
	}
	label$563:;
	return fb$result$1;
...
FBSTRING* SYMBDUMPPRETTYTOSTR( struct $8FBSYMBOL* SYM$1 )
{
	...
	FBSTRING* vr$6 = fb_StrConcat( &TMP$165$1, *(void**)(((uint8*)CLASSNAMESPRETTY$ + (*(int64*)SYM$1 << (3ll & 63ll))) + -8ll), 0ll, (void*)" ", 2ll );
	__builtin_memset( &TMP$166$1, 0, 24ll );
	FBSTRING* vr$9 = fb_StrConcat( &TMP$166$1, (void*)vr$6, -1ll, *(void**)((uint8*)SYM$1 + 32ll), 0ll );
...
static int64 HSYMBCHECKCONSTASSIGNFUNCPTR( $11FB_DATATYPE LDTYPE$1, $11FB_DATATYPE RDTYPE$1, struct $8FBSYMBOL* LSUBTYPE$1, struct $8FBSYMBOL* RSUBTYPE$1, $12FB_PARAMMODE MODE$1, int64* MATCHES$1, $13FB_WARNINGMSG* WRNMSG$1 )
{
	...
	TMP$141$1 = 1ll;
	label$664:;
	$22FB_OVLPROC_MATCH_SCORE vr$7 = TYPECALCMATCH( *(int64*)((uint8*)LSUBTYPE$1 + 56ll), *(struct $8FBSYMBOL**)((uint8*)LSUBTYPE$1 + 64ll), TMP$141$1, *(int64*)((uint8*)RSUBTYPE$1 + 56ll), *(struct $8FBSYMBOL**)((uint8*)RSUBTYPE$1 + 64ll) );
	MATCH$1 = vr$7;
	...
	if( LPARAM$1 == (struct $8FBSYMBOL*)0ull ) goto label$630;
	{
		...
		TMP$142$2 = 0ll;
		int64 vr$31 = SYMBCHECKCONSTASSIGN( L$2, R$2, LS$2, RS$2, M$2, &TMP$142$2, WRNMSG$1 );
...
static void HFOREACHGLOBAL( struct $8FBSYMBOL* SYM$1, int64 SYMCLASS$1, tmp$42 CALLBACK$1 )
{
	...
	{
		{
			$12FB_SYMBCLASS TMP$143$3;
			TMP$143$3 = *($12FB_SYMBCLASS*)SYM$1;
			if( TMP$143$3 != 8ll ) goto label$644;
			label$645:;
			{
			...
			goto label$643;
			label$644:;
			if( TMP$143$3 != 10ll ) goto label$646;
			label$647:;
			{
				HFOREACHGLOBAL( *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 104ll), SYMCLASS$1, CALLBACK$1 );
			}
			goto label$643;
			label$646:;
			if( TMP$143$3 != 15ll ) goto label$648;
			label$649:;
			{
			...
			goto label$643;
			label$648:;
			if( TMP$143$3 != SYMCLASS$1 ) goto label$650;
			label$651:;
			{
				(CALLBACK$1)( SYM$1 );
			}
...
static FBSTRING* HGETNAMESPACEPREFIX( struct $8FBSYMBOL* SYM$1 )
{
	...
	if( NS$1 == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 196704ll) ) goto label$659;
	{
		...
		FBSTRING* vr$12 = fb_StrConcat( &TMP$145$2, *(void**)((uint8*)NS$1 + 32ll), 0ll, (void*)".", 2ll );
		__builtin_memset( &TMP$146$2, 0, 24ll );
		FBSTRING* vr$15 = fb_StrConcat( &TMP$146$2, (void*)vr$12, -1ll, (void*)&S$1, -1ll );
