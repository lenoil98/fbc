...
void CFORSTMTBEGIN( void )
{
	...
	label$162:;
	{
		...
		goto label$164;
		label$165:;
		static const void* tmp$102[20ll] = {
			&&label$166,
			&&label$167,
			&&label$167,
			&&label$169,
		...
		if( (TMP$100$2 - 1ull) > 19ull ) goto label$178;
		goto *tmp$102[TMP$100$2 - 1ull];
		label$164:;
	}
	...
	*(struct $8FBSYMBOL**)((uint8*)STK$1 + 152ll) = EL$1;
	...
	label$182:;
	label$181:;
	if( ISCONST$1 != 3ll ) goto label$184;
	{
		$6AST_OP TMP$101$2;
		struct $7ASTNODE* vr$52 = ASTNEWCONST( (union $7FBVALUE*)((uint8*)STK$1 + 64ll), *(int64*)((uint8*)STK$1 + 72ll), (struct $8FBSYMBOL*)0ull );
		struct $7ASTNODE* vr$56 = ASTNEWCONST( (union $7FBVALUE*)((uint8*)STK$1 + 40ll), *(int64*)((uint8*)STK$1 + 48ll), (struct $8FBSYMBOL*)0ull );
		if( *(int64*)((uint8*)STK$1 + 112ll) == 0ll ) goto label$185;
		TMP$101$2 = 50ll;
		goto label$188;
		label$185:;
		TMP$101$2 = 49ll;
		label$188:;
		struct $7ASTNODE* vr$58 = ASTNEWBOP( TMP$101$2, vr$56, vr$52, (struct $8FBSYMBOL*)0ull, 1ll );
		EXPR$1 = vr$58;
		int64 vr$59 = ASTCONSTFLUSHTOINT( EXPR$1, 8ll );
		if( vr$59 != 0ll ) goto label$187;
		{
			struct $7ASTNODE* vr$60 = ASTNEWBRANCH( 98ll, EL$1, (struct $7ASTNODE*)0ull );
			ASTADD( vr$60 );
		}
		label$187:;
		label$186:;
	...
	label$184:;
	{
		struct $7ASTNODE* vr$61 = ASTNEWBRANCH( 98ll, TL$1, (struct $7ASTNODE*)0ull );
		ASTADD( vr$61 );
	}
	label$183:;
	struct $8FBSYMBOL* vr$62 = SYMBADDLABEL( (uint8*)0ull, 4ll );
	IL$1 = vr$62;
	struct $7ASTNODE* vr$63 = ASTNEWLABEL( IL$1, -1ll );
	ASTADD( vr$63 );
	struct $7ASTNODE* vr$64 = ASTSCOPEBEGIN(  );
	*(struct $7ASTNODE**)((uint8*)STK$1 + 16ll) = vr$64;
...
void CFORSTMTEND( void )
{
	...
	label$225:;
	{
		...
		STK$1 = vr$0;
		if( STK$1 != (struct $13FB_CMPSTMTSTK*)0ull ) goto label$229;
		{
		...
		IDEXPR$2 = vr$4;
		if( IDEXPR$2 != (struct $7ASTNODE*)0ull ) goto label$233;
		{
			ERRREPORT( 14ll, 0ll, (uint8*)0ull );
		}
		goto label$232;
		label$233:;
		{
			if( *(struct $8FBSYMBOL**)((uint8*)IDEXPR$2 + 24ll) == *(struct $8FBSYMBOL**)((uint8*)STK$1 + 32ll) ) goto label$235;
			{
				ERRREPORT( 283ll, 0ll, (uint8*)0ull );
			}
			label$235:;
			label$234:;
			if( (*(int64*)((uint8*)&ENV$ + 392ll) & 8ll) == 0ll ) goto label$237;
			{
...
static void HSCALARNEXT( struct $13FB_CMPSTMTSTK* STK$1 )
{
	...
	if( *(struct $8FBSYMBOL**)((uint8*)STK$1 + 104ll) != (struct $8FBSYMBOL*)0ull ) goto label$37;
	{
		...
		TMP$94$2 = 49ll;
		label$240:;
		HFLUSHBOP( TMP$94$2, (struct $17FB_CMPSTMT_FORELM*)((uint8*)STK$1 + 32ll), (struct $17FB_CMPSTMT_FORELM*)((uint8*)STK$1 + 56ll), *(struct $8FBSYMBOL**)((uint8*)STK$1 + 136ll) );
	}
	goto label$36;
	label$37:;
	{
...
static struct $8FBSYMBOL* HADDIMPLICITVAR( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	int64 OPTIONS$1;
	OPTIONS$1 = 0ll;
	if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 2ll) != 0ll ) goto label$42;
	{
...
static struct $8FBSYMBOL* HSTORETEMP( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, struct $7ASTNODE* EXPR$1 )
{
	...
	int64 OPTIONS$1;
	OPTIONS$1 = 0ll;
	if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 2ll) != 0ll ) goto label$48;
	{
		OPTIONS$1 = OPTIONS$1 | 2ll;
	}
	label$48:;
	...
	{
		{
			...
			label$57:;
			{
				ERRREPORT( 198ll, -1ll, *(uint8**)((uint8*)AST_OPTB$ + 16ll) );
			}
			goto label$54;
			label$55:;
			static const void* tmp$112[1ll] = {
				&&label$56,
			};
			if( (TMP$96$3 - 20ull) > 0ull ) goto label$57;
			goto *tmp$112[TMP$96$3 - 20ull];
			label$54:;
		}
	}
	label$52:;
...
static void HFLUSHBOP( int64 OP$1, struct $17FB_CMPSTMT_FORELM* LHS$1, struct $17FB_CMPSTMT_FORELM* RHS$1, struct $8FBSYMBOL* EX$1 )
{
	...
	{
		ERRREPORT( 198ll, -1ll, *(uint8**)(((uint8*)AST_OPTB$ + (OP$1 << (5ll & 63ll))) + 16ll) );
		goto label$59;
	}
	label$61:;
	label$60:;
	...
	*(int64*)((uint8*)STK$1 + 168ll) = 0ll;
	...
	if( (FLAGS$1 & 2ll) != 0ll ) goto label$121;
	{
		...
		if( (FLAGS$1 & 1ll) != 0ll ) goto label$127;
		{
			...
			goto label$242;
			label$128:;
			TMP$98$3 = *(int64*)((uint8*)EXPR$2 + 8ll) & 31ll;
			label$242:;
			if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$98$3 * 56ll)) + 16ll) == 0ll ) goto label$130;
			{
	...
	label$243:;
	if( ((int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$99$1 * 56ll)) + 16ll) == 0ll) & (int64)-((FLAGS$1 & 1ll) == 0ll)) == 0ll ) goto label$145;
	{
...
static struct $7ASTNODE* HUDTCALLOPOVL( struct $8FBSYMBOL* PARENT$1, $6AST_OP OP$1, struct $7ASTNODE* INST_EXPR$1, struct $7ASTNODE* SECOND_ARG$1, struct $7ASTNODE* THIRD_ARG$1 )
{
	...
	if( SECOND_ARG$1 != (struct $7ASTNODE*)0ull ) goto label$194;
	{
	...
	label$194:;
	{
		...
		struct $8FBARRAY1I11FB_CALL_ARGE tmp$103$2;
		*(struct $11FB_CALL_ARG**)&tmp$103$2 = (struct $11FB_CALL_ARG*)ARGS$2;
		*(struct $11FB_CALL_ARG**)((uint8*)&tmp$103$2 + 8ll) = (struct $11FB_CALL_ARG*)ARGS$2;
		*(int64*)((uint8*)&tmp$103$2 + 16ll) = 48ll;
		*(int64*)((uint8*)&tmp$103$2 + 24ll) = 24ll;
		*(int64*)((uint8*)&tmp$103$2 + 32ll) = 1ll;
		*(int64*)((uint8*)&tmp$103$2 + 40ll) = 49ll;
		*(int64*)((uint8*)&tmp$103$2 + 48ll) = 2ll;
		*(int64*)((uint8*)&tmp$103$2 + 56ll) = 0ll;
		*(int64*)((uint8*)&tmp$103$2 + 64ll) = 1ll;
		int64 PARAMS$2;
		PARAMS$2 = 1ll;
		{
			struct $11FB_CALL_ARG* TMP$104$3;
			TMP$104$3 = (struct $11FB_CALL_ARG*)ARGS$2;
			*(struct $7ASTNODE**)TMP$104$3 = SECOND_ARG$1;
			*($12FB_PARAMMODE*)((uint8*)TMP$104$3 + 8ll) = -1ll;
			*(struct $11FB_CALL_ARG**)((uint8*)TMP$104$3 + 16ll) = (struct $11FB_CALL_ARG*)0ull;
		}
		if( OP$1 != 26ll ) goto label$196;
		{
			if( THIRD_ARG$1 == (struct $7ASTNODE*)0ull ) goto label$198;
			{
				*(struct $11FB_CALL_ARG**)((uint8*)ARGS$2 + 16ll) = (struct $11FB_CALL_ARG*)((uint8*)ARGS$2 + 24ll);
				PARAMS$2 = PARAMS$2 + 1ll;
				{
					struct $11FB_CALL_ARG* TMP$105$5;
					TMP$105$5 = (struct $11FB_CALL_ARG*)((uint8*)ARGS$2 + 24ll);
					*(struct $7ASTNODE**)TMP$105$5 = THIRD_ARG$1;
					*($12FB_PARAMMODE*)((uint8*)TMP$105$5 + 8ll) = -1ll;
					*(struct $11FB_CALL_ARG**)((uint8*)TMP$105$5 + 16ll) = (struct $11FB_CALL_ARG*)0ull;
				}
			}
			label$198:;
			label$197:;
	...
	{
		if( ERR_NUM$1 == 0ll ) goto label$202;
		{
		...
		label$202:;
		{
			...
			FBSTRING* vr$23 = fb_StrConcat( &TMP$107$3, *(void**)(((uint8*)AST_OPTB$ + (OP$1 << (5ll & 63ll))) + 16ll), 0ll, (void*)" (with", 7ll );
			fb_StrInit( (void*)&OP_VERSION$3, -1ll, (void*)vr$23, -1ll, 0 );
			{
				uint64 TMP$108$4;
				TMP$108$4 = (uint64)OP$1;
				goto label$204;
				label$205:;
				{
					if( SECOND_ARG$1 != (struct $7ASTNODE*)0ull ) goto label$207;
					{
				...
				label$208:;
				{
					if( THIRD_ARG$1 != (struct $7ASTNODE*)0ull ) goto label$210;
					{
						fb_StrConcatAssign( (void*)&OP_VERSION$3, -1ll, (void*)"out", 4ll, 0 );
					}
					label$210:;
				...
				goto label$203;
				label$204:;
				static const void* tmp$113[3ll] = {
					&&label$205,
					&&label$205,
					&&label$208,
				};
				if( (TMP$108$4 - 24ull) > 2ull ) goto label$203;
				goto *tmp$113[TMP$108$4 - 24ull];
				label$203:;
			}
...
{
	label$213:;
	if( *(struct $7ASTNODE**)((uint8*)STK$1 + 16ll) == (struct $7ASTNODE*)0ull ) goto label$216;
	{
	...
	{
		int64 TMP$111$2;
		TMP$111$2 = *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)STK$1 + 32ll) + 56ll) & 511ll;
		if( TMP$111$2 != 20ll ) goto label$218;
		label$219:;
		{
			HUDTSTEP( STK$1 );
	...
	ASTADD( vr$12 );
	if( *(struct $7ASTNODE**)((uint8*)STK$1 + 24ll) == (struct $7ASTNODE*)0ull ) goto label$222;
	{
