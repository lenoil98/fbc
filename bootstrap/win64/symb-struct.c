...
static int64 HGETRETURNTYPEGAS64LINUX( struct $8FBSYMBOL* );
...
struct $8FBSYMBOL* SYMBSTRUCTBEGIN( struct $10FBSYMBOLTB* SYMTB$1, struct $8FBHASHTB* HASHTB$1, struct $8FBSYMBOL* PARENT$1, uint8* ID$1, uint8* ID_ALIAS$1, int64 ISUNION$1, int64 ALIGN$1, int64 IS_DERIVED$1, $13FB_SYMBATTRIB ATTRIB$1, int64 OPTIONS$1 )
{
	...
	{
		if( *(int64*)((uint8*)&PARSER$ + 200ll) == 0ll ) goto label$15;
		{
			ID_ALIAS$1 = ID$1;
		}
		label$15:;
...
void SYMBSTRUCTADDBASE( struct $8FBSYMBOL* S$1, struct $8FBSYMBOL* BASE_$1 )
{
	...
	struct $8FBSYMBOL* vr$0 = SYMBADDFIELD( S$1, (uint8*)"base$", 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$94$1, 20ll, BASE_$1, 0ll, 0ll, 0ll );
	*(struct $8FBSYMBOL**)((uint8*)S$1 + 176ll) = vr$0;
	...
	if( (*(int64*)((uint8*)BASE_$1 + 24ll) & 4194304ll) == 0ll ) goto label$35;
	{
		*($12FB_SYMBSTATS*)((uint8*)S$1 + 24ll) = *(int64*)((uint8*)S$1 + 24ll) | 4194304ll;
		SYMBUDTALLOCEXT( S$1 );
		*(int64*)((uint8*)*(struct $12FB_STRUCTEXT**)((uint8*)S$1 + 240ll) + 280ll) = *(int64*)((uint8*)*(struct $12FB_STRUCTEXT**)((uint8*)BASE_$1 + 240ll) + 280ll);
		*(int64*)((uint8*)*(struct $12FB_STRUCTEXT**)((uint8*)S$1 + 240ll) + 304ll) = *(int64*)((uint8*)*(struct $12FB_STRUCTEXT**)((uint8*)BASE_$1 + 240ll) + 304ll);
	}
	label$35:;
	label$34:;
	label$33:;
...
int64 TYPECALCNATURALALIGN( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	int64 ALIGN$1;
	{
		...
		label$43:;
		{
			...
			label$50:;
			ALIGN$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$98$3 * 56ll)) + 8ll);
		}
		goto label$39;
		label$40:;
		...
		if( (TMP$97$2 - 17ull) > 3ull ) goto label$43;
		goto *tmp$99[TMP$97$2 - 17ull];
		label$39:;
	}
...
int64 SYMBCHECKBITFIELD( struct $8FBSYMBOL* UDT$1, int64 DTYPE$1, int64 LGT$1, int64 BITS$1 )
{
	...
	label$63:;
	{
		...
		goto label$66;
		label$67:;
		static const void* tmp$102[14ll] = {
			&&label$68,
			&&label$68,
			&&label$68,
			&&label$70,
		...
		if( (TMP$101$2 - 1ull) > 13ull ) goto label$70;
...
struct $8FBSYMBOL* SYMBADDFIELD( struct $8FBSYMBOL* PARENT$1, uint8* ID$1, int64 DIMENSIONS$1, struct $7FBARRAYI10FBARRAYDIME* DTB$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int64 LGT$1, int64 BITS$1, $13FB_SYMBATTRIB ATTRIB$1 )
{
	...
	if( (ATTRIB$1 & 4ll) == 0ll ) goto label$77;
	{
		...
		__FB_STATIC_ASSERT( sizeof( struct $8FBARRAY1I10FBARRAYDIME ) == 72 );
		struct $8FBARRAY1I10FBARRAYDIME tmp$103$2;
		*(struct $10FBARRAYDIM**)&tmp$103$2 = (struct $10FBARRAYDIM*)EMPTYDTB$2;
		*(struct $10FBARRAYDIM**)((uint8*)&tmp$103$2 + 8ll) = (struct $10FBARRAYDIM*)EMPTYDTB$2;
		*(int64*)((uint8*)&tmp$103$2 + 16ll) = 16ll;
		*(int64*)((uint8*)&tmp$103$2 + 24ll) = 16ll;
		*(int64*)((uint8*)&tmp$103$2 + 32ll) = 1ll;
		*(int64*)((uint8*)&tmp$103$2 + 40ll) = 49ll;
		*(int64*)((uint8*)&tmp$103$2 + 48ll) = 1ll;
		*(int64*)((uint8*)&tmp$103$2 + 56ll) = 0ll;
		*(int64*)((uint8*)&tmp$103$2 + 64ll) = 0ll;
		struct $8FBSYMBOL* vr$6 = SYMBADDARRAYDESCRIPTORTYPE( DIMENSIONS$1, DTYPE$1, SUBTYPE$1 );
		DESCTYPE$1 = vr$6;
		struct $8FBSYMBOL* vr$8 = SYMBADDFIELD( PARENT$1, ID$1, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$103$2, 20ll, DESCTYPE$1, 0ll, 0ll, 8192ll );
		DESC$1 = vr$8;
	...
	if( ALLOC_FIELD$1 == 0ll ) goto label$89;
	{
		...
		if( PAD$1 <= 0ll ) goto label$91;
		{
			...
			{
				if( *(int64*)((uint8*)&ENV$ + 424ll) != 0ll ) goto label$95;
				{
					if( BITS$1 > (PAD$1 << (3ll & 63ll)) ) goto label$97;
					{
						...
						PAD$1 = 0ll;
						{
							...
							label$100:;
							{
								...
								label$152:;
								if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$104$8 * 56ll)) + 16ll) == 0ll ) goto label$103;
								{
									DTYPE$1 = 2ll;
								}
								goto label$102;
							...
							label$105:;
							{
								...
								label$153:;
								if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$105$8 * 56ll)) + 16ll) == 0ll ) goto label$108;
								{
									DTYPE$1 = 5ll;
								}
								goto label$107;
	...
	{
		{
			...
			if( TMP$106$3 != 17ll ) goto label$126;
			label$127:;
			{
			...
			goto label$125;
			label$126:;
			if( TMP$106$3 != 20ll ) goto label$130;
			label$131:;
			{
				...
				label$135:;
				label$134:;
				struct $8FBSYMBOL* vr$128 = SYMBGETCOMPDTOR( SUBTYPE$1 );
...
void SYMBSTRUCTEND( struct $8FBSYMBOL* SYM$1, int64 ISNESTED$1 )
{
	...
	*($15FB_STRUCT_INREG*)((uint8*)SYM$1 + 224ll) = 0ll;
	int64 vr$13 = HGETRETURNTYPE( SYM$1 );
	*($11FB_DATATYPE*)((uint8*)SYM$1 + 216ll) = vr$13;
	SYMBUDTIMPLEMENTDEFAULTMEMBERS( &DEFAULTMEMBERS$1, SYM$1 );
	if( *(int64*)((uint8*)&SYMB$ + 197336ll) <= 0ll ) goto label$272;
	{
...
void SYMBDELSTRUCT( struct $8FBSYMBOL* S$1 )
{
	...
	if( *(struct $12FB_STRUCTEXT**)((uint8*)S$1 + 240ll) == (struct $12FB_STRUCTEXT*)0ull ) goto label$276;
	{
...
struct $8FBSYMBOL* SYMBUDTGETNEXTINITABLEFIELD( struct $8FBSYMBOL* SYM$1 )
{
	...
	label$297:;
	{
		...
		PARENT$1 = vr$2;
		if( PARENT$1 != (struct $8FBSYMBOL*)0ull ) goto label$303;
		{
			goto label$298;
		}
		label$303:;
		label$302:;
		if( ((int64)*(int32*)((uint8*)PARENT$1 + 208ll) & 1ll) != 0ll ) goto label$305;
		{
			goto label$298;
		}
		label$305:;
...
int64 SYMBGETUDTBASELEVEL( struct $8FBSYMBOL* S$1, struct $8FBSYMBOL* BASESYM$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$306:;
	if( ((int64)-(S$1 == (struct $8FBSYMBOL*)0ull) | (int64)-(BASESYM$1 == (struct $8FBSYMBOL*)0ull)) == 0ll ) goto label$309;
	{
		fb$result$1 = 0ll;
		goto label$307;
	}
	...
	LEVEL$1 = 1ll;
	label$310:;
	if( *(struct $8FBSYMBOL**)((uint8*)S$1 + 176ll) == (struct $8FBSYMBOL*)0ull ) goto label$311;
	{
		if( *(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)S$1 + 176ll) + 64ll) != BASESYM$1 ) goto label$313;
		{
			fb$result$1 = LEVEL$1;
			goto label$307;
		}
...
struct $8FBSYMBOL* SYMBCLONESIMPLESTRUCT( struct $8FBSYMBOL* SYM$1 )
{
	...
	__FB_STATIC_ASSERT( sizeof( struct $8FBARRAY1I10FBARRAYDIME ) == 72 );
	static struct $8FBARRAY1I10FBARRAYDIME tmp$111$1 = { (struct $10FBARRAYDIM*)DTB$1, (struct $10FBARRAYDIM*)DTB$1, 16ll, 16ll, 1ll, 49ll, { { 1ll, 0ll, 0ll } } };
	struct $8FBSYMBOL* S$1;
	struct $8FBSYMBOL* FLD$1;
	...
	FLD$1 = vr$4;
	label$316:;
	if( FLD$1 == (struct $8FBSYMBOL*)0ull ) goto label$317;
	{
		SYMBADDFIELD( S$1, *(uint8**)((uint8*)FLD$1 + 32ll), 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$111$1, *(int64*)((uint8*)FLD$1 + 56ll), *(struct $8FBSYMBOL**)((uint8*)FLD$1 + 64ll), 0ll, 0ll, 0ll );
...
static void STRUCT_ANALYZE( struct $8FBSYMBOL* FLD$1, int64* PART1$1, int64* PART2$1, int64* RANGE$1 )
{
	...
	if( FLD$1 == (struct $8FBSYMBOL*)0ull ) goto label$179;
	{
		...
		label$318:;
		if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$107$2 * 56ll)) != 3ll ) goto label$184;
		{
		...
		goto label$319;
		label$186:;
		TMP$108$2 = *(int64*)((uint8*)FLD$1 + 56ll) & 31ll;
		label$319:;
		if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$108$2 * 56ll)) != 0ll ) goto label$185;
		{
...
static int64 HGETRETURNTYPEGAS64LINUX( struct $8FBSYMBOL* SYM$1 )
{
	int64 fb$result$1;
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$196:;
	if( *(int64*)((uint8*)SYM$1 + 80ll) > (*(int64*)((uint8*)SYMB_DTYPETB$ + 736ll) << (1ll & 63ll)) ) goto label$199;
	{
		{
			uint64 TMP$109$3;
			int64 vr$3 = HGETMAGICSTRUCTNUMBER( SYM$1 );
			TMP$109$3 = (uint64)vr$3;
			goto label$201;
			label$202:;
			{
				fb$result$1 = 13ll;
			...
			goto label$200;
			label$201:;
			static const void* tmp$112[10ll] = {
				&&label$202,
				&&label$203,
				&&label$208,
				&&label$208,
			...
			if( (TMP$109$3 - 1ull) > 9ull ) goto label$208;
			goto *tmp$112[TMP$109$3 - 1ull];
			label$200:;
		}
	}
	label$199:;
...
static int64 HGETRETURNTYPE( struct $8FBSYMBOL* SYM$1 )
{
	...
	if( vr$2 == 0ll ) goto label$216;
	{
		...
		{
			if( *(int64*)((uint8*)&ENV$ + 216ll) != 2ll ) goto label$220;
			{
				int64 vr$3 = HGETRETURNTYPEGAS64LINUX( SYM$1 );
				fb$result$1 = vr$3;
				goto label$210;
			}
			label$220:;
	...
	label$216:;
	label$215:;
	if( (*(int64*)((uint8*)&ENV$ + 520ll) & 16ll) != 0ll ) goto label$222;
	{
		fb$result$1 = 52ll;
		goto label$210;
	}
	...
	label$223:;
	{
		...
		label$229:;
		{
			struct $8FBSYMBOL* vr$6 = SYMBUDTGETFIRSTFIELD( SYM$1 );
			FLD$1 = vr$6;
		...
		label$234:;
		{
			label$235:;
			{
				...
				if( vr$10 == (struct $8FBSYMBOL*)0ull ) goto label$239;
				{
					goto label$236;
				}
				label$239:;
		...
		label$246:;
		{
			struct $8FBSYMBOL* vr$16 = SYMBUDTGETFIRSTFIELD( SYM$1 );
			FLD$1 = vr$16;
		...
		label$251:;
		{
			label$252:;
			{
				...
				FLD$1 = vr$19;
				struct $8FBSYMBOL* vr$20 = SYMBUDTGETNEXTFIELD( FLD$1 );
				if( vr$20 == (struct $8FBSYMBOL*)0ull ) goto label$256;
				{
					goto label$253;
				}
				label$256:;
		...
		if( (TMP$110$2 - 1ull) > 7ull ) goto label$225;
		goto *tmp$113[TMP$110$2 - 1ull];
		label$225:;
	}
...
static struct $8FBSYMBOL* HSKIPTOFIELD( struct $8FBSYMBOL* SYM$1 )
{
	...
	{
		if( *(int64*)SYM$1 != 12ll ) goto label$282;
		{
			goto label$280;
		}
		label$282:;
...
static struct $8FBSYMBOL* HFINDCOMMONPARENT( struct $8FBSYMBOL* A$1, struct $8FBSYMBOL* B$1 )
{
	...
	ORIGINALB$1 = B$1;
	label$289:;
	if( A$1 == (struct $8FBSYMBOL*)0ull ) goto label$290;
	{
		B$1 = ORIGINALB$1;
		label$291:;
		if( B$1 == (struct $8FBSYMBOL*)0ull ) goto label$292;
		{
			if( A$1 != B$1 ) goto label$294;
			{
				fb$result$1 = A$1;
				goto label$288;
			}
