...
struct $7ASTNODE* ASTNEWUOP( int64 OP$1, struct $7ASTNODE* O$1 )
{
	...
	label$144:;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$89$1 * 56ll)) != 2ll ) goto label$72;
	{
		goto label$56;
	}
	label$72:;
	...
	label$146:;
	DO_PROMOTE$1 = (int64)-(*(int64*)((uint8*)&ENV$ + 272ll) != 3ll) & (int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$92$1 * 56ll)) == 0ll);
	...
	if( DO_PROMOTE$1 == 0ll ) goto label$92;
	{
		...
		label$147:;
		if( (*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$93$2 * 56ll)) + 32ll) & 480ll) == 0ll ) goto label$95;
		TMP$95$2 = 24ll;
		goto label$148;
		label$95:;
		...
		label$149:;
		TMP$95$2 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$94$2 * 56ll)) + 32ll) & 31ll;
		label$148:;
		RANK$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$95$2 * 56ll)) + 24ll);
	...
	SUBTYPE$1 = *(struct $8FBSYMBOL**)((uint8*)O$1 + 16ll);
	{
		...
		label$102:;
		{
			...
			label$150:;
			if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$97$3 * 56ll)) == 0ll ) goto label$105;
			{
		...
		label$106:;
		{
			...
			label$151:;
			if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$98$3 * 56ll)) != 0ll ) goto label$109;
			{
		...
		label$110:;
		{
			...
			label$152:;
			if( ~(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$99$3 * 56ll)) + 16ll)) == 0ll ) goto label$113;
			{
				if( *(int64*)O$1 != 16ll ) goto label$115;
				{
					if( *(int64*)((uint8*)&AST$ + 464ll) != 0ll ) goto label$117;
					{
						...
						label$153:;
						if( *(uint64*)((uint8*)O$1 + 40ll) <= (1ull << (((*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$100$6 * 56ll)) + 8ll) << (3ll & 63ll)) + -1ll) & 63ll)) ) goto label$120;
						{
		...
		label$121:;
		{
			...
			label$154:;
			if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$101$3 * 56ll)) == 1ll ) goto label$124;
			{
		...
		label$125:;
		{
			...
			label$155:;
			if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$102$3 * 56ll)) != 0ll ) goto label$128;
			{
		...
		label$129:;
		{
			...
			label$156:;
			if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$103$3 * 56ll)) != 0ll ) goto label$132;
			{
		...
		if( (TMP$96$2 - 52ull) > 20ull ) goto label$100;
	...
	{
		int64 vr$130 = (*(tmp$40*)((uint8*)&IR$ + 48ll))( OP$1, DTYPE$1 );
...
struct $6IRVREG* ASTLOADUOP( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$164;
	{
		...
		{
			struct $6IRVREG* vr$10 = (*(tmp$69*)((uint8*)&IR$ + 456ll))( *(int64*)((uint8*)O$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)O$1 + 16ll) );
			VR$1 = vr$10;
		...
		label$165:;
		(*(tmp$51*)((uint8*)&IR$ + 200ll))( OP$1, V1$1, VR$1 );
...
static struct $7ASTNODE* HCONSTUOP( int64 OP$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, struct $7ASTNODE* L$1 )
{
	...
	label$169:;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$84$1 * 56ll)) != 1ll ) goto label$19;
	{
	...
	label$19:;
	{
		...
		label$170:;
		if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$86$2 * 56ll)) + 8ll) != 8ll ) goto label$40;
		{
			{
				uint64 TMP$87$4;
