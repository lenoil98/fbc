...
void OBJINFOREADLIB( FBSTRING* LIBNAME$1, struct $5TLIST* LIBPATHS$1 )
{
	...
	if( PATH$1 == (struct $11TSTRSETITEM*)0ull ) goto label$230;
	{
		...
		FBSTRING* vr$11 = fb_StrConcat( &TMP$52$2, (void*)PATH$1, -1ll, (void*)"/", 2ll );
		__builtin_memset( &TMP$53$2, 0, 24ll );
		FBSTRING* vr$14 = fb_StrConcat( &TMP$53$2, (void*)vr$11, -1ll, (void*)&FILENAME$1, -1ll );
		...
		if( *(int64*)&PARSER$ >= *(int64*)((uint8*)&FBCTINF$ + 8ll) ) goto label$248;
		{
			...
			*(int64*)&PARSER$ = *(int64*)&PARSER$ + 1ll;
			...
			fb_StrAssign( (void*)DAT$1, -1ll, (void*)vr$10, 0ll, 0 );
			{
				...
				if( TMP$54$4 != 1ll ) goto label$258;
				label$259:;
				{
					fb$result$1 = 0ll;
					goto label$242;
				...
				goto label$257;
				label$258:;
				if( TMP$54$4 != 2ll ) goto label$260;
				label$261:;
				{
					fb$result$1 = 1ll;
					goto label$242;
				...
				goto label$257;
				label$260:;
				if( TMP$54$4 != 3ll ) goto label$262;
				label$263:;
				{
					{
						FBSTRING TMP$55$6;
						fb_StrInit( (void*)&TMP$55$6, -1ll, (void*)DAT$1, -1ll, 0 );
						int32 vr$13 = fb_StrCompare( (void*)&TMP$55$6, -1ll, (void*)"-lang", 6ll );
						...
						goto label$264;
						label$265:;
						int32 vr$19 = fb_StrCompare( (void*)&TMP$55$6, -1ll, (void*)"-mt", 4ll );
	...
	{
		{
			...
			TMP$40$3 = vr$1;
			if( TMP$40$3 != 1ll ) goto label$191;
			label$192:;
			{
			...
			goto label$190;
			label$191:;
			if( TMP$40$3 != 0ll ) goto label$193;
			label$194:;
			{
	...
	{
		{
			...
			TMP$41$3 = vr$3;
			if( TMP$41$3 != 1ll ) goto label$197;
			label$198:;
			{
			...
			goto label$196;
			label$197:;
			if( TMP$41$3 != 0ll ) goto label$199;
			label$200:;
			{
			...
			goto label$196;
			label$199:;
			if( TMP$41$3 != 3ll ) goto label$201;
			label$202:;
			{
			...
			goto label$196;
			label$201:;
			if( TMP$41$3 != 2ll ) goto label$203;
			label$204:;
			{
			...
			goto label$196;
			label$203:;
			if( TMP$41$3 != 5ll ) goto label$205;
			label$206:;
			{
			...
			goto label$196;
			label$205:;
			if( TMP$41$3 != 4ll ) goto label$207;
			label$208:;
			{
