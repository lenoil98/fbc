...
static int64 HCHECKBYDESCPARAM( struct $7ASTNODE* PARENT$1, struct $8FBSYMBOL* PARAM$1, struct $7ASTNODE* N$1 )
{
	...
	if( ((int64)-(*(int64*)((uint8*)PARENT$1 + 40ll) == 0ll) & (int64)-(SYM_DTYPE$1 != 0ll)) == 0ll ) goto label$82;
	{
		...
		label$329:;
		if( ((int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$86$2 * 56ll)) != *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$87$2 * 56ll))) | (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$88$2 * 56ll)) + 8ll) != *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$89$2 * 56ll)) + 8ll))) == 0ll ) goto label$88;
		{
			goto label$76;
		}
		label$88:;
...
static int64 HCHECKVARARGPARAM( struct $7ASTNODE* PARENT$1, struct $8FBSYMBOL* PARAM$1, struct $7ASTNODE* N$1 )
{
	...
	ARG_DTYPE$1 = *(int64*)((uint8*)*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) + 8ll) & 511ll;
	{
		...
		label$330:;
		TMP$91$2 = *(uint64*)((uint8*)SYMB_DTYPETB$ + (TMP$90$2 * 56ll));
		goto label$111;
		label$112:;
		{
		...
		{
			{
				...
				label$115:;
				{
					...
					label$331:;
					if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$92$5 * 56ll)) + 8ll) >= 4ll ) goto label$121;
					{
						int64 TMP$93$6;
						...
						label$332:;
						if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$93$6 * 56ll)) + 16ll) == 0ll ) goto label$123;
						TMP$94$6 = 11ll;
						goto label$333;
						label$123:;
						TMP$94$6 = 12ll;
		...
		if( TMP$91$2 > 2ull ) goto label$127;
...
static int64 HCHECKSTRPARAM( struct $7ASTNODE* PARENT$1, struct $8FBSYMBOL* PARAM$1, struct $7ASTNODE* N$1 )
{
	...
	ARGDTYPE$1 = *(int64*)((uint8*)*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) + 8ll) & 511ll;
	{
		...
		if( (TMP$95$2 - 4ull) > 14ull ) goto label$142;
	...
	*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) = vr$5;
	{
		...
		if( TMP$96$2 != 2ll ) goto label$144;
		label$145:;
		{
		...
		goto label$143;
		label$144:;
		if( TMP$96$2 != 1ll ) goto label$148;
		label$149:;
		{
			HBUILDBYREFARG( PARAM$1, N$1 );
		}
...
static int64 HCHECKUDTPARAM( struct $8FBSYMBOL* PARAM$1, struct $7ASTNODE* N$1 )
{
	...
	label$180:;
	{
		...
		if( TMP$97$2 != 2ll ) goto label$189;
		label$190:;
		{
		...
		goto label$188;
		label$189:;
		if( TMP$97$2 != 1ll ) goto label$195;
		label$196:;
		{
			HUDTPASSBYVAL( PARAM$1, N$1 );
		}
...
static int64 HCHECKPARAM( struct $7ASTNODE* PARENT$1, struct $8FBSYMBOL* PARAM$1, struct $7ASTNODE* N$1 )
{
	...
	*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) = vr$2;
	...
	ARG_DTYPE$1 = *(int64*)((uint8*)*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) + 8ll) & 511ll;
	{
		...
		if( TMP$98$2 != 3ll ) goto label$200;
		label$201:;
		{
		...
		goto label$199;
		label$200:;
		if( TMP$98$2 != 4ll ) goto label$204;
		label$205:;
		{
		...
		goto label$199;
		label$204:;
		if( TMP$98$2 != 2ll ) goto label$206;
		label$207:;
		{
			int64 TMP$101$3;
			...
			if( *(int64*)((uint8*)N$1 + 40ll) != 1ll ) goto label$211;
			{
				...
				label$335:;
				if( ((int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$99$4 * 56ll)) != 0ll) | (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$100$4 * 56ll)) + 8ll) != *(int64*)((uint8*)&ENV$ + 544ll))) == 0ll ) goto label$215;
				{
					ERRREPORT( 58ll, 0ll, (uint8*)0ull );
					goto label$198;
				}
			...
			TMP$101$3 = 0ll;
			label$336:;
			if( TMP$101$3 == 0ll ) goto label$218;
			{
				ERRREPORT( 58ll, 0ll, (uint8*)0ull );
				goto label$198;
			}
	...
	}
	{
		...
		if( (TMP$102$2 - 4ull) > 16ull ) goto label$241;
	...
	if( ((int64)-(PARAM_DTYPE$1 == 10ll) | (int64)-(ARG_DTYPE$1 == 10ll)) == 0ll ) goto label$260;
	{
		...
		label$338:;
		if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$103$2 * 56ll)) == *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$104$2 * 56ll)) ) goto label$264;
		{
	...
	if( ((int64)-(PARAM_DTYPE$1 != ARG_DTYPE$1) | (int64)-(*(struct $8FBSYMBOL**)((uint8*)PARAM$1 + 64ll) != *(struct $8FBSYMBOL**)((uint8*)*(struct $7ASTNODE**)((uint8*)N$1 + 112ll) + 16ll))) == 0ll ) goto label$277;
	{
		...
		label$342:;
		if( ((int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$105$2 * 56ll)) + 8ll) != *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$106$2 * 56ll)) + 8ll)) | (int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$107$2 * 56ll)) != *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$108$2 * 56ll)))) == 0ll ) goto label$283;
		{
