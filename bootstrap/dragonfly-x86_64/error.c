...
void ERRPUSHPARAMLOCATION( struct $8FBSYMBOL* PROC$1, int64 TK$1, int64 PARAMNUM$1, uint8* PARAMID$1 )
{
	...
	{
		if( (*(int64*)((uint8*)PROC$1 + 16ll) & 2ll) == 0ll ) goto label$23;
		{
...
void ERRREPORTEX( int64 ERRNUM$1, uint8* MSGEX$1, int64 LINENUM$1, $12FB_ERRMSGOPT OPTIONS$1, uint8* CUSTOMTEXT$1 )
{
	...
	if( LINENUM$1 != 0ll ) goto label$68;
	{
		...
		label$70:;
		label$69:;
		if( *(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) == (struct $9LEX_TKCTX*)0ull ) goto label$72;
		{
			LINENUM$1 = *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16744ll);
		}
		label$72:;
		label$71:;
	...
	label$68:;
	label$67:;
	HPRINTERRMSG( ERRNUM$1, MSGEX$1, OPTIONS$1, LINENUM$1, *(int64*)((uint8*)&ENV$ + 376ll), CUSTOMTEXT$1 );
	*(int64*)((uint8*)&ERRCTX$ + 8ll) = *(int64*)((uint8*)&ERRCTX$ + 8ll) + 1ll;
	if( *(int64*)((uint8*)&ERRCTX$ + 8ll) < *(int64*)((uint8*)&ENV$ + 384ll) ) goto label$74;
	{
...
void ERRREPORTWARNEX( int64 MSGNUM$1, uint8* MSGEX$1, int64 LINENUM$1, $12FB_ERRMSGOPT OPTIONS$1, uint8* CUSTOMTEXT$1 )
{
	...
	FBSTRING TMP$489$1;
	label$95:;
	if( ((int64)-(MSGNUM$1 < 1ll) | (int64)-(MSGNUM$1 >= 45ll)) == 0ll ) goto label$98;
	{
		goto label$96;
	}
	label$98:;
	label$97:;
	if( *(int64*)(((uint8*)WARNINGMSGS$ + (MSGNUM$1 << (4ll & 63ll))) + -16ll) >= *(int64*)((uint8*)&ENV$ + 368ll) ) goto label$100;
	{
		goto label$96;
	}
	label$100:;
	...
	label$104:;
	label$103:;
	int64 vr$6 = fb_StrLen( (void*)((uint8*)&ENV$ + 560ll), 261ll );
	if( vr$6 <= 0ll ) goto label$106;
	{
		FBSTRING* vr$8 = fb_StrAllocTempDescZ( (uint8*)((uint8*)&ENV$ + 560ll) );
	...
	if( LINENUM$1 <= 0ll ) goto label$110;
	{
		FBSTRING TMP$481$2;
		FBSTRING TMP$482$2;
		FBSTRING* vr$10 = fb_LongintToStr( LINENUM$1 );
		__builtin_memset( &TMP$481$2, 0, 24ll );
		FBSTRING* vr$13 = fb_StrConcat( &TMP$481$2, (void*)"(", 2ll, (void*)vr$10, -1ll );
		__builtin_memset( &TMP$482$2, 0, 24ll );
		FBSTRING* vr$16 = fb_StrConcat( &TMP$482$2, (void*)vr$13, -1ll, (void*)")", 2ll );
		fb_PrintString( 0, (FBSTRING*)vr$16, 0 );
	}
	goto label$109;
	label$110:;
	{
		FBSTRING* vr$17 = fb_StrAllocTempDescZEx( (uint8*)"()", 2ll );
		fb_PrintString( 0, (FBSTRING*)vr$17, 0 );
	}
	label$109:;
	FBSTRING* vr$19 = fb_LongintToStr( *(int64*)(((uint8*)WARNINGMSGS$ + (MSGNUM$1 << (4ll & 63ll))) + -16ll) );
	FBSTRING* vr$20 = fb_LongintToStr( MSGNUM$1 );
	__builtin_memset( &TMP$486$1, 0, 24ll );
	FBSTRING* vr$23 = fb_StrConcat( &TMP$486$1, (void*)" warning ", 10ll, (void*)vr$20, -1ll );
	__builtin_memset( &TMP$487$1, 0, 24ll );
	FBSTRING* vr$26 = fb_StrConcat( &TMP$487$1, (void*)vr$23, -1ll, (void*)"(", 2ll );
	__builtin_memset( &TMP$488$1, 0, 24ll );
	FBSTRING* vr$29 = fb_StrConcat( &TMP$488$1, (void*)vr$26, -1ll, (void*)vr$19, -1ll );
	__builtin_memset( &TMP$489$1, 0, 24ll );
	FBSTRING* vr$32 = fb_StrConcat( &TMP$489$1, (void*)vr$29, -1ll, (void*)"): ", 4ll );
	fb_PrintString( 0, (FBSTRING*)vr$32, 0 );
	FBSTRING* vr$34 = fb_StrAllocTempDescZ( *(uint8**)(((uint8*)WARNINGMSGS$ + (MSGNUM$1 << (4ll & 63ll))) + -8ll) );
	fb_PrintString( 0, (FBSTRING*)vr$34, 0 );
	if( CUSTOMTEXT$1 == (uint8*)0ull ) goto label$112;
	{
	...
	label$112:;
	label$111:;
	if( MSGEX$1 == (uint8*)0ull ) goto label$114;
	{
		if( (OPTIONS$1 & 1ll) == 0ll ) goto label$116;
		{
			FBSTRING* vr$37 = fb_StrAllocTempDescZEx( (uint8*)", ", 2ll );
		...
		{
			FBSTRING* vr$39 = fb_StrAllocTempDescZEx( (uint8*)": ", 2ll );
			fb_PrintString( 0, (FBSTRING*)vr$39, 0 );
		}
		goto label$115;
		label$117:;
		{
			FBSTRING* vr$40 = fb_StrAllocTempDescZEx( (uint8*)" ", 1ll );
		...
		if( (OPTIONS$1 & 4ll) == 0ll ) goto label$121;
		{
			FBSTRING* vr$45 = fb_StrAllocTempDescZEx( (uint8*)"\x22", 1ll );
...
{
	label$122:;
	ERRREPORTWARNEX( MSGNUM$1, MSGEX$1, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16744ll), OPTIONS$1, CUSTOMTEXT$1 );
	label$123:;
}
...
void ERRREPORTUNDEF( int64 ERRNUM$1, uint8* ID$1 )
{
	...
	if( vr$4 == (void*)0ull ) goto label$193;
	{
		goto label$191;
	}
	label$193:;
...
static void HPRINTERRMSG( int64 ERRNUM$1, uint8* MSGEX$1, $12FB_ERRMSGOPT OPTIONS$1, int64 LINENUM$1, int64 SHOWERROR$1, uint8* CUSTOMTEXT$1 )
{
	...
	if( ((int64)-(ERRNUM$1 < 1ll) | (int64)-(ERRNUM$1 >= 325ll)) == 0ll ) goto label$33;
	{
		MSG$1 = (uint8*)0ull;
	}
	goto label$32;
	label$33:;
	{
		MSG$1 = *(uint8**)(((uint8*)ERRORMSGS$ + (ERRNUM$1 << (3ll & 63ll))) + -8ll);
	}
	label$32:;
	...
	label$35:;
	label$34:;
	int64 vr$5 = fb_StrLen( (void*)((uint8*)&ENV$ + 560ll), 261ll );
	if( vr$5 <= 0ll ) goto label$37;
	{
		FBSTRING* vr$7 = fb_StrAllocTempDescZ( (uint8*)((uint8*)&ENV$ + 560ll) );
	...
	if( ERRNUM$1 < 0ll ) goto label$41;
	{
		...
		FBSTRING* vr$15 = fb_StrConcat( &TMP$468$2, (void*)" ", 2ll, (void*)vr$12, -1ll );
		__builtin_memset( &TMP$469$2, 0, 24ll );
		FBSTRING* vr$18 = fb_StrConcat( &TMP$469$2, (void*)vr$15, -1ll, (void*)": ", 3ll );
		__builtin_memset( &TMP$470$2, 0, 24ll );
		FBSTRING* vr$21 = fb_StrConcat( &TMP$470$2, (void*)vr$18, -1ll, (void*)MSG$1, 0ll );
		...
		if( SHOWERROR$1 == 0ll ) goto label$56;
		{
			...
			FBSTRING* vr$37 = LEXPEEKCURRENTLINE( &TOKEN_POS$1, (int64)-((*(int64*)((uint8*)&ENV$ + 1248ll) & 256ll) != 0ll) );
			fb_StrAssign( (void*)&LN$3, -1ll, (void*)vr$37, -1ll, 0 );
			int64 vr$38 = fb_StrLen( (void*)&LN$3, -1ll );
			if( vr$38 <= 0ll ) goto label$58;
			{
				if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 256ll) == 0ll ) goto label$60;
				{
					FBSTRING TMP$475$5;
					FBSTRING TMP$476$5;
					__builtin_memset( &TMP$475$5, 0, 24ll );
					FBSTRING* vr$42 = fb_StrConcat( &TMP$475$5, (void*)" in '", 6ll, (void*)&LN$3, -1ll );
					__builtin_memset( &TMP$476$5, 0, 24ll );
					FBSTRING* vr$45 = fb_StrConcat( &TMP$476$5, (void*)vr$42, -1ll, (void*)"'", 2ll );
...
static uint8* HADDTOKEN( int64 ISBEFORE$1, int64 ADDCOMMA$1, uint8* MSGEX$1 )
{
	...
	if( vr$2 <= 0ll ) goto label$80;
	{
		{
			int64 TMP$477$3;
			int64 vr$3 = LEXGETTOKEN( 0ll );
			TMP$477$3 = vr$3;
			if( TMP$477$3 <= 32ll ) goto label$83;
			label$84:;
			if( TMP$477$3 == 257ll ) goto label$83;
			label$85:;
			if( TMP$477$3 != 256ll ) goto label$82;
			label$83:;
			{
			}
			goto label$81;
...
static FBSTRING* GETNOTALLOWEDMSG( $11FB_LANG_OPT OPT$1, uint8* MSGEX$1 )
{
	...
	LANGS$1 = 0ll;
	{
		...
		label$129:;
		{
			...
			if( (vr$4 & OPT$1) == 0ll ) goto label$131;
			{
				if( LANGS$1 <= 0ll ) goto label$133;
				{
		...
		I$1 = I$1 + 1ll;
		label$126:;
		if( I$1 <= 3ll ) goto label$129;
		label$128:;
	}
	uint8* vr$12 = HADDTOKEN( 0ll, (int64)-(LANGS$1 > 0ll), MSGEX$1 );
	__builtin_memset( &TMP$491$1, 0, 24ll );
	FBSTRING* vr$16 = fb_StrConcat( &TMP$491$1, (void*)&MSG$1, -1ll, (void*)vr$12, 0ll );
...
static uint8* HMAKEPARAMDESC( uint8* MSGEX$1 )
{
	...
	if( PARAMLOC$1 != (struct $16ERRPARAMLOCATION*)0ull ) goto label$139;
	{
		fb$result$1 = MSGEX$1;
		goto label$137;
	}
	...
	if( MSGEX$1 == (uint8*)0ull ) goto label$141;
	{
		FBSTRING TMP$492$2;
		__builtin_memset( &TMP$492$2, 0, 24ll );
		FBSTRING* vr$8 = fb_StrConcat( &TMP$492$2, (void*)MSGEX$1, 0ll, (void*)" ", 2ll );
		fb_StrAssign( (void*)&DESC$1, -1ll, (void*)vr$8, -1ll, 0 );
	}
	label$141:;
	label$140:;
	if( PNUM$1 <= 0ll ) goto label$143;
	{
		...
		if( PID$1 != (uint8*)0ull ) goto label$145;
		{
			if( PROC$1 == (struct $8FBSYMBOL*)0ull ) goto label$147;
			{
				int64 TMP$494$4;
				struct $8FBSYMBOL* PARAM$4;
				PARAM$4 = *(struct $8FBSYMBOL**)((uint8*)PROC$1 + 136ll);
				int64 CNT$4;
				if( (*(int64*)((uint8*)PROC$1 + 16ll) & 2ll) == 0ll ) goto label$148;
				TMP$494$4 = 0ll;
				goto label$194;
				label$148:;
				TMP$494$4 = 1ll;
				...
				goto label$149;
				label$150:;
				if( PARAM$4 == (struct $8FBSYMBOL*)0ull ) goto label$154;
				{
		...
		label$145:;
		label$144:;
		if( PID$1 == (uint8*)0ull ) goto label$156;
		{
			int64 vr$16 = fb_StrLen( (void*)PID$1, 0ll );
			if( vr$16 <= 0ll ) goto label$158;
			{
				FBSTRING TMP$496$4;
				fb_StrConcatAssign( (void*)&DESC$1, -1ll, (void*)" (", 3ll, 0 );
				__builtin_memset( &TMP$496$4, 0, 24ll );
				FBSTRING* vr$19 = fb_StrConcat( &TMP$496$4, (void*)&DESC$1, -1ll, (void*)PID$1, 0ll );
	...
	label$143:;
	label$142:;
	if( PROC$1 == (struct $8FBSYMBOL*)0ull ) goto label$160;
	{
		int64 SHOWNAME$2;
		SHOWNAME$2 = -1ll;
		PNAME$1 = (uint8*)0ull;
		if( (*(int64*)((uint8*)PROC$1 + 24ll) & 32ll) == 0ll ) goto label$162;
		{
			if( *(uint8**)((uint8*)PROC$1 + 32ll) == (uint8*)0ull ) goto label$164;
			{
				...
				if( (int64)vr$26 != 0ll ) goto label$166;
				{
					SHOWNAME$2 = 0ll;
				}
				label$166:;
		...
		{
			static FBSTRING S$3;
			if( (*(int64*)((uint8*)PROC$1 + 24ll) & 16384ll) == 0ll ) goto label$168;
			{
			...
			goto label$167;
			label$168:;
			if( (*(int64*)((uint8*)PROC$1 + 16ll) & 28ll) == 0ll ) goto label$169;
			{
		...
		label$161:;
		if( SHOWNAME$2 == 0ll ) goto label$171;
		{
			if( PNAME$1 != (uint8*)0ull ) goto label$173;
			{
				ADDPRNTS$1 = -1ll;
			...
			if( PNAME$1 == (uint8*)0ull ) goto label$179;
			{
				...
				FBSTRING* vr$39 = fb_StrConcat( &TMP$499$4, (void*)&DESC$1, -1ll, (void*)PNAME$1, 0ll );
				fb_StrAssign( (void*)&DESC$1, -1ll, (void*)vr$39, -1ll, 0 );
				if( ADDPRNTS$1 == 0ll ) goto label$183;
				{
					fb_StrConcatAssign( (void*)&DESC$1, -1ll, (void*)"()", 3ll, 0 );
				}
				label$183:;
	...
	label$160:;
	{
		...
		FBSTRING* vr$44 = fb_StrConcat( &TMP$500$2, (void*)&DESC$1, -1ll, (void*)vr$41, 0ll );
