...
void COPTDECL( void )
{
	...
	LEXSKIPTOKEN( 2048ll );
	{
		...
		goto label$16;
		label$17:;
		static const void* tmp$101[86ll] = {
			&&label$20,
			&&label$24,
			&&label$24,
			&&label$24,
		...
		if( (TMP$93$2 - 307ull) > 85ull ) goto label$24;
...
static void HUNDEFSYMBOL( void )
{
	...
	__builtin_memset( &S$1, 0, 8ll );
	{
		...
		label$52:;
		{
			S$1 = *(struct $8FBSYMBOL**)*(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 4136ll);
		...
		label$55:;
		{
			struct $8FBSYMBOL* vr$7 = SYMBFINDBYCLASS( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 4136ll), 3ll );
			S$1 = vr$7;
			...
			label$57:;
			{
				struct $8FBSYMBOL* vr$17 = SYMBFINDBYCLASS( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 4136ll), 5ll );
				S$1 = vr$17;
