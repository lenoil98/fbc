...
int64 CCOMPOUNDSTMT( void )
{
	...
	{
		if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 16ll) == 2147483648ll ) goto label$21;
		{
			fb$result$1 = 0ll;
			goto label$17;
		}
...
void CEXITSTATEMENT( void )
{
	...
	TK$1 = vr$0;
	{
		...
		label$114:;
		{
			...
			if( LABEL$1 != (struct $8FBSYMBOL*)0ull ) goto label$118;
			{
				...
				__builtin_memset( &ERRMSG$4, 0, 8ll );
				{
					...
					if( (TMP$99$5 - 345ull) > 5ull ) goto label$126;
			...
			ERRNUM$3 = 0ll;
			{
				...
				if( (TMP$100$4 - 345ull) > 5ull ) goto label$127;
		...
		if( (TMP$98$2 - 270ull) > 80ull ) goto label$153;
...
void CCONTINUESTATEMENT( void )
{
	...
	LEXSKIPTOKEN( 2048ll );
	{
		...
		if( (TMP$104$2 - 273ull) > 8ull ) goto label$185;
...
int64 CCOMPSTMTCHECK( void )
{
	...
	label$201:;
	{
		...
		{
			{
				...
				if( (TMP$108$4 - 345ull) > 5ull ) goto label$212;
		...
		if( (TMP$107$2 - 266ull) > 80ull ) goto label$203;
	...
	*(struct $7ASTNODE**)((uint8*)STK$1 + 16ll) = (struct $7ASTNODE*)0ull;
	{
		...
		if( (TMP$111$2 - 270ull) > 76ull ) goto label$225;
		...
		if( SHOWERROR$1 == 0ll ) goto label$240;
		{
			...
			label$242:;
			{
				static int64 ERRMSG$4;
				{
					...
					if( (TMP$113$5 - 266ull) > 80ull ) goto label$243;
...
void CCOMPSTMTPOP( struct $13FB_CMPSTMTSTK* STK$1 )
{
	label$255:;
	{
		...
		if( (TMP$115$2 - 270ull) > 76ull ) goto label$257;
...
static void CCOMPOUNDEND( void )
{
	label$186:;
	{
		...
		if( (TMP$106$2 - 266ull) > 84ull ) goto label$198;
