...
{
	label$30:;
	if( *(int64*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) == 35ll ) goto label$33;
	{
		goto label$31;
	}
	label$33:;
	label$32:;
	if( *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16760ll) == 0ll ) goto label$35;
	{
		goto label$31;
	}
	label$35:;
	label$34:;
	if( *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16752ll) == 257ll ) goto label$37;
	{
		if( *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16752ll) == -1ll ) goto label$39;
		{
			goto label$31;
		}
		label$39:;
	...
	*(struct $8FBSYMBOL**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16776ll) = (struct $8FBSYMBOL*)&PP$;
	LEXSKIPTOKEN( 256ll );
	PPPARSE(  );
	*(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16760ll) = *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16760ll) + -1ll;
	label$31:;
...
void PPPARSE( void )
{
	label$40:;
	{
				...
				label$50:;
				{
					...
					label$52:;
					{
						if( *(int64*)((uint8*)&ENV$ + 1144ll) <= 0ll ) goto label$54;
						{
							...
							{
								FBSTRING TMP$117$8;
								__builtin_memset( &TMP$117$8, 0, 24ll );
								fb_StrAssign( (void*)&TMP$117$8, -1ll, (void*)"#undef", 7ll, 0 );
		...
		goto label$42;
		label$43:;
		static const void* tmp$118[21ll] = {
			&&label$57,
			&&label$57,
			&&label$57,
			&&label$58,
		...
		if( (TMP$115$2 - 266ull) > 20ull ) goto label$71;
		goto *tmp$118[TMP$115$2 - 266ull];
		label$42:;
	}
	CCOMMENT( 0ll );
	if( *(int64*)((uint8*)&ENV$ + 296ll) == 0ll ) goto label$73;
	{
		...
		{
			struct $7ASTNODE* vr$19 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 49632ll) );
			ASTADD( vr$19 );
	...
	{
		{
			...
			label$142:;
			{
				...
				label$145:;
				{
					LEXSKIPTOKEN( 62ll );
					{
						...
						TMP$132$6 = vr$2;
						if( TMP$132$6 == 257ll ) goto label$150;
						label$151:;
						if( TMP$132$6 != 256ll ) goto label$149;
						label$150:;
						{
							goto label$146;
						}
			...
			{
				{
					...
					TMP$133$5 = vr$3;
					if( TMP$133$5 != 274ll ) goto label$154;
					label$155:;
					{
					...
					goto label$153;
					label$154:;
					if( TMP$133$5 != 275ll ) goto label$158;
					label$159:;
					{
			...
			label$167:;
			{
				...
				fb_StrAssign( (void*)&TMP$135$4, -1ll, (void*)vr$7, -1ll, 0 );
			...
			goto label$132;
			label$133:;
			static const void* tmp$136[369ll] = {
				&&label$164,
				&&label$132,
				&&label$132,
				&&label$132,
			...
			if( (TMP$130$3 - 9ull) > 368ull ) goto label$132;
			goto *tmp$136[TMP$130$3 - 9ull];
			label$132:;
		}
		if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 16ll) == 7ll ) goto label$169;
		{
		...
		label$169:;
		{
			DZSTRCONCATASSIGNW( &TEXT$1, (uint32*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 24ll) );
		}
		label$168:;
		LEXSKIPTOKEN( 62ll );
	}
	...
	{
		{
			...
			label$193:;
			{
				...
				label$196:;
				{
					LEXSKIPTOKEN( 62ll );
					{
						...
						int64 vr$2 = LEXGETTOKEN( 62ll );
						TMP$140$6 = vr$2;
						if( TMP$140$6 == 257ll ) goto label$201;
						label$202:;
						if( TMP$140$6 != 256ll ) goto label$200;
						label$201:;
						{
							goto label$197;
						}
			...
			{
				{
					...
					int64 vr$3 = LEXGETLOOKAHEAD( 1ll, 314ll );
					TMP$141$5 = vr$3;
					if( TMP$141$5 != 274ll ) goto label$205;
					label$206:;
					{
					...
					goto label$204;
					label$205:;
					if( TMP$141$5 != 275ll ) goto label$209;
					label$210:;
					{
			...
			label$218:;
			{
				...
				FBSTRING* vr$7 = PPTYPEOF(  );
				fb_StrAssign( (void*)&TMP$143$4, -1ll, (void*)vr$7, -1ll, 0 );
			...
			if( (TMP$138$3 - 9ull) > 368ull ) goto label$183;
			goto *tmp$144[TMP$138$3 - 9ull];
			label$183:;
		}
		if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 16ll) != 7ll ) goto label$220;
		{
			DWSTRCONCATASSIGN( &TEXT$1, (uint32*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 24ll) );
		}
		goto label$219;
		label$220:;
		{
...
static void PPINCLIB( void )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 1144ll) <= 0ll ) goto label$89;
	{
		...
		fb_StrAssign( (void*)&TMP$121$2, -1ll, (void*)"#inclib", 8ll, 0 );
...
static void PPLIBPATH( void )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 1144ll) <= 0ll ) goto label$95;
	{
		...
		fb_StrAssign( (void*)&TMP$123$2, -1ll, (void*)"#libpath", 9ll, 0 );
...
static void PPLINE( void )
{
	...
	label$99:;
	{
		...
		*(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16744ll) = (int64)vr$3;
		LEXSKIPTOKEN( 0ll );
...
static void PPLANG( void )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 1144ll) <= 0ll ) goto label$109;
	{
		...
		FBSTRING* vr$7 = fb_StrConcat( &TMP$126$2, (void*)"#lang \x22", 8ll, (void*)vr$4, -1ll );
		__builtin_memset( &TMP$127$2, 0, 24ll );
		FBSTRING* vr$10 = fb_StrConcat( &TMP$127$2, (void*)vr$7, -1ll, (void*)"\x22", 2ll );
		fb_StrAssign( (void*)&TMP$128$2, -1ll, (void*)vr$10, -1ll, 0 );
	...
	{
		{
			...
			goto label$123;
			label$124:;
			static const void* tmp$145[24ll] = {
				&&label$125,
				&&label$125,
				&&label$126,
				&&label$126,
			...
			if( (TMP$129$3 - 9ull) > 23ull ) goto label$126;
			goto *tmp$145[TMP$129$3 - 9ull];
			label$123:;
		}
	...
	{
		{
			...
			if( (TMP$137$3 - 9ull) > 23ull ) goto label$177;
			goto *tmp$146[TMP$137$3 - 9ull];
			label$174:;
		}
