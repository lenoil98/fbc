...
void FBINIT( int64 ISMAIN$1, int64 RESTARTS$1 )
{
	...
	*(int64*)((uint8*)&ENV$ + 536ll) = 0ll;
	{
		...
		label$45:;
		if( TMP$150$2 != 4ll ) goto label$43;
		label$44:;
		{
		...
		goto label$42;
		label$43:;
		if( TMP$150$2 == 1ll ) goto label$47;
		label$48:;
		if( TMP$150$2 != 0ll ) goto label$46;
		label$47:;
		{
	...
	*(int64*)((uint8*)&ENV$ + 544ll) = 0ll;
	...
	goto label$50;
	label$49:;
	TMP$151$1 = *(int64*)((uint8*)&ENV$ + 496ll) & 31ll;
	label$50:;
	*(int64*)((uint8*)&ENV$ + 528ll) = (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$151$1 * 56ll)) + 8ll) == 4ll);
...
void FBSETOPTION( int64 OPT$1, int64 VALUE$1 )
{
	label$65:;
	{
		...
		label$102:;
		{
			if( VALUE$1 >= 0ll ) goto label$104;
			{
				if( *(int64*)((uint8*)&ENV$ + 456ll) != 0ll ) goto label$106;
				{
					...
					TMP$153$5 = 1048576ll;
					label$115:;
					*(int64*)((uint8*)&ENV$ + 456ll) = TMP$153$5;
				}
				label$106:;
				label$105:;
			}
		...
		goto label$67;
		label$68:;
		static const void* tmp$156[37ll] = {
			&&label$69,
			&&label$70,
			&&label$71,
			&&label$72,
		...
		if( TMP$152$2 > 36ull ) goto label$67;
...
int64 FBGETOPTION( int64 OPT$1 )
{
	...
	label$118:;
	{
		...
		goto label$120;
		label$121:;
		static const void* tmp$158[37ll] = {
			&&label$122,
			&&label$123,
			&&label$124,
			&&label$125,
		...
		if( TMP$157$2 > 36ull ) goto label$159;
...
void FBCHANGEOPTION( int64 OPT$1, int64 VALUE$1 )
{
	label$160:;
	{
		...
		goto label$162;
		label$163:;
		static const void* tmp$160[20ll] = {
			&&label$165,
			&&label$176,
			&&label$176,
			&&label$176,
		...
		if( (TMP$159$2 - 10ull) > 19ull ) goto label$176;
...
FBSTRING* FBGETHOSTID( void )
{
	...
	__builtin_memset( &fb$result$1, 0, 24ll );
	label$192:;
	FBSTRING* vr$1 = HGETTARGETID( 5ll, 16ll );
	fb_StrAssign( (void*)&fb$result$1, -1ll, (void*)vr$1, -1ll, 0 );
	label$193:;
	FBSTRING* vr$4 = fb_StrAllocTempResult( (FBSTRING*)&fb$result$1 );
	return vr$4;
...
int64 FBGETHOSTBITS( void )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$224:;
	fb$result$1 = *(int64*)((uint8*)CPUTYPEINFO$ + 536ll);
	label$225:;
	return fb$result$1;
}
...
FBSTRING* FBGETMODULEENTRY( void )
{
	...
	fb_StrAssign( (void*)&TMP$173$1, -1ll, (void*)((uint8*)&ENV$ + 856ll), 261ll, 0 );
...
FBSTRING* FBGETINPUTFILEPARENTDIR( void )
{
	...
	FBSTRING* vr$13 = fb_StrConcat( &TMP$176$1, (void*)&S$1, -1ll, (void*)((uint8*)&ENV$ + 560ll), 261ll );
...
void FBADDLIB( uint8* LIBNAME$1 )
{
	...
	fb_StrAssign( (void*)&TMP$179$1, -1ll, (void*)LIBNAME$1, 0ll, 0 );
	STRSETADD( (struct $7TSTRSET*)((uint8*)&ENV$ + 1400ll), &TMP$179$1, 0ll );
...
void FBADDLIBPATH( uint8* PATH$1 )
{
	...
	fb_StrAssign( (void*)&TMP$180$1, -1ll, (void*)PATH$1, 0ll, 0 );
	FBSTRING* vr$4 = PATHSTRIPDIV( &TMP$180$1 );
	fb_StrAssign( (void*)&TMP$181$1, -1ll, (void*)vr$4, -1ll, 0 );
	STRSETADD( (struct $7TSTRSET*)((uint8*)&ENV$ + 1488ll), &TMP$181$1, 0ll );
...
void FBCOMPILE( uint8* INFNAME$1, uint8* OUTFNAME$1, FBSTRING* PPONLYFILE$1, int64 ISMAIN$1 )
{
	...
	HREPLACESLASH( (uint8*)((uint8*)&ENV$ + 560ll), 47ll );
	...
	*(int64*)((uint8*)&ENV$ + 552ll) = (int64)vr$7;
	...
	if( *(int64*)((uint8*)&ENV$ + 472ll) == 0ll ) goto label$317;
	{
		...
		fb_StrAssign( (void*)&TMP$192$2, -1ll, (void*)INFNAME$1, 0ll, 0 );
		FBSTRING* vr$17 = PATHSTRIPCURDIR( &TMP$192$2 );
		fb_StrAssign( (void*)&TMP$193$2, -1ll, (void*)vr$17, -1ll, 0 );
		HSHOWINCLUDE( 0ll, &TMP$193$2 );
	...
	*($13FBFILE_FORMAT*)((uint8*)&ENV$ + 840ll) = vr$22;
	int64 vr$23 = (*(tmp$38*)((uint8*)&IR$ + 24ll))(  );
...
void FBINCLUDEFILE( uint8* FILENAME$1, int64 ISONCE$1 )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 1224ll) < 16ll ) goto label$375;
	{
	...
	if( vr$6 != 0ll ) goto label$377;
	{
		...
		if( vr$7 != 0ll ) goto label$379;
		{
			...
			goto label$380;
			label$381:;
			if( PATH$3 != (FBSTRING*)0ull ) goto label$385;
			{
				FBSTRING TMP$204$4;
				FBSTRING TMP$205$4;
				FBSTRING TMP$206$4;
				if( *(int64*)((uint8*)&ENV$ + 472ll) == 0ll ) goto label$387;
				{
					FBSTRING TMP$201$5;
					FBSTRING TMP$202$5;
					__builtin_memset( &TMP$202$5, 0, 24ll );
					__builtin_memset( &TMP$201$5, 0, 24ll );
					FBSTRING* vr$21 = fb_StrConcat( &TMP$201$5, (void*)FILENAME$1, 0ll, (void*)" (not found in include dirs)", 29ll );
					fb_StrAssign( (void*)&TMP$202$5, -1ll, (void*)vr$21, -1ll, 0 );
					HSHOWINCLUDE( *(int64*)((uint8*)&ENV$ + 1224ll) + 1ll, &TMP$202$5 );
				...
				FBSTRING* vr$29 = fb_StrConcat( &TMP$204$4, (void*)"\x22", 2ll, (void*)FILENAME$1, 0ll );
				__builtin_memset( &TMP$205$4, 0, 24ll );
				FBSTRING* vr$32 = fb_StrConcat( &TMP$205$4, (void*)vr$29, -1ll, (void*)"\x22", 2ll );
				fb_StrAssign( (void*)&TMP$206$4, -1ll, (void*)vr$32, -1ll, 0 );
				ERRREPORTEX( 23ll, (uint8*)*(uint8**)&TMP$206$4, 0ll, 1ll, (uint8*)0ull );
	...
	int64 vr$36 = IS_ROOTPATH( &TMP$207$1 );
	if( vr$36 != 0ll ) goto label$389;
	{
		FBSTRING TMP$208$2;
		FBSTRING TMP$209$2;
		FBSTRING* vr$37 = HCURDIR(  );
		__builtin_memset( &TMP$208$2, 0, 24ll );
		FBSTRING* vr$40 = fb_StrConcat( &TMP$208$2, (void*)vr$37, -1ll, (void*)"/", 2ll );
		__builtin_memset( &TMP$209$2, 0, 24ll );
		FBSTRING* vr$43 = fb_StrConcat( &TMP$209$2, (void*)vr$40, -1ll, (void*)INCFILE$1, 260ll );
		fb_StrAssign( (void*)INCFILE$1, 260ll, (void*)vr$43, -1ll, 0 );
	}
	label$389:;
	label$388:;
	TMP$210$1 = (uint8*)INCFILE$1;
	int64 vr$45 = IS_ROOTPATH( &TMP$210$1 );
	if( vr$45 != 0ll ) goto label$391;
	{
		FBSTRING TMP$211$2;
		FBSTRING TMP$212$2;
		FBSTRING TMP$213$2;
		...
		FBSTRING* vr$49 = fb_StrConcat( &TMP$211$2, (void*)"\x22", 2ll, (void*)INCFILE$1, 260ll );
		__builtin_memset( &TMP$212$2, 0, 24ll );
		FBSTRING* vr$52 = fb_StrConcat( &TMP$212$2, (void*)vr$49, -1ll, (void*)"\x22", 2ll );
		fb_StrAssign( (void*)&TMP$213$2, -1ll, (void*)vr$52, -1ll, 0 );
		ERRREPORTEX( 23ll, (uint8*)*(uint8**)&TMP$213$2, 0ll, 1ll, (uint8*)0ull );
	...
	if( vr$55 != 0ll ) goto label$393;
	{
		...
		FBSTRING* vr$59 = fb_StrConcat( &TMP$214$2, (void*)"\x22", 2ll, (void*)INCFILE$1, 260ll );
		__builtin_memset( &TMP$215$2, 0, 24ll );
		FBSTRING* vr$62 = fb_StrConcat( &TMP$215$2, (void*)vr$59, -1ll, (void*)"\x22", 2ll );
		fb_StrAssign( (void*)&TMP$216$2, -1ll, (void*)vr$62, -1ll, 0 );
		ERRREPORTEX( 23ll, (uint8*)*(uint8**)&TMP$216$2, 0ll, 1ll, (uint8*)0ull );
	...
	if( ISONCE$1 == 0ll ) goto label$395;
	{
		uint8* vr$66 = HFINDINCFILE( (struct $5THASH*)((uint8*)&ENV$ + 1176ll), (uint8*)INCFILE$1 );
		if( vr$66 == (uint8*)0ull ) goto label$397;
		{
			FBSTRING TMP$217$3;
			__builtin_memset( &TMP$217$3, 0, 24ll );
			fb_StrAssign( (void*)&TMP$217$3, -1ll, (void*)INCFILE$1, 260ll, 0 );
	...
	if( vr$72 == (uint8*)0ull ) goto label$399;
	{
		FBSTRING TMP$218$2;
		__builtin_memset( &TMP$218$2, 0, 24ll );
		fb_StrAssign( (void*)&TMP$218$2, -1ll, (void*)INCFILE$1, 260ll, 0 );
	...
	*(uint8**)((uint8*)&ENV$ + 824ll) = FILEIDX$1;
	if( *(int64*)((uint8*)&ENV$ + 472ll) == 0ll ) goto label$401;
	{
		FBSTRING TMP$219$2;
		FBSTRING TMP$220$2;
		...
		fb_StrAssign( (void*)&TMP$220$2, -1ll, (void*)vr$90, -1ll, 0 );
		HSHOWINCLUDE( *(int64*)((uint8*)&ENV$ + 1224ll), &TMP$220$2 );
	...
	*(int64*)((uint8*)&ENV$ + 552ll) = (int64)vr$95;
	...
	if( (int64)vr$99 == 0ll ) goto label$403;
	{
		FBSTRING TMP$221$2;
		FBSTRING TMP$222$2;
		FBSTRING TMP$223$2;
		...
		FBSTRING* vr$104 = fb_StrConcat( &TMP$221$2, (void*)"\x22", 2ll, (void*)FILENAME$1, 0ll );
		__builtin_memset( &TMP$222$2, 0, 24ll );
		FBSTRING* vr$107 = fb_StrConcat( &TMP$222$2, (void*)vr$104, -1ll, (void*)"\x22", 2ll );
		fb_StrAssign( (void*)&TMP$223$2, -1ll, (void*)vr$107, -1ll, 0 );
		ERRREPORTEX( 23ll, (uint8*)*(uint8**)&TMP$223$2, 0ll, 1ll, (uint8*)0ull );
	...
	*($13FBFILE_FORMAT*)((uint8*)&ENV$ + 840ll) = vr$110;
	...
	if( (int64)vr$112 == 0ll ) goto label$404;
...
$7FB_LANG FBGETLANGID( uint8* TXT$1 )
{
	...
	label$407:;
	{
		...
		fb_StrInit( (void*)&TMP$224$2, -1ll, (void*)vr$2, -1ll, 0 );
		int32 vr$5 = fb_StrCompare( (void*)&TMP$224$2, -1ll, (void*)"fb", 3ll );
		if( (int64)vr$5 != 0ll ) goto label$410;
		label$411:;
		{
			fb$result$1 = 0ll;
		}
		goto label$409;
		label$410:;
		int32 vr$8 = fb_StrCompare( (void*)&TMP$224$2, -1ll, (void*)"deprecated", 11ll );
		if( (int64)vr$8 != 0ll ) goto label$412;
		label$413:;
		{
			fb$result$1 = 1ll;
		}
		goto label$409;
		label$412:;
		int32 vr$11 = fb_StrCompare( (void*)&TMP$224$2, -1ll, (void*)"fblite", 7ll );
		if( (int64)vr$11 != 0ll ) goto label$414;
		label$415:;
		{
			fb$result$1 = 2ll;
		}
		goto label$409;
		label$414:;
		int32 vr$14 = fb_StrCompare( (void*)&TMP$224$2, -1ll, (void*)"qb", 3ll );
		if( (int64)vr$14 != 0ll ) goto label$416;
		label$417:;
		{
			fb$result$1 = 3ll;
		}
...
$19FB_CVA_LIST_TYPEDEF FBGETBACKENDVALISTTYPE( void )
{
	...
	TYPEDEF$1 = 0ll;
	{
		...
		TMP$225$2 = *($10FB_BACKEND*)((uint8*)&ENV$ + 208ll);
		if( TMP$225$2 != 1ll ) goto label$422;
		label$423:;
		{
			{
				int64 TMP$226$4;
				...
				TMP$226$4 = vr$1;
				if( TMP$226$4 != 0ll ) goto label$425;
				label$426:;
				{
					TYPEDEF$1 = 2ll;
				}
				goto label$424;
				label$425:;
				if( TMP$226$4 != 1ll ) goto label$427;
				label$428:;
				{
					{
						$13FB_COMPTARGET TMP$227$6;
						TMP$227$6 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 216ll);
						if( TMP$227$6 != 0ll ) goto label$430;
						label$431:;
						{
							TYPEDEF$1 = 2ll;
						}
				...
				goto label$424;
				label$427:;
				if( TMP$226$4 != 2ll ) goto label$433;
				label$434:;
				{
					TYPEDEF$1 = 5ll;
				}
				goto label$424;
				label$433:;
				if( TMP$226$4 != 3ll ) goto label$435;
				label$436:;
				{
					TYPEDEF$1 = 4ll;
				}
				goto label$424;
				label$435:;
				if( TMP$226$4 != 4ll ) goto label$437;
				label$438:;
				{
					TYPEDEF$1 = 2ll;
				}
				goto label$424;
				label$437:;
				if( TMP$226$4 != 5ll ) goto label$439;
				label$440:;
				{
					TYPEDEF$1 = 2ll;
				}
		...
		goto label$421;
		label$422:;
		if( TMP$225$2 != 0ll ) goto label$442;
		label$443:;
		{
			TYPEDEF$1 = 1ll;
		}
		goto label$421;
		label$442:;
		if( TMP$225$2 != 2ll ) goto label$444;
		label$445:;
		{
			TYPEDEF$1 = 1ll;
		}
		goto label$421;
		label$444:;
		if( TMP$225$2 != 3ll ) goto label$446;
		label$447:;
		{
			{
				$13FB_COMPTARGET TMP$228$4;
				TMP$228$4 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 216ll);
				if( TMP$228$4 != 0ll ) goto label$449;
				label$450:;
				{
					TYPEDEF$1 = 2ll;
				}
	...
	if( TYPEDEF$1 != 2ll ) goto label$454;
	{
		int64 vr$2 = FBGETOPTION( 27ll );
		if( vr$2 == 0ll ) goto label$456;
		{
			TYPEDEF$1 = 1ll;
		}
		label$456:;
...
static FBSTRING* HGETTARGETID( int64 OS$1, int64 CPUTYPE$1 )
{
	...
	FBSTRING* vr$19 = fb_StrConcat( &TMP$164$1, (void*)vr$16, -1ll, *(void**)((uint8*)CPUFAMILYINFO$ + (CPUFAMILY$1 << (4ll & 63ll))), 0ll );
...
static void HAPPENDFBCTINF( uint8* VALUE$1 )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 1576ll) != 0ll ) goto label$281;
	{
		*(int64*)((uint8*)&ENV$ + 1576ll) = -1ll;
		(*(tmp$37*)((uint8*)&IR$ + 432ll))(  );
	}
	label$281:;
	label$280:;
	(*(tmp$68*)((uint8*)&IR$ + 440ll))( VALUE$1 );
	label$279:;
}
...
static void HEMITOBJINFO( void )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 272ll) == 0ll ) goto label$297;
	{
		...
		fb_StrAssign( (void*)&TMP$183$2, -1ll, (void*)vr$17, -1ll, 0 );
...
static void HSHOWINCLUDE( int64 INCLUDELEVEL$1, FBSTRING* MESSAGE$1 )
{
	...
	FBSTRING* vr$6 = fb_StrConcat( &TMP$186$1, (void*)&LN$1, -1ll, (void*)MESSAGE$1, -1ll );
...
static void HONSKIPPEDFILE( FBSTRING* FILENAME$1 )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 472ll) == 0ll ) goto label$309;
	{
		...
		FBSTRING* vr$4 = fb_StrConcat( &TMP$189$2, (void*)"(", 2ll, (void*)vr$1, -1ll );
		__builtin_memset( &TMP$190$2, 0, 24ll );
		FBSTRING* vr$7 = fb_StrConcat( &TMP$190$2, (void*)vr$4, -1ll, (void*)")", 2ll );
		fb_StrAssign( (void*)&TMP$191$2, -1ll, (void*)vr$7, -1ll, 0 );
		HSHOWINCLUDE( *(int64*)((uint8*)&ENV$ + 1224ll) + 1ll, &TMP$191$2 );
...
static int64 GET_ROOTPATH_LEN( uint8* PATH$1 )
{
	...
	label$352:;
	fb$result$1 = 0ll;
	if( (int64)*PATH$1 != 0ll ) goto label$355;
	{
		goto label$353;
	}
	label$355:;
...
static int64 SOLVE_PATH( uint8* PATH$1 )
{
	...
	static struct $8FBARRAY1IlE tmp$194$1 = { (int64*)CIDX$1, (int64*)CIDX$1, 1048ll, 8ll, 1ll, 49ll, { { 131ll, 0ll, 130ll } } };
	int64 STK$1;
	int64 S$1;
	int64 N$1;
	int64 D$1;
	...
	*(int64*)((uint8*)CIDX$1 + (STK$1 << (3ll & 63ll))) = S$1;
	...
	D$1 = 0ll;
	{
		...
		label$361:;
		{
			...
			if( ((int64)-((uint64)C$1 == 47ull) | (int64)-((uint64)C$1 == 92ull)) == 0ll ) goto label$363;
			{
				if( N$1 != 0ll ) goto label$365;
				{
				}
				goto label$364;
				label$365:;
				if( ((int64)-(D$1 == 1ll) & (int64)-(N$1 == 1ll)) == 0ll ) goto label$366;
				{
					W$1 = W$1 + -1ll;
				}
				goto label$364;
				label$366:;
				if( ((int64)-(D$1 == 2ll) & (int64)-(N$1 == 2ll)) == 0ll ) goto label$367;
				{
					if( STK$1 == 0ll ) goto label$369;
					{
						STK$1 = STK$1 + -1ll;
					}
					label$369:;
			...
			label$363:;
			{
				if( (uint64)C$1 != 46ull ) goto label$371;
				{
					D$1 = D$1 + 1ll;
				}
				label$371:;
