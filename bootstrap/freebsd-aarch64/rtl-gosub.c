...
{
	label$10:;
	if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 65536ll) == 0ll ) goto label$13;
	{
...
struct $7ASTNODE* RTLGOSUBPUSH( struct $7ASTNODE* CTX$1 )
{
	...
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_GosubPush", 335ll );
...
struct $7ASTNODE* RTLGOSUBPOP( struct $7ASTNODE* CTX$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	fb$result$1 = (struct $7ASTNODE*)0ull;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_GosubPop", 336ll );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$2;
	struct $7ASTNODE* vr$3 = ASTNEWARG( PROC$1, CTX$1, 2147483648ll, -1ll );
...
int64 RTLGOSUBRETURN( struct $7ASTNODE* CTX$1 )
{
	...
	label$28:;
	struct $7ASTNODE* PROC$1;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_GosubReturn", 337ll );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$2;
	struct $7ASTNODE* vr$3 = ASTNEWARG( PROC$1, CTX$1, 2147483648ll, -1ll );
...
struct $7ASTNODE* RTLGOSUBEXIT( struct $7ASTNODE* CTX$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	fb$result$1 = (struct $7ASTNODE*)0ull;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_GosubExit", 338ll );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$2;
	struct $7ASTNODE* vr$3 = ASTNEWARG( PROC$1, CTX$1, 2147483648ll, -1ll );
...
struct $7ASTNODE* RTLSETJMP( struct $7ASTNODE* CTX$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	fb$result$1 = (struct $7ASTNODE*)0ull;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_SetJmp", 339ll );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0ull );
	PROC$1 = vr$2;
	struct $7ASTNODE* vr$3 = ASTNEWARG( PROC$1, CTX$1, 2147483648ll, -1ll );
