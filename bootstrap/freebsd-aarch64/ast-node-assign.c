...
int64 ASTCHECKASSIGN( struct $7ASTNODE* L$1, struct $7ASTNODE* R$1 )
{
	...
	label$133:;
	LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$93$1 * 56ll));
	...
	label$134:;
	RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$94$1 * 56ll));
	...
	if( ((int64)-(LDTYPE$1 == 7ll) | (int64)-(RDTYPE$1 == 7ll)) == 0ll ) goto label$98;
	{
		if( LDTYPE$1 == RDTYPE$1 ) goto label$100;
		{
			...
			label$135:;
			LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$95$3 * 56ll));
			...
			label$136:;
			RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$96$3 * 56ll));
	...
	if( ((int64)-(LDTYPE$1 == 4ll) | (int64)-(RDTYPE$1 == 4ll)) == 0ll ) goto label$109;
	{
		...
		label$139:;
		LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$99$2 * 56ll));
		...
		label$140:;
		RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$100$2 * 56ll));
...
struct $7ASTNODE* ASTNEWASSIGN( struct $7ASTNODE* L$1, struct $7ASTNODE* R$1, $9AST_OPOPT OPTIONS$1 )
{
	...
	label$265:;
	LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$104$1 * 56ll));
	...
	label$267:;
	RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$106$1 * 56ll));
	...
	label$269:;
	RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$109$1 * 56ll));
	...
	if( ((int64)-(LDTYPE$1 == 20ll) | (int64)-(RDTYPE$1 == 20ll)) == 0ll ) goto label$204;
	{
		...
		label$271:;
		LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$111$2 * 56ll));
	...
	if( ((int64)-(LDTYPE$1 == 7ll) | (int64)-(RDTYPE$1 == 7ll)) == 0ll ) goto label$217;
	{
		...
		label$219:;
		{
			...
			label$272:;
			LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$112$3 * 56ll));
			...
			label$273:;
			RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$113$3 * 56ll));
	...
	if( ((int64)-(LDTYPE$1 == 4ll) | (int64)-(RDTYPE$1 == 4ll)) == 0ll ) goto label$230;
	{
		...
		label$276:;
		LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$116$2 * 56ll));
		...
		label$277:;
		RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$117$2 * 56ll));
...
struct $6IRVREG* ASTLOADASSIGN( struct $7ASTNODE* N$1 )
{
	...
	{
		(*(tmp$44*)((uint8*)&IR$ + 208ll))( VR$1, VS$1 );
	}
	label$289:;
	label$288:;
	ASTDELNODE( L$1 );
...
static int64 HCHECKCONSTANDPOINTEROPS( struct $7ASTNODE* L$1, $11FB_DATATYPE LDTYPE$1, struct $7ASTNODE* R$1, $11FB_DATATYPE RDTYPE$1 )
{
	...
	if( (LDTYPE$1 & 480ll) == 0ll ) goto label$67;
	{
		...
		label$293:;
		if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$89$2 * 56ll)) != 1ll ) goto label$70;
		{
			goto label$63;
		}
		label$70:;
	...
	if( (RDTYPE$1 & 480ll) == 0ll ) goto label$79;
	{
		...
		label$294:;
		if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$90$2 * 56ll)) != 1ll ) goto label$82;
		{
			goto label$63;
		}
		label$82:;
...
static struct $7ASTNODE* HSHALLOWCOPY( struct $7ASTNODE* L$1, struct $7ASTNODE* R$1, int64 OPTIONS$1 )
{
	...
	if( HAS_VPTR$1 == 0ll ) goto label$150;
	{
		...
		label$152:;
		label$151:;
		struct $7ASTNODE* vr$19 = _Z19ASTBUILDDEREFADDROFP7ASTNODExlP8FBSYMBOLS2_( L$1, *(int64*)((uint8*)&ENV$ + 544ll), 2ll, (struct $8FBSYMBOL*)0ull, (struct $8FBSYMBOL*)0ull );
		L$1 = vr$19;
		struct $7ASTNODE* vr$20 = _Z19ASTBUILDDEREFADDROFP7ASTNODExlP8FBSYMBOLS2_( R$1, *(int64*)((uint8*)&ENV$ + 544ll), 2ll, (struct $8FBSYMBOL*)0ull, (struct $8FBSYMBOL*)0ull );
		R$1 = vr$20;
	}
	label$150:;
	label$149:;
