...
struct $7ASTNODE* CATOM( struct $8FBSYMBOL* BASE_PARENT$1, struct $10FBSYMCHAIN* CHAIN_$1 )
{
	...
	label$169:;
	{
		...
		label$176:;
		{
			...
			{
				struct $7ASTNODE* vr$7 = HCHECKID( BASE_PARENT$1, *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 4136ll) );
				fb$result$1 = vr$7;
				goto label$168;
			}
			label$178:;
		...
		if( TMP$99$2 > 6ull ) goto label$171;
...
static struct $7ASTNODE* HFINDID_QB( struct $8FBSYMBOL* BASE_PARENT$1, struct $10FBSYMCHAIN* CHAIN_$1 )
{
	...
	label$50:;
	{
		...
		{
			struct $7ASTNODE* vr$43 = _Z11CVARIABLEEXP8FBSYMBOLl( VAR_SYM$2, (int64)-((*(int64*)((uint8*)&PARSER$ + 296ll) & 2ll) != 0ll) );
			fb$result$1 = vr$43;
			goto label$49;
		}
		label$114:;
		...
		{
			{
				...
				label$129:;
				{
					struct $7ASTNODE* vr$8 = _Z11CVARIABLEEXP10FBSYMCHAINl( CHAIN_$1, (int64)-((*(int64*)((uint8*)&PARSER$ + 296ll) & 2ll) != 0ll) );
					fb$result$1 = vr$8;
					goto label$116;
				}
				goto label$125;
				...
				goto label$125;
				label$126:;
				static const void* tmp$105[13ll] = {
					&&label$129,
					&&label$127,
					&&label$128,
					&&label$125,
				...
				if( (TMP$97$4 - 1ull) > 12ull ) goto label$125;
...
static struct $7ASTNODE* HCHECKID( struct $8FBSYMBOL* BASE_PARENT$1, struct $10FBSYMCHAIN* CHAIN_$1 )
{
	...
	label$166:;
	label$165:;
	struct $7ASTNODE* vr$13 = _Z11CVARIABLEEXP10FBSYMCHAINl( (struct $10FBSYMCHAIN*)0ull, (int64)-((*(int64*)((uint8*)&PARSER$ + 296ll) & 2ll) != 0ll) );
	fb$result$1 = vr$13;
	goto label$154;
	label$154:;
	return fb$result$1;
