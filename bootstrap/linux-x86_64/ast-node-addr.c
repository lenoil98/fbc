...
struct $6IRVREG* ASTLOADOFFSET( struct $7ASTNODE* N$1 )
{
	...
	{
		struct $6IRVREG* vr$8 = (*(tmp$72*)((uint8*)&IR$ + 504ll))( *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), SYM$1, *(int64*)((uint8*)N$1 + 40ll) );
		VR$1 = vr$8;
	}
	label$25:;
	label$24:;
...
struct $6IRVREG* ASTLOADADDROF( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$92;
	{
		...
		label$98:;
		if( (((int64)-(*(int64*)V1$1 != 4ll) | (int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$86$2 * 56ll)) != 0ll)) | (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$87$2 * 56ll)) + 8ll) != *(int64*)((uint8*)&ENV$ + 544ll))) == 0ll ) goto label$96;
		{
			struct $6IRVREG* vr$21 = (*(tmp$69*)((uint8*)&IR$ + 456ll))( *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll) );
			VR$1 = vr$21;
			(*(tmp$51*)((uint8*)&IR$ + 248ll))( 22ll, V1$1, VR$1 );
		}
		goto label$95;
		label$96:;
		{
