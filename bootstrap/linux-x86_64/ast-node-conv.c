...
int64 ASTCHECKCONVNONPTRTOPTR( int64 TO_DTYPE$1, int64 EXPR_DTYPE$1, struct $7ASTNODE* EXPR$1, $11AST_CONVOPT OPTIONS$1 )
{
	...
	label$78:;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$93$1 * 56ll)) != 0ll ) goto label$70;
	{
		int64 TMP$94$2;
		...
		label$79:;
		if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$94$2 * 56ll)) + 8ll) != *(int64*)((uint8*)&ENV$ + 544ll) ) goto label$77;
		{
			fb$result$1 = 0ll;
			goto label$67;
		}
...
int64 ASTCHECKCONV( int64 TO_DTYPE$1, struct $8FBSYMBOL* TO_SUBTYPE$1, struct $7ASTNODE* L$1 )
{
	...
	label$147:;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$101$1 * 56ll)) != 2ll ) goto label$133;
	{
		goto label$122;
	}
	label$133:;
...
struct $7ASTNODE* ASTNEWCONV( int64 TO_DTYPE$1, struct $8FBSYMBOL* TO_SUBTYPE$1, struct $7ASTNODE* L$1, $11AST_CONVOPT OPTIONS$1, int64* PERRMSG$1 )
{
	...
	label$291:;
	if( TMP$104$1 != 20ll ) goto label$180;
	{
	...
	}
	{
		...
		label$202:;
		{
			...
			label$293:;
			if( TMP$107$3 == 20ll ) goto label$205;
			{
				goto label$163;
			}
			label$205:;
		...
		label$208:;
		{
			...
			label$294:;
			if( TMP$108$3 != 20ll ) goto label$211;
			{
				goto label$163;
			}
			label$211:;
		...
		if( TMP$106$2 > 20ull ) goto label$208;
	...
	label$295:;
	LDCLASS$1 = *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$109$1 * 56ll));
	...
	{
		{
			...
			if( (TMP$111$3 - 4ull) > 14ull ) goto label$226;
		...
		{
			{
				...
				label$297:;
				TMP$113$4 = TMP$112$4;
				if( TMP$113$4 == 4ll ) goto label$234;
				label$235:;
				if( TMP$113$4 != 7ll ) goto label$233;
				label$234:;
				{
	...
	label$298:;
	if( LDCLASS$1 != *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$114$1 * 56ll)) ) goto label$242;
	{
		{
			int64 TMP$115$3;
			int64 TMP$116$3;
			...
			label$299:;
			TMP$116$3 = TMP$115$3;
			if( TMP$116$3 != 20ll ) goto label$245;
			label$246:;
			{
				DOCONV$1 = 0ll;
			}
			...
			label$245:;
			{
				...
				label$249:;
				{
					...
					label$301:;
					if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$117$5 * 56ll)) + 8ll) != *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$118$5 * 56ll)) + 8ll) ) goto label$255;
					{
						DOCONV$1 = 0ll;
					}
					label$255:;
	...
	if( (*(int64*)((uint8*)&IR$ + 552ll) & 1ll) == 0ll ) goto label$257;
	{
		...
		label$302:;
		if( ((int64)-(LDCLASS$1 == 1ll) & (int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$119$2 * 56ll)) == 1ll)) == 0ll ) goto label$260;
		{
			int64 TMP$120$3;
			int64 TMP$121$3;
			...
			label$304:;
			if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$120$3 * 56ll)) + 8ll) == *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$121$3 * 56ll)) + 8ll) ) goto label$264;
			{
				DOCONV$1 = -1ll;
			}
			label$264:;
	...
	*(int64*)((uint8*)N$1 + 56ll) = 0ll;
	...
	if( *(int64*)((uint8*)&ENV$ + 208ll) != 0ll ) goto label$284;
	{
		if( DOCONV$1 == 0ll ) goto label$286;
		{
			...
			label$305:;
			if( TMP$124$3 != 16ll ) goto label$289;
			{
				int64 TMP$125$4;
...
void ASTUPDATECONVFD2FS( struct $7ASTNODE* N$1, int64 TO_DTYPE$1, int64 IS_EXPR$1 )
{
	...
	label$321:;
	*(int64*)((uint8*)N$1 + 48ll) = (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$128$1 * 56ll)) + 8ll) >= 4ll);
	...
	label$322:;
	if( TMP$129$1 != 15ll ) goto label$320;
	{
...
struct $6IRVREG* ASTLOADCONV( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$328;
	{
		*(int64*)((uint8*)VS$1 + 40ll) = *(int64*)((uint8*)N$1 + 32ll);
		...
		{
			struct $6IRVREG* vr$8 = (*(tmp$69*)((uint8*)&IR$ + 456ll))( *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll) );
			VR$1 = vr$8;
			*(int64*)((uint8*)VR$1 + 40ll) = *(int64*)((uint8*)N$1 + 32ll);
			(*(tmp$44*)((uint8*)&IR$ + 120ll))( VR$1, VS$1 );
			if( *(int64*)((uint8*)N$1 + 48ll) == 0ll ) goto label$332;
			{
				if( *(int64*)((uint8*)VS$1 + 8ll) != 16ll ) goto label$334;
				{
					if( *(int64*)((uint8*)VR$1 + 8ll) != 15ll ) goto label$336;
					{
						...
						{
							(*(tmp$51*)((uint8*)&IR$ + 200ll))( 74ll, VR$1, (struct $6IRVREG*)0ull );
						}
						label$338:;
						label$337:;
					}
		...
		{
			VR$1 = VS$1;
			(*(tmp$75*)((uint8*)&IR$ + 512ll))( VR$1, *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll) );
		}
		label$329:;
	}
	label$328:;
...
static void HCONSTCONV( int64 TODTYPE$1, struct $7ASTNODE* L$1 )
{
	...
	label$365:;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$84$1 * 56ll)) != 1ll ) goto label$14;
	{
		{
			int64 TMP$85$3;
			uint64 TMP$86$3;
			...
			label$366:;
			TMP$86$3 = *(uint64*)(((uint8*)SYMB_DTYPETB$ + (TMP$85$3 * 56ll)) + 40ll);
			goto label$17;
			label$18:;
			{
	...
	label$368:;
	if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$88$1 * 56ll)) + 16ll) == 0ll ) goto label$32;
	{
		{
			int64 TMP$89$3;
			uint64 TMP$90$3;
			...
			label$369:;
			TMP$90$3 = *(uint64*)(((uint8*)SYMB_DTYPETB$ + (TMP$89$3 * 56ll)) + 40ll);
			goto label$36;
			label$37:;
			{
	...
	{
		{
			...
			label$370:;
			TMP$92$3 = *(uint64*)(((uint8*)SYMB_DTYPETB$ + (TMP$91$3 * 56ll)) + 40ll);
			goto label$50;
			label$51:;
			{
...
static int64 HCHECKPTR( int64 TO_DTYPE$1, struct $8FBSYMBOL* TO_SUBTYPE$1, int64 EXPR_DTYPE$1, struct $7ASTNODE* EXPR$1, $11AST_CONVOPT OPTIONS$1 )
{
	...
	if( (EXPR_DTYPE$1 & 480ll) == 0ll ) goto label$86;
	{
		...
		label$371:;
		if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$95$2 * 56ll)) != 0ll ) goto label$89;
		{
			int64 TMP$96$3;
			...
			label$372:;
			if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$96$3 * 56ll)) + 8ll) != *(int64*)((uint8*)&ENV$ + 544ll) ) goto label$96;
			{
				goto label$81;
			}
			label$96:;
