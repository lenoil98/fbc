							...
							{
								{
									...
									TMP$109$9 = *($11FB_DATATYPE*)((uint8*)RANK$1 + (I$1 << (3ll & 63ll)));
									*($11FB_DATATYPE*)((uint8*)RANK$1 + (I$1 << (3ll & 63ll))) = *($11FB_DATATYPE*)((uint8*)RANK$1 + (J$1 << (3ll & 63ll)));
									*($11FB_DATATYPE*)((uint8*)RANK$1 + (J$1 << (3ll & 63ll))) = TMP$109$9;
								}
							}
							label$31:;
							label$30:;
...
void TYPEMAX( int64 LDTYPE$1, struct $8FBSYMBOL* LSUBTYPE$1, int64 RDTYPE$1, struct $8FBSYMBOL* RSUBTYPE$1, int64* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1 )
{
	...
	label$52:;
	DTYPE1$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$110$1 * 56ll)) + 32ll);
	...
	label$53:;
	DTYPE2$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$111$1 * 56ll)) + 32ll);
	...
	label$55:;
	if( ((int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$112$1 * 56ll)) == 0ll) & (int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$113$1 * 56ll)) == 0ll)) == 0ll ) goto label$44;
	{
		int64 TMP$114$2;
		int64 TMP$115$2;
		...
		label$57:;
		if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$114$2 * 56ll)) + 24ll) <= *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$115$2 * 56ll)) + 24ll) ) goto label$50;
		{
			*DTYPE$1 = LDTYPE$1;
			*SUBTYPE$1 = LSUBTYPE$1;
		}
...
$11FB_DATATYPE CLOSESTTYPE( $11FB_DATATYPE DTYPE$1, $11FB_DATATYPE DTYPE1$1, $11FB_DATATYPE DTYPE2$1 )
{
	...
	label$196:;
	SAMECLASS1$1 = (int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$130$1 * 56ll)) == *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$131$1 * 56ll)));
	int64 SAMECLASS2$1;
	...
	label$198:;
	SAMECLASS2$1 = (int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$132$1 * 56ll)) == *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$133$1 * 56ll)));
	...
	label$200:;
	LARGER1$1 = (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$134$1 * 56ll)) + 8ll) >= *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$135$1 * 56ll)) + 8ll));
	int64 LARGER2$1;
	...
	label$202:;
	LARGER2$1 = (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$136$1 * 56ll)) + 8ll) >= *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$137$1 * 56ll)) + 8ll));
	...
	label$204:;
	SIZEDIFF1$1 = __builtin_llabs( (*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$138$1 * 56ll)) + 8ll) - *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$139$1 * 56ll)) + 8ll)) );
	int64 SIZEDIFF2$1;
	...
	label$206:;
	SIZEDIFF2$1 = __builtin_llabs( (*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$140$1 * 56ll)) + 8ll) - *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$141$1 * 56ll)) + 8ll)) );
	...
	label$208:;
	SAMESIGN1$1 = (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$142$1 * 56ll)) + 16ll) == *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$143$1 * 56ll)) + 16ll));
	int64 SAMESIGN2$1;
	...
	label$210:;
	SAMESIGN2$1 = (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$144$1 * 56ll)) + 16ll) == *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$145$1 * 56ll)) + 16ll));
...
$22FB_OVLPROC_MATCH_SCORE TYPECALCMATCH( int64 LDTYPE$1, struct $8FBSYMBOL* LSUBTYPE$1, int64 LPARAMMODE$1, int64 RDTYPE$1, struct $8FBSYMBOL* RSUBTYPE$1 )
{
	...
	if( LDT$1 == RDT$1 ) goto label$222;
	{
		...
		label$241:;
		if( (((int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$146$2 * 56ll)) == 0ll) & (int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$147$2 * 56ll)) == 0ll)) & (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$148$2 * 56ll)) + 8ll) == *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$149$2 * 56ll)) + 8ll))) == 0ll ) goto label$228;
		{
