...
FBSTRING* HSTRIPPATH( uint8* FILENAME$1 )
{
	...
	label$90:;
	{
		...
		*(int64*)((uint8*)P$1 + 8ll) = vr$8;
		if( ((int64)-(*(int64*)P$1 == 0ll) | ((int64)-(*(int64*)((uint8*)P$1 + 8ll) > 0ll) & (int64)-(*(int64*)((uint8*)P$1 + 8ll) < *(int64*)P$1))) == 0ll ) goto label$94;
		{
...
FBSTRING* HSTRIPFILENAME( uint8* FILENAME$1 )
{
	...
	label$101:;
	{
		...
		*(int64*)P$1 = vr$4;
		...
		int64 vr$8 = fb_StrInstr( LP$1 + 1ll, (FBSTRING*)vr$6, (FBSTRING*)vr$5 );
		*(int64*)((uint8*)P$1 + 8ll) = vr$8;
		if( ((int64)-(*(int64*)P$1 == 0ll) | ((int64)-(*(int64*)((uint8*)P$1 + 8ll) > 0ll) & (int64)-(*(int64*)((uint8*)P$1 + 8ll) < *(int64*)P$1))) == 0ll ) goto label$105;
		{
			P_FOUND$1 = *(int64*)((uint8*)P$1 + 8ll);
		}
		goto label$104;
