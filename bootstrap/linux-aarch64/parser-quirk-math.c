...
struct $7ASTNODE* CMATHFUNCT( $8FB_TOKEN TK$1, int64 ISASM$1 )
{
	...
	fb$result$1 = (struct $7ASTNODE*)0ull;
	{
		...
		goto label$85;
		label$86:;
		static const void* tmp$102[19ll] = {
			&&label$87,
			&&label$88,
			&&label$89,
			&&label$90,
		...
		if( (TMP$101$2 - 446ull) > 18ull ) goto label$85;
		goto *tmp$102[TMP$101$2 - 446ull];
		label$85:;
	}
	label$84:;
	return fb$result$1;
...
static struct $7ASTNODE* HLEN( struct $7ASTNODE* EXPR$1, int64* LGT$1 )
{
	...
	struct $7ASTNODE* LENEXPR$1;
	{
		...
		label$44:;
		{
			...
			label$46:;
			label$45:;
			uint32* vr$12 = HUNESCAPEW( *(uint32**)((uint8*)LITSYM$1 + 96ll) );
		...
		label$48:;
		{
			int64 TMP$95$3;
			TMP$95$3 = 0ll;
			int64 vr$16 = ASTSIZEOF( EXPR$1, &TMP$95$3 );
			*LGT$1 = vr$16 + -1ll;
		}
		goto label$36;
		label$47:;
		...
		label$50:;
		{
			...
			label$51:;
			TMP$96$3 = 0ll;
			int64 vr$21 = ASTSIZEOF( EXPR$1, &TMP$96$3 );
			*LGT$1 = vr$21;
		}
		goto label$36;
		label$49:;
		{
			int64 TMP$97$3;
			TMP$97$3 = 0ll;
			int64 vr$24 = ASTSIZEOF( EXPR$1, &TMP$97$3 );
			*LGT$1 = vr$24;
		}
		label$53:;
		label$36:;
...
static struct $7ASTNODE* HLENSIZEOF( int64 TK$1, int64 ISASM$1 )
{
	...
	if( TK$1 != 463ll ) goto label$63;
	{
		...
		if( IS_FIXLENSTR$2 == 0ll ) goto label$65;
		{
			{
				int64 TMP$99$4;
				TMP$99$4 = DTYPE$1 & 511ll;
				if( TMP$99$4 == 4ll ) goto label$68;
				label$69:;
				if( TMP$99$4 == 17ll ) goto label$68;
				label$70:;
				if( TMP$99$4 != 18ll ) goto label$67;
				label$68:;
				{
	...
	if( EXPR$1 == (struct $7ASTNODE*)0ull ) goto label$78;
	{
		...
		label$80:;
		{
			int64 TMP$100$3;
			TMP$100$3 = 0ll;
			int64 vr$35 = ASTSIZEOF( EXPR$1, &TMP$100$3 );
			LGT$1 = vr$35;
			ASTDELTREE( EXPR$1 );
