...
int64 RTLFILESEEK( struct $7ASTNODE* FILENUM$1, struct $7ASTNODE* NEWPOS$1 )
{
	...
	label$91:;
	if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$176$1 * 56ll)) + 8ll) != 8ll ) goto label$86;
	{
...
struct $7ASTNODE* RTLFILEPUT( struct $7ASTNODE* FILENUM$1, struct $7ASTNODE* OFFSET$1, struct $7ASTNODE* SRC$1, struct $7ASTNODE* ELEMENTS$1, int64 ISFUNC$1 )
{
	...
	label$126:;
	ISLARGE$1 = (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$177$1 * 56ll)) + 8ll) == 8ll);
...
struct $7ASTNODE* RTLFILEPUTARRAY( struct $7ASTNODE* FILENUM$1, struct $7ASTNODE* OFFSET$1, struct $7ASTNODE* SRC$1, int64 ISFUNC$1 )
{
	...
	label$147:;
	if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$178$1 * 56ll)) + 8ll) != 8ll ) goto label$133;
	{
...
struct $7ASTNODE* RTLFILEGET( struct $7ASTNODE* FILENUM$1, struct $7ASTNODE* OFFSET$1, struct $7ASTNODE* DST$1, struct $7ASTNODE* ELEMENTS$1, struct $7ASTNODE* IOBYTES$1, int64 ISFUNC$1 )
{
	...
	label$198:;
	ISLARGE$1 = (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$179$1 * 56ll)) + 8ll) == 8ll);
...
int64 RTLFILELINEINPUTWSTR( int64 ISFILE$1, struct $7ASTNODE* EXPR$1, struct $7ASTNODE* DSTEXPR$1, int64 ADDQUESTION$1, int64 ADDNEWLINE$1 )
{
	...
	label$260:;
	struct $7ASTNODE* vr$9 = ASTNEWARG( PROC$1, EXPR$1, 2147483648ll, -1ll );
	if( vr$9 != (struct $7ASTNODE*)0ull ) goto label$263;
	{
		goto label$257;
	}
	label$263:;
	...
	LGT$1 = vr$12;
	struct $7ASTNODE* vr$13 = ASTNEWARG( PROC$1, DSTEXPR$1, 2147483648ll, -1ll );
	if( vr$13 != (struct $7ASTNODE*)0ull ) goto label$265;
	{
		goto label$257;
	}
	label$265:;
	...
	struct $7ASTNODE* vr$14 = ASTNEWCONSTI( LGT$1, 8ll, (struct $8FBSYMBOL*)0ull );
	struct $7ASTNODE* vr$15 = ASTNEWARG( PROC$1, vr$14, 2147483648ll, -1ll );
	if( vr$15 != (struct $7ASTNODE*)0ull ) goto label$267;
	{
		goto label$257;
	}
	label$267:;
	...
	{
		struct $7ASTNODE* vr$16 = ASTNEWCONSTI( ADDQUESTION$1, 8ll, (struct $8FBSYMBOL*)0ull );
		struct $7ASTNODE* vr$17 = ASTNEWARG( PROC$1, vr$16, 2147483648ll, -1ll );
		if( vr$17 != (struct $7ASTNODE*)0ull ) goto label$271;
		{
			goto label$257;
		}
		label$271:;
		label$270:;
		struct $7ASTNODE* vr$18 = ASTNEWCONSTI( ADDNEWLINE$1, 8ll, (struct $8FBSYMBOL*)0ull );
...
int64 RTLFILEINPUTGET( struct $7ASTNODE* DSTEXPR$1 )
{
	...
	DTYPE$1 = *(int64*)((uint8*)DSTEXPR$1 + 8ll) & 511ll;
	{
		...
		{
			{
				...
				label$324:;
				TMP$186$4 = *(uint64*)(((uint8*)SYMB_DTYPETB$ + (TMP$185$4 * 56ll)) + 40ll);
				goto label$299;
				label$300:;
				{
				...
				if( (TMP$186$4 - 1ull) > 7ull ) goto label$298;
		...
		if( (TMP$184$2 - 1ull) > 23ull ) goto label$310;
...
int64 RTLFILELOCK( int64 ISLOCK$1, struct $7ASTNODE* FILENUM$1, struct $7ASTNODE* INIEXPR$1, struct $7ASTNODE* ENDEXPR$1 )
{
	...
	label$342:;
	ISLARGE$1 = (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$189$1 * 56ll)) + 8ll) == 8ll) | (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$190$1 * 56ll)) + 8ll) == 8ll);
