...
static int64 HNODESMATCH( struct $7ASTNODE* VN$1, struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)VN$1 != 16ll ) goto label$19;
	{
		...
		label$315:;
		if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$83$2 * 56ll)) != 1ll ) goto label$24;
		{
...
static int64 HCHECKMEMOFFSET( struct $7ASTNODE* VECTORNODE$1, int64 OFFSET$1, $11FB_DATATYPE DTYPE$1 )
{
	...
	if( *(int64*)((uint8*)VECTORNODE$1 + 32ll) == 0ll ) goto label$146;
	{
		...
		label$319:;
		NEEDOFFSET$1 = VECTORWIDTH$ * *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$89$2 * 56ll)) + 8ll);
	}
	goto label$145;
	label$146:;
	{
		...
		label$320:;
		NEEDOFFSET$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$90$2 * 56ll)) + 8ll);
	}
	label$145:;
	fb$result$1 = -1ll;
...
static int64 HMERGENODE( struct $7ASTNODE* VECTORNODE$1, struct $7ASTNODE* N$1, int64 DOMERGE$1 )
{
	...
	if( *(int64*)VECTORNODE$1 != 2ll ) goto label$181;
	{
		...
		if( *(int64*)((uint8*)VECTORNODE$1 + 32ll) == 0ll ) goto label$183;
		{
			...
			label$321:;
			NEEDOFFSET$1 = VECTORWIDTH$ * *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$92$3 * 56ll)) + 8ll);
		}
		goto label$182;
		label$183:;
		{
			...
			label$322:;
			NEEDOFFSET$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$93$3 * 56ll)) + 8ll);
		}
		label$182:;
