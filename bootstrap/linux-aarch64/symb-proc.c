...
struct $8FBSYMBOL* SYMBADDPROCPARAM( struct $8FBSYMBOL* PROC$1, uint8* ID$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int64 DIMENSIONS$1, int64 MODE$1, $13FB_SYMBATTRIB ATTRIB$1, $13FB_PROCATTRIB PATTRIB$1 )
{
	...
	*(int64*)((uint8*)PARAM$1 + 120ll) = DIMENSIONS$1;
	...
	label$75:;
	if( TMP$94$1 != 20ll ) goto label$70;
	{
...
void SYMBPROCRECALCREALTYPE( struct $8FBSYMBOL* PROC$1 )
{
	...
	label$94:;
	{
		...
		if( TMP$95$2 == 17ll ) goto label$98;
		label$99:;
		if( TMP$95$2 != 7ll ) goto label$97;
		label$98:;
		{
			DTYPE$1 = (((DTYPE$1 & 31ll) | ((DTYPE$1 & 480ll) + 32ll)) | ((DTYPE$1 & 261632ll) << (1ll & 63ll))) | (DTYPE$1 & 32505856ll);
		}
		goto label$96;
		label$97:;
		if( TMP$95$2 != 20ll ) goto label$100;
		label$101:;
		{
...
struct $8FBSYMBOL* SYMBADDVARFORPARAM( struct $8FBSYMBOL* PARAM$1 )
{
	...
	*(struct $10FBARRAYDIM**)((uint8*)&tmp$99$1 + 8ll) = (struct $10FBARRAYDIM*)DTB$1;
	*(int64*)((uint8*)&tmp$99$1 + 16ll) = 16ll;
	*(int64*)((uint8*)&tmp$99$1 + 24ll) = 16ll;
	*(int64*)((uint8*)&tmp$99$1 + 32ll) = 1ll;
	*(int64*)((uint8*)&tmp$99$1 + 40ll) = 49ll;
	*(int64*)((uint8*)&tmp$99$1 + 48ll) = 1ll;
	*(int64*)((uint8*)&tmp$99$1 + 56ll) = 0ll;
	*(int64*)((uint8*)&tmp$99$1 + 64ll) = 0ll;
	...
	{
		uint64 TMP$100$2;
		TMP$100$2 = *(uint64*)((uint8*)PARAM$1 + 96ll);
		goto label$340;
		label$341:;
		{
			ATTRIB$1 = 32768ll;
		...
		if( (TMP$100$2 - 1ull) > 2ull ) goto label$346;
	...
	label$348:;
	label$347:;
	struct $8FBSYMBOL* vr$14 = SYMBADDVAR( (uint8*)*(uint8**)((uint8*)PARAM$1 + 32ll), (uint8*)0ull, DTYPE$1, *(struct $8FBSYMBOL**)((uint8*)PARAM$1 + 64ll), 0ll, *(int64*)((uint8*)PARAM$1 + 120ll), (struct $7FBARRAYI10FBARRAYDIME*)&tmp$99$1, ATTRIB$1, 0ll );
	S$1 = vr$14;
...
struct $8FBSYMBOL* SYMBADDVARFORPROCRESULTPARAM( struct $8FBSYMBOL* PROC$1 )
{
	...
	*(int64*)((uint8*)&tmp$102$1 + 64ll) = 0ll;
	...
	struct $8FBSYMBOL* vr$7 = SYMBADDVAR( (uint8*)vr$6, (uint8*)0ull, 20ll, *(struct $8FBSYMBOL**)((uint8*)PROC$1 + 64ll), 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$102$1, 65536ll, 1ll );
	S$1 = vr$7;
	SYMBPROCALLOCEXT( PROC$1 );
...
struct $8FBSYMBOL* SYMBADDPROCRESULTVAR( struct $8FBSYMBOL* PROC$1 )
{
	...
	*(int64*)((uint8*)&tmp$103$1 + 64ll) = 0ll;
	...
	label$364:;
	label$363:;
	struct $8FBSYMBOL* vr$19 = SYMBADDVAR( (uint8*)"fb$result", (uint8*)0ull, DTYPE$1, *(struct $8FBSYMBOL**)((uint8*)PROC$1 + 64ll), 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$103$1, 131072ll, 1ll );
	RES$1 = vr$19;
	SYMBPROCALLOCEXT( PROC$1 );
...
void SYMBADDPROCINSTANCEPARAM( struct $8FBSYMBOL* PARENT$1, struct $8FBSYMBOL* PROC$1 )
{
	...
	int64 DTYPE$1;
	{
		...
		if( TMP$105$2 != 10ll ) goto label$368;
		label$369:;
		{
			DTYPE$1 = 20ll;
		}
		goto label$367;
		label$368:;
		if( TMP$105$2 != 11ll ) goto label$370;
		label$371:;
		{
		}
		label$370:;
...
struct $8FBSYMBOL* SYMBFINDBOPOVLPROC( $6AST_OP OP$1, struct $7ASTNODE* L$1, struct $7ASTNODE* R$1, $9FB_ERRMSG* ERR_NUM$1 )
{
	...
	*ERR_NUM$1 = 0ll;
	{
		int64 TMP$126$2;
		TMP$126$2 = *(int64*)((uint8*)L$1 + 8ll) & 511ll;
		if( TMP$126$2 == 20ll ) goto label$641;
		label$642:;
		if( TMP$126$2 != 10ll ) goto label$640;
		label$641:;
		{
		}
		goto label$639;
		label$640:;
		{
			{
				int64 TMP$127$4;
				TMP$127$4 = *(int64*)((uint8*)R$1 + 8ll) & 511ll;
				if( TMP$127$4 == 20ll ) goto label$646;
				label$647:;
				if( TMP$127$4 != 10ll ) goto label$645;
				label$646:;
				{
				}
				goto label$644;
	...
	*ERR_NUM$1 = 0ll;
	{
		...
		if( TMP$128$2 != 20ll ) goto label$656;
		label$657:;
		{
	...
	*ERR_NUM$1 = 0ll;
	{
		...
		if( TMP$129$2 == 20ll ) goto label$673;
		label$674:;
		if( TMP$129$2 != 10ll ) goto label$672;
		label$673:;
		{
		}
		goto label$671;
	...
	*ERR_NUM$1 = 0ll;
	{
		...
		if( TMP$130$2 != 20ll ) goto label$683;
		label$684:;
		{
			struct $8FBSYMBOL* SUBTYPE$3;
			SUBTYPE$3 = *(struct $8FBSYMBOL**)((uint8*)L$1 + 16ll);
	...
	*ERR_NUM$1 = 0ll;
	{
		...
		if( TMP$135$2 != 20ll ) goto label$721;
		label$722:;
		{
			struct $8FBSYMBOL* SUBTYPE$3;
			SUBTYPE$3 = *(struct $8FBSYMBOL**)((uint8*)L$1 + 16ll);
	...
	goto label$754;
	label$730:;
	TMP$136$1 = TO_DTYPE$1 & 31ll;
	label$754:;
	if( TMP$136$1 == 0ll ) goto label$732;
	{
		PROC$1 = PROC_HEAD$1;
		label$733:;
...
$22FB_OVLPROC_MATCH_SCORE SYMBCALCPROCMATCH( struct $8FBSYMBOL* L$1, struct $8FBSYMBOL* R$1, int64* ERRMSG$1 )
{
	...
	TMP$137$1 = 1ll;
	label$810:;
	$22FB_OVLPROC_MATCH_SCORE vr$7 = TYPECALCMATCH( *(int64*)((uint8*)L$1 + 56ll), *(struct $8FBSYMBOL**)((uint8*)L$1 + 64ll), TMP$137$1, *(int64*)((uint8*)R$1 + 56ll), *(struct $8FBSYMBOL**)((uint8*)R$1 + 64ll) );
	MATCH$1 = vr$7;
...
uint8* SYMBGETFULLPROCNAME( struct $8FBSYMBOL* PROC$1 )
{
	...
	if( NS$1 == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 196704ll) ) goto label$918;
	{
		...
		FBSTRING* vr$7 = fb_StrConcat( &TMP$177$2, *(void**)((uint8*)NS$1 + 32ll), 0ll, (void*)".", 2ll );
		__builtin_memset( &TMP$178$2, 0, 24ll );
		FBSTRING* vr$10 = fb_StrConcat( &TMP$178$2, (void*)vr$7, -1ll, (void*)&RES$1, -1ll );
	...
	if( (*(int64*)((uint8*)PROC$1 + 16ll) & 16ll) == 0ll ) goto label$922;
	{
		...
		if( *(struct $10FB_PROCEXT**)((uint8*)PROC$1 + 208ll) == (struct $10FB_PROCEXT*)0ull ) goto label$924;
		{
			...
			FBSTRING* vr$25 = fb_StrConcat( &TMP$182$3, (void*)&RES$1, -1ll, *(void**)(((uint8*)AST_OPTB$ + (*(int64*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)PROC$1 + 208ll) + 80ll) << (5ll & 63ll))) + 16ll), 0ll );
	...
	if( (*(int64*)((uint8*)PROC$1 + 16ll) & 32ll) == 0ll ) goto label$925;
	{
		...
		FBSTRING* vr$31 = fb_StrConcat( &TMP$183$2, (void*)&RES$1, -1ll, *(void**)((uint8*)PROC$1 + 32ll), 0ll );
	...
	label$925:;
	{
		...
		FBSTRING* vr$37 = fb_StrConcat( &TMP$187$2, (void*)&RES$1, -1ll, *(void**)((uint8*)PROC$1 + 32ll), 0ll );
...
int64 SYMBGETDEFAULTPARAMMODE( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	{
		uint64 TMP$188$2;
		TMP$188$2 = (uint64)(DTYPE$1 & 511ll);
		goto label$933;
		label$934:;
		{
			fb$result$1 = 2ll;
		...
		goto label$932;
		label$933:;
		static const void* tmp$189[20ll] = {
			&&label$934,
			&&label$935,
			&&label$935,
			&&label$934,
		...
		if( (TMP$188$2 - 4ull) > 19ull ) goto label$935;
		goto *tmp$189[TMP$188$2 - 4ull];
		label$932:;
	}
	label$931:;
	return fb$result$1;
...
static $22FB_OVLPROC_MATCH_SCORE HCALCTYPESDIFF( int64 PARAM_DTYPE_IN$1, struct $8FBSYMBOL* PARAM_SUBTYPE$1, int64 PARAM_PTRCNT$1, int64 ARG_DTYPE_IN$1, struct $8FBSYMBOL* ARG_SUBTYPE$1, struct $7ASTNODE* ARG_EXPR$1, $12FB_PARAMMODE MODE$1 )
{
	...
	goto label$959;
	label$426:;
	TMP$106$1 = ARG_DTYPE$1 & 31ll;
	label$959:;
	ARG_DCLASS$1 = *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$106$1 * 56ll));
	{
		int64 TMP$107$2;
		uint64 TMP$108$2;
		...
		label$960:;
		TMP$108$2 = *(uint64*)((uint8*)SYMB_DTYPETB$ + (TMP$107$2 * 56ll));
		goto label$429;
		label$430:;
		{
			{
				...
				label$433:;
				{
					...
					label$962:;
					fb$result$1 = -(*(int64*)(((uint8*)SYMB_DTYPEMATCHTB$ + (((TMP$110$5 << (4ll & 63ll)) + TMP$111$5) << (3ll & 63ll))) + -136ll)) + 26ll;
					goto label$425;
				}
				goto label$431;
				label$487:;
				{
					...
					label$964:;
					fb$result$1 = -(*(int64*)(((uint8*)SYMB_DTYPEMATCHTB$ + (((TMP$112$5 << (4ll & 63ll)) + TMP$113$5) << (3ll & 63ll))) + -136ll)) + 26ll;
					goto label$425;
				}
				goto label$431;
				label$492:;
				...
				goto label$431;
				label$432:;
				static const void* tmp$190[3ll] = {
					&&label$433,
					&&label$487,
					&&label$492,
				};
				if( TMP$109$4 > 2ull ) goto label$431;
				goto *tmp$190[TMP$109$4 - 0ull];
				label$431:;
			}
		}
		goto label$428;
		...
		{
			{
				...
				label$503:;
				{
					...
					label$966:;
					fb$result$1 = -(*(int64*)(((uint8*)SYMB_DTYPEMATCHTB$ + (((TMP$115$5 << (4ll & 63ll)) + TMP$116$5) << (3ll & 63ll))) + -136ll)) + 26ll;
					goto label$425;
				}
				goto label$501;
				label$510:;
				{
					...
					label$968:;
					fb$result$1 = -(*(int64*)(((uint8*)SYMB_DTYPEMATCHTB$ + (((TMP$117$5 << (4ll & 63ll)) + TMP$118$5) << (3ll & 63ll))) + -136ll)) + 26ll;
					goto label$425;
				}
				goto label$501;
				label$502:;
				static const void* tmp$191[2ll] = {
					&&label$503,
					&&label$510,
				};
				if( TMP$114$4 > 1ull ) goto label$501;
				goto *tmp$191[TMP$114$4 - 0ull];
				label$501:;
			}
		}
		goto label$428;
		...
		goto label$428;
		label$429:;
		static const void* tmp$192[3ll] = {
			&&label$430,
			&&label$500,
			&&label$513,
		};
		if( TMP$108$2 > 2ull ) goto label$428;
		goto *tmp$192[TMP$108$2 - 0ull];
		label$428:;
	}
	label$425:;
	return fb$result$1;
...
static $22FB_OVLPROC_MATCH_SCORE HCHECKOVLPARAM( struct $8FBSYMBOL* PARENT$1, struct $8FBSYMBOL* PARAM$1, struct $7ASTNODE* ARG_EXPR$1, int64 ARG_MODE$1 )
{
	...
	ARG_SUBTYPE$1 = *(struct $8FBSYMBOL**)((uint8*)ARG_EXPR$1 + 16ll);
	{
		...
		TMP$119$2 = *($12FB_PARAMMODE*)((uint8*)PARAM$1 + 96ll);
		if( TMP$119$2 != 3ll ) goto label$531;
		label$532:;
		{
		...
		goto label$530;
		label$531:;
		if( TMP$119$2 != 2ll ) goto label$541;
		label$542:;
		{
			if( ARG_MODE$1 != 1ll ) goto label$544;
			{
				...
				label$970:;
				if( ((int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$120$4 * 56ll)) != 0ll) | (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$121$4 * 56ll)) + 8ll) != *(int64*)((uint8*)&ENV$ + 544ll))) == 0ll ) goto label$548;
				{
					fb$result$1 = 0ll;
					goto label$525;
				}
	...
	if( (PARAM_DTYPE$1 & 511ll) != (ARG_DTYPE$1 & 511ll) ) goto label$552;
	{
		...
		label$554:;
		{
			{
				int64 TMP$122$4;
				TMP$122$4 = PARAM_DTYPE$1 & 31ll;
				if( TMP$122$4 != 20ll ) goto label$556;
				label$557:;
				{
					int64 BASELEVEL$5;
				...
				goto label$555;
				label$556:;
				if( TMP$122$4 != 22ll ) goto label$560;
				label$561:;
				{
					int64 TMP$123$5;
					TMP$123$5 = 0ll;
...
static $22FB_OVLPROC_MATCH_SCORE HCHECKCASTOVL( struct $8FBSYMBOL* PROC$1, int64 TO_DTYPE$1, struct $8FBSYMBOL* TO_SUBTYPE$1, int64 IS_EXPLICIT$1 )
{
	...
	label$706:;
	{
		...
		goto label$971;
		label$708:;
		TMP$131$2 = PROC_DTYPE$1 & 31ll;
		label$971:;
		TMP$132$2 = TMP$131$2;
		if( TMP$132$2 == 20ll ) goto label$711;
		label$712:;
		if( TMP$132$2 != 10ll ) goto label$710;
		label$711:;
		{
			fb$result$1 = 0ll;
			goto label$697;
		...
		{
			{
				...
				goto label$972;
				label$714:;
				TMP$133$4 = TO_DTYPE$1 & 31ll;
				label$972:;
				TMP$134$4 = TMP$133$4;
				if( TMP$134$4 != 20ll ) goto label$716;
				label$717:;
				{
					fb$result$1 = 0ll;
					goto label$697;
...
static void HSUBORFUNCTOSTR( FBSTRING* S$1, struct $8FBSYMBOL* PROC$1 )
{
	...
	if( (*(int64*)((uint8*)PROC$1 + 56ll) & 511ll) != 0ll ) goto label$846;
	{
		...
		FBSTRING* vr$4 = fb_StrConcat( &TMP$139$2, (void*)S$1, -1ll, (void*)"sub", 4ll );
	...
	label$846:;
	{
		...
		FBSTRING* vr$7 = fb_StrConcat( &TMP$141$2, (void*)S$1, -1ll, (void*)"function", 9ll );
	...
	{
		{
			...
			if( TMP$142$3 == 1ll ) goto label$853;
			label$854:;
			if( TMP$142$3 != 2ll ) goto label$852;
			label$853:;
			{
				FBSTRING TMP$144$4;
				__builtin_memset( &TMP$144$4, 0, 24ll );
				FBSTRING* vr$10 = fb_StrConcat( &TMP$144$4, (void*)S$1, -1ll, (void*)" stdcall", 9ll );
				fb_StrAssign( (void*)S$1, -1ll, (void*)vr$10, -1ll, 0 );
			}
			goto label$851;
			label$852:;
			if( TMP$142$3 != 4ll ) goto label$855;
			label$856:;
			{
				FBSTRING TMP$146$4;
				__builtin_memset( &TMP$146$4, 0, 24ll );
				FBSTRING* vr$13 = fb_StrConcat( &TMP$146$4, (void*)S$1, -1ll, (void*)" pascal", 8ll );
	...
	{
		{
			...
			if( TMP$147$3 == 1ll ) goto label$859;
			label$860:;
			if( TMP$147$3 != 2ll ) goto label$858;
			label$859:;
			{
				{
					$11FB_FUNCMODE TMP$148$5;
					TMP$148$5 = *($11FB_FUNCMODE*)((uint8*)&ENV$ + 504ll);
					if( TMP$148$5 == 1ll ) goto label$863;
					label$864:;
					if( TMP$148$5 != 2ll ) goto label$862;
					label$863:;
					{
					}
					goto label$861;
					label$862:;
					{
						...
						FBSTRING* vr$17 = fb_StrConcat( &TMP$149$6, (void*)S$1, -1ll, (void*)" stdcall", 9ll );
			...
			goto label$857;
			label$858:;
			if( TMP$147$3 != 4ll ) goto label$866;
			label$867:;
			{
				if( *(int64*)((uint8*)&ENV$ + 504ll) == 4ll ) goto label$869;
				{
					FBSTRING TMP$150$5;
					__builtin_memset( &TMP$150$5, 0, 24ll );
					FBSTRING* vr$20 = fb_StrConcat( &TMP$150$5, (void*)S$1, -1ll, (void*)" pascal", 8ll );
			...
			goto label$857;
			label$866:;
			if( TMP$147$3 != 3ll ) goto label$870;
			label$871:;
			{
				if( *(int64*)((uint8*)&ENV$ + 504ll) == 3ll ) goto label$873;
				{
					...
					FBSTRING* vr$23 = fb_StrConcat( &TMP$152$5, (void*)S$1, -1ll, (void*)" cdecl", 7ll );
...
static void HPARAMSTOSTR( FBSTRING* S$1, struct $8FBSYMBOL* PROC$1 )
{
	...
	FBSTRING* vr$2 = fb_StrConcat( &TMP$158$1, (void*)S$1, -1ll, (void*)"(", 2ll );
	...
	if( PARAM$1 == (struct $8FBSYMBOL*)0ull ) goto label$887;
	{
		...
		PARAMMODE$2 = *($12FB_PARAMMODE*)((uint8*)PARAM$1 + 96ll);
		{
			...
			label$890:;
			{
				...
				FBSTRING TMP$166$4;
				{
					...
					label$895:;
					{
						...
						if( ((int64)-(*(int64*)((uint8*)&ENV$ + 272ll) == 0ll) & (int64)-(vr$14 != PARAMMODE$2)) == 0ll ) goto label$898;
						{
							...
							{
								FBSTRING TMP$160$8;
								__builtin_memset( &TMP$160$8, 0, 24ll );
								FBSTRING* vr$19 = fb_StrConcat( &TMP$160$8, (void*)S$1, -1ll, (void*)"byval ", 7ll );
							...
							{
								FBSTRING TMP$162$8;
								__builtin_memset( &TMP$162$8, 0, 24ll );
								FBSTRING* vr$22 = fb_StrConcat( &TMP$162$8, (void*)S$1, -1ll, (void*)"byref ", 7ll );
					...
					label$902:;
					{
						...
						FBSTRING* vr$27 = fb_StrConcat( &TMP$163$6, (void*)S$1, -1ll, (void*)vr$24, -1ll );
				...
				FBSTRING* vr$33 = fb_StrConcat( &TMP$165$4, (void*)"as ", 4ll, (void*)vr$30, -1ll );
				__builtin_memset( &TMP$166$4, 0, 24ll );
				FBSTRING* vr$36 = fb_StrConcat( &TMP$166$4, (void*)S$1, -1ll, (void*)vr$33, -1ll );
			...
			label$904:;
			{
				...
				FBSTRING* vr$39 = fb_StrConcat( &TMP$168$4, (void*)S$1, -1ll, (void*)"...", 4ll );
		...
		if( PARAM$1 == (struct $8FBSYMBOL*)0ull ) goto label$906;
		{
			...
			FBSTRING* vr$43 = fb_StrConcat( &TMP$169$3, (void*)S$1, -1ll, (void*)", ", 3ll );
	...
	FBSTRING* vr$46 = fb_StrConcat( &TMP$171$1, (void*)S$1, -1ll, (void*)")", 2ll );
...
static void HRESULTTOSTR( FBSTRING* S$1, struct $8FBSYMBOL* PROC$1 )
{
	...
	if( (*(int64*)((uint8*)PROC$1 + 56ll) & 511ll) == 0ll ) goto label$910;
	{
		...
		if( (*(int64*)((uint8*)PROC$1 + 16ll) & 2048ll) == 0ll ) goto label$912;
		{
			...
			FBSTRING* vr$6 = fb_StrConcat( &TMP$173$3, (void*)S$1, -1ll, (void*)" byref", 7ll );
		...
		FBSTRING* vr$12 = fb_StrConcat( &TMP$175$2, (void*)" as ", 5ll, (void*)vr$9, -1ll );
		__builtin_memset( &TMP$176$2, 0, 24ll );
		FBSTRING* vr$15 = fb_StrConcat( &TMP$176$2, (void*)S$1, -1ll, (void*)vr$12, -1ll );
