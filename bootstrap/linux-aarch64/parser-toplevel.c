...
void CPROGRAM( void )
{
	...
	label$26:;
	{
		...
		label$38:;
		label$37:;
		struct $7ASTNODE* vr$9 = ASTNEWDBG( 113ll, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16744ll), *(uint8**)((uint8*)&ENV$ + 824ll) );
		ASTADD( vr$9 );
		CLABEL(  );
		CSTATEMENT(  );
		CCOMMENT( 0ll );
		...
		label$41:;
		{
			...
			TMP$93$3 = vr$11;
			if( TMP$93$3 != 257ll ) goto label$46;
			label$47:;
			{
				LEXSKIPTOKEN( 0ll );
			}
			goto label$45;
			label$46:;
			if( TMP$93$3 != 256ll ) goto label$48;
			label$49:;
			{
			}
			goto label$45;
	...
	{
		{
			...
			if( (TMP$94$3 - 40ull) > 220ull ) goto label$88;
	...
	{
		{
			...
			TMP$96$3 = vr$2;
			if( TMP$96$3 != 256ll ) goto label$103;
			label$104:;
			{
				goto label$96;
			}
			goto label$102;
			label$103:;
			if( TMP$96$3 != 257ll ) goto label$105;
			label$106:;
			{
				ISCOMMENT$1 = 0ll;
			}
			goto label$102;
			label$105:;
			if( TMP$96$3 == 259ll ) goto label$108;
			label$109:;
			if( TMP$96$3 != 260ll ) goto label$107;
			label$108:;
			{
				ISCOMMENT$1 = -1ll;
			}
			goto label$102;
			label$107:;
			if( TMP$96$3 != 340ll ) goto label$110;
			label$111:;
			{
...
static void HEMITCURRENTLINETEXT( void )
{
	...
	if( N$1 == (struct $7ASTNODE*)0ull ) goto label$19;
	{
		if( *(int64*)N$1 != 30ll ) goto label$21;
		{
			...
			{
				struct $7ASTNODE* vr$4 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 49632ll) );
