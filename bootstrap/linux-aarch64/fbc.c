...
static struct $12FBOSARCHINFO FBOSARCHMAP$[12] = { { (uint8*)"win32", 0ll, 1ll }, { (uint8*)"win64", 0ll, 13ll }, { (uint8*)"dragonfly", 6ll, 13ll }, { (uint8*)"solaris", 7ll, 13ll }, { (uint8*)"dos", 3ll, 1ll }, { (uint8*)"xbox", 4ll, 1ll }, { (uint8*)"cygwin", 1ll, 16ll }, { (uint8*)"darwin", 9ll, 16ll }, { (uint8*)"freebsd", 5ll, 16ll }, { (uint8*)"linux", 2ll, 16ll }, { (uint8*)"netbsd", 10ll, 16ll }, { (uint8*)"openbsd", 8ll, 16ll } };
...
static void HANDLEOPT( int64 OPTID$1, FBSTRING* ARG$1 )
{
	label$418:;
	{
		...
		label$537:;
		{
			...
			if( (((int64)-(OS$3 != 2ll) | (int64)-(CPUTYPE$3 != 16ll)) | IS_GNU_TRIPLET$3) == 0ll ) goto label$541;
			{
				FBSTRING TMP$308$4;
...
static void HPRINTVERSION( int64 VERBOSE$1 )
{
	...
	FBSTRING* vr$6 = fb_StrConcat( &TMP$711$1, (void*)"FreeBASIC Compiler - Version 1.08.0 (2021-02-17), built for ", 61ll, (void*)vr$3, -1ll );
