...
int64 HCHECKTYPES( int64 LDTYPE$1, struct $8FBSYMBOL* LSUBTYPE$1, int64 RDTYPE$1, struct $8FBSYMBOL* RSUBTYPE$1, int64* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1 )
{
	...
	if( (LMATCH$1 | RMATCH$1) == 0ll ) goto label$13;
	{
		...
		label$15:;
		{
			...
			label$49:;
			if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$84$3 * 56ll)) == 0ll ) goto label$22;
			{
				goto label$11;
			}
			label$22:;
...
struct $6IRVREG* ASTLOADIIF( struct $7ASTNODE* N$1 )
{
	...
	{
		(*(tmp$56*)((uint8*)&IR$ + 288ll))( 98ll, EXITLABEL$1 );
	}
	label$116:;
	label$115:;
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$118;
	{
		(*(tmp$41*)((uint8*)&IR$ + 136ll))( *(struct $8FBSYMBOL**)((uint8*)N$1 + 40ll) );
	}
	label$118:;
	label$117:;
	...
	{
		(*(tmp$41*)((uint8*)&IR$ + 136ll))( EXITLABEL$1 );
	}
	label$122:;
	label$121:;
