...
int64 CLINEINPUTSTMT( void )
{
	...
	label$133:;
	{
		...
		if( TMP$94$2 == 17ll ) goto label$137;
		label$138:;
		if( TMP$94$2 == 18ll ) goto label$137;
		label$139:;
		if( TMP$94$2 != 4ll ) goto label$136;
		label$137:;
		{
		...
		goto label$135;
		label$136:;
		if( TMP$94$2 != 7ll ) goto label$140;
		label$141:;
		{
...
int64 CINPUTSTMT( void )
{
	...
	label$146:;
	{
		...
		if( vr$11 != 4ll ) goto label$150;
		{
			...
			struct $8FBSYMBOL* vr$15 = SYMBALLOCSTRCONST( vr$14, *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 4128ll) );
...
int64 CFILESTMT( $8FB_TOKEN TK$1 )
{
	...
	fb$result$1 = 0ll;
	{
		...
		if( (TMP$119$2 - 468ull) > 20ull ) goto label$488;
		goto *tmp$120[TMP$119$2 - 468ull];
		label$488:;
	}
	label$487:;
	return fb$result$1;
...
struct $7ASTNODE* CFILEFUNCT( $8FB_TOKEN TK$1 )
{
	...
	fb$result$1 = (struct $7ASTNODE*)0ull;
	{
		...
		if( (TMP$121$2 - 468ull) > 15ull ) goto label$521;
		goto *tmp$123[TMP$121$2 - 468ull];
		label$521:;
	}
	label$520:;
	return fb$result$1;
		...
		{
			{
				...
				if( TMP$95$4 == 17ll ) goto label$231;
				label$232:;
				if( TMP$95$4 != 18ll ) goto label$230;
				label$231:;
				{
					ERRREPORT( 277ll, 0ll, (uint8*)0ull );
			...
			{
				{
					...
					if( TMP$96$5 == 17ll ) goto label$284;
					label$285:;
					if( TMP$96$5 != 18ll ) goto label$283;
					label$284:;
					{
						ERRREPORT( 277ll, 0ll, (uint8*)0ull );
						ASTDELTREE( ELMEXPR$1 );
	...
	if( vr$32 == 0ll ) goto label$294;
	{
		...
		if( IOBEXPR$1 == (struct $7ASTNODE*)0ull ) goto label$296;
		{
			...
			if( S$1 == (struct $8FBSYMBOL*)0ull ) goto label$298;
			{
				...
				label$557:;
				if( (((int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$97$4 * 56ll)) + 8ll) != *(int64*)((uint8*)&ENV$ + 544ll)) | (int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$98$4 * 56ll)) != 0ll)) | (int64)-((DTYPE$4 & 480ll) != 0ll)) == 0ll ) goto label$302;
				{
					ERRREPORT( 24ll, 0ll, (uint8*)0ull );
				}
				label$302:;
...
static struct $7ASTNODE* HFILEOPEN( int64 ISFUNC$1 )
{
	...
	{
		{
			...
			label$317:;
			{
				if( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 4136ll) != (struct $10FBSYMCHAIN*)0ull ) goto label$319;
				{
					LEXSKIPTOKEN( 2048ll );
					OPEN_KIND$1 = 1ll;
				}
			...
			label$323:;
			{
				if( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 4136ll) != (struct $10FBSYMCHAIN*)0ull ) goto label$325;
				{
					LEXSKIPTOKEN( 2048ll );
					OPEN_KIND$1 = 3ll;
				}
			...
			label$327:;
			{
				if( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 4136ll) != (struct $10FBSYMCHAIN*)0ull ) goto label$329;
				{
					LEXSKIPTOKEN( 2048ll );
					OPEN_KIND$1 = 4ll;
				}
			...
			label$331:;
			{
				if( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 4136ll) != (struct $10FBSYMCHAIN*)0ull ) goto label$333;
				{
					LEXSKIPTOKEN( 2048ll );
					OPEN_KIND$1 = 5ll;
				}
			...
			label$335:;
			{
				if( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 4136ll) != (struct $10FBSYMCHAIN*)0ull ) goto label$337;
				{
					LEXSKIPTOKEN( 2048ll );
					OPEN_KIND$1 = 6ll;
				}
	...
	label$342:;
	{
					...
					{
						{
							...
							TMP$107$7 = vr$49;
							if( TMP$107$7 == 281ll ) goto label$359;
							label$360:;
							if( TMP$107$7 == 473ll ) goto label$359;
							label$361:;
							if( TMP$107$7 != 376ll ) goto label$358;
							label$359:;
							{
							}
							goto label$357;
		...
		if( TMP$106$2 > 7ull ) goto label$365;
	...
	{
		{
			...
			fb_StrInit( (void*)&TMP$108$3, -1ll, (void*)vr$71, -1ll, 0 );
			int32 vr$74 = fb_StrCompare( (void*)&TMP$108$3, -1ll, (void*)"INPUT", 6ll );
			...
			goto label$402;
			label$403:;
			int32 vr$77 = fb_StrCompare( (void*)&TMP$108$3, -1ll, (void*)"OUTPUT", 7ll );
			...
			goto label$402;
			label$405:;
			int32 vr$80 = fb_StrCompare( (void*)&TMP$108$3, -1ll, (void*)"BINARY", 7ll );
			...
			goto label$402;
			label$407:;
			int32 vr$83 = fb_StrCompare( (void*)&TMP$108$3, -1ll, (void*)"RANDOM", 7ll );
			...
			goto label$402;
			label$409:;
			int32 vr$86 = fb_StrCompare( (void*)&TMP$108$3, -1ll, (void*)"APPEND", 7ll );
