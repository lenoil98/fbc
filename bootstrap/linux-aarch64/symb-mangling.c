...
uint8* SYMBUNIQUELABEL( void )
{
	...
	label$21:;
	{
		...
		FBSTRING* vr$14 = fb_StrConcat( &TMP$90$2, (void*)((uint8*)&CTX$ + 120ll), 17ll, (void*)vr$10, 0ll );
	...
	{
		{
			...
			if( (TMP$93$3 - 8ull) > 3ull ) goto label$33;
...
uint8* SYMBGETMANGLEDNAME( struct $8FBSYMBOL* SYM$1 )
{
	...
	label$54:;
	{
		...
		if( (TMP$103$2 - 1ull) > 13ull ) goto label$63;
		goto *tmp$105[TMP$103$2 - 1ull];
		label$56:;
	}
...
uint8* HMANGLEBUILTINTYPE( int64 DTYPE$1, int64* ADD_ABBREV$1 )
{
	...
	*ADD_ABBREV$1 = 0ll;
	...
	static struct $8FBARRAY1IPcE tmp$121$1 = { (uint8**)TYPECODES$1, (uint8**)TYPECODES$1, 208ll, 8ll, 1ll, 49ll, { { 26ll, 0ll, 25ll } } };
...
void SYMBMANGLETYPE( FBSTRING* MANGLED$1, int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, $12FB_MANGLEOPT OPTIONS$1 )
{
	...
	label$167:;
	if( TMP$136$1 != 23ll ) goto label$123;
	{
	...
	if( (DTYPE$1 & 524288ll) == 0ll ) goto label$125;
	{
		...
		FBSTRING* vr$9 = fb_StrConcat( &TMP$138$2, (void*)MANGLED$1, -1ll, (void*)"R", 2ll );
	...
	if( (DTYPE$1 & 512ll) == 0ll ) goto label$127;
	{
		if( (OPTIONS$1 & 1ll) == 0ll ) goto label$129;
		{
			...
			FBSTRING* vr$17 = fb_StrConcat( &TMP$140$3, (void*)MANGLED$1, -1ll, (void*)"K", 2ll );
	...
	if( (DTYPE$1 & 480ll) == 0ll ) goto label$131;
	{
		...
		FBSTRING* vr$23 = fb_StrConcat( &TMP$142$2, (void*)MANGLED$1, -1ll, (void*)"P", 2ll );
			...
			{
				{
					...
					TMP$143$5 = vr$40;
					if( TMP$143$5 != 3ll ) goto label$139;
					label$140:;
					{
						if( (OPTIONS$1 & 6ll) == 0ll ) goto label$142;
						{
							FBSTRING TMP$145$7;
							__builtin_memset( &TMP$145$7, 0, 24ll );
							FBSTRING* vr$44 = fb_StrConcat( &TMP$145$7, (void*)MANGLED$1, -1ll, (void*)"A1_", 4ll );
						...
						label$142:;
						{
							...
							FBSTRING* vr$47 = fb_StrConcat( &TMP$146$7, (void*)MANGLED$1, -1ll, (void*)"P", 2ll );
					...
					goto label$138;
					label$139:;
					if( TMP$143$5 == 4ll ) goto label$144;
					label$145:;
					if( TMP$143$5 != 5ll ) goto label$143;
					label$144:;
					{
						FBSTRING TMP$148$6;
						__builtin_memset( &TMP$148$6, 0, 24ll );
						FBSTRING* vr$51 = fb_StrConcat( &TMP$148$6, (void*)MANGLED$1, -1ll, (void*)"St", 3ll );
	...
	{
		int64 TMP$149$2;
		TMP$149$2 = DTYPE$1 & 31ll;
		if( TMP$149$2 == 20ll ) goto label$148;
		label$149:;
		if( TMP$149$2 != 10ll ) goto label$147;
		label$148:;
		{
			...
			label$151:;
			{
				...
				FBSTRING* vr$59 = fb_StrConcat( &TMP$151$4, (void*)MANGLED$1, -1ll, (void*)"N", 2ll );
				...
				FBSTRING* vr$63 = fb_StrConcat( &TMP$152$4, (void*)MANGLED$1, -1ll, (void*)"E", 2ll );
		...
		goto label$146;
		label$147:;
		if( TMP$149$2 != 21ll ) goto label$152;
		label$153:;
		{
		...
		goto label$146;
		label$152:;
		if( TMP$149$2 != 22ll ) goto label$158;
		label$159:;
		{
			FBSTRING TMP$154$3;
			FBSTRING TMP$157$3;
			__builtin_memset( &TMP$154$3, 0, 24ll );
			FBSTRING* vr$69 = fb_StrConcat( &TMP$154$3, (void*)MANGLED$1, -1ll, (void*)"F", 2ll );
			...
			if( (*(int64*)((uint8*)SUBTYPE$1 + 16ll) & 2048ll) == 0ll ) goto label$161;
			{
				...
				FBSTRING* vr$74 = fb_StrConcat( &TMP$155$4, (void*)MANGLED$1, -1ll, (void*)"R", 2ll );
			...
			if( (*(int64*)((uint8*)SUBTYPE$1 + 56ll) & 512ll) == 0ll ) goto label$163;
			{
				...
				FBSTRING* vr$79 = fb_StrConcat( &TMP$156$4, (void*)MANGLED$1, -1ll, (void*)"K", 2ll );
			...
			FBSTRING* vr$84 = fb_StrConcat( &TMP$157$3, (void*)MANGLED$1, -1ll, (void*)"E", 2ll );
		...
		label$158:;
		{
			...
			FBSTRING* vr$89 = fb_StrConcat( &TMP$158$3, (void*)MANGLED$1, -1ll, (void*)vr$86, 0ll );
...
void SYMBMANGLEPARAM( FBSTRING* MANGLED$1, struct $8FBSYMBOL* PARAM$1 )
{
	...
	{
		uint64 TMP$159$2;
		TMP$159$2 = *(uint64*)((uint8*)PARAM$1 + 96ll);
		goto label$171;
		label$172:;
		{
		...
		label$175:;
		{
			...
			FBSTRING* vr$9 = fb_StrConcat( &TMP$161$3, (void*)MANGLED$1, -1ll, (void*)"z", 2ll );
			fb_StrAssign( (void*)MANGLED$1, -1ll, (void*)vr$9, -1ll, 0 );
		}
		goto label$170;
		label$171:;
		...
		if( (TMP$159$2 - 1ull) > 3ull ) goto label$170;
		goto *tmp$162[TMP$159$2 - 1ull];
		label$170:;
	}
	label$169:;
}
...
static void HMANGLEUDTID( FBSTRING* MANGLED$1, struct $8FBSYMBOL* SYM$1 )
{
	...
	if( ((int64)-(*(int64*)SYM$1 == 10ll) & (int64)-((*(int64*)((uint8*)SYM$1 + 8ll) & 8192ll) != 0ll)) == 0ll ) goto label$51;
	{
		...
		FBSTRING* vr$29 = fb_StrConcat( &TMP$100$2, (void*)MANGLED$1, -1ll, (void*)"I", 2ll );
		...
		FBSTRING* vr$34 = fb_StrConcat( &TMP$102$2, (void*)MANGLED$1, -1ll, (void*)"E", 2ll );
...
static void HABBREVGET( FBSTRING* MANGLED$1, int64 IDX$1 )
{
	...
	FBSTRING* vr$2 = fb_StrConcat( &TMP$107$1, (void*)MANGLED$1, -1ll, (void*)"S", 2ll );
	...
	if( IDX$1 <= 0ll ) goto label$85;
	{
		if( IDX$1 > 10ll ) goto label$87;
		{
			...
			FBSTRING* vr$8 = fb_StrConcat( &TMP$108$3, (void*)MANGLED$1, -1ll, (void*)vr$5, -1ll );
		...
		if( IDX$1 > 33ll ) goto label$88;
		{
			...
			FBSTRING* vr$14 = fb_StrConcat( &TMP$110$3, (void*)MANGLED$1, -1ll, (void*)vr$11, -1ll );
		...
		label$88:;
		{
			...
			FBSTRING* vr$19 = fb_StrConcat( &TMP$111$3, (void*)MANGLED$1, -1ll, (void*)vr$16, -1ll );
			...
			if( IDX$1 > 10ll ) goto label$90;
			{
				...
				FBSTRING* vr$26 = fb_StrConcat( &TMP$112$4, (void*)MANGLED$1, -1ll, (void*)vr$23, -1ll );
			...
			if( IDX$1 > 33ll ) goto label$91;
			{
				...
				FBSTRING* vr$32 = fb_StrConcat( &TMP$113$4, (void*)MANGLED$1, -1ll, (void*)vr$29, -1ll );
	...
	FBSTRING* vr$35 = fb_StrConcat( &TMP$115$1, (void*)MANGLED$1, -1ll, (void*)"_", 2ll );
...
static void HMANGLENAMESPACE( FBSTRING* MANGLED$1, struct $8FBSYMBOL* NS$1, int64 DOHASHING$1, int64 ISCONST$1 )
{
	...
	static struct $8FBARRAY1IP8FBSYMBOLE tmp$163$1 = { (struct $8FBSYMBOL**)NSSTK$1, (struct $8FBSYMBOL**)NSSTK$1, 512ll, 8ll, 1ll, 49ll, { { 64ll, 0ll, 63ll } } };
	int64 TOS$1;
	...
	FBSTRING* vr$12 = fb_StrConcat( &TMP$164$1, (void*)MANGLED$1, -1ll, (void*)"N", 2ll );
	fb_StrAssign( (void*)MANGLED$1, -1ll, (void*)vr$12, -1ll, 0 );
	if( ISCONST$1 == 0ll ) goto label$204;
	{
		FBSTRING TMP$165$2;
		__builtin_memset( &TMP$165$2, 0, 24ll );
		FBSTRING* vr$15 = fb_StrConcat( &TMP$165$2, (void*)MANGLED$1, -1ll, (void*)"K", 2ll );
...
static void HMANGLEVARIABLE( struct $8FBSYMBOL* SYM$1 )
{
	...
	if( (*(int64*)((uint8*)SYM$1 + 8ll) & 59ll) == 0ll ) goto label$213;
	{
		...
		label$216:;
		{
			...
			if( TMP$167$3 == 0ll ) goto label$220;
			label$221:;
			if( TMP$167$3 != 1ll ) goto label$219;
			label$220:;
			{
	...
	label$235:;
	{
		...
		if( (ISGLOBAL$1 | DOCPP$1) == 0ll ) goto label$237;
		{
			...
			if( (*(int64*)((uint8*)SYM$1 + 8ll) & 1048576ll) == 0ll ) goto label$243;
			{
				...
				FBSTRING TMP$174$4;
				TMP$173$4 = 0ll;
				uint8* vr$44 = HMANGLEBUILTINTYPE( *(int64*)((uint8*)SYM$1 + 56ll) & 511ll, &TMP$173$4 );
				__builtin_memset( &TMP$174$4, 0, 24ll );
				FBSTRING* vr$47 = fb_StrConcat( &TMP$174$4, (void*)&ID$1, -1ll, (void*)vr$44, 0ll );
		...
		{
			{
				...
				TMP$175$4 = *($10FB_BACKEND*)((uint8*)&ENV$ + 208ll);
				if( TMP$175$4 != 1ll ) goto label$247;
				label$248:;
				{
					...
					label$250:;
					{
						if( (int64)*(int16*)((uint8*)SYM$1 + 74ll) != 0ll ) goto label$252;
						{
							...
							if( (*(int64*)((uint8*)SYM$1 + 8ll) & 1048576ll) == 0ll ) goto label$254;
							{
								...
								FBSTRING TMP$177$8;
								TMP$176$8 = 0ll;
								uint8* vr$62 = HMANGLEBUILTINTYPE( *(int64*)((uint8*)SYM$1 + 56ll) & 511ll, &TMP$176$8 );
								__builtin_memset( &TMP$177$8, 0, 24ll );
								FBSTRING* vr$65 = fb_StrConcat( &TMP$177$8, (void*)&ID$1, -1ll, (void*)vr$62, 0ll );
							...
							FBSTRING* vr$71 = fb_StrConcat( &TMP$178$7, (void*)&ID$1, -1ll, (void*)vr$68, -1ll );
				...
				goto label$246;
				label$247:;
				if( TMP$175$4 != 2ll ) goto label$255;
				label$256:;
				{
					if( (int64)*(int16*)((uint8*)SYM$1 + 74ll) != 0ll ) goto label$258;
					{
						...
						if( (*(int64*)((uint8*)SYM$1 + 8ll) & 1048576ll) == 0ll ) goto label$260;
						{
							...
							FBSTRING TMP$180$7;
							TMP$179$7 = 0ll;
							uint8* vr$81 = HMANGLEBUILTINTYPE( *(int64*)((uint8*)SYM$1 + 56ll) & 511ll, &TMP$179$7 );
							__builtin_memset( &TMP$180$7, 0, 24ll );
							FBSTRING* vr$84 = fb_StrConcat( &TMP$180$7, (void*)&ID$1, -1ll, (void*)vr$81, 0ll );
				...
				goto label$246;
				label$255:;
				if( TMP$175$4 != 3ll ) goto label$261;
				label$262:;
				{
					if( (int64)*(int16*)((uint8*)SYM$1 + 74ll) != 0ll ) goto label$264;
					{
						...
						if( (*(int64*)((uint8*)SYM$1 + 8ll) & 1048576ll) == 0ll ) goto label$266;
						{
							...
							FBSTRING TMP$182$7;
							TMP$181$7 = 0ll;
							uint8* vr$96 = HMANGLEBUILTINTYPE( *(int64*)((uint8*)SYM$1 + 56ll) & 511ll, &TMP$181$7 );
							__builtin_memset( &TMP$182$7, 0, 24ll );
							FBSTRING* vr$99 = fb_StrConcat( &TMP$182$7, (void*)&ID$1, -1ll, (void*)vr$96, 0ll );
				...
				label$261:;
				{
					...
					label$270:;
					{
						uint8* vr$109 = (*(tmp$43*)((uint8*)&IR$ + 88ll))(  );
...
static void HGETPROCPARAMSTYPECODE( FBSTRING* MANGLED$1, struct $8FBSYMBOL* SYM$1, int64 IS_REAL_PROC$1 )
{
	...
	if( PARAM$1 != (struct $8FBSYMBOL*)0ull ) goto label$286;
	{
		...
		FBSTRING* vr$8 = fb_StrConcat( &TMP$183$2, (void*)MANGLED$1, -1ll, (void*)"v", 2ll );
		fb_StrAssign( (void*)MANGLED$1, -1ll, (void*)vr$8, -1ll, 0 );
		goto label$280;
	}
	label$286:;
...
static uint8* HGETOPERATORNAME( struct $8FBSYMBOL* PROC$1 )
{
	...
	{
		uint64 TMP$184$2;
		TMP$184$2 = *(uint64*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)PROC$1 + 208ll) + 80ll);
		goto label$293;
		label$294:;
		{
		...
		goto label$292;
		label$293:;
		static const void* tmp$270[82ll] = {
			&&label$294,
			&&label$296,
			&&label$298,
			&&label$300,
		...
		if( TMP$184$2 > 81ull ) goto label$292;
		goto *tmp$270[TMP$184$2 - 0ull];
		label$292:;
	}
	label$291:;
	return fb$result$1;
...
static void HMANGLEPROC( struct $8FBSYMBOL* SYM$1 )
{
	...
	if( *(int64*)((uint8*)&ENV$ + 208ll) != 2ll ) goto label$373;
	{
		...
		label$374:;
		{
			...
			TMP$259$3 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 216ll);
			if( TMP$259$3 == 0ll ) goto label$378;
			label$379:;
			if( TMP$259$3 == 1ll ) goto label$378;
			label$380:;
			if( TMP$259$3 != 4ll ) goto label$377;
			label$378:;
			{
	...
	if( (*(int64*)((uint8*)SYM$1 + 24ll) & 512ll) == 0ll ) goto label$390;
	{
		...
		if( DOCPP$1 == 0ll ) goto label$392;
		{
			...
			FBSTRING* vr$34 = fb_StrConcat( &TMP$261$3, (void*)&MANGLED$1, -1ll, (void*)vr$30, -1ll );
			fb_StrAssign( (void*)&MANGLED$1, -1ll, (void*)vr$34, -1ll, 0 );
		}
		label$392:;
		label$391:;
		__builtin_memset( &TMP$262$2, 0, 24ll );
		FBSTRING* vr$40 = fb_StrConcat( &TMP$262$2, (void*)&MANGLED$1, -1ll, *(void**)((uint8*)SYM$1 + 40ll), 0ll );
	...
	if( (*(int64*)((uint8*)SYM$1 + 16ll) & 16ll) == 0ll ) goto label$393;
	{
		...
		label$395:;
		{
			...
			FBSTRING* vr$54 = fb_StrConcat( &TMP$264$3, (void*)&MANGLED$1, -1ll, (void*)vr$50, 0ll );
	...
	label$397:;
	{
		...
		FBSTRING* vr$75 = fb_StrConcat( &TMP$267$2, (void*)&MANGLED$1, -1ll, (void*)ID$1, 0ll );
