...
void LEXREADUTF8( void )
{
	...
	label$69:;
	*(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16824ll) = CHARS$1;
...
static int64 HUTF8TOCHAR( void )
{
	...
	static int64 I$1;
	DST$1 = (uint8*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16840ll);
	CHARS$1 = 0ll;
	label$12:;
	if( CHARS$1 >= 8192ll ) goto label$13;
	{
		int32 vr$4 = fb_FileEof( (int32)*(int64*)((uint8*)&ENV$ + 552ll) );
		...
		label$15:;
		label$14:;
		int32 vr$7 = fb_FileGetLarge( (int32)*(int64*)((uint8*)&ENV$ + 552ll), 0ll, (void*)SRC$1, 1ull );
		...
		label$17:;
		label$16:;
		EXTBYTES$1 = (int64)*(uint8*)((uint8*)UTF8_TRAILINGTB$ + (int64)*(uint8*)SRC$1);
		C$1 = 0ull;
		P$1 = (uint8*)SRC$1;
		if( EXTBYTES$1 <= 0ll ) goto label$19;
		{
			int32 vr$12 = fb_FileGetLarge( (int32)*(int64*)((uint8*)&ENV$ + 552ll), 0ll, (void*)((uint8*)SRC$1 + 1ll), (uint64)EXTBYTES$1 );
		...
		label$18:;
		C$1 = C$1 + (uint64)(int64)*P$1;
		C$1 = C$1 - *(uint64*)((uint8*)UTF8_OFFSETSTB$ + (EXTBYTES$1 << (3ll & 63ll)));
...
static int64 HUTF8TOUTF16LE( void )
{
	...
	static int64 EXTBYTES$1;
	static int64 I$1;
	DST$1 = (uint16*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16840ll);
	CHARS$1 = 0ll;
	label$29:;
...
static int64 HUTF8TOUTF32LE( void )
{
	...
	static int64 EXTBYTES$1;
	static int64 I$1;
	DST$1 = (uint32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16840ll);
	CHARS$1 = 0ll;
	label$48:;
...
static int64 HUTF16LETOCHAR( void )
{
	...
	if( CHARS$1 >= 8192ll ) goto label$75;
	{
		...
		label$77:;
		label$76:;
		int32 vr$7 = fb_FileGetLarge( (int32)*(int64*)((uint8*)&ENV$ + 552ll), 0ll, (void*)&C$1, 2ull );
		...
		if( (int64)C$1 <= 255ll ) goto label$81;
		{
			if( (int64)C$1 < 55296ll ) goto label$83;
			{
				...
				{
					int32 vr$13 = fb_FileGetLarge( (int32)*(int64*)((uint8*)&ENV$ + 552ll), 0ll, (void*)&C$1, 2ull );
...
static int64 HUTF16LETOUTF16LE( void )
{
	...
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$88:;
	int32 vr$4 = fb_FileGetWstrLarge( (int32)*(int64*)((uint8*)&ENV$ + 552ll), 0ll, (uint32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16840ll), 8193ll );
	if( (int64)vr$4 != 0ll ) goto label$91;
	{
		int64 vr$7 = fb_FileTell( (int32)*(int64*)((uint8*)&ENV$ + 552ll) );
		fb$result$1 = (int64)((uint64)(vr$7 - *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 49616ll)) >> (1ull & 63ll));
	}
	goto label$90;
	label$91:;
	{
...
static int64 HUTF16LETOUTF32LE( void )
{
	...
	if( CHARS$1 >= 8192ll ) goto label$95;
	{
		...
		if( WC$1 < 55296ull ) goto label$101;
		{
			...
			{
				int32 vr$11 = fb_FileGetLarge( (int32)*(int64*)((uint8*)&ENV$ + 552ll), 0ll, (void*)&C$1, 2ull );
	...
	if( CHARS$1 >= 8192ll ) goto label$120;
	{
		...
		if( (int64)C$1 <= 255ll ) goto label$126;
		{
			if( (int64)C$1 < 55296ll ) goto label$128;
			{
				...
				{
					int32 vr$20 = fb_FileGetLarge( (int32)*(int64*)((uint8*)&ENV$ + 552ll), 0ll, (void*)&C$1, 2ull );
...
static int64 HUTF16BETOUTF32LE( void )
{
	...
	if( CHARS$1 >= 8192ll ) goto label$142;
	{
		...
		if( WC$1 < 55296ull ) goto label$148;
		{
			...
			{
				int32 vr$16 = fb_FileGetLarge( (int32)*(int64*)((uint8*)&ENV$ + 552ll), 0ll, (void*)&C$1, 2ull );
...
static int64 HUTF32LETOCHAR( void )
{
	...
	if( CHARS$1 >= 8192ll ) goto label$163;
	{
		...
		label$165:;
		label$164:;
		int32 vr$7 = fb_FileGetLarge( (int32)*(int64*)((uint8*)&ENV$ + 552ll), 0ll, (void*)&C$1, 8ull );
...
static int64 HUTF32LETOUTF32LE( void )
{
	...
	{
		int64 vr$7 = fb_FileTell( (int32)*(int64*)((uint8*)&ENV$ + 552ll) );
		fb$result$1 = (int64)((uint64)(vr$7 - *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 49616ll)) >> (2ull & 63ll));
	}
	goto label$184;
	label$185:;
	{
