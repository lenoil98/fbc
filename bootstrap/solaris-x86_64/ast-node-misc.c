...
struct $6IRVREG* ASTLOADLABEL( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$19;
	{
		...
		label$21:;
		{
			(*(tmp$41*)((uint8*)&IR$ + 136ll))( *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) );
		}
		label$20:;
	}
	label$19:;
...
struct $6IRVREG* ASTLOADLIT( struct $7ASTNODE* N$1 )
{
	...
	{
		(*(tmp$49*)((uint8*)&IR$ + 184ll))( *(uint8**)((uint8*)N$1 + 40ll) );
	}
	label$27:;
	label$26:;
...
struct $6IRVREG* ASTLOADASM( struct $7ASTNODE* N$1 )
{
	...
	{
		(*(tmp$48*)((uint8*)&IR$ + 176ll))( *(struct $9ASTASMTOK**)((uint8*)N$1 + 40ll) );
	}
	label$43:;
	label$42:;
	...
	if( NODE$1 == (struct $9ASTASMTOK*)0ull ) goto label$45;
	{
		...
		NXT$2 = *(struct $9ASTASMTOK**)((uint8*)NODE$1 + 16ll);
		{
			...
			if( TMP$114$3 != 0ll ) goto label$47;
			label$48:;
			{
...
struct $6IRVREG* ASTLOADDBG( struct $7ASTNODE* N$1 )
{
	...
	{
		(*(tmp$60*)((uint8*)&IR$ + 344ll))( *(int64*)((uint8*)N$1 + 56ll), *(struct $8FBSYMBOL**)((uint8*)*(struct $7ASTNODE**)((uint8*)&AST$ + 80ll) + 24ll), *(int64*)((uint8*)N$1 + 40ll), *(uint8**)((uint8*)N$1 + 48ll) );
	}
	label$58:;
	label$57:;
	fb$result$1 = (struct $6IRVREG*)0ull;
...
struct $6IRVREG* ASTLOADLINK( struct $7ASTNODE* N$1 )
{
	...
	{
		int64 TMP$115$2;
		TMP$115$2 = *(int64*)((uint8*)N$1 + 40ll);
		if( TMP$115$2 != 1ll ) goto label$99;
		label$100:;
		{
			fb$result$1 = VRL$1;
		}
		goto label$98;
		label$99:;
		if( TMP$115$2 != 2ll ) goto label$101;
		label$102:;
		{
			fb$result$1 = VRR$1;
		}
...
struct $6IRVREG* ASTLOADLOAD( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$111;
	{
		...
		{
			struct $6IRVREG* vr$6 = (*(tmp$69*)((uint8*)&IR$ + 456ll))( *(int64*)((uint8*)V1$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)V1$1 + 16ll) );
			VR$1 = vr$6;
			(*(tmp$44*)((uint8*)&IR$ + 232ll))( V1$1, VR$1 );
		}
		goto label$112;
		label$113:;
		{
			(*(tmp$52*)((uint8*)&IR$ + 224ll))( V1$1 );
		}
		label$112:;
	}
	label$111:;
...
void ASTFORGETBITFIELDS( struct $7ASTNODE* N$1 )
{
	...
	TMP$116$1 = (int64)-(*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 192ll) > 0ll);
	goto label$129;
	label$126:;
	TMP$116$1 = 0ll;
	label$129:;
	if( TMP$116$1 == 0ll ) goto label$128;
	{
		*(int64*)((uint8*)&AST$ + 288ll) = *(int64*)((uint8*)&AST$ + 288ll) + -1ll;
	}
	label$128:;
...
struct $7ASTNODE* ASTUPDATEBITFIELDS( struct $7ASTNODE* N$1 )
{
	...
	label$161:;
	{
		...
		if( TMP$118$2 != 2ll ) goto label$164;
		label$165:;
		{
		...
		goto label$163;
		label$164:;
		if( TMP$118$2 != 19ll ) goto label$170;
		label$171:;
		{
...
struct $6IRVREG* ASTLOADSTACK( struct $7ASTNODE* N$1 )
{
	...
	{
		(*(tmp$53*)((uint8*)&IR$ + 240ll))( *(int64*)((uint8*)N$1 + 40ll), VR$1 );
	}
	label$187:;
	label$186:;
	ASTDELNODE( L$1 );
...
FBSTRING* ASTDUMPOPTOSTR( $6AST_OP OP$1 )
{
	...
	if( ((int64)-(OP$1 > 120ll) | (int64)-(OP$1 < 0ll)) == 0ll ) goto label$201;
	{
		...
		FBSTRING* vr$7 = fb_StrConcat( &TMP$281$2, (void*)"OP:", 4ll, (void*)vr$4, -1ll );
...
static struct $7ASTNODE* ASTSETBITFIELD( struct $8FBSYMBOL* BITFIELD$1, struct $7ASTNODE* L$1, struct $7ASTNODE* R$1 )
{
	...
	if( (*(int64*)((uint8*)BITFIELD$1 + 56ll) & 511ll) != 1ll ) goto label$143;
	{
		...
		TMP$117$2 = (int64)-(*(int64*)((uint8*)R$1 + 8ll) != 1ll);
		goto label$267;
		label$144:;
		TMP$117$2 = -1ll;
		label$267:;
		if( TMP$117$2 == 0ll ) goto label$146;
		{
...
static FBSTRING* HASTNODECLASSTOSTR( $13AST_NODECLASS C$1 )
{
	...
	if( ((int64)-(C$1 > 44ll) | (int64)-(C$1 < 0ll)) == 0ll ) goto label$205;
	{
		...
		FBSTRING* vr$7 = fb_StrConcat( &TMP$283$2, (void*)"CLASS:", 7ll, (void*)vr$4, -1ll );
		fb_StrInit( (void*)&fb$result$1, -1ll, (void*)vr$7, -1ll, 0 );
		goto label$203;
	}
	label$205:;
...
static FBSTRING* HASTNODETOSTR( struct $7ASTNODE* N$1 )
{
	...
	label$217:;
	{
		...
		label$221:;
		{
			...
			FBSTRING* vr$8 = fb_StrConcat( &TMP$286$3, (void*)vr$5, -1ll, (void*)" =-= ", 6ll );
			__builtin_memset( &TMP$287$3, 0, 24ll );
			FBSTRING* vr$11 = fb_StrConcat( &TMP$287$3, (void*)vr$8, -1ll, (void*)vr$3, -1ll );
		...
		label$223:;
		{
			...
			goto label$268;
			label$224:;
			TMP$288$3 = *(int64*)((uint8*)N$1 + 8ll) & 31ll;
			label$268:;
			if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$288$3 * 56ll)) != 1ll ) goto label$226;
			{
				FBSTRING TMP$291$4;
				FBSTRING TMP$292$4;
				FBSTRING TMP$293$4;
				...
				FBSTRING* vr$24 = fb_StrConcat( &TMP$291$4, (void*)" (", 3ll, (void*)vr$21, -1ll );
				__builtin_memset( &TMP$292$4, 0, 24ll );
				FBSTRING* vr$27 = fb_StrConcat( &TMP$292$4, (void*)vr$24, -1ll, (void*)")", 2ll );
				FBSTRING* vr$29 = fb_DoubleToStr( *(double*)((uint8*)N$1 + 40ll) );
				__builtin_memset( &TMP$293$4, 0, 24ll );
				FBSTRING* vr$32 = fb_StrConcat( &TMP$293$4, (void*)vr$29, -1ll, (void*)vr$27, -1ll );
			...
			FBSTRING* vr$37 = fb_StrConcat( &TMP$294$3, (void*)" (", 3ll, (void*)vr$34, -1ll );
			__builtin_memset( &TMP$295$3, 0, 24ll );
			FBSTRING* vr$40 = fb_StrConcat( &TMP$295$3, (void*)vr$37, -1ll, (void*)")", 2ll );
			FBSTRING* vr$42 = fb_LongintToStr( *(int64*)((uint8*)N$1 + 40ll) );
			__builtin_memset( &TMP$296$3, 0, 24ll );
			FBSTRING* vr$45 = fb_StrConcat( &TMP$296$3, (void*)vr$42, -1ll, (void*)vr$40, -1ll );
		...
		label$227:;
		{
			...
			FBSTRING* vr$50 = fb_StrConcat( &TMP$303$3, (void*)" (", 3ll, (void*)vr$47, -1ll );
			__builtin_memset( &TMP$304$3, 0, 24ll );
			FBSTRING* vr$53 = fb_StrConcat( &TMP$304$3, (void*)vr$50, -1ll, (void*)")", 2ll );
			if( *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) == (struct $8FBSYMBOL*)0ull ) goto label$228;
			TMP$299$3 = *(uint8**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 32ll);
			goto label$269;
			label$228:;
			TMP$299$3 = (uint8*)"<NULL>";
			label$269:;
			__builtin_memset( &TMP$301$3, 0, 24ll );
			FBSTRING* vr$59 = fb_StrConcat( &TMP$301$3, (void*)"VAR( ", 6ll, (void*)TMP$299$3, 0ll );
			...
			FBSTRING* vr$65 = fb_StrConcat( &TMP$305$3, (void*)vr$62, -1ll, (void*)vr$53, -1ll );
		...
		label$229:;
		{
			...
			FBSTRING* vr$70 = fb_StrConcat( &TMP$309$3, (void*)" (", 3ll, (void*)vr$67, -1ll );
			__builtin_memset( &TMP$310$3, 0, 24ll );
			FBSTRING* vr$73 = fb_StrConcat( &TMP$310$3, (void*)vr$70, -1ll, (void*)")", 2ll );
			__builtin_memset( &TMP$307$3, 0, 24ll );
			FBSTRING* vr$78 = fb_StrConcat( &TMP$307$3, (void*)"FIELD( ", 8ll, *(void**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 32ll), 0ll );
			__builtin_memset( &TMP$308$3, 0, 24ll );
			FBSTRING* vr$81 = fb_StrConcat( &TMP$308$3, (void*)vr$78, -1ll, (void*)" )", 3ll );
			__builtin_memset( &TMP$311$3, 0, 24ll );
			FBSTRING* vr$84 = fb_StrConcat( &TMP$311$3, (void*)vr$81, -1ll, (void*)vr$73, -1ll );
		...
		label$230:;
		{
			...
			if( *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) == (struct $8FBSYMBOL*)0ull ) goto label$232;
			{
				FBSTRING TMP$313$4;
				FBSTRING TMP$314$4;
				__builtin_memset( &TMP$313$4, 0, 24ll );
				FBSTRING* vr$91 = fb_StrConcat( &TMP$313$4, (void*)"DECL( ", 7ll, *(void**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 32ll), 0ll );
				__builtin_memset( &TMP$314$4, 0, 24ll );
				FBSTRING* vr$94 = fb_StrConcat( &TMP$314$4, (void*)vr$91, -1ll, (void*)" )", 3ll );
			...
			FBSTRING* vr$99 = fb_StrConcat( &TMP$315$3, (void*)" (", 3ll, (void*)vr$96, -1ll );
			__builtin_memset( &TMP$316$3, 0, 24ll );
			FBSTRING* vr$102 = fb_StrConcat( &TMP$316$3, (void*)vr$99, -1ll, (void*)")", 2ll );
			__builtin_memset( &TMP$317$3, 0, 24ll );
			FBSTRING* vr$105 = fb_StrConcat( &TMP$317$3, (void*)"DECL", 5ll, (void*)vr$102, -1ll );
		...
		label$233:;
		{
			...
			FBSTRING* vr$111 = fb_StrConcat( &TMP$319$3, (void*)"CALL( ", 7ll, *(void**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 32ll), 0ll );
			__builtin_memset( &TMP$320$3, 0, 24ll );
			FBSTRING* vr$114 = fb_StrConcat( &TMP$320$3, (void*)vr$111, -1ll, (void*)" )", 3ll );
		...
		label$234:;
		{
			...
			FBSTRING* vr$120 = fb_StrConcat( &TMP$322$3, (void*)"LABEL: ", 8ll, (void*)vr$117, -1ll );
		...
		label$235:;
		{
			...
			FBSTRING* vr$128 = fb_StrConcat( &TMP$325$3, (void*)"BRANCH: ", 9ll, (void*)vr$125, -1ll );
			__builtin_memset( &TMP$326$3, 0, 24ll );
			FBSTRING* vr$131 = fb_StrConcat( &TMP$326$3, (void*)vr$128, -1ll, (void*)" ", 2ll );
			__builtin_memset( &TMP$327$3, 0, 24ll );
			FBSTRING* vr$134 = fb_StrConcat( &TMP$327$3, (void*)vr$131, -1ll, (void*)vr$123, -1ll );
		...
		label$236:;
		{
			...
			FBSTRING* vr$140 = fb_StrConcat( &TMP$329$3, (void*)"SCOPEBEGIN: ", 13ll, (void*)vr$137, -1ll );
		...
		label$237:;
		{
			...
			FBSTRING* vr$146 = fb_StrConcat( &TMP$331$3, (void*)"TYPEINI_ASSIGN( offset=", 24ll, (void*)vr$143, -1ll );
			__builtin_memset( &TMP$332$3, 0, 24ll );
			FBSTRING* vr$149 = fb_StrConcat( &TMP$332$3, (void*)vr$146, -1ll, (void*)" )", 3ll );
		...
		label$238:;
		{
			...
			FBSTRING* vr$154 = fb_StrConcat( &TMP$336$3, (void*)" (", 3ll, (void*)vr$151, -1ll );
			__builtin_memset( &TMP$337$3, 0, 24ll );
			FBSTRING* vr$157 = fb_StrConcat( &TMP$337$3, (void*)vr$154, -1ll, (void*)")", 2ll );
			FBSTRING* vr$159 = ASTDUMPOPTOSTR( *($6AST_OP*)((uint8*)N$1 + 40ll) );
			__builtin_memset( &TMP$334$3, 0, 24ll );
			FBSTRING* vr$162 = fb_StrConcat( &TMP$334$3, (void*)"MACRO: ", 8ll, (void*)vr$159, -1ll );
			__builtin_memset( &TMP$335$3, 0, 24ll );
			FBSTRING* vr$165 = fb_StrConcat( &TMP$335$3, (void*)vr$162, -1ll, (void*)" ", 2ll );
			__builtin_memset( &TMP$338$3, 0, 24ll );
			FBSTRING* vr$168 = fb_StrConcat( &TMP$338$3, (void*)vr$165, -1ll, (void*)vr$157, -1ll );
		...
		label$239:;
		{
			...
			{
				int64 TMP$339$4;
				TMP$339$4 = *(int64*)((uint8*)N$1 + 40ll);
				if( TMP$339$4 != 1ll ) goto label$241;
				label$242:;
				{
				...
				goto label$240;
				label$241:;
				if( TMP$339$4 != 2ll ) goto label$243;
				label$244:;
				{
			...
			FBSTRING* vr$178 = fb_StrConcat( &TMP$343$3, (void*)" (", 3ll, (void*)vr$175, -1ll );
			__builtin_memset( &TMP$344$3, 0, 24ll );
			FBSTRING* vr$181 = fb_StrConcat( &TMP$344$3, (void*)vr$178, -1ll, (void*)")", 2ll );
			FBSTRING* vr$183 = HASTNODECLASSTOSTR( *($13AST_NODECLASS*)N$1 );
			__builtin_memset( &TMP$342$3, 0, 24ll );
			FBSTRING* vr$186 = fb_StrConcat( &TMP$342$3, (void*)"*", 2ll, (void*)vr$183, -1ll );
			__builtin_memset( &TMP$345$3, 0, 24ll );
			FBSTRING* vr$189 = fb_StrConcat( &TMP$345$3, (void*)vr$186, -1ll, (void*)vr$181, -1ll );
			__builtin_memset( &TMP$346$3, 0, 24ll );
			FBSTRING* vr$192 = fb_StrConcat( &TMP$346$3, (void*)vr$189, -1ll, (void*)"-", 2ll );
			__builtin_memset( &TMP$347$3, 0, 24ll );
			FBSTRING* vr$195 = fb_StrConcat( &TMP$347$3, (void*)vr$192, -1ll, (void*)&S$3, -1ll );
		...
		label$245:;
		{
			...
			FBSTRING* vr$202 = fb_StrConcat( &TMP$348$3, (void*)" (", 3ll, (void*)vr$199, -1ll );
			__builtin_memset( &TMP$349$3, 0, 24ll );
			FBSTRING* vr$205 = fb_StrConcat( &TMP$349$3, (void*)vr$202, -1ll, (void*)")", 2ll );
			FBSTRING* vr$207 = HASTNODECLASSTOSTR( *($13AST_NODECLASS*)N$1 );
			__builtin_memset( &TMP$350$3, 0, 24ll );
			FBSTRING* vr$210 = fb_StrConcat( &TMP$350$3, (void*)vr$207, -1ll, (void*)vr$205, -1ll );
			fb_StrInit( (void*)&fb$result$1, -1ll, (void*)vr$210, -1ll, 0 );
			goto label$218;
		}
		goto label$219;
		label$220:;
		static const void* tmp$357[42ll] = {
			&&label$221,
			&&label$222,
			&&label$245,
			&&label$245,
		...
		if( (TMP$284$2 - 3ull) > 41ull ) goto label$245;
		goto *tmp$357[TMP$284$2 - 3ull];
		label$219:;
	}
	label$218:;
...
static void ASTDUMPTREEEX( struct $7ASTNODE* N$1, int64 COL$1, int64 JUST$1, int64 DEPTH$1 )
{
	...
	if( *(struct $7ASTNODE**)((uint8*)N$1 + 112ll) == (struct $7ASTNODE*)0ull ) goto label$253;
	{
		if( *(struct $7ASTNODE**)((uint8*)N$1 + 120ll) == (struct $7ASTNODE*)0ull ) goto label$255;
		{
			...
			fb_StrAssign( (void*)&TMP$352$3, -1ll, (void*)"/ \x5C", 4ll, 0 );
			DBG_ASTOUTPUT( &TMP$352$3, COL$1 + -2ll, 0ll, -1ll );
		...
		label$255:;
		{
			...
			fb_StrAssign( (void*)&TMP$353$3, -1ll, (void*)"/", 2ll, 0 );
			DBG_ASTOUTPUT( &TMP$353$3, COL$1 + -2ll, 0ll, -1ll );
	...
	if( *(struct $7ASTNODE**)((uint8*)N$1 + 120ll) == (struct $7ASTNODE*)0ull ) goto label$256;
	{
		...
		fb_StrAssign( (void*)&TMP$355$2, -1ll, (void*)"  \x5C", 4ll, 0 );
		DBG_ASTOUTPUT( &TMP$355$2, COL$1 + -2ll, 0ll, -1ll );
	...
	label$256:;
	{
		...
		fb_StrAssign( (void*)&TMP$356$2, -1ll, (void*)"", 1ll, 0 );
		DBG_ASTOUTPUT( &TMP$356$2, 0ll, 0ll, -1ll );
