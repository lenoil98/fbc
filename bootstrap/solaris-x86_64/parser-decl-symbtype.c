...
void CUDTTYPEMEMBER( int64*, struct $8FBSYMBOL**, int64*, int64* );
...
int64 HISCONSTINRANGE( int64 DTYPE$1, int64 VALUE$1, int64 TODTYPE$1 )
{
	...
	label$36:;
	R$1 = (struct $11RANGEVALUES*)((uint8*)RANGE$1 + (*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$95$1 * 56ll)) + 40ll) * 24ll));
	...
	label$37:;
	if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$96$1 * 56ll)) + 16ll) == 0ll ) goto label$21;
	{
		int64 TMP$97$2;
		...
		label$38:;
		if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$97$2 * 56ll)) + 16ll) == 0ll ) goto label$24;
		{
		...
		label$24:;
		{
			...
			label$40:;
			if( ((int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$98$3 * 56ll)) + 40ll) == 7ll) & (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$99$3 * 56ll)) + 40ll) == 8ll)) == 0ll ) goto label$28;
			{
	...
	label$21:;
	{
		...
		label$41:;
		if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$100$2 * 56ll)) + 16ll) == 0ll ) goto label$31;
		{
			int64 TMP$101$3;
			int64 TMP$102$3;
			...
			label$43:;
			if( ((int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$101$3 * 56ll)) + 40ll) == 8ll) & (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$102$3 * 56ll)) + 40ll) == 7ll)) == 0ll ) goto label$35;
			{
...
struct $7ASTNODE* CTYPEOREXPRESSION( int64 TK$1, int64* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1, int64* LGT$1, int64* IS_FIXLENSTR$1 )
{
	...
	if( ((int64)-(vr$2 == 265ll) & (int64)-(vr$4 == 41ll)) == 0ll ) goto label$99;
	{
		...
		CHAIN_$2 = *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 4136ll);
	...
	label$104:;
	if( ((MAYBE_TYPE$1 & (int64)-(TK$1 == 463ll)) & (int64)-(*(int64*)((uint8*)&ENV$ + 272ll) == 3ll)) == 0ll ) goto label$118;
	{
		MAYBE_TYPE$1 = 0ll;
	}
	label$118:;
...
void CTYPEOF( int64* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1, int64* LGT$1, int64* IS_FIXLENSTR$1 )
{
	label$127:;
	struct $7ASTNODE* EXPR$1;
	struct $7ASTNODE* vr$0 = CTYPEOREXPRESSION( 377ll, DTYPE$1, SUBTYPE$1, LGT$1, IS_FIXLENSTR$1 );
	EXPR$1 = vr$0;
...
int64 CSYMBOLTYPE( int64* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1, int64* LGT$1, int64* IS_FIXLENSTR$1, $14FB_SYMBTYPEOPT OPTIONS$1 )
{
	...
	*IS_FIXLENSTR$1 = 0ll;
	...
	if( vr$5 != 377ll ) goto label$189;
	{
		LEXSKIPTOKEN( 2048ll );
		int64 vr$6 = HMATCH( 40ll, 0ll );
		if( vr$6 != 0ll ) goto label$191;
		{
		...
		int64 vr$7 = HMATCH( 41ll, 0ll );
		if( vr$7 != 0ll ) goto label$193;
		{
	...
	label$189:;
	{
		...
		label$195:;
		label$194:;
		int64 vr$9 = HMATCH( 375ll, 2048ll );
		ISUNSIGNED$1 = vr$9;
		{
			uint64 TMP$127$3;
			int64 vr$10 = LEXGETTOKEN( 0ll );
			TMP$127$3 = (uint64)vr$10;
			goto label$197;
			label$198:;
			{
				LEXSKIPTOKEN( 2048ll );
			...
			{
				LEXSKIPTOKEN( 2048ll );
				int64 vr$17 = HMATCH( 301ll, 0ll );
				if( vr$17 == 0ll ) goto label$206;
				{
					struct $7ASTNODE* vr$18 = CGTINPARENSONLYEXPR(  );
					int64 vr$19 = CCONSTINTEXPR( vr$18, 8ll );
					*LGT$1 = vr$19;
					$11FB_DATATYPE vr$22 = HINTEGERTYPEFROMBITSIZE( *LGT$1, 0ll );
					*DTYPE$1 = vr$22;
					int64 vr$24 = HMATCH( 300ll, 0ll );
					if( vr$24 != 0ll ) goto label$208;
					{
			...
			{
				LEXSKIPTOKEN( 2048ll );
				int64 vr$26 = HMATCH( 301ll, 0ll );
				if( vr$26 == 0ll ) goto label$211;
				{
					struct $7ASTNODE* vr$27 = CGTINPARENSONLYEXPR(  );
					int64 vr$28 = CCONSTINTEXPR( vr$27, 8ll );
					*LGT$1 = vr$28;
					$11FB_DATATYPE vr$31 = HINTEGERTYPEFROMBITSIZE( *LGT$1, -1ll );
					*DTYPE$1 = vr$31;
					int64 vr$33 = HMATCH( 300ll, 0ll );
					if( vr$33 != 0ll ) goto label$213;
					{
						ERRREPORT( 309ll, -1ll, (uint8*)0ull );
					}
					label$213:;
			...
			label$223:;
			{
				...
				ISFUNCTION$1 = (int64)-(vr$44 == 346ll);
				LEXSKIPTOKEN( 2048ll );
				*DTYPE$1 = 54ll;
				PTR_CNT$1 = PTR_CNT$1 + 1ll;
				struct $8FBSYMBOL* vr$48 = CSYMBOLTYPEFUNCPTR( ISFUNCTION$1 );
				*SUBTYPE$1 = vr$48;
				if( *SUBTYPE$1 != (struct $8FBSYMBOL*)0ull ) goto label$225;
				{
					goto label$187;
				}
				label$225:;
			...
			goto label$196;
			label$197:;
			static const void* tmp$144[28ll] = {
				&&label$223,
				&&label$223,
				&&label$196,
				&&label$196,
			...
			if( (TMP$127$3 - 345ull) > 27ull ) goto label$196;
			goto *tmp$144[TMP$127$3 - 345ull];
			label$196:;
		}
		if( *DTYPE$1 == 2147483648ll ) goto label$227;
		{
			{
				int64 TMP$128$4;
				TMP$128$4 = *DTYPE$1 & 511ll;
				if( TMP$128$4 == 4ll ) goto label$230;
				label$231:;
				if( TMP$128$4 != 7ll ) goto label$229;
				label$230:;
				{
					*LGT$1 = 0ll;
				}
				...
				label$229:;
				{
					...
					goto label$340;
					label$233:;
					TMP$129$5 = *DTYPE$1 & 31ll;
					label$340:;
					*LGT$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$129$5 * 56ll)) + 8ll);
				}
				label$232:;
				label$228:;
			}
		...
		label$227:;
		{
			...
			int64 CHECK_ID$3;
			CHECK_ID$3 = -1ll;
			if( *(struct $13FB_CMPSTMTSTK**)((uint8*)&PARSER$ + 104ll) == (struct $13FB_CMPSTMTSTK*)0ull ) goto label$235;
			{
				int64 vr$61 = LEXGETTOKEN( 0ll );
				if( vr$61 != 46ll ) goto label$237;
				{
					int64 vr$62 = LEXGETLOOKAHEAD( 1ll, 64ll );
					CHECK_ID$3 = (int64)-(vr$62 == 46ll);
				}
				label$237:;
				label$236:;
			}
			label$235:;
			label$234:;
			if( CHECK_ID$3 == 0ll ) goto label$239;
			{
				int64 TMP$130$4;
				if( (OPTIONS$1 & 8ll) == 0ll ) goto label$240;
				TMP$130$4 = 0ll;
				goto label$341;
				label$240:;
				TMP$130$4 = 50ll;
				label$341:;
				struct $10FBSYMCHAIN* vr$66 = CIDENTIFIER( &BASE_PARENT$3, TMP$130$4 );
				CHAIN_$3 = vr$66;
			}
			label$239:;
			label$238:;
			if( CHAIN_$3 == (struct $10FBSYMCHAIN*)0ull ) goto label$242;
			{
				...
				{
					{
						...
						if( TMP$131$6 == 2ll ) goto label$247;
						label$248:;
						if( TMP$131$6 == 1ll ) goto label$247;
						label$249:;
						if( TMP$131$6 != 12ll ) goto label$246;
						label$247:;
						{
				...
				label$250:;
				{
					...
					{
						{
							...
							if( TMP$132$7 != 10ll ) goto label$257;
							label$258:;
							{
								LEXSKIPTOKEN( 2048ll );
								*DTYPE$1 = 20ll;
							...
							goto label$256;
							label$257:;
							if( TMP$132$7 != 9ll ) goto label$259;
							label$260:;
							{
								LEXSKIPTOKEN( 2048ll );
								*DTYPE$1 = 10ll;
								*SUBTYPE$1 = SYM$5;
								*LGT$1 = *(int64*)((uint8*)SYMB_DTYPETB$ + 568ll);
								goto label$251;
							}
							goto label$256;
							label$259:;
							if( TMP$132$7 != 13ll ) goto label$261;
							label$262:;
							{
								LEXSKIPTOKEN( 2048ll );
					...
					label$255:;
					if( SYM$5 != (struct $8FBSYMBOL*)0ull ) goto label$253;
					label$254:;
				...
				label$251:;
				if( (OPTIONS$1 & 8ll) == 0ll ) goto label$264;
				{
					if( *DTYPE$1 == 2147483648ll ) goto label$266;
					{
						*(struct $10FBSYMCHAIN**)((uint8*)&PARSER$ + 184ll) = (struct $10FBSYMCHAIN*)0ull;
					}
					label$266:;
		...
		label$226:;
		if( *DTYPE$1 != 2147483648ll ) goto label$268;
		{
			if( ISUNSIGNED$1 == 0ll ) goto label$270;
			{
				ERRREPORT( 17ll, 0ll, (uint8*)0ull );
			}
			label$270:;
			label$269:;
			if( IS_CONST$1 == 0ll ) goto label$272;
			{
				*DTYPE$1 = 512ll;
			}
			label$272:;
		...
		label$268:;
		label$267:;
		if( ISUNSIGNED$1 == 0ll ) goto label$274;
		{
			{
				int64 TMP$133$4;
				uint64 TMP$134$4;
				if( (*DTYPE$1 & 480ll) == 0ll ) goto label$275;
				TMP$133$4 = 24ll;
				goto label$342;
				label$275:;
				TMP$133$4 = *DTYPE$1 & 31ll;
				label$342:;
				TMP$134$4 = (uint64)TMP$133$4;
				goto label$277;
				label$278:;
				{
					*DTYPE$1 = 3ll;
				...
				label$281:;
				{
					if( (*DTYPE$1 & 32505856ll) == 0ll ) goto label$283;
					{
						*DTYPE$1 = 9437196ll;
					}
					goto label$282;
				...
				if( (TMP$134$4 - 2ull) > 11ull ) goto label$285;
				goto *tmp$145[TMP$134$4 - 2ull];
				label$276:;
			}
		}
		label$274:;
	...
	if( vr$111 != 42ll ) goto label$287;
	{
		LEXSKIPTOKEN( 0ll );
		struct $7ASTNODE* vr$112 = CEQINPARENSONLYEXPR(  );
		int64 vr$113 = CCONSTINTEXPR( vr$112, 8ll );
		*LGT$1 = vr$113;
		*IS_FIXLENSTR$1 = -1ll;
		{
			int64 TMP$135$3;
			...
			goto label$343;
			label$288:;
			TMP$135$3 = *DTYPE$1 & 31ll;
			label$343:;
			TMP$136$3 = (uint64)TMP$135$3;
			goto label$290;
			label$291:;
			{
				*LGT$1 = *(int64*)LGT$1 + 1ll;
				if( *(int64*)LGT$1 > 1ll ) goto label$293;
				{
					ERRREPORT( 17ll, -1ll, (uint8*)0ull );
					*LGT$1 = 2ll;
				}
			...
			{
				int64 TMP$137$4;
				if( *(int64*)LGT$1 >= 1ll ) goto label$296;
				{
					ERRREPORT( 17ll, -1ll, (uint8*)0ull );
					*LGT$1 = 1ll;
				}
				...
				goto label$344;
				label$297:;
				TMP$137$4 = *DTYPE$1 & 31ll;
				label$344:;
				if( TMP$137$4 != 7ll ) goto label$299;
				{
					*LGT$1 = *(int64*)LGT$1 * *(int64*)((uint8*)SYMB_DTYPETB$ + 400ll);
				}
				label$299:;
				label$298:;
			}
			...
			goto label$289;
			label$290:;
			static const void* tmp$146[14ll] = {
				&&label$294,
				&&label$300,
				&&label$300,
				&&label$294,
			...
			if( (TMP$136$3 - 4ull) > 13ull ) goto label$300;
			goto *tmp$146[TMP$136$3 - 4ull];
			label$289:;
		}
		if( (OPTIONS$1 & 4ll) == 0ll ) goto label$302;
		{
			ERRREPORT( 324ll, -1ll, (uint8*)0ull );
		}
		label$302:;
		label$301:;
		if( IS_CONST$1 == 0ll ) goto label$304;
		{
	...
	label$287:;
	{
		if( IS_CONST$1 == 0ll ) goto label$306;
		{
			*DTYPE$1 = *DTYPE$1 | 512ll;
		}
		label$306:;
		...
		label$307:;
		{
			{
				uint64 TMP$138$4;
				int64 vr$142 = LEXGETTOKEN( 0ll );
				TMP$138$4 = (uint64)vr$142;
				goto label$311;
				label$312:;
				{
					LEXSKIPTOKEN( 2048ll );
					{
						int64 TMP$139$6;
						int64 vr$143 = LEXGETTOKEN( 0ll );
						TMP$139$6 = vr$143;
						if( TMP$139$6 == 373ll ) goto label$315;
						label$316:;
						if( TMP$139$6 != 374ll ) goto label$314;
						label$315:;
						{
							if( PTR_CNT$1 < 8ll ) goto label$318;
							{
				...
				label$320:;
				{
					if( PTR_CNT$1 < 8ll ) goto label$322;
					{
						ERRREPORT( 274ll, 0ll, (uint8*)0ull );
					}
					goto label$321;
				...
				goto label$310;
				label$311:;
				static const void* tmp$147[40ll] = {
					&&label$312,
					&&label$323,
					&&label$323,
					&&label$323,
				...
				if( (TMP$138$4 - 335ull) > 39ull ) goto label$323;
				goto *tmp$147[TMP$138$4 - 335ull];
				label$310:;
			}
		}
		label$309:;
	...
	label$286:;
	if( PTR_CNT$1 <= 0ll ) goto label$325;
	{
		int64 TMP$140$2;
		if( (*DTYPE$1 & 480ll) == 0ll ) goto label$326;
		TMP$140$2 = 24ll;
		goto label$345;
		label$326:;
		TMP$140$2 = *DTYPE$1 & 31ll;
		label$345:;
		*LGT$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$140$2 * 56ll)) + 8ll);
	}
	goto label$324;
	label$325:;
	{
		...
		label$346:;
		if( TMP$141$2 != 23ll ) goto label$329;
		{
			if( (OPTIONS$1 & 2ll) != 0ll ) goto label$331;
			{
		...
		goto label$328;
		label$329:;
		if( *(int64*)LGT$1 > 0ll ) goto label$332;
		{
			{
				int64 TMP$142$4;
				TMP$142$4 = *DTYPE$1 & 511ll;
				if( TMP$142$4 == 4ll ) goto label$335;
				label$336:;
				if( TMP$142$4 != 7ll ) goto label$334;
				label$335:;
				{
					int64 TMP$143$5;
					if( (OPTIONS$1 & 1ll) == 0ll ) goto label$338;
					{
					...
					label$338:;
					label$337:;
					if( (*DTYPE$1 & 480ll) == 0ll ) goto label$339;
					TMP$143$5 = 24ll;
					goto label$347;
					label$339:;
					TMP$143$5 = *DTYPE$1 & 31ll;
					label$347:;
					*LGT$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$143$5 * 56ll)) + 8ll);
				}
				label$334:;
				label$333:;
			}
		...
		{
			{
				...
				label$153:;
				{
					...
					if( (vr$10 & (int64)-((*(int64*)((uint8*)&ENV$ + 520ll) & 1ll) == 0ll)) == 0ll ) goto label$155;
					{
						{
							int64 TMP$120$7;
							TMP$120$7 = *DTYPE$1;
				...
				goto label$151;
				label$168:;
				int32 vr$33 = fb_StrCompare( (void*)&TMP$118$4, -1ll, (void*)"__builtin_va_list", 18ll );
				if( (int64)vr$33 == 0ll ) goto label$175;
				label$176:;
				int32 vr$36 = fb_StrCompare( (void*)&TMP$118$4, -1ll, (void*)"__builtin_va_list[]", 20ll );
				if( (int64)vr$36 != 0ll ) goto label$174;
				label$175:;
				{
					{
						int64 TMP$126$6;
						TMP$126$6 = *DTYPE$1;
						if( TMP$126$6 != 0ll ) goto label$178;
						label$179:;
						{
						...
						goto label$177;
						label$178:;
						if( TMP$126$6 != 20ll ) goto label$180;
						label$181:;
						{
							*DTYPE$1 = (*DTYPE$1 & -32505857ll) | 19922944ll;
							$19FB_CVA_LIST_TYPEDEF vr$50 = FBGETBACKENDVALISTTYPE(  );
							*(int32*)((uint8*)*SUBTYPE$1 + 208ll) = (int32)((int64)*(int32*)((uint8*)*SUBTYPE$1 + 208ll) | ((vr$50 << (20ll & 63ll)) & 15728640ll));
						}
						goto label$177;
						label$180:;
						{
				...
				goto label$151;
				label$174:;
				int32 vr$58 = fb_StrCompare( (void*)&TMP$118$4, -1ll, (void*)"", 1ll );
				if( (int64)vr$58 != 0ll ) goto label$183;
				label$184:;
				{
