...
void ASTSCOPEBREAK( struct $8FBSYMBOL* TARGET$1 )
{
	...
	*(int64*)((uint8*)N$1 + 56ll) = *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16744ll);
	...
	label$163:;
	{
		...
		if( S$1 == (struct $8FBSYMBOL*)0ull ) goto label$169;
		{
			if( ((int64)-(*(int64*)S$1 == 1ll) & (int64)-((*(int64*)((uint8*)S$1 + 8ll) & 3ll) == 0ll)) == 0ll ) goto label$171;
			{
				...
				{
					(*(tmp$42*)((uint8*)&IR$ + 72ll))( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll), S$1 );
				}
				goto label$172;
				label$173:;
				{
