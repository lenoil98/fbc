		...
		{
			{
				...
				goto label$255;
				label$256:;
				static const void* tmp$103[48ll] = {
					&&label$257,
					&&label$271,
					&&label$255,
					&&label$263,
				...
				if( (TMP$102$4 - 346ull) > 47ull ) goto label$255;
...
int64 HFORWARDCALL( void )
{
	...
	fb$result$1 = 0ll;
	{
		...
		label$329:;
		{
			if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 524288ll) == 0ll ) goto label$331;
			{
				...
				{
					if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 4144ll) <= 0ll ) goto label$335;
					{
	...
	if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 16ll) == 2147483648ll ) goto label$338;
	{
		ERRREPORT( 17ll, 0ll, (uint8*)0ull );
	}
	label$338:;
...
static int64 HPROCCALLORASSIGN_QB( void )
{
	...
	fb$result$1 = 0ll;
	{
		...
		label$239:;
		{
			int64 vr$4 = HASSIGNORCALL_QB( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 4136ll), 0ll );
			fb$result$1 = vr$4;
			goto label$236;
		}
		goto label$237;
		label$240:;
		{
			...
			{
				int64 vr$8 = HASSIGNORCALL_QB( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 4136ll), 0ll );
				fb$result$1 = vr$8;
				goto label$236;
			}
			label$242:;
			...
			label$243:;
			LEXSKIPTOKEN( 2048ll );
			if( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 4136ll) != (struct $10FBSYMCHAIN*)0ull ) goto label$246;
			{
			...
			label$246:;
			{
				int64 vr$15 = HASSIGNORCALL_QB( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 4136ll), -1ll );
				fb$result$1 = vr$15;
				goto label$236;
			}
			label$245:;
