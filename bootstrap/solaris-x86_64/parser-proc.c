				...
				{
					{
						...
						if( TMP$104$6 != 3ll ) goto label$159;
						label$160:;
						{
...
$21FB_PROC_RETURN_METHOD CPROCRETURNMETHOD( $11FB_DATATYPE DTYPE$1 )
{
	...
	label$181:;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$105$1 * 56ll)) == 1ll ) goto label$169;
	{
...
$11FB_FUNCMODE CPROCCALLINGCONV( $11FB_FUNCMODE DEFAULT$1 )
{
	...
	label$184:;
	{
		...
		label$191:;
		{
			{
				uint64 TMP$109$4;
				TMP$109$4 = *(uint64*)((uint8*)&PARSER$ + 200ll);
				goto label$193;
				label$194:;
				{
				...
				if( TMP$109$4 > 6ull ) goto label$192;
				goto *tmp$110[TMP$109$4 - 0ull];
				label$192:;
			}
		}
		goto label$186;
		...
		if( (TMP$108$2 - 381ull) > 2ull ) goto label$191;
		goto *tmp$111[TMP$108$2 - 381ull];
		label$186:;
	}
	label$183:;
	return fb$result$1;
...
struct $8FBSYMBOL* CPROCHEADER( $13FB_SYMBATTRIB ATTRIB$1, $13FB_PROCATTRIB PATTRIB$1, int64* IS_NESTED$1, $10FB_PROCOPT OPTIONS$1, int64 TK$1 )
{
	...
	label$436:;
	{
		...
		label$455:;
		{
			...
			label$463:;
			{
				...
				if( (TMP$133$4 - 18ull) > 3ull ) goto label$476;
	...
	*($13FB_PROCATTRIB*)((uint8*)PROC$1 + 16ll) = PATTRIB$1;
	CPARAMETERS( PARENT$1, PROC$1, MODE$1, (int64)-((OPTIONS$1 & 1ll) != 0ll) );
	{
		...
		label$535:;
		{
			if( IS_MEMBERPROC$1 == 0ll ) goto label$543;
			{
				...
				TMP$134$4 = -1ll;
				label$654:;
				if( TMP$134$4 == 0ll ) goto label$546;
				{
					PATTRIB$1 = PATTRIB$1 | 1ll;
				}
				label$546:;
	...
	label$557:;
	{
		...
		TMP$135$2 = vr$141;
		if( TMP$135$2 == 347ll ) goto label$574;
		label$575:;
		if( TMP$135$2 != 348ll ) goto label$573;
		label$574:;
		{
			...
			{
				if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 16ll) == 8ll ) goto label$584;
				{
		...
		{
			{
				...
				label$622:;
				{
					...
					TMP$136$5 = 0ll;
					label$655:;
					struct $8FBSYMBOL* vr$187 = SYMBFINDOVERLOADPROC( HEAD_PROC$1, PROC$1, TMP$136$5 );
					HEAD_PROC$1 = vr$187;
				}
				label$624:;
				label$619:;
...
void CPROCSTMTBEGIN( $13FB_SYMBATTRIB ATTRIB$1, $13FB_PROCATTRIB PATTRIB$1 )
{
	...
	TKN$1 = vr$5;
	{
		...
		if( (TMP$139$2 - 345ull) > 5ull ) goto label$697;
	...
	{
		{
			...
			if( TMP$141$3 != 345ll ) goto label$713;
			label$714:;
			{
			...
			goto label$712;
			label$713:;
			if( TMP$141$3 != 346ll ) goto label$715;
			label$716:;
			{
			...
			goto label$712;
			label$715:;
			if( TMP$141$3 != 347ll ) goto label$717;
			label$718:;
			{
			...
			goto label$712;
			label$717:;
			if( TMP$141$3 != 348ll ) goto label$719;
			label$720:;
			{
			...
			goto label$712;
			label$719:;
			if( TMP$141$3 != 349ll ) goto label$721;
			label$722:;
			{
			...
			goto label$712;
			label$721:;
			if( TMP$141$3 != 350ll ) goto label$723;
			label$724:;
			{
	...
	fb$result$1 = 0ll;
	{
		...
		label$104:;
		{
			if( (*(int64*)((uint8*)&ENV$ + 1248ll) & 524288ll) == 0ll ) goto label$106;
			{
				...
				{
					if( *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 4144ll) <= 0ll ) goto label$110;
					{
...
static struct $8FBSYMBOL* HGETID( struct $8FBSYMBOL* PARENT$1, uint8* ID$1, int64* DTYPE$1, int64 IS_SUB$1 )
{
	...
	*DTYPE$1 = *(int64*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16712ll) + 16ll);
...
static int64 HCHECKOPOVLPARAMS( struct $8FBSYMBOL* PARENT$1, int64 OP$1, struct $8FBSYMBOL* PROC$1 )
{
	...
	{
		uint64 TMP$114$2;
		TMP$114$2 = *(uint64*)((uint8*)AST_OPTB$ + (OP$1 << (5ll & 63ll)));
		goto label$223;
		label$224:;
		{
			int64 TMP$115$3;
		...
		if( (TMP$114$2 - 2ull) > 12ull ) goto label$233;
	...
	if( PARAMS$1 <= 0ll ) goto label$239;
	{
		...
		{
			uint64 TMP$118$3;
			TMP$118$3 = *(uint64*)((uint8*)AST_OPTB$ + (OP$1 << (5ll & 63ll)));
			goto label$245;
			label$246:;
			{
				{
					...
					if( TMP$119$5 == 20ll ) goto label$249;
					label$250:;
					if( TMP$119$5 != 10ll ) goto label$248;
					label$249:;
					{
					}
					goto label$247;
			...
			label$252:;
			{
				if( PARAMS$1 <= 1ll ) goto label$254;
				{
					...
					label$257:;
					{
						...
						if( TMP$120$6 == 20ll ) goto label$261;
						label$262:;
						if( TMP$120$6 != 10ll ) goto label$260;
						label$261:;
						{
						}
						goto label$259;
						...
						{
							{
								...
								if( TMP$121$8 == 20ll ) goto label$266;
								label$267:;
								if( TMP$121$8 != 10ll ) goto label$265;
								label$266:;
								{
								}
								goto label$264;
			...
			{
				{
					...
					label$272:;
					{
						...
						label$739:;
						if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$122$6 * 56ll)) != 0ll ) goto label$276;
						{
							int64 IS_INTEGER$7;
							IS_INTEGER$7 = -1ll;
							...
							label$277:;
							{
								...
								if( TMP$123$8 == 4ll ) goto label$281;
								label$282:;
								if( TMP$123$8 != 7ll ) goto label$280;
								label$281:;
								{
									IS_INTEGER$7 = 0ll;
								}
					...
					label$271:;
					{
						...
						label$740:;
						if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$124$6 * 56ll)) != 0ll ) goto label$288;
						{
			...
			{
				{
					...
					label$294:;
					{
						if( PARAMS$1 <= 1ll ) goto label$296;
						{
							...
							label$299:;
							{
								...
								if( TMP$126$8 == 20ll ) goto label$303;
								label$304:;
								if( TMP$126$8 != 10ll ) goto label$302;
								label$303:;
								{
								}
								goto label$301;
								...
								{
									{
										...
										if( TMP$127$10 == 20ll ) goto label$308;
										label$309:;
										if( TMP$127$10 != 10ll ) goto label$307;
										label$308:;
										{
										}
										goto label$306;
					...
					if( (TMP$125$5 - 24ull) > 26ull ) goto label$326;
			...
			if( (TMP$118$3 - 3ull) > 11ull ) goto label$244;
	...
	FOUND_MISMATCH$1 = 0ll;
	{
		...
		TMP$128$2 = *($13AST_NODECLASS*)((uint8*)AST_OPTB$ + (OP$1 << (5ll & 63ll)));
		if( TMP$128$2 != 5ll ) goto label$328;
		label$329:;
		{
		...
		goto label$327;
		label$328:;
		if( TMP$128$2 != 4ll ) goto label$332;
		label$333:;
		{
			FOUND_MISMATCH$1 = (int64)-((*(int64*)((uint8*)PROC$1 + 56ll) & 511ll) == 0ll);
		}
		goto label$327;
		label$332:;
		if( TMP$128$2 != 2ll ) goto label$334;
		label$335:;
		{
			FOUND_MISMATCH$1 = (int64)-((*(int64*)((uint8*)PROC$1 + 56ll) & 511ll) != 0ll);
		}
		goto label$327;
		label$334:;
		if( TMP$128$2 != 6ll ) goto label$336;
		label$337:;
		{
			{
		...
		goto label$327;
		label$336:;
		if( TMP$128$2 != 12ll ) goto label$344;
		label$345:;
		{
			{
		...
		goto label$327;
		label$344:;
		if( TMP$128$2 != 3ll ) goto label$351;
		label$352:;
		{
			{
				uint64 TMP$129$4;
				...
				if( (TMP$129$4 - 23ull) > 27ull ) goto label$357;
		...
		goto label$327;
		label$351:;
		if( TMP$128$2 != 14ll ) goto label$360;
		label$361:;
		{
...
static int64 HCHECKISSELFCLONEBYVAL( struct $8FBSYMBOL* PARENT$1, struct $8FBSYMBOL* PROC$1, int64 OPTIONS$1 )
{
	...
	label$741:;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$130$1 * 56ll)) != 0ll ) goto label$382;
	{
