...
static struct $8FBARRAY1IP8FBSYMBOLE tmp$84$ = { (struct $8FBSYMBOL**)RTLLOOKUPTB$, (struct $8FBSYMBOL**)RTLLOOKUPTB$, 2928ll, 8ll, 1ll, 49ll, { { 366ll, 0ll, 365ll } } };
				...
				{
					{
						...
						TMP$86$6 = (struct $15FB_RTL_PARAMDEF*)((uint8*)((uint8*)PROCDEF$1 + (I$4 * 40ll)) + 56ll);
						...
						{
							{
								...
								label$47:;
								{
									...
									INNER_PROC$9 = vr$34;
									{
										...
										label$51:;
										{
											I$4 = I$4 + 1ll;
											{
												...
												TMP$89$12 = (struct $15FB_RTL_PARAMDEF*)((uint8*)((uint8*)PROCDEF$1 + (I$4 * 40ll)) + 56ll);
									...
									I$4 = I$4 + 1ll;
									{
										...
										TMP$92$10 = (struct $15FB_RTL_PARAMDEF*)((uint8*)((uint8*)PROCDEF$1 + (I$4 * 40ll)) + 56ll);
										struct $8FBSYMBOL* vr$62 = SYMBADDPROCPTR( INNER_PROC$9, *(int64*)TMP$92$10, (struct $8FBSYMBOL*)0ull, 0ll, 0ll, *(int64*)((uint8*)&ENV$ + 504ll) );
										SUBTYPE$6 = vr$62;
									}
