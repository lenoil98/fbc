		...
		label$95:;
		{
			...
			label$108:;
			{
				...
				SUBTYPE$1 = *(struct $8FBSYMBOL**)((uint8*)FLD$2 + 64ll);
				{
					...
					label$120:;
					TMP$101$5 = TMP$100$5;
					if( TMP$101$5 != 20ll ) goto label$111;
					label$112:;
					{
			...
			if( (TMP$99$3 - 1ull) > 11ull ) goto label$119;
			...
			{
				{
					...
					if( TMP$104$5 == 7ll ) goto label$133;
					label$134:;
					if( TMP$104$5 == 4ll ) goto label$133;
					label$135:;
					if( TMP$104$5 == 17ll ) goto label$133;
					label$136:;
					if( TMP$104$5 != 18ll ) goto label$132;
					label$133:;
					{
						*IS_FIXLENSTR$1 = -1ll;
...
struct $7ASTNODE* CMEMBERDEREF( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, struct $7ASTNODE* VAREXPR$1, int64 CHECK_ARRAY$1 )
{
	...
	label$162:;
	{
		IDXEXPR$1 = (struct $7ASTNODE*)0ull;
		{
			...
			TMP$108$3 = vr$1;
			if( TMP$108$3 != 398ll ) goto label$166;
			label$167:;
			{
				DEREFCNT$1 = 0ll;
				if( (DTYPE$1 & 480ll) == 0ll ) goto label$169;
				{
					...
					DTYPE$1 = (((DTYPE$1 & 31ll) | ((DTYPE$1 & 480ll) + -32ll)) | (((DTYPE$1 & 261632ll) >> (1ll & 63ll)) & 261632ll)) | (DTYPE$1 & 32505856ll);
					{
						...
						if( TMP$109$6 == 0ll ) goto label$172;
						label$173:;
						if( TMP$109$6 != 23ll ) goto label$171;
						label$172:;
						{
						...
						goto label$170;
						label$171:;
						if( TMP$109$6 != 20ll ) goto label$174;
						label$175:;
						{
						}
						goto label$170;
			...
			goto label$165;
			label$166:;
			if( TMP$108$3 != 91ll ) goto label$195;
			label$196:;
			{
				LEXSKIPTOKEN( 0ll );
				...
				label$197:;
				{
					...
					if( TMP$110$5 == 17ll ) goto label$201;
					label$202:;
					if( TMP$110$5 == 18ll ) goto label$201;
					label$203:;
					if( TMP$110$5 == 4ll ) goto label$201;
					label$204:;
					if( TMP$110$5 != 7ll ) goto label$200;
					label$201:;
					{
					...
					goto label$199;
					label$200:;
					if( TMP$110$5 != 20ll ) goto label$205;
					label$206:;
					{
					...
					{
						{
							...
							if( TMP$111$7 == 0ll ) goto label$220;
							label$221:;
							if( TMP$111$7 != 23ll ) goto label$219;
							label$220:;
							{
								ERRREPORT( 71ll, -1ll, (uint8*)0ull );
								DTYPE$1 = 40ll;
...
struct $7ASTNODE* CVARIABLE( struct $10FBSYMCHAIN* CHAIN_$1, int64 CHECK_ARRAY$1 )
{
	...
	label$391:;
	{
		...
		TMP$113$2 = vr$1;
		if( TMP$113$2 == 0ll ) goto label$395;
		label$396:;
		if( TMP$113$2 != 2ll ) goto label$394;
		label$395:;
		{
...
struct $7ASTNODE* CVARORDEREF( $13FB_VAREXPROPT OPTIONS$1 )
{
	...
	if( EXPR$1 == (struct $7ASTNODE*)0ull ) goto label$425;
	{
		...
		COMPLAIN$2 = -1ll;
		{
			...
			if( (TMP$114$3 - 9ull) > 16ull ) goto label$428;
			...
			{
				{
					...
					goto label$83;
					label$84:;
					static const void* tmp$117[12ll] = {
						&&label$85,
						&&label$85,
						&&label$88,
						&&label$89,
					...
					if( (TMP$97$5 - 1ull) > 11ull ) goto label$89;
					goto *tmp$117[TMP$97$5 - 1ull];
					label$83:;
				}
				fb$result$1 = SYM$2;
				goto label$59;
...
static struct $7ASTNODE* HSTRINDEXING( int64 DTYPE$1, struct $7ASTNODE* VAREXPR$1, struct $7ASTNODE* IDXEXPR$1 )
{
	...
	label$435:;
	if( TMP$105$1 != 17ll ) goto label$147;
	{
	...
	label$436:;
	if( TMP$106$1 != 7ll ) goto label$150;
	{
	...
	label$437:;
	if( TMP$107$1 != 7ll ) goto label$155;
	{
