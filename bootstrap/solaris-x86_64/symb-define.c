...
void SYMBDEFINEINIT( int64 ISMAIN$1 )
{
		...
		label$291:;
		{
			...
			if( *(uint8**)(((uint8*)DEFTB$ + (I$2 << (5ll & 63ll))) + 8ll) == (uint8*)0ull ) goto label$293;
			{
				if( (*(int64*)(((uint8*)DEFTB$ + (I$2 << (5ll & 63ll))) + 16ll) & 1ll) == 0ll ) goto label$295;
				{
					...
					FBSTRING* vr$12 = fb_StrConcat( &TMP$193$5, (void*)"\x22", 2ll, (void*)&VALUE$1, -1ll );
					__builtin_memset( &TMP$194$5, 0, 24ll );
					FBSTRING* vr$15 = fb_StrConcat( &TMP$194$5, (void*)vr$12, -1ll, (void*)"\x22", 2ll );
			...
			SYMBADDDEFINE( *(uint8**)((uint8*)DEFTB$ + (I$2 << (5ll & 63ll))), (uint8*)*(uint8**)&VALUE$1, vr$20, 0ll, *(tmp$27*)(((uint8*)DEFTB$ + (I$2 << (5ll & 63ll))) + 24ll), *($15FB_DEFINE_FLAGS*)(((uint8*)DEFTB$ + (I$2 << (5ll & 63ll))) + 16ll) );
		}
		label$289:;
		I$2 = I$2 + 1ll;
		label$288:;
	...
	FBSTRING* vr$28 = fb_StrConcat( &TMP$197$1, (void*)"__FB_", 6ll, (void*)vr$25, -1ll );
	__builtin_memset( &TMP$198$1, 0, 24ll );
	FBSTRING* vr$31 = fb_StrConcat( &TMP$198$1, (void*)vr$28, -1ll, (void*)"__", 3ll );
	fb_StrAssign( (void*)&TMP$199$1, -1ll, (void*)vr$31, -1ll, 0 );
	SYMBADDDEFINE( (uint8*)*(uint8**)&TMP$199$1, (uint8*)0ull, 0ll, 0ll, (tmp$27)0ull, 0ll );
	...
	label$300:;
	{
		...
		TMP$204$2 = vr$36;
		if( TMP$204$2 == 2ll ) goto label$304;
		label$305:;
		if( TMP$204$2 != 3ll ) goto label$303;
		label$304:;
		{
		...
		goto label$302;
		label$303:;
		if( TMP$204$2 == 0ll ) goto label$307;
		label$308:;
		if( TMP$204$2 != 1ll ) goto label$306;
		label$307:;
		{
		...
		goto label$302;
		label$306:;
		if( TMP$204$2 == 4ll ) goto label$310;
		label$311:;
		if( TMP$204$2 != 5ll ) goto label$309;
		label$310:;
		{
	...
	SYMBADDDEFINE( (uint8*)"__FB_VECTORIZE__", (uint8*)*(uint8**)&VALUE$1, vr$40, 0ll, (tmp$27)0ull, 0ll );
	...
	HASHINIT( (struct $5THASH*)((uint8*)&SYMB$ + 197504ll), 32ll, 0ll );
	{
		...
		label$319:;
		{
			...
			LASTPARAM$3 = FIRSTPARAM$3;
			{
				...
				J$4 = 1ll;
				int64 TMP$212$4;
				TMP$212$4 = *(int64*)(((uint8*)MACROTB$ + (I$2 * 80ll)) + 32ll) + -1ll;
				goto label$320;
				label$323:;
				{
			...
			SYM$3 = vr$56;
			*(tmp$28*)((uint8*)SYM$3 + 136ll) = *(tmp$28*)(((uint8*)MACROTB$ + (I$2 * 80ll)) + 16ll);
			*(tmp$29*)((uint8*)SYM$3 + 144ll) = *(tmp$29*)(((uint8*)MACROTB$ + (I$2 * 80ll)) + 24ll);
		}
		label$317:;
		I$2 = I$2 + 1ll;
		label$316:;
	...
	*($14FB_DEFTOK_TYPE*)T$1 = DTYPE$1;
	{
		...
		goto label$358;
		label$359:;
		static const void* tmp$215[2ll] = {
			&&label$360,
			&&label$361,
		};
		if( (TMP$214$2 - 2ull) > 1ull ) goto label$358;
		goto *tmp$215[TMP$214$2 - 2ull];
		label$358:;
	}
	fb$result$1 = T$1;
	label$355:;
...
struct $9FB_DEFTOK* SYMBDELDEFINETOK( struct $9FB_DEFTOK* TOK$1 )
{
	...
	label$364:;
	{
		...
		if( TMP$216$2 != 2ll ) goto label$367;
		label$368:;
		{
		...
		goto label$366;
		label$367:;
		if( TMP$216$2 != 3ll ) goto label$371;
		label$372:;
		{
			if( *(uint32**)((uint8*)TOK$1 + 8ll) == (uint32*)0ull ) goto label$374;
			{
				free( *(void**)((uint8*)TOK$1 + 8ll) );
			}
			label$374:;
...
int64 SYMBDELDEFINE( struct $8FBSYMBOL* S$1 )
{
	...
	if( *(int64*)((uint8*)S$1 + 96ll) != 0ll ) goto label$390;
	{
		...
		label$392:;
		{
			if( *(uint32**)((uint8*)S$1 + 112ll) == (uint32*)0ull ) goto label$396;
			{
				free( *(void**)((uint8*)S$1 + 112ll) );
			}
			label$396:;
...
static FBSTRING* HDEFLINE_CB( void )
{
	...
	__builtin_memset( &fb$result$1, 0, 24ll );
	label$19:;
	FBSTRING* vr$2 = fb_LongintToStr( *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16744ll) );
...
static FBSTRING* HDEFDATEISO_CB( void )
{
	...
	fb_StrAssign( (void*)&TMP$96$1, -1ll, (void*)"yyyy-mm-dd", 11ll, 0 );
	double vr$4 = fb_Now(  );
...
static FBSTRING* HDEFFPMODE_CB( void )
{
	...
	label$85:;
	{
		...
		TMP$100$2 = vr$1;
		if( TMP$100$2 != 0ll ) goto label$88;
		label$89:;
		{
		...
		goto label$87;
		label$88:;
		if( TMP$100$2 != 1ll ) goto label$90;
		label$91:;
		{
...
static FBSTRING* HDEFASM_CB( void )
{
	...
	label$95:;
	{
		...
		TMP$103$2 = *($12FB_ASMSYNTAX*)((uint8*)&ENV$ + 264ll);
		if( TMP$103$2 != 0ll ) goto label$98;
		label$99:;
		{
		...
		goto label$97;
		label$98:;
		if( TMP$103$2 != 1ll ) goto label$100;
		label$101:;
		{
...
static uint8* HMACRO_GETARGZ( struct $11LEXPP_ARGTB* ARGTB$1, int64 NUM$1 )
{
	...
	label$105:;
	{
		...
		if( DT$2 != (uint32*)0ull ) goto label$109;
		{
			fb$result$1 = (uint8*)0ull;
			goto label$103;
		}
...
static uint32* HMACRO_GETARGW( struct $11LEXPP_ARGTB* ARGTB$1, int64 NUM$1 )
{
	...
	label$113:;
	{
		uint32* DT$2;
		DT$2 = *(uint32**)((uint8*)ARGTB$1 + (NUM$1 * 24ll));
		if( DT$2 != (uint32*)0ull ) goto label$117;
		{
			fb$result$1 = (uint32*)0ull;
			goto label$111;
		}
...
static FBSTRING* HDEFARGEXTRACT_CB( struct $11LEXPP_ARGTB* ARGTB$1, int64* ERRNUM$1 )
{
	...
	if( NUMSTR$1 == (uint8*)0ull ) goto label$159;
	{
		...
		ZEROVAL$2 = 48u;
		{
			I$2 = 0;
			int32 TMP$106$3;
			TMP$106$3 = (int32)((int64)NUMARGLEN$2 + -1ll);
			goto label$160;
			label$163:;
			{
				int64 TMP$108$4;
				if( (uint64)(int64)*(uint8*)((uint8*)NUMSTR$1 + (int64)I$2) > 57ull ) goto label$164;
				TMP$108$4 = (int64)-((uint64)(int64)*(uint8*)((uint8*)NUMSTR$1 + (int64)I$2) >= 48ull);
				goto label$397;
				label$164:;
				TMP$108$4 = 0ll;
				label$397:;
				if( ~TMP$108$4 == 0ll ) goto label$166;
				{
					goto label$162;
				}
				label$166:;
			...
			label$160:;
			if( (int64)I$2 <= (int64)TMP$106$3 ) goto label$163;
			label$162:;
		}
		if( (int64)I$2 != (int64)NUMARGLEN$2 ) goto label$168;
		{
			...
			if( (int64)INDEX$2 >= (int64)NUMVARARGS$3 ) goto label$170;
			{
				...
				*(int64*)((uint8*)&VARARGS$4 + 40ll) = 8ll;
				...
				fb_StrAssign( (void*)&TMP$111$4, -1ll, (void*)",", 2ll, 0 );
				__builtin_memset( &TMP$109$4, 0, 24ll );
				fb_StrAssign( (void*)&TMP$109$4, -1ll, (void*)ARGSTRING$4, 0ll, 0 );
...
static FBSTRING* HDEFJOINZ_CB( struct $11LEXPP_ARGTB* ARGTB$1, int64* ERRNUM$1 )
{
	...
	if( ((int64)-(L$1 != (uint8*)0ull) & (int64)-(R$1 != (uint8*)0ull)) == 0ll ) goto label$230;
	{
		...
		FBSTRING* vr$9 = fb_StrConcat( &TMP$117$2, (void*)L$1, 0ll, (void*)R$1, 0ll );
...
static uint32* HDEFJOINW_CB( struct $11LEXPP_ARGTB* ARGTB$1, int64* ERRNUM$1 )
{
	...
	static struct $8DWSTRING RES$1;
	DWSTRASSIGN( &RES$1, (uint32*)0ull );
	if( ((int64)-(L$1 != (uint32*)0ull) & (int64)-(R$1 != (uint32*)0ull)) == 0ll ) goto label$238;
	{
...
static uint32* HDEFQUOTEW_CB( struct $11LEXPP_ARGTB* ARGTB$1, int64* ERRNUM$1 )
{
	...
	static struct $8DWSTRING RES$1;
	DWSTRASSIGN( &RES$1, (uint32*)0ull );
	if( ARG$1 == (uint32*)0ull ) goto label$248;
	{
...
static FBSTRING* HDEFUNQUOTEZ_CB( struct $11LEXPP_ARGTB* ARGTB$1, int64* ERRNUM$1 )
{
	...
	if( ARG$1 == (uint8*)0ull ) goto label$252;
	{
		...
		TMP$125$2 = (int64)-((((int64)-((uint64)(int64)*ARG$1 == 36ull) & (int64)-((uint64)(int64)*(uint8*)((uint8*)ARG$1 + 1ll) == 34ull)) & (int64)-((uint64)(int64)*(uint8*)((uint8*)((uint8*)ARG$1 + LENGTH$2) + -1ll) == 34ull)) != 0ll);
		goto label$398;
		label$253:;
		TMP$125$2 = 0ll;
		label$398:;
		if( TMP$125$2 == 0ll ) goto label$255;
		{
			FBSTRING TMP$126$3;
			...
			fb_StrAssign( (void*)&TMP$126$3, -1ll, (void*)vr$19, -1ll, 0 );
		...
		TMP$127$2 = (int64)-(((int64)-((uint64)(int64)*ARG$1 == 34ull) & (int64)-((uint64)(int64)*(uint8*)((uint8*)((uint8*)ARG$1 + LENGTH$2) + -1ll) == 34ull)) != 0ll);
		goto label$399;
		label$257:;
		TMP$127$2 = 0ll;
		label$399:;
		if( TMP$127$2 == 0ll ) goto label$256;
		{
			FBSTRING TMP$128$3;
			...
			fb_StrAssign( (void*)&TMP$128$3, -1ll, (void*)vr$35, -1ll, 0 );
...
static uint32* HDEFUNQUOTEW_CB( struct $11LEXPP_ARGTB* ARGTB$1, int64* ERRNUM$1 )
{
	...
	static struct $8DWSTRING RES$1;
	DWSTRASSIGN( &RES$1, (uint32*)0ull );
	if( ARG$1 == (uint32*)0ull ) goto label$263;
	{
		int64 TMP$129$2;
		int64 TMP$131$2;
		int64 LENGTH$2;
		...
		TMP$129$2 = (int64)-((((int64)-((uint64)(int64)*ARG$1 == 36ull) & (int64)-((uint64)(int64)*(uint32*)((uint8*)ARG$1 + 4ll) == 34ull)) & (int64)-((uint64)(int64)*(uint32*)((uint8*)((uint8*)ARG$1 + (LENGTH$2 << (2ll & 63ll))) + -4ll) == 34ull)) != 0ll);
		goto label$400;
		label$264:;
		TMP$129$2 = 0ll;
		label$400:;
		if( TMP$129$2 == 0ll ) goto label$266;
		{
			uint32* TMP$130$3;
			uint32* vr$17 = fb_WstrMid( (uint32*)ARG$1, 3ll, LENGTH$2 + -3ll );
			TMP$130$3 = vr$17;
			uint32* vr$18 = HREPLACEW( TMP$130$3, (uint32*)L"\x00000022\x00000022", (uint32*)L"\x00000022" );
			DWSTRASSIGN( &RES$1, vr$18 );
			fb_WstrDelete( (uint32*)TMP$130$3 );
		}
		goto label$265;
		label$266:;
		if( LENGTH$2 < 2ll ) goto label$268;
		TMP$131$2 = (int64)-(((int64)-((uint64)(int64)*ARG$1 == 34ull) & (int64)-((uint64)(int64)*(uint32*)((uint8*)((uint8*)ARG$1 + (LENGTH$2 << (2ll & 63ll))) + -4ll) == 34ull)) != 0ll);
		goto label$401;
		label$268:;
		TMP$131$2 = 0ll;
		label$401:;
		if( TMP$131$2 == 0ll ) goto label$267;
		{
			uint32* TMP$132$3;
			uint32* vr$29 = fb_WstrMid( (uint32*)ARG$1, 2ll, LENGTH$2 + -2ll );
			TMP$132$3 = vr$29;
			uint32* vr$30 = HREPLACEW( TMP$132$3, (uint32*)L"\x00000022\x00000022", (uint32*)L"\x00000022" );
			DWSTRASSIGN( &RES$1, vr$30 );
...
static FBSTRING* HDEFEVAL_CB( struct $11LEXPP_ARGTB* ARGTB$1, int64* ERRNUM$1 )
{
	...
	if( ARG$1 == (uint8*)0ull ) goto label$272;
	{
		LEXPUSHCTX(  );
		LEXINIT( 0ll, -1ll );
		*(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16760ll) = *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16760ll) + 1ll;
		DZSTRASSIGN( (struct $8DZSTRING*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16800ll), ARG$1 );
		...
		*(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16784ll) = *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16784ll) + vr$11;
		DZSTRCONCATASSIGN( (struct $8DZSTRING*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16800ll), (uint8*)"\x0A" );
		*(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16792ll) = *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16800ll);
		*(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16784ll) = *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16784ll) + 1ll;
		...
		if( EXPR$2 == (struct $7ASTNODE*)0ull ) goto label$274;
		{
			...
			if( vr$27 == 0ll ) goto label$279;
			{
				...
				FBSTRING* vr$33 = fb_StrConcat( &TMP$135$4, (void*)"\x22", 2ll, (void*)vr$30, -1ll );
				__builtin_memset( &TMP$136$4, 0, 24ll );
				FBSTRING* vr$36 = fb_StrConcat( &TMP$136$4, (void*)vr$33, -1ll, (void*)"\x22", 2ll );
...
static void HRESETDEFHASH( void )
{
	...
	__builtin_memset( &I$1, 0, 8ll );
	{
		I$1 = 0ll;
		int64 TMP$213$2;
		TMP$213$2 = *(int64*)((uint8*)&SYMB$ + 197496ll) + -1ll;
		goto label$340;
		label$343:;
		{
