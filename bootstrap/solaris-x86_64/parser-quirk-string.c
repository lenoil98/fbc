...
struct $7ASTNODE* CCVXFUNCT( $8FB_TOKEN TK$1 )
{
	...
	TMP$112$1 = (int64)-(vr$1 != 0ll);
	goto label$224;
	label$141:;
	TMP$112$1 = 0ll;
	label$224:;
	if( TMP$112$1 == 0ll ) goto label$143;
	{
		int64 LGT$2;
	...
	IS_STR$1 = 0ll;
	{
		...
		if( TMP$113$2 != 4ll ) goto label$155;
		label$156:;
		{
		...
		goto label$154;
		label$155:;
		if( TMP$113$2 == 17ll ) goto label$158;
		label$159:;
		if( TMP$113$2 == 18ll ) goto label$158;
		label$160:;
		if( TMP$113$2 != 7ll ) goto label$157;
		label$158:;
		{
			IS_STR$1 = -1ll;
		}
	...
	$11FB_DATATYPE FUNCTYPE$1;
	{
		...
		if( (TMP$114$2 - 422ull) > 4ull ) goto label$170;
		goto *tmp$131[TMP$114$2 - 422ull];
		label$161:;
	}
	uint8* ZS$1;
	int64 ZSLEN$1;
	...
	TMP$115$1 = (int64)-(FUNCTYPE$1 == 5ll);
	goto label$225;
	label$173:;
	TMP$115$1 = -1ll;
	label$225:;
	if( TMP$115$1 == 0ll ) goto label$175;
	{
		int64 TMP$116$2;
		...
		goto label$226;
		label$176:;
		TMP$116$2 = FUNCTYPE$1 & 31ll;
		label$226:;
		if( ZSLEN$1 < *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$116$2 * 56ll)) + 8ll) ) goto label$178;
		{
			{
				...
				{
					{
						...
						goto label$227;
						label$185:;
						TMP$117$6 = FUNCTYPE$1 & 31ll;
						label$227:;
						TMP$118$6 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$117$6 * 56ll)) + 8ll);
						if( TMP$118$6 != 2ll ) goto label$187;
						label$188:;
						{
						...
						goto label$186;
						label$187:;
						if( TMP$118$6 != 4ll ) goto label$189;
						label$190:;
						{
				...
				{
					{
						...
						goto label$228;
						label$198:;
						TMP$121$6 = FUNCTYPE$1 & 31ll;
						label$228:;
						TMP$122$6 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$121$6 * 56ll)) + 8ll);
						if( TMP$122$6 != 2ll ) goto label$200;
						label$201:;
						{
						...
						goto label$199;
						label$200:;
						if( TMP$122$6 != 4ll ) goto label$202;
						label$203:;
						{
	...
	{
		{
			...
			label$210:;
			{
				...
				goto label$229;
				label$213:;
				TMP$128$4 = FUNCTYPE$1 & 31ll;
				label$229:;
				if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$128$4 * 56ll)) + 8ll) != 4ll ) goto label$215;
				{
...
struct $7ASTNODE* CMKXFUNCT( $8FB_TOKEN TK$1 )
{
	...
	int64 vr$1 = HMATCH( 301ll, 0ll );
	TMP$132$1 = (int64)-(vr$1 != 0ll);
	goto label$271;
	label$232:;
	TMP$132$1 = 0ll;
	label$271:;
	if( TMP$132$1 == 0ll ) goto label$234;
	{
		int64 LGT$2;
		struct $7ASTNODE* vr$3 = CGTINPARENSONLYEXPR(  );
		int64 vr$4 = CCONSTINTEXPR( vr$3, 8ll );
	...
	{
		{
				...
				{
					{
						...
						goto label$272;
						label$256:;
						TMP$137$6 = DTYPE$1 & 31ll;
						label$272:;
						TMP$138$6 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$137$6 * 56ll)) + 40ll);
						if( TMP$138$6 != 3ll ) goto label$258;
						label$259:;
						{
						...
						goto label$257;
						label$258:;
						if( TMP$138$6 != 5ll ) goto label$260;
						label$261:;
						{
						...
						goto label$257;
						label$260:;
						if( TMP$138$6 != 7ll ) goto label$262;
						label$263:;
						{
			...
			if( (TMP$133$3 - 428ull) > 4ull ) goto label$266;
			goto *tmp$142[TMP$133$3 - 428ull];
			label$247:;
		}
				...
				*(struct $7ASTNODE**)((uint8*)EXPRTB$1 + (I$1 << (3ll & 63ll))) = (struct $7ASTNODE*)0ull;
				...
				label$98:;
				{
					if( ((int64)-(V$1 < 32ll) | (int64)-(V$1 > 127ll)) == 0ll ) goto label$104;
					{
						...
						TMP$107$6 = vr$42;
						fb_WstrAssign( (uint32*)WS$1, 417ll, (uint32*)TMP$107$6 );
						...
						TMP$108$6 = vr$45;
						fb_WstrConcatAssign( (uint32*)WS$1, 417ll, (uint32*)TMP$108$6 );
...
static struct $7ASTNODE* CSTRASC( void )
{
	...
	if( LITSYM$1 == (struct $8FBSYMBOL*)0ull ) goto label$124;
	{
		...
		if( P$1 < 0ll ) goto label$134;
		{
			...
			{
				uint32* WS$4;
				uint32* vr$25 = HUNESCAPEW( *(uint32**)((uint8*)LITSYM$1 + 96ll) );
				WS$4 = vr$25;
				uint32 vr$26 = fb_WstrAsc( (uint32*)WS$4, P$1 );
