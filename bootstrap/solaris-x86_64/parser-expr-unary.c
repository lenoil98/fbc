...
struct $7ASTNODE* CSTRIDXORMEMBERDEREF( struct $7ASTNODE* EXPR$1 )
{
		...
		{
			{
				...
				goto label$48;
				label$49:;
				if( TMP$96$4 == 398ll ) goto label$54;
				label$55:;
	...
	if( (DTYPE$1 & 480ll) == 0ll ) goto label$57;
	{
		...
		ISFIELD$2 = 0ll;
		{
			...
			goto label$58;
			label$59:;
			if( TMP$97$3 == 398ll ) goto label$62;
			label$63:;
...
struct $7ASTNODE* CHIGHESTPRECEXPR( struct $8FBSYMBOL* BASE_PARENT$1, struct $10FBSYMCHAIN* CHAIN_$1 )
{
	...
	struct $7ASTNODE* EXPR$1;
	{
		...
		int64 vr$1 = LEXGETTOKEN( 0ll );
		TMP$99$2 = vr$1;
		if( TMP$99$2 != 64ll ) goto label$70;
		label$71:;
		{
		...
		goto label$69;
		label$70:;
		if( TMP$99$2 != 42ll ) goto label$72;
		label$73:;
		{
		...
		goto label$69;
		label$72:;
		if( TMP$99$2 != 40ll ) goto label$74;
		label$75:;
		{
			int64 IS_OPT$3;
		...
		{
			{
					...
					{
						{
							...
							int64 vr$13 = LEXGETTOKEN( 0ll );
							TMP$101$7 = vr$13;
							if( TMP$101$7 != 377ll ) goto label$89;
							label$90:;
							{
								FBSTRING TMP$102$8;
								__builtin_memset( &TMP$102$8, 0, 24ll );
								FBSTRING* vr$15 = PPTYPEOF(  );
								fb_StrAssign( (void*)&TMP$102$8, -1ll, (void*)vr$15, -1ll, 0 );
							...
							goto label$88;
							label$89:;
							if( TMP$101$7 != 315ll ) goto label$91;
							label$92:;
							{
				...
				if( (TMP$100$4 - 387ull) > 28ull ) goto label$85;
				goto *tmp$103[TMP$100$4 - 387ull];
				label$79:;
			}
		}
		label$78:;
...
struct $7ASTNODE* CADDROFEXPRESSION( void )
{
	...
	label$178:;
	{
		...
		label$202:;
		{
			...
			goto label$226;
			label$207:;
			TMP$111$3 = DTYPE$3 & 31ll;
			label$226:;
			if( TMP$111$3 != 20ll ) goto label$209;
			{
			...
			T$3 = vr$46;
			{
				...
				goto label$214;
				label$215:;
				static const void* tmp$114[20ll] = {
					&&label$216,
					&&label$216,
					&&label$216,
					&&label$216,
				...
				if( (TMP$112$4 - 17ull) > 19ull ) goto label$217;
				goto *tmp$114[TMP$112$4 - 17ull];
				label$214:;
			}
			{
		...
		if( (TMP$110$2 - 394ull) > 3ull ) goto label$188;
		goto *tmp$115[TMP$110$2 - 394ull];
		label$188:;
	}
...
static struct $7ASTNODE* HCAST( $11AST_CONVOPT OPTIONS$1 )
{
	...
	label$97:;
	{
		...
		goto label$102;
		label$103:;
		static const void* tmp$116[25ll] = {
			&&label$104,
			&&label$113,
			&&label$113,
			&&label$113,
		...
		if( TMP$107$2 > 24ull ) goto label$113;
		goto *tmp$116[TMP$107$2 - 0ull];
		label$102:;
	}
...
static struct $7ASTNODE* HPROCPTRBODY( struct $8FBSYMBOL* BASE_PARENT$1, struct $8FBSYMBOL* PROC$1 )
{
	...
	if( CALLBACK$1 == (tmp$33)0ull ) goto label$158;
	{
		(CALLBACK$1)( PROC$1 );
	}
	label$158:;
...
static struct $7ASTNODE* HVARPTRBODY( struct $8FBSYMBOL* BASE_PARENT$1, struct $10FBSYMCHAIN* CHAIN_$1 )
{
	...
	T$1 = vr$3;
	{
		...
		goto label$163;
		label$164:;
		static const void* tmp$117[27ll] = {
			&&label$165,
			&&label$169,
			&&label$169,
			&&label$169,
		...
		if( (TMP$108$2 - 10ull) > 26ull ) goto label$169;
		goto *tmp$117[TMP$108$2 - 10ull];
		label$163:;
	}
	{
