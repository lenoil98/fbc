...
static int64 HSCOPEDSWAP( void )
{
	...
	label$114:;
	USE_PUSHPOP$1 = USE_PUSHPOP$1 & (int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$94$1 * 56ll)) + 8ll) == *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$95$1 * 56ll)) + 8ll));
	...
	label$116:;
	USE_PUSHPOP$1 = USE_PUSHPOP$1 & (int64)-(*(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$96$1 * 56ll)) == *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$97$1 * 56ll)));
