	...
	{
		{
			...
			if( TMP$93$3 != 38ll ) goto label$91;
			label$92:;
			{
					...
					if( *(int64*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) != 12ll ) goto label$96;
					{
						if( *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 192ll) <= 0ll ) goto label$98;
						{
							if( *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 184ll) != 0ll ) goto label$100;
							{
								...
								struct $7ASTNODE* vr$19 = _Z19ASTBUILDDEREFADDROFP7ASTNODExlP8FBSYMBOLS2_( vr$18, *(int64*)((uint8*)N$1 + 40ll), *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), (struct $8FBSYMBOL*)0ull );
								L$1 = vr$19;
								if( (*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 56ll) & 480ll) == 0ll ) goto label$101;
								TMP$94$8 = 24ll;
								goto label$112;
								label$101:;
								TMP$94$8 = *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 56ll) & 31ll;
								label$112:;
								struct $7ASTNODE* vr$27 = ASTNEWCONSTI( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$94$8 * 56ll)) + 8ll), 8ll, (struct $8FBSYMBOL*)0ull );
				...
				struct $7ASTNODE* vr$35 = _Z19ASTBUILDDEREFADDROFP7ASTNODExlP8FBSYMBOLS2_( vr$34, *(int64*)((uint8*)N$1 + 40ll), *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) );
				L$1 = vr$35;
			...
			goto label$90;
			label$91:;
			if( TMP$93$3 != 37ll ) goto label$102;
			label$103:;
			{
				struct $7ASTNODE* vr$43 = ASTCLONETREE( TARGET$1 );
				struct $7ASTNODE* vr$44 = _Z19ASTBUILDDEREFADDROFP7ASTNODExlP8FBSYMBOLS2_( vr$43, *(int64*)((uint8*)N$1 + 40ll), *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), (struct $8FBSYMBOL*)0ull );
				L$1 = vr$44;
			...
			goto label$90;
			label$102:;
			if( TMP$93$3 != 39ll ) goto label$104;
			label$105:;
			{
				struct $7ASTNODE* vr$53 = ASTCLONETREE( TARGET$1 );
				struct $7ASTNODE* vr$54 = _Z19ASTBUILDDEREFADDROFP7ASTNODExlP8FBSYMBOLS2_( vr$53, *(int64*)((uint8*)N$1 + 40ll), *(int64*)((uint8*)N$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) );
				L$1 = vr$54;
			...
			goto label$90;
			label$104:;
			if( TMP$93$3 != 40ll ) goto label$106;
			label$107:;
			{
			...
			goto label$90;
			label$106:;
			if( TMP$93$3 == 41ll ) goto label$109;
			label$110:;
			if( TMP$93$3 != 42ll ) goto label$108;
			label$109:;
			{
			}
			goto label$90;
...
void ASTLOADSTATICINITIALIZER( struct $7ASTNODE* TREE$1, struct $8FBSYMBOL* BASESYM$1 )
{
	...
	if( N$1 == (struct $7ASTNODE*)0ull ) goto label$149;
	{
		NXT$1 = *(struct $7ASTNODE**)((uint8*)N$1 + 120ll);
		{
			...
			label$152:;
			{
				(*(tmp$66*)((uint8*)&IR$ + 408ll))( *(int64*)((uint8*)N$1 + 48ll) );
			}
			goto label$150;
			label$153:;
			{
				(*(tmp$67*)((uint8*)&IR$ + 416ll))( *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll), *(int64*)((uint8*)N$1 + 40ll) );
			}
			goto label$150;
			label$154:;
			{
			...
			if( (TMP$98$3 - 37ull) > 5ull ) goto label$155;
			goto *tmp$99[TMP$98$3 - 37ull];
			label$150:;
		}
		ASTDELNODE( N$1 );
		N$1 = NXT$1;
	...
	goto label$148;
	label$149:;
	(*(tmp$41*)((uint8*)&IR$ + 360ll))( BASESYM$1 );
	ASTDELNODE( TREE$1 );
	label$147:;
}
	...
	{
		{
			...
			if( TMP$104$3 != 38ll ) goto label$188;
			label$189:;
			{
			...
			goto label$187;
			label$188:;
			if( TMP$104$3 == 39ll ) goto label$193;
			label$194:;
			if( TMP$104$3 != 40ll ) goto label$192;
			label$193:;
			{
				fb$result$1 = 0ll;
				goto label$184;
...
static void HFLUSHEXPRSTATIC( struct $7ASTNODE* N$1, struct $8FBSYMBOL* BASESYM$1 )
{
	...
	if( LITSYM$1 != (struct $8FBSYMBOL*)0ull ) goto label$126;
	{
		...
		{
			(*(tmp$63*)((uint8*)&IR$ + 384ll))( SYM$1, *(struct $8FBSYMBOL**)((uint8*)EXPR$1 + 24ll), *(int64*)((uint8*)EXPR$1 + 40ll) );
		}
		goto label$127;
		label$128:;
		{
			{
				...
				if( LEXPR$4 == (struct $7ASTNODE*)0ull ) goto label$130;
				{
					...
					{
						(*(tmp$63*)((uint8*)&IR$ + 384ll))( SYM$1, *(struct $8FBSYMBOL**)((uint8*)LEXPR$4 + 24ll), *(int64*)((uint8*)LEXPR$4 + 40ll) );
			...
			if( EXPR$1 == (struct $7ASTNODE*)0ull ) goto label$134;
			{
				...
				goto label$231;
				label$137:;
				TMP$95$4 = SDTYPE$1 & 31ll;
				label$231:;
				if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$95$4 * 56ll)) != 1ll ) goto label$139;
				{
					(*(tmp$62*)((uint8*)&IR$ + 376ll))( SYM$1, *(double*)((uint8*)EXPR$1 + 40ll) );
				}
				goto label$138;
				label$139:;
				{
					(*(tmp$61*)((uint8*)&IR$ + 368ll))( SYM$1, *(int64*)((uint8*)EXPR$1 + 40ll) );
				}
				label$138:;
			}
			label$134:;
	...
	label$126:;
	{
		if( SDTYPE$1 == 7ll ) goto label$141;
		{
			...
			{
				(*(tmp$64*)((uint8*)&IR$ + 392ll))( *(int64*)((uint8*)SYM$1 + 80ll) + -1ll, *(uint8**)((uint8*)LITSYM$1 + 96ll), *(int64*)((uint8*)LITSYM$1 + 80ll) + -1ll );
			}
			goto label$142;
			label$143:;
			{
				FBSTRING TMP$96$4;
				__builtin_memset( &TMP$96$4, 0, 24ll );
				FBSTRING* vr$53 = fb_WstrToStr( (uint32*)*(uint32**)((uint8*)LITSYM$1 + 96ll) );
				fb_StrAssign( (void*)&TMP$96$4, -1ll, (void*)vr$53, -1ll, 0 );
				(*(tmp$64*)((uint8*)&IR$ + 392ll))( *(int64*)((uint8*)SYM$1 + 80ll) + -1ll, (uint8*)*(uint8**)&TMP$96$4, (*(int64*)((uint8*)LITSYM$1 + 80ll) / *(int64*)((uint8*)SYMB_DTYPETB$ + 400ll)) + -1ll );
		...
		label$141:;
		{
			if( EDTYPE$1 == 7ll ) goto label$145;
			{
				...
				TMP$97$4 = vr$61;
				(*(tmp$65*)((uint8*)&IR$ + 400ll))( (*(int64*)((uint8*)SYM$1 + 80ll) / *(int64*)((uint8*)SYMB_DTYPETB$ + 400ll)) + -1ll, TMP$97$4, *(int64*)((uint8*)LITSYM$1 + 80ll) + -1ll );
				fb_WstrDelete( (uint32*)TMP$97$4 );
			}
			goto label$144;
			label$145:;
			{
				(*(tmp$65*)((uint8*)&IR$ + 400ll))( (*(int64*)((uint8*)SYM$1 + 80ll) / *(int64*)((uint8*)SYMB_DTYPETB$ + 400ll)) + -1ll, *(uint32**)((uint8*)LITSYM$1 + 96ll), (*(int64*)((uint8*)LITSYM$1 + 80ll) / *(int64*)((uint8*)SYMB_DTYPETB$ + 400ll)) + -1ll );
			}
			label$144:;
		}
		label$140:;
...
static int64 HEXPRISCONST( struct $7ASTNODE* N$1 )
{
	...
	if( LSYM$1 == (struct $8FBSYMBOL*)0ull ) goto label$159;
	{
		...
		TMP$100$2 = (int64)-(*(int64*)((uint8*)LSYM$1 + 192ll) > 0ll);
		goto label$232;
		label$160:;
		TMP$100$2 = 0ll;
		label$232:;
		if( TMP$100$2 == 0ll ) goto label$162;
		{
	...
	EXPR$1 = *(struct $7ASTNODE**)((uint8*)N$1 + 112ll);
	{
		...
		if( TMP$101$2 == 23ll ) goto label$165;
		label$166:;
		if( TMP$101$2 != 16ll ) goto label$164;
		label$165:;
		{
			fb$result$1 = -1ll;
			goto label$157;
		...
		goto label$163;
		label$164:;
		if( TMP$101$2 != 5ll ) goto label$167;
		label$168:;
		{
			label$169:;
			...
			{
				{
					...
					if( TMP$102$5 != 5ll ) goto label$172;
					label$173:;
					{
					}
					goto label$171;
					label$172:;
					if( TMP$102$5 != 23ll ) goto label$174;
					label$175:;
					{
						fb$result$1 = -1ll;
						goto label$157;
	...
	{
		int64 TMP$103$2;
		TMP$103$2 = *(int64*)((uint8*)EXPR$1 + 8ll) & 511ll;
		if( TMP$103$2 == 4ll ) goto label$179;
		label$180:;
		if( TMP$103$2 != 7ll ) goto label$178;
		label$179:;
		{
