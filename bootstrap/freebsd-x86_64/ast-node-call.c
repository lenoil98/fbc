...
struct $6IRVREG* ASTLOADCALL( struct $7ASTNODE* N$1 )
{
	...
	if( ((int64)-(*(int64*)((uint8*)&ENV$ + 208ll) == 0ll) & (int64)-((*(int64*)((uint8*)&ENV$ + 520ll) & 32ll) != 0ll)) == 0ll ) goto label$33;
	{
		ARGBYTES$1 = 0ll;
		...
		if( ARG$1 == (struct $7ASTNODE*)0ull ) goto label$35;
		{
			...
			ARGBYTES$1 = ARGBYTES$1 + vr$12;
			ARG$1 = *(struct $7ASTNODE**)((uint8*)ARG$1 + 120ll);
		}
		goto label$34;
		label$35:;
		int64 vr$15 = SYMBPROCRETURNSONSTACK( PROC$1 );
		if( vr$15 == 0ll ) goto label$37;
		{
			ARGBYTES$1 = ARGBYTES$1 + *(int64*)((uint8*)&ENV$ + 544ll);
		}
		label$37:;
		label$36:;
		BYTESTOALIGN$1 = (-((TOTALSTACKBYTES$1 + ARGBYTES$1) & 15ll) + 16ll) & 15ll;
		if( BYTESTOALIGN$1 <= 0ll ) goto label$39;
		{
			if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$41;
			{
				(*(tmp$45*)((uint8*)&IR$ + 272ll))( BYTESTOALIGN$1 );
			}
			label$41:;
			label$40:;
	...
	ARG$1 = *(struct $7ASTNODE**)((uint8*)N$1 + 120ll);
	label$42:;
	if( ARG$1 == (struct $7ASTNODE*)0ull ) goto label$43;
	{
		NEXTARG$1 = *(struct $7ASTNODE**)((uint8*)ARG$1 + 120ll);
		L$1 = *(struct $7ASTNODE**)((uint8*)ARG$1 + 112ll);
		int64 vr$29 = SYMBCALCARGLEN( *(int64*)((uint8*)L$1 + 8ll), *(struct $8FBSYMBOL**)((uint8*)L$1 + 16ll), *(int64*)((uint8*)ARG$1 + 40ll) );
		ARGBYTES$1 = vr$29;
		if( *(int64*)((uint8*)PROC$1 + 152ll) != 3ll ) goto label$45;
		{
			BYTESTOPOP$1 = BYTESTOPOP$1 + ARGBYTES$1;
		}
		label$45:;
		label$44:;
		if( *(int64*)L$1 != 5ll ) goto label$47;
		{
			ASTUPDATECONVFD2FS( L$1, *(int64*)((uint8*)ARG$1 + 8ll), 0ll );
		}
		label$47:;
		label$46:;
		struct $6IRVREG* vr$34 = ASTLOAD( L$1 );
		V1$1 = vr$34;
		ASTDELNODE( L$1 );
		if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$49;
		{
			(*(tmp$47*)((uint8*)&IR$ + 168ll))( *(struct $8FBSYMBOL**)((uint8*)ARG$1 + 24ll), V1$1, *(int64*)((uint8*)ARG$1 + 48ll), RECLEVEL$1 );
		}
		label$49:;
		label$48:;
	...
	goto label$42;
	label$43:;
	int64 vr$38 = SYMBPROCRETURNSONSTACK( PROC$1 );
	if( vr$38 == 0ll ) goto label$51;
	{
		if( ((int64)-(*(int64*)((uint8*)PROC$1 + 152ll) == 3ll) & (int64)-((*(int64*)((uint8*)&ENV$ + 520ll) & 8ll) == 0ll)) == 0ll ) goto label$53;
		{
			BYTESTOPOP$1 = BYTESTOPOP$1 + *(int64*)((uint8*)&ENV$ + 544ll);
		}
		label$53:;
		label$52:;
		if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$55;
		{
			int64 vr$46 = SYMBHASCTOR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 80ll) );
			if( vr$46 != 0ll ) goto label$57;
			{
				struct $7ASTNODE* vr$48 = ASTBUILDTEMPVARCLEAR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 80ll) );
				ASTLOAD( vr$48 );
			}
			label$57:;
			label$56:;
			struct $7ASTNODE* vr$50 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 80ll), 0ll, 2147483648ll, (struct $8FBSYMBOL*)0ull );
			L$1 = vr$50;
			struct $7ASTNODE* vr$51 = ASTNEWADDROF( L$1 );
			L$1 = vr$51;
			struct $6IRVREG* vr$52 = ASTLOAD( L$1 );
			V1$1 = vr$52;
			(*(tmp$47*)((uint8*)&IR$ + 168ll))( (struct $8FBSYMBOL*)0ull, V1$1, 0ll, RECLEVEL$1 );
		}
		label$55:;
		label$54:;
		TOTALSTACKBYTES$1 = TOTALSTACKBYTES$1 + *(int64*)((uint8*)&ENV$ + 544ll);
	}
	label$51:;
	label$50:;
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$59;
	{
		if( (*(int64*)((uint8*)N$1 + 8ll) & 511ll) != 0ll ) goto label$61;
		{
		...
		label$61:;
		{
			if( ((*(int64*)((uint8*)N$1 + 8ll) & 32505856ll) >> (20ll & 63ll)) != 19ll ) goto label$63;
			{
			}
			goto label$62;
			label$63:;
			...
			label$62:;
			struct $6IRVREG* vr$61 = (*(tmp$69*)((uint8*)&IR$ + 456ll))( *(int64*)((uint8*)PROC$1 + 160ll), *(struct $8FBSYMBOL**)((uint8*)PROC$1 + 168ll) );
			VR$1 = vr$61;
			if( *(int64*)((uint8*)PROC$1 + 176ll) == 1ll ) goto label$65;
			{
	...
	if( L$1 == (struct $7ASTNODE*)0ull ) goto label$67;
	{
		struct $6IRVREG* vr$65 = ASTLOAD( L$1 );
		V1$1 = vr$65;
		ASTDELNODE( L$1 );
		if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$69;
		{
			(*(tmp$55*)((uint8*)&IR$ + 264ll))( PROC$1, V1$1, VR$1, BYTESTOPOP$1, RECLEVEL$1 );
		}
		label$69:;
		label$68:;
	}
	...
	label$67:;
	{
		if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$71;
		{
			(*(tmp$54*)((uint8*)&IR$ + 256ll))( PROC$1, BYTESTOPOP$1, VR$1, RECLEVEL$1 );
		}
		label$71:;
		label$70:;
	}
...
void ASTCLONECALL( struct $7ASTNODE* N$1, struct $7ASTNODE* C$1 )
{
	label$74:;
	{
		...
		*(struct $19AST_TMPSTRLIST_ITEM**)((uint8*)C$1 + 72ll) = (struct $19AST_TMPSTRLIST_ITEM*)0ull;
		...
		label$76:;
		if( SN$2 == (struct $19AST_TMPSTRLIST_ITEM*)0ull ) goto label$77;
		{
	...
	label$78:;
	if( N$1 == (struct $7ASTNODE*)0ull ) goto label$79;
	{
		if( *(struct $7ASTNODE**)((uint8*)N$1 + 120ll) != (struct $7ASTNODE*)0ull ) goto label$81;
		{
			goto label$79;
		}
		label$81:;
...
void ASTDELCALL( struct $7ASTNODE* N$1 )
{
	label$82:;
	{
		...
		label$84:;
		if( S$2 == (struct $19AST_TMPSTRLIST_ITEM*)0ull ) goto label$85;
		{
...
{
	label$86:;
	if( *(struct $8FBSYMBOL**)((uint8*)N$1 + 80ll) != OLD_SYM$1 ) goto label$89;
	{
	...
	label$88:;
	{
		...
		S$2 = *(struct $19AST_TMPSTRLIST_ITEM**)((uint8*)N$1 + 72ll);
		label$90:;
		if( S$2 == (struct $19AST_TMPSTRLIST_ITEM*)0ull ) goto label$91;
		{
...
struct $7ASTNODE* ASTBUILDBYREFRESULTDEREF( struct $7ASTNODE* EXPR$1 )
{
	...
	int64 DTYPE$1;
	struct $8FBSYMBOL* SUBTYPE$1;
	if( *(int64*)EXPR$1 == 9ll ) goto label$103;
	{
		fb$result$1 = EXPR$1;
		goto label$101;
	}
	label$103:;
	label$102:;
	if( (*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)EXPR$1 + 24ll) + 16ll) & 2048ll) != 0ll ) goto label$105;
	{
		fb$result$1 = EXPR$1;
		goto label$101;
	}
	...
	if( (DTYPE$1 & 31ll) != 23ll ) goto label$107;
	{
...
int64 ASTISBYREFRESULTDEREF( struct $7ASTNODE* EXPR$1 )
{
	...
	label$108:;
	fb$result$1 = 0ll;
	if( (struct $7ASTNODE*)(int64)-(*(int64*)EXPR$1 == 20ll) == (struct $7ASTNODE*)0ull ) goto label$110;
	TMP$84$1 = (int64)-(*(struct $7ASTNODE**)((uint8*)EXPR$1 + 112ll) != (struct $7ASTNODE*)0ull);
	goto label$115;
	label$110:;
	TMP$84$1 = 0ll;
	label$115:;
	if( TMP$84$1 == 0ll ) goto label$112;
	{
		if( *(int64*)*(struct $7ASTNODE**)((uint8*)EXPR$1 + 112ll) != 9ll ) goto label$114;
		{
...
struct $7ASTNODE* ASTIGNORECALLRESULT( struct $7ASTNODE* N$1 )
{
	...
	label$131:;
	label$130:;
	if( *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) == (struct $8FBSYMBOL*)0ull ) goto label$133;
	{
		if( (*(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll) + 24ll) & 64ll) == 0ll ) goto label$135;
		{
	...
	label$132:;
	{
		if( DTYPE$1 == 17ll ) goto label$138;
		label$139:;
		if( DTYPE$1 != 7ll ) goto label$137;
		label$138:;
		{
			if( DTYPE$1 != 7ll ) goto label$141;
			{
...
struct $7ASTNODE* ASTBUILDFAKECALL( struct $8FBSYMBOL* PROC$1 )
{
	...
	label$144:;
	if( PARAM$1 == (struct $8FBSYMBOL*)0ull ) goto label$145;
	{
