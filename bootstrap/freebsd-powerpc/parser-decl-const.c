...
static void HGETTYPE( int32* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1 )
{
	...
	if( vr$0 != 376 ) goto label$13;
	{
		...
		TMP$94$2 = 0;
		TMP$93$2 = 0ll;
		int32 vr$3 = CSYMBOLTYPE( DTYPE$1, SUBTYPE$1, &TMP$93$2, &TMP$94$2, 1 );
		...
		{
			int32 TMP$95$3;
			TMP$95$3 = *DTYPE$1 & 511;
			if( TMP$95$3 == 0 ) goto label$18;
			label$19:;
			if( TMP$95$3 == 18 ) goto label$18;
			label$20:;
			if( TMP$95$3 == 4 ) goto label$18;
			label$21:;
			if( TMP$95$3 == 7 ) goto label$18;
			label$22:;
			if( TMP$95$3 == 20 ) goto label$18;
			label$23:;
			if( TMP$95$3 != 23 ) goto label$17;
			label$18:;
			{
...
static void CCONSTASSIGN( int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, $13FB_SYMBATTRIB ATTRIB$1 )
{
	...
	CCURRENTPARENTID(  );
	{
		...
		label$28:;
		{
			if( (*(int32*)((uint8*)&ENV$ + 888) & 524288) == 0 ) goto label$30;
			{
				if( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 98536) == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 98352) ) goto label$32;
				{
					if( *(int32*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16548) + 4120) <= 0 ) goto label$34;
					{
		...
		label$35:;
		{
			...
			{
				if( (-(*(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 98536) == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 98352)) | -(*(uint32*)((uint8*)&PARSER$ + 96) > 0u)) == 0 ) goto label$39;
				{
		...
		if( TMP$96$2 > 5u ) goto label$43;
		goto *tmp$97[TMP$96$2 - 0u];
		label$26:;
	}
	...
	label$61:;
	{
		...
		{
			int32 vr$26 = ASTCHECKASSIGNTOTYPE( DTYPE$1, SUBTYPE$1, EXPR$1 );
