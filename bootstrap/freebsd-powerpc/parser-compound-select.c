...
void CSELECTSTMTBEGIN( void )
{
	...
	label$29:;
	{
		int32 TMP$96$2;
		{
			...
			label$47:;
			TMP$95$3 = TMP$94$3;
			if( TMP$95$3 == 18 ) goto label$33;
			label$34:;
			if( TMP$95$3 != 4 ) goto label$32;
			label$33:;
			{
				DTYPE$1 = 17;
			}
		...
		OPTIONS$1 = 0;
		if( (*(int32*)((uint8*)&ENV$ + 888) & 2) != 0 ) goto label$36;
		{
...
static void HCASEEXPRESSION( struct $9FBCASECTX* CASECTX$1, struct $8FBSYMBOL* SYM$1 )
{
	...
	*(struct $7ASTNODE**)((uint8*)CASECTX$1 + 8) = vr$7;
	if( *(struct $7ASTNODE**)((uint8*)CASECTX$1 + 8) != (struct $7ASTNODE*)0u ) goto label$55;
	{
		...
		goto label$120;
		label$56:;
		TMP$98$2 = *(int32*)((uint8*)SYM$1 + 28) & 511;
		label$120:;
		struct $7ASTNODE* vr$14 = ASTNEWCONSTZ( TMP$98$2, (struct $8FBSYMBOL*)0u );
