...
void CFORSTMTBEGIN( void )
{
	...
	label$162:;
	{
		...
		if( (TMP$99$2 - 1u) > 19u ) goto label$178;
		goto *tmp$101[TMP$99$2 - 1u];
		label$164:;
	}
	...
	*(struct $8FBSYMBOL**)((uint8*)STK$1 + 132) = EL$1;
	...
	label$182:;
	label$181:;
	if( ISCONST$1 != 3 ) goto label$184;
	{
		$6AST_OP TMP$100$2;
		struct $7ASTNODE* vr$52 = ASTNEWCONST( (union $7FBVALUE*)((uint8*)STK$1 + 56), *(int32*)((uint8*)STK$1 + 64), (struct $8FBSYMBOL*)0u );
		struct $7ASTNODE* vr$56 = ASTNEWCONST( (union $7FBVALUE*)((uint8*)STK$1 + 32), *(int32*)((uint8*)STK$1 + 40), (struct $8FBSYMBOL*)0u );
		if( *(int64*)((uint8*)STK$1 + 104) == 0ll ) goto label$185;
		TMP$100$2 = 50;
		goto label$188;
		label$185:;
		TMP$100$2 = 49;
		label$188:;
		struct $7ASTNODE* vr$58 = ASTNEWBOP( TMP$100$2, vr$56, vr$52, (struct $8FBSYMBOL*)0u, 1 );
		EXPR$1 = vr$58;
		int64 vr$59 = ASTCONSTFLUSHTOINT( EXPR$1, 8 );
		if( vr$59 != 0ll ) goto label$187;
		{
			struct $7ASTNODE* vr$60 = ASTNEWBRANCH( 98, EL$1, (struct $7ASTNODE*)0u );
			ASTADD( vr$60 );
		}
		label$187:;
		label$186:;
	...
	label$184:;
	{
		struct $7ASTNODE* vr$61 = ASTNEWBRANCH( 98, TL$1, (struct $7ASTNODE*)0u );
		ASTADD( vr$61 );
	}
	label$183:;
	struct $8FBSYMBOL* vr$62 = SYMBADDLABEL( (uint8*)0u, 4 );
	IL$1 = vr$62;
	struct $7ASTNODE* vr$63 = ASTNEWLABEL( IL$1, -1 );
	ASTADD( vr$63 );
	struct $7ASTNODE* vr$64 = ASTSCOPEBEGIN(  );
	*(struct $7ASTNODE**)((uint8*)STK$1 + 8) = vr$64;
...
void CFORSTMTEND( void )
{
	...
	label$225:;
	{
		...
		STK$1 = vr$0;
		if( STK$1 != (struct $13FB_CMPSTMTSTK*)0u ) goto label$229;
		{
			HSKIPUNTIL( -1, 0, 0, 0 );
			goto label$224;
		}
		...
		IDEXPR$2 = vr$4;
		if( IDEXPR$2 != (struct $7ASTNODE*)0u ) goto label$233;
		{
			ERRREPORT( 14, 0, (uint8*)0u );
		}
		goto label$232;
		label$233:;
		{
			if( *(struct $8FBSYMBOL**)((uint8*)IDEXPR$2 + 12) == *(struct $8FBSYMBOL**)((uint8*)STK$1 + 24) ) goto label$235;
			{
				ERRREPORT( 283, 0, (uint8*)0u );
			}
			label$235:;
			label$234:;
			if( (*(int32*)((uint8*)&ENV$ + 196) & 8) == 0 ) goto label$237;
			{
...
static void HSCALARNEXT( struct $13FB_CMPSTMTSTK* STK$1 )
{
	...
	if( *(struct $8FBSYMBOL**)((uint8*)STK$1 + 96) != (struct $8FBSYMBOL*)0u ) goto label$37;
	{
		...
		TMP$93$2 = 49;
		label$240:;
		HFLUSHBOP( TMP$93$2, (struct $17FB_CMPSTMT_FORELM*)((uint8*)STK$1 + 24), (struct $17FB_CMPSTMT_FORELM*)((uint8*)STK$1 + 48), *(struct $8FBSYMBOL**)((uint8*)STK$1 + 124) );
	}
	goto label$36;
	label$37:;
	{
...
static struct $8FBSYMBOL* HADDIMPLICITVAR( int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	int32 OPTIONS$1;
	OPTIONS$1 = 0;
	if( (*(int32*)((uint8*)&ENV$ + 888) & 2) != 0 ) goto label$42;
	{
...
static struct $8FBSYMBOL* HSTORETEMP( int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, struct $7ASTNODE* EXPR$1 )
{
	...
	int32 OPTIONS$1;
	OPTIONS$1 = 0;
	if( (*(int32*)((uint8*)&ENV$ + 888) & 2) != 0 ) goto label$48;
	{
		OPTIONS$1 = OPTIONS$1 | 2;
	}
	label$48:;
	...
	{
		{
			...
			label$57:;
			{
				ERRREPORT( 198, -1, *(uint8**)((uint8*)AST_OPTB$ + 8) );
			}
			goto label$54;
			label$55:;
			static const void* tmp$111[1] = {
				&&label$56,
			};
			if( (TMP$95$3 - 20u) > 0u ) goto label$57;
			goto *tmp$111[TMP$95$3 - 20u];
			label$54:;
		}
	}
	label$52:;
...
static void HFLUSHBOP( int32 OP$1, struct $17FB_CMPSTMT_FORELM* LHS$1, struct $17FB_CMPSTMT_FORELM* RHS$1, struct $8FBSYMBOL* EX$1 )
{
	...
	{
		ERRREPORT( 198, -1, *(uint8**)(((uint8*)AST_OPTB$ + (OP$1 << (4 & 31))) + 8) );
		goto label$59;
	}
	label$61:;
	label$60:;
	...
	*(int32*)((uint8*)STK$1 + 140) = 0;
	...
	if( (FLAGS$1 & 2) != 0 ) goto label$121;
	{
		...
		if( (FLAGS$1 & 1) != 0 ) goto label$127;
		{
			...
			goto label$242;
			label$128:;
			TMP$97$3 = *(int32*)((uint8*)EXPR$2 + 4) & 31;
			label$242:;
			if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$97$3 * 28)) + 8) == 0 ) goto label$130;
			{
	...
	TMP$98$1 = DTYPE$1 & 31;
	label$243:;
	if( (-(*(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$98$1 * 28)) + 8) == 0) & -((FLAGS$1 & 1) == 0)) == 0 ) goto label$145;
	{
...
static struct $7ASTNODE* HUDTCALLOPOVL( struct $8FBSYMBOL* PARENT$1, $6AST_OP OP$1, struct $7ASTNODE* INST_EXPR$1, struct $7ASTNODE* SECOND_ARG$1, struct $7ASTNODE* THIRD_ARG$1 )
{
	...
	SYM$1 = vr$1;
	if( SYM$1 != (struct $8FBSYMBOL*)0u ) goto label$192;
	{
		ERRREPORT( 198, -1, *(uint8**)(((uint8*)AST_OPTB$ + (OP$1 << (4 & 31))) + 8) );
	...
	if( SECOND_ARG$1 != (struct $7ASTNODE*)0u ) goto label$194;
	{
	...
	label$194:;
	{
		...
		struct $8FBARRAY1I11FB_CALL_ARGE tmp$102$2;
		*(struct $11FB_CALL_ARG**)&tmp$102$2 = (struct $11FB_CALL_ARG*)ARGS$2;
		*(struct $11FB_CALL_ARG**)((uint8*)&tmp$102$2 + 4) = (struct $11FB_CALL_ARG*)ARGS$2;
		*(int32*)((uint8*)&tmp$102$2 + 8) = 24;
		*(int32*)((uint8*)&tmp$102$2 + 12) = 12;
		*(int32*)((uint8*)&tmp$102$2 + 16) = 1;
		*(int32*)((uint8*)&tmp$102$2 + 20) = 49;
		*(int32*)((uint8*)&tmp$102$2 + 24) = 2;
		*(int32*)((uint8*)&tmp$102$2 + 28) = 0;
		*(int32*)((uint8*)&tmp$102$2 + 32) = 1;
		int32 PARAMS$2;
		PARAMS$2 = 1;
		{
			struct $11FB_CALL_ARG* TMP$103$3;
			TMP$103$3 = (struct $11FB_CALL_ARG*)ARGS$2;
			*(struct $7ASTNODE**)TMP$103$3 = SECOND_ARG$1;
			*($12FB_PARAMMODE*)((uint8*)TMP$103$3 + 4) = -1;
			*(struct $11FB_CALL_ARG**)((uint8*)TMP$103$3 + 8) = (struct $11FB_CALL_ARG*)0u;
		}
		if( OP$1 != 26 ) goto label$196;
		{
			if( THIRD_ARG$1 == (struct $7ASTNODE*)0u ) goto label$198;
			{
				*(struct $11FB_CALL_ARG**)((uint8*)ARGS$2 + 8) = (struct $11FB_CALL_ARG*)((uint8*)ARGS$2 + 12);
				PARAMS$2 = PARAMS$2 + 1;
				{
					struct $11FB_CALL_ARG* TMP$104$5;
					TMP$104$5 = (struct $11FB_CALL_ARG*)((uint8*)ARGS$2 + 12);
					*(struct $7ASTNODE**)TMP$104$5 = THIRD_ARG$1;
					*($12FB_PARAMMODE*)((uint8*)TMP$104$5 + 4) = -1;
					*(struct $11FB_CALL_ARG**)((uint8*)TMP$104$5 + 8) = (struct $11FB_CALL_ARG*)0u;
				}
			}
			label$198:;
			label$197:;
	...
	label$193:;
	if( SYM$1 != (struct $8FBSYMBOL*)0u ) goto label$200;
	{
		if( ERR_NUM$1 == 0 ) goto label$202;
		{
		...
		label$202:;
		{
			...
			__builtin_memset( &TMP$106$3, 0, 12 );
			FBSTRING* vr$23 = fb_StrConcat( &TMP$106$3, *(void**)(((uint8*)AST_OPTB$ + (OP$1 << (4 & 31))) + 8), 0, (void*)" (with", 7 );
			fb_StrInit( (void*)&OP_VERSION$3, -1, (void*)vr$23, -1, 0 );
			{
				uint32 TMP$107$4;
				TMP$107$4 = (uint32)OP$1;
				goto label$204;
				label$205:;
				{
					if( SECOND_ARG$1 != (struct $7ASTNODE*)0u ) goto label$207;
					{
				...
				label$208:;
				{
					if( THIRD_ARG$1 != (struct $7ASTNODE*)0u ) goto label$210;
					{
						fb_StrConcatAssign( (void*)&OP_VERSION$3, -1, (void*)"out", 4, 0 );
					}
					label$210:;
				...
				goto label$203;
				label$204:;
				static const void* tmp$112[3] = {
					&&label$205,
					&&label$205,
					&&label$208,
				};
				if( (TMP$107$4 - 24u) > 2u ) goto label$203;
				goto *tmp$112[TMP$107$4 - 24u];
				label$203:;
			}
...
{
	label$213:;
	if( *(struct $7ASTNODE**)((uint8*)STK$1 + 8) == (struct $7ASTNODE*)0u ) goto label$216;
	{
	...
	{
		int32 TMP$110$2;
		TMP$110$2 = *(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)STK$1 + 24) + 28) & 511;
		if( TMP$110$2 != 20 ) goto label$218;
		label$219:;
		{
			HUDTSTEP( STK$1 );
	...
	ASTADD( vr$12 );
	if( *(struct $7ASTNODE**)((uint8*)STK$1 + 16) == (struct $7ASTNODE*)0u ) goto label$222;
	{
