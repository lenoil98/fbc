...
int32 CONSTMT( void )
{
	...
	fb$result$1 = 0;
	LEXSKIPTOKEN( 2048 );
	int32 vr$1 = HMATCH( 498, 2048 );
	if( vr$1 == 0 ) goto label$43;
	{
		if( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) != *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 880) ) goto label$45;
		{
	...
	label$46:;
	{
		...
		label$54:;
		{
			...
			label$56:;
			label$55:;
			if( (*(int32*)((uint8*)&ENV$ + 888) & 65536) != 0 ) goto label$58;
			{
			...
			label$58:;
			label$57:;
			if( *(int32*)((uint8*)&ENV$ + 948) != 0 ) goto label$60;
			{
				ERRREPORT( 17, 0, (uint8*)0u );
				HSKIPUNTIL( -1, 0, 0, 0 );
				fb$result$1 = -1;
...
static int32 CGOTBSTMT( struct $7ASTNODE* EXPR$1, int32 ISGOTO$1 )
{
	...
	*(uint64**)((uint8*)&tmp$94$1 + 4) = (uint64*)VALUES$1;
	*(int32*)((uint8*)&tmp$94$1 + 8) = 512;
	*(int32*)((uint8*)&tmp$94$1 + 12) = 8;
	...
	*(struct $8FBSYMBOL***)((uint8*)&tmp$95$1 + 4) = (struct $8FBSYMBOL**)LABELS$1;
	*(int32*)((uint8*)&tmp$95$1 + 8) = 256;
	*(int32*)((uint8*)&tmp$95$1 + 12) = 4;
	*(int32*)((uint8*)&tmp$95$1 + 16) = 1;
	*(int32*)((uint8*)&tmp$95$1 + 20) = 49;
	*(int32*)((uint8*)&tmp$95$1 + 24) = 64;
	*(int32*)((uint8*)&tmp$95$1 + 28) = 0;
	*(int32*)((uint8*)&tmp$95$1 + 32) = 63;
	struct $10FBSYMCHAIN* CHAIN_$1;
	struct $8FBSYMBOL* BASE_PARENT$1;
	fb$result$1 = 0;
	...
	{
		{
			...
			TMP$96$3 = vr$11;
			if( TMP$96$3 == 3 ) goto label$21;
			label$22:;
			if( TMP$96$3 != 0 ) goto label$20;
			label$21:;
			{
				...
				if( L$1 >= 64 ) goto label$24;
				{
					...
					*(struct $8FBSYMBOL**)((uint8*)LABELS$1 + (L$1 << (2 & 31))) = vr$14;
					if( *(struct $8FBSYMBOL**)((uint8*)LABELS$1 + (L$1 << (2 & 31))) != (struct $8FBSYMBOL*)0u ) goto label$26;
					{
						uint8* vr$17 = LEXGETTEXT(  );
						struct $8FBSYMBOL* vr$18 = SYMBADDLABEL( vr$17, 64 );
						*(struct $8FBSYMBOL**)((uint8*)LABELS$1 + (L$1 << (2 & 31))) = vr$18;
					}
					label$26:;
					label$25:;
				}
			...
			label$20:;
			{
				...
				if( L$1 >= 64 ) goto label$30;
				{
					...
					*(struct $8FBSYMBOL**)((uint8*)LABELS$1 + (L$1 << (2 & 31))) = vr$21;
				}
				label$30:;
				label$29:;
			}
	...
	EXITLABEL$1 = vr$25;
	{
		...
		label$36:;
		{
			*(uint64*)((uint8*)VALUES$1 + (I$2 << (3 & 31))) = (uint64)I$2;
		}
		label$34:;
		I$2 = I$2 + 1;
		label$33:;
	...
	TMP$98$1 = 0;
	label$72:;
	struct $7ASTNODE* vr$34 = ASTBUILDJMPTB( SYM$1, (uint64*)VALUES$1, (struct $8FBSYMBOL**)LABELS$1, L$1, EXITLABEL$1, 1ull, (uint64)TMP$98$1 );
	EXPR$1 = vr$34;
	...
	label$39:;
	{
		ASTGOSUBADDJUMPPTR( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104), EXPR$1, EXITLABEL$1 );
	}
	label$38:;
