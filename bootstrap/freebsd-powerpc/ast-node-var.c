...
struct $6IRVREG* ASTLOADVAR( struct $7ASTNODE* N$1 )
{
	...
	{
		struct $6IRVREG* vr$10 = (*(tmp$72*)((uint8*)&IR$ + 240))( *(int32*)((uint8*)N$1 + 4), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8), S$1, OFS$1 );
		VR$1 = vr$10;
