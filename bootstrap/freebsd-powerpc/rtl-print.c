...
int32 RTLPRINT( struct $7ASTNODE* FILEEXPR$1, int32 ISCOMMA$1, int32 ISSEMICOLON$1, struct $7ASTNODE* EXPR$1, int32 ISLPRINT$1 )
{
	...
	if( EXPR$1 != (struct $7ASTNODE*)0u ) goto label$17;
	{
		...
		{
			struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_LPrintVoid", 173 );
			F$1 = vr$1;
		}
		goto label$18;
		label$19:;
		{
			struct $8FBSYMBOL* vr$2 = RTLPROCLOOKUP( (uint8*)"fb_PrintVoid", 159 );
			F$1 = vr$2;
		}
		label$18:;
	}
	...
	label$17:;
	{
		ASTTRYOVLSTRINGCONV( &EXPR$1 );
		{
			...
			goto label$89;
			label$20:;
			TMP$148$3 = (*(int32*)((uint8*)EXPR$1 + 4) & 511) & 31;
			label$89:;
			TMP$149$3 = TMP$148$3;
			if( TMP$149$3 == 20 ) goto label$23;
			label$24:;
			if( TMP$149$3 != 10 ) goto label$22;
			label$23:;
			{
		...
		{
			uint32 TMP$150$3;
			TMP$150$3 = (uint32)(*(int32*)((uint8*)EXPR$1 + 4) & 511);
			goto label$31;
			label$32:;
			{
				if( ISLPRINT$1 == 0 ) goto label$34;
				{
					struct $8FBSYMBOL* vr$16 = RTLPROCLOOKUP( (uint8*)"fb_LPrintString", 185 );
					F$1 = vr$16;
				}
				goto label$33;
				label$34:;
				{
					struct $8FBSYMBOL* vr$17 = RTLPROCLOOKUP( (uint8*)"fb_PrintString", 171 );
					F$1 = vr$17;
				}
				label$33:;
			}
			...
			label$35:;
			{
				...
				{
					struct $8FBSYMBOL* vr$18 = RTLPROCLOOKUP( (uint8*)"fb_LPrintWstr", 186 );
					F$1 = vr$18;
				}
				goto label$36;
				label$37:;
				{
					struct $8FBSYMBOL* vr$19 = RTLPROCLOOKUP( (uint8*)"fb_PrintWstr", 172 );
					F$1 = vr$19;
				}
				label$36:;
			}
			...
			label$38:;
			{
				...
				{
					struct $8FBSYMBOL* vr$20 = RTLPROCLOOKUP( (uint8*)"fb_LPrintBool", 174 );
					F$1 = vr$20;
				}
				goto label$39;
				label$40:;
				{
					struct $8FBSYMBOL* vr$21 = RTLPROCLOOKUP( (uint8*)"fb_PrintBool", 160 );
					F$1 = vr$21;
				}
				label$39:;
			}
			...
			{
				{
					...
					goto label$90;
					label$42:;
					TMP$151$5 = *(int32*)((uint8*)EXPR$1 + 4) & 31;
					label$90:;
					TMP$152$5 = *(uint32*)(((uint8*)SYMB_DTYPETB$ + (TMP$151$5 * 28)) + 20);
					goto label$44;
					label$45:;
					{
						if( ISLPRINT$1 == 0 ) goto label$47;
						{
							struct $8FBSYMBOL* vr$27 = RTLPROCLOOKUP( (uint8*)"fb_LPrintByte", 175 );
							F$1 = vr$27;
						}
						goto label$46;
						label$47:;
						{
							struct $8FBSYMBOL* vr$28 = RTLPROCLOOKUP( (uint8*)"fb_PrintByte", 161 );
							F$1 = vr$28;
						}
						label$46:;
					}
					...
					label$48:;
					{
						...
						{
							struct $8FBSYMBOL* vr$29 = RTLPROCLOOKUP( (uint8*)"fb_LPrintUByte", 176 );
							F$1 = vr$29;
						}
						goto label$49;
						label$50:;
						{
							struct $8FBSYMBOL* vr$30 = RTLPROCLOOKUP( (uint8*)"fb_PrintUByte", 162 );
							F$1 = vr$30;
						}
						label$49:;
					}
					...
					label$51:;
					{
						...
						{
							struct $8FBSYMBOL* vr$31 = RTLPROCLOOKUP( (uint8*)"fb_LPrintShort", 177 );
							F$1 = vr$31;
						}
						goto label$52;
						label$53:;
						{
							struct $8FBSYMBOL* vr$32 = RTLPROCLOOKUP( (uint8*)"fb_PrintShort", 163 );
							F$1 = vr$32;
						}
						label$52:;
					}
					...
					label$54:;
					{
						...
						{
							struct $8FBSYMBOL* vr$33 = RTLPROCLOOKUP( (uint8*)"fb_LPrintUShort", 178 );
							F$1 = vr$33;
						}
						goto label$55;
						label$56:;
						{
							struct $8FBSYMBOL* vr$34 = RTLPROCLOOKUP( (uint8*)"fb_PrintUShort", 164 );
							F$1 = vr$34;
						}
						label$55:;
					}
					...
					label$57:;
					{
						...
						{
							struct $8FBSYMBOL* vr$35 = RTLPROCLOOKUP( (uint8*)"fb_LPrintInt", 179 );
							F$1 = vr$35;
						}
						goto label$58;
						label$59:;
						{
							struct $8FBSYMBOL* vr$36 = RTLPROCLOOKUP( (uint8*)"fb_PrintInt", 165 );
							F$1 = vr$36;
						}
						label$58:;
					}
					...
					label$60:;
					{
						...
						{
							struct $8FBSYMBOL* vr$37 = RTLPROCLOOKUP( (uint8*)"fb_LPrintUInt", 180 );
							F$1 = vr$37;
						}
						goto label$61;
						label$62:;
						{
							struct $8FBSYMBOL* vr$38 = RTLPROCLOOKUP( (uint8*)"fb_PrintUInt", 166 );
							F$1 = vr$38;
						}
						label$61:;
					}
					...
					label$63:;
					{
						...
						{
							struct $8FBSYMBOL* vr$39 = RTLPROCLOOKUP( (uint8*)"fb_LPrintLongint", 181 );
							F$1 = vr$39;
						}
						goto label$64;
						label$65:;
						{
							struct $8FBSYMBOL* vr$40 = RTLPROCLOOKUP( (uint8*)"fb_PrintLongint", 167 );
							F$1 = vr$40;
						}
						label$64:;
					}
					...
					label$66:;
					{
						...
						{
							struct $8FBSYMBOL* vr$41 = RTLPROCLOOKUP( (uint8*)"fb_LPrintULongint", 182 );
							F$1 = vr$41;
						}
						goto label$67;
						label$68:;
						{
							struct $8FBSYMBOL* vr$42 = RTLPROCLOOKUP( (uint8*)"fb_PrintULongint", 168 );
							F$1 = vr$42;
						}
						label$67:;
					}
					...
					if( (TMP$152$5 - 1u) > 7u ) goto label$43;
					goto *tmp$153[TMP$152$5 - 1u];
					label$43:;
				}
			}
			goto label$30;
			label$69:;
			{
				...
				{
					struct $8FBSYMBOL* vr$43 = RTLPROCLOOKUP( (uint8*)"fb_LPrintSingle", 183 );
					F$1 = vr$43;
				}
				goto label$70;
				label$71:;
				{
					struct $8FBSYMBOL* vr$44 = RTLPROCLOOKUP( (uint8*)"fb_PrintSingle", 169 );
					F$1 = vr$44;
				}
				label$70:;
			}
			...
			label$72:;
			{
				...
				{
					struct $8FBSYMBOL* vr$45 = RTLPROCLOOKUP( (uint8*)"fb_LPrintDouble", 184 );
					F$1 = vr$45;
				}
				goto label$73;
				label$74:;
				{
					struct $8FBSYMBOL* vr$46 = RTLPROCLOOKUP( (uint8*)"fb_PrintDouble", 170 );
					F$1 = vr$46;
				}
				label$73:;
			}
			...
			if( (TMP$150$3 - 1u) > 17u ) goto label$75;
			goto *tmp$154[TMP$150$3 - 1u];
			label$30:;
		}
	}
	label$16:;
...
int32 RTLPRINTSPCTAB( struct $7ASTNODE* FILEEXPR$1, struct $7ASTNODE* EXPR$1, int32 ISTAB$1, int32 ISLPRINT$1 )
{
	...
	{
		struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_PrintTab", 188 );
	...
	label$96:;
	{
		struct $8FBSYMBOL* vr$3 = RTLPROCLOOKUP( (uint8*)"fb_PrintSPC", 187 );
...
int32 RTLWRITE( struct $7ASTNODE* FILEEXPR$1, int32 ISCOMMA$1, struct $7ASTNODE* EXPR$1 )
{
	...
	{
		struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_WriteVoid", 189 );
		F$1 = vr$1;
	}
	goto label$103;
	label$104:;
	{
		...
		{
			int32 TMP$155$3;
			TMP$155$3 = *(int32*)((uint8*)EXPR$1 + 4) & 511;
			if( TMP$155$3 == 20 ) goto label$107;
			label$108:;
			if( TMP$155$3 != 10 ) goto label$106;
			label$107:;
			{
		...
		{
			uint32 TMP$156$3;
			TMP$156$3 = (uint32)(*(int32*)((uint8*)EXPR$1 + 4) & 511);
			goto label$115;
			label$116:;
			{
				struct $8FBSYMBOL* vr$11 = RTLPROCLOOKUP( (uint8*)"fb_WriteString", 201 );
				F$1 = vr$11;
			}
			goto label$114;
			label$117:;
			{
				struct $8FBSYMBOL* vr$12 = RTLPROCLOOKUP( (uint8*)"fb_WriteWstr", 202 );
				F$1 = vr$12;
			}
			goto label$114;
			label$118:;
			{
				struct $8FBSYMBOL* vr$13 = RTLPROCLOOKUP( (uint8*)"fb_WriteBool", 190 );
				F$1 = vr$13;
			}
			goto label$114;
			label$119:;
			{
				{
					...
					goto label$144;
					label$120:;
					TMP$157$5 = *(int32*)((uint8*)EXPR$1 + 4) & 31;
					label$144:;
					TMP$158$5 = *(uint32*)(((uint8*)SYMB_DTYPETB$ + (TMP$157$5 * 28)) + 20);
					goto label$122;
					label$123:;
					{
						struct $8FBSYMBOL* vr$19 = RTLPROCLOOKUP( (uint8*)"fb_WriteByte", 191 );
						F$1 = vr$19;
					}
					goto label$121;
					label$124:;
					{
						struct $8FBSYMBOL* vr$20 = RTLPROCLOOKUP( (uint8*)"fb_WriteUByte", 192 );
						F$1 = vr$20;
					}
					goto label$121;
					label$125:;
					{
						struct $8FBSYMBOL* vr$21 = RTLPROCLOOKUP( (uint8*)"fb_WriteShort", 193 );
						F$1 = vr$21;
					}
					goto label$121;
					label$126:;
					{
						struct $8FBSYMBOL* vr$22 = RTLPROCLOOKUP( (uint8*)"fb_WriteUShort", 194 );
						F$1 = vr$22;
					}
					goto label$121;
					label$127:;
					{
						struct $8FBSYMBOL* vr$23 = RTLPROCLOOKUP( (uint8*)"fb_WriteInt", 195 );
						F$1 = vr$23;
					}
					goto label$121;
					label$128:;
					{
						struct $8FBSYMBOL* vr$24 = RTLPROCLOOKUP( (uint8*)"fb_WriteUInt", 196 );
						F$1 = vr$24;
					}
					goto label$121;
					label$129:;
					{
						struct $8FBSYMBOL* vr$25 = RTLPROCLOOKUP( (uint8*)"fb_WriteLongint", 197 );
						F$1 = vr$25;
					}
					goto label$121;
					label$130:;
					{
						struct $8FBSYMBOL* vr$26 = RTLPROCLOOKUP( (uint8*)"fb_WriteULongint", 198 );
						F$1 = vr$26;
					}
					goto label$121;
					label$122:;
					static const void* tmp$159[8] = {
						&&label$123,
						&&label$124,
						&&label$125,
						&&label$126,
					...
					if( (TMP$158$5 - 1u) > 7u ) goto label$121;
					goto *tmp$159[TMP$158$5 - 1u];
					label$121:;
				}
			}
			goto label$114;
			label$131:;
			{
				struct $8FBSYMBOL* vr$27 = RTLPROCLOOKUP( (uint8*)"fb_WriteSingle", 199 );
				F$1 = vr$27;
			}
			goto label$114;
			label$132:;
			{
				struct $8FBSYMBOL* vr$28 = RTLPROCLOOKUP( (uint8*)"fb_WriteDouble", 200 );
				F$1 = vr$28;
			}
			goto label$114;
			label$133:;
			...
			if( (TMP$156$3 - 1u) > 17u ) goto label$133;
			goto *tmp$160[TMP$156$3 - 1u];
			label$114:;
		}
	}
	label$103:;
...
int32 RTLPRINTUSINGINIT( struct $7ASTNODE* USINGEXPR$1, int32 ISLPRINT$1 )
{
	...
	{
		struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_LPrintUsingInit", 212 );
		F$1 = vr$1;
	}
	goto label$147;
	label$148:;
	{
		struct $8FBSYMBOL* vr$2 = RTLPROCLOOKUP( (uint8*)"fb_PrintUsingInit", 203 );
		F$1 = vr$2;
	}
	label$147:;
...
int32 RTLPRINTUSINGEND( struct $7ASTNODE* FILEEXPR$1, int32 ISLPRINT$1 )
{
	...
	label$154:;
	label$153:;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_PrintUsingEnd", 211 );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0u );
	PROC$1 = vr$2;
...
int32 RTLPRINTUSING( struct $7ASTNODE* FILEEXPR$1, struct $7ASTNODE* EXPR$1, int32 ISCOMMA$1, int32 ISSEMICOLON$1, int32 ISLPRINT$1 )
{
	...
	ASTTRYOVLSTRINGCONV( &EXPR$1 );
	{
		...
		if( TMP$161$2 == 20 ) goto label$165;
		label$166:;
		if( TMP$161$2 != 10 ) goto label$164;
		label$165:;
		{
	...
	{
		int32 TMP$162$2;
		TMP$162$2 = *(int32*)((uint8*)EXPR$1 + 4) & 511;
		if( TMP$162$2 == 18 ) goto label$171;
		label$172:;
		if( TMP$162$2 == 17 ) goto label$171;
		label$173:;
		if( TMP$162$2 != 4 ) goto label$170;
		label$171:;
		{
			struct $8FBSYMBOL* vr$7 = RTLPROCLOOKUP( (uint8*)"fb_PrintUsingStr", 204 );
			F$1 = vr$7;
		}
		goto label$169;
		label$170:;
		if( TMP$162$2 != 7 ) goto label$174;
		label$175:;
		{
			struct $8FBSYMBOL* vr$8 = RTLPROCLOOKUP( (uint8*)"fb_PrintUsingWstr", 205 );
			F$1 = vr$8;
		}
		goto label$169;
		label$174:;
		if( TMP$162$2 != 15 ) goto label$176;
		label$177:;
		{
			struct $8FBSYMBOL* vr$9 = RTLPROCLOOKUP( (uint8*)"fb_PrintUsingSingle", 206 );
			F$1 = vr$9;
		}
		goto label$169;
		label$176:;
		if( TMP$162$2 == 13 ) goto label$179;
		label$180:;
		if( TMP$162$2 == 8 ) goto label$179;
		label$181:;
		if( TMP$162$2 == 11 ) goto label$179;
		label$182:;
		if( TMP$162$2 == 5 ) goto label$179;
		label$183:;
		if( TMP$162$2 != 2 ) goto label$178;
		label$179:;
		{
			struct $8FBSYMBOL* vr$10 = RTLPROCLOOKUP( (uint8*)"fb_PrintUsingLongint", 208 );
			F$1 = vr$10;
		}
		goto label$169;
		label$178:;
		if( TMP$162$2 == 14 ) goto label$185;
		label$186:;
		if( TMP$162$2 == 9 ) goto label$185;
		label$187:;
		if( TMP$162$2 == 12 ) goto label$185;
		label$188:;
		if( TMP$162$2 == 6 ) goto label$185;
		label$189:;
		if( TMP$162$2 != 3 ) goto label$184;
		label$185:;
		{
			struct $8FBSYMBOL* vr$11 = RTLPROCLOOKUP( (uint8*)"fb_PrintUsingULongint", 209 );
			F$1 = vr$11;
		}
		goto label$169;
		label$184:;
		if( TMP$162$2 != 1 ) goto label$190;
		label$191:;
		{
			struct $8FBSYMBOL* vr$12 = RTLPROCLOOKUP( (uint8*)"fb_PrintUsingBoolean", 210 );
			F$1 = vr$12;
		}
		goto label$169;
		label$190:;
		{
			struct $8FBSYMBOL* vr$13 = RTLPROCLOOKUP( (uint8*)"fb_PrintUsingDouble", 207 );
			F$1 = vr$13;
		}
		label$192:;
		label$169:;
...
struct $7ASTNODE* RTLWIDTHDEV( struct $7ASTNODE* DEVICE$1, struct $7ASTNODE* WIDTH_ARG$1, int32 ISFUNC$1 )
{
	...
	RTLPRINTER_CB( (struct $8FBSYMBOL*)0u );
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_WidthDev", 289 );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0u );
	PROC$1 = vr$2;
...
int32 RTLPRINTER_CB( struct $8FBSYMBOL* SYM$1 )
{
	...
	if( LIBSADDED$1 != 0 ) goto label$212;
	{
		LIBSADDED$1 = -1;
		{
			$13FB_COMPTARGET TMP$164$3;
			TMP$164$3 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 108);
			if( TMP$164$3 == 0 ) goto label$215;
			label$216:;
			if( TMP$164$3 != 1 ) goto label$214;
			label$215:;
			{
