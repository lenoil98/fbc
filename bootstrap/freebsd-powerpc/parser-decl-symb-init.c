...
__FB_STATIC_ASSERT( sizeof( struct $10FB_INITCTX ) == 28 );
...
int32 ASTCHECKASSIGNTOTYPE( int32, struct $8FBSYMBOL*, struct $7ASTNODE* );
...
struct $7ASTNODE* CINITIALIZER( struct $8FBSYMBOL* SYM$1, $9FB_INIOPT OPTIONS$1, int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	if( (-((*(int32*)((uint8*)SYM$1 + 4) & 16388) != 0) | -((*(int32*)((uint8*)SYM$1 + 4) & 8) != 0)) == 0 ) goto label$142;
	{
	...
	label$142:;
	label$141:;
	if( *(int32*)SYM$1 != 1 ) goto label$144;
	{
	...
	*(struct $7ASTNODE**)((uint8*)&CTX$1 + 24) = (struct $7ASTNODE*)0u;
	...
	struct $7ASTNODE* vr$14 = ASTTYPEINIBEGIN( *(int32*)((uint8*)&CTX$1 + 4), *(struct $8FBSYMBOL**)((uint8*)&CTX$1 + 8), IS_LOCAL$1, *(int64*)((uint8*)SYM$1 + 48) );
	*(struct $7ASTNODE**)((uint8*)&CTX$1 + 16) = vr$14;
	int32 vr$15 = TYPEHASCTOR( *(int32*)((uint8*)&CTX$1 + 4), *(struct $8FBSYMBOL**)((uint8*)&CTX$1 + 8) );
	if( vr$15 == 0 ) goto label$146;
	{
		*($9FB_INIOPT*)((uint8*)&CTX$1 + 20) = *(int32*)((uint8*)&CTX$1 + 20) | 2;
	}
	label$146:;
	label$145:;
	if( (-(*(int32*)*(struct $8FBSYMBOL**)&CTX$1 == 1) | -(*(int32*)*(struct $8FBSYMBOL**)&CTX$1 == 12)) == 0 ) goto label$148;
	{
		int32 vr$23 = HARRAYINIT( &CTX$1, 0 );
		OK$1 = vr$23;
	}
	goto label$147;
	label$148:;
	{
		if( (*(int32*)((uint8*)&CTX$1 + 4) & 511) != 20 ) goto label$150;
		{
			int32 vr$26 = HUDTINIT( &CTX$1 );
			OK$1 = vr$26;
		}
		goto label$149;
		label$150:;
		{
			int32 vr$28 = HELMINIT( &CTX$1, 0 );
			OK$1 = vr$28;
		}
		label$149:;
	}
	...
	if( OK$1 == 0 ) goto label$151;
	TMP$95$1 = *(struct $7ASTNODE**)((uint8*)&CTX$1 + 16);
	goto label$152;
	label$151:;
	TMP$95$1 = (struct $7ASTNODE*)0u;
	label$152:;
...
static int32 HDOASSIGN( struct $10FB_INITCTX* CTX$1, struct $7ASTNODE* EXPR$1, int32 NO_FAKE$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 4 );
	label$14:;
	int32 vr$3 = ASTCHECKASSIGNTOTYPE( *(int32*)((uint8*)CTX$1 + 4), *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 8), EXPR$1 );
	if( vr$3 != 0 ) goto label$17;
	{
		struct $7ASTNODE* vr$6 = ASTNEWCONV( *(int32*)((uint8*)CTX$1 + 4), *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 8), EXPR$1, 0, (int32*)0u );
		EXPR$1 = vr$6;
	...
	label$17:;
	label$16:;
	ASTTYPEINIADDASSIGN( *(struct $7ASTNODE**)((uint8*)CTX$1 + 16), EXPR$1, *(struct $8FBSYMBOL**)CTX$1, *(int32*)((uint8*)CTX$1 + 4), *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 8) );
	fb$result$1 = -1;
	label$15:;
	return fb$result$1;
}
...
static int32 HELMINIT( struct $10FB_INITCTX* CTX$1, int32 NO_FAKE$1 )
{
	...
	int32 OLD_DTYPE$1;
	fb$result$1 = 0;
	OLDSYM$1 = *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 156);
	OLD_DTYPE$1 = *(int32*)((uint8*)&PARSER$ + 152);
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 156) = *(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)CTX$1 + 32);
	*(int32*)((uint8*)&PARSER$ + 152) = *(int32*)((uint8*)*(struct $8FBSYMBOL**)CTX$1 + 28) & 511;
	...
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 156) = OLDSYM$1;
	*(int32*)((uint8*)&PARSER$ + 152) = OLD_DTYPE$1;
...
static int32 HARRAYINIT( struct $10FB_INITCTX* CTX$1, int32 NO_FAKE$1 )
{
	...
	label$41:;
	{
		...
		label$45:;
		{
			...
			{
				int32 vr$47 = HUDTINIT( CTX$1 );
				if( vr$47 != 0 ) goto label$51;
				{
					goto label$27;
				}
				label$51:;
			...
			label$49:;
			{
				int32 vr$48 = HELMINIT( CTX$1, NO_FAKE$1 );
				if( vr$48 != 0 ) goto label$53;
				{
					goto label$27;
				}
				label$53:;
		...
		if( (-((int64)ELM_CNT$1 >= ELEMENTS$1) & -(ELEMENTS$1 != -1ll)) == 0 ) goto label$55;
		{
			goto label$42;
		}
		label$55:;
	...
	label$43:;
	int32 vr$54 = HMATCH( 44, 0 );
	if( vr$54 != 0 ) goto label$41;
	label$42:;
	if( ELEMENTS$1 != -1ll ) goto label$57;
	{
		...
		int32 vr$69 = SYMBCHECKARRAYSIZE( *(int32*)((uint8*)*(struct $8FBSYMBOL**)CTX$1 + 64), *(struct $10FBARRAYDIM**)((uint8*)*(struct $8FBSYMBOL**)CTX$1 + 68), *(int64*)((uint8*)*(struct $8FBSYMBOL**)CTX$1 + 40), -((*(int32*)((uint8*)*(struct $8FBSYMBOL**)CTX$1 + 4) & 3) == 0) );
		if( vr$69 != 0 ) goto label$59;
		{
	...
	{
		int64 vr$77 = SYMBCALCARRAYELEMENTS( *(struct $8FBSYMBOL**)CTX$1, *(int32*)((uint8*)CTX$1 + 12) + 1 );
		ELEMENTS$1 = ELEMENTS$1 * vr$77;
		struct $8FBSYMBOL* CTOR$2;
		CTOR$2 = (struct $8FBSYMBOL*)0u;
		if( (*(int32*)((uint8*)CTX$1 + 20) & 2) == 0 ) goto label$63;
		{
			struct $8FBSYMBOL* vr$82 = SYMBGETCOMPDEFCTOR( *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 8) );
			CTOR$2 = vr$82;
			if( CTOR$2 != (struct $8FBSYMBOL*)0u ) goto label$65;
			{
			...
			label$65:;
			{
				int32 vr$83 = SYMBCHECKACCESS( CTOR$2 );
				if( vr$83 != 0 ) goto label$67;
				{
		...
		{
			int64 PAD_LGT$3;
			if( (*(int32*)((uint8*)*(struct $8FBSYMBOL**)CTX$1 + 4) & 262144) == 0 ) goto label$71;
			{
				PAD_LGT$3 = (int64)*(int32*)((uint8*)&ENV$ + 272);
			}
			goto label$70;
			label$71:;
			{
				{
					uint32 TMP$94$5;
					TMP$94$5 = (uint32)(*(int32*)((uint8*)CTX$1 + 4) & 511);
					goto label$73;
					label$74:;
					{
					...
					label$75:;
					{
						int64 vr$98 = SYMBCALCLEN( *(int32*)((uint8*)CTX$1 + 4), *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 8) );
						PAD_LGT$3 = vr$98;
					}
					goto label$72;
					label$73:;
					static const void* tmp$96[15] = {
						&&label$74,
						&&label$75,
						&&label$75,
						&&label$74,
					...
					if( (TMP$94$5 - 4u) > 14u ) goto label$75;
					goto *tmp$96[TMP$94$5 - 4u];
					label$72:;
				}
			}
			label$70:;
...
static int32 HUDTINIT( struct $10FB_INITCTX* CTX$1 )
{
	...
	if( (*(int32*)((uint8*)CTX$1 + 20) & 2) == 0 ) goto label$83;
	{
		struct $7ASTNODE* EXPR$2;
		OLDSUBTYPE$1 = *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 156);
		OLDDTYPE$1 = *(int32*)((uint8*)&PARSER$ + 152);
		*(int32*)((uint8*)&PARSER$ + 152) = *(int32*)((uint8*)CTX$1 + 4);
		*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 156) = *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 8);
		struct $7ASTNODE* vr$6 = CEXPRESSION(  );
		EXPR$2 = vr$6;
		*(int32*)((uint8*)&PARSER$ + 152) = OLDDTYPE$1;
		*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 156) = OLDSUBTYPE$1;
		if( EXPR$2 != (struct $7ASTNODE*)0u ) goto label$85;
		{
			ERRREPORT( 9, 0, (uint8*)0u );
		...
		label$85:;
		label$84:;
		if( *(int32*)*(struct $8FBSYMBOL**)CTX$1 != 4 ) goto label$87;
		{
			if( *(int32*)((uint8*)*(struct $8FBSYMBOL**)CTX$1 + 56) != 2 ) goto label$89;
			{
				if( (-((*(int32*)((uint8*)EXPR$2 + 4) & 511) == (*(int32*)((uint8*)CTX$1 + 4) & 511)) & -(*(struct $8FBSYMBOL**)((uint8*)EXPR$2 + 8) == *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 8))) == 0 ) goto label$91;
				{
					REC_CNT$1 = REC_CNT$1 + -1;
					int32 vr$22 = HDOASSIGN( CTX$1, EXPR$2, 0 );
					fb$result$1 = vr$22;
					goto label$81;
				}
				label$91:;
		...
		label$86:;
		int32 IS_CTORCALL$2;
		$12FB_PARAMMODE vr$24 = CBYDESCARRAYARGPARENS( EXPR$2 );
		struct $7ASTNODE* vr$26 = ASTBUILDIMPLICITCTORCALLEX( *(struct $8FBSYMBOL**)CTX$1, EXPR$2, vr$24, &IS_CTORCALL$2 );
		EXPR$2 = vr$26;
		if( EXPR$2 != (struct $7ASTNODE*)0u ) goto label$93;
		{
			REC_CNT$1 = REC_CNT$1 + -1;
			goto label$81;
		}
		label$93:;
		label$92:;
		if( IS_CTORCALL$2 == 0 ) goto label$95;
		{
			REC_CNT$1 = REC_CNT$1 + -1;
			struct $7ASTNODE* vr$33 = ASTTYPEINIADDCTORCALL( *(struct $7ASTNODE**)((uint8*)CTX$1 + 16), *(struct $8FBSYMBOL**)CTX$1, EXPR$2, *(int32*)((uint8*)CTX$1 + 4), *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 8) );
			fb$result$1 = -(vr$33 != (struct $7ASTNODE*)0u);
			goto label$81;
		}
		goto label$94;
		label$95:;
		{
			REC_CNT$1 = REC_CNT$1 + -1;
			int32 vr$36 = HDOASSIGN( CTX$1, EXPR$2, 0 );
			fb$result$1 = vr$36;
			goto label$81;
		}
		label$94:;
	...
	if( vr$37 == 40 ) goto label$97;
	{
		if( REC_CNT$1 > 1 ) goto label$99;
		{
			REC_CNT$1 = REC_CNT$1 + -1;
			int32 vr$39 = HELMINIT( CTX$1, 0 );
			fb$result$1 = vr$39;
			goto label$81;
		}
		label$99:;
		label$98:;
		int32 vr$40 = LEXGETLOOKAHEAD( 1, 0 );
		COMMA$1 = -(vr$40 == 44);
		PARENTH$1 = 0;
	}
	goto label$96;
	...
	label$96:;
	struct $8FBSYMBOL* vr$45 = SYMBUDTGETFIRSTFIELD( *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 8) );
	FIRST$1 = vr$45;
	FLD$1 = FIRST$1;
	LGT$1 = 0ll;
	BASEOFS$1 = *(int64*)((uint8*)*(struct $7ASTNODE**)((uint8*)CTX$1 + 16) + 24);
	__builtin_memcpy( &OLD_CTX$1, CTX$1, 28 );
	*(int32*)((uint8*)CTX$1 + 12) = -1;
	label$100:;
	{
		if( FLD$1 != (struct $8FBSYMBOL*)0u ) goto label$104;
		{
		...
		label$104:;
		label$103:;
		if( LGT$1 <= 0ll ) goto label$106;
		{
			PAD_LGT$1 = *(int64*)((uint8*)FLD$1 + 48) - LGT$1;
			if( PAD_LGT$1 <= 0ll ) goto label$108;
			{
		...
		*(int64*)((uint8*)*(struct $7ASTNODE**)((uint8*)CTX$1 + 16) + 24) = BASEOFS$1 + *(int64*)((uint8*)FLD$1 + 48);
		int32 vr$58 = SYMBCHECKACCESS( FLD$1 );
		if( vr$58 != 0 ) goto label$110;
		{
		...
		*($9FB_INIOPT*)((uint8*)CTX$1 + 20) = *(int32*)((uint8*)CTX$1 + 20) & -3;
		int32 vr$63 = SYMBHASCTOR( FLD$1 );
		if( vr$63 == 0 ) goto label$112;
		{
			*($9FB_INIOPT*)((uint8*)CTX$1 + 20) = *(int32*)((uint8*)CTX$1 + 20) | 2;
		}
		label$112:;
		label$111:;
		int32 vr$67 = HARRAYINIT( CTX$1, -1 );
		if( vr$67 != 0 ) goto label$114;
		{
			if( (-(FLD$1 != FIRST$1) | -(*(struct $7ASTNODE**)((uint8*)CTX$1 + 24) == (struct $7ASTNODE*)0u)) == 0 ) goto label$116;
			{
				ERRREPORT( 24, -1, (uint8*)0u );
				REC_CNT$1 = REC_CNT$1 + -1;
				goto label$81;
			...
			__builtin_memcpy( CTX$1, &OLD_CTX$1, 28 );
			struct $7ASTNODE* vr$77 = ASTBUILDIMPLICITCTORCALLEX( *(struct $8FBSYMBOL**)CTX$1, EXPR$3, -1, &IS_CTORCALL$3 );
			EXPR$3 = vr$77;
			if( EXPR$3 != (struct $7ASTNODE*)0u ) goto label$118;
			{
				REC_CNT$1 = REC_CNT$1 + -1;
				goto label$81;
			}
			label$118:;
			label$117:;
			if( PARENTH$1 == 0 ) goto label$120;
			{
				int32 vr$79 = LEXGETTOKEN( 0 );
				if( vr$79 == 41 ) goto label$122;
				{
			...
			label$119:;
			REC_CNT$1 = REC_CNT$1 + -1;
			if( IS_CTORCALL$3 == 0 ) goto label$124;
			{
				struct $7ASTNODE* vr$86 = ASTTYPEINIADDCTORCALL( *(struct $7ASTNODE**)((uint8*)CTX$1 + 16), *(struct $8FBSYMBOL**)CTX$1, EXPR$3, *(int32*)((uint8*)CTX$1 + 4), *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 8) );
				fb$result$1 = -(vr$86 != (struct $7ASTNODE*)0u);
				goto label$81;
			}
			goto label$123;
			label$124:;
			{
				int32 vr$88 = HDOASSIGN( CTX$1, EXPR$3, 0 );
				fb$result$1 = vr$88;
				goto label$81;
			}
			label$123:;
		...
		label$114:;
		label$113:;
		int64 vr$89 = SYMBGETREALSIZE( FLD$1 );
		LGT$1 = LGT$1 + vr$89;
		struct $8FBSYMBOL* vr$91 = SYMBUDTGETNEXTINITABLEFIELD( FLD$1 );
		FLD$1 = vr$91;
		if( REC_CNT$1 <= 1 ) goto label$126;
		{
			if( COMMA$1 == 0 ) goto label$128;
			{
				if( FLD$1 != (struct $8FBSYMBOL*)0u ) goto label$130;
				{
					goto label$101;
				}
				label$130:;
		...
		label$126:;
		label$125:;
		int32 vr$92 = HMATCH( 44, 0 );
		if( vr$92 != 0 ) goto label$132;
		{
			goto label$101;
		}
		label$132:;
	...
	goto label$100;
	label$101:;
	if( PARENTH$1 == 0 ) goto label$134;
	{
		int32 vr$93 = LEXGETTOKEN( 0 );
		if( vr$93 == 41 ) goto label$136;
		{
			ERRREPORT( 7, 0, (uint8*)0u );
			HSKIPUNTIL( 41, -1, 0, 0 );
		}
	...
	__builtin_memcpy( CTX$1, &OLD_CTX$1, 28 );
	int64 SYM_LEN$1;
	int64 vr$99 = SYMBCALCLEN( *(int32*)((uint8*)CTX$1 + 4), *(struct $8FBSYMBOL**)((uint8*)CTX$1 + 8) );
	SYM_LEN$1 = vr$99;
	PAD_LGT$1 = SYM_LEN$1 - LGT$1;
	if( PAD_LGT$1 <= 0ll ) goto label$138;
	{
		ASTTYPEINIADDPAD( *(struct $7ASTNODE**)((uint8*)CTX$1 + 16), PAD_LGT$1 );
	}
	label$138:;
