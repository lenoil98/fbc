...
struct $6IRVREG* ASTLOADDEREF( struct $7ASTNODE* N$1 )
{
	...
	if( L$1 != (struct $7ASTNODE*)0u ) goto label$37;
	{
		...
		{
			struct $6IRVREG* vr$5 = (*(tmp$74*)((uint8*)&IR$ + 248))( *(int32*)((uint8*)N$1 + 4), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8), *(int64*)((uint8*)N$1 + 24), (struct $6IRVREG*)0u );
			VR$1 = vr$5;
	...
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$41;
	{
		...
		label$47:;
		if( ((-(*(int32*)V1$1 != 4) | -(*(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$84$2 * 28)) != 0)) | -(*(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$85$2 * 28)) + 4) != *(int32*)((uint8*)&ENV$ + 272))) == 0 ) goto label$45;
		{
			struct $6IRVREG* vr$39 = (*(tmp$69*)((uint8*)&IR$ + 228))( (((*(int32*)((uint8*)N$1 + 4) & 31) | ((*(int32*)((uint8*)N$1 + 4) & 480) + 32)) | ((*(int32*)((uint8*)N$1 + 4) & 261632) << (1 & 31))) | (*(int32*)((uint8*)N$1 + 4) & 32505856), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8) );
			VP$1 = vr$39;
			(*(tmp$51*)((uint8*)&IR$ + 124))( 76, V1$1, VP$1 );
		}
		goto label$44;
		label$45:;
		{
		...
		label$44:;
		struct $6IRVREG* vr$43 = (*(tmp$74*)((uint8*)&IR$ + 248))( *(int32*)((uint8*)N$1 + 4), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8), *(int64*)((uint8*)N$1 + 24), VP$1 );
		VR$1 = vr$43;
		*(int32*)((uint8*)VR$1 + 20) = *(int32*)((uint8*)N$1 + 16);
	}
	label$41:;
