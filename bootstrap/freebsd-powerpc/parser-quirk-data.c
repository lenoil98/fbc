	...
	fb$result$1 = 0;
	{
		...
		label$14:;
		{
			...
			SYM$3 = (struct $8FBSYMBOL*)0u;
			{
				...
				TMP$94$4 = vr$1;
				if( TMP$94$4 == 0 ) goto label$17;
				label$18:;
				if( TMP$94$4 == 2 ) goto label$17;
				label$19:;
				if( TMP$94$4 != 3 ) goto label$16;
				label$17:;
				{
		...
		label$34:;
		{
			if( *(int32*)((uint8*)&ENV$ + 136) == 3 ) goto label$36;
			{
				...
				label$38:;
				label$37:;
				if( *(uint32*)((uint8*)&PARSER$ + 96) <= 0u ) goto label$40;
				{
					if( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) == *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 880) ) goto label$42;
					{
			...
			label$36:;
			{
				if( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) == *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 880) ) goto label$44;
				{
					ERRREPORT( 61, 0, (uint8*)0u );
					HSKIPUNTIL( -1, 0, 0, 0 );
					fb$result$1 = 0;
				...
				label$47:;
				{
					...
					if( ISCONST$5 != 0 ) goto label$53;
					{
						...
						label$55:;
						{
							{
								int32 TMP$95$8;
								TMP$95$8 = *(int32*)((uint8*)EXPR$3 + 4) & 511;
								if( TMP$95$8 == 4 ) goto label$58;
								label$59:;
								if( TMP$95$8 != 7 ) goto label$57;
								label$58:;
								{
				...
				label$64:;
				{
					...
					label$67:;
					{
						FBSTRING TMP$97$6;
						{
							...
							if( (TMP$96$7 - 9u) > 251u ) goto label$70;
							goto *tmp$99[TMP$96$7 - 9u];
							label$70:;
						}
						uint8* vr$27 = LEXGETTEXT(  );
						__builtin_memset( &TMP$97$6, 0, 12 );
						FBSTRING* vr$31 = fb_StrConcat( &TMP$97$6, (void*)&TEXT$4, -1, (void*)vr$27, 0 );
