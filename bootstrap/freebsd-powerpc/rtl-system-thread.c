...
struct $7ASTNODE* RTLTHREADCALL( struct $7ASTNODE* CALLEXPR$1 )
{
	...
	*(int32*)((uint8*)&ARGMODE$1 + 20) = 17;
	...
	struct $8FBSYMBOL* vr$32 = RTLPROCLOOKUP( (uint8*)"fb_ThreadCall", 365 );
	...
	{
		PROCMODE_FB$1 = *(int32*)((uint8*)&ENV$ + 252);
		label$103:;
	}
	...
	TMP$93$1 = *(struct $8FBSYMBOL**)((uint8*)PROC$1 + 80);
	goto label$137;
	label$113:;
	TMP$93$1 = *(struct $8FBSYMBOL**)((uint8*)PROC$1 + 76);
	label$137:;
	PARAM$1 = TMP$93$1;
	{
		int32 I$2;
		...
		label$117:;
		{
			...
			TMP$95$3 = *(struct $8FBSYMBOL**)((uint8*)PARAM$1 + 172);
			goto label$138;
			label$135:;
			TMP$95$3 = *(struct $8FBSYMBOL**)((uint8*)PARAM$1 + 176);
			label$138:;
			PARAM$1 = TMP$95$3;
		}
		label$115:;
...
static int32 HTHREADCALLMAPTYPE( struct $8FBSYMBOL* SYM$1, int32 UDT$1 )
{
	...
	TMP$85$1 = -(*(int32*)((uint8*)SYM$1 + 116) > 0);
	goto label$140;
	label$15:;
	TMP$85$1 = 0;
	label$140:;
	if( TMP$85$1 == 0 ) goto label$17;
	{
		goto label$11;
	}
	label$17:;
		...
		{
			{
				...
				TMP$87$4 = DTYPE$1 & 31;
				label$142:;
				TMP$88$4 = *(uint32*)(((uint8*)SYMB_DTYPETB$ + (TMP$87$4 * 28)) + 20);
				goto label$50;
				label$51:;
				{
					fb$result$1 = 2;
				...
				if( (TMP$88$4 - 1u) > 9u ) goto label$61;
				goto *tmp$96[TMP$88$4 - 1u];
				label$49:;
			}
		}
		goto label$20;
