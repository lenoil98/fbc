...
struct $6IRVREG* ASTLOADOFFSET( struct $7ASTNODE* N$1 )
{
	...
	{
		struct $6IRVREG* vr$8 = (*(tmp$72*)((uint8*)&IR$ + 252))( *(int32*)((uint8*)N$1 + 4), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8), SYM$1, *(int64*)((uint8*)N$1 + 24) );
		VR$1 = vr$8;
	}
	label$25:;
	label$24:;
...
struct $6IRVREG* ASTLOADADDROF( struct $7ASTNODE* N$1 )
{
	...
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$92;
	{
		...
		goto label$98;
		label$94:;
		TMP$87$2 = *(int32*)((uint8*)V1$1 + 4) & 31;
		label$98:;
		if( ((-(*(int32*)V1$1 != 4) | -(*(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$86$2 * 28)) != 0)) | -(*(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$87$2 * 28)) + 4) != *(int32*)((uint8*)&ENV$ + 272))) == 0 ) goto label$96;
		{
			struct $6IRVREG* vr$21 = (*(tmp$69*)((uint8*)&IR$ + 228))( *(int32*)((uint8*)N$1 + 4), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8) );
			VR$1 = vr$21;
			(*(tmp$51*)((uint8*)&IR$ + 124))( 22, V1$1, VR$1 );
		}
		goto label$95;
		label$96:;
		{
