...
int32 ASTCHECKASSIGN( struct $7ASTNODE*, struct $7ASTNODE* );
...
int32 ASTCHECKASSIGN( struct $7ASTNODE* L$1, struct $7ASTNODE* R$1 )
{
	int32 TMP$91$1;
	int32 TMP$92$1;
	int32 TMP$93$1;
	...
	label$133:;
	LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$93$1 * 28));
	...
	label$134:;
	RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$94$1 * 28));
	...
	{
		int32 vr$21 = HCHECKUDTOPS( L$1, LDCLASS$1, &R$1, RDCLASS$1, -1 );
	...
	if( (-(LDTYPE$1 == 7) | -(RDTYPE$1 == 7)) == 0 ) goto label$98;
	{
		if( LDTYPE$1 == RDTYPE$1 ) goto label$100;
		{
			...
			goto label$135;
			label$105:;
			TMP$95$3 = LDFULL$1 & 31;
			label$135:;
			LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$95$3 * 28));
			if( (RDFULL$1 & 480) == 0 ) goto label$106;
			TMP$96$3 = 24;
			goto label$136;
			label$106:;
			TMP$96$3 = RDFULL$1 & 31;
			label$136:;
			RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$96$3 * 28));
			if( (LDFULL$1 & 480) == 0 ) goto label$107;
			TMP$97$3 = 24;
			goto label$137;
			label$107:;
			TMP$97$3 = LDFULL$1 & 31;
			label$137:;
			LDTYPE$1 = TMP$97$3;
	...
	if( (-(LDTYPE$1 == 4) | -(RDTYPE$1 == 4)) == 0 ) goto label$109;
	{
		...
		goto label$139;
		label$114:;
		TMP$99$2 = LDFULL$1 & 31;
		label$139:;
		LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$99$2 * 28));
		if( (RDFULL$1 & 480) == 0 ) goto label$115;
		TMP$100$2 = 24;
		goto label$140;
		label$115:;
		TMP$100$2 = RDFULL$1 & 31;
		label$140:;
		RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$100$2 * 28));
		if( (LDFULL$1 & 480) == 0 ) goto label$116;
		TMP$101$2 = 24;
		goto label$141;
		label$116:;
		TMP$101$2 = LDFULL$1 & 31;
		label$141:;
		LDTYPE$1 = TMP$101$2;
...
int32 ASTCHECKASSIGNTOTYPE( int32 LDTYPE$1, struct $8FBSYMBOL* LSUBTYPE$1, struct $7ASTNODE* R$1 )
{
	int32 fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$143:;
	...
	L$1 = vr$1;
	int32 vr$2 = ASTCHECKASSIGN( L$1, R$1 );
	fb$result$1 = vr$2;
	ASTDELTREE( L$1 );
	label$144:;
	return fb$result$1;
...
struct $7ASTNODE* ASTNEWASSIGN( struct $7ASTNODE* L$1, struct $7ASTNODE* R$1, $9AST_OPOPT OPTIONS$1 )
{
	...
	label$265:;
	LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$104$1 * 28));
	...
	goto label$267;
	label$166:;
	TMP$106$1 = RDTYPE$1 & 31;
	label$267:;
	RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$106$1 * 28));
	if( (OPTIONS$1 & 32) != 0 ) goto label$168;
	{
		...
		CHECK_LETOP$2 = -1;
		{
			...
			goto label$169;
			label$170:;
			static const void* tmp$122[1] = {
				&&label$171,
			};
			if( (TMP$107$3 - 20u) > 0u ) goto label$169;
			goto *tmp$122[TMP$107$3 - 20u];
			label$169:;
		}
	...
	goto label$269;
	label$195:;
	TMP$109$1 = RDTYPE$1 & 31;
	label$269:;
	RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$109$1 * 28));
	...
	if( (-(LDTYPE$1 == 20) | -(RDTYPE$1 == 20)) == 0 ) goto label$204;
	{
		...
		goto label$271;
		label$216:;
		TMP$111$2 = LDTYPE$1 & 31;
		label$271:;
		LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$111$2 * 28));
	...
	if( (-(LDTYPE$1 == 7) | -(RDTYPE$1 == 7)) == 0 ) goto label$217;
	{
		...
		label$219:;
		{
			...
			goto label$272;
			label$226:;
			TMP$112$3 = LDFULL$1 & 31;
			label$272:;
			LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$112$3 * 28));
			if( (RDFULL$1 & 480) == 0 ) goto label$227;
			TMP$113$3 = 24;
			goto label$273;
			label$227:;
			TMP$113$3 = RDFULL$1 & 31;
			label$273:;
			RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$113$3 * 28));
			if( (LDFULL$1 & 480) == 0 ) goto label$228;
			TMP$114$3 = 24;
			goto label$274;
			label$228:;
			TMP$114$3 = LDFULL$1 & 31;
			label$274:;
			LDTYPE$1 = TMP$114$3;
	...
	if( (-(LDTYPE$1 == 4) | -(RDTYPE$1 == 4)) == 0 ) goto label$230;
	{
		...
		goto label$276;
		label$235:;
		TMP$116$2 = LDFULL$1 & 31;
		label$276:;
		LDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$116$2 * 28));
		if( (RDFULL$1 & 480) == 0 ) goto label$236;
		TMP$117$2 = 24;
		goto label$277;
		label$236:;
		TMP$117$2 = RDFULL$1 & 31;
		label$277:;
		RDCLASS$1 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$117$2 * 28));
		if( (LDFULL$1 & 480) == 0 ) goto label$237;
		TMP$118$2 = 24;
		goto label$278;
		label$237:;
		TMP$118$2 = LDFULL$1 & 31;
		label$278:;
		LDTYPE$1 = TMP$118$2;
	...
	if( (-(LDTYPE$1 != RDTYPE$1) | -(*(struct $8FBSYMBOL**)((uint8*)L$1 + 8) != *(struct $8FBSYMBOL**)((uint8*)R$1 + 8))) == 0 ) goto label$245;
	{
		if( RDCLASS$1 == 2 ) goto label$247;
		{
			if( *(int32*)R$1 != 16 ) goto label$249;
			{
				...
				TMP$120$4 = 0;
				label$280:;
				struct $7ASTNODE* vr$144 = ASTNEWCONV( LDFULL$1, LSUBTYPE$1, R$1, TMP$120$4, (int32*)0u );
				R$1 = vr$144;
			...
			if( *(int32*)((uint8*)&ENV$ + 104) != 0 ) goto label$254;
			{
				if( (-(LDCLASS$1 == 1) | -(RDCLASS$1 == 1)) == 0 ) goto label$256;
				{
					...
					{
						DOCONV$3 = -((*(int32*)((uint8*)&IR$ + 276) & 1) != 0);
					}
					label$258:;
					label$257:;
				}
			...
			if( DOCONV$3 == 0 ) goto label$260;
			{
				...
				TMP$121$4 = 0;
				label$281:;
				struct $7ASTNODE* vr$152 = ASTNEWCONV( LDFULL$1, *(struct $8FBSYMBOL**)((uint8*)L$1 + 8), R$1, TMP$121$4, (int32*)0u );
				R$1 = vr$152;
...
static int32 HCHECKSTRINGOPS( struct $7ASTNODE* L$1, $12FB_DATACLASS LDCLASS$1, struct $7ASTNODE* R$1, $12FB_DATACLASS RDCLASS$1 )
{
	...
	{
		int32 TMP$84$2;
		TMP$84$2 = *(int32*)((uint8*)OTHER$1 + 4) & 511;
		if( TMP$84$2 == 4 ) goto label$16;
		label$17:;
		if( TMP$84$2 != 7 ) goto label$15;
		label$16:;
		{
		}
		goto label$14;
...
static int32 HCHECKUDTOPS( struct $7ASTNODE* L$1, $12FB_DATACLASS LDCLASS$1, struct $7ASTNODE** R$1, $12FB_DATACLASS RDCLASS$1, int32 CHECKONLY$1 )
{
	int32 fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$19:;
	...
	if( *(struct $8FBSYMBOL**)((uint8*)L$1 + 8) == *(struct $8FBSYMBOL**)((uint8*)*R$1 + 8) ) goto label$28;
	{
		...
		label$30:;
		label$29:;
		if( CHECKONLY$1 != 0 ) goto label$32;
		{
...
static int32 HCHECKWSTRINGOPS( struct $7ASTNODE* L$1, int32* LDFULL$1, struct $7ASTNODE* R$1, int32* RDFULL$1, int32* IS_ZSTR$1 )
{
	...
	if( LDTYPE$1 != 7 ) goto label$42;
	{
		...
		label$44:;
		label$43:;
		*LDFULL$1 = (*LDFULL$1 & -512) | (*(int32*)((uint8*)&ENV$ + 248) & 511);
	}
	goto label$41;
	label$42:;
	{
		...
		label$46:;
		label$45:;
		*RDFULL$1 = (*RDFULL$1 & -512) | (*(int32*)((uint8*)&ENV$ + 248) & 511);
	}
	label$41:;
	fb$result$1 = -1;
	label$34:;
...
static int32 HCHECKZSTRINGOPS( struct $7ASTNODE* L$1, int32* LDFULL$1, struct $7ASTNODE* R$1, int32* RDFULL$1 )
{
	...
	goto label$292;
	label$49:;
	TMP$87$1 = *LDFULL$1 & 31;
	label$292:;
	if( TMP$87$1 != 4 ) goto label$51;
	{
...
static int32 HCHECKCONSTANDPOINTEROPS( struct $7ASTNODE* L$1, $11FB_DATATYPE LDTYPE$1, struct $7ASTNODE* R$1, $11FB_DATATYPE RDTYPE$1 )
{
	...
	fb$result$1 = 0;
	TMP$88$1 = 0;
	int32 vr$4 = SYMBCHECKCONSTASSIGNTOPLEVEL( LDTYPE$1, RDTYPE$1, *(struct $8FBSYMBOL**)((uint8*)L$1 + 8), *(struct $8FBSYMBOL**)((uint8*)R$1 + 8), 0, &TMP$88$1 );
	...
	if( (LDTYPE$1 & 480) == 0 ) goto label$67;
	{
		...
		goto label$293;
		label$68:;
		TMP$89$2 = RDTYPE$1 & 31;
		label$293:;
		if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$89$2 * 28)) != 1 ) goto label$70;
		{
			goto label$63;
		}
		label$70:;
	...
	if( (RDTYPE$1 & 480) == 0 ) goto label$79;
	{
		...
		goto label$294;
		label$80:;
		TMP$90$2 = LDTYPE$1 & 31;
		label$294:;
		if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$90$2 * 28)) != 1 ) goto label$82;
		{
			goto label$63;
		}
		label$82:;
...
static struct $7ASTNODE* HSHALLOWCOPY( struct $7ASTNODE* L$1, struct $7ASTNODE* R$1, int32 OPTIONS$1 )
{
	...
	{
		BYTESTOCOPY$1 = BYTESTOCOPY$1 - (int64)*(int32*)((uint8*)&ENV$ + 272);
		...
		label$152:;
		label$151:;
		struct $7ASTNODE* vr$21 = _Z19ASTBUILDDEREFADDROFP7ASTNODExlP8FBSYMBOLS2_( L$1, (int64)*(int32*)((uint8*)&ENV$ + 272), 2, (struct $8FBSYMBOL*)0u, (struct $8FBSYMBOL*)0u );
		L$1 = vr$21;
		struct $7ASTNODE* vr$23 = _Z19ASTBUILDDEREFADDROFP7ASTNODExlP8FBSYMBOLS2_( R$1, (int64)*(int32*)((uint8*)&ENV$ + 272), 2, (struct $8FBSYMBOL*)0u, (struct $8FBSYMBOL*)0u );
		R$1 = vr$23;
	}
	label$150:;
	label$149:;
