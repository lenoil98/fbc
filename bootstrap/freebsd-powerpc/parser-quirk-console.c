...
struct $7ASTNODE* CWIDTHSTMT( int32 ISFUNC$1 )
{
	...
	{
		struct $7ASTNODE* vr$15 = HMATCHEXPR( 8 );
		FNUM$1 = vr$15;
		...
		if( vr$16 == 0 ) goto label$51;
		{
			struct $7ASTNODE* vr$17 = HMATCHEXPR( 8 );
			WIDTH_ARG$1 = vr$17;
			if( WIDTH_ARG$1 != (struct $7ASTNODE*)0u ) goto label$53;
			{
				goto label$35;
			}
			label$53:;
		...
		label$51:;
		{
			struct $7ASTNODE* vr$18 = ASTNEWCONSTI( -1ll, 8, (struct $8FBSYMBOL*)0u );
			WIDTH_ARG$1 = vr$18;
		}
		label$50:;
	...
	if( vr$20 == 0 ) goto label$54;
	{
		struct $7ASTNODE* vr$21 = ASTNEWCONSTI( -1ll, 8, (struct $8FBSYMBOL*)0u );
		WIDTH_ARG$1 = vr$21;
		struct $7ASTNODE* vr$22 = HMATCHEXPR( 8 );
		HEIGHT_ARG$1 = vr$22;
		if( HEIGHT_ARG$1 != (struct $7ASTNODE*)0u ) goto label$56;
		{
			goto label$35;
		}
		label$56:;
	...
	label$54:;
	{
		...
		DEV_NAME$1 = vr$24;
		if( DEV_NAME$1 != (struct $7ASTNODE*)0u ) goto label$58;
		{
			goto label$35;
		}
		label$58:;
		label$57:;
		int32 vr$27 = SYMBISSTRING( *(int32*)((uint8*)DEV_NAME$1 + 4) & 511 );
		if( vr$27 == 0 ) goto label$60;
		{
			...
			if( vr$28 == 0 ) goto label$62;
			{
				...
				WIDTH_ARG$1 = vr$29;
				if( WIDTH_ARG$1 != (struct $7ASTNODE*)0u ) goto label$64;
				{
					goto label$35;
				}
				label$64:;
			...
			label$62:;
			{
				struct $7ASTNODE* vr$30 = ASTNEWCONSTI( -1ll, 8, (struct $8FBSYMBOL*)0u );
				WIDTH_ARG$1 = vr$30;
			}
			label$61:;
		...
		label$60:;
		{
			...
			if( vr$32 == 0 ) goto label$66;
			{
				struct $7ASTNODE* vr$33 = HMATCHEXPR( 8 );
				HEIGHT_ARG$1 = vr$33;
				if( HEIGHT_ARG$1 != (struct $7ASTNODE*)0u ) goto label$68;
				{
					goto label$35;
				}
				label$68:;
			...
			label$66:;
			{
				struct $7ASTNODE* vr$34 = ASTNEWCONSTI( -1ll, 8, (struct $8FBSYMBOL*)0u );
				HEIGHT_ARG$1 = vr$34;
			}
			label$65:;
	...
	label$43:;
	if( CHECKRPRNT$1 == 0 ) goto label$70;
	{
		int32 vr$36 = LEXGETTOKEN( 0 );
		if( vr$36 == 41 ) goto label$72;
		{
			ERRREPORT( 7, 0, (uint8*)0u );
			HSKIPUNTIL( 41, -1, 0, 0 );
		}
...
struct $7ASTNODE* CCOLORSTMT( int32 ISFUNC$1 )
{
	...
	fb$result$1 = (struct $7ASTNODE*)0u;
	LEXSKIPTOKEN( 2048 );
	if( ISFUNC$1 == 0 ) goto label$76;
	{
		int32 vr$2 = HMATCH( 40, 0 );
		if( vr$2 != -1 ) goto label$78;
		{
			struct $7ASTNODE* vr$3 = CEXPRESSION(  );
			FORE_COLOR$1 = vr$3;
			int32 vr$4 = HMATCH( 44, 0 );
			if( vr$4 != -1 ) goto label$80;
			{
				struct $7ASTNODE* vr$5 = HMATCHEXPR( -1 );
				BACK_COLOR$1 = vr$5;
				if( BACK_COLOR$1 != (struct $7ASTNODE*)0u ) goto label$82;
				{
					goto label$74;
				}
				label$82:;
	...
	label$76:;
	{
		...
		if( vr$7 != -1 ) goto label$86;
		{
			struct $7ASTNODE* vr$8 = CEXPRESSION(  );
			FORE_COLOR$1 = vr$8;
			int32 vr$9 = HMATCH( 44, 0 );
			if( vr$9 != -1 ) goto label$88;
			{
				struct $7ASTNODE* vr$10 = HMATCHEXPR( -1 );
				BACK_COLOR$1 = vr$10;
				if( BACK_COLOR$1 != (struct $7ASTNODE*)0u ) goto label$90;
				{
					goto label$74;
				}
				label$90:;
			...
			label$88:;
			{
				...
				if( vr$13 != -1 ) goto label$96;
				{
					struct $7ASTNODE* vr$14 = HMATCHEXPR( -1 );
					BACK_COLOR$1 = vr$14;
					if( BACK_COLOR$1 != (struct $7ASTNODE*)0u ) goto label$98;
					{
						goto label$74;
					}
					label$98:;
		...
		label$86:;
		{
			...
			FORE_COLOR$1 = vr$15;
			int32 vr$16 = HMATCH( 44, 0 );
			if( vr$16 != -1 ) goto label$100;
			{
				struct $7ASTNODE* vr$17 = HMATCHEXPR( -1 );
				BACK_COLOR$1 = vr$17;
				if( BACK_COLOR$1 != (struct $7ASTNODE*)0u ) goto label$102;
				{
					goto label$74;
				}
				label$102:;
...
struct $7ASTNODE* CSCREENFUNCT( void )
{
	...
	label$106:;
	label$105:;
	if( YEXPR$1 != (struct $7ASTNODE*)0u ) goto label$108;
	{
	...
	label$108:;
	{
		...
		XEXPR$2 = vr$7;
		if( XEXPR$2 != (struct $7ASTNODE*)0u ) goto label$112;
		{
			goto label$104;
		}
		label$112:;
		...
		if( vr$8 == 0 ) goto label$114;
		{
			struct $7ASTNODE* vr$9 = HMATCHEXPR( 8 );
			FEXPR$2 = vr$9;
			if( FEXPR$2 != (struct $7ASTNODE*)0u ) goto label$116;
			{
				goto label$104;
			}
			label$116:;
	...
	label$107:;
	if( MATCH_PAREN$1 == 0 ) goto label$118;
	{
		int32 vr$11 = LEXGETTOKEN( 0 );
		if( vr$11 == 41 ) goto label$120;
		{
			ERRREPORT( 7, 0, (uint8*)0u );
			HSKIPUNTIL( 41, -1, 0, 0 );
		}
