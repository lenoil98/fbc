...
void PARSERSETCTX( void )
{
	...
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) = (struct $8FBSYMBOL*)0u;
...
void CPROGRAM( void )
{
	...
	label$26:;
	{
		...
		label$38:;
		label$37:;
		struct $7ASTNODE* vr$9 = ASTNEWDBG( 113, *(int32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16564), *(uint8**)((uint8*)&ENV$ + 544) );
		ASTADD( vr$9 );
		CLABEL(  );
		CSTATEMENT(  );
		CCOMMENT( 0 );
		int32 vr$10 = FBSHOULDCONTINUE(  );
		...
		label$40:;
		label$39:;
		if( *(int32*)((uint8*)&ENV$ + 148) == 0 ) goto label$42;
		{
			if( *(int32*)((uint8*)&ENV$ + 876) != 0 ) goto label$44;
			{
		...
		int32 vr$12 = FBSHOULDCONTINUE(  );
		if( vr$12 != 0 ) goto label$52;
		{
			goto label$25;
		}
		label$52:;
		label$51:;
		struct $7ASTNODE* vr$13 = ASTNEWDBG( 114, 0, (uint8*)0u );
		ASTADD( vr$13 );
		*(int32*)((uint8*)&PARSER$ + 28) = *(int32*)((uint8*)&PARSER$ + 28) + 1;
	}
	label$28:;
	int32 vr$15 = LEXGETTOKEN( 0 );
	if( vr$15 != 256 ) goto label$26;
	label$27:;
	if( *(int32*)((uint8*)&PP$ + 216) == STARTLEVEL$1 ) goto label$54;
	{
	...
	label$53:;
	LEXSKIPTOKEN( 0 );
	if( *(int32*)((uint8*)&ENV$ + 876) != 0 ) goto label$56;
	{
		CCOMPSTMTCHECK(  );
	}
	label$56:;
	...
	{
		{
			...
			label$83:;
			{
				if( (-(TOKEN$1 == 44) | STOP_ON_COMMA$1) == 0 ) goto label$85;
				{
					if( PRNTCNT$1 != 0 ) goto label$87;
					{
						goto label$60;
					}
					label$87:;
			...
			if( (TMP$94$3 - 40u) > 220u ) goto label$88;
			goto *tmp$95[TMP$94$3 - 40u];
			label$62:;
		}
...
void HSKIPCOMPOUND( int32 FOR_TOKEN$1, int32 UNTIL_TOKEN$1, $8LEXCHECK FLAGS$1 )
{
	...
	if( UNTIL_TOKEN$1 != -1 ) goto label$98;
	{
	...
	{
		{
			...
			TMP$96$3 = vr$2;
			if( TMP$96$3 != 256 ) goto label$103;
			label$104:;
			{
				goto label$96;
			}
			goto label$102;
			label$103:;
			if( TMP$96$3 != 257 ) goto label$105;
			label$106:;
			{
				ISCOMMENT$1 = 0;
			}
			goto label$102;
			label$105:;
			if( TMP$96$3 == 259 ) goto label$108;
			label$109:;
			if( TMP$96$3 != 260 ) goto label$107;
			label$108:;
			{
				ISCOMMENT$1 = -1;
			}
			goto label$102;
			label$107:;
			if( TMP$96$3 != 340 ) goto label$110;
			label$111:;
			{
				if( ISCOMMENT$1 != 0 ) goto label$113;
				{
					int32 vr$3 = LEXGETLOOKAHEAD( 1, FLAGS$1 );
					if( vr$3 != UNTIL_TOKEN$1 ) goto label$115;
					{
						LEXSKIPTOKEN( FLAGS$1 );
						if( CNT$1 <= 0 ) goto label$117;
						{
							CNT$1 = CNT$1 + -1;
						}
						label$117:;
						label$116:;
						if( CNT$1 != 0 ) goto label$119;
						{
							goto label$100;
						}
						label$119:;
			...
			goto label$102;
			label$110:;
			if( TMP$96$3 != FOR_TOKEN$1 ) goto label$120;
			label$121:;
			{
				if( ISCOMMENT$1 != 0 ) goto label$123;
				{
					CNT$1 = CNT$1 + 1;
				}
				label$123:;
...
struct $7ASTNODE* HMATCHEXPR( int32 DTYPE$1 )
{
	...
	if( EXPR$1 != (struct $7ASTNODE*)0u ) goto label$127;
	{
		...
		if( DTYPE$1 != -2147483648u ) goto label$129;
		{
...
static void HEMITCURRENTLINETEXT( void )
{
	...
	if( N$1 == (struct $7ASTNODE*)0u ) goto label$19;
	{
		if( *(int32*)N$1 != 30 ) goto label$21;
		{
			...
			{
				struct $7ASTNODE* vr$4 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 49392) );
