...
void CWITHSTMTBEGIN( void )
{
	...
	label$20:;
	struct $7ASTNODE* T$1;
	struct $7ASTNODE* vr$11 = HEXTENDTEMPLIFETIME( *(struct $8FBSYMBOL**)((uint8*)SCOPENODE$1 + 12) );
	T$1 = vr$11;
	...
	if( *(int32*)EFFECTIVEEXPR$1 != 17 ) goto label$27;
	{
		...
		struct $7ASTNODE* vr$16 = ASTNEWLINK( T$1, vr$15, 2 );
		T$1 = vr$16;
	}
	goto label$26;
	label$27:;
	{
		...
		EXPR$1 = vr$17;
		OPTIONS$1 = 0;
		if( (*(int32*)((uint8*)&ENV$ + 888) & 2) != 0 ) goto label$29;
		{
			OPTIONS$1 = OPTIONS$1 | 2;
		}
		label$29:;
		label$28:;
		struct $8FBSYMBOL* vr$22 = SYMBADDIMPLICITVAR( *(int32*)((uint8*)EXPR$1 + 4), *(struct $8FBSYMBOL**)((uint8*)EXPR$1 + 8), OPTIONS$1 );
		SYM$1 = vr$22;
		if( (OPTIONS$1 & 2) == 0 ) goto label$31;
		{
			struct $7ASTNODE* vr$24 = ASTNEWDECL( SYM$1, -1 );
			ASTADDUNSCOPED( vr$24 );
			struct $7ASTNODE* vr$25 = ASTNEWVAR( SYM$1, 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
			struct $7ASTNODE* vr$26 = ASTNEWASSIGN( vr$25, EXPR$1, 0 );
			struct $7ASTNODE* vr$27 = ASTNEWLINK( T$1, vr$26, 2 );
			T$1 = vr$27;
		}
		goto label$30;
		label$31:;
		{
			struct $7ASTNODE* vr$28 = ASTNEWDECL( SYM$1, 0 );
			struct $7ASTNODE* vr$29 = ASTNEWLINK( T$1, vr$28, 2 );
			T$1 = vr$29;
			struct $7ASTNODE* vr$30 = ASTNEWVAR( SYM$1, 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
			struct $7ASTNODE* vr$31 = ASTNEWASSIGN( vr$30, EXPR$1, 64 );
			struct $7ASTNODE* vr$32 = ASTNEWLINK( T$1, vr$31, 2 );
			T$1 = vr$32;
		}
		label$30:;
		IS_PTR$1 = -1;
	...
	label$26:;
	ASTADD( T$1 );
	struct $13FB_CMPSTMTSTK* vr$33 = CCOMPSTMTPUSH( 280, 1 );
	STK$1 = vr$33;
