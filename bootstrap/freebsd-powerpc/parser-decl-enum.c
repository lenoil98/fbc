	...
	label$23:;
	{
		...
		label$27:;
		{
			...
			label$31:;
			{
				...
				{
					{
						...
						TMP$95$6 = vr$7;
						if( TMP$95$6 != 0 ) goto label$38;
						label$39:;
						{
							if( (*(int32*)((uint8*)&ENV$ + 888) & 524288) == 0 ) goto label$41;
							{
								if( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 98536) == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 98352) ) goto label$43;
								{
									if( *(int32*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16548) + 4120) <= 0 ) goto label$45;
									{
						...
						goto label$37;
						label$38:;
						if( TMP$95$6 != 2 ) goto label$46;
						label$47:;
						{
							if( (-(*(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 98536) == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 98352)) | -(*(uint32*)((uint8*)&PARSER$ + 96) > 0u)) == 0 ) goto label$49;
							{
				...
				{
					if( *(int32*)((uint8*)&ENV$ + 876) != 0 ) goto label$58;
					{
						struct $7ASTNODE* vr$24 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 49392) );
						ASTADD( vr$24 );
...
void CENUMDECL( $13FB_SYMBATTRIB ATTRIB$1 )
{
	...
	CCURRENTPARENTID(  );
	{
		...
		TMP$96$2 = vr$0;
		if( TMP$96$2 == 0 ) goto label$67;
		label$68:;
		if( TMP$96$2 != 2 ) goto label$66;
		label$67:;
		{
			if( (*(int32*)((uint8*)&ENV$ + 888) & 524288) == 0 ) goto label$70;
			{
				if( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 98536) == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 98352) ) goto label$72;
				{
					if( *(int32*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16548) + 4120) <= 0 ) goto label$74;
					{
						ERRREPORT( 90, 0, (uint8*)0u );
					}
					label$74:;
			...
			fb_StrAssign( (void*)ID$1, 129, (void*)vr$5, 0, 0 );
			LEXSKIPTOKEN( 4096 );
		}
		goto label$65;
		label$66:;
	...
	label$76:;
	int32 USE_HASHTB$1;
	USE_HASHTB$1 = -(*(int32*)((uint8*)&PARSER$ + 100) == 0);
	USE_HASHTB$1 = USE_HASHTB$1 | ISEXPLICIT$1;
	struct $8FBSYMBOL* vr$11 = SYMBADDENUM( (uint8*)ID$1, PALIAS$1, ATTRIB$1, USE_HASHTB$1 );
	E$1 = vr$11;
	if( E$1 != (struct $8FBSYMBOL*)0u ) goto label$79;
	{
		ERRREPORTEX( 4, (uint8*)ID$1, 0, 1, (uint8*)0u );
		uint8* vr$12 = SYMBUNIQUELABEL(  );
		struct $8FBSYMBOL* vr$13 = SYMBADDENUM( vr$12, (uint8*)0u, 0, USE_HASHTB$1 );
		E$1 = vr$13;
	}
	label$79:;
	label$78:;
	CCOMMENT( 0 );
	if( *(int32*)((uint8*)&ENV$ + 148) == 0 ) goto label$81;
	{
		if( *(int32*)((uint8*)&ENV$ + 876) != 0 ) goto label$83;
		{
			struct $7ASTNODE* vr$15 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 49392) );
			ASTADD( vr$15 );
			DZSTRRESET( (struct $8DZSTRING*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 49392) );
		}
		label$83:;
	...
	label$81:;
	label$80:;
	int32 vr$18 = CSTMTSEPARATOR( 0 );
	if( vr$18 != 0 ) goto label$85;
	{
	...
	label$85:;
	label$84:;
	if( USE_HASHTB$1 == 0 ) goto label$87;
	{
		SYMBNESTBEGIN( E$1, 0 );
	}
	label$87:;
	...
	label$91:;
	{
		...
		{
			LEXSKIPTOKEN( 2048 );
			if( ISEXPLICIT$1 != 0 ) goto label$95;
			{
				if( USE_HASHTB$1 == 0 ) goto label$97;
				{
...
static void HENUMCONSTDECL( uint8* ID$1, int64* VALUE$1 )
{
	...
	if( vr$0 == 0 ) goto label$13;
	{
		...
		label$98:;
		if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$93$2 * 28)) == 0 ) goto label$20;
		{
