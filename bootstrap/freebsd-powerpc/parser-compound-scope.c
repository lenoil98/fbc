...
void CSCOPESTMTBEGIN( void )
{
	...
	if( (*(int32*)((uint8*)&ENV$ + 888) & 2) != 0 ) goto label$13;
	{
	...
	*(int32*)((uint8*)STK$1 + 16) = -((*(int32*)((uint8*)&PARSER$ + 148) & 8) != 0);
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 148) = *(int32*)((uint8*)&PARSER$ + 148) | 8;
	}
	goto label$16;
	label$17:;
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 148) = *(int32*)((uint8*)&PARSER$ + 148) & -9;
	}
	label$16:;
	label$11:;
}
