...
void DZSTRASSIGNW( struct $8DZSTRING* DST$1, uint32* SRC$1 )
{
	...
	int32 vr$0 = fb_WstrLen( (uint32*)SRC$1 );
	TMP$84$1 = vr$0;
	goto label$47;
	label$38:;
	TMP$84$1 = 0;
...
void DZSTRCONCATASSIGNW( struct $8DZSTRING* DST$1, uint32* SRC$1 )
{
	...
	{
		fb_WstrAssignToA( (void*)((uint8*)*(uint8**)DST$1 + DST_LEN$1), 0, (uint32*)SRC$1, 0 );
	}
	label$72:;
	label$71:;
	label$67:;
...
void DWSTRASSIGN( struct $8DWSTRING* DST$1, uint32* SRC$1 )
{
	...
	{
		fb_WstrAssign( *(uint32**)DST$1, 0, (uint32*)SRC$1 );
	}
	label$104:;
	label$103:;
	label$95:;
...
void DWSTRCONCATASSIGN( struct $8DWSTRING* DST$1, uint32* SRC$1 )
{
	...
	{
		fb_WstrAssign( (uint32*)((uint8*)*(uint32**)DST$1 + (DST_LEN$1 << (2 & 31))), 0, (uint32*)SRC$1 );
	}
	label$134:;
	label$133:;
	label$129:;
