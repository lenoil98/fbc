...
void PPCONDIF( void )
{
	...
	ISTRUE$1 = 0;
	{
		...
		TMP$94$2 = (uint32)vr$0;
		goto label$28;
		label$29:;
		{
			LEXSKIPTOKEN( 2050 );
			struct $10FBSYMCHAIN* vr$2 = CIDENTIFIER( &BASE_PARENT$1, 0 );
			if( vr$2 == (struct $10FBSYMCHAIN*)0u ) goto label$31;
			{
				ISTRUE$1 = -1;
			}
			label$31:;
		...
		{
			LEXSKIPTOKEN( 2050 );
			struct $10FBSYMCHAIN* vr$4 = CIDENTIFIER( &BASE_PARENT$1, 0 );
			if( vr$4 != (struct $10FBSYMCHAIN*)0u ) goto label$34;
			{
				ISTRUE$1 = -1;
			}
			label$34:;
		...
		if( (TMP$94$2 - 266u) > 2u ) goto label$27;
		goto *tmp$95[TMP$94$2 - 266u];
		label$27:;
	}
	*(int32*)((uint8*)&PP$ + 216) = *(int32*)((uint8*)&PP$ + 216) + 1;
	if( *(int32*)((uint8*)&PP$ + 216) <= 64 ) goto label$37;
	{
	...
	label$37:;
	label$36:;
	*(int32*)(((uint8*)PPTB$ + (*(int32*)((uint8*)&PP$ + 216) << (3 & 31))) + -8) = ISTRUE$1;
	*(int32*)(((uint8*)PPTB$ + (*(int32*)((uint8*)&PP$ + 216) << (3 & 31))) + -4) = 0;
	if( ISTRUE$1 != 0 ) goto label$39;
	{
		PPSKIP(  );
	}
	label$39:;
...
void PPCONDELSE( void )
{
	...
	int32 ISTRUE$1;
	ISTRUE$1 = 0;
	if( *(int32*)((uint8*)&PP$ + 216) != 0 ) goto label$43;
	{
	...
	label$43:;
	label$42:;
	if( *(int32*)(((uint8*)PPTB$ + (*(int32*)((uint8*)&PP$ + 216) << (3 & 31))) + -4) <= 0 ) goto label$45;
	{
	...
	if( vr$1 != 270 ) goto label$47;
	{
		LEXSKIPTOKEN( 2048 );
		int32 vr$2 = PPEXPRESSION(  );
		ISTRUE$1 = vr$2;
		if( *(int32*)(((uint8*)PPTB$ + (*(int32*)((uint8*)&PP$ + 216) << (3 & 31))) + -8) == 0 ) goto label$49;
		{
			PPSKIP(  );
			goto label$41;
		}
	...
	{
		LEXSKIPTOKEN( 2048 );
		*(int32*)(((uint8*)PPTB$ + (*(int32*)((uint8*)&PP$ + 216) << (3 & 31))) + -4) = *(int32*)(((uint8*)PPTB$ + (*(int32*)((uint8*)&PP$ + 216) << (3 & 31))) + -4) + 1;
		*(int32*)(((uint8*)PPTB$ + (*(int32*)((uint8*)&PP$ + 216) << (3 & 31))) + -8) = ~(*(int32*)(((uint8*)PPTB$ + (*(int32*)((uint8*)&PP$ + 216) << (3 & 31))) + -8));
	}
	label$46:;
	if( *(int32*)(((uint8*)PPTB$ + (*(int32*)((uint8*)&PP$ + 216) << (3 & 31))) + -8) != 0 ) goto label$51;
	{
		PPSKIP(  );
	}
	label$51:;
...
void PPCONDENDIF( void )
{
	label$52:;
	LEXSKIPTOKEN( 2048 );
	if( *(int32*)((uint8*)&PP$ + 216) <= 0 ) goto label$55;
	{
		*(int32*)((uint8*)&PP$ + 216) = *(int32*)((uint8*)&PP$ + 216) + -1;
	}
	goto label$54;
...
static int32 PPEXPRESSION( void )
{
	...
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 148) = *(int32*)((uint8*)&PARSER$ + 148) | 1024;
	}
	goto label$16;
	label$17:;
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 148) = *(int32*)((uint8*)&PARSER$ + 148) & -1025;
	}
	label$16:;
...
static void PPSKIP( void )
{
	...
	*(int32*)((uint8*)&PP$ + 220) = -1;
	...
	{
		if( *(int32*)((uint8*)&ENV$ + 876) != 0 ) goto label$65;
		{
			struct $7ASTNODE* vr$1 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 49392) );
			ASTADD( vr$1 );
	...
	{
		{
			...
			label$73:;
			{
				LEXSKIPTOKEN( 256 );
				{
					...
					{
						{
							if( IFLEVEL$1 != *(int32*)((uint8*)&PP$ + 216) ) goto label$79;
							label$80:;
							{
					...
					{
						{
							if( IFLEVEL$1 != *(int32*)((uint8*)&PP$ + 216) ) goto label$85;
							label$86:;
							{
								*(int32*)((uint8*)&PP$ + 220) = 0;
								PPCONDENDIF(  );
					...
					if( (TMP$97$5 - 266u) > 20u ) goto label$91;
					goto *tmp$98[TMP$97$5 - 266u];
					label$74:;
				}
			}
			goto label$71;
			label$72:;
			if( TMP$96$3 != 256 ) goto label$92;
			label$93:;
			{
