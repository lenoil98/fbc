...
void CTYPEOF( int32*, struct $8FBSYMBOL**, int64*, int32* );
...
int32 HISCONSTINRANGE( int32 DTYPE$1, int64 VALUE$1, int32 TODTYPE$1 )
{
	...
	static struct $8FBARRAY1I11RANGEVALUESE tmp$94$1 = { (struct $11RANGEVALUES*)RANGE$1, (struct $11RANGEVALUES*)RANGE$1, 216, 24, 1, 49, { { 9, 0, 8 } } };
	struct $11RANGEVALUES* R$1;
	if( (TODTYPE$1 & 480) == 0 ) goto label$18;
	TMP$95$1 = 24;
	goto label$36;
	label$18:;
	TMP$95$1 = TODTYPE$1 & 31;
	label$36:;
	R$1 = (struct $11RANGEVALUES*)((uint8*)RANGE$1 + (*(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$95$1 * 28)) + 20) * 24));
	...
	TMP$96$1 = DTYPE$1 & 31;
	label$37:;
	if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$96$1 * 28)) + 8) == 0 ) goto label$21;
	{
		int32 TMP$97$2;
		...
		goto label$38;
		label$22:;
		TMP$97$2 = TODTYPE$1 & 31;
		label$38:;
		if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$97$2 * 28)) + 8) == 0 ) goto label$24;
		{
		...
		label$24:;
		{
			...
			goto label$40;
			label$26:;
			TMP$99$3 = TODTYPE$1 & 31;
			label$40:;
			if( (-(*(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$98$3 * 28)) + 20) == 7) & -(*(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$99$3 * 28)) + 20) == 8)) == 0 ) goto label$28;
			{
	...
	label$21:;
	{
		...
		goto label$41;
		label$29:;
		TMP$100$2 = TODTYPE$1 & 31;
		label$41:;
		if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$100$2 * 28)) + 8) == 0 ) goto label$31;
		{
			int32 TMP$101$3;
			int32 TMP$102$3;
			...
			goto label$42;
			label$32:;
			TMP$101$3 = DTYPE$1 & 31;
			label$42:;
			if( (TODTYPE$1 & 480) == 0 ) goto label$33;
			TMP$102$3 = 24;
			goto label$43;
			label$33:;
			TMP$102$3 = TODTYPE$1 & 31;
			label$43:;
			if( (-(*(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$101$3 * 28)) + 20) == 8) & -(*(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$102$3 * 28)) + 20) == 7)) == 0 ) goto label$35;
			{
...
struct $7ASTNODE* CTYPEOREXPRESSION( int32 TK$1, int32* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1, int64* LGT$1, int32* IS_FIXLENSTR$1 )
{
	...
	int32 vr$4 = LEXGETLOOKAHEAD( 1, 0 );
	if( (-(vr$2 == 265) & -(vr$4 == 41)) == 0 ) goto label$99;
	{
		struct $10FBSYMCHAIN* CHAIN_$2;
		CHAIN_$2 = *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16548) + 4116);
	...
	label$104:;
	if( ((MAYBE_TYPE$1 & -(TK$1 == 463)) & -(*(int32*)((uint8*)&ENV$ + 136) == 3)) == 0 ) goto label$118;
	{
		MAYBE_TYPE$1 = 0;
	}
	label$118:;
...
void CTYPEOF( int32* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1, int64* LGT$1, int32* IS_FIXLENSTR$1 )
{
	label$127:;
	struct $7ASTNODE* EXPR$1;
	struct $7ASTNODE* vr$0 = CTYPEOREXPRESSION( 377, DTYPE$1, SUBTYPE$1, LGT$1, IS_FIXLENSTR$1 );
	EXPR$1 = vr$0;
	if( EXPR$1 != (struct $7ASTNODE*)0u ) goto label$130;
	{
		CUDTTYPEMEMBER( DTYPE$1, SUBTYPE$1, LGT$1, IS_FIXLENSTR$1 );
		goto label$128;
	}
	label$130:;
	label$129:;
	struct $7ASTNODE* vr$1 = ASTREMOVENIDXARRAY( EXPR$1 );
	EXPR$1 = vr$1;
	*DTYPE$1 = *(int32*)((uint8*)EXPR$1 + 4);
	*SUBTYPE$1 = *(struct $8FBSYMBOL**)((uint8*)EXPR$1 + 8);
	int64 vr$6 = ASTSIZEOF( EXPR$1, IS_FIXLENSTR$1 );
	*LGT$1 = vr$6;
	ASTDELTREE( EXPR$1 );
	label$128:;
}
...
int32 CSYMBOLTYPE( int32* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1, int64* LGT$1, int32* IS_FIXLENSTR$1, $14FB_SYMBTYPEOPT OPTIONS$1 )
{
	...
	*IS_FIXLENSTR$1 = 0;
	...
	if( vr$5 != 377 ) goto label$189;
	{
		LEXSKIPTOKEN( 2048 );
		int32 vr$6 = HMATCH( 40, 0 );
		if( vr$6 != 0 ) goto label$191;
		{
		...
		int32 vr$7 = HMATCH( 41, 0 );
		if( vr$7 != 0 ) goto label$193;
		{
	...
	label$189:;
	{
		...
		label$195:;
		label$194:;
		int32 vr$9 = HMATCH( 375, 2048 );
		ISUNSIGNED$1 = vr$9;
		{
			uint32 TMP$127$3;
			int32 vr$10 = LEXGETTOKEN( 0 );
			TMP$127$3 = (uint32)vr$10;
			goto label$197;
			label$198:;
			{
				LEXSKIPTOKEN( 2048 );
			...
			{
				LEXSKIPTOKEN( 2048 );
				int32 vr$17 = HMATCH( 301, 0 );
				if( vr$17 == 0 ) goto label$206;
				{
					struct $7ASTNODE* vr$18 = CGTINPARENSONLYEXPR(  );
					int64 vr$19 = CCONSTINTEXPR( vr$18, 8 );
					*LGT$1 = vr$19;
					$11FB_DATATYPE vr$22 = HINTEGERTYPEFROMBITSIZE( *LGT$1, 0 );
					*DTYPE$1 = vr$22;
					int32 vr$24 = HMATCH( 300, 0 );
					if( vr$24 != 0 ) goto label$208;
					{
			...
			{
				LEXSKIPTOKEN( 2048 );
				int32 vr$26 = HMATCH( 301, 0 );
				if( vr$26 == 0 ) goto label$211;
				{
					struct $7ASTNODE* vr$27 = CGTINPARENSONLYEXPR(  );
					int64 vr$28 = CCONSTINTEXPR( vr$27, 8 );
					*LGT$1 = vr$28;
					$11FB_DATATYPE vr$31 = HINTEGERTYPEFROMBITSIZE( *LGT$1, -1 );
					*DTYPE$1 = vr$31;
					int32 vr$33 = HMATCH( 300, 0 );
					if( vr$33 != 0 ) goto label$213;
					{
						ERRREPORT( 309, -1, (uint8*)0u );
					}
					label$213:;
			...
			label$223:;
			{
				int32 vr$44 = LEXGETTOKEN( 0 );
				ISFUNCTION$1 = -(vr$44 == 346);
				LEXSKIPTOKEN( 2048 );
				*DTYPE$1 = 54;
				PTR_CNT$1 = PTR_CNT$1 + 1;
				struct $8FBSYMBOL* vr$48 = CSYMBOLTYPEFUNCPTR( ISFUNCTION$1 );
				*SUBTYPE$1 = vr$48;
				if( *SUBTYPE$1 != (struct $8FBSYMBOL*)0u ) goto label$225;
				{
					goto label$187;
				}
				label$225:;
			...
			if( (TMP$127$3 - 345u) > 27u ) goto label$196;
			goto *tmp$144[TMP$127$3 - 345u];
			label$196:;
		}
		if( *DTYPE$1 == -2147483648u ) goto label$227;
		{
			{
				int32 TMP$128$4;
				TMP$128$4 = *DTYPE$1 & 511;
				if( TMP$128$4 == 4 ) goto label$230;
				label$231:;
				if( TMP$128$4 != 7 ) goto label$229;
				label$230:;
				{
					*LGT$1 = 0ll;
				}
				...
				label$229:;
				{
					...
					goto label$340;
					label$233:;
					TMP$129$5 = *DTYPE$1 & 31;
					label$340:;
					*LGT$1 = (int64)*(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$129$5 * 28)) + 4);
				}
				label$232:;
				label$228:;
			}
		...
		label$227:;
		{
			...
			int32 CHECK_ID$3;
			CHECK_ID$3 = -1;
			if( *(struct $13FB_CMPSTMTSTK**)((uint8*)&PARSER$ + 52) == (struct $13FB_CMPSTMTSTK*)0u ) goto label$235;
			{
				int32 vr$62 = LEXGETTOKEN( 0 );
				if( vr$62 != 46 ) goto label$237;
				{
					int32 vr$63 = LEXGETLOOKAHEAD( 1, 64 );
					CHECK_ID$3 = -(vr$63 == 46);
				}
				label$237:;
				label$236:;
			...
			label$235:;
			label$234:;
			if( CHECK_ID$3 == 0 ) goto label$239;
			{
				int32 TMP$130$4;
				if( (OPTIONS$1 & 8) == 0 ) goto label$240;
				TMP$130$4 = 0;
				goto label$341;
				label$240:;
				TMP$130$4 = 50;
				label$341:;
				struct $10FBSYMCHAIN* vr$67 = CIDENTIFIER( &BASE_PARENT$3, TMP$130$4 );
				CHAIN_$3 = vr$67;
			}
			label$239:;
			label$238:;
			if( CHAIN_$3 == (struct $10FBSYMCHAIN*)0u ) goto label$242;
			{
				if( (OPTIONS$1 & 8) == 0 ) goto label$244;
				{
					{
						$12FB_SYMBCLASS TMP$131$6;
						TMP$131$6 = *($12FB_SYMBCLASS*)*(struct $8FBSYMBOL**)CHAIN_$3;
						if( TMP$131$6 == 2 ) goto label$247;
						label$248:;
						if( TMP$131$6 == 1 ) goto label$247;
						label$249:;
						if( TMP$131$6 != 12 ) goto label$246;
						label$247:;
						{
				...
				label$250:;
				{
					...
					{
						{
							$12FB_SYMBCLASS TMP$132$7;
							TMP$132$7 = *($12FB_SYMBCLASS*)SYM$5;
							if( TMP$132$7 != 10 ) goto label$257;
							label$258:;
							{
								LEXSKIPTOKEN( 2048 );
								*DTYPE$1 = 20;
							...
							goto label$256;
							label$257:;
							if( TMP$132$7 != 9 ) goto label$259;
							label$260:;
							{
								LEXSKIPTOKEN( 2048 );
								*DTYPE$1 = 10;
								*SUBTYPE$1 = SYM$5;
								*LGT$1 = (int64)*(int32*)((uint8*)SYMB_DTYPETB$ + 284);
								goto label$251;
							}
							goto label$256;
							label$259:;
							if( TMP$132$7 != 13 ) goto label$261;
							label$262:;
							{
								LEXSKIPTOKEN( 2048 );
					...
					label$255:;
					if( SYM$5 != (struct $8FBSYMBOL*)0u ) goto label$253;
					label$254:;
					CHAIN_$3 = *(struct $10FBSYMCHAIN**)((uint8*)CHAIN_$3 + 4);
				}
				label$252:;
				if( CHAIN_$3 != (struct $10FBSYMCHAIN*)0u ) goto label$250;
				label$251:;
				if( (OPTIONS$1 & 8) == 0 ) goto label$264;
				{
					if( *DTYPE$1 == -2147483648u ) goto label$266;
					{
						*(struct $10FBSYMCHAIN**)((uint8*)&PARSER$ + 92) = (struct $10FBSYMCHAIN*)0u;
					}
					label$266:;
		...
		label$226:;
		if( *DTYPE$1 != -2147483648u ) goto label$268;
		{
			if( ISUNSIGNED$1 == 0 ) goto label$270;
			{
				ERRREPORT( 17, 0, (uint8*)0u );
			}
			label$270:;
			label$269:;
			if( IS_CONST$1 == 0 ) goto label$272;
			{
				*DTYPE$1 = 512;
			}
			label$272:;
		...
		label$268:;
		label$267:;
		if( ISUNSIGNED$1 == 0 ) goto label$274;
		{
			{
				int32 TMP$133$4;
				uint32 TMP$134$4;
				if( (*DTYPE$1 & 480) == 0 ) goto label$275;
				TMP$133$4 = 24;
				goto label$342;
				label$275:;
				TMP$133$4 = *DTYPE$1 & 31;
				label$342:;
				TMP$134$4 = (uint32)TMP$133$4;
				goto label$277;
				label$278:;
				{
					*DTYPE$1 = 3;
				...
				label$281:;
				{
					if( (*DTYPE$1 & 32505856) == 0 ) goto label$283;
					{
						*DTYPE$1 = 9437196;
					}
					goto label$282;
				...
				if( (TMP$134$4 - 2u) > 11u ) goto label$285;
				goto *tmp$145[TMP$134$4 - 2u];
				label$276:;
			}
		}
		label$274:;
	...
	label$188:;
	int32 vr$113 = LEXGETTOKEN( 0 );
	if( vr$113 != 42 ) goto label$287;
	{
		LEXSKIPTOKEN( 0 );
		struct $7ASTNODE* vr$114 = CEQINPARENSONLYEXPR(  );
		int64 vr$115 = CCONSTINTEXPR( vr$114, 8 );
		*LGT$1 = vr$115;
		*IS_FIXLENSTR$1 = -1;
		{
			int32 TMP$135$3;
			uint32 TMP$136$3;
			if( (*DTYPE$1 & 480) == 0 ) goto label$288;
			TMP$135$3 = 24;
			goto label$343;
			label$288:;
			TMP$135$3 = *DTYPE$1 & 31;
			label$343:;
			TMP$136$3 = (uint32)TMP$135$3;
			goto label$290;
			label$291:;
			{
				*LGT$1 = *LGT$1 + 1ll;
				if( *LGT$1 > 1ll ) goto label$293;
				{
					ERRREPORT( 17, -1, (uint8*)0u );
					*LGT$1 = 2ll;
				}
			...
			label$294:;
			{
				...
				goto label$344;
				label$297:;
				TMP$137$4 = *DTYPE$1 & 31;
				label$344:;
				if( TMP$137$4 != 7 ) goto label$299;
				{
			...
			if( (TMP$136$3 - 4u) > 13u ) goto label$300;
			goto *tmp$146[TMP$136$3 - 4u];
			label$289:;
		}
		if( (OPTIONS$1 & 4) == 0 ) goto label$302;
		{
			ERRREPORT( 324, -1, (uint8*)0u );
		}
		label$302:;
		label$301:;
		if( IS_CONST$1 == 0 ) goto label$304;
		{
			*DTYPE$1 = *DTYPE$1 | 512;
		}
		label$304:;
	...
	label$287:;
	{
		if( IS_CONST$1 == 0 ) goto label$306;
		{
			*DTYPE$1 = *DTYPE$1 | 512;
		}
		label$306:;
		...
		label$307:;
		{
			{
				uint32 TMP$138$4;
				int32 vr$145 = LEXGETTOKEN( 0 );
				TMP$138$4 = (uint32)vr$145;
				goto label$311;
				label$312:;
				{
					LEXSKIPTOKEN( 2048 );
					{
						int32 TMP$139$6;
						int32 vr$146 = LEXGETTOKEN( 0 );
						TMP$139$6 = vr$146;
						if( TMP$139$6 == 373 ) goto label$315;
						label$316:;
						if( TMP$139$6 != 374 ) goto label$314;
						label$315:;
						{
							if( PTR_CNT$1 < 8 ) goto label$318;
							{
				...
				if( (TMP$138$4 - 335u) > 39u ) goto label$323;
				goto *tmp$147[TMP$138$4 - 335u];
				label$310:;
			}
		}
		label$309:;
	...
	label$286:;
	if( PTR_CNT$1 <= 0 ) goto label$325;
	{
		int32 TMP$140$2;
		if( (*DTYPE$1 & 480) == 0 ) goto label$326;
		TMP$140$2 = 24;
		goto label$345;
		label$326:;
		TMP$140$2 = *DTYPE$1 & 31;
		label$345:;
		*LGT$1 = (int64)*(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$140$2 * 28)) + 4);
	}
	goto label$324;
	label$325:;
	{
		int32 TMP$141$2;
		if( (*DTYPE$1 & 480) == 0 ) goto label$327;
		TMP$141$2 = 24;
		goto label$346;
		label$327:;
		TMP$141$2 = *DTYPE$1 & 31;
		label$346:;
		if( TMP$141$2 != 23 ) goto label$329;
		{
			if( (OPTIONS$1 & 2) != 0 ) goto label$331;
			{
		...
		goto label$328;
		label$329:;
		if( *LGT$1 > 0ll ) goto label$332;
		{
			{
				int32 TMP$142$4;
				TMP$142$4 = *DTYPE$1 & 511;
				if( TMP$142$4 == 4 ) goto label$335;
				label$336:;
				if( TMP$142$4 != 7 ) goto label$334;
				label$335:;
				{
					int32 TMP$143$5;
					if( (OPTIONS$1 & 1) == 0 ) goto label$338;
					{
					...
					label$338:;
					label$337:;
					if( (*DTYPE$1 & 480) == 0 ) goto label$339;
					TMP$143$5 = 24;
					goto label$347;
					label$339:;
					TMP$143$5 = *DTYPE$1 & 31;
					label$347:;
					*LGT$1 = (int64)*(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$143$5 * 28)) + 4);
				}
				label$334:;
				label$333:;
			}
...
static struct $8FBSYMBOL* CSYMBOLTYPEFUNCPTR( int32 IS_FUNC$1 )
{
	...
	PATTRIB$1 = 0;
	SUBTYPE$1 = (struct $8FBSYMBOL*)0u;
	$11FB_FUNCMODE vr$1 = CPROCCALLINGCONV( -1 );
	MODE$1 = vr$1;
	struct $8FBSYMBOL* vr$2 = SYMBPREADDPROC( (uint8*)0u );
	PROC$1 = vr$2;
	...
	label$54:;
	struct $8FBSYMBOL* vr$7 = SYMBADDPROCPTR( PROC$1, DTYPE$1, SUBTYPE$1, ATTRIB$1, PATTRIB$1, MODE$1 );
	fb$result$1 = vr$7;
	label$53:;
	return fb$result$1;
}
		...
		{
			{
				...
				label$153:;
				{
					...
					if( (vr$9 & -((*(int32*)((uint8*)&ENV$ + 260) & 1) == 0)) == 0 ) goto label$155;
					{
						{
							int32 TMP$120$7;
							TMP$120$7 = *DTYPE$1;
				...
				goto label$151;
				label$168:;
				int32 vr$31 = fb_StrCompare( (void*)&TMP$118$4, -1, (void*)"__builtin_va_list", 18 );
				if( vr$31 == 0 ) goto label$175;
				label$176:;
				int32 vr$33 = fb_StrCompare( (void*)&TMP$118$4, -1, (void*)"__builtin_va_list[]", 20 );
				if( vr$33 != 0 ) goto label$174;
				label$175:;
				{
					{
						int32 TMP$126$6;
						TMP$126$6 = *DTYPE$1;
						if( TMP$126$6 != 0 ) goto label$178;
						label$179:;
						{
						...
						goto label$177;
						label$178:;
						if( TMP$126$6 != 20 ) goto label$180;
						label$181:;
						{
							*DTYPE$1 = (*DTYPE$1 & -32505857) | 19922944;
							$19FB_CVA_LIST_TYPEDEF vr$45 = FBGETBACKENDVALISTTYPE(  );
							*(int32*)((uint8*)*SUBTYPE$1 + 120) = *(int32*)((uint8*)*SUBTYPE$1 + 120) | ((vr$45 << (20 & 31)) & 15728640);
						}
						goto label$177;
						label$180:;
						{
				...
				goto label$151;
				label$174:;
				int32 vr$52 = fb_StrCompare( (void*)&TMP$118$4, -1, (void*)"", 1 );
				if( vr$52 != 0 ) goto label$183;
				label$184:;
				{
