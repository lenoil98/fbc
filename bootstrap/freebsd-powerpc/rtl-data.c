...
int32 RTLDATAREAD( struct $7ASTNODE* VAREXPR$1 )
{
	...
	DTYPE$1 = *(int32*)((uint8*)VAREXPR$1 + 4) & 511;
	{
		...
		label$19:;
		{
			struct $8FBSYMBOL* vr$5 = RTLPROCLOOKUP( (uint8*)"fb_DataReadStr", 145 );
			F$1 = vr$5;
			ARGS$1 = 3;
		}
		goto label$17;
		label$20:;
		{
			struct $8FBSYMBOL* vr$6 = RTLPROCLOOKUP( (uint8*)"fb_DataReadWstr", 146 );
			F$1 = vr$6;
			ARGS$1 = 2;
		}
		goto label$17;
		label$21:;
		{
			struct $8FBSYMBOL* vr$7 = RTLPROCLOOKUP( (uint8*)"fb_DataReadBool", 147 );
			F$1 = vr$7;
		}
		goto label$17;
		label$22:;
		{
			{
				...
				goto label$53;
				label$23:;
				TMP$101$4 = DTYPE$1 & 31;
				label$53:;
				TMP$102$4 = *(uint32*)(((uint8*)SYMB_DTYPETB$ + (TMP$101$4 * 28)) + 20);
				goto label$25;
				label$26:;
				{
					struct $8FBSYMBOL* vr$11 = RTLPROCLOOKUP( (uint8*)"fb_DataReadByte", 148 );
					F$1 = vr$11;
				}
				goto label$24;
				label$27:;
				{
					struct $8FBSYMBOL* vr$12 = RTLPROCLOOKUP( (uint8*)"fb_DataReadUByte", 152 );
					F$1 = vr$12;
				}
				goto label$24;
				label$28:;
				{
					struct $8FBSYMBOL* vr$13 = RTLPROCLOOKUP( (uint8*)"fb_DataReadShort", 149 );
					F$1 = vr$13;
				}
				goto label$24;
				label$29:;
				{
					struct $8FBSYMBOL* vr$14 = RTLPROCLOOKUP( (uint8*)"fb_DataReadUShort", 153 );
					F$1 = vr$14;
				}
				goto label$24;
				label$30:;
				{
					struct $8FBSYMBOL* vr$15 = RTLPROCLOOKUP( (uint8*)"fb_DataReadInt", 150 );
					F$1 = vr$15;
				}
				goto label$24;
				label$31:;
				{
					struct $8FBSYMBOL* vr$16 = RTLPROCLOOKUP( (uint8*)"fb_DataReadUInt", 154 );
					F$1 = vr$16;
				}
				goto label$24;
				label$32:;
				{
					struct $8FBSYMBOL* vr$17 = RTLPROCLOOKUP( (uint8*)"fb_DataReadLongint", 151 );
					F$1 = vr$17;
				}
				goto label$24;
				label$33:;
				{
					struct $8FBSYMBOL* vr$18 = RTLPROCLOOKUP( (uint8*)"fb_DataReadULongint", 155 );
					F$1 = vr$18;
				}
				goto label$24;
				label$25:;
				...
				if( (TMP$102$4 - 1u) > 7u ) goto label$24;
				goto *tmp$103[TMP$102$4 - 1u];
				label$24:;
			}
		}
		goto label$17;
		label$34:;
		{
			struct $8FBSYMBOL* vr$19 = RTLPROCLOOKUP( (uint8*)"fb_DataReadSingle", 156 );
			F$1 = vr$19;
		}
		goto label$17;
		label$35:;
		{
			struct $8FBSYMBOL* vr$20 = RTLPROCLOOKUP( (uint8*)"fb_DataReadDouble", 157 );
			F$1 = vr$20;
		}
		goto label$17;
		label$36:;
		...
		if( (TMP$100$2 - 1u) > 23u ) goto label$37;
		goto *tmp$104[TMP$100$2 - 1u];
		label$17:;
	}
...
int32 RTLDATARESTORE( struct $8FBSYMBOL* LABEL$1, struct $7ASTNODE* AFTERNODE$1 )
{
	...
	fb$result$1 = 0;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_DataRestore", 144 );
