	...
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$19;
	{
		...
		*($12FB_SYMBSTATS*)((uint8*)S$1 + 12) = *(int32*)((uint8*)S$1 + 12) | 2;
		...
		if( VIDX$1 == (struct $6IRVREG*)0u ) goto label$23;
		{
			...
			{
				(*(tmp$52*)((uint8*)&IR$ + 112))( VIDX$1 );
			}
			label$25:;
			label$24:;
			struct $6IRVREG* vr$21 = (*(tmp$73*)((uint8*)&IR$ + 244))( *(int32*)((uint8*)N$1 + 4), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8), S$1, OFS$1, *(int32*)((uint8*)N$1 + 32), VIDX$1 );
			VR$1 = vr$21;
		}
		goto label$22;
		label$23:;
		{
			struct $6IRVREG* vr$24 = (*(tmp$72*)((uint8*)&IR$ + 240))( *(int32*)((uint8*)N$1 + 4), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8), S$1, OFS$1 );
			VR$1 = vr$24;
		}
		label$22:;
