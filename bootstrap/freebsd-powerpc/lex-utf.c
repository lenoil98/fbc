...
void LEXREADUTF8( void )
{
	...
	label$69:;
	*(int32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16604) = CHARS$1;
...
static int32 HUTF8TOCHAR( void )
{
	...
	static struct $8FBARRAY1IhE tmp$94$1 = { (uint8*)SRC$1, (uint8*)SRC$1, 7, 1, 1, 49, { { 7, 0, 6 } } };
	static uint8* P$1;
	static uint32 C$1;
	static uint8* DST$1;
	static int32 CHARS$1;
	...
	static int32 I$1;
	DST$1 = (uint8*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16612);
	CHARS$1 = 0;
	label$12:;
	if( CHARS$1 >= 8192 ) goto label$13;
	{
		int32 vr$3 = fb_FileEof( *(int32*)((uint8*)&ENV$ + 276) );
		...
		label$15:;
		label$14:;
		int32 vr$4 = fb_FileGet( *(int32*)((uint8*)&ENV$ + 276), 0, (void*)SRC$1, 1u );
		...
		label$17:;
		label$16:;
		EXTBYTES$1 = (int32)*(uint8*)((uint8*)UTF8_TRAILINGTB$ + (int32)*(uint8*)SRC$1);
		C$1 = 0u;
		P$1 = (uint8*)SRC$1;
		if( EXTBYTES$1 <= 0 ) goto label$19;
		{
			int32 vr$7 = fb_FileGet( *(int32*)((uint8*)&ENV$ + 276), 0, (void*)((uint8*)SRC$1 + 1), (uint32)EXTBYTES$1 );
		...
		label$18:;
		C$1 = C$1 + (uint32)(int32)*P$1;
		C$1 = C$1 - *(uint32*)((uint8*)UTF8_OFFSETSTB$ + (EXTBYTES$1 << (2 & 31)));
...
static int32 HUTF8TOUTF16LE( void )
{
	...
	static int32 EXTBYTES$1;
	static int32 I$1;
	DST$1 = (uint16*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16612);
	CHARS$1 = 0;
	label$29:;
...
static int32 HUTF8TOUTF32LE( void )
{
	...
	label$46:;
	static uint8 SRC$1[7];
	static struct $8FBARRAY1IhE tmp$97$1 = { (uint8*)SRC$1, (uint8*)SRC$1, 7, 1, 1, 49, { { 7, 0, 6 } } };
	static uint8* P$1;
	static uint32 C$1;
	static uint32* DST$1;
	static int32 CHARS$1;
	static int32 EXTBYTES$1;
	static int32 I$1;
	DST$1 = (uint32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16612);
	CHARS$1 = 0;
	label$48:;
...
static int32 HUTF16LETOCHAR( void )
{
	...
	if( CHARS$1 >= 8192 ) goto label$75;
	{
		...
		label$77:;
		label$76:;
		int32 vr$4 = fb_FileGet( *(int32*)((uint8*)&ENV$ + 276), 0, (void*)&C$1, 2u );
		...
		if( (int32)C$1 <= 255 ) goto label$81;
		{
			if( (int32)C$1 < 55296 ) goto label$83;
			{
				...
				{
					int32 vr$8 = fb_FileGet( *(int32*)((uint8*)&ENV$ + 276), 0, (void*)&C$1, 2u );
...
static int32 HUTF16LETOUTF16LE( void )
{
	...
	__builtin_memset( &fb$result$1, 0, 4 );
	label$88:;
	int32 vr$3 = fb_FileGetWstr( *(int32*)((uint8*)&ENV$ + 276), 0, (uint32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16612), 8193 );
	if( vr$3 != 0 ) goto label$91;
	{
		int64 vr$4 = fb_FileTell( *(int32*)((uint8*)&ENV$ + 276) );
		uint64 vr$8 = __udivdi3( (uint64)(vr$4 - (int64)*(int32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 49384)), 2ull );
...
static int32 HUTF16LETOUTF32LE( void )
{
	...
	if( CHARS$1 >= 8192 ) goto label$95;
	{
		...
		if( WC$1 < 55296u ) goto label$101;
		{
			...
			{
				int32 vr$6 = fb_FileGet( *(int32*)((uint8*)&ENV$ + 276), 0, (void*)&C$1, 2u );
	...
	if( CHARS$1 >= 8192 ) goto label$120;
	{
		...
		if( (int32)C$1 <= 255 ) goto label$126;
		{
			if( (int32)C$1 < 55296 ) goto label$128;
			{
				...
				{
					int32 vr$15 = fb_FileGet( *(int32*)((uint8*)&ENV$ + 276), 0, (void*)&C$1, 2u );
...
static int32 HUTF16BETOUTF32LE( void )
{
	...
	if( CHARS$1 >= 8192 ) goto label$142;
	{
		...
		if( WC$1 < 55296u ) goto label$148;
		{
			...
			{
				int32 vr$11 = fb_FileGet( *(int32*)((uint8*)&ENV$ + 276), 0, (void*)&C$1, 2u );
...
static int32 HUTF32LETOCHAR( void )
{
	...
	if( CHARS$1 >= 8192 ) goto label$163;
	{
		...
		label$165:;
		label$164:;
		int32 vr$4 = fb_FileGet( *(int32*)((uint8*)&ENV$ + 276), 0, (void*)&C$1, 4u );
...
static int32 HUTF32LETOUTF32LE( void )
{
	...
	{
		int64 vr$4 = fb_FileTell( *(int32*)((uint8*)&ENV$ + 276) );
		uint64 vr$8 = __udivdi3( (uint64)(vr$4 - (int64)*(int32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 49384)), 4ull );
		fb$result$1 = (int32)vr$8;
	}
	goto label$184;
	label$185:;
