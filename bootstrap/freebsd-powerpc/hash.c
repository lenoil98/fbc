...
void* HASHLOOKUP( struct $5THASH* HASH$1, uint8* SYMBOL$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 4 );
	label$48:;
	uint32 vr$1 = HASHHASH( (uint8*)SYMBOL$1 );
...
void STRSETADD( struct $7TSTRSET* SET$1, FBSTRING* S$1, int32 USERDATA$1 )
{
	...
	*(int32*)((uint8*)I$1 + 12) = USERDATA$1;
	int32 vr$13 = fb_StrLen( (void*)I$1, -1 );
	if( vr$13 != 0 ) goto label$81;
	{
		goto label$75;
	}
	label$81:;
	label$80:;
	uint32 vr$15 = HASHHASH( (uint8*)*(uint8**)I$1 );
	HASHADD( (struct $5THASH*)((uint8*)SET$1 + 32), (uint8*)*(uint8**)I$1, (void*)I$1, vr$15 );
	label$75:;
}
...
void STRSETCOPY( struct $7TSTRSET* TARGET$1, struct $7TSTRSET* SOURCE$1 )
{
	...
	label$84:;
	if( I$1 == (struct $11TSTRSETITEM*)0u ) goto label$85;
	{
...
{
	label$86:;
	LISTINIT( (struct $5TLIST*)SET$1, NODES$1, 16, -1 );
...
void STRSETEND( struct $7TSTRSET* SET$1 )
{
	...
	I$1 = (struct $11TSTRSETITEM*)vr$4;
	label$90:;
	if( I$1 == (struct $11TSTRSETITEM*)0u ) goto label$91;
	{
