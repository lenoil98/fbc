...
struct $7ASTNODE* CEQINPARENSONLYEXPR( void )
{
	...
	EQINPARENSONLY$1 = -((*(int32*)((uint8*)&PARSER$ + 148) & 256) != 0);
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 148) = *(int32*)((uint8*)&PARSER$ + 148) | 256;
	}
	goto label$12;
	label$13:;
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 148) = *(int32*)((uint8*)&PARSER$ + 148) & -257;
	}
	label$12:;
...
struct $7ASTNODE* CGTINPARENSONLYEXPR( void )
{
	...
	GTINPARENSONLY$1 = -((*(int32*)((uint8*)&PARSER$ + 148) & 512) != 0);
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 148) = *(int32*)((uint8*)&PARSER$ + 148) | 512;
	}
	goto label$18;
	label$19:;
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 148) = *(int32*)((uint8*)&PARSER$ + 148) & -513;
	}
	label$18:;
	struct $7ASTNODE* vr$5 = CEXPRESSION(  );
	EXPR$1 = vr$5;
...
struct $7ASTNODE* CPARENTEXPRESSION( void )
{
	...
	*(int32*)((uint8*)&PARSER$ + 144) = *(int32*)((uint8*)&PARSER$ + 144) + 1;
	int32 IS_OPT$1;
	IS_OPT$1 = -((*(int32*)((uint8*)&PARSER$ + 148) & 1) != 0);
	goto label$27;
	{
	...
	EQINPARENSONLY$1 = -((*(int32*)((uint8*)&PARSER$ + 148) & 256) != 0);
	GTINPARENSONLY$1 = -((*(int32*)((uint8*)&PARSER$ + 148) & 512) != 0);
	IDXINPARENSONLY$1 = -((*(int32*)((uint8*)&PARSER$ + 148) & 4096) != 0);
	goto label$29;
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 148) = *(int32*)((uint8*)&PARSER$ + 148) | 256;
	}
	...
	goto label$33;
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 148) = *(int32*)((uint8*)&PARSER$ + 148) | 4096;
	}
	goto label$32;
	label$33:;
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 148) = *(int32*)((uint8*)&PARSER$ + 148) & -4097;
	}
	label$32:;
	...
	label$45:;
	{
		if( (-(IS_OPT$1 == 0) | -(*(int32*)((uint8*)&PARSER$ + 144) == 0)) == 0 ) goto label$47;
		{
...
struct $7ASTNODE* CATOM( struct $8FBSYMBOL* BASE_PARENT$1, struct $10FBSYMCHAIN* CHAIN_$1 )
{
	...
	{
		uint32 TMP$99$2;
		TMP$99$2 = (uint32)TK_CLASS$1;
		goto label$172;
		label$173:;
		{
			if( CHAIN_$1 != (struct $10FBSYMCHAIN*)0u ) goto label$175;
			{
		...
		label$176:;
		{
			if( *(int32*)((uint8*)&ENV$ + 136) != 3 ) goto label$178;
			{
				struct $7ASTNODE* vr$7 = HCHECKID( BASE_PARENT$1, *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16548) + 4116) );
				fb$result$1 = vr$7;
				goto label$168;
			}
			label$178:;
		...
		label$181:;
		{
			...
			label$183:;
			label$182:;
			if( *(struct $13FB_CMPSTMTSTK**)((uint8*)&PARSER$ + 52) == (struct $13FB_CMPSTMTSTK*)0u ) goto label$185;
			{
				int32 vr$11 = LEXGETLOOKAHEAD( 1, 64 );
				if( vr$11 == 46 ) goto label$187;
				{
					struct $7ASTNODE* vr$14 = CWITHVARIABLE( -((*(int32*)((uint8*)&PARSER$ + 148) & 2) != 0) );
					fb$result$1 = vr$14;
					goto label$168;
				}
				label$187:;
			...
			CHAIN_$1 = vr$16;
			if( CHAIN_$1 == (struct $10FBSYMCHAIN*)0u ) goto label$189;
			{
		...
		if( TMP$99$2 > 6u ) goto label$171;
		goto *tmp$100[TMP$99$2 - 0u];
		label$171:;
	}
	fb$result$1 = (struct $7ASTNODE*)0u;
	label$168:;
...
static struct $7ASTNODE* HFINDID_QB( struct $8FBSYMBOL* BASE_PARENT$1, struct $10FBSYMCHAIN* CHAIN_$1 )
{
	...
	label$50:;
	{
				...
				if( (*(int32*)((uint8*)SYM$2 + 4) & 1048576) == 0 ) goto label$59;
				{
					if( *(int32*)SYM$2 != 1 ) goto label$61;
					{
						if( DEFDTYPE$1 != 17 ) goto label$63;
						{
							{
								uint32 TMP$93$8;
								TMP$93$8 = (uint32)(*(int32*)((uint8*)SYM$2 + 28) & 511);
								goto label$65;
								label$66:;
								{
								}
								...
								if( (TMP$93$8 - 4u) > 14u ) goto label$67;
								goto *tmp$101[TMP$93$8 - 4u];
								label$64:;
							}
						}
						goto label$62;
				...
				{
					{
						...
						if( (TMP$94$6 - 1u) > 5u ) goto label$70;
						goto *tmp$102[TMP$94$6 - 1u];
						label$70:;
					}
				}
				label$69:;
		...
		label$54:;
		{
			label$86:;
			{
				...
				if( SUFFIX$1 != 17 ) goto label$90;
				{
					{
						uint32 TMP$95$6;
						TMP$95$6 = (uint32)(*(int32*)((uint8*)SYM$2 + 28) & 511);
						goto label$92;
						label$93:;
						{
							IS_MATCH$4 = -1;
						...
						if( (TMP$95$6 - 4u) > 14u ) goto label$94;
						goto *tmp$103[TMP$95$6 - 4u];
						label$91:;
					}
				}
				goto label$89;
				...
				{
					{
						...
						if( (TMP$96$6 - 1u) > 5u ) goto label$97;
						goto *tmp$104[TMP$96$6 - 1u];
						label$97:;
					}
				}
				goto label$95;
				label$96:;
				{
					...
					{
						if( *(int32*)((uint8*)SYM$2 + 56) != 476 ) goto label$110;
						{
		...
		{
			struct $7ASTNODE* vr$43 = _Z11CVARIABLEEXP8FBSYMBOLl( VAR_SYM$2, -((*(int32*)((uint8*)&PARSER$ + 148) & 2) != 0) );
			fb$result$1 = vr$43;
			goto label$49;
		}
		label$114:;
		...
		{
			{
				...
				label$129:;
				{
					struct $7ASTNODE* vr$8 = _Z11CVARIABLEEXP10FBSYMCHAINl( CHAIN_$1, -((*(int32*)((uint8*)&PARSER$ + 148) & 2) != 0) );
					fb$result$1 = vr$8;
					goto label$116;
				}
				goto label$125;
				label$130:;
				{
					struct $7ASTNODE* vr$11 = CIMPLICITDATAMEMBER( BASE_PARENT$1, CHAIN_$1, -((*(int32*)((uint8*)&PARSER$ + 148) & 2) != 0), OPTIONS$1 );
					fb$result$1 = vr$11;
					goto label$116;
				}
				goto label$125;
				...
				if( (TMP$97$4 - 1u) > 12u ) goto label$125;
				goto *tmp$105[TMP$97$4 - 1u];
				label$125:;
			}
			SYM$2 = *(struct $8FBSYMBOL**)((uint8*)SYM$2 + 160);
		}
...
static struct $7ASTNODE* HBASEMEMBERACCESS( void )
{
	...
	if( (*(int32*)((uint8*)PROC$1 + 8) & 2) != 0 ) goto label$143;
	{
	...
	label$144:;
	{
		if( BASE_$1 != (struct $8FBSYMBOL*)0u ) goto label$148;
		{
...
static struct $7ASTNODE* HCHECKID( struct $8FBSYMBOL* BASE_PARENT$1, struct $10FBSYMCHAIN* CHAIN_$1 )
{
	...
	label$153:;
	struct $7ASTNODE* EXPR$1;
	if( CHAIN_$1 == (struct $10FBSYMCHAIN*)0u ) goto label$156;
	{
	...
	label$156:;
	label$155:;
	if( (*(int32*)((uint8*)&PARSER$ + 148) & 1024) == 0 ) goto label$160;
	{
		FBSTRING TMP$98$2;
		...
		fb_StrAssign( (void*)&TMP$98$2, -1, (void*)vr$6, -1, 0 );
	...
	label$160:;
	label$159:;
	if( *(int32*)((uint8*)&ENV$ + 136) == 3 ) goto label$162;
	{
		int32 vr$10 = LEXGETCLASS( 0 );
		if( vr$10 == 0 ) goto label$164;
		{
			fb$result$1 = (struct $7ASTNODE*)0u;
			goto label$154;
		}
	...
	label$166:;
	label$165:;
	struct $7ASTNODE* vr$13 = _Z11CVARIABLEEXP10FBSYMCHAINl( (struct $10FBSYMCHAIN*)0u, -((*(int32*)((uint8*)&PARSER$ + 148) & 2) != 0) );
	fb$result$1 = vr$13;
	goto label$154;
	label$154:;
	return fb$result$1;
