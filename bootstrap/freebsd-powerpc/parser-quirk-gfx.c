		...
		{
			{
				...
				fb_StrInit( (void*)&TMP$110$4, -1, (void*)vr$36, -1, 0 );
				int32 vr$39 = fb_StrCompare( (void*)&TMP$110$4, -1, (void*)"B", 2 );
				...
				goto label$177;
				label$178:;
				int32 vr$41 = fb_StrCompare( (void*)&TMP$110$4, -1, (void*)"BF", 3 );
...
int32 CGFXVIEW( int32 ISVIEW$1 )
{
	...
	fb$result$1 = 0;
	{
		...
		int32 vr$8 = LEXGETTOKEN( 0 );
		TMP$114$2 = vr$8;
		if( TMP$114$2 == 508 ) goto label$286;
		label$287:;
		if( TMP$114$2 != 509 ) goto label$285;
		label$286:;
		{
			LEXSKIPTOKEN( 2048 );
			FLAGS$1 = 1;
...
int32 CGFXPALETTE( void )
{
	...
	if( vr$9 == 0 ) goto label$326;
	{
		...
		goto label$367;
		label$329:;
		TMP$116$2 = (((((*(int32*)((uint8*)ARRAYEXPR$1 + 4) & 511) & 31) | (((*(int32*)((uint8*)ARRAYEXPR$1 + 4) & 511) & 480) + -32)) | ((((*(int32*)((uint8*)ARRAYEXPR$1 + 4) & 511) & 261632) >> (1 & 31)) & 261632)) | ((*(int32*)((uint8*)ARRAYEXPR$1 + 4) & 511) & 32505856)) & 31;
		label$367:;
		DPTRSIZE$1 = *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$116$2 * 28)) + 4);
		if( (-(DPTRSIZE$1 != *(int32*)((uint8*)SYMB_DTYPETB$ + 312)) & -(DPTRSIZE$1 != *(int32*)((uint8*)SYMB_DTYPETB$ + 368))) == 0 ) goto label$331;
		{
			DPTRSIZE$1 = *(int32*)((uint8*)SYMB_DTYPETB$ + 228);
		}
		label$331:;
		label$330:;
		int32 vr$55 = RTLGFXPALETTEUSING( ARRAYEXPR$1, ISGET$1, -(DPTRSIZE$1 == *(int32*)((uint8*)SYMB_DTYPETB$ + 368)) );
		fb$result$1 = vr$55;
	}
	goto label$325;
	label$326:;
	{
		...
		if( ISGET$1 == 0 ) goto label$361;
		{
			...
			TMP$117$3 = -((*(int32*)((uint8*)REXPR$1 + 4) & 512) != 0);
			goto label$368;
			label$362:;
			TMP$117$3 = 0;
			label$368:;
			...
			TMP$118$3 = -((*(int32*)((uint8*)GEXPR$1 + 4) & 512) != 0);
			goto label$369;
			label$363:;
			TMP$118$3 = 0;
			label$369:;
			...
			TMP$119$3 = -((*(int32*)((uint8*)BEXPR$1 + 4) & 512) != 0);
			goto label$370;
			label$364:;
			TMP$119$3 = 0;
			label$370:;
...
int32 CGFXSTMT( $8FB_TOKEN TK$1 )
{
	...
	fb$result$1 = 0;
	{
		...
		if( (TMP$120$2 - 471u) > 40u ) goto label$521;
		goto *tmp$121[TMP$120$2 - 471u];
		label$521:;
	}
	label$520:;
	return fb$result$1;
...
static struct $7ASTNODE* HCHECKFBIMAGEEXPR( struct $7ASTNODE* EXPR$1, int32 ALLOW_CONST$1, struct $7ASTNODE** PDESCEXPR$1 )
{
	...
	if( (*(int32*)((uint8*)EXPR$1 + 4) & 480) != 0 ) goto label$47;
	{
		if( (*(int32*)((uint8*)EXPR$1 + 4) & 511) != 20 ) goto label$49;
		{
			...
			FBSTRING TMP$98$3;
			FBSTRING TMP$99$3;
			__builtin_memset( &TMP$99$3, 0, 12 );
			__builtin_memset( &TMP$97$3, 0, 12 );
			FBSTRING* vr$20 = fb_StrConcat( &TMP$97$3, (void*)" \x22", 3, *(void**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)EXPR$1 + 8) + 16), 0 );
			__builtin_memset( &TMP$98$3, 0, 12 );
			FBSTRING* vr$23 = fb_StrConcat( &TMP$98$3, (void*)vr$20, -1, (void*)".cast() as any ptr\x22", 20 );
			fb_StrAssign( (void*)&TMP$99$3, -1, (void*)vr$23, -1, 0 );
			ERRREPORT( 99, -1, (uint8*)*(uint8**)&TMP$99$3 );
...
static int32 HGETMODE( int32* MODE$1, struct $7ASTNODE** ALPHAEXPR$1, struct $7ASTNODE** FUNCEXPR$1, struct $7ASTNODE** PARAMEXPR$1 )
{
	...
	fb$result$1 = 0;
	{
		...
		TMP$100$2 = vr$5;
		if( TMP$100$2 != 288 ) goto label$69;
		label$70:;
		{
			LEXSKIPTOKEN( 2048 );
			*MODE$1 = 3;
		...
		goto label$68;
		label$69:;
		if( TMP$100$2 != 289 ) goto label$71;
		label$72:;
		{
			LEXSKIPTOKEN( 2048 );
			*MODE$1 = 4;
		...
		goto label$68;
		label$71:;
		if( TMP$100$2 != 292 ) goto label$73;
		label$74:;
		{
			LEXSKIPTOKEN( 2048 );
			*MODE$1 = 5;
	...
	}
	{
		...
		TMP$101$2 = vr$9;
		if( TMP$101$2 == 0 ) goto label$77;
		label$78:;
		if( TMP$101$2 == 2 ) goto label$77;
		label$79:;
		if( TMP$101$2 != 1 ) goto label$76;
		label$77:;
		{
			{
				FBSTRING TMP$102$4;
				...
				fb_StrInit( (void*)&TMP$102$4, -1, (void*)vr$12, -1, 0 );
				int32 vr$15 = fb_StrCompare( (void*)&TMP$102$4, -1, (void*)"PSET", 5 );
				...
				goto label$80;
				label$81:;
				int32 vr$19 = fb_StrCompare( (void*)&TMP$102$4, -1, (void*)"PRESET", 7 );
				...
				goto label$80;
				label$83:;
				int32 vr$23 = fb_StrCompare( (void*)&TMP$102$4, -1, (void*)"TRANS", 6 );
				...
				goto label$80;
				label$85:;
				int32 vr$27 = fb_StrCompare( (void*)&TMP$102$4, -1, (void*)"ADD", 4 );
				...
				goto label$80;
				label$87:;
				int32 vr$38 = fb_StrCompare( (void*)&TMP$102$4, -1, (void*)"ALPHA", 6 );
				...
				goto label$80;
				label$93:;
				int32 vr$48 = fb_StrCompare( (void*)&TMP$102$4, -1, (void*)"CUSTOM", 7 );
