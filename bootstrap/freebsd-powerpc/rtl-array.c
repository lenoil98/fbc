...
struct $7ASTNODE* RTLARRAYCLEAR( struct $7ASTNODE* ARRAYEXPR$1 )
{
	...
	if( (-(CTOR$1 != (struct $8FBSYMBOL*)0u) | -(DTOR$1 != (struct $8FBSYMBOL*)0u)) == 0 ) goto label$50;
	{
		...
		struct $8FBSYMBOL* vr$13 = RTLPROCLOOKUP( (uint8*)"fb_ArrayClearObj", 123 );
	...
	{
		struct $8FBSYMBOL* vr$20 = RTLPROCLOOKUP( (uint8*)"fb_ArrayDestructStr", 121 );
	...
	label$57:;
	{
		struct $8FBSYMBOL* vr$23 = RTLPROCLOOKUP( (uint8*)"fb_ArrayClear", 122 );
...
struct $7ASTNODE* RTLARRAYERASE( struct $7ASTNODE* ARRAYEXPR$1, int32 IS_DYNAMIC$1, int32 CHECK_ACCESS$1 )
{
	...
	if( (-(CTOR$1 != (struct $8FBSYMBOL*)0u) | -(DTOR$1 != (struct $8FBSYMBOL*)0u)) == 0 ) goto label$69;
	{
		...
		{
			struct $8FBSYMBOL* vr$13 = RTLPROCLOOKUP( (uint8*)"fb_ArrayEraseObj", 125 );
			struct $7ASTNODE* vr$14 = ASTNEWCALL( vr$13, (struct $7ASTNODE*)0u );
			PROC$1 = vr$14;
		}
		goto label$70;
		label$71:;
		{
			struct $8FBSYMBOL* vr$15 = RTLPROCLOOKUP( (uint8*)"fb_ArrayDestructObj", 120 );
	...
	if( DTYPE$1 != 17 ) goto label$80;
	{
		...
		{
			struct $8FBSYMBOL* vr$22 = RTLPROCLOOKUP( (uint8*)"fb_ArrayStrErase", 126 );
		...
		label$82:;
		{
			struct $8FBSYMBOL* vr$24 = RTLPROCLOOKUP( (uint8*)"fb_ArrayDestructStr", 121 );
	...
	label$80:;
	{
		...
		label$86:;
		label$85:;
		struct $8FBSYMBOL* vr$27 = RTLPROCLOOKUP( (uint8*)"fb_ArrayErase", 124 );
...
struct $7ASTNODE* RTLARRAYREDIM( struct $7ASTNODE* ARRAYEXPR$1, int32 DIMENSIONS$1, struct $7FBARRAYIP7ASTNODEE* EXPRTB$1, int32 DOPRESERVE$1, int32 DOCLEAR$1 )
{
	...
	if( (-(CTOR$1 == (struct $8FBSYMBOL*)0u) & -(DTOR$1 == (struct $8FBSYMBOL*)0u)) == 0 ) goto label$96;
	{
		...
		{
			struct $8FBSYMBOL* vr$10 = RTLPROCLOOKUP( (uint8*)"fb_ArrayRedimEx", 127 );
			F$1 = vr$10;
		}
		goto label$97;
		label$98:;
		{
			struct $8FBSYMBOL* vr$11 = RTLPROCLOOKUP( (uint8*)"fb_ArrayRedimPresvEx", 129 );
			F$1 = vr$11;
		}
		label$97:;
	}
	...
	label$96:;
	{
		...
		{
			struct $8FBSYMBOL* vr$12 = RTLPROCLOOKUP( (uint8*)"fb_ArrayRedimObj", 128 );
			F$1 = vr$12;
		}
		goto label$99;
		label$100:;
		{
			struct $8FBSYMBOL* vr$13 = RTLPROCLOOKUP( (uint8*)"fb_ArrayRedimPresvObj", 130 );
			F$1 = vr$13;
		}
		label$99:;
	}
	...
	label$115:;
	{
		...
		label$120:;
		{
			...
			if( vr$44 != (struct $7ASTNODE*)0u ) goto label$124;
			{
				goto label$94;
			}
			label$124:;
			...
			if( (*(int32*)((uint8*)EXPR$1 + 4) & 511) == 8 ) goto label$126;
			{
			...
			if( vr$53 != (struct $7ASTNODE*)0u ) goto label$128;
			{
				goto label$94;
			}
			label$128:;
...
struct $7ASTNODE* RTLARRAYREDIMTO( struct $7ASTNODE* DSTEXPR$1, struct $7ASTNODE* SRCEXPR$1, int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	if( vr$6 != (struct $7ASTNODE*)0u ) goto label$134;
	{
		goto label$130;
	}
	label$134:;
	...
	if( vr$11 != (struct $7ASTNODE*)0u ) goto label$136;
	{
		goto label$130;
	}
	label$136:;
	...
	if( vr$13 != (struct $7ASTNODE*)0u ) goto label$138;
	{
		goto label$130;
	}
	label$138:;
	...
	if( vr$15 != (struct $7ASTNODE*)0u ) goto label$140;
	{
		goto label$130;
	}
	label$140:;
...
struct $7ASTNODE* RTLARRAYBOUND( struct $7ASTNODE* ARRAYEXPR$1, struct $7ASTNODE* DIMEXPR$1, int32 ISLBOUND$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	fb$result$1 = (struct $7ASTNODE*)0u;
	if( ISLBOUND$1 == 0 ) goto label$143;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_ArrayLBound", 132 );
	TMP$114$1 = vr$1;
	goto label$148;
	label$143:;
	struct $8FBSYMBOL* vr$2 = RTLPROCLOOKUP( (uint8*)"fb_ArrayUBound", 133 );
	TMP$114$1 = vr$2;
	label$148:;
	struct $7ASTNODE* vr$3 = ASTNEWCALL( TMP$114$1, (struct $7ASTNODE*)0u );
	PROC$1 = vr$3;
	...
	if( vr$5 != (struct $7ASTNODE*)0u ) goto label$147;
	{
		goto label$142;
	}
	label$147:;
...
struct $7ASTNODE* RTLARRAYBOUNDSCHECK( struct $7ASTNODE* IDX$1, struct $7ASTNODE* LB$1, struct $7ASTNODE* RB$1, int32 LINENUM$1, uint8* MODULE$1 )
{
	...
	struct $8FBSYMBOL* F$1;
	fb$result$1 = (struct $7ASTNODE*)0u;
	if( LB$1 != (struct $7ASTNODE*)0u ) goto label$152;
	{
		struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_ArraySngBoundChk", 134 );
		F$1 = vr$1;
	}
	goto label$151;
	label$152:;
	{
		struct $8FBSYMBOL* vr$2 = RTLPROCLOOKUP( (uint8*)"fb_ArrayBoundChk", 135 );
		F$1 = vr$2;
	}
	label$151:;
	...
	if( vr$5 != (struct $7ASTNODE*)0u ) goto label$154;
	{
		goto label$150;
	}
	label$154:;
	...
	if( LB$1 == (struct $7ASTNODE*)0u ) goto label$156;
	{
		...
		if( vr$6 != (struct $7ASTNODE*)0u ) goto label$158;
		{
			goto label$150;
		}
		label$158:;
	...
	if( vr$7 != (struct $7ASTNODE*)0u ) goto label$160;
	{
		goto label$150;
	}
	label$160:;
	...
	if( vr$10 != (struct $7ASTNODE*)0u ) goto label$162;
	{
		goto label$150;
	}
	label$162:;
	...
	if( vr$12 != (struct $7ASTNODE*)0u ) goto label$164;
	{
		goto label$150;
	}
	label$164:;
...
static void HCHECKDTOR( struct $8FBSYMBOL* DTOR$1, int32 CHECK_ACCESS$1, int32 IS_ERASE$1 )
{
	...
	if( *(int32*)((uint8*)DTOR$1 + 84) == 3 ) goto label$41;
	{
		...
		TMP$112$2 = 172;
		label$167:;
		ERRREPORT( TMP$112$2, 0, (uint8*)0u );
	}
	label$41:;
	label$40:;
	label$33:;
