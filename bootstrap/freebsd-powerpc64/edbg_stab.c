...
void EDBGEMITHEADER( uint8* FILENAME$1 )
{
	...
	*(uint8**)((uint8*)&CTX$ + 320ll) = (uint8*)0ull;
	...
	(*(tmp$109*)((uint8*)&EMIT$ + 440ll))( 3ll, 0ll );
...
void EDBGSCOPEBEGIN( struct $8FBSYMBOL* S$1 )
{
	...
	label$67:;
	label$66:;
	*(int64*)((uint8*)S$1 + 128ll) = *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16744ll);
...
void EDBGSCOPEEND( struct $8FBSYMBOL* S$1 )
{
	...
	label$71:;
	label$70:;
	*(int64*)((uint8*)S$1 + 136ll) = *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16744ll);
	struct $8FBSYMBOL* vr$2 = SYMBADDLABEL( (uint8*)0ull, 4ll );
