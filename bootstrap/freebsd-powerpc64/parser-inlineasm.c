...
static void HINITASMKEYWORDS( void );
static int64 HISASMKEYWORD( uint8* );
void CASMCODE( void );
...
void CASMCODE( void )
{
	...
	label$26:;
	{
		...
		THISTOK$1 = vr$0;
		{
			...
			goto label$29;
			label$30:;
			static const void* tmp$704[85ll] = {
				&&label$31,
				&&label$31,
				&&label$29,
				&&label$31,
			...
			if( (TMP$695$3 - 256ull) > 84ull ) goto label$29;
			goto *tmp$704[TMP$695$3 - 256ull];
			label$29:;
		}
		...
		DOSKIP$1 = 0ll;
		{
			...
			label$34:;
			{
				...
				fb_StrAssign( (void*)&TMP$697$4, -1ll, (void*)vr$8, -1ll, 0 );
				int64 vr$10 = HISASMKEYWORD( (uint8*)*(uint8**)&TMP$697$4 );
				TMP$698$4 = (int64)-(vr$10 == 0ll);
				fb_StrDelete( (FBSTRING*)&TMP$697$4 );
				if( TMP$698$4 == 0ll ) goto label$41;
				{
					struct $8FBSYMBOL* BASE_PARENT$5;
					struct $10FBSYMCHAIN* vr$14 = CIDENTIFIER( &BASE_PARENT$5, 34ll );
					CHAIN_$1 = vr$14;
					label$42:;
					if( CHAIN_$1 == (struct $10FBSYMCHAIN*)0ull ) goto label$43;
					{
						...
						{
							{
								$12FB_SYMBCLASS TMP$699$8;
								TMP$699$8 = *($12FB_SYMBCLASS*)S$6;
								if( TMP$699$8 == 3ll ) goto label$49;
								label$50:;
								if( TMP$699$8 != 7ll ) goto label$48;
								label$49:;
								{
									SYM$1 = S$6;
									goto label$43;
								...
								goto label$47;
								label$48:;
								if( TMP$699$8 != 2ll ) goto label$51;
								label$52:;
								{
								...
								goto label$47;
								label$51:;
								if( TMP$699$8 != 1ll ) goto label$53;
								label$54:;
								{
									struct $8FBSYMBOL* vr$18 = SYMBFINDBYCLASS( CHAIN_$1, 1ll );
									SYM$1 = vr$18;
									if( SYM$1 == (struct $8FBSYMBOL*)0ull ) goto label$56;
									{
						...
						label$46:;
						if( S$6 != (struct $8FBSYMBOL*)0ull ) goto label$44;
						label$45:;
			...
			label$60:;
			{
				...
				EXPR$1 = vr$26;
				if( EXPR$1 == (struct $7ASTNODE*)0ull ) goto label$62;
				{
					struct $8FBSYMBOL* LITSYM$5;
					struct $8FBSYMBOL* vr$27 = ASTGETSTRLITSYMBOL( EXPR$1 );
					LITSYM$5 = vr$27;
					if( LITSYM$5 == (struct $8FBSYMBOL*)0ull ) goto label$64;
					{
						FBSTRING TMP$703$6;
						fb_StrAssign( (void*)TEXT$1, 1025ll, (void*)"\x22", 2ll, 0 );
						if( (*(int64*)((uint8*)LITSYM$5 + 56ll) & 511ll) == 7ll ) goto label$66;
						{
							FBSTRING TMP$701$7;
							__builtin_memset( &TMP$701$7, 0, 24ll );
							FBSTRING* vr$33 = fb_StrConcat( &TMP$701$7, (void*)TEXT$1, 1025ll, *(void**)((uint8*)LITSYM$5 + 96ll), 0ll );
						...
						label$66:;
						{
							...
							TMP$702$7 = vr$35;
							fb_WstrAssignToA( (void*)TEXT$1, 1025ll, (uint32*)TMP$702$7, 0 );
							fb_WstrDelete( (uint32*)TMP$702$7 );
						}
						label$65:;
						__builtin_memset( &TMP$703$6, 0, 24ll );
						FBSTRING* vr$38 = fb_StrConcat( &TMP$703$6, (void*)TEXT$1, 1025ll, (void*)"\x22", 2ll );
			...
			{
				{
					if( THISTOK$1 != 346ll ) goto label$69;
					label$70:;
					{
						struct $8FBSYMBOL* vr$39 = SYMBGETPROCRESULT( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 208ll) );
						SYM$1 = vr$39;
					...
					goto label$68;
					label$69:;
					if( THISTOK$1 != 404ll ) goto label$73;
					label$74:;
					{
						...
						{
							if( *(int64*)EXPR$1 != 16ll ) goto label$78;
							{
			...
			if( TMP$696$3 > 4ull ) goto label$32;
			goto *tmp$705[TMP$696$3 - 0ull];
			label$32:;
		}
		if( DOSKIP$1 != 0ll ) goto label$80;
		{
			if( SYM$1 == (struct $8FBSYMBOL*)0ull ) goto label$82;
			{
			...
			label$81:;
			if( HEAD$1 != (struct $9ASTASMTOK*)0ull ) goto label$84;
			{
				HEAD$1 = TAIL$1;
			}
			label$84:;
	...
	goto label$26;
	label$27:;
	if( HEAD$1 == (struct $9ASTASMTOK*)0ull ) goto label$86;
	{
...
int64 CASMBLOCK( void )
{
	...
	if( vr$3 == 0ll ) goto label$94;
	{
		if( *(int64*)((uint8*)&ENV$ + 296ll) == 0ll ) goto label$96;
		{
			if( *(int64*)((uint8*)&ENV$ + 1224ll) != 0ll ) goto label$98;
			{
				struct $7ASTNODE* vr$5 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 49632ll) );
				ASTADD( vr$5 );
	...
	label$103:;
	{
		if( ISSINGLELINE$1 != 0ll ) goto label$107;
		{
			struct $7ASTNODE* vr$11 = ASTNEWDBG( 113ll, *(int64*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 16744ll), *(uint8**)((uint8*)&ENV$ + 824ll) );
			ASTADD( vr$11 );
		}
		label$107:;
		label$106:;
		CASMCODE(  );
		CCOMMENT( 1028ll );
		if( *(int64*)((uint8*)&ENV$ + 296ll) == 0ll ) goto label$109;
		{
			if( *(int64*)((uint8*)&ENV$ + 1224ll) != 0ll ) goto label$111;
			{
				struct $7ASTNODE* vr$13 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 49632ll) );
				ASTADD( vr$13 );
				DZSTRRESET( (struct $8DZSTRING*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 49632ll) );
			}
			label$111:;
		...
		label$108:;
		{
			...
			TMP$706$3 = vr$16;
			if( TMP$706$3 != 257ll ) goto label$113;
			label$114:;
			{
				if( ISSINGLELINE$1 == 0ll ) goto label$116;
				{
					goto label$104;
				}
				label$116:;
			...
			goto label$112;
			label$113:;
			if( TMP$706$3 != 256ll ) goto label$117;
			label$118:;
			{
				goto label$104;
			}
			goto label$112;
			label$117:;
			if( TMP$706$3 != 340ll ) goto label$119;
			label$120:;
			{
				goto label$104;
			}
		...
		if( ISSINGLELINE$1 != 0ll ) goto label$123;
		{
	...
	goto label$103;
	label$104:;
	if( ISSINGLELINE$1 != 0ll ) goto label$125;
	{
		int64 vr$18 = HMATCH( 340ll, 2048ll );
		if( vr$18 != 0ll ) goto label$127;
		{
...
{
	label$10:;
	HASHINIT( (struct $5THASH*)((uint8*)&ASMKEYWORDS$ + 8ll), 600ll, 0ll );
	{
		int64 I$2;
		I$2 = 0ll;
		label$15:;
		{
			HASHADD( (struct $5THASH*)((uint8*)&ASMKEYWORDS$ + 8ll), *(uint8**)((uint8*)ASMKEYWORDSX86$ + (I$2 << (3ll & 63ll))), (void*)18446744073709551615ull, 18446744073709551615ull );
		}
		label$13:;
		I$2 = I$2 + 1ll;
		label$12:;
		if( I$2 <= 601ll ) goto label$15;
		label$14:;
	}
	label$11:;
}

static int64 HISASMKEYWORD( uint8* TEXT$1 )
{
	int64 fb$result$1;
	__builtin_memset( &fb$result$1, 0, 8ll );
	label$16:;
	if( *(int64*)&ASMKEYWORDS$ != 0ll ) goto label$19;
	{
		HINITASMKEYWORDS(  );
		*(int64*)&ASMKEYWORDS$ = -1ll;
	}
	label$19:;
	label$18:;
	void* vr$2 = HASHLOOKUP( (struct $5THASH*)((uint8*)&ASMKEYWORDS$ + 8ll), TEXT$1 );
