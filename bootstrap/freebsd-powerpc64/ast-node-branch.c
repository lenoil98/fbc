...
struct $6IRVREG* ASTLOADBRANCH( struct $7ASTNODE* N$1 )
{
	...
	if( *(int64*)((uint8*)&AST$ + 272ll) == 0ll ) goto label$19;
	{
		...
		label$21:;
		{
			(*(tmp$56*)((uint8*)&IR$ + 288ll))( *(int64*)((uint8*)N$1 + 40ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 56ll) );
		}
		label$20:;
	}
	label$19:;
...
struct $6IRVREG* ASTLOADJMPTB( struct $7ASTNODE* N$1 )
{
	...
	{
		(*(tmp$57*)((uint8*)&IR$ + 296ll))( V1$1, *(struct $8FBSYMBOL**)((uint8*)N$1 + 24ll), *(uint64**)((uint8*)N$1 + 40ll), *(struct $8FBSYMBOL***)((uint8*)N$1 + 48ll), *(int64*)((uint8*)N$1 + 56ll), *(struct $8FBSYMBOL**)((uint8*)N$1 + 64ll), *(uint64*)((uint8*)N$1 + 72ll), *(uint64*)((uint8*)N$1 + 80ll) );
	}
	label$39:;
	label$38:;
