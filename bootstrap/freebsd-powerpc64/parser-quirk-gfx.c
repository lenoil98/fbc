...
int64 CGFXVIEW( int64 ISVIEW$1 )
{
	...
	fb$result$1 = 0ll;
	{
		...
		int64 vr$8 = LEXGETTOKEN( 0ll );
		TMP$114$2 = vr$8;
		if( TMP$114$2 == 508ll ) goto label$286;
		label$287:;
		if( TMP$114$2 != 509ll ) goto label$285;
		label$286:;
		{
			LEXSKIPTOKEN( 2048ll );
			FLAGS$1 = 1ll;
...
int64 CGFXPALETTE( void )
{
	...
	if( vr$9 == 0ll ) goto label$326;
	{
		...
		label$367:;
		DPTRSIZE$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$116$2 * 56ll)) + 8ll);
...
int64 CGFXSTMT( $8FB_TOKEN TK$1 )
{
	...
	fb$result$1 = 0ll;
	{
		...
		if( (TMP$120$2 - 471ull) > 40ull ) goto label$521;
		goto *tmp$121[TMP$120$2 - 471ull];
		label$521:;
	}
	label$520:;
	return fb$result$1;
