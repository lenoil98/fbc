...
void CSELCONSTSTMTBEGIN( void )
{
	...
	label$45:;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$94$1 * 56ll)) == 0ll ) goto label$22;
	{
		ASTDELTREE( EXPR$1 );
	...
	if( DTYPE$1 == 9ll ) goto label$32;
	{
		...
		label$46:;
		if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$96$2 * 56ll)) + 8ll) > *(int64*)((uint8*)SYMB_DTYPETB$ + 512ll) ) goto label$35;
		{
	...
	label$31:;
	{
		...
		label$38:;
		{
			...
			label$47:;
			DTYPE$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$97$3 * 56ll)) + 32ll);
		}
		label$37:;
		label$36:;
	}
