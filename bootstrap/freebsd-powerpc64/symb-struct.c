...
int64 TYPECALCNATURALALIGN( int64 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	int64 ALIGN$1;
	{
		...
		label$43:;
		{
			...
			label$50:;
			ALIGN$1 = *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$97$3 * 56ll)) + 8ll);
		}
		goto label$39;
		label$40:;
					...
					if( BITS$1 > (PAD$1 << (3ll & 63ll)) ) goto label$97;
					{
						...
						PAD$1 = 0ll;
						{
							...
							label$100:;
							{
								...
								label$152:;
								if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$103$8 * 56ll)) + 16ll) == 0ll ) goto label$103;
								{
									DTYPE$1 = 2ll;
								}
								goto label$102;
							...
							label$105:;
							{
								...
								label$153:;
								if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$104$8 * 56ll)) + 16ll) == 0ll ) goto label$108;
								{
									DTYPE$1 = 5ll;
								}
								goto label$107;
...
static void STRUCT_ANALYZE( struct $8FBSYMBOL* FLD$1, int64* PART1$1, int64* PART2$1, int64* RANGE$1 )
{
	...
	if( FLD$1 == (struct $8FBSYMBOL*)0ull ) goto label$179;
	{
		...
		label$318:;
		if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$106$2 * 56ll)) != 3ll ) goto label$184;
		{
		...
		label$319:;
		if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$107$2 * 56ll)) != 0ll ) goto label$185;
		{
