...
void CFORSTMTBEGIN( void )
{
	...
	label$162:;
	{
		...
		goto label$164;
		label$165:;
		static const void* tmp$101[20ll] = {
			&&label$166,
			&&label$167,
			&&label$167,
			&&label$169,
	...
	*(struct $8FBSYMBOL**)((uint8*)STK$1 + 152ll) = EL$1;
	...
	if( ISCONST$1 != 3ll ) goto label$184;
	{
		...
		TMP$100$2 = 49ll;
		label$188:;
		struct $7ASTNODE* vr$58 = ASTNEWBOP( TMP$100$2, vr$56, vr$52, (struct $8FBSYMBOL*)0ull, 1ll );
		EXPR$1 = vr$58;
	...
	{
		{
			...
			goto label$54;
			label$55:;
			static const void* tmp$111[1ll] = {
				&&label$56,
			};
			if( (TMP$95$3 - 20ull) > 0ull ) goto label$57;
			goto *tmp$111[TMP$95$3 - 20ull];
			label$54:;
		}
	}
	label$52:;
	...
	*(int64*)((uint8*)STK$1 + 168ll) = 0ll;
	...
	if( (FLAGS$1 & 2ll) != 0ll ) goto label$121;
	{
		...
		if( (FLAGS$1 & 1ll) != 0ll ) goto label$127;
		{
			...
			label$242:;
			if( *(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$97$3 * 56ll)) + 16ll) == 0ll ) goto label$130;
			{
	...
	label$243:;
	if( ((int64)-(*(int64*)(((uint8*)SYMB_DTYPETB$ + (TMP$98$1 * 56ll)) + 16ll) == 0ll) & (int64)-((FLAGS$1 & 1ll) == 0ll)) == 0ll ) goto label$145;
	{
...
static struct $7ASTNODE* HUDTCALLOPOVL( struct $8FBSYMBOL* PARENT$1, $6AST_OP OP$1, struct $7ASTNODE* INST_EXPR$1, struct $7ASTNODE* SECOND_ARG$1, struct $7ASTNODE* THIRD_ARG$1 )
{
	...
	label$194:;
	{
		...
		*(struct $11FB_CALL_ARG**)((uint8*)&tmp$102$2 + 8ll) = (struct $11FB_CALL_ARG*)ARGS$2;
		*(int64*)((uint8*)&tmp$102$2 + 16ll) = 48ll;
		*(int64*)((uint8*)&tmp$102$2 + 24ll) = 24ll;
		*(int64*)((uint8*)&tmp$102$2 + 32ll) = 1ll;
		*(int64*)((uint8*)&tmp$102$2 + 40ll) = 49ll;
		*(int64*)((uint8*)&tmp$102$2 + 48ll) = 2ll;
		*(int64*)((uint8*)&tmp$102$2 + 56ll) = 0ll;
		*(int64*)((uint8*)&tmp$102$2 + 64ll) = 1ll;
		int64 PARAMS$2;
		PARAMS$2 = 1ll;
		{
			...
			*($12FB_PARAMMODE*)((uint8*)TMP$103$3 + 8ll) = -1ll;
			*(struct $11FB_CALL_ARG**)((uint8*)TMP$103$3 + 16ll) = (struct $11FB_CALL_ARG*)0ull;
		}
			...
			if( THIRD_ARG$1 == (struct $7ASTNODE*)0ull ) goto label$198;
			{
				*(struct $11FB_CALL_ARG**)((uint8*)ARGS$2 + 16ll) = (struct $11FB_CALL_ARG*)((uint8*)ARGS$2 + 24ll);
				PARAMS$2 = PARAMS$2 + 1ll;
				{
					...
					TMP$104$5 = (struct $11FB_CALL_ARG*)((uint8*)ARGS$2 + 24ll);
					*(struct $7ASTNODE**)TMP$104$5 = THIRD_ARG$1;
					*($12FB_PARAMMODE*)((uint8*)TMP$104$5 + 8ll) = -1ll;
					*(struct $11FB_CALL_ARG**)((uint8*)TMP$104$5 + 16ll) = (struct $11FB_CALL_ARG*)0ull;
				}
			}
			label$198:;
			label$197:;
	...
	if( SYM$1 != (struct $8FBSYMBOL*)0ull ) goto label$200;
	{
		...
		label$202:;
		{
			...
			FBSTRING* vr$23 = fb_StrConcat( &TMP$106$3, *(void**)(((uint8*)AST_OPTB$ + (OP$1 << (5ll & 63ll))) + 16ll), 0ll, (void*)" (with", 7ll );
			fb_StrInit( (void*)&OP_VERSION$3, -1ll, (void*)vr$23, -1ll, 0 );
			{
				uint64 TMP$107$4;
				TMP$107$4 = (uint64)OP$1;
				goto label$204;
				label$205:;
				{
				...
				if( (TMP$107$4 - 24ull) > 2ull ) goto label$203;
				goto *tmp$112[TMP$107$4 - 24ull];
				label$203:;
			}
...
static void HFORSTMTCLOSE( struct $13FB_CMPSTMTSTK* STK$1 )
{
	...
	{
		int64 TMP$110$2;
		TMP$110$2 = *(int64*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)STK$1 + 32ll) + 56ll) & 511ll;
		if( TMP$110$2 != 20ll ) goto label$218;
		label$219:;
		{
			HUDTSTEP( STK$1 );
