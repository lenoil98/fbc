		...
		{
			{
				...
				label$83:;
				TMP$88$4 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$87$4 * 56ll));
...
int64 ASTISEQUALPARAMINIT( struct $7ASTNODE* L$1, struct $7ASTNODE* R$1 )
{
	...
	label$94:;
	{
		...
		label$121:;
		{
			...
			label$167:;
			if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$92$3 * 56ll)) != 1ll ) goto label$124;
			{
		...
		{
			{
				...
				label$267:;
				TMP$101$4 = *(uint64*)(((uint8*)SYMB_DTYPETB$ + (TMP$100$4 * 56ll)) + 40ll);
				goto label$257;
				label$258:;
				{
				...
				label$261:;
				{
					...
					label$268:;
					if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$102$5 * 56ll)) != 1ll ) goto label$264;
					{
...
int64 ASTPTRCHECK( int64 PDTYPE$1, struct $8FBSYMBOL* PSUBTYPE$1, int64 PPARAMMODE$1, struct $7ASTNODE* EXPR$1 )
{
	...
	if( (EDTYPE$1 & 480ll) != 0ll ) goto label$272;
	{
		if( *(int64*)EXPR$1 != 16ll ) goto label$274;
		{
			...
			label$283:;
			if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$105$3 * 56ll)) != 0ll ) goto label$277;
			{
...
struct $7ASTNODE* ASTBUILDBRANCH( struct $7ASTNODE* EXPR$1, struct $8FBSYMBOL* LABEL$1, int64 IS_INVERSE$1, int64 IS_IIF$1 )
{
	...
	label$374:;
	if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$108$1 * 56ll)) != 2ll ) goto label$308;
	{
		fb$result$1 = (struct $7ASTNODE*)0ull;
		goto label$303;
	}
			...
			{
				{
					...
					label$343:;
					{
						...
						label$375:;
						if( *(int64*)((uint8*)SYMB_DTYPETB$ + (TMP$118$6 * 56ll)) != 0ll ) goto label$346;
						{
...
void ASTDTORLISTSCOPEBEGIN( int64 COOKIE$1 )
{
	...
	label$429:;
	{
		...
		if( *(int64*)((uint8*)TMP$128$2 + 8ll) != *(int64*)((uint8*)TMP$128$2 + 16ll) ) goto label$432;
		{
	...
	*(struct $8FBSYMBOL**)((uint8*)N$1 + 16ll) = SUBTYPE$1;
	{
		...
		if( TMP$130$2 != 15ll ) goto label$444;
		label$445:;
		{
			{
				int64 TMP$131$4;
				TMP$131$4 = *(int64*)((uint8*)N$1 + 40ll);
				if( TMP$131$4 != 1ll ) goto label$447;
				label$448:;
				{
				...
				goto label$446;
				label$447:;
				if( TMP$131$4 != 2ll ) goto label$449;
				label$450:;
				{
		...
		goto label$443;
		label$444:;
		if( TMP$130$2 != 19ll ) goto label$451;
		label$452:;
		{
			ASTSETTYPE( *(struct $7ASTNODE**)((uint8*)N$1 + 112ll), DTYPE$1, SUBTYPE$1 );
		}
		goto label$443;
		label$451:;
		if( TMP$130$2 != 10ll ) goto label$453;
		label$454:;
		{
			ASTSETTYPE( *(struct $7ASTNODE**)((uint8*)N$1 + 120ll), DTYPE$1, SUBTYPE$1 );
		}
		goto label$443;
		label$453:;
		if( TMP$130$2 != 26ll ) goto label$455;
		label$456:;
		{
			ASTSETTYPE( *(struct $7ASTNODE**)((uint8*)N$1 + 112ll), DTYPE$1, SUBTYPE$1 );
		}
...
int64 ASTSIZEOF( struct $7ASTNODE* N$1, int64* IS_FIXLENSTR$1 )
{
	...
	*IS_FIXLENSTR$1 = 0ll;
	...
	fb$result$1 = vr$4;
	{
		...
		if( TMP$132$2 == 4ll ) goto label$461;
		label$462:;
		if( TMP$132$2 == 7ll ) goto label$461;
		label$463:;
		if( TMP$132$2 != 18ll ) goto label$460;
		label$461:;
		{
...
int64 ASTISACCESSTOLOCAL( struct $7ASTNODE* EXPR$1 )
{
	...
	fb$result$1 = 0ll;
	{
		...
		if( TMP$133$2 != 17ll ) goto label$471;
		label$472:;
		{
		...
		goto label$470;
		label$471:;
		if( TMP$133$2 != 18ll ) goto label$473;
		label$474:;
		{
		...
		goto label$470;
		label$473:;
		if( TMP$133$2 != 9ll ) goto label$477;
		label$478:;
		{
			fb$result$1 = -1ll;
		}
		goto label$470;
		label$477:;
		if( TMP$133$2 != 19ll ) goto label$479;
		label$480:;
		{
			if( *(int64*)*(struct $7ASTNODE**)((uint8*)EXPR$1 + 112ll) != 20ll ) goto label$482;
			{
				if( *(struct $7ASTNODE**)((uint8*)*(struct $7ASTNODE**)((uint8*)EXPR$1 + 112ll) + 112ll) == (struct $7ASTNODE*)0ull ) goto label$484;
				{
					...
					TMP$134$5 = 0ll;
					label$490:;
					if( TMP$134$5 == 0ll ) goto label$487;
					{
