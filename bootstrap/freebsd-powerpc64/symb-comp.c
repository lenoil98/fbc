	...
	{
		{
			...
			if( (int64)TMP$89$3 != 1ll ) goto label$150;
			label$151:;
			{
			...
			goto label$149;
			label$150:;
			if( (int64)TMP$89$3 != 2ll ) goto label$152;
			label$153:;
			{
	...
	{
		{
			...
			if( TMP$90$3 != 10ll ) goto label$217;
			label$218:;
			{
			...
			goto label$216;
			label$217:;
			if( TMP$90$3 != 9ll ) goto label$221;
			label$222:;
			{
				fb$result$1 = (struct $8FBSYMBOL*)0ull;
			}
			goto label$216;
			label$221:;
			if( TMP$90$3 != 11ll ) goto label$223;
			label$224:;
			{
			}
			label$223:;
...
static void HBUILDRTTI( struct $8FBSYMBOL* UDT$1 )
{
	...
	SYMBNESTBEGIN( UDT$1, -1ll );
	struct $8FBSYMBOL* vr$0 = SYMBADDVAR( (uint8*)0ull, (uint8*)0ull, 20ll, *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 199232ll), 0ll, 0ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$85$1, 2051ll, 1ll );
	RTTI$1 = vr$0;
...
static void HBUILDVTABLE( struct $8FBSYMBOL* UDT$1 )
{
	...
	*(int64*)((uint8*)DTB$1 + 8ll) = *(int64*)((uint8*)*(struct $12FB_STRUCTEXT**)((uint8*)UDT$1 + 240ll) + 280ll) + -1ll;
	struct $8FBSYMBOL* vr$3 = SYMBADDVAR( (uint8*)0ull, (uint8*)0ull, 32ll, (struct $8FBSYMBOL*)0ull, 0ll, 1ll, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$86$1, 2051ll, 1ll );
	VTABLE$1 = vr$3;
