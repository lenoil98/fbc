...
static void PPSKIP( void )
{
	...
	*(int64*)((uint8*)&PP$ + 392ll) = -1ll;
	...
	if( *(int64*)((uint8*)&ENV$ + 296ll) == 0ll ) goto label$63;
	{
		...
		{
			struct $7ASTNODE* vr$1 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 844288ll) + 49632ll) );
			ASTADD( vr$1 );
	...
	{
		{
			...
			TMP$96$3 = vr$5;
			if( TMP$96$3 != 35ll ) goto label$72;
			label$73:;
			{
				LEXSKIPTOKEN( 256ll );
				{
					...
					if( (TMP$97$5 - 266ull) > 20ull ) goto label$91;
					goto *tmp$98[TMP$97$5 - 266ull];
					label$74:;
				}
			}
			goto label$71;
			label$72:;
			if( TMP$96$3 != 256ll ) goto label$92;
			label$93:;
			{
