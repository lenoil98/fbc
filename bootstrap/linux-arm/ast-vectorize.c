...
static int32 HNODESMATCH( struct $7ASTNODE* VN$1, struct $7ASTNODE* N$1 )
{
	...
	if( *(int32*)VN$1 != 16 ) goto label$19;
	{
		...
		goto label$315;
		label$22:;
		TMP$83$2 = *(int32*)((uint8*)VN$1 + 4) & 31;
		label$315:;
		if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$83$2 * 28)) != 1 ) goto label$24;
		{
...
static int32 HALLOWEDINVECTORIZE( struct $7ASTNODE* N$1, int32 DEREF$1 )
{
	...
	}
	{
		...
		if( (TMP$84$2 - 1u) > 19u ) goto label$65;
		goto *tmp$94[TMP$84$2 - 1u];
		label$33:;
	}
	fb$result$1 = 0;
	goto label$30;
		...
		if( *(int32*)N$1 != 4 ) goto label$82;
		{
			if( (-(*(int32*)((uint8*)N$1 + 24) == 75) | -(*(int32*)((uint8*)N$1 + 24) == 55)) == 0 ) goto label$84;
			{
				if( DOMERGE$1 == 0 ) goto label$86;
				{
					...
					goto label$316;
					label$87:;
					TMP$85$5 = *(int32*)((uint8*)N$1 + 16) + 1;
					label$316:;
					*(int32*)((uint8*)N$1 + 16) = TMP$85$5;
				}
				label$86:;
				label$85:;
...
static struct $7ASTNODE* HVECTORIZENODE( struct $7ASTNODE* N$1, int32 DIST$1 )
{
	...
	if( (-(*(int32*)N$1 == 4) | -(*(int32*)N$1 == 3)) == 0 ) goto label$113;
	{
		...
		goto label$317;
		label$114:;
		TMP$86$2 = *(int32*)((uint8*)N$1 + 16) + 1;
		label$317:;
		*(int32*)((uint8*)N$1 + 16) = TMP$86$2;
	}
	goto label$112;
	label$113:;
	{
		...
		label$116:;
		{
			...
			goto label$318;
			label$117:;
			TMP$87$3 = *(int32*)((uint8*)N$1 + 16) + 1;
			label$318:;
			*(int32*)((uint8*)N$1 + 16) = TMP$87$3;
		}
		label$115:;
	}
	label$112:;
	...
	{
		{
			...
			goto label$124;
			label$125:;
			if( TMP$88$3 == 17 ) goto label$130;
			label$131:;
			if( TMP$88$3 != 19 ) goto label$129;
			label$130:;
			{
				*DTYPE$1 = *(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 12) + 28) & 31;
...
static int32 HCHECKMEMOFFSET( struct $7ASTNODE* VECTORNODE$1, int32 OFFSET$1, $11FB_DATATYPE DTYPE$1 )
{
	...
	if( *(int32*)((uint8*)VECTORNODE$1 + 16) == 0 ) goto label$146;
	{
		...
		TMP$89$2 = DTYPE$1 & 31;
		label$319:;
		NEEDOFFSET$1 = VECTORWIDTH$ * *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$89$2 * 28)) + 4);
	}
	goto label$145;
	label$146:;
	{
		...
		TMP$90$2 = DTYPE$1 & 31;
		label$320:;
		NEEDOFFSET$1 = *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$90$2 * 28)) + 4);
	}
	label$145:;
	fb$result$1 = -1;
...
static $11FB_DATATYPE HGETASSIGNDATATYPE( struct $7ASTNODE* N$1 )
{
	...
	}
	{
		...
		goto label$161;
		label$162:;
		if( TMP$91$2 == 17 ) goto label$165;
		label$166:;
		if( TMP$91$2 != 19 ) goto label$164;
		label$165:;
		{
...
static int32 HMERGENODE( struct $7ASTNODE* VECTORNODE$1, struct $7ASTNODE* N$1, int32 DOMERGE$1 )
{
	...
	if( *(int32*)VECTORNODE$1 != 2 ) goto label$181;
	{
		...
		if( *(int32*)((uint8*)VECTORNODE$1 + 16) == 0 ) goto label$183;
		{
			...
			TMP$92$3 = DTYPE$1 & 31;
			label$321:;
			NEEDOFFSET$1 = VECTORWIDTH$ * *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$92$3 * 28)) + 4);
		}
		goto label$182;
		label$183:;
		{
			...
			TMP$93$3 = DTYPE$1 & 31;
			label$322:;
			NEEDOFFSET$1 = *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$93$3 * 28)) + 4);
		}
		label$182:;
