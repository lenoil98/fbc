...
typedef int32 (*tmp$92)( struct $8REGCLASS*, struct $6IRVREG*, struct $6IRVREG*, uint32 );
typedef int32 (*tmp$93)( struct $8REGCLASS*, int32, struct $6IRVREG*, struct $6IRVREG* );
typedef void (*tmp$94)( struct $8REGCLASS*, int32 );
typedef int32 (*tmp$95)( struct $8REGCLASS*, int32 );
typedef void (*tmp$96)( struct $8REGCLASS*, int32, struct $6IRVREG*, struct $6IRVREG* );
typedef int32 (*tmp$97)( struct $8REGCLASS* );
typedef struct $6IRVREG* (*tmp$98)( struct $8REGCLASS*, int32, struct $6IRVREG** );
...
{
	label$10:;
	*(int32*)((uint8*)REMAPTB$ + 28) = *(int32*)((uint8*)REMAPTB$ + (*(int32*)((uint8*)&ENV$ + 248) << (2 & 31)));
	label$11:;
}
...
void EDBGEMITHEADER( uint8* FILENAME$1 )
{
	...
	*(uint8**)((uint8*)&CTX$ + 292) = (uint8*)0u;
	...
	HLABEL( (uint8*)*(uint8**)&LNAME$1 );
	{
		...
		label$31:;
		{
			HEMITSTABS( 128, *(uint8**)((uint8*)STABSTB$ + (I$2 << (2 & 31))), 0, 0, (uint8*)"0" );
...
void EDBGSCOPEBEGIN( struct $8FBSYMBOL* S$1 )
{
	...
	label$67:;
	label$66:;
	*(int32*)((uint8*)S$1 + 72) = *(int32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16564);
...
void EDBGSCOPEEND( struct $8FBSYMBOL* S$1 )
{
	...
	label$71:;
	label$70:;
	*(int32*)((uint8*)S$1 + 76) = *(int32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16564);
	struct $8FBSYMBOL* vr$2 = SYMBADDLABEL( (uint8*)0u, 4 );
...
static FBSTRING* HGETDATATYPE( struct $8FBSYMBOL* SYM$1, int32 REQUESTEDDIMTBELEMENTS$1 )
{
	...
	DTYPE$1 = DTYPE$1 & -513;
	{
		...
		label$165:;
		{
			FBSTRING* vr$101 = fb_IntToStr( *(int32*)((uint8*)REMAPTB$ + (DTYPE$1 << (2 & 31))) );
