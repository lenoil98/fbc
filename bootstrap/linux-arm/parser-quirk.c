...
int32 CQUIRKSTMT( $8FB_TOKEN TK$1 )
{
	...
	if( TK$1 != -1 ) goto label$13;
	{
		...
		TK$1 = vr$1;
		{
			...
			TMP$93$3 = vr$2;
			if( TMP$93$3 == 1 ) goto label$16;
			label$17:;
			if( TMP$93$3 != 2 ) goto label$15;
			label$16:;
			{
	...
	RES$1 = 0;
	{
		...
		if( (TMP$94$2 - 260u) > 256u ) goto label$27;
		goto *tmp$95[TMP$94$2 - 260u];
		label$27:;
	}
...
struct $7ASTNODE* CQUIRKFUNCTION( struct $8FBSYMBOL* SYM$1 )
{
	...
	if( (*(int32*)((uint8*)&PARSER$ + 148) & 1024) == 0 ) goto label$94;
	{
		...
		if( (-(vr$3 != 40) & (-(TK$1 != 336) | -(vr$6 != 301))) == 0 ) goto label$96;
		{
			...
			fb_StrAssign( (void*)&TMP$96$3, -1, (void*)vr$13, -1, 0 );
	...
	label$93:;
	{
		...
		if( (TMP$97$2 - 336u) > 181u ) goto label$97;
		goto *tmp$98[TMP$97$2 - 336u];
		label$97:;
	}
