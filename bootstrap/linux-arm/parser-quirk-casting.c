...
struct $7ASTNODE* CTYPECONVEXPR( $8FB_TOKEN TK$1, int32 ISASM$1 )
{
	...
	OP$1 = -1;
	{
		...
		if( (TMP$93$2 - 399u) > 14u ) goto label$12;
		goto *tmp$94[TMP$93$2 - 399u];
		label$12:;
	}
	...
	label$29:;
	LEXSKIPTOKEN( 2048 );
	if( (-(TK$1 == 404) | -(TK$1 == 405)) == 0 ) goto label$34;
	{
		...
		if( vr$4 == 0 ) goto label$36;
		{
			...
			LGT$3 = vr$6;
			$11FB_DATATYPE vr$8 = HINTEGERTYPEFROMBITSIZE( LGT$3, -(TK$1 == 405) );
			DTYPE$1 = vr$8;
	...
	struct $7ASTNODE* vr$18 = ASTNEWCONV( DTYPE$1, (struct $8FBSYMBOL*)0u, EXPR$1, 2, &ERRMSG$1 );
	EXPR$1 = vr$18;
...
struct $7ASTNODE* CANONTYPE( void )
{
	...
	if( IS_EXPLICIT$1 == 0 ) goto label$59;
	{
		...
		TMP$96$2 = 0;
		TMP$95$2 = 0ll;
		int32 vr$6 = CSYMBOLTYPE( &DTYPE$1, &SUBTYPE$1, &TMP$95$2, &TMP$96$2, 1 );
	...
	label$59:;
	{
		SUBTYPE$1 = *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 156);
		DTYPE$1 = *(int32*)((uint8*)&PARSER$ + 152);
		...
		{
			int32 TMP$97$3;
			TMP$97$3 = DTYPE$1 & 511;
			if( TMP$97$3 == 0 ) goto label$66;
			label$67:;
			if( TMP$97$3 != 23 ) goto label$65;
			label$66:;
			{
				ERRREPORT( 71, 0, (uint8*)0u );
				DTYPE$1 = 8;
	...
	if( (DTYPE$1 & 511) != 20 ) goto label$73;
	{
		...
		if( vr$10 == (struct $8FBSYMBOL*)0u ) goto label$75;
		{
	...
	SYM$1 = vr$12;
	struct $7ASTNODE* vr$13 = CINITIALIZER( SYM$1, 0, -2147483648u, (struct $8FBSYMBOL*)0u );
	INITREE$1 = vr$13;
