...
int32 ASTCONSTEQZERO( struct $7ASTNODE* N$1 )
{
	...
	label$15:;
	if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$83$1 * 28)) != 1 ) goto label$14;
	{
...
int32 ASTCONSTGEZERO( struct $7ASTNODE* N$1 )
{
	...
	label$23:;
	if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$84$1 * 28)) != 1 ) goto label$20;
	{
		fb$result$1 = -(*(double*)((uint8*)N$1 + 24) >= 0x0p+0);
	}
	goto label$19;
	...
	goto label$24;
	label$22:;
	TMP$85$1 = *(int32*)((uint8*)N$1 + 4) & 31;
	label$24:;
	if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$85$1 * 28)) + 8) == 0 ) goto label$21;
	{
		fb$result$1 = -(*(int64*)((uint8*)N$1 + 24) >= 0ll);
	}
	goto label$19;
...
struct $7ASTNODE* ASTNEWCONST( union $7FBVALUE* V$1, int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	TMP$86$1 = DTYPE$1 & 31;
	label$48:;
	if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$86$1 * 28)) != 1 ) goto label$47;
	{
	...
	struct $8FBSYMBOL* FLD$1;
	{
		...
		label$56:;
		{
			...
			if( FLD$1 == (struct $8FBSYMBOL*)0u ) goto label$58;
			{
				...
				ASTTYPEINIADDASSIGN( TREE$1, vr$9, FLD$1, -2147483648u, (struct $8FBSYMBOL*)0u );
		...
		label$59:;
		{
			...
			TMP$88$3 = DTYPE$1 & 31;
			label$65:;
			if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$88$3 * 28)) != 1 ) goto label$64;
			{
		...
		if( TMP$87$2 > 20u ) goto label$59;
		goto *tmp$89[TMP$87$2 - 0u];
		label$51:;
	}
	label$50:;
	return fb$result$1;
...
struct $6IRVREG* ASTLOADCONST( struct $7ASTNODE* N$1 )
{
	...
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$69;
	{
		...
		TMP$90$2 = DTYPE$1 & 31;
		label$73:;
		if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$90$2 * 28)) != 1 ) goto label$72;
		{
			struct $6IRVREG* vr$8 = (*(tmp$71*)((uint8*)&IR$ + 236))( DTYPE$1, *(struct $8FBSYMBOL**)((uint8*)N$1 + 8), *(double*)((uint8*)N$1 + 24) );
			fb$result$1 = vr$8;
		}
		goto label$71;
		label$72:;
		{
			struct $6IRVREG* vr$11 = (*(tmp$70*)((uint8*)&IR$ + 232))( DTYPE$1, *(struct $8FBSYMBOL**)((uint8*)N$1 + 8), *(int64*)((uint8*)N$1 + 24) );
			fb$result$1 = vr$11;
		}
		label$71:;
	}
...
FBSTRING* ASTCONSTFLUSHTOSTR( struct $7ASTNODE* N$1 )
{
	...
	label$86:;
	if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$91$1 * 28)) != 1 ) goto label$80;
	{
	...
	label$87:;
	if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$92$1 * 28)) + 8) == 0 ) goto label$84;
	{
...
uint32* ASTCONSTFLUSHTOWSTR( struct $7ASTNODE* N$1 )
{
	...
	goto label$98;
	label$90:;
	TMP$93$1 = *(int32*)((uint8*)N$1 + 4) & 31;
	label$98:;
	if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$93$1 * 28)) != 1 ) goto label$92;
	{
		...
		label$94:;
		{
			...
			TMP$95$3 = vr$12;
			fb_WstrAssign( (uint32*)W$1, 65, (uint32*)TMP$95$3 );
			fb_WstrDelete( (uint32*)TMP$95$3 );
		}
		label$93:;
	}
	goto label$91;
	...
	if( (*(int32*)((uint8*)N$1 + 4) & 511) != 1 ) goto label$95;
	{
		...
		TMP$96$2 = vr$17;
		fb_WstrAssign( (uint32*)W$1, 65, (uint32*)TMP$96$2 );
		fb_WstrDelete( (uint32*)TMP$96$2 );
	}
	goto label$91;
	label$95:;
	...
	goto label$99;
	label$97:;
	TMP$97$1 = *(int32*)((uint8*)N$1 + 4) & 31;
	label$99:;
	if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$97$1 * 28)) + 8) == 0 ) goto label$96;
	{
		uint32* TMP$98$2;
	...
	label$96:;
	{
		...
		TMP$99$2 = vr$26;
		fb_WstrAssign( (uint32*)W$1, 65, (uint32*)TMP$99$2 );
		fb_WstrDelete( (uint32*)TMP$99$2 );
	}
	label$91:;
	ASTDELNODE( N$1 );
...
int64 ASTCONSTGETASINT64( struct $7ASTNODE* N$1 )
{
	...
	label$105:;
	if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$100$1 * 28)) != 1 ) goto label$104;
	{
...
double ASTCONSTGETASDOUBLE( struct $7ASTNODE* N$1 )
{
	...
	label$113:;
	if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$101$1 * 28)) != 1 ) goto label$110;
	{
	...
	goto label$114;
	label$112:;
	TMP$102$1 = *(int32*)((uint8*)N$1 + 4) & 31;
	label$114:;
	if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$102$1 * 28)) + 8) == 0 ) goto label$111;
	{
...
struct $7ASTNODE* ASTCONVERTRAWCONSTI( int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, struct $7ASTNODE* L$1 )
{
	...
	goto label$126;
	label$124:;
	TMP$104$1 = *(int32*)((uint8*)L$1 + 4) & 31;
	label$126:;
	if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$104$1 * 28)) + 8) == 0 ) goto label$125;
	TMP$105$1 = 13;
	goto label$127;
	label$125:;
	TMP$105$1 = 14;
	label$127:;
	*(int32*)((uint8*)L$1 + 4) = TMP$105$1;
