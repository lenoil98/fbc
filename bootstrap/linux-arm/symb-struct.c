...
static int32 HGETRETURNTYPEGAS64LINUX( struct $8FBSYMBOL* );
...
struct $8FBSYMBOL* SYMBSTRUCTBEGIN( struct $10FBSYMBOLTB* SYMTB$1, struct $8FBHASHTB* HASHTB$1, struct $8FBSYMBOL* PARENT$1, uint8* ID$1, uint8* ID_ALIAS$1, int32 ISUNION$1, int32 ALIGN$1, int32 IS_DERIVED$1, $13FB_SYMBATTRIB ATTRIB$1, int32 OPTIONS$1 )
{
	...
	{
		if( *(int32*)((uint8*)&PARSER$ + 100) == 0 ) goto label$15;
		{
			ID_ALIAS$1 = ID$1;
		}
		label$15:;
...
void SYMBSTRUCTADDBASE( struct $8FBSYMBOL* S$1, struct $8FBSYMBOL* BASE_$1 )
{
	...
	struct $8FBSYMBOL* vr$0 = SYMBADDFIELD( S$1, (uint8*)"base$", 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$93$1, 20, BASE_$1, 0ll, 0, 0 );
	*(struct $8FBSYMBOL**)((uint8*)S$1 + 96) = vr$0;
	...
	if( (*(int32*)((uint8*)BASE_$1 + 12) & 4194304) == 0 ) goto label$35;
	{
		*($12FB_SYMBSTATS*)((uint8*)S$1 + 12) = *(int32*)((uint8*)S$1 + 12) | 4194304;
		SYMBUDTALLOCEXT( S$1 );
		*(int32*)((uint8*)*(struct $12FB_STRUCTEXT**)((uint8*)S$1 + 140) + 140) = *(int32*)((uint8*)*(struct $12FB_STRUCTEXT**)((uint8*)BASE_$1 + 140) + 140);
		*(int32*)((uint8*)*(struct $12FB_STRUCTEXT**)((uint8*)S$1 + 140) + 152) = *(int32*)((uint8*)*(struct $12FB_STRUCTEXT**)((uint8*)BASE_$1 + 140) + 152);
	}
	label$35:;
	label$34:;
	label$33:;
...
int32 TYPECALCNATURALALIGN( int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	int32 ALIGN$1;
	{
		...
		label$43:;
		{
			...
			TMP$97$3 = DTYPE$1 & 31;
			label$50:;
			ALIGN$1 = *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$97$3 * 28)) + 4);
		}
		goto label$39;
		label$40:;
		...
		if( (TMP$96$2 - 17u) > 3u ) goto label$43;
		goto *tmp$98[TMP$96$2 - 17u];
		label$39:;
	}
...
int32 SYMBCHECKBITFIELD( struct $8FBSYMBOL* UDT$1, int32 DTYPE$1, int64 LGT$1, int32 BITS$1 )
{
	...
	label$63:;
	{
		...
		if( (TMP$100$2 - 1u) > 13u ) goto label$70;
...
struct $8FBSYMBOL* SYMBADDFIELD( struct $8FBSYMBOL* PARENT$1, uint8* ID$1, int32 DIMENSIONS$1, struct $7FBARRAYI10FBARRAYDIME* DTB$1, int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int64 LGT$1, int32 BITS$1, $13FB_SYMBATTRIB ATTRIB$1 )
{
	...
	if( (ATTRIB$1 & 4) == 0 ) goto label$77;
	{
		...
		*(struct $10FBARRAYDIM**)((uint8*)&tmp$102$2 + 4) = (struct $10FBARRAYDIM*)EMPTYDTB$2;
		*(int32*)((uint8*)&tmp$102$2 + 8) = 16;
		*(int32*)((uint8*)&tmp$102$2 + 12) = 16;
		*(int32*)((uint8*)&tmp$102$2 + 16) = 1;
		*(int32*)((uint8*)&tmp$102$2 + 20) = 49;
		*(int32*)((uint8*)&tmp$102$2 + 24) = 1;
		*(int32*)((uint8*)&tmp$102$2 + 28) = 0;
		*(int32*)((uint8*)&tmp$102$2 + 32) = 0;
		struct $8FBSYMBOL* vr$6 = SYMBADDARRAYDESCRIPTORTYPE( DIMENSIONS$1, DTYPE$1, SUBTYPE$1 );
		DESCTYPE$1 = vr$6;
		struct $8FBSYMBOL* vr$8 = SYMBADDFIELD( PARENT$1, ID$1, 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$102$2, 20, DESCTYPE$1, 0ll, 0, 8192 );
		DESC$1 = vr$8;
	...
	if( ALLOC_FIELD$1 == 0 ) goto label$89;
	{
		...
		if( PAD$1 <= 0 ) goto label$91;
		{
			...
			{
				if( *(int32*)((uint8*)&ENV$ + 212) != 0 ) goto label$95;
				{
					if( BITS$1 > (PAD$1 << (3 & 31)) ) goto label$97;
					{
						...
						PAD$1 = 0;
						{
							...
							label$100:;
							{
								...
								label$152:;
								if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$103$8 * 28)) + 8) == 0 ) goto label$103;
								{
									DTYPE$1 = 2;
								}
								goto label$102;
							...
							label$105:;
							{
								...
								goto label$153;
								label$106:;
								TMP$104$8 = DTYPE$1 & 31;
								label$153:;
								if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$104$8 * 28)) + 8) == 0 ) goto label$108;
								{
									DTYPE$1 = 5;
								}
								goto label$107;
	...
	*(int32*)((uint8*)SYM$1 + 116) = BITS$1;
	...
	label$122:;
	{
		{
			int32 TMP$105$3;
			TMP$105$3 = DTYPE$1 & 511;
			if( TMP$105$3 != 17 ) goto label$126;
			label$127:;
			{
			...
			goto label$125;
			label$126:;
			if( TMP$105$3 != 20 ) goto label$130;
			label$131:;
			{
				...
				label$135:;
				label$134:;
				struct $8FBSYMBOL* vr$108 = SYMBGETCOMPDTOR( SUBTYPE$1 );
...
void SYMBSTRUCTEND( struct $8FBSYMBOL* SYM$1, int32 ISNESTED$1 )
{
	...
	*($15FB_STRUCT_INREG*)((uint8*)SYM$1 + 132) = 0;
	int32 vr$14 = HGETRETURNTYPE( SYM$1 );
	*($11FB_DATATYPE*)((uint8*)SYM$1 + 128) = vr$14;
	SYMBUDTIMPLEMENTDEFAULTMEMBERS( &DEFAULTMEMBERS$1, SYM$1 );
	if( *(int32*)((uint8*)&SYMB$ + 98692) <= 0 ) goto label$272;
	{
...
void SYMBDELSTRUCT( struct $8FBSYMBOL* S$1 )
{
	...
	if( *(struct $12FB_STRUCTEXT**)((uint8*)S$1 + 140) == (struct $12FB_STRUCTEXT*)0u ) goto label$276;
	{
...
struct $8FBSYMBOL* SYMBUDTGETNEXTINITABLEFIELD( struct $8FBSYMBOL* SYM$1 )
{
	...
	label$297:;
	{
		...
		PARENT$1 = vr$2;
		if( PARENT$1 != (struct $8FBSYMBOL*)0u ) goto label$303;
		{
			goto label$298;
		}
		label$303:;
		label$302:;
		if( (*(int32*)((uint8*)PARENT$1 + 120) & 1) != 0 ) goto label$305;
		{
			goto label$298;
		}
		label$305:;
...
int32 SYMBGETUDTBASELEVEL( struct $8FBSYMBOL* S$1, struct $8FBSYMBOL* BASESYM$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 4 );
	label$306:;
	if( (-(S$1 == (struct $8FBSYMBOL*)0u) | -(BASESYM$1 == (struct $8FBSYMBOL*)0u)) == 0 ) goto label$309;
	{
		fb$result$1 = 0;
		goto label$307;
	}
	...
	LEVEL$1 = 1;
	label$310:;
	if( *(struct $8FBSYMBOL**)((uint8*)S$1 + 96) == (struct $8FBSYMBOL*)0u ) goto label$311;
	{
		if( *(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)S$1 + 96) + 32) != BASESYM$1 ) goto label$313;
		{
			fb$result$1 = LEVEL$1;
			goto label$307;
		}
...
struct $8FBSYMBOL* SYMBCLONESIMPLESTRUCT( struct $8FBSYMBOL* SYM$1 )
{
	...
	__FB_STATIC_ASSERT( sizeof( struct $8FBARRAY1I10FBARRAYDIME ) == 36 );
	static struct $8FBARRAY1I10FBARRAYDIME tmp$110$1 = { (struct $10FBARRAYDIM*)DTB$1, (struct $10FBARRAYDIM*)DTB$1, 16, 16, 1, 49, { { 1, 0, 0 } } };
	struct $8FBSYMBOL* S$1;
	struct $8FBSYMBOL* FLD$1;
	...
	FLD$1 = vr$4;
	label$316:;
	if( FLD$1 == (struct $8FBSYMBOL*)0u ) goto label$317;
	{
		SYMBADDFIELD( S$1, *(uint8**)((uint8*)FLD$1 + 16), 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$110$1, *(int32*)((uint8*)FLD$1 + 28), *(struct $8FBSYMBOL**)((uint8*)FLD$1 + 32), 0ll, 0, 0 );
...
static void STRUCT_ANALYZE( struct $8FBSYMBOL* FLD$1, int32* PART1$1, int32* PART2$1, int32* RANGE$1 )
{
	...
	if( FLD$1 == (struct $8FBSYMBOL*)0u ) goto label$179;
	{
		...
		label$318:;
		if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$106$2 * 28)) != 3 ) goto label$184;
		{
		...
		goto label$319;
		label$186:;
		TMP$107$2 = *(int32*)((uint8*)FLD$1 + 28) & 31;
		label$319:;
		if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$107$2 * 28)) != 0 ) goto label$185;
		{
...
static int32 HGETRETURNTYPEGAS64LINUX( struct $8FBSYMBOL* SYM$1 )
{
	int32 fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$196:;
	if( *(int64*)((uint8*)SYM$1 + 40) > (int64)(*(int32*)((uint8*)SYMB_DTYPETB$ + 368) << (1 & 31)) ) goto label$199;
	{
		{
			uint32 TMP$108$3;
			int32 vr$4 = HGETMAGICSTRUCTNUMBER( SYM$1 );
			TMP$108$3 = (uint32)vr$4;
			goto label$201;
			label$202:;
			{
				fb$result$1 = 13;
			...
			if( (TMP$108$3 - 1u) > 9u ) goto label$208;
			goto *tmp$111[TMP$108$3 - 1u];
			label$200:;
		}
	}
	label$199:;
...
static int32 HGETRETURNTYPE( struct $8FBSYMBOL* SYM$1 )
{
	...
	if( vr$2 == 0 ) goto label$216;
	{
		...
		{
			if( *(int32*)((uint8*)&ENV$ + 108) != 2 ) goto label$220;
			{
				int32 vr$3 = HGETRETURNTYPEGAS64LINUX( SYM$1 );
				fb$result$1 = vr$3;
				goto label$210;
			}
			label$220:;
	...
	label$216:;
	label$215:;
	if( (*(int32*)((uint8*)&ENV$ + 260) & 16) != 0 ) goto label$222;
	{
		fb$result$1 = 52;
		goto label$210;
	}
	...
	label$223:;
	{
		...
		label$234:;
		{
			label$235:;
			{
				...
				FLD$1 = vr$11;
				struct $8FBSYMBOL* vr$12 = SYMBUDTGETNEXTFIELD( FLD$1 );
				if( vr$12 == (struct $8FBSYMBOL*)0u ) goto label$239;
				{
					goto label$236;
				}
				label$239:;
		...
		label$246:;
		{
			struct $8FBSYMBOL* vr$18 = SYMBUDTGETFIRSTFIELD( SYM$1 );
			FLD$1 = vr$18;
		...
		label$251:;
		{
			label$252:;
			{
				...
				FLD$1 = vr$21;
				struct $8FBSYMBOL* vr$22 = SYMBUDTGETNEXTFIELD( FLD$1 );
				if( vr$22 == (struct $8FBSYMBOL*)0u ) goto label$256;
				{
					goto label$253;
				}
				label$256:;
		...
		if( (TMP$109$2 - 1u) > 7u ) goto label$225;
		goto *tmp$112[TMP$109$2 - 1u];
		label$225:;
	}
...
static struct $8FBSYMBOL* HSKIPTOFIELD( struct $8FBSYMBOL* SYM$1 )
{
	...
	{
		if( *(int32*)SYM$1 != 12 ) goto label$282;
		{
			goto label$280;
		}
		label$282:;
...
static struct $8FBSYMBOL* HFINDCOMMONPARENT( struct $8FBSYMBOL* A$1, struct $8FBSYMBOL* B$1 )
{
	...
	ORIGINALB$1 = B$1;
	label$289:;
	if( A$1 == (struct $8FBSYMBOL*)0u ) goto label$290;
	{
		B$1 = ORIGINALB$1;
		label$291:;
		if( B$1 == (struct $8FBSYMBOL*)0u ) goto label$292;
		{
