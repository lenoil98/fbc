...
static struct $8FBARRAY1IP8FBSYMBOLE tmp$84$ = { (struct $8FBSYMBOL**)RTLLOOKUPTB$, (struct $8FBSYMBOL**)RTLLOOKUPTB$, 1464, 4, 1, 49, { { 366, 0, 365 } } };
...
void RTLADDINTRINSICPROCS( struct $14FB_RTL_PROCDEF* PROCDEF$1 )
{
	...
	label$16:;
	{
		...
		{
			CALLCONV$1 = *(int32*)((uint8*)&ENV$ + 252);
		}
		label$22:;
		label$21:;
		int32 DOADD$2;
		...
		{
			DOADD$2 = -((*(int32*)((uint8*)&ENV$ + 888) & 1) != 0);
		}
		label$24:;
		label$23:;
		...
		if( DOADD$2 == 0 ) goto label$36;
		{
			...
			PROC$3 = vr$20;
			{
				...
				I$4 = 0;
				int32 TMP$85$4;
				TMP$85$4 = *(int32*)((uint8*)PROCDEF$1 + 24) + -1;
				goto label$37;
				label$40:;
				{
					{
						...
						TMP$86$6 = (struct $15FB_RTL_PARAMDEF*)((uint8*)((uint8*)PROCDEF$1 + (I$4 * 20)) + 28);
						struct $8FBSYMBOL* SUBTYPE$6;
						SUBTYPE$6 = (struct $8FBSYMBOL*)0u;
						int32 DTYPE$6;
						struct $7ASTNODE* PARAM_OPTVAL$6;
						if( *(int32*)((uint8*)TMP$86$6 + 8) == 0 ) goto label$42;
						{
							{
								uint32 TMP$87$8;
								TMP$87$8 = (uint32)(*(int32*)TMP$86$6 & 511);
								goto label$44;
								label$45:;
								{
								...
								label$46:;
								{
									struct $7ASTNODE* vr$33 = ASTNEWCONSTF( (double)*(int32*)((uint8*)TMP$86$6 + 12), *(int32*)TMP$86$6 );
								...
								label$47:;
								{
									...
									INNER_PROC$9 = vr$34;
									{
										...
										FUNC_ARG$10 = 0;
										int32 TMP$88$10;
										TMP$88$10 = *(int32*)((uint8*)TMP$86$6 + 12) + -1;
										goto label$48;
										label$51:;
										{
											I$4 = I$4 + 1;
											{
												...
												TMP$89$12 = (struct $15FB_RTL_PARAMDEF*)((uint8*)((uint8*)PROCDEF$1 + (I$4 * 20)) + 28);
												if( *(int32*)((uint8*)TMP$89$12 + 8) == 0 ) goto label$53;
												{
													{
														uint32 TMP$90$14;
														TMP$90$14 = (uint32)(*(int32*)TMP$89$12 & 511);
														goto label$55;
														label$56:;
														{
														...
														label$57:;
														{
															struct $7ASTNODE* vr$48 = ASTNEWCONSTF( (double)*(int32*)((uint8*)TMP$89$12 + 12), *(int32*)TMP$89$12 );
															INNER_PARAM_OPTVAL$9 = vr$48;
														}
														goto label$54;
														label$58:;
														{
															struct $7ASTNODE* vr$52 = ASTNEWCONSTI( (int64)*(int32*)((uint8*)TMP$89$12 + 12), *(int32*)TMP$89$12, (struct $8FBSYMBOL*)0u );
														...
														if( (TMP$90$14 - 15u) > 2u ) goto label$58;
														goto *tmp$96[TMP$90$14 - 15u];
														label$54:;
													}
												}
												goto label$52;
												...
												label$52:;
												if( *(int32*)((uint8*)TMP$89$12 + 4) != 3 ) goto label$59;
												TMP$91$12 = -1;
												goto label$82;
												label$59:;
												TMP$91$12 = 0;
												label$82:;
												struct $8FBSYMBOL* vr$56 = SYMBADDPROCPARAM( INNER_PROC$9, (uint8*)0u, *(int32*)TMP$89$12, (struct $8FBSYMBOL*)0u, TMP$91$12, *(int32*)((uint8*)TMP$89$12 + 4), 0, 0 );
												PARAM$1 = vr$56;
									...
									I$4 = I$4 + 1;
									{
										...
										TMP$92$10 = (struct $15FB_RTL_PARAMDEF*)((uint8*)((uint8*)PROCDEF$1 + (I$4 * 20)) + 28);
										struct $8FBSYMBOL* vr$63 = SYMBADDPROCPTR( INNER_PROC$9, *(int32*)TMP$92$10, (struct $8FBSYMBOL*)0u, 0, 0, *(int32*)((uint8*)&ENV$ + 252) );
										SUBTYPE$6 = vr$63;
									}
								...
								label$60:;
								{
									struct $7ASTNODE* vr$67 = ASTNEWCONSTI( (int64)*(int32*)((uint8*)TMP$86$6 + 12), *(int32*)TMP$86$6, (struct $8FBSYMBOL*)0u );
									PARAM_OPTVAL$6 = vr$67;
								}
								goto label$43;
								label$44:;
								static const void* tmp$97[40] = {
									&&label$46,
									&&label$46,
									&&label$45,
									&&label$60,
								...
								if( (TMP$87$8 - 15u) > 39u ) goto label$60;
								goto *tmp$97[TMP$87$8 - 15u];
								label$43:;
							}
						}
						goto label$41;
						...
						label$62:;
						label$61:;
						if( *(int32*)((uint8*)TMP$86$6 + 4) != 3 ) goto label$63;
						TMP$93$6 = -1;
						goto label$83;
						label$63:;
						TMP$93$6 = 0;
						label$83:;
						struct $8FBSYMBOL* vr$71 = SYMBADDPROCPARAM( PROC$3, (uint8*)0u, DTYPE$6, SUBTYPE$6, TMP$93$6, *(int32*)((uint8*)TMP$86$6 + 4), 0, 0 );
						PARAM$1 = vr$71;
			...
			if( (*(int32*)((uint8*)PROCDEF$1 + 20) & 128) == 0 ) goto label$69;
			{
				if( *(int32*)((uint8*)&ENV$ + 136) != 3 ) goto label$71;
				{
					...
					FBSTRING* vr$84 = fb_StrConcat( &TMP$95$5, (void*)"__", 3, (void*)PNAME$3, 0 );
		...
		label$36:;
		label$35:;
		PROCDEF$1 = (struct $14FB_RTL_PROCDEF*)((uint8*)PROCDEF$1 + 348);
	}
	label$18:;
	goto label$16;
	label$17:;
...
struct $8FBSYMBOL* RTLPROCLOOKUP( uint8* PNAME$1, int32 PIDX$1 )
{
	...
	if( *(struct $8FBSYMBOL**)((uint8*)RTLLOOKUPTB$ + (PIDX$1 << (2 & 31))) != (struct $8FBSYMBOL*)0u ) goto label$87;
	{
		...
		if( CHAIN_$1 != (struct $10FBSYMCHAIN*)0u ) goto label$89;
		{
			if( *(int32*)((uint8*)&ENV$ + 136) != 3 ) goto label$91;
			{
				...
				FBSTRING* vr$6 = fb_StrConcat( &TMP$98$4, (void*)"__", 3, (void*)PNAME$1, 0 );
				...
				if( CHAIN_$1 != (struct $10FBSYMCHAIN*)0u ) goto label$93;
				{
					...
					*(struct $8FBSYMBOL**)((uint8*)RTLLOOKUPTB$ + (PIDX$1 << (2 & 31))) = (struct $8FBSYMBOL*)0u;
				}
				goto label$92;
				label$93:;
				{
					*(struct $8FBSYMBOL**)((uint8*)RTLLOOKUPTB$ + (PIDX$1 << (2 & 31))) = *(struct $8FBSYMBOL**)CHAIN_$1;
				}
				label$92:;
			}
			goto label$90;
	...
	label$87:;
	label$86:;
	fb$result$1 = *(struct $8FBSYMBOL**)((uint8*)RTLLOOKUPTB$ + (PIDX$1 << (2 & 31)));
	label$85:;
	return fb$result$1;
}
...
int64 RTLCALCEXPRLEN( struct $7ASTNODE* EXPR$1 )
{
	...
	DTYPE$1 = *(int32*)((uint8*)EXPR$1 + 4) & 511;
	{
		...
		if( (TMP$99$2 - 4u) > 14u ) goto label$109;
		goto *tmp$100[TMP$99$2 - 4u];
		label$106:;
	}
	label$105:;
	return fb$result$1;
	...
	__builtin_memset( &S$1, 0, 4 );
	{
		...
		label$121:;
		{
			...
			label$123:;
			{
				...
				label$125:;
				{
					int64 vr$15 = __divdi3( *(int64*)((uint8*)S$1 + 40), (int64)*(int32*)((uint8*)SYMB_DTYPETB$ + 200) );
					fb$result$1 = vr$15;
				}
				label$124:;
			}
		...
		if( (TMP$102$2 - 2u) > 16u ) goto label$126;
		goto *tmp$103[TMP$102$2 - 2u];
		label$113:;
	}
	label$111:;
	return fb$result$1;
