...
struct $7ASTNODE* RTLMATHPOW( struct $7ASTNODE* XEXPR$1, struct $7ASTNODE* YEXPR$1 )
{
	...
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_Pow", 158 );
...
struct $7ASTNODE* RTLMATHLONGINTDIV( int32 DTYPE$1, struct $7ASTNODE* LEXPR$1, int32 LDTYPE$1, struct $7ASTNODE* REXPR$1, int32 RDTYPE$1 )
{
	...
	label$29:;
	if( TMP$132$1 != 13 ) goto label$24;
	{
		struct $8FBSYMBOL* vr$3 = RTLPROCLOOKUP( (uint8*)"fb___divdi3", 115 );
		F$1 = vr$3;
	}
	goto label$23;
	label$24:;
	{
		struct $8FBSYMBOL* vr$4 = RTLPROCLOOKUP( (uint8*)"fb___udivdi3", 116 );
		F$1 = vr$4;
	}
	label$23:;
...
struct $7ASTNODE* RTLMATHLONGINTMOD( int32 DTYPE$1, struct $7ASTNODE* LEXPR$1, int32 LDTYPE$1, struct $7ASTNODE* REXPR$1, int32 RDTYPE$1 )
{
	...
	label$39:;
	if( TMP$133$1 != 13 ) goto label$34;
	{
		struct $8FBSYMBOL* vr$3 = RTLPROCLOOKUP( (uint8*)"fb___moddi3", 117 );
		F$1 = vr$3;
	}
	goto label$33;
	label$34:;
	{
		struct $8FBSYMBOL* vr$4 = RTLPROCLOOKUP( (uint8*)"fb___umoddi3", 118 );
		F$1 = vr$4;
	}
	label$33:;
	struct $7ASTNODE* vr$5 = ASTNEWCALL( F$1, (struct $7ASTNODE*)0u );
...
struct $7ASTNODE* RTLMATHFP2ULONGINT( struct $7ASTNODE* EXPR$1, int32 DTYPE$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	fb$result$1 = (struct $7ASTNODE*)0u;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb___fixunsdfdi", 119 );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0u );
	PROC$1 = vr$2;
...
struct $7ASTNODE* RTLMATHUOP( int32 OP$1, struct $7ASTNODE* EXPR$1 )
{
	...
	{
		uint32 TMP$134$2;
		TMP$134$2 = (uint32)OP$1;
		goto label$47;
		label$48:;
		{
			struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"{sgn}", 340 );
			SYM$1 = vr$1;
		}
		goto label$46;
		label$49:;
		{
			struct $8FBSYMBOL* vr$2 = RTLPROCLOOKUP( (uint8*)"{abs}", 345 );
			SYM$1 = vr$2;
		}
		goto label$46;
		label$50:;
		{
			struct $8FBSYMBOL* vr$3 = RTLPROCLOOKUP( (uint8*)"{fix}", 346 );
			SYM$1 = vr$3;
		}
		goto label$46;
		label$51:;
		{
			struct $8FBSYMBOL* vr$4 = RTLPROCLOOKUP( (uint8*)"{frac}", 347 );
			SYM$1 = vr$4;
		}
		goto label$46;
		label$52:;
		{
			struct $8FBSYMBOL* vr$5 = RTLPROCLOOKUP( (uint8*)"{asin}", 341 );
			SYM$1 = vr$5;
		}
		goto label$46;
		label$53:;
		{
			struct $8FBSYMBOL* vr$6 = RTLPROCLOOKUP( (uint8*)"{acos}", 342 );
			SYM$1 = vr$6;
		}
		goto label$46;
		label$54:;
		{
			struct $8FBSYMBOL* vr$7 = RTLPROCLOOKUP( (uint8*)"{tan}", 343 );
			SYM$1 = vr$7;
		}
		goto label$46;
		label$55:;
		{
			struct $8FBSYMBOL* vr$8 = RTLPROCLOOKUP( (uint8*)"{atan}", 344 );
			SYM$1 = vr$8;
		}
		goto label$46;
		label$56:;
		...
		if( (TMP$134$2 - 56u) > 16u ) goto label$56;
		goto *tmp$135[TMP$134$2 - 56u];
		label$46:;
	}
...
struct $7ASTNODE* RTLMATHBOP( int32 OP$1, struct $7ASTNODE* LEXPR$1, struct $7ASTNODE* REXPR$1 )
{
	...
	{
		uint32 TMP$136$2;
		TMP$136$2 = (uint32)OP$1;
		goto label$60;
		label$61:;
		{
			struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"{atan2}", 348 );
			SYM$1 = vr$1;
		}
		goto label$59;
		label$62:;
		...
		goto label$59;
		label$60:;
		static const void* tmp$137[1] = {
			&&label$61,
		};
		if( (TMP$136$2 - 64u) > 0u ) goto label$62;
		goto *tmp$137[TMP$136$2 - 64u];
		label$59:;
	}
...
static int32 HRNDCALLBACK( struct $8FBSYMBOL* SYM$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 4 );
	label$63:;
	static int32 ADDED$1 = 0;
	if( ADDED$1 != 0 ) goto label$66;
	{
		ADDED$1 = -1;
		{
			$13FB_COMPTARGET TMP$138$3;
			TMP$138$3 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 108);
			if( TMP$138$3 == 0 ) goto label$69;
			label$70:;
			if( TMP$138$3 != 1 ) goto label$68;
			label$69:;
			{
