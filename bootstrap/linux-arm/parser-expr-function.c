...
struct $7ASTNODE* CMETHODCALL( struct $8FBSYMBOL* SYM$1, struct $7ASTNODE* THISEXPR$1, $12FB_PARSEROPT OPTIONS$1 )
{
	...
	LEXSKIPTOKEN( 4096 );
	if( (*(int32*)((uint8*)&PARSER$ + 148) & 4) == 0 ) goto label$39;
	{
...
struct $7ASTNODE* CCTORCALL( struct $8FBSYMBOL* SYM$1 )
{
	...
	*(struct $11FB_CALL_ARG**)((uint8*)&ARG_LIST$1 + 8) = (struct $11FB_CALL_ARG*)0u;
	...
	struct $11FB_CALL_ARG* vr$7 = SYMBALLOCOVLCALLARG( (struct $5TLIST*)((uint8*)&PARSER$ + 112), &ARG_LIST$1, 0 );
	ARG$1 = vr$7;
	...
	*($12FB_PARAMMODE*)((uint8*)ARG$1 + 4) = -1;
	...
	struct $7ASTNODE* vr$14 = CPROCARGLIST( (struct $8FBSYMBOL*)0u, vr$13, (struct $7ASTNODE*)0u, &ARG_LIST$1, TMP$95$1 | 80 );
	PROCEXPR$1 = vr$14;
