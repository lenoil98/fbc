...
struct $7ASTNODE* RTLINITAPP( struct $7ASTNODE* ARGC$1, struct $7ASTNODE* ARGV$1 )
{
	...
	{
		{
			...
			TMP$180$3 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 108);
			if( TMP$180$3 == 0 ) goto label$38;
			label$39:;
			if( TMP$180$3 != 1 ) goto label$37;
			label$38:;
			{
				if( *(int32*)((uint8*)&ENV$ + 180) == 0 ) goto label$41;
				{
		...
		{
			struct $8FBSYMBOL* vr$2 = RTLPROCLOOKUP( (uint8*)"fb___main", 141 );
	...
	label$35:;
	label$34:;
	struct $8FBSYMBOL* vr$4 = RTLPROCLOOKUP( (uint8*)"fb_Init", 139 );
	...
	{
		struct $8FBSYMBOL* vr$9 = RTLPROCLOOKUP( (uint8*)"fb_InitSignals", 140 );
...
int32 RTLEXITAPP( struct $7ASTNODE* ERRLEVEL$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	fb$result$1 = 0;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_End", 142 );
...
struct $7ASTNODE* RTLATEXIT( struct $7ASTNODE* PROCEXPR$1 )
{
	...
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_atexit", 143 );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0u );
	PROC$1 = vr$2;
	struct $7ASTNODE* vr$3 = ASTNEWARG( PROC$1, PROCEXPR$1, -2147483648u, -1 );
	if( vr$3 != (struct $7ASTNODE*)0u ) goto label$63;
	{
		goto label$61;
	}
	label$63:;
...
static int32 RTLX86CPUCHECK( void )
{
	...
	struct $8FBSYMBOL* vr$6 = RTLPROCLOOKUP( (uint8*)"fb_CpuDetect", 138 );
	...
	FBSTRING* vr$18 = fb_StrConcat( &TMP$176$1, (void*)"This program requires at least a ", 34, (void*)&FAMILYSTR$1, -1 );
	__builtin_memset( &TMP$177$1, 0, 12 );
	FBSTRING* vr$21 = fb_StrConcat( &TMP$177$1, (void*)vr$18, -1, (void*)" to run.", 9 );
	fb_StrAssign( (void*)&TMP$178$1, -1, (void*)vr$21, -1, 0 );
	struct $8FBSYMBOL* vr$23 = SYMBALLOCSTRCONST( (uint8*)*(uint8**)&TMP$178$1, -1 );
	S$1 = vr$23;
	...
	struct $8FBSYMBOL* vr$27 = RTLPROCLOOKUP( (uint8*)"fb_End", 142 );
	...
	{
		struct $8FBSYMBOL* vr$33 = RTLPROCLOOKUP( (uint8*)"fb_CpuDetect", 138 );
		...
		struct $8FBSYMBOL* vr$43 = RTLPROCLOOKUP( (uint8*)"fb_End", 142 );
...
static int32 HTHREADCALL_CB( struct $8FBSYMBOL* SYM$1 )
{
	...
	if( LIBSADDED$1 != 0 ) goto label$59;
	{
		LIBSADDED$1 = -1;
		FBADDLIB( (uint8*)"ffi" );
	}
	label$59:;
	label$58:;
	int32 vr$1 = HMULTITHREAD_CB( SYM$1 );
	fb$result$1 = vr$1;
	goto label$57;
	label$57:;
	return fb$result$1;
