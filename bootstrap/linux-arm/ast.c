...
static tmp$83 AST_LOADCALLBACKS$[45] = { (tmp$83)&ASTLOADNOP, (tmp$83)&ASTLOADLOAD, (tmp$83)&ASTLOADASSIGN, (tmp$83)&ASTLOADBOP, (tmp$83)&ASTLOADUOP, (tmp$83)&ASTLOADCONV, (tmp$83)&ASTLOADADDROF, (tmp$83)&ASTLOADBRANCH, (tmp$83)&ASTLOADJMPTB, (tmp$83)&ASTLOADCALL, (tmp$83)&ASTLOADCALLCTOR, (tmp$83)&ASTLOADSTACK, (tmp$83)&ASTLOADMEM, (tmp$83)&ASTLOADLOOP, (tmp$83)0u, (tmp$83)&ASTLOADLINK, (tmp$83)&ASTLOADCONST, (tmp$83)&ASTLOADVAR, (tmp$83)&ASTLOADIDX, (tmp$83)&ASTLOADFIELD, (tmp$83)&ASTLOADDEREF, (tmp$83)&ASTLOADLABEL, (tmp$83)0u, (tmp$83)&ASTLOADOFFSET, (tmp$83)&ASTLOADDECL, (tmp$83)&ASTLOADNIDXARRAY, (tmp$83)&ASTLOADIIF, (tmp$83)&ASTLOADLIT, (tmp$83)&ASTLOADASM, (tmp$83)0u, (tmp$83)&ASTLOADDBG, (tmp$83)&ASTLOADBOUNDCHK, (tmp$83)&ASTLOADPTRCHK, (tmp$83)&ASTLOADSCOPEBEGIN, (tmp$83)&ASTLOADSCOPEEND, (tmp$83)0u, (tmp$83)0u, (tmp$83)0u, (tmp$83)0u, (tmp$83)0u, (tmp$83)0u, (tmp$83)0u, (tmp$83)0u, (tmp$83)0u, (tmp$83)&ASTLOADMACRO };
struct $6ASTCTX AST$;
...
struct $7ASTNODE* ASTREBUILDWITHOUTEFFECTIVEPART( struct $7ASTNODE* N$1 )
{
	...
	if( *(int32*)N$1 != 15 ) goto label$56;
	{
		...
		{
			int32 TMP$196$3;
			TMP$196$3 = *(int32*)((uint8*)N$1 + 24);
			if( TMP$196$3 != 1 ) goto label$58;
			label$59:;
			{
...
int32 ASTCANTAKEADDROF( struct $7ASTNODE* N$1 )
{
	...
	label$63:;
	{
		...
		label$69:;
		{
			{
				int32 TMP$198$4;
				TMP$198$4 = *(int32*)((uint8*)N$1 + 24);
				if( TMP$198$4 != 1 ) goto label$71;
				label$72:;
				{
		...
		if( (TMP$197$2 - 10u) > 26u ) goto label$76;
		goto *tmp$199[TMP$197$2 - 10u];
		label$65:;
	}
	label$64:;
	return fb$result$1;
...
struct $7ASTNODE* ASTMAKEREF( struct $7ASTNODE** EXPR$1 )
{
	...
	TMP$200$1 = -(*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)*EXPR$1 + 12) + 116) > 0);
	goto label$88;
	label$79:;
	TMP$200$1 = 0;
	label$88:;
	if( TMP$200$1 == 0 ) goto label$81;
	{
	...
	if( *(int32*)*EXPR$1 != 9 ) goto label$83;
	{
		{
			int32 TMP$201$3;
			TMP$201$3 = *(int32*)((uint8*)*EXPR$1 + 4) & 511;
			if( TMP$201$3 == 17 ) goto label$86;
			label$87:;
			if( TMP$201$3 != 7 ) goto label$85;
			label$86:;
			{
...
struct $7ASTNODE* ASTREMSIDEFX( struct $7ASTNODE** N$1 )
{
	...
	*N$1 = vr$2;
	{
		uint32 TMP$202$2;
		TMP$202$2 = (uint32)(*(int32*)((uint8*)*N$1 + 4) & 511);
		goto label$92;
		label$93:;
		{
		...
		if( (TMP$202$2 - 4u) > 16u ) goto label$94;
		goto *tmp$203[TMP$202$2 - 4u];
		label$91:;
	}
	label$90:;
	return fb$result$1;
...
int32 ASTGETINVERSELOGOP( int32 OP$1 )
{
	...
	label$117:;
	{
		...
		if( (TMP$204$2 - 45u) > 5u ) goto label$119;
		goto *tmp$205[TMP$204$2 - 45u];
		label$119:;
	}
	fb$result$1 = OP$1;
	label$118:;
...
struct $6IRVREG* ASTLOAD( struct $7ASTNODE* N$1 )
{
	...
	{
		struct $6IRVREG* vr$1 = (*(tmp$83*)((uint8*)AST_LOADCALLBACKS$ + (*(int32*)N$1 << (2 & 31))))( N$1 );
		fb$result$1 = vr$1;
	}
	label$130:;
	label$129:;
