...
struct $7ASTNODE* ASTDATASTMTSTORE( struct $7ASTNODE* TREE$1, struct $7ASTNODE* EXPR$1 )
{
	...
	*(struct $7ASTNODE**)((uint8*)TREE$1 + 68) = N$1;
	...
	label$19:;
	{
		...
		{
			int32 TMP$83$3;
			TMP$83$3 = *(int32*)((uint8*)EXPR$1 + 4) & 511;
			if( TMP$83$3 == 4 ) goto label$22;
			label$23:;
			if( TMP$83$3 != 7 ) goto label$21;
			label$22:;
			{
...
void ASTDATASTMTEND( struct $7ASTNODE* TREE$1 )
{
	...
	N$1 = *(struct $7ASTNODE**)((uint8*)TREE$1 + 64);
	{
		I$1 = 0;
		int32 TMP$84$2;
		TMP$84$2 = *(int32*)((uint8*)TREE$1 + 24) + -1;
		goto label$33;
		label$36:;
		{
			...
			{
				int32 TMP$85$4;
				TMP$85$4 = *(int32*)((uint8*)N$1 + 24);
				if( TMP$85$4 != 1 ) goto label$38;
				label$39:;
				{
				...
				goto label$37;
				label$38:;
				if( TMP$85$4 != 32768 ) goto label$40;
				label$41:;
				{
					struct $8FBSYMBOL* vr$15 = ASTGETSTRLITSYMBOL( EXPR$1 );
					int64 vr$16 = __divdi3( *(int64*)((uint8*)vr$15 + 40), (int64)*(int32*)((uint8*)SYMB_DTYPETB$ + 200) );
				...
				goto label$37;
				label$42:;
				if( TMP$85$4 == 0 ) goto label$45;
				label$46:;
				if( TMP$85$4 != 65535 ) goto label$44;
				label$45:;
				{
			...
			ASTTYPEINIADDASSIGN( INITREE$1, vr$29, ELM$1, -2147483648u, (struct $8FBSYMBOL*)0u );
			ELM$1 = *(struct $8FBSYMBOL**)((uint8*)ELM$1 + 176);
			ASTTYPEINIADDASSIGN( INITREE$1, EXPR$1, ELM$1, -2147483648u, (struct $8FBSYMBOL*)0u );
...
struct $8FBSYMBOL* ASTDATASTMTADD( struct $8FBSYMBOL* LABEL$1, int32 ELEMENTS$1 )
{
	...
	if( LABEL$1 != (struct $8FBSYMBOL*)0u ) goto label$58;
	{
		...
		label$60:;
		{
			...
			*(struct $8FBSYMBOL**)((uint8*)&AST$ + 128) = LASTLABEL$1;
			...
			FBSTRING* vr$8 = fb_StrConcat( &TMP$87$3, (void*)"_{fbdata}_", 11, *(void**)((uint8*)LASTLABEL$1 + 16), 0 );
			fb_StrAssign( (void*)&ID$1, -1, (void*)vr$8, -1, 0 );
		}
		label$59:;
		*(int64*)((uint8*)DTB$1 + 8) = (int64)(ELEMENTS$1 + -1);
	}
	goto label$57;
	label$58:;
	{
		...
		FBSTRING* vr$14 = fb_StrConcat( &TMP$88$2, (void*)"_{fbdata}_", 11, *(void**)((uint8*)LABEL$1 + 16), 0 );
	...
	if( SYM$1 == (struct $8FBSYMBOL*)0u ) goto label$62;
	{
		...
		{
			SYMBSETARRAYDIMTB( SYM$1, 1, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$86$1 );
	...
	struct $8FBSYMBOL* vr$18 = SYMBADDVAR( (uint8*)*(uint8**)&ID$1, (uint8*)vr$17, 20, *(struct $8FBSYMBOL**)((uint8*)&AST$ + 116), 0ll, 1, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$86$1, 3, 9 );
	SYM$1 = vr$18;
...
static void HCREATEDATADESC( void )
{
	...
	*(struct $8FBSYMBOL**)((uint8*)&AST$ + 116) = vr$0;
	SYMBADDFIELD( *(struct $8FBSYMBOL**)((uint8*)&AST$ + 116), (uint8*)"type", 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$89$1, 5, (struct $8FBSYMBOL*)0u, 0ll, 0, 0 );
	SYMBADDFIELD( *(struct $8FBSYMBOL**)((uint8*)&AST$ + 116), (uint8*)"node", 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$89$1, 32, (struct $8FBSYMBOL*)0u, 0ll, 0, 0 );
