...
int32 COPERATOR( int32 IS_OVERLOAD$1 )
{
	...
	TK$1 = vr$1;
	{
		...
		label$41:;
		{
			...
			LEXSKIPTOKEN( 2048 );
			{
				...
				if( (TMP$94$4 - 64u) > 399u ) goto label$85;
				goto *tmp$97[TMP$94$4 - 64u];
				label$44:;
			}
			fb$result$1 = OP$1;
			goto label$21;
		...
		if( (TMP$93$2 - 38u) > 425u ) goto label$86;
		goto *tmp$98[TMP$93$2 - 38u];
		label$22:;
	}
	LEXSKIPTOKEN( 2048 );
	...
	{
		OP$1 = *(int32*)(((uint8*)AST_OPTB$ + (OP$1 << (4 & 31))) + 12);
	}
	label$90:;
	label$89:;
	fb$result$1 = OP$1;
...
void CASSIGNMENT( struct $7ASTNODE* L$1 )
{
	...
	label$97:;
	LEXSKIPTOKEN( 0 );
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 156) = *(struct $8FBSYMBOL**)((uint8*)L$1 + 8);
	*(int32*)((uint8*)&PARSER$ + 152) = *(int32*)((uint8*)L$1 + 4) & 511;
	struct $7ASTNODE* R$1;
...
int32 CASSIGNMENTORPTRCALL( void )
{
	...
	label$142:;
	label$141:;
	if( (*(int32*)((uint8*)&ENV$ + 888) & 262144) != 0 ) goto label$150;
	{
	...
	if( EXPR$1 == (struct $7ASTNODE*)0u ) goto label$177;
	{
		{
			int32 TMP$108$3;
			TMP$108$3 = *(int32*)((uint8*)EXPR$1 + 4) & 511;
			if( TMP$108$3 != 20 ) goto label$179;
			label$180:;
			{
...
static void HREPORTLETERROR( int32 ERRNUM$1, int32 ELMNUM$1 )
{
	...
	FBSTRING* vr$4 = fb_StrConcat( &TMP$105$1, (void*)"at the ", 8, (void*)vr$1, 0 );
	__builtin_memset( &TMP$106$1, 0, 12 );
	FBSTRING* vr$7 = fb_StrConcat( &TMP$106$1, (void*)vr$4, -1, (void*)" element of LET()", 18 );
	fb_StrAssign( (void*)&TMP$107$1, -1, (void*)vr$7, -1, 0 );
	ERRREPORTEX( ERRNUM$1, (uint8*)*(uint8**)&TMP$107$1, 0, 1, (uint8*)0u );
