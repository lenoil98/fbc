...
int32 HCHECKTYPES( int32 LDTYPE$1, struct $8FBSYMBOL* LSUBTYPE$1, int32 RDTYPE$1, struct $8FBSYMBOL* RSUBTYPE$1, int32* DTYPE$1, struct $8FBSYMBOL** SUBTYPE$1 )
{
	...
	if( (LMATCH$1 | RMATCH$1) == 0 ) goto label$13;
	{
		...
		label$15:;
		{
			...
			goto label$49;
			label$20:;
			TMP$84$3 = OTHERDTYPE$1 & 31;
			label$49:;
			if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$84$3 * 28)) == 0 ) goto label$22;
			{
				goto label$11;
			}
			label$22:;
			...
			{
				int32 TMP$85$4;
				TMP$85$4 = OTHERDTYPE$1 & 31;
				if( TMP$85$4 == 4 ) goto label$25;
				label$26:;
				if( TMP$85$4 != 7 ) goto label$24;
				label$25:;
				{
					goto label$11;
				}
...
struct $7ASTNODE* ASTNEWIIF( struct $7ASTNODE* CONDEXPR$1, struct $7ASTNODE* TRUEXPR$1, int32 TRUECOOKIE$1, struct $7ASTNODE* FALSEXPR$1, int32 FALSECOOKIE$1 )
{
	...
	{
		int32 TMP$86$2;
		TMP$86$2 = DTYPE$1 & 511;
		if( TMP$86$2 == 18 ) goto label$83;
		label$84:;
		if( TMP$86$2 != 4 ) goto label$82;
		label$83:;
		{
			DTYPE$1 = 17;
		}
...
struct $6IRVREG* ASTLOADIIF( struct $7ASTNODE* N$1 )
{
	...
	{
		(*(tmp$56*)((uint8*)&IR$ + 144))( 98, EXITLABEL$1 );
	}
	label$116:;
	label$115:;
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$118;
	{
		(*(tmp$41*)((uint8*)&IR$ + 68))( *(struct $8FBSYMBOL**)((uint8*)N$1 + 24) );
	}
	label$118:;
	label$117:;
	...
	{
		(*(tmp$41*)((uint8*)&IR$ + 68))( EXITLABEL$1 );
	}
	label$122:;
	label$121:;
