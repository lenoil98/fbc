...
void CDEFDECL( void )
{
	...
	int32 ICHAR$1;
	int32 ECHAR$1;
	if( (*(int32*)((uint8*)&ENV$ + 888) & 4194304) != 0 ) goto label$13;
	{
	...
	TMP$93$1 = 8;
	label$43:;
	int32 vr$1 = CCOMPSTMTISALLOWED( TMP$93$1 );
	...
	DTYPE$1 = -2147483648u;
	{
		...
		if( (TMP$94$2 - 321u) > 12u ) goto label$17;
		goto *tmp$95[TMP$94$2 - 321u];
		label$17:;
	}
	LEXSKIPTOKEN( 2048 );
	label$32:;
