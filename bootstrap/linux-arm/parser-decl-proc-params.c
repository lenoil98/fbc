...
void CPARAMETERS( struct $8FBSYMBOL* PARENT$1, struct $8FBSYMBOL* PROC$1, int32 PROCMODE$1, int32 ISPROTO$1 )
{
	...
	if( (*(int32*)((uint8*)PROC$1 + 8) & 2) == 0 ) goto label$13;
	{
		...
		LENGTH$1 = LENGTH$1 + (int64)*(int32*)((uint8*)&ENV$ + 272);
	}
	label$13:;
	label$12:;
	...
	label$27:;
	if( LENGTH$1 <= (int64)(*(int32*)((uint8*)&ENV$ + 272) << (6 & 31)) ) goto label$30;
	{
...
static struct $7ASTNODE* HOPTIONALEXPR( struct $8FBSYMBOL* PROC$1, uint8* PID$1, struct $8FBSYMBOL* PARAM$1 )
{
	...
	{
		int32 TMP$93$2;
		TMP$93$2 = *(int32*)((uint8*)PARAM$1 + 28) & 511;
		if( TMP$93$2 == 0 ) goto label$43;
		label$44:;
		if( TMP$93$2 != 23 ) goto label$42;
		label$43:;
		{
...
static struct $8FBSYMBOL* HMOCKPARAM( struct $8FBSYMBOL* PROC$1, int32 PMODE$1 )
{
	...
	TMP$94$1 = 0;
	label$161:;
	struct $8FBSYMBOL* vr$1 = SYMBADDPROCPARAM( PROC$1, (uint8*)0u, DTYPE$1, (struct $8FBSYMBOL*)0u, TMP$94$1, PMODE$1, 0, 0 );
	fb$result$1 = vr$1;
	label$50:;
	return fb$result$1;
}
...
static struct $8FBSYMBOL* HPARAMDECL( struct $8FBSYMBOL* PROC$1, int32 PROC_MODE$1, int32 ISPROTO$1 )
{
	...
	static struct $8FBARRAY1IcE tmp$95$1 = { (uint8*)IDTB$1, (uint8*)IDTB$1, 1032, 129, 1, 49, { { 8, 0, 7 } } };
	...
	static struct $8FBARRAY2IP7ASTNODEE tmp$96$1 = { (struct $7ASTNODE**)EXPRTB$1, (struct $7ASTNODE**)EXPRTB$1, 64, 4, 2, 50, { { 8, 0, 7 }, { 2, 0, 1 } } };
	...
	}
	{
		...
		goto label$74;
		label$75:;
		if( TMP$99$2 == 1 ) goto label$78;
		label$79:;
		if( TMP$99$2 != 2 ) goto label$77;
		label$78:;
		{
	...
	label$86:;
	label$85:;
	ID$1 = (uint8*)((uint8*)IDTB$1 + (RECLEVEL$1 * 129));
	...
	if( READID$1 == 0 ) goto label$88;
	{
		...
		DOTPOS$1 = *(int32*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16548) + 4120);
		LEXCHECKTOKEN( 4096 );
	...
	{
		MODE$1 = *(int32*)((uint8*)&ENV$ + 928);
		USE_DEFAULT$1 = -1;
		if( (*(int32*)((uint8*)&ENV$ + 196) & 2) == 0 ) goto label$102;
		{
	...
	if( vr$36 != 376 ) goto label$104;
	{
		...
		TMP$101$2 = 0;
		TMP$100$2 = 0ll;
		int32 vr$45 = CSYMBOLTYPE( &DTYPE$1, &SUBTYPE$1, &TMP$100$2, &TMP$101$2, OPTIONS$2 );
	...
	label$104:;
	{
		if( (*(int32*)((uint8*)&ENV$ + 888) & 4194304) != 0 ) goto label$116;
		{
	...
	label$125:;
	{
		...
		goto label$162;
		label$127:;
		TMP$102$2 = DTYPE$1 & 31;
		label$162:;
		TMP$103$2 = (uint32)TMP$102$2;
		goto label$129;
		label$130:;
		{
			int32 TMP$104$3;
			...
			goto label$163;
			label$131:;
			TMP$104$3 = DTYPE$1 & 31;
			label$163:;
			if( (-(MODE$1 == 1) | -(TMP$104$3 == 18)) == 0 ) goto label$133;
			{
				HPARAMERROR( PROC$1, ID$1, 59, 1 );
		...
		if( TMP$103$2 > 20u ) goto label$128;
	...
	TMP$105$1 = ID$1;
	label$164:;
	struct $8FBSYMBOL* vr$85 = SYMBADDPROCPARAM( PROC$1, TMP$105$1, DTYPE$1, SUBTYPE$1, DIMENSIONS$1, MODE$1, ATTRIB$1, 0 );
	PARAM$1 = vr$85;
	...
	{
		if( *(int64*)((uint8*)PARAM$1 + 40) <= (int64)(*(int32*)((uint8*)&ENV$ + 272) << (2 & 31)) ) goto label$150;
		{
			if( (*(int32*)((uint8*)&ENV$ + 196) & 4) == 0 ) goto label$152;
			{
