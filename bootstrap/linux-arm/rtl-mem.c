...
static struct $14FB_RTL_PROCDEF FUNCDATA$[12] = { { (uint8*)"fb_NullPtrChk", (uint8*)0u, 32, -1, (tmp$33)0u, 2048, 3, { { 1056, 1, 0 }, { 523, 1, 0 }, { 1060, 1, 0 } } }, { (uint8*)"fb_MemSwap", (uint8*)0u, 0, -1, (tmp$33)0u, 0, 3, { { 0, 2, 0, 0, -1 }, { 0, 2, 0, 0, -1 }, { 520, 1, 0 } } }, { (uint8*)"fb_MemCopyClear", (uint8*)0u, 0, -1, (tmp$33)0u, 0, 4, { { 0, 2, 0, 0, -1 }, { 521, 1, 0 }, { 512, 2, 0, 0, -1 }, { 521, 1, 0 } } }, { (uint8*)"fre", (uint8*)"fb_GetMemAvail", 9, -1, (tmp$33)0u, 0, 1, { { 523, 1, -1, 0 } } }, { (uint8*)"allocate", (uint8*)"malloc", 32, 3, (tmp$33)0u, 128, 1, { { 521, 1, 0 } } }, { (uint8*)"callocate", (uint8*)"calloc", 32, 3, (tmp$33)0u, 128, 2, { { 521, 1, 0 }, { 521, 1, -1, 1 } } }, { (uint8*)"reallocate", (uint8*)"realloc", 32, 3, (tmp$33)0u, 128, 2, { { 1056, 1, 0, 0, -1 }, { 521, 1, 0 } } }, { (uint8*)"deallocate", (uint8*)"free", 0, 3, (tmp$33)0u, 128, 1, { { 1056, 1, 0, 0, -1 } } }, { (uint8*)"clear", (uint8*)"memset", 32, 3, (tmp$33)0u, 0, 3, { { 0, 2, 0, 0, -1 }, { 523, 1, -1, 0 }, { 521, 1, 0 } } }, { (uint8*)"fb_MemMove", (uint8*)"memmove", 32, 3, (tmp$33)0u, 0, 3, { { 0, 2, 0, 0, -1 }, { 512, 2, 0, 0, -1 }, { 521, 1, 0 } } }, { (uint8*)"fb_MemCopy", (uint8*)"memcpy", 32, 3, (tmp$33)0u, 0, 3, { { 0, 2, 0, 0, -1 }, { 512, 2, 0, 0, -1 }, { 521, 1, 0 } } }, { (uint8*)0u } };
...
struct $7ASTNODE* RTLNULLPTRCHECK( struct $7ASTNODE* P$1, int32 LINENUM$1, uint8* MODULE$1 )
{
	...
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_NullPtrChk", 136 );
...
int32 RTLMEMSWAP( struct $7ASTNODE* DST$1, struct $7ASTNODE* SRC$1 )
{
	...
	fb$result$1 = 0;
	struct $7ASTNODE* PROC$1;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_MemSwap", 218 );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0u );
	PROC$1 = vr$2;
	int64 BYTES$1;
...
int32 RTLMEMCOPYCLEAR( struct $7ASTNODE* DSTEXPR$1, int64 DSTLEN$1, struct $7ASTNODE* SRCEXPR$1, int64 SRCLEN$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	fb$result$1 = 0;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_MemCopyClear", 219 );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0u );
	PROC$1 = vr$2;
...
struct $7ASTNODE* RTLMEMNEWOP( int32 OP$1, struct $7ASTNODE* LEN_EXPR$1, int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	label$55:;
	if( TMP$104$1 != 20 ) goto label$44;
	{
		struct $8FBSYMBOL* vr$4 = SYMBGETCOMPOPOVLHEAD( SUBTYPE$1, *($6AST_OP*)(((uint8*)AST_OPTB$ + (OP$1 << (4 & 31))) + 12) );
		SYM$1 = vr$4;
	...
	{
		struct $8FBSYMBOL* vr$6 = RTLPROCLOOKUP( (uint8*)"allocate", 221 );
		SYM$1 = vr$6;
...
struct $7ASTNODE* RTLMEMDELETEOP( int32 OP$1, struct $7ASTNODE* PTR_EXPR$1, int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	{
		struct $8FBSYMBOL* vr$6 = RTLPROCLOOKUP( (uint8*)"deallocate", 222 );
		SYM$1 = vr$6;
