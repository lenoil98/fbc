...
struct $8FBSYMBOL* SYMBREUSEORADDCONST( uint8* ID$1, int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, union $7FBVALUE* VALUE$1, $13FB_SYMBATTRIB ATTRIB$1 )
{
	...
	if( SYM$1 != (struct $8FBSYMBOL*)0u ) goto label$17;
	{
		...
		if( (-(*(int32*)((uint8*)SYM$1 + 28) == DTYPE$1) & -(*(struct $8FBSYMBOL**)((uint8*)SYM$1 + 32) == SUBTYPE$1)) == 0 ) goto label$21;
		{
			{
				int32 TMP$83$4;
				TMP$83$4 = DTYPE$1 & 511;
				if( TMP$83$4 == 17 ) goto label$24;
				label$25:;
				if( TMP$83$4 == 4 ) goto label$24;
				label$26:;
				if( TMP$83$4 != 7 ) goto label$23;
				label$24:;
				{
				...
				goto label$22;
				label$23:;
				if( TMP$83$4 == 15 ) goto label$28;
				label$29:;
				if( TMP$83$4 != 16 ) goto label$27;
				label$28:;
				{
...
struct $8FBSYMBOL* SYMBALLOCFLOATCONST( double VALUE$1, int32 DTYPE$1 )
{
	...
	fb_StrAssign( (void*)&TMP$87$1, -1, (void*)vr$2, -1, 0 );
...
struct $8FBSYMBOL* SYMBALLOCINTCONST( int64 VALUE$1, int32 DTYPE$1 )
{
	...
	TMP$89$1 = DTYPE$1 & 31;
	label$46:;
	if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$89$1 * 28)) + 4) != 8 ) goto label$45;
	{
...
struct $8FBSYMBOL* SYMBALLOCSTRCONST( uint8* SNAME$1, int32 STRLENGTH$1 )
{
	...
	if( INTERNALSTRLEN$1 > 122 ) goto label$52;
	{
		...
		__builtin_memset( &TMP$92$2, 0, 12 );
		FBSTRING* vr$4 = fb_StrConcat( &TMP$92$2, (void*)ID$1, 134, (void*)SNAME$1, 0 );
	...
	struct $8FBSYMBOL* vr$11 = SYMBADDVAR( (uint8*)ID$1, (uint8*)ID_ALIAS$1, 4, (struct $8FBSYMBOL*)0u, (int64)STRSIZE$1, 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$90$1, 3073, 137 );
	S$1 = vr$11;
...
struct $8FBSYMBOL* SYMBALLOCWSTRCONST( uint32* SNAME$1, int32 STRLENGTH$1 )
{
	...
	if( (INTERNALSTRLEN$1 << (4 & 31)) > 122 ) goto label$60;
	{
		...
		uint8* vr$3 = HESCAPEW( SNAME$1 );
		__builtin_memset( &TMP$95$2, 0, 12 );
		FBSTRING* vr$6 = fb_StrConcat( &TMP$95$2, (void*)ID$1, 134, (void*)vr$3, 0 );
	...
	int32 STRSIZE$1;
	STRSIZE$1 = (STRLENGTH$1 + 1) * *(int32*)((uint8*)SYMB_DTYPETB$ + 200);
	struct $8FBSYMBOL* vr$14 = SYMBADDVAR( (uint8*)ID$1, (uint8*)ID_ALIAS$1, 7, (struct $8FBSYMBOL*)0u, (int64)STRSIZE$1, 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$93$1, 3073, 137 );
	S$1 = vr$14;
...
FBSTRING* SYMBGETCONSTVALUEASSTR( struct $8FBSYMBOL* S$1 )
{
	...
	{
		int32 TMP$96$2;
		TMP$96$2 = *(int32*)((uint8*)S$1 + 28) & 511;
		if( TMP$96$2 == 17 ) goto label$71;
		label$72:;
		if( TMP$96$2 == 18 ) goto label$71;
		label$73:;
		if( TMP$96$2 != 4 ) goto label$70;
		label$71:;
		{
		...
		label$76:;
		{
			...
			goto label$82;
			label$79:;
			TMP$97$3 = *(int32*)((uint8*)S$1 + 28) & 31;
			label$82:;
			if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$97$3 * 28)) + 8) == 0 ) goto label$81;
			{
...
static struct $8FBSYMBOL* HALLOCINTORFLOATCONST( FBSTRING* SVALUE$1, int32 DTYPE$1 )
{
	...
	*(struct $10FBARRAYDIM**)((uint8*)&tmp$84$1 + 4) = (struct $10FBARRAYDIM*)DTB$1;
	*(int32*)((uint8*)&tmp$84$1 + 8) = 16;
	*(int32*)((uint8*)&tmp$84$1 + 12) = 16;
	*(int32*)((uint8*)&tmp$84$1 + 16) = 1;
	*(int32*)((uint8*)&tmp$84$1 + 20) = 49;
	*(int32*)((uint8*)&tmp$84$1 + 24) = 1;
	*(int32*)((uint8*)&tmp$84$1 + 28) = 0;
	*(int32*)((uint8*)&tmp$84$1 + 32) = 0;
	fb$result$1 = (struct $8FBSYMBOL*)0u;
	fb_StrAssign( (void*)ID$1, 134, (void*)"{fbnc}", 7, 0 );
	__builtin_memset( &TMP$86$1, 0, 12 );
	FBSTRING* vr$6 = fb_StrConcat( &TMP$86$1, (void*)ID$1, 134, (void*)SVALUE$1, -1 );
	fb_StrAssign( (void*)ID$1, 134, (void*)vr$6, -1, 0 );
	struct $8FBSYMBOL* S$1;
	...
	label$37:;
	uint8* vr$10 = SYMBUNIQUEID( (boolean)0 );
	struct $8FBSYMBOL* vr$11 = SYMBADDVAR( (uint8*)ID$1, (uint8*)vr$10, DTYPE$1, (struct $8FBSYMBOL*)0u, 0ll, 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$84$1, 3073, 137 );
	S$1 = vr$11;
