...
void SYMBVARINIT( void )
{
	...
	static struct $8FBARRAY1I10FBARRAYDIME tmp$93$1 = { (struct $10FBARRAYDIM*)DTB$1, (struct $10FBARRAYDIM*)DTB$1, 16, 16, 1, 49, { { 1, 0, 0 } } };
	...
	*(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 99628) = vr$0;
	SYMBADDFIELD( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 99628), (uint8*)"elements", 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$93$1, 8, (struct $8FBSYMBOL*)0u, 0ll, 0, 0 );
	SYMBADDFIELD( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 99628), (uint8*)"lbound", 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$93$1, 8, (struct $8FBSYMBOL*)0u, 0ll, 0, 0 );
	SYMBADDFIELD( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 99628), (uint8*)"ubound", 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$93$1, 8, (struct $8FBSYMBOL*)0u, 0ll, 0, 0 );
	SYMBSTRUCTEND( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 99628), 0 );
	*(int32*)((uint8*)&SYMB$ + 99612) = 0;
	*(int32*)((uint8*)&SYMB$ + 99616) = *(int32*)((uint8*)&ENV$ + 272);
	*(int32*)((uint8*)&SYMB$ + 99620) = *(int32*)((uint8*)&ENV$ + 272) << (1 & 31);
	*(int32*)((uint8*)&SYMB$ + 99624) = *(int32*)((uint8*)&ENV$ + 272) * 6;
	*(int32*)((uint8*)&SYMB$ + 99632) = *(int32*)((uint8*)&ENV$ + 272);
	*(int32*)((uint8*)&SYMB$ + 99636) = *(int32*)((uint8*)&ENV$ + 272) << (1 & 31);
	label$11:;
}
...
int32 SYMBGETDESCTYPEDIMENSIONS( struct $8FBSYMBOL* DESCTYPE$1 )
{
	...
	label$19:;
	label$18:;
	DIMTBSIZE$1 = (int32)(*(int64*)((uint8*)DESCTYPE$1 + 40) - (int64)(*(int32*)((uint8*)&ENV$ + 272) * 6));
	DIMENSIONS$1 = DIMTBSIZE$1 / (*(int32*)((uint8*)&ENV$ + 272) * 3);
...
struct $8FBSYMBOL* SYMBADDARRAYDESCRIPTORTYPE( int32 DIMENSIONS$1, int32 ARRAYDTYPE$1, struct $8FBSYMBOL* ARRAYSUBTYPE$1 )
{
	...
	__FB_STATIC_ASSERT( sizeof( struct $8FBARRAY1I10FBARRAYDIME ) == 36 );
	static struct $8FBARRAY1I10FBARRAYDIME tmp$99$1 = { (struct $10FBARRAYDIM*)DTB$1, (struct $10FBARRAYDIM*)DTB$1, 16, 16, 1, 49, { { 1, 0, 0 } } };
	FBSTRING ID$1;
	...
	ATTRIB$1 = 0;
	PATTRIB$1 = 0;
	TMP$103$1 = (struct $8FBSYMBOL*)0u;
	struct $8FBSYMBOL* vr$20 = SYMBLOOKUPINTERNALLYMANGLEDSUBTYPE( (uint8*)*(uint8**)&ID$1, ($13FB_SYMBATTRIB*)&ATTRIB$1, ($13FB_PROCATTRIB*)&PATTRIB$1, &TMP$103$1, &SYMTB$1, &HASHTB$1 );
	SYM$1 = vr$20;
	...
	SYM$1 = vr$24;
	*(int64*)DTB$1 = 0ll;
	*(int64*)((uint8*)DTB$1 + 8) = 0ll;
	SYMBADDFIELD( SYM$1, (uint8*)"data", 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$99$1, (((ARRAYDTYPE$1 & 31) | ((ARRAYDTYPE$1 & 480) + 32)) | ((ARRAYDTYPE$1 & 261632) << (1 & 31))) | (ARRAYDTYPE$1 & 32505856), ARRAYSUBTYPE$1, 0ll, 0, 0 );
	SYMBADDFIELD( SYM$1, (uint8*)"ptr", 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$99$1, (((ARRAYDTYPE$1 & 31) | ((ARRAYDTYPE$1 & 480) + 32)) | ((ARRAYDTYPE$1 & 261632) << (1 & 31))) | (ARRAYDTYPE$1 & 32505856), ARRAYSUBTYPE$1, 0ll, 0, 0 );
	SYMBADDFIELD( SYM$1, (uint8*)"size", 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$99$1, 8, (struct $8FBSYMBOL*)0u, 0ll, 0, 0 );
	SYMBADDFIELD( SYM$1, (uint8*)"element_len", 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$99$1, 8, (struct $8FBSYMBOL*)0u, 0ll, 0, 0 );
	SYMBADDFIELD( SYM$1, (uint8*)"dimensions", 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$99$1, 8, (struct $8FBSYMBOL*)0u, 0ll, 0, 0 );
	SYMBADDFIELD( SYM$1, (uint8*)"flags", 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$99$1, 8, (struct $8FBSYMBOL*)0u, 0ll, 0, 0 );
	...
	label$28:;
	*(int64*)DTB$1 = 0ll;
	*(int64*)((uint8*)DTB$1 + 8) = (int64)(DIMENSIONS$1 + -1);
	SYMBADDFIELD( SYM$1, (uint8*)"dimTB", 1, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$99$1, 20, *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 99628), 0ll, 0, 0 );
...
struct $8FBSYMBOL* SYMBADDARRAYDESC( struct $8FBSYMBOL* ARRAY$1 )
{
	...
	label$33:;
	{
		...
		if( (-((*(int32*)((uint8*)ARRAY$1 + 4) & 8) != 0) | ISDYNAMIC$1) == 0 ) goto label$37;
		{
			...
			if( (*(int32*)((uint8*)ARRAY$1 + 4) & 1048576) == 0 ) goto label$39;
			{
				...
				TMP$111$4 = 0;
				uint8* vr$24 = HMANGLEBUILTINTYPE( *(int32*)((uint8*)ARRAY$1 + 28) & 511, &TMP$111$4 );
				__builtin_memset( &TMP$112$4, 0, 12 );
				FBSTRING* vr$27 = fb_StrConcat( &TMP$112$4, (void*)&TEMPID$1, -1, (void*)vr$24, 0 );
	...
	{
		if( *(uint32*)((uint8*)&PARSER$ + 96) != 0u ) goto label$51;
		{
			SYMTB$1 = (struct $10FBSYMBOLTB*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 56);
		}
		goto label$50;
		label$51:;
		{
...
int32 SYMBARRAYHASUNKNOWNBOUNDS( struct $8FBSYMBOL* SYM$1 )
{
	...
	label$68:;
	{
		...
		I$2 = 0;
		int32 TMP$114$2;
		TMP$114$2 = *(int32*)((uint8*)SYM$1 + 64) + -1;
		goto label$70;
		label$73:;
		{
...
void SYMBSETFIXEDSIZEARRAYDIMENSIONELEMENTS( struct $8FBSYMBOL* SYM$1, int32 DIMENSION$1, int64 ELEMENTS$1 )
{
	label$90:;
	{
		...
		TMP$116$2 = (struct $10FBARRAYDIM*)((uint8*)*(struct $10FBARRAYDIM**)((uint8*)SYM$1 + 68) + (DIMENSION$1 << (4 & 31)));
		*(int64*)((uint8*)TMP$116$2 + 8) = (*(int64*)TMP$116$2 + ELEMENTS$1) + -1ll;
	}
	SYMBRECALCARRAYDIFFANDELEMENTS( SYM$1 );
	label$91:;
}
...
struct $8FBSYMBOL* SYMBADDVAR( uint8* ID$1, uint8* ID_ALIAS$1, int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int64 LGT$1, int32 DIMENSIONS$1, struct $7FBARRAYI10FBARRAYDIME* DTB$1, $13FB_SYMBATTRIB ATTRIB$1, $10FB_SYMBOPT OPTIONS$1 )
{
	...
	{
		if( *(int32*)((uint8*)&PARSER$ + 100) == 0 ) goto label$115;
		{
			ID_ALIAS$1 = ID$1;
		}
		label$115:;
	...
	*(int64*)((uint8*)S$1 + 48) = 0ll;
	...
	{
		*(int32*)((uint8*)S$1 + 100) = *(int32*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 112) + 52) + 1;
	}
	goto label$126;
	label$127:;
	...
	label$128:;
	label$126:;
	if( (-((*(int32*)((uint8*)S$1 + 28) & 511) == 20) & -(*(struct $8FBSYMBOL**)((uint8*)S$1 + 32) == *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 98536))) == 0 ) goto label$130;
	{
...
struct $8FBSYMBOL* SYMBADDTEMPVAR( int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1 )
{
	...
	OPTIONS$1 = 0;
	if( (*(int32*)((uint8*)&ENV$ + 888) & 2) != 0 ) goto label$134;
	{
	...
	struct $8FBSYMBOL* vr$4 = SYMBADDVAR( (uint8*)vr$3, (uint8*)0u, DTYPE$1, SUBTYPE$1, 0ll, 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$117$1, 4096, OPTIONS$1 );
	SYM$1 = vr$4;
...
struct $8FBSYMBOL* SYMBADDIMPLICITVAR( int32 DTYPE$1, struct $8FBSYMBOL* SUBTYPE$1, int32 OPTIONS$1 )
{
	...
	__FB_STATIC_ASSERT( sizeof( struct $8FBARRAY1I10FBARRAYDIME ) == 36 );
	static struct $8FBARRAY1I10FBARRAYDIME tmp$118$1 = { (struct $10FBARRAYDIM*)DTB$1, (struct $10FBARRAYDIM*)DTB$1, 16, 16, 1, 49, { { 1, 0, 0 } } };
	struct $8FBSYMBOL* SYM$1;
	uint8* vr$1 = SYMBUNIQUEID( (boolean)0 );
	struct $8FBSYMBOL* vr$2 = SYMBADDVAR( (uint8*)vr$1, (uint8*)0u, DTYPE$1, SUBTYPE$1, 0ll, 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$118$1, 0, OPTIONS$1 );
	SYM$1 = vr$2;
	*($12FB_SYMBSTATS*)((uint8*)SYM$1 + 12) = *(int32*)((uint8*)SYM$1 + 12) | 16;
	fb$result$1 = SYM$1;
	label$136:;
...
struct $8FBSYMBOL* SYMBADDANDALLOCATETEMPVAR( int32 DTYPE$1 )
{
	...
	S$1 = vr$1;
	(*(tmp$42*)((uint8*)&IR$ + 40))( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104), S$1 );
	fb$result$1 = S$1;
	label$138:;
	return fb$result$1;
}
...
int64 SYMBGETREALSIZE( struct $8FBSYMBOL* SYM$1 )
{
	...
	TMP$119$1 = (int64)*(int32*)((uint8*)&ENV$ + 272);
	goto label$142;
	label$141:;
	TMP$119$1 = *(int64*)((uint8*)SYM$1 + 40);
	label$142:;
	SIZE$1 = TMP$119$1;
...
int64 SYMBCALCARRAYELEMENTS( struct $8FBSYMBOL* SYM$1, int32 FIRST$1 )
{
	...
	TOTALELEMENTS$1 = 1ll;
	{
		...
		I$2 = FIRST$1;
		int32 TMP$120$2;
		TMP$120$2 = *(int32*)((uint8*)SYM$1 + 64) + -1;
		goto label$153;
		label$156:;
		{
...
int32 SYMBCHECKARRAYSIZE( int32 DIMENSIONS$1, struct $10FBARRAYDIM* DIMTB$1, int64 LGT$1, int32 IS_ON_STACK$1 )
{
	...
	label$174:;
	{
		if( (IS_ON_STACK$1 & -(ALLELEMENTS$1 > (uint64)*(int32*)((uint8*)&ENV$ + 228))) == 0 ) goto label$176;
		{
...
int32 SYMBGETVARHASCTOR( struct $8FBSYMBOL* S$1 )
{
	...
	label$179:;
	{
		...
		if( TMP$122$2 != 17 ) goto label$182;
		label$183:;
		{
			fb$result$1 = -1;
			goto label$178;
		...
		goto label$181;
		label$182:;
		if( TMP$122$2 != 39 ) goto label$184;
		label$185:;
		{
...
int32 SYMBGETVARHASDTOR( struct $8FBSYMBOL* S$1 )
{
	...
	{
		int32 TMP$123$2;
		TMP$123$2 = *(int32*)((uint8*)S$1 + 28) & 511;
		if( TMP$123$2 != 17 ) goto label$195;
		label$196:;
		{
			fb$result$1 = -1;
			goto label$191;
		...
		goto label$194;
		label$195:;
		if( TMP$123$2 != 39 ) goto label$197;
		label$198:;
		{
...
struct $8FBSYMBOL* SYMBCLONEVAR( struct $8FBSYMBOL* SYM$1 )
{
	...
	__FB_STATIC_ASSERT( sizeof( struct $8FBARRAY1I10FBARRAYDIME ) == 36 );
	static struct $8FBARRAY1I10FBARRAYDIME tmp$124$1 = { (struct $10FBARRAYDIM*)DTB$1, (struct $10FBARRAYDIM*)DTB$1, 128, 16, 1, 49, { { 8, 0, 7 } } };
	...
	label$209:;
	{
		...
		{
			{
				...
				I$4 = 0;
				int32 TMP$125$4;
				TMP$125$4 = *(int32*)((uint8*)SYM$1 + 64) + -1;
				goto label$212;
				label$215:;
				{
					__builtin_memcpy( (struct $10FBARRAYDIM*)((uint8*)DTB$1 + (I$4 << (4 & 31))), (struct $10FBARRAYDIM*)((uint8*)*(struct $10FBARRAYDIM**)((uint8*)SYM$1 + 68) + (I$4 << (4 & 31))), 16 );
				}
				label$213:;
				I$4 = I$4 + 1;
				label$212:;
		...
		label$211:;
		label$210:;
		struct $8FBSYMBOL* vr$27 = SYMBADDVAR( (uint8*)*(uint8**)((uint8*)SYM$1 + 16), (uint8*)0u, *(int32*)((uint8*)SYM$1 + 28) & 511, *(struct $8FBSYMBOL**)((uint8*)SYM$1 + 32), 0ll, *(int32*)((uint8*)SYM$1 + 64), (struct $7FBARRAYI10FBARRAYDIME*)&tmp$124$1, *($13FB_SYMBATTRIB*)((uint8*)SYM$1 + 4), 0 );
		fb$result$1 = vr$27;
	}
	label$207:;
	label$206:;
...
int32 SYMBVARCHECKACCESS( struct $8FBSYMBOL* SYM$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 4 );
	label$216:;
	if( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) == *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 880) ) goto label$219;
	{
