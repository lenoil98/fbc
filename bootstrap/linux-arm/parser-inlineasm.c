...
static int32 HISASMKEYWORD( uint8* );
void CASMCODE( void );
...
__FB_STATIC_ASSERT( sizeof( struct $15ASMKEYWORDSINFO ) == 16 );
static struct $15ASMKEYWORDSINFO ASMKEYWORDS$;

void PARSERINLINEASMEND( void )
{
	label$20:;
	if( *(int32*)&ASMKEYWORDS$ == 0 ) goto label$23;
	{
		HASHEND( (struct $5THASH*)((uint8*)&ASMKEYWORDS$ + 4) );
		*(int32*)&ASMKEYWORDS$ = 0;
	}
	label$23:;
	label$22:;
...
void CASMCODE( void )
{
	...
	label$26:;
	{
		...
		THISTOK$1 = vr$0;
		{
			...
			if( (TMP$695$3 - 256u) > 84u ) goto label$29;
			goto *tmp$704[TMP$695$3 - 256u];
			label$29:;
		}
		...
		DOSKIP$1 = 0;
		{
			...
			label$34:;
			{
				...
				fb_StrAssign( (void*)&TMP$697$4, -1, (void*)vr$8, -1, 0 );
				int32 vr$10 = HISASMKEYWORD( (uint8*)*(uint8**)&TMP$697$4 );
				TMP$698$4 = -(vr$10 == 0);
				fb_StrDelete( (FBSTRING*)&TMP$697$4 );
				if( TMP$698$4 == 0 ) goto label$41;
				{
					struct $8FBSYMBOL* BASE_PARENT$5;
					struct $10FBSYMCHAIN* vr$14 = CIDENTIFIER( &BASE_PARENT$5, 34 );
					CHAIN_$1 = vr$14;
					label$42:;
					if( CHAIN_$1 == (struct $10FBSYMCHAIN*)0u ) goto label$43;
					{
						...
						{
							{
								...
								if( TMP$699$8 == 3 ) goto label$49;
								label$50:;
								if( TMP$699$8 != 7 ) goto label$48;
								label$49:;
								{
									SYM$1 = S$6;
									goto label$43;
								...
								goto label$47;
								label$51:;
								if( TMP$699$8 != 1 ) goto label$53;
								label$54:;
								{
									struct $8FBSYMBOL* vr$18 = SYMBFINDBYCLASS( CHAIN_$1, 1 );
									SYM$1 = vr$18;
									if( SYM$1 == (struct $8FBSYMBOL*)0u ) goto label$56;
									{
						...
						label$46:;
						if( S$6 != (struct $8FBSYMBOL*)0u ) goto label$44;
						label$45:;
			...
			label$60:;
			{
				...
				EXPR$1 = vr$26;
				if( EXPR$1 == (struct $7ASTNODE*)0u ) goto label$62;
				{
					struct $8FBSYMBOL* LITSYM$5;
					struct $8FBSYMBOL* vr$27 = ASTGETSTRLITSYMBOL( EXPR$1 );
					LITSYM$5 = vr$27;
					if( LITSYM$5 == (struct $8FBSYMBOL*)0u ) goto label$64;
					{
						FBSTRING TMP$703$6;
						fb_StrAssign( (void*)TEXT$1, 1025, (void*)"\x22", 2, 0 );
						if( (*(int32*)((uint8*)LITSYM$5 + 28) & 511) == 7 ) goto label$66;
						{
							FBSTRING TMP$701$7;
							__builtin_memset( &TMP$701$7, 0, 12 );
							FBSTRING* vr$33 = fb_StrConcat( &TMP$701$7, (void*)TEXT$1, 1025, *(void**)((uint8*)LITSYM$5 + 56), 0 );
						...
						label$66:;
						{
							...
							TMP$702$7 = vr$35;
							fb_WstrAssignToA( (void*)TEXT$1, 1025, (uint32*)TMP$702$7, 0 );
							fb_WstrDelete( (uint32*)TMP$702$7 );
						}
						label$65:;
						__builtin_memset( &TMP$703$6, 0, 12 );
						FBSTRING* vr$38 = fb_StrConcat( &TMP$703$6, (void*)TEXT$1, 1025, (void*)"\x22", 2 );
			...
			{
				{
					if( THISTOK$1 != 346 ) goto label$69;
					label$70:;
					{
						struct $8FBSYMBOL* vr$39 = SYMBGETPROCRESULT( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) );
						SYM$1 = vr$39;
					...
					goto label$68;
					label$69:;
					if( THISTOK$1 != 404 ) goto label$73;
					label$74:;
					{
						...
						{
							if( *(int32*)EXPR$1 != 16 ) goto label$78;
							{
			...
			if( TMP$696$3 > 4u ) goto label$32;
			goto *tmp$705[TMP$696$3 - 0u];
			label$32:;
		}
		if( DOSKIP$1 != 0 ) goto label$80;
		{
			if( SYM$1 == (struct $8FBSYMBOL*)0u ) goto label$82;
			{
			...
			label$81:;
			if( HEAD$1 != (struct $9ASTASMTOK*)0u ) goto label$84;
			{
				HEAD$1 = TAIL$1;
			}
			label$84:;
	...
	goto label$26;
	label$27:;
	if( HEAD$1 == (struct $9ASTASMTOK*)0u ) goto label$86;
	{
...
int32 CASMBLOCK( void )
{
	...
	if( vr$3 == 0 ) goto label$94;
	{
		if( *(int32*)((uint8*)&ENV$ + 148) == 0 ) goto label$96;
		{
			if( *(int32*)((uint8*)&ENV$ + 876) != 0 ) goto label$98;
			{
				struct $7ASTNODE* vr$5 = ASTNEWLIT( *(uint8**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 49392) );
				ASTADD( vr$5 );
	...
	label$103:;
	{
		if( ISSINGLELINE$1 != 0 ) goto label$107;
		{
			struct $7ASTNODE* vr$11 = ASTNEWDBG( 113, *(int32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16564), *(uint8**)((uint8*)&ENV$ + 544) );
			ASTADD( vr$11 );
		}
		label$107:;
		label$106:;
		CASMCODE(  );
		CCOMMENT( 1028 );
		if( *(int32*)((uint8*)&ENV$ + 148) == 0 ) goto label$109;
		{
			if( *(int32*)((uint8*)&ENV$ + 876) != 0 ) goto label$111;
			{
		...
		label$108:;
		{
			...
			TMP$706$3 = vr$16;
			if( TMP$706$3 != 257 ) goto label$113;
			label$114:;
			{
				if( ISSINGLELINE$1 == 0 ) goto label$116;
				{
					goto label$104;
				}
				label$116:;
			...
			goto label$112;
			label$113:;
			if( TMP$706$3 != 256 ) goto label$117;
			label$118:;
			{
				goto label$104;
			}
			goto label$112;
			label$117:;
			if( TMP$706$3 != 340 ) goto label$119;
			label$120:;
			{
				goto label$104;
			}
		...
		if( ISSINGLELINE$1 != 0 ) goto label$123;
		{
	...
	goto label$103;
	label$104:;
	if( ISSINGLELINE$1 != 0 ) goto label$125;
	{
		int32 vr$18 = HMATCH( 340, 2048 );
		if( vr$18 != 0 ) goto label$127;
		{
...
{
	label$10:;
	HASHINIT( (struct $5THASH*)((uint8*)&ASMKEYWORDS$ + 4), 600, 0 );
	{
		int32 I$2;
		I$2 = 0;
		label$15:;
		{
			HASHADD( (struct $5THASH*)((uint8*)&ASMKEYWORDS$ + 4), *(uint8**)((uint8*)ASMKEYWORDSX86$ + (I$2 << (2 & 31))), (void*)4294967295u, 4294967295u );
		}
		label$13:;
		I$2 = I$2 + 1;
		label$12:;
		if( I$2 <= 601 ) goto label$15;
		label$14:;
	}
	label$11:;
}

static int32 HISASMKEYWORD( uint8* TEXT$1 )
{
	int32 fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$16:;
	if( *(int32*)&ASMKEYWORDS$ != 0 ) goto label$19;
	{
		HINITASMKEYWORDS(  );
		*(int32*)&ASMKEYWORDS$ = -1;
	}
	label$19:;
	label$18:;
	void* vr$2 = HASHLOOKUP( (struct $5THASH*)((uint8*)&ASMKEYWORDS$ + 4), TEXT$1 );
