...
void ERRPUSHPARAMLOCATION( struct $8FBSYMBOL* PROC$1, int32 TK$1, int32 PARAMNUM$1, uint8* PARAMID$1 )
{
	...
	if( PROC$1 == (struct $8FBSYMBOL*)0u ) goto label$21;
	{
		if( (*(int32*)((uint8*)PROC$1 + 8) & 2) == 0 ) goto label$23;
		{
			if( PARAMNUM$1 <= 1 ) goto label$25;
			{
...
{
	label$61:;
	if( *(int32*)((uint8*)&ERRCTX$ + 8) == 0 ) goto label$64;
	{
		goto label$62;
	}
	label$64:;
	label$63:;
	if( *(int32*)&ERRCTX$ <= 0 ) goto label$66;
	{
	...
	label$66:;
	label$65:;
	if( LINENUM$1 != 0 ) goto label$68;
	{
		if( *(int32*)((uint8*)&PARSER$ + 28) != *(int32*)((uint8*)&ERRCTX$ + 16) ) goto label$70;
		{
			goto label$62;
		}
		label$70:;
		label$69:;
		if( *(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) == (struct $9LEX_TKCTX*)0u ) goto label$72;
		{
			LINENUM$1 = *(int32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16564);
		}
		label$72:;
		label$71:;
	...
	label$68:;
	label$67:;
	HPRINTERRMSG( ERRNUM$1, MSGEX$1, OPTIONS$1, LINENUM$1, *(int32*)((uint8*)&ENV$ + 188), CUSTOMTEXT$1 );
	*(int32*)((uint8*)&ERRCTX$ + 4) = *(int32*)((uint8*)&ERRCTX$ + 4) + 1;
	if( *(int32*)((uint8*)&ERRCTX$ + 4) < *(int32*)((uint8*)&ENV$ + 192) ) goto label$74;
	{
...
void ERRREPORTWARNEX( int32 MSGNUM$1, uint8* MSGEX$1, int32 LINENUM$1, $12FB_ERRMSGOPT OPTIONS$1, uint8* CUSTOMTEXT$1 )
{
	...
	FBSTRING TMP$489$1;
	label$95:;
	if( (-(MSGNUM$1 < 1) | -(MSGNUM$1 >= 45)) == 0 ) goto label$98;
	{
		goto label$96;
	}
	label$98:;
	label$97:;
	if( *(int32*)(((uint8*)WARNINGMSGS$ + (MSGNUM$1 << (3 & 31))) + -8) >= *(int32*)((uint8*)&ENV$ + 184) ) goto label$100;
	{
		goto label$96;
	}
	label$100:;
	label$99:;
	if( *(int32*)((uint8*)&ERRCTX$ + 8) == 0 ) goto label$102;
	{
		goto label$96;
	}
	label$102:;
	label$101:;
	if( *(int32*)&ERRCTX$ <= 0 ) goto label$104;
	{
		uint8* vr$4 = HMAKEPARAMDESC( MSGEX$1 );
		MSGEX$1 = vr$4;
	}
	label$104:;
	label$103:;
	int32 vr$6 = fb_StrLen( (void*)((uint8*)&ENV$ + 280), 261 );
	if( vr$6 <= 0 ) goto label$106;
	{
		FBSTRING* vr$8 = fb_StrAllocTempDescZ( (uint8*)((uint8*)&ENV$ + 280) );
		fb_PrintString( 0, (FBSTRING*)vr$8, 0 );
	}
	goto label$105;
	label$106:;
	{
		if( MSGEX$1 == (uint8*)0u ) goto label$108;
		{
			FBSTRING* vr$9 = fb_StrAllocTempDescZ( MSGEX$1 );
	...
	label$105:;
	if( LINENUM$1 <= 0 ) goto label$110;
	{
		FBSTRING TMP$481$2;
		FBSTRING TMP$482$2;
		FBSTRING* vr$10 = fb_IntToStr( LINENUM$1 );
		__builtin_memset( &TMP$481$2, 0, 12 );
		FBSTRING* vr$13 = fb_StrConcat( &TMP$481$2, (void*)"(", 2, (void*)vr$10, -1 );
		__builtin_memset( &TMP$482$2, 0, 12 );
		FBSTRING* vr$16 = fb_StrConcat( &TMP$482$2, (void*)vr$13, -1, (void*)")", 2 );
		fb_PrintString( 0, (FBSTRING*)vr$16, 0 );
	}
	goto label$109;
	label$110:;
	{
		FBSTRING* vr$17 = fb_StrAllocTempDescZEx( (uint8*)"()", 2 );
		fb_PrintString( 0, (FBSTRING*)vr$17, 0 );
	}
	label$109:;
	FBSTRING* vr$19 = fb_IntToStr( *(int32*)(((uint8*)WARNINGMSGS$ + (MSGNUM$1 << (3 & 31))) + -8) );
	FBSTRING* vr$20 = fb_IntToStr( MSGNUM$1 );
	__builtin_memset( &TMP$486$1, 0, 12 );
	FBSTRING* vr$23 = fb_StrConcat( &TMP$486$1, (void*)" warning ", 10, (void*)vr$20, -1 );
	__builtin_memset( &TMP$487$1, 0, 12 );
	FBSTRING* vr$26 = fb_StrConcat( &TMP$487$1, (void*)vr$23, -1, (void*)"(", 2 );
	__builtin_memset( &TMP$488$1, 0, 12 );
	FBSTRING* vr$29 = fb_StrConcat( &TMP$488$1, (void*)vr$26, -1, (void*)vr$19, -1 );
	__builtin_memset( &TMP$489$1, 0, 12 );
	FBSTRING* vr$32 = fb_StrConcat( &TMP$489$1, (void*)vr$29, -1, (void*)"): ", 4 );
	fb_PrintString( 0, (FBSTRING*)vr$32, 0 );
	FBSTRING* vr$34 = fb_StrAllocTempDescZ( *(uint8**)(((uint8*)WARNINGMSGS$ + (MSGNUM$1 << (3 & 31))) + -4) );
	fb_PrintString( 0, (FBSTRING*)vr$34, 0 );
	if( CUSTOMTEXT$1 == (uint8*)0u ) goto label$112;
	{
		FBSTRING* vr$35 = fb_StrAllocTempDescZ( CUSTOMTEXT$1 );
		fb_PrintString( 0, (FBSTRING*)vr$35, 0 );
	}
	label$112:;
	label$111:;
	if( MSGEX$1 == (uint8*)0u ) goto label$114;
	{
		if( (OPTIONS$1 & 1) == 0 ) goto label$116;
		{
			FBSTRING* vr$37 = fb_StrAllocTempDescZEx( (uint8*)", ", 2 );
			fb_PrintString( 0, (FBSTRING*)vr$37, 0 );
		}
		goto label$115;
		label$116:;
		if( (OPTIONS$1 & 2) == 0 ) goto label$117;
		{
			FBSTRING* vr$39 = fb_StrAllocTempDescZEx( (uint8*)": ", 2 );
			fb_PrintString( 0, (FBSTRING*)vr$39, 0 );
		}
		goto label$115;
		label$117:;
		{
			FBSTRING* vr$40 = fb_StrAllocTempDescZEx( (uint8*)" ", 1 );
			fb_PrintString( 0, (FBSTRING*)vr$40, 0 );
		}
		label$115:;
		if( (OPTIONS$1 & 4) == 0 ) goto label$119;
		{
			FBSTRING* vr$42 = fb_StrAllocTempDescZEx( (uint8*)"\x22", 1 );
		...
		if( (OPTIONS$1 & 4) == 0 ) goto label$121;
		{
			FBSTRING* vr$45 = fb_StrAllocTempDescZEx( (uint8*)"\x22", 1 );
			fb_PrintString( 0, (FBSTRING*)vr$45, 0 );
		}
		label$121:;
		label$120:;
	}
...
{
	label$122:;
	ERRREPORTWARNEX( MSGNUM$1, MSGEX$1, *(int32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16564), OPTIONS$1, CUSTOMTEXT$1 );
	label$123:;
}
...
void ERRREPORTUNDEF( int32 ERRNUM$1, uint8* ID$1 )
{
	...
	if( vr$4 == (void*)0u ) goto label$193;
	{
		goto label$191;
	}
	label$193:;
...
static void HPRINTERRMSG( int32 ERRNUM$1, uint8* MSGEX$1, $12FB_ERRMSGOPT OPTIONS$1, int32 LINENUM$1, int32 SHOWERROR$1, uint8* CUSTOMTEXT$1 )
{
	...
	if( (-(ERRNUM$1 < 1) | -(ERRNUM$1 >= 325)) == 0 ) goto label$33;
	{
		MSG$1 = (uint8*)0u;
	}
	goto label$32;
	label$33:;
	{
		MSG$1 = *(uint8**)(((uint8*)ERRORMSGS$ + (ERRNUM$1 << (2 & 31))) + -4);
	}
	label$32:;
	if( MSGEX$1 != (uint8*)0u ) goto label$35;
	{
		MSGEX$1 = (uint8*)"";
	}
	label$35:;
	label$34:;
	int32 vr$5 = fb_StrLen( (void*)((uint8*)&ENV$ + 280), 261 );
	if( vr$5 <= 0 ) goto label$37;
	{
		FBSTRING* vr$7 = fb_StrAllocTempDescZ( (uint8*)((uint8*)&ENV$ + 280) );
		fb_PrintString( 0, (FBSTRING*)vr$7, 0 );
		FBSTRING* vr$8 = fb_StrAllocTempDescZEx( (uint8*)"(", 1 );
		fb_PrintString( 0, (FBSTRING*)vr$8, 0 );
		if( LINENUM$1 <= 0 ) goto label$39;
		{
	...
	if( ERRNUM$1 < 0 ) goto label$41;
	{
		...
		FBSTRING* vr$15 = fb_StrConcat( &TMP$468$2, (void*)" ", 2, (void*)vr$12, -1 );
		__builtin_memset( &TMP$469$2, 0, 12 );
		FBSTRING* vr$18 = fb_StrConcat( &TMP$469$2, (void*)vr$15, -1, (void*)": ", 3 );
		__builtin_memset( &TMP$470$2, 0, 12 );
		FBSTRING* vr$21 = fb_StrConcat( &TMP$470$2, (void*)vr$18, -1, (void*)MSG$1, 0 );
		fb_PrintString( 0, (FBSTRING*)vr$21, 0 );
		if( CUSTOMTEXT$1 == (uint8*)0u ) goto label$43;
		{
		...
		label$43:;
		label$42:;
		if( SHOWERROR$1 == 0 ) goto label$45;
		{
		...
		if( vr$24 <= 0 ) goto label$47;
		{
			if( (OPTIONS$1 & 1) == 0 ) goto label$49;
			{
			...
			label$48:;
			if( (OPTIONS$1 & 4) == 0 ) goto label$52;
			{
		...
		label$47:;
		label$46:;
		if( SHOWERROR$1 == 0 ) goto label$56;
		{
			static FBSTRING LN$3;
			FBSTRING* vr$37 = LEXPEEKCURRENTLINE( &TOKEN_POS$1, -((*(int32*)((uint8*)&ENV$ + 888) & 256) != 0) );
			fb_StrAssign( (void*)&LN$3, -1, (void*)vr$37, -1, 0 );
			int32 vr$38 = fb_StrLen( (void*)&LN$3, -1 );
			if( vr$38 <= 0 ) goto label$58;
			{
				if( (*(int32*)((uint8*)&ENV$ + 888) & 256) == 0 ) goto label$60;
				{
					FBSTRING TMP$475$5;
					FBSTRING TMP$476$5;
					__builtin_memset( &TMP$475$5, 0, 12 );
					FBSTRING* vr$42 = fb_StrConcat( &TMP$475$5, (void*)" in '", 6, (void*)&LN$3, -1 );
					__builtin_memset( &TMP$476$5, 0, 12 );
					FBSTRING* vr$45 = fb_StrConcat( &TMP$476$5, (void*)vr$42, -1, (void*)"'", 2 );
...
static uint8* HADDTOKEN( int32 ISBEFORE$1, int32 ADDCOMMA$1, uint8* MSGEX$1 )
{
	...
	if( MSGEX$1 != (uint8*)0u ) goto label$78;
	{
	...
	if( vr$2 <= 0 ) goto label$80;
	{
		{
			int32 TMP$477$3;
			int32 vr$3 = LEXGETTOKEN( 0 );
			TMP$477$3 = vr$3;
			if( TMP$477$3 <= 32 ) goto label$83;
			label$84:;
			if( TMP$477$3 == 257 ) goto label$83;
			label$85:;
			if( TMP$477$3 != 256 ) goto label$82;
			label$83:;
			{
			}
			goto label$81;
			label$82:;
			{
				if( ADDCOMMA$1 == 0 ) goto label$88;
				{
					fb_StrConcatAssign( (void*)&RES$1, -1, (void*)", ", 3, 0 );
				}
				label$88:;
				label$87:;
				if( ISBEFORE$1 == 0 ) goto label$90;
				{
...
static FBSTRING* GETNOTALLOWEDMSG( $11FB_LANG_OPT OPT$1, uint8* MSGEX$1 )
{
	...
	LANGS$1 = 0;
	{
		...
		label$129:;
		{
			...
			if( (vr$4 & OPT$1) == 0 ) goto label$131;
			{
				if( LANGS$1 <= 0 ) goto label$133;
				{
		...
		I$1 = I$1 + 1;
		label$126:;
		if( I$1 <= 3 ) goto label$129;
		label$128:;
	}
	uint8* vr$12 = HADDTOKEN( 0, -(LANGS$1 > 0), MSGEX$1 );
	__builtin_memset( &TMP$491$1, 0, 12 );
	FBSTRING* vr$16 = fb_StrConcat( &TMP$491$1, (void*)&MSG$1, -1, (void*)vr$12, 0 );
...
static uint8* HMAKEPARAMDESC( uint8* MSGEX$1 )
{
	...
	if( PARAMLOC$1 != (struct $16ERRPARAMLOCATION*)0u ) goto label$139;
	{
		fb$result$1 = MSGEX$1;
		goto label$137;
	}
	...
	if( MSGEX$1 == (uint8*)0u ) goto label$141;
	{
		FBSTRING TMP$492$2;
		__builtin_memset( &TMP$492$2, 0, 12 );
		FBSTRING* vr$8 = fb_StrConcat( &TMP$492$2, (void*)MSGEX$1, 0, (void*)" ", 2 );
		fb_StrAssign( (void*)&DESC$1, -1, (void*)vr$8, -1, 0 );
	}
	label$141:;
	label$140:;
	if( PNUM$1 <= 0 ) goto label$143;
	{
		...
		if( PID$1 != (uint8*)0u ) goto label$145;
		{
			if( PROC$1 == (struct $8FBSYMBOL*)0u ) goto label$147;
			{
				int32 TMP$494$4;
				struct $8FBSYMBOL* PARAM$4;
				PARAM$4 = *(struct $8FBSYMBOL**)((uint8*)PROC$1 + 76);
				int32 CNT$4;
				if( (*(int32*)((uint8*)PROC$1 + 8) & 2) == 0 ) goto label$148;
				TMP$494$4 = 0;
				goto label$194;
				label$148:;
				TMP$494$4 = 1;
				...
				CNT$4 = TMP$494$4;
				label$149:;
				if( PARAM$4 == (struct $8FBSYMBOL*)0u ) goto label$150;
				{
					if( CNT$4 != PNUM$1 ) goto label$152;
					{
						goto label$150;
					}
					label$152:;
				...
				goto label$149;
				label$150:;
				if( PARAM$4 == (struct $8FBSYMBOL*)0u ) goto label$154;
				{
		...
		label$145:;
		label$144:;
		if( PID$1 == (uint8*)0u ) goto label$156;
		{
			int32 vr$16 = fb_StrLen( (void*)PID$1, 0 );
			if( vr$16 <= 0 ) goto label$158;
			{
				FBSTRING TMP$496$4;
				fb_StrConcatAssign( (void*)&DESC$1, -1, (void*)" (", 3, 0 );
				__builtin_memset( &TMP$496$4, 0, 12 );
				FBSTRING* vr$19 = fb_StrConcat( &TMP$496$4, (void*)&DESC$1, -1, (void*)PID$1, 0 );
	...
	label$143:;
	label$142:;
	if( PROC$1 == (struct $8FBSYMBOL*)0u ) goto label$160;
	{
		int32 SHOWNAME$2;
		SHOWNAME$2 = -1;
		PNAME$1 = (uint8*)0u;
		if( (*(int32*)((uint8*)PROC$1 + 12) & 32) == 0 ) goto label$162;
		{
			if( *(uint8**)((uint8*)PROC$1 + 16) == (uint8*)0u ) goto label$164;
			{
		...
		{
			static FBSTRING S$3;
			if( (*(int32*)((uint8*)PROC$1 + 12) & 16384) == 0 ) goto label$168;
			{
			...
			goto label$167;
			label$168:;
			if( (*(int32*)((uint8*)PROC$1 + 8) & 28) == 0 ) goto label$169;
			{
		...
		label$161:;
		if( SHOWNAME$2 == 0 ) goto label$171;
		{
			if( PNAME$1 != (uint8*)0u ) goto label$173;
			{
				ADDPRNTS$1 = -1;
				PNAME$1 = *(uint8**)((uint8*)PROC$1 + 16);
				if( PNAME$1 == (uint8*)0u ) goto label$175;
				{
					int32 vr$34 = fb_StrLen( (void*)PNAME$1, 0 );
					if( vr$34 != 0 ) goto label$177;
					{
			...
			if( PNAME$1 == (uint8*)0u ) goto label$179;
			{
				...
				FBSTRING* vr$38 = fb_StrConcat( &TMP$499$4, (void*)&DESC$1, -1, (void*)PNAME$1, 0 );
				fb_StrAssign( (void*)&DESC$1, -1, (void*)vr$38, -1, 0 );
				if( ADDPRNTS$1 == 0 ) goto label$183;
				{
					fb_StrConcatAssign( (void*)&DESC$1, -1, (void*)"()", 3, 0 );
				}
				label$183:;
	...
	label$160:;
	{
		...
		FBSTRING* vr$43 = fb_StrConcat( &TMP$500$2, (void*)&DESC$1, -1, (void*)vr$40, 0 );
