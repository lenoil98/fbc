...
int32 CASSIGNFUNCTRESULT( int32 IS_RETURN$1 )
{
	...
	fb$result$1 = 0;
	struct $8FBSYMBOL* vr$1 = SYMBGETPROCRESULT( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) );
	RES$1 = vr$1;
	...
	label$23:;
	label$22:;
	int32 vr$2 = SYMBHASCTOR( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) );
	HAS_CTOR$1 = vr$2;
	int32 vr$3 = SYMBHASDEFCTOR( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) );
	HAS_DEFCTOR$1 = vr$3;
	int32 RETURNS_BYREF$1;
	RETURNS_BYREF$1 = -((*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 8) & 2048) != 0);
	if( IS_RETURN$1 == 0 ) goto label$25;
	{
		if( (*(int32*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 112) + 48) & 2) == 0 ) goto label$27;
		{
		...
		label$27:;
		label$26:;
		*($12FB_PROCSTATS*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 112) + 48) = *(int32*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 112) + 48) | 1;
	}
	goto label$24;
	label$25:;
	{
		if( (*(int32*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 112) + 48) & 1) == 0 ) goto label$31;
		{
		...
		label$31:;
		label$30:;
		*($12FB_PROCSTATS*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 112) + 48) = *(int32*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 112) + 48) | 2;
	}
	label$24:;
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 156) = *(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 32);
	*(int32*)((uint8*)&PARSER$ + 152) = *(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 28) & 511;
	...
	if( (RETURNS_BYREF$1 & ~vr$30) == 0 ) goto label$35;
	{
		...
		if( RHS$1 == (struct $7ASTNODE*)0u ) goto label$37;
		{
			...
			label$39:;
			label$38:;
			int32 vr$37 = ASTCHECKBYREFASSIGN( *(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 28), *(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 32), RHS$1 );
			...
			label$41:;
			{
				...
				ASTDELTREE( RHS$1 );
				struct $7ASTNODE* vr$53 = ASTNEWCONSTZ( (((*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 28) & 31) | ((*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 28) & 480) + 32)) | ((*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 28) & 261632) << (1 & 31))) | (*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 28) & 32505856), *(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 32) );
				RHS$1 = vr$53;
			}
			label$40:;
		}
	...
	label$34:;
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 156) = (struct $8FBSYMBOL*)0u;
	*(int32*)((uint8*)&PARSER$ + 152) = -2147483648u;
	...
	*($12FB_SYMBSTATS*)((uint8*)RES$1 + 12) = *(int32*)((uint8*)RES$1 + 12) | 2;
	...
	if( (IS_RETURN$1 & ~RETURNS_BYREF$1) == 0 ) goto label$45;
	{
		if( HAS_CTOR$1 == 0 ) goto label$47;
		{
			...
			{
				struct $7ASTNODE* vr$63 = ASTBUILDPROCRESULTVAR( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104), RES$1 );
	...
	label$45:;
	label$44:;
	struct $7ASTNODE* vr$65 = ASTBUILDPROCRESULTVAR( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104), RES$1 );
...
void HMETHODCALLADDINSTPTROVLARG( struct $8FBSYMBOL* PROC$1, struct $7ASTNODE* THISEXPR$1, struct $16FB_CALL_ARG_LIST* ARG_LIST$1, $12FB_PARSEROPT* OPTIONS$1 )
{
	...
	struct $11FB_CALL_ARG* vr$1 = SYMBALLOCOVLCALLARG( (struct $5TLIST*)((uint8*)&PARSER$ + 112), ARG_LIST$1, 0 );
	ARG$1 = vr$1;
	...
	*(struct $7ASTNODE**)ARG$1 = THISEXPR$1;
	...
	TMP$94$1 = -1;
	label$61:;
	*($12FB_PARAMMODE*)((uint8*)ARG$1 + 4) = TMP$94$1;
	...
	*(struct $11FB_CALL_ARG**)((uint8*)&ARG_LIST$1 + 8) = (struct $11FB_CALL_ARG*)0u;
	...
	if( (*(int32*)((uint8*)SYM$1 + 8) & 32) == 0 ) goto label$80;
	{
		...
		if( vr$5 != 40 ) goto label$82;
		{
			...
			struct $11FB_CALL_ARG* vr$10 = SYMBALLOCOVLCALLARG( (struct $5TLIST*)((uint8*)&PARSER$ + 112), &ARG_LIST$1, 0 );
			ARG$3 = vr$10;
	...
	label$107:;
	label$106:;
	*(int32*)((uint8*)&PARSER$ + 144) = 0;
	if( ~CHECKPRNTS$1 == 0 ) goto label$111;
	{
		*($12FB_PARSEROPT*)((uint8*)&PARSER$ + 148) = *(int32*)((uint8*)&PARSER$ + 148) | 1;
	}
	goto label$110;
	label$111:;
	{
	...
	PROCEXPR$1 = vr$40;
	if( (CHECKPRNTS$1 | -(*(int32*)((uint8*)&PARSER$ + 144) > 0)) == 0 ) goto label$113;
	{
		*(int32*)((uint8*)&PARSER$ + 144) = *(int32*)((uint8*)&PARSER$ + 144) + -1;
		...
		goto label$114;
		label$115:;
		if( *(int32*)((uint8*)&PARSER$ + 144) <= 0 ) goto label$116;
		{
			label$117:;
			if( *(int32*)((uint8*)&PARSER$ + 144) <= 0 ) goto label$118;
			{
				HSKIPUNTIL( 41, -1, 0, 0 );
				*(int32*)((uint8*)&PARSER$ + 144) = *(int32*)((uint8*)&PARSER$ + 144) + -1;
			}
...
int32 CPROCCALLORASSIGN( void )
{
	...
	label$249:;
	{
		...
		{
			{
				...
				TMP$102$4 = (uint32)vr$6;
				goto label$256;
				label$257:;
				{
					if( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) != *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 880) ) goto label$259;
					{
					...
					label$259:;
					label$258:;
					if( (*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 8) & 16) == 0 ) goto label$261;
					{
						ERRREPORT( 157, 0, (uint8*)0u );
					}
					goto label$260;
					label$261:;
					if( (*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 8) & 32) == 0 ) goto label$262;
					{
				...
				label$263:;
				{
					if( (*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 8) & 16) != 0 ) goto label$265;
					{
				...
				label$266:;
				{
					if( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) != *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 880) ) goto label$268;
					{
					...
					label$268:;
					{
						if( (*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 8) & 32) != 0 ) goto label$270;
						{
							ERRREPORT( 193, 0, (uint8*)0u );
						}
						label$270:;
				...
				label$275:;
				{
					if( (*(int32*)((uint8*)&ENV$ + 888) & 131072) != 0 ) goto label$277;
					{
				...
				if( (TMP$102$4 - 346u) > 47u ) goto label$255;
				goto *tmp$103[TMP$102$4 - 346u];
				label$255:;
			}
		}
		goto label$251;
		...
		label$285:;
		{
			...
			if( vr$26 != 46 ) goto label$287;
			{
				if( *(struct $13FB_CMPSTMTSTK**)((uint8*)&PARSER$ + 52) == (struct $13FB_CMPSTMTSTK*)0u ) goto label$289;
				{
					...
					{
						struct $7ASTNODE* vr$30 = CWITHVARIABLE( -((*(int32*)((uint8*)&PARSER$ + 148) & 2) != 0) );
						EXPR$1 = vr$30;
		...
		if( TMP$101$2 > 6u ) goto label$251;
		goto *tmp$104[TMP$101$2 - 0u];
		label$251:;
	}
	label$248:;
	return fb$result$1;
...
int32 HFORWARDCALL( void )
{
	...
	fb$result$1 = 0;
	{
		...
		TMP$105$2 = vr$1;
		if( TMP$105$2 != 0 ) goto label$328;
		label$329:;
		{
			if( (*(int32*)((uint8*)&ENV$ + 888) & 524288) == 0 ) goto label$331;
			{
				if( *(struct $8FBSYMBOL**)((uint8*)&SYMB$ + 98536) == (struct $8FBSYMBOL*)((uint8*)&SYMB$ + 98352) ) goto label$333;
				{
					if( *(int32*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16548) + 4120) <= 0 ) goto label$335;
					{
	...
	if( *(int32*)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16548) + 8) == -2147483648u ) goto label$338;
	{
		ERRREPORT( 17, 0, (uint8*)0u );
	}
	label$338:;
	...
	*(struct $11FB_CALL_ARG**)((uint8*)&ARG_LIST$1 + 8) = (struct $11FB_CALL_ARG*)0u;
	label$341:;
	{
		...
		{
			int32 TMP$106$3;
			TMP$106$3 = *(int32*)((uint8*)EXPR$2 + 4) & 511;
			if( TMP$106$3 == 17 ) goto label$352;
			label$353:;
			if( TMP$106$3 == 18 ) goto label$352;
			label$354:;
			if( TMP$106$3 == 4 ) goto label$352;
			label$355:;
			if( TMP$106$3 != 7 ) goto label$351;
			label$352:;
			{
				DTYPE$2 = 17;
			}
		...
		TMP$107$2 = 0;
		label$367:;
		struct $8FBSYMBOL* vr$17 = SYMBADDPROCPARAM( PROC$1, (uint8*)0u, DTYPE$2, (struct $8FBSYMBOL*)0u, TMP$107$2, MODE$2, 0, 0 );
		...
		struct $11FB_CALL_ARG* vr$20 = SYMBALLOCOVLCALLARG( (struct $5TLIST*)((uint8*)&PARSER$ + 112), &ARG_LIST$1, 0 );
		ARG$2 = vr$20;
	...
	label$362:;
	label$361:;
	struct $8FBSYMBOL* vr$25 = SYMBADDPROC( PROC$1, (uint8*)*(uint8**)&ID$1, (uint8*)0u, 0, (struct $8FBSYMBOL*)0u, 0, 0, *(int32*)((uint8*)&ENV$ + 252), 0 );
	PROC$1 = vr$25;
...
static int32 HLOOKSLIKEENDOFSTATEMENT( void )
{
	...
	label$62:;
	{
		...
		int32 vr$1 = LEXGETTOKEN( 0 );
		TMP$95$2 = vr$1;
		if( TMP$95$2 == 258 ) goto label$66;
		label$67:;
		if( TMP$95$2 == 257 ) goto label$66;
		label$68:;
		if( TMP$95$2 == 256 ) goto label$66;
		label$69:;
		if( TMP$95$2 == 259 ) goto label$66;
		label$70:;
		if( TMP$95$2 != 260 ) goto label$65;
		label$66:;
		{
			fb$result$1 = -1;
		}
...
static int32 HPROCSYMBOL( struct $8FBSYMBOL* BASE_PARENT$1, struct $8FBSYMBOL* SYM$1, int32 ISCALL$1, $12FB_PARSEROPT OPTIONS$1 )
{
	...
	if( DO_CALL$1 != 0 ) goto label$132;
	{
		...
		{
			DO_CALL$1 = -1;
			if( (*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 8) & 32) == 0 ) goto label$136;
			{
				if( (int32)*(int16*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 68) != 1 ) goto label$138;
				{
					int32 vr$11 = SYMBISPROCOVERLOADOF( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104), SYM$1 );
	...
	label$146:;
	label$145:;
	int32 vr$13 = SYMBISPROCOVERLOADOF( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104), SYM$1 );
...
static int32 HMATCHESDEFDTYPE( struct $8FBSYMBOL* SYM$1, int32 DEFDTYPE$1 )
{
	...
	if( DEFDTYPE$1 != 17 ) goto label$160;
	{
		{
			int32 TMP$96$3;
			TMP$96$3 = *(int32*)((uint8*)SYM$1 + 28) & 511;
			if( TMP$96$3 == 17 ) goto label$163;
			label$164:;
			if( TMP$96$3 == 18 ) goto label$163;
			label$165:;
			if( TMP$96$3 != 4 ) goto label$162;
			label$163:;
			{
				fb$result$1 = -1;
			}
				...
				{
					{
						...
						if( (TMP$97$6 - 1u) > 5u ) goto label$182;
				...
				{
					{
						...
						if( (TMP$98$6 - 1u) > 5u ) goto label$202;
						goto *tmp$109[TMP$98$6 - 1u];
						label$202:;
					}
				}
				label$201:;
		...
		{
			{
				...
				if( (TMP$99$4 - 1u) > 11u ) goto label$228;
				goto *tmp$110[TMP$99$4 - 1u];
				label$228:;
			}
			SYM$2 = *(struct $8FBSYMBOL**)((uint8*)SYM$2 + 160);
		}
...
static int32 HPROCCALLORASSIGN_QB( void )
{
	...
	fb$result$1 = 0;
	{
		...
		label$239:;
		{
			int32 vr$4 = HASSIGNORCALL_QB( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16548) + 4116), 0 );
			fb$result$1 = vr$4;
			goto label$236;
		}
		goto label$237;
		...
		{
			int32 vr$5 = LEXGETTOKEN( 0 );
			if( vr$5 == 393 ) goto label$242;
			{
				int32 vr$8 = HASSIGNORCALL_QB( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16548) + 4116), 0 );
				fb$result$1 = vr$8;
				goto label$236;
			}
			label$242:;
			...
			label$243:;
			LEXSKIPTOKEN( 2048 );
			if( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16548) + 4116) != (struct $10FBSYMCHAIN*)0u ) goto label$246;
			{
			...
			label$246:;
			{
				int32 vr$15 = HASSIGNORCALL_QB( *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16548) + 4116), -1 );
				fb$result$1 = vr$15;
				goto label$236;
			}
			label$245:;
		...
		if( TMP$100$2 > 5u ) goto label$237;
		goto *tmp$111[TMP$100$2 - 0u];
		label$237:;
	}
	label$236:;
	return fb$result$1;
...
static void HCTORCHAIN( void )
{
	...
	if( (*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 8) & 4) != 0 ) goto label$299;
	{
	...
	label$299:;
	label$298:;
	PARENT$1 = *(struct $8FBSYMBOL**)*(struct $8FBHASHTB**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 144);
	struct $7ASTNODE* vr$4 = ASTFINDFIRSTCODE( *(struct $7ASTNODE**)((uint8*)&AST$ + 40) );
	if( (-(vr$4 != (struct $7ASTNODE*)0u) | -(*(struct $7ASTNODE**)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 112) + 64) != (struct $7ASTNODE*)0u)) == 0 ) goto label$301;
	{
		ERRREPORT( 169, 0, (uint8*)0u );
	}
	label$301:;
	label$300:;
	*($12FB_SYMBSTATS*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 12) = *(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 12) | 4;
	LEXSKIPTOKEN( 2048 );
	struct $7ASTNODE* vr$15 = ASTBUILDVARFIELD( *(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 76) + 60), (struct $8FBSYMBOL*)0u, 0ll );
...
static void HBASEINIT( void )
{
	...
	if( (*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 8) & 4) != 0 ) goto label$305;
	{
		ERRREPORT( 165, 0, (uint8*)0u );
		HSKIPUNTIL( -1, 0, 0, 0 );
		goto label$303;
	...
	label$305:;
	label$304:;
	BASE_$1 = *(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)*(struct $8FBHASHTB**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 144) + 96);
	...
	if( (-(vr$5 != (struct $7ASTNODE*)0u) | -(*(struct $7ASTNODE**)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 112) + 64) != (struct $7ASTNODE*)0u)) == 0 ) goto label$309;
	{
	...
	label$310:;
	*(struct $7ASTNODE**)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 112) + 64) = INITREE$1;
	label$303:;
}
...
static int32 HBASEMEMBERACCESS( void )
{
	...
	label$312:;
	struct $8FBSYMBOL* PROC$1;
	PROC$1 = *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104);
