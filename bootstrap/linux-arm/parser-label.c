...
int32 CLABEL( void )
{
	...
	fb$result$1 = 0;
	{
		...
		TMP$93$2 = (uint32)vr$1;
		goto label$13;
		label$14:;
		{
			if( (*(int32*)((uint8*)&ENV$ + 888) & 1048576) != 0 ) goto label$16;
			{
			...
			label$16:;
			{
				...
				struct $8FBSYMBOL* vr$4 = SYMBADDLABEL( vr$3, 68 );
				L$1 = vr$4;
				if( L$1 != (struct $8FBSYMBOL*)0u ) goto label$18;
				{
		...
		label$19:;
		{
			...
			if( vr$6 != 258 ) goto label$21;
			{
				CHAIN_$1 = *(struct $10FBSYMCHAIN**)((uint8*)*(struct $7FBTOKEN**)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16548) + 4116);
				struct $8FBSYMBOL* vr$9 = SYMBFINDBYCLASS( CHAIN_$1, 3 );
				if( vr$9 == (struct $8FBSYMBOL*)0u ) goto label$23;
				{
					goto label$11;
				}
				label$23:;
				...
				struct $8FBSYMBOL* vr$11 = SYMBADDLABEL( vr$10, 68 );
				L$1 = vr$11;
				if( L$1 != (struct $8FBSYMBOL*)0u ) goto label$25;
				{
					ERRREPORT( 4, 0, (uint8*)0u );
				}
				label$25:;
		...
		if( TMP$93$2 > 3u ) goto label$12;
		goto *tmp$94[TMP$93$2 - 0u];
		label$12:;
	}
	if( L$1 == (struct $8FBSYMBOL*)0u ) goto label$27;
	{
		struct $7ASTNODE* vr$12 = ASTNEWLABEL( L$1, -1 );
		ASTADD( vr$12 );
