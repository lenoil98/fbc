...
int32 CGOTOSTMT( $8FB_TOKEN TK$1 )
{
	...
	fb$result$1 = 0;
	{
		...
		label$61:;
		{
			if( (*(int32*)((uint8*)&ENV$ + 888) & 65536) == 0 ) goto label$63;
			{
				if( *(int32*)((uint8*)&ENV$ + 948) == 0 ) goto label$65;
				{
		...
		label$66:;
		{
			if( (*(int32*)((uint8*)&ENV$ + 888) & 134217728) != 0 ) goto label$68;
			{
		...
		if( (TMP$97$2 - 390u) > 110u ) goto label$51;
		goto *tmp$98[TMP$97$2 - 390u];
		label$51:;
	}
	label$50:;
	return fb$result$1;
...
static int32 HFUNCRETURN( void )
{
	...
	label$14:;
	LEXSKIPTOKEN( 2048 );
	if( (*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 28) & 511) == 0 ) goto label$17;
	{
		CHECKEXPR$1 = -1;
	}
	goto label$16;
	...
	{
		{
			...
			if( (TMP$94$3 - 256u) > 84u ) goto label$21;
			goto *tmp$99[TMP$94$3 - 256u];
			label$18:;
		}
	}
	label$16:;
...
static struct $8FBSYMBOL* HGETLABELID( void )
{
	...
	struct $8FBSYMBOL* SYM$1;
	{
		...
		goto label$28;
		label$29:;
		static const void* tmp$100[4] = {
			&&label$31,
			&&label$31,
			&&label$31,
			&&label$30,
		};
		if( TMP$95$2 > 3u ) goto label$32;
		goto *tmp$100[TMP$95$2 - 0u];
		label$28:;
	}
...
static void HGOSUBBRANCH( void )
{
	...
	{
		ASTGOSUBADDJMP( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104), L$1 );
	}
	label$40:;
	label$39:;
	label$38:;
...
static int32 HGOSUBRETURN( void )
{
	...
	LEXSKIPTOKEN( 2048 );
	{
		...
		label$45:;
		{
			int32 vr$2 = ASTGOSUBADDRETURN( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104), (struct $8FBSYMBOL*)0u );
			fb$result$1 = vr$2;
		}
		goto label$43;
		label$46:;
		{
			...
			{
				int32 vr$4 = ASTGOSUBADDRETURN( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104), L$1 );
				fb$result$1 = vr$4;
			}
			goto label$47;
			label$48:;
		...
		if( (TMP$96$2 - 256u) > 84u ) goto label$46;
		goto *tmp$101[TMP$96$2 - 256u];
		label$43:;
	}
	label$42:;
	return fb$result$1;
