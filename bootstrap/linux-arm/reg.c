	...
	*(struct $7REG_REG**)((uint8*)THIS_$1 + 132) = (struct $7REG_REG*)0u;
	{
		...
		label$41:;
		{
			...
			*(uint32*)((uint8*)((uint8*)((uint8*)THIS_$1 + 128) + (N$1 << (2 & 31))) + 108) = 0u;
...
static int32 REGALLOCATE( struct $8REGCLASS* THIS_$1, struct $6IRVREG* VREG$1, struct $6IRVREG* VAUXPARENT$1, uint32 SIZE$1 )
{
	...
	if( R$1 != -1 ) goto label$57;
	{
		...
		R$1 = vr$9;
		(*(tmp$44*)((uint8*)&IR$ + 268))( *(struct $6IRVREG**)((uint8*)((uint8*)THIS_$1 + (R$1 << (2 & 31))) + 64), *(struct $6IRVREG**)((uint8*)((uint8*)THIS_$1 + (R$1 << (2 & 31))) + 96) );
	...
	*(struct $6IRVREG**)((uint8*)((uint8*)THIS_$1 + (R$1 << (2 & 31))) + 96) = VAUXPARENT$1;
	uint32 vr$23 = (*(tmp$76*)((uint8*)&IR$ + 260))( VREG$1 );
...
static int32 REGALLOCATEREG( struct $8REGCLASS* THIS_$1, int32 R$1, struct $6IRVREG* VREG$1, struct $6IRVREG* VAUXPARENT$1 )
{
	...
	*(struct $6IRVREG**)((uint8*)((uint8*)THIS_$1 + (R$1 << (2 & 31))) + 64) = VREG$1;
	*(struct $6IRVREG**)((uint8*)((uint8*)THIS_$1 + (R$1 << (2 & 31))) + 96) = VAUXPARENT$1;
	uint32 vr$13 = (*(tmp$76*)((uint8*)&IR$ + 260))( VREG$1 );
...
static int32 REGENSURE( struct $8REGCLASS* THIS_$1, struct $6IRVREG* VREG$1, struct $6IRVREG* VAUXPARENT$1, uint32 SIZE$1 )
{
	...
	if( R$1 != -1 ) goto label$68;
	{
		...
		R$1 = vr$2;
		(*(tmp$51*)((uint8*)&IR$ + 264))( R$1, VREG$1, VAUXPARENT$1 );
	}
	label$68:;
	label$67:;
	fb$result$1 = R$1;
...
static void REGFREE( struct $8REGCLASS* THIS_$1, int32 R$1 )
{
	...
	if( (*(int32*)((uint8*)THIS_$1 + 136) & (1 << (R$1 & 31))) != 0 ) goto label$74;
	{
		...
		*(uint32*)((uint8*)((uint8*)((uint8*)THIS_$1 + 128) + (R$1 << (2 & 31))) + 108) = 0u;
		REGPUSH( THIS_$1, R$1 );
	}
	label$74:;
	label$73:;
...
static void REGINITCLASS( struct $8REGCLASS* THIS_$1, struct $7FBARRAYI12REG_SIZEMASKE* SIZETB$1 )
{
	...
	*(tmp$83*)((uint8*)THIS_$1 + 4) = (tmp$83)&REGALLOCATE;
	*(tmp$84*)((uint8*)THIS_$1 + 8) = (tmp$84)&REGALLOCATEREG;
	*(tmp$85*)((uint8*)THIS_$1 + 12) = (tmp$85)&REGFREE;
	*(tmp$86*)((uint8*)THIS_$1 + 16) = (tmp$86)&REGISFREE;
	*(tmp$87*)((uint8*)THIS_$1 + 20) = (tmp$87)&REGSETOWNER;
	*(tmp$88*)((uint8*)THIS_$1 + 24) = (tmp$88)&REGGETMAXREGS;
	*(tmp$88*)((uint8*)THIS_$1 + 28) = (tmp$88)&REGGETFIRST;
	*(tmp$86*)((uint8*)THIS_$1 + 32) = (tmp$86)&REGGETNEXT;
	*(tmp$89*)((uint8*)THIS_$1 + 36) = (tmp$89)&REGGETVREG;
	*(tmp$86*)((uint8*)THIS_$1 + 40) = (tmp$86)&REGGETREALREG;
	*(tmp$90*)((uint8*)THIS_$1 + 44) = (tmp$90)&REGCLEAR;
	*(tmp$90*)((uint8*)THIS_$1 + 48) = (tmp$90)&REGDUMP;
	label$94:;
}
...
static void SREGINITCLASS( struct $8REGCLASS* THIS_$1, struct $7FBARRAYI12REG_SIZEMASKE* SIZETB$1 )
{
	...
	*(tmp$83*)((uint8*)THIS_$1 + 4) = (tmp$83)&SREGALLOCATE;
	*(tmp$84*)((uint8*)THIS_$1 + 8) = (tmp$84)&SREGALLOCATEREG;
	*(tmp$85*)((uint8*)THIS_$1 + 12) = (tmp$85)&SREGFREE;
	*(tmp$86*)((uint8*)THIS_$1 + 16) = (tmp$86)&SREGISFREE;
	*(tmp$87*)((uint8*)THIS_$1 + 20) = (tmp$87)&SREGSETOWNER;
	*(tmp$88*)((uint8*)THIS_$1 + 24) = (tmp$88)&SREGGETMAXREGS;
	*(tmp$88*)((uint8*)THIS_$1 + 28) = (tmp$88)&SREGGETFIRST;
	*(tmp$86*)((uint8*)THIS_$1 + 32) = (tmp$86)&SREGGETNEXT;
	*(tmp$89*)((uint8*)THIS_$1 + 36) = (tmp$89)&SREGGETVREG;
	*(tmp$86*)((uint8*)THIS_$1 + 40) = (tmp$86)&SREGGETREALREG;
	*(tmp$90*)((uint8*)THIS_$1 + 44) = (tmp$90)&SREGCLEAR;
	*(tmp$90*)((uint8*)THIS_$1 + 48) = (tmp$90)&SREGDUMP;
	label$202:;
}
