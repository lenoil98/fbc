...
struct $7ASTNODE* CARRAYFUNCT( $8FB_TOKEN TK$1 )
{
	...
	{
		if( TK$1 == 493 ) goto label$95;
		label$96:;
		if( TK$1 != 494 ) goto label$94;
		label$95:;
		{
			LEXSKIPTOKEN( 2048 );
...
static int32 HSCOPEDSWAP( void )
{
	...
	int32 vr$34 = ASTCHECKASSIGN( L$1, R$1 );
	int32 vr$36 = ASTCHECKASSIGN( R$1, L$1 );
	...
	goto label$113;
	label$77:;
	TMP$94$1 = LDTYPE$1 & 31;
	label$113:;
	if( (RDTYPE$1 & 480) == 0 ) goto label$78;
	TMP$95$1 = 24;
	goto label$114;
	label$78:;
	TMP$95$1 = RDTYPE$1 & 31;
	label$114:;
	USE_PUSHPOP$1 = USE_PUSHPOP$1 & -(*(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$94$1 * 28)) + 4) == *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$95$1 * 28)) + 4));
	if( (LDTYPE$1 & 480) == 0 ) goto label$79;
	TMP$96$1 = 24;
	goto label$115;
	label$79:;
	TMP$96$1 = LDTYPE$1 & 31;
	label$115:;
	if( (RDTYPE$1 & 480) == 0 ) goto label$80;
	TMP$97$1 = 24;
	goto label$116;
	label$80:;
	TMP$97$1 = RDTYPE$1 & 31;
	label$116:;
	USE_PUSHPOP$1 = USE_PUSHPOP$1 & -(*(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$96$1 * 28)) == *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$97$1 * 28)));
	if( *(int32*)L$1 != 19 ) goto label$81;
	TMP$98$1 = -(*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)L$1 + 12) + 116) > 0);
	goto label$117;
	label$81:;
	TMP$98$1 = 0;
	label$117:;
	...
	TMP$99$1 = -(*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)R$1 + 12) + 116) > 0);
	goto label$118;
	label$82:;
	TMP$99$1 = 0;
	label$118:;
	USE_PUSHPOP$1 = USE_PUSHPOP$1 & -(TMP$99$1 == 0);
	struct $7ASTNODE* T$1;
