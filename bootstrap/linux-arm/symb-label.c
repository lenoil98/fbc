...
struct $8FBSYMBOL* SYMBADDLABEL( uint8* SYMBOL$1, $10FB_SYMBOPT OPTIONS$1 )
{
	...
	if( SYMBOL$1 == (uint8*)0u ) goto label$13;
	{
		...
		if( L$1 == (struct $8FBSYMBOL*)0u ) goto label$15;
		{
			if( (OPTIONS$1 & 4) == 0 ) goto label$17;
			{
				...
				*(struct $8FBSYMBOL**)((uint8*)L$1 + 56) = *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 108);
				*(int32*)((uint8*)L$1 + 64) = *(int32*)((uint8*)&PARSER$ + 28);
				*(uint16*)((uint8*)L$1 + 36) = (uint16)*(uint32*)((uint8*)&PARSER$ + 96);
				fb$result$1 = L$1;
				goto label$11;
			}
			goto label$16;
	...
	label$23:;
	{
		if( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) != *(struct $8FBSYMBOL**)((uint8*)&ENV$ + 880) ) goto label$25;
		{
			ISGLOBAL$1 = -1;
	...
	TMP$93$1 = 32;
	label$35:;
	struct $8FBSYMBOL* vr$20 = SYMBNEWSYMBOL( TMP$93$1, (struct $8FBSYMBOL*)0u, SYMTB$1, HASHTB$1, 7, (uint8*)ID$1, (uint8*)ID_ALIAS$1, -2147483648u, (struct $8FBSYMBOL*)0u, TMP$94$1, 0 );
	L$1 = vr$20;
