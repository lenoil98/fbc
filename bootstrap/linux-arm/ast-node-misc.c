	...
	*(int32*)((uint8*)N$1 + 24) = DOFLUSH$1;
	if( *(int32*)SYM$1 != 7 ) goto label$13;
	{
		if( *(int32*)((uint8*)SYM$1 + 60) != 0 ) goto label$15;
		{
			...
			*(struct $8FBSYMBOL**)((uint8*)SYM$1 + 56) = *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 108);
		}
		label$15:;
		label$14:;
	}
...
struct $6IRVREG* ASTLOADLABEL( struct $7ASTNODE* N$1 )
{
	...
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$19;
	{
		...
		label$21:;
		{
			(*(tmp$41*)((uint8*)&IR$ + 68))( *(struct $8FBSYMBOL**)((uint8*)N$1 + 12) );
		}
		label$20:;
	}
	label$19:;
...
struct $6IRVREG* ASTLOADLIT( struct $7ASTNODE* N$1 )
{
	...
	{
		(*(tmp$49*)((uint8*)&IR$ + 92))( *(uint8**)((uint8*)N$1 + 24) );
	}
	label$27:;
	label$26:;
...
struct $6IRVREG* ASTLOADASM( struct $7ASTNODE* N$1 )
{
	...
	{
		(*(tmp$48*)((uint8*)&IR$ + 88))( *(struct $9ASTASMTOK**)((uint8*)N$1 + 24) );
	}
	label$43:;
	label$42:;
	...
	if( NODE$1 == (struct $9ASTASMTOK*)0u ) goto label$45;
	{
		...
		NXT$2 = *(struct $9ASTASMTOK**)((uint8*)NODE$1 + 8);
		{
			...
			TMP$114$3 = *($14AST_ASMTOKTYPE*)NODE$1;
			if( TMP$114$3 != 0 ) goto label$47;
			label$48:;
			{
...
struct $6IRVREG* ASTLOADDBG( struct $7ASTNODE* N$1 )
{
	...
	{
		(*(tmp$60*)((uint8*)&IR$ + 172))( *(int32*)((uint8*)N$1 + 32), *(struct $8FBSYMBOL**)((uint8*)*(struct $7ASTNODE**)((uint8*)&AST$ + 40) + 12), *(int32*)((uint8*)N$1 + 24), *(uint8**)((uint8*)N$1 + 28) );
	}
	label$58:;
	label$57:;
	fb$result$1 = (struct $6IRVREG*)0u;
...
struct $6IRVREG* ASTLOADLINK( struct $7ASTNODE* N$1 )
{
	...
	{
		int32 TMP$115$2;
		TMP$115$2 = *(int32*)((uint8*)N$1 + 24);
		if( TMP$115$2 != 1 ) goto label$99;
		label$100:;
		{
			fb$result$1 = VRL$1;
		}
...
struct $6IRVREG* ASTLOADLOAD( struct $7ASTNODE* N$1 )
{
	...
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$111;
	{
		...
		{
			struct $6IRVREG* vr$6 = (*(tmp$69*)((uint8*)&IR$ + 228))( *(int32*)((uint8*)V1$1 + 4), *(struct $8FBSYMBOL**)((uint8*)V1$1 + 8) );
			VR$1 = vr$6;
			(*(tmp$44*)((uint8*)&IR$ + 116))( V1$1, VR$1 );
		}
		goto label$112;
		label$113:;
		{
			(*(tmp$52*)((uint8*)&IR$ + 112))( V1$1 );
		}
		label$112:;
	}
	label$111:;
...
void ASTFORGETBITFIELDS( struct $7ASTNODE* N$1 )
{
	...
	TMP$116$1 = -(*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 12) + 116) > 0);
	goto label$129;
	label$126:;
	TMP$116$1 = 0;
	label$129:;
	if( TMP$116$1 == 0 ) goto label$128;
	{
		*(int32*)((uint8*)&AST$ + 144) = *(int32*)((uint8*)&AST$ + 144) + -1;
	}
	label$128:;
...
struct $7ASTNODE* ASTUPDATEBITFIELDS( struct $7ASTNODE* N$1 )
{
	...
	label$161:;
	{
		...
		TMP$118$2 = *($13AST_NODECLASS*)N$1;
		if( TMP$118$2 != 2 ) goto label$164;
		label$165:;
		{
		...
		goto label$163;
		label$164:;
		if( TMP$118$2 != 19 ) goto label$170;
		label$171:;
		{
...
struct $6IRVREG* ASTLOADSTACK( struct $7ASTNODE* N$1 )
{
	...
	{
		(*(tmp$53*)((uint8*)&IR$ + 120))( *(int32*)((uint8*)N$1 + 24), VR$1 );
	}
	label$187:;
	label$186:;
	ASTDELNODE( L$1 );
...
FBSTRING* ASTDUMPOPTOSTR( $6AST_OP OP$1 )
{
	...
	if( (-(OP$1 > 120) | -(OP$1 < 0)) == 0 ) goto label$201;
	{
		...
		__builtin_memset( &TMP$281$2, 0, 12 );
		FBSTRING* vr$7 = fb_StrConcat( &TMP$281$2, (void*)"OP:", 4, (void*)vr$4, -1 );
		fb_StrInit( (void*)&fb$result$1, -1, (void*)vr$7, -1, 0 );
		goto label$199;
	}
	label$201:;
	label$200:;
	fb_StrInit( (void*)&fb$result$1, -1, *(void**)((uint8*)DBG_ASTNODEOPNAMES$ + (OP$1 << (2 & 31))), 0, 0 );
	goto label$199;
	label$199:;
...
static struct $7ASTNODE* ASTSETBITFIELD( struct $8FBSYMBOL* BITFIELD$1, struct $7ASTNODE* L$1, struct $7ASTNODE* R$1 )
{
	...
	if( (*(int32*)((uint8*)BITFIELD$1 + 28) & 511) != 1 ) goto label$143;
	{
		...
		TMP$117$2 = -(*(int32*)((uint8*)R$1 + 4) != 1);
		goto label$267;
		label$144:;
		TMP$117$2 = -1;
		label$267:;
		if( TMP$117$2 == 0 ) goto label$146;
		{
...
static FBSTRING* HASTNODECLASSTOSTR( $13AST_NODECLASS C$1 )
{
	...
	if( (-(C$1 > 44) | -(C$1 < 0)) == 0 ) goto label$205;
	{
		...
		__builtin_memset( &TMP$283$2, 0, 12 );
		FBSTRING* vr$7 = fb_StrConcat( &TMP$283$2, (void*)"CLASS:", 7, (void*)vr$4, -1 );
		fb_StrInit( (void*)&fb$result$1, -1, (void*)vr$7, -1, 0 );
		goto label$203;
	}
	label$205:;
	label$204:;
	fb_StrInit( (void*)&fb$result$1, -1, *(void**)((uint8*)DBG_ASTNODECLASSNAMES$ + (C$1 << (2 & 31))), 0, 0 );
	goto label$203;
	label$203:;
	FBSTRING* vr$12 = fb_StrAllocTempResult( (FBSTRING*)&fb$result$1 );
	return vr$12;
...
static FBSTRING* HASTNODETOSTR( struct $7ASTNODE* N$1 )
{
	...
	label$217:;
	{
		...
		label$221:;
		{
			...
			FBSTRING* vr$8 = fb_StrConcat( &TMP$286$3, (void*)vr$5, -1, (void*)" =-= ", 6 );
			__builtin_memset( &TMP$287$3, 0, 12 );
			FBSTRING* vr$11 = fb_StrConcat( &TMP$287$3, (void*)vr$8, -1, (void*)vr$3, -1 );
		...
		label$223:;
		{
			...
			goto label$268;
			label$224:;
			TMP$288$3 = *(int32*)((uint8*)N$1 + 4) & 31;
			label$268:;
			if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$288$3 * 28)) != 1 ) goto label$226;
			{
				FBSTRING TMP$291$4;
				FBSTRING TMP$292$4;
				FBSTRING TMP$293$4;
				...
				FBSTRING* vr$24 = fb_StrConcat( &TMP$291$4, (void*)" (", 3, (void*)vr$21, -1 );
				__builtin_memset( &TMP$292$4, 0, 12 );
				FBSTRING* vr$27 = fb_StrConcat( &TMP$292$4, (void*)vr$24, -1, (void*)")", 2 );
				FBSTRING* vr$29 = fb_DoubleToStr( *(double*)((uint8*)N$1 + 24) );
				__builtin_memset( &TMP$293$4, 0, 12 );
				FBSTRING* vr$32 = fb_StrConcat( &TMP$293$4, (void*)vr$29, -1, (void*)vr$27, -1 );
			...
			FBSTRING* vr$37 = fb_StrConcat( &TMP$294$3, (void*)" (", 3, (void*)vr$34, -1 );
			__builtin_memset( &TMP$295$3, 0, 12 );
			FBSTRING* vr$40 = fb_StrConcat( &TMP$295$3, (void*)vr$37, -1, (void*)")", 2 );
			FBSTRING* vr$42 = fb_LongintToStr( *(int64*)((uint8*)N$1 + 24) );
			__builtin_memset( &TMP$296$3, 0, 12 );
			FBSTRING* vr$45 = fb_StrConcat( &TMP$296$3, (void*)vr$42, -1, (void*)vr$40, -1 );
		...
		label$227:;
		{
			...
			FBSTRING* vr$50 = fb_StrConcat( &TMP$303$3, (void*)" (", 3, (void*)vr$47, -1 );
			__builtin_memset( &TMP$304$3, 0, 12 );
			FBSTRING* vr$53 = fb_StrConcat( &TMP$304$3, (void*)vr$50, -1, (void*)")", 2 );
			if( *(struct $8FBSYMBOL**)((uint8*)N$1 + 12) == (struct $8FBSYMBOL*)0u ) goto label$228;
			TMP$299$3 = *(uint8**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 12) + 16);
			goto label$269;
			label$228:;
			TMP$299$3 = (uint8*)"<NULL>";
			label$269:;
			__builtin_memset( &TMP$301$3, 0, 12 );
			FBSTRING* vr$59 = fb_StrConcat( &TMP$301$3, (void*)"VAR( ", 6, (void*)TMP$299$3, 0 );
			__builtin_memset( &TMP$302$3, 0, 12 );
			FBSTRING* vr$62 = fb_StrConcat( &TMP$302$3, (void*)vr$59, -1, (void*)" )", 3 );
			__builtin_memset( &TMP$305$3, 0, 12 );
			FBSTRING* vr$65 = fb_StrConcat( &TMP$305$3, (void*)vr$62, -1, (void*)vr$53, -1 );
		...
		label$229:;
		{
			...
			__builtin_memset( &TMP$309$3, 0, 12 );
			FBSTRING* vr$70 = fb_StrConcat( &TMP$309$3, (void*)" (", 3, (void*)vr$67, -1 );
			__builtin_memset( &TMP$310$3, 0, 12 );
			FBSTRING* vr$73 = fb_StrConcat( &TMP$310$3, (void*)vr$70, -1, (void*)")", 2 );
			__builtin_memset( &TMP$307$3, 0, 12 );
			FBSTRING* vr$78 = fb_StrConcat( &TMP$307$3, (void*)"FIELD( ", 8, *(void**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 12) + 16), 0 );
			__builtin_memset( &TMP$308$3, 0, 12 );
			FBSTRING* vr$81 = fb_StrConcat( &TMP$308$3, (void*)vr$78, -1, (void*)" )", 3 );
			__builtin_memset( &TMP$311$3, 0, 12 );
			FBSTRING* vr$84 = fb_StrConcat( &TMP$311$3, (void*)vr$81, -1, (void*)vr$73, -1 );
		...
		label$230:;
		{
			...
			if( *(struct $8FBSYMBOL**)((uint8*)N$1 + 12) == (struct $8FBSYMBOL*)0u ) goto label$232;
			{
				...
				FBSTRING* vr$91 = fb_StrConcat( &TMP$313$4, (void*)"DECL( ", 7, *(void**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 12) + 16), 0 );
				__builtin_memset( &TMP$314$4, 0, 12 );
				FBSTRING* vr$94 = fb_StrConcat( &TMP$314$4, (void*)vr$91, -1, (void*)" )", 3 );
			...
			FBSTRING* vr$99 = fb_StrConcat( &TMP$315$3, (void*)" (", 3, (void*)vr$96, -1 );
			__builtin_memset( &TMP$316$3, 0, 12 );
			FBSTRING* vr$102 = fb_StrConcat( &TMP$316$3, (void*)vr$99, -1, (void*)")", 2 );
			__builtin_memset( &TMP$317$3, 0, 12 );
			FBSTRING* vr$105 = fb_StrConcat( &TMP$317$3, (void*)"DECL", 5, (void*)vr$102, -1 );
		...
		label$233:;
		{
			...
			FBSTRING* vr$111 = fb_StrConcat( &TMP$319$3, (void*)"CALL( ", 7, *(void**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 12) + 16), 0 );
			__builtin_memset( &TMP$320$3, 0, 12 );
			FBSTRING* vr$114 = fb_StrConcat( &TMP$320$3, (void*)vr$111, -1, (void*)" )", 3 );
		...
		label$234:;
		{
			...
			FBSTRING* vr$120 = fb_StrConcat( &TMP$322$3, (void*)"LABEL: ", 8, (void*)vr$117, -1 );
		...
		label$235:;
		{
			...
			FBSTRING* vr$128 = fb_StrConcat( &TMP$325$3, (void*)"BRANCH: ", 9, (void*)vr$125, -1 );
			__builtin_memset( &TMP$326$3, 0, 12 );
			FBSTRING* vr$131 = fb_StrConcat( &TMP$326$3, (void*)vr$128, -1, (void*)" ", 2 );
			__builtin_memset( &TMP$327$3, 0, 12 );
			FBSTRING* vr$134 = fb_StrConcat( &TMP$327$3, (void*)vr$131, -1, (void*)vr$123, -1 );
		...
		label$236:;
		{
			...
			FBSTRING* vr$140 = fb_StrConcat( &TMP$329$3, (void*)"SCOPEBEGIN: ", 13, (void*)vr$137, -1 );
		...
		label$237:;
		{
			FBSTRING TMP$331$3;
			FBSTRING TMP$332$3;
			FBSTRING* vr$143 = fb_LongintToStr( *(int64*)((uint8*)N$1 + 24) );
			__builtin_memset( &TMP$331$3, 0, 12 );
			FBSTRING* vr$146 = fb_StrConcat( &TMP$331$3, (void*)"TYPEINI_ASSIGN( offset=", 24, (void*)vr$143, -1 );
			__builtin_memset( &TMP$332$3, 0, 12 );
			FBSTRING* vr$149 = fb_StrConcat( &TMP$332$3, (void*)vr$146, -1, (void*)" )", 3 );
			fb_StrInit( (void*)&fb$result$1, -1, (void*)vr$149, -1, 0 );
			goto label$218;
		}
		goto label$219;
		label$238:;
		{
			...
			FBSTRING* vr$154 = fb_StrConcat( &TMP$336$3, (void*)" (", 3, (void*)vr$151, -1 );
			__builtin_memset( &TMP$337$3, 0, 12 );
			FBSTRING* vr$157 = fb_StrConcat( &TMP$337$3, (void*)vr$154, -1, (void*)")", 2 );
			FBSTRING* vr$159 = ASTDUMPOPTOSTR( *($6AST_OP*)((uint8*)N$1 + 24) );
			__builtin_memset( &TMP$334$3, 0, 12 );
			FBSTRING* vr$162 = fb_StrConcat( &TMP$334$3, (void*)"MACRO: ", 8, (void*)vr$159, -1 );
			__builtin_memset( &TMP$335$3, 0, 12 );
			FBSTRING* vr$165 = fb_StrConcat( &TMP$335$3, (void*)vr$162, -1, (void*)" ", 2 );
			__builtin_memset( &TMP$338$3, 0, 12 );
			FBSTRING* vr$168 = fb_StrConcat( &TMP$338$3, (void*)vr$165, -1, (void*)vr$157, -1 );
			fb_StrInit( (void*)&fb$result$1, -1, (void*)vr$168, -1, 0 );
			goto label$218;
		}
		goto label$219;
		label$239:;
		{
			...
			{
				int32 TMP$339$4;
				TMP$339$4 = *(int32*)((uint8*)N$1 + 24);
				if( TMP$339$4 != 1 ) goto label$241;
				label$242:;
				{
			...
			__builtin_memset( &TMP$343$3, 0, 12 );
			FBSTRING* vr$178 = fb_StrConcat( &TMP$343$3, (void*)" (", 3, (void*)vr$175, -1 );
			__builtin_memset( &TMP$344$3, 0, 12 );
			FBSTRING* vr$181 = fb_StrConcat( &TMP$344$3, (void*)vr$178, -1, (void*)")", 2 );
			FBSTRING* vr$183 = HASTNODECLASSTOSTR( *($13AST_NODECLASS*)N$1 );
			__builtin_memset( &TMP$342$3, 0, 12 );
			FBSTRING* vr$186 = fb_StrConcat( &TMP$342$3, (void*)"*", 2, (void*)vr$183, -1 );
			__builtin_memset( &TMP$345$3, 0, 12 );
			FBSTRING* vr$189 = fb_StrConcat( &TMP$345$3, (void*)vr$186, -1, (void*)vr$181, -1 );
			__builtin_memset( &TMP$346$3, 0, 12 );
			FBSTRING* vr$192 = fb_StrConcat( &TMP$346$3, (void*)vr$189, -1, (void*)"-", 2 );
			__builtin_memset( &TMP$347$3, 0, 12 );
			FBSTRING* vr$195 = fb_StrConcat( &TMP$347$3, (void*)vr$192, -1, (void*)&S$3, -1 );
			fb_StrInit( (void*)&fb$result$1, -1, (void*)vr$195, -1, 0 );
		...
		label$245:;
		{
			...
			__builtin_memset( &TMP$348$3, 0, 12 );
			FBSTRING* vr$202 = fb_StrConcat( &TMP$348$3, (void*)" (", 3, (void*)vr$199, -1 );
			__builtin_memset( &TMP$349$3, 0, 12 );
			FBSTRING* vr$205 = fb_StrConcat( &TMP$349$3, (void*)vr$202, -1, (void*)")", 2 );
			FBSTRING* vr$207 = HASTNODECLASSTOSTR( *($13AST_NODECLASS*)N$1 );
			__builtin_memset( &TMP$350$3, 0, 12 );
			FBSTRING* vr$210 = fb_StrConcat( &TMP$350$3, (void*)vr$207, -1, (void*)vr$205, -1 );
			fb_StrInit( (void*)&fb$result$1, -1, (void*)vr$210, -1, 0 );
			goto label$218;
		}
		goto label$219;
		label$220:;
		static const void* tmp$357[42] = {
			&&label$221,
			&&label$222,
			&&label$245,
			&&label$245,
		...
		if( (TMP$284$2 - 3u) > 41u ) goto label$245;
		goto *tmp$357[TMP$284$2 - 3u];
		label$219:;
	}
	label$218:;
...
static void ASTDUMPTREEEX( struct $7ASTNODE* N$1, int32 COL$1, int32 JUST$1, int32 DEPTH$1 )
{
	...
	if( *(struct $7ASTNODE**)((uint8*)N$1 + 64) == (struct $7ASTNODE*)0u ) goto label$253;
	{
		if( *(struct $7ASTNODE**)((uint8*)N$1 + 68) == (struct $7ASTNODE*)0u ) goto label$255;
		{
			...
			fb_StrAssign( (void*)&TMP$352$3, -1, (void*)"/ \x5C", 4, 0 );
			DBG_ASTOUTPUT( &TMP$352$3, COL$1 + -2, 0, -1 );
		...
		label$255:;
		{
			...
			fb_StrAssign( (void*)&TMP$353$3, -1, (void*)"/", 2, 0 );
			DBG_ASTOUTPUT( &TMP$353$3, COL$1 + -2, 0, -1 );
	...
	if( *(struct $7ASTNODE**)((uint8*)N$1 + 68) == (struct $7ASTNODE*)0u ) goto label$256;
	{
		...
		fb_StrAssign( (void*)&TMP$355$2, -1, (void*)"  \x5C", 4, 0 );
		DBG_ASTOUTPUT( &TMP$355$2, COL$1 + -2, 0, -1 );
	...
	{
		FBSTRING TMP$356$2;
		__builtin_memset( &TMP$356$2, 0, 12 );
		fb_StrAssign( (void*)&TMP$356$2, -1, (void*)"", 1, 0 );
		DBG_ASTOUTPUT( &TMP$356$2, 0, 0, -1 );
