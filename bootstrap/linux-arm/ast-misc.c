...
void ASTMISCINIT( void )
{
	...
	LISTINIT( (struct $5TLIST*)((uint8*)&AST$ + 148), 64, 12, 6 );
	{
		...
		*(int32**)TMP$84$2 = (int32*)0u;
		*(int32*)((uint8*)TMP$84$2 + 4) = 0;
		*(int32*)((uint8*)TMP$84$2 + 8) = 0;
	}
...
void ASTMISCEND( void )
{
	label$12:;
	{
		...
		TMP$85$2 = (struct $23AST_DTORLIST_SCOPESTACK*)((uint8*)&AST$ + 180);
		free( *(void**)TMP$85$2 );
	}
...
int32 ASTISTREEEQUAL( struct $7ASTNODE* L$1, struct $7ASTNODE* R$1 )
{
	...
	label$24:;
	{
		...
		{
			{
				...
				goto label$83;
				label$37:;
				TMP$87$4 = *(int32*)((uint8*)L$1 + 4) & 31;
				label$83:;
				TMP$88$4 = *($12FB_DATACLASS*)((uint8*)SYMB_DTYPETB$ + (TMP$87$4 * 28));
				if( TMP$88$4 != 1 ) goto label$39;
				label$40:;
				{
		...
		if( (TMP$86$2 - 1u) > 22u ) goto label$26;
		goto *tmp$89[TMP$86$2 - 1u];
		label$26:;
	}
...
int32 ASTISEQUALPARAMINIT( struct $7ASTNODE* L$1, struct $7ASTNODE* R$1 )
{
	...
	if( *(struct $8FBSYMBOL**)((uint8*)L$1 + 8) == *(struct $8FBSYMBOL**)((uint8*)R$1 + 8) ) goto label$95;
	{
		if( (*(int32*)((uint8*)L$1 + 4) & 31) != 22 ) goto label$97;
		{
			int32 TMP$90$3;
			TMP$90$3 = 0;
			$22FB_OVLPROC_MATCH_SCORE vr$15 = SYMBCALCPROCMATCH( *(struct $8FBSYMBOL**)((uint8*)L$1 + 8), *(struct $8FBSYMBOL**)((uint8*)R$1 + 8), &TMP$90$3 );
	...
	label$94:;
	{
		...
		label$121:;
		{
			...
			goto label$167;
			label$122:;
			TMP$92$3 = *(int32*)((uint8*)L$1 + 4) & 31;
			label$167:;
			if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$92$3 * 28)) != 1 ) goto label$124;
			{
		...
		if( (TMP$91$2 - 3u) > 20u ) goto label$100;
		goto *tmp$93[TMP$91$2 - 3u];
		label$100:;
	}
...
int32 ASTISSYMBOLONTREE( struct $8FBSYMBOL* SYM$1, struct $7ASTNODE* N$1 )
{
	...
	label$180:;
	{
		...
		if( (TMP$94$2 - 6u) > 17u ) goto label$182;
		goto *tmp$95[TMP$94$2 - 6u];
		label$182:;
	}
...
void ASTREPLACESYMBOLONTREE( struct $7ASTNODE* N$1, struct $8FBSYMBOL* OLD_SYM$1, struct $8FBSYMBOL* NEW_SYM$1 )
{
	...
	label$204:;
	{
		...
		if( (TMP$96$2 - 3u) > 23u ) goto label$206;
		goto *tmp$97[TMP$96$2 - 3u];
		label$206:;
	}
...
void ASTCHECKCONST( int32 DTYPE$1, struct $7ASTNODE* N$1 )
{
	...
	RESULT$1 = -1;
	{
		...
		{
			{
				...
				label$267:;
				TMP$101$4 = *(uint32*)(((uint8*)SYMB_DTYPETB$ + (TMP$100$4 * 28)) + 20);
				goto label$257;
				label$258:;
				{
				...
				label$261:;
				{
					...
					goto label$268;
					label$262:;
					TMP$102$5 = *(int32*)((uint8*)N$1 + 4) & 31;
					label$268:;
					if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$102$5 * 28)) != 1 ) goto label$264;
					{
				...
				if( (TMP$101$4 - 1u) > 7u ) goto label$256;
				goto *tmp$103[TMP$101$4 - 1u];
				label$256:;
			}
		}
		goto label$243;
		label$244:;
		static const void* tmp$104[15] = {
			&&label$253,
			&&label$254,
			&&label$254,
			&&label$254,
		...
		if( (TMP$98$2 - 1u) > 14u ) goto label$254;
...
int32 ASTPTRCHECK( int32 PDTYPE$1, struct $8FBSYMBOL* PSUBTYPE$1, int32 PPARAMMODE$1, struct $7ASTNODE* EXPR$1 )
{
	...
	if( (EDTYPE$1 & 480) != 0 ) goto label$272;
	{
		if( *(int32*)EXPR$1 != 16 ) goto label$274;
		{
			...
			goto label$283;
			label$275:;
			TMP$105$3 = EDTYPE$1 & 31;
			label$283:;
			if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$105$3 * 28)) != 0 ) goto label$277;
			{
...
struct $7ASTNODE* ASTUPDSTRCONCAT( struct $7ASTNODE* N$1 )
{
	...
	{
		uint32 TMP$106$2;
		TMP$106$2 = (uint32)(*(int32*)((uint8*)N$1 + 4) & 511);
		goto label$289;
		label$290:;
		{
		}
		...
		if( (TMP$106$2 - 7u) > 11u ) goto label$291;
		goto *tmp$107[TMP$106$2 - 7u];
		label$288:;
	}
...
struct $7ASTNODE* ASTBUILDBRANCH( struct $7ASTNODE* EXPR$1, struct $8FBSYMBOL* LABEL$1, int32 IS_INVERSE$1, int32 IS_IIF$1 )
{
	...
	goto label$374;
	label$306:;
	TMP$108$1 = DTYPE$1 & 31;
	label$374:;
	if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$108$1 * 28)) != 2 ) goto label$308;
	{
		fb$result$1 = (struct $7ASTNODE*)0u;
		goto label$303;
	}
	...
	label$307:;
	{
			...
			if( OVLPROC$3 != (struct $8FBSYMBOL*)0u ) goto label$316;
			{
				...
				if( OVLPROC$3 != (struct $8FBSYMBOL*)0u ) goto label$318;
				{
					...
					if( OVLPROC$3 != (struct $8FBSYMBOL*)0u ) goto label$320;
					{
						...
						FBSTRING TMP$113$6;
						FBSTRING TMP$114$6;
						__builtin_memset( &TMP$114$6, 0, 12 );
						__builtin_memset( &TMP$112$6, 0, 12 );
						FBSTRING* vr$19 = fb_StrConcat( &TMP$112$6, (void*)" \x22", 3, *(void**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)EXPR$1 + 8) + 16), 0 );
						__builtin_memset( &TMP$113$6, 0, 12 );
						FBSTRING* vr$22 = fb_StrConcat( &TMP$113$6, (void*)vr$19, -1, (void*)".cast()\x22", 9 );
						fb_StrAssign( (void*)&TMP$114$6, -1, (void*)vr$22, -1, 0 );
						ERRREPORT( 99, -1, (uint8*)*(uint8**)&TMP$114$6 );
		...
		if( (TMP$109$2 - 4u) > 16u ) goto label$309;
		goto *tmp$123[TMP$109$2 - 4u];
		label$309:;
	}
	...
	if( CALL_DTORS$1 != 0 ) goto label$322;
	{
		...
		if( *(int32*)N$1 != 15 ) goto label$324;
		{
			...
			{
				int32 TMP$115$4;
				TMP$115$4 = *(int32*)((uint8*)N$1 + 24);
				if( TMP$115$4 != 1 ) goto label$326;
				label$327:;
				{
		...
		label$324:;
		{
			...
			if( TMP$116$3 != 16 ) goto label$332;
			label$333:;
			{
			...
			goto label$331;
			label$332:;
			if( TMP$116$3 != 3 ) goto label$336;
			label$337:;
			{
				{
					uint32 TMP$117$5;
					TMP$117$5 = *(uint32*)((uint8*)N$1 + 24);
					goto label$339;
					label$340:;
					{
					...
					label$343:;
					{
						...
						goto label$375;
						label$344:;
						TMP$118$6 = DTYPE$1 & 31;
						label$375:;
						if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$118$6 * 28)) != 0 ) goto label$346;
						{
							DOOPT$6 = -((*(int32*)((uint8*)&IR$ + 276) & 256) != 0);
							if( DOOPT$6 == 0 ) goto label$348;
							{
								{
									uint32 TMP$119$9;
									TMP$119$9 = (uint32)DTYPE$1;
									goto label$350;
									label$351:;
									{
										DOOPT$6 = -((*(int32*)((uint8*)&IR$ + 276) & 1024) != 0);
									}
									goto label$349;
									label$350:;
									static const void* tmp$124[2] = {
										&&label$351,
										&&label$351,
									};
									if( (TMP$119$9 - 13u) > 1u ) goto label$349;
									goto *tmp$124[TMP$119$9 - 13u];
									label$349:;
								}
							}
							label$348:;
						...
						label$346:;
						{
							DOOPT$6 = -((*(int32*)((uint8*)&IR$ + 276) & 4) != 0);
						}
						label$345:;
					...
					if( (TMP$117$5 - 28u) > 22u ) goto label$355;
					goto *tmp$125[TMP$117$5 - 28u];
					label$338:;
				}
			}
			goto label$331;
		...
		if( N$1 == (struct $7ASTNODE*)0u ) goto label$358;
		{
			if( PARENTLINK$1 == (struct $7ASTNODE*)0u ) goto label$360;
			{
				{
					int32 TMP$121$5;
					TMP$121$5 = *(int32*)((uint8*)PARENTLINK$1 + 24);
					if( TMP$121$5 != 1 ) goto label$362;
					label$363:;
					{
	...
	label$321:;
	{
		...
		label$369:;
		{
			DTYPE$1 = (DTYPE$1 & -512) | (*(int32*)(((uint8*)SYMB_DTYPETB$ + (DTYPE$1 * 28)) + 16) & 511);
		}
		label$368:;
		label$367:;
	}
	...
	TMP$122$1 = 45;
	label$377:;
	struct $7ASTNODE* vr$72 = ASTNEWBOP( TMP$122$1, EXPR$1, vr$71, LABEL$1, 0 );
	...
	*(struct $8FBSYMBOL**)N$1 = SYM$1;
	{
		...
		if( *(int32*)((uint8*)TMP$127$2 + 4) <= 0 ) goto label$392;
		{
			*(int32*)((uint8*)N$1 + 4) = *(int32*)((uint8*)((uint8*)*(int32**)TMP$127$2 + (*(int32*)((uint8*)TMP$127$2 + 4) << (2 & 31))) + -4);
		}
		goto label$391;
		label$392:;
		{
...
void ASTDTORLISTDEL( struct $8FBSYMBOL* SYM$1 )
{
	...
	N$1 = (struct $17AST_DTORLIST_ITEM*)vr$2;
	label$423:;
	if( N$1 == (struct $17AST_DTORLIST_ITEM*)0u ) goto label$424;
	{
...
void ASTDTORLISTSCOPEBEGIN( int32 COOKIE$1 )
{
	...
	label$429:;
	{
		...
		if( *(int32*)((uint8*)TMP$128$2 + 4) != *(int32*)((uint8*)TMP$128$2 + 8) ) goto label$432;
		{
			*(int32*)((uint8*)TMP$128$2 + 8) = *(int32*)((uint8*)TMP$128$2 + 8) + 8;
			void* vr$10 = XREALLOCATE( *(void**)TMP$128$2, *(int32*)((uint8*)TMP$128$2 + 8) << (2 & 31) );
			*(int32**)TMP$128$2 = (int32*)vr$10;
		}
		label$432:;
		label$431:;
		*(int32*)((uint8*)*(int32**)TMP$128$2 + (*(int32*)((uint8*)TMP$128$2 + 4) << (2 & 31))) = COOKIE$1;
...
int32 ASTDTORLISTSCOPEEND( void )
{
	...
	label$433:;
	{
		...
		TMP$129$2 = (struct $23AST_DTORLIST_SCOPESTACK*)((uint8*)&AST$ + 180);
		fb$result$1 = *(int32*)((uint8*)((uint8*)*(int32**)TMP$129$2 + (*(int32*)((uint8*)TMP$129$2 + 4) << (2 & 31))) + -4);
		*(int32*)((uint8*)TMP$129$2 + 4) = *(int32*)((uint8*)TMP$129$2 + 4) + -1;
	}
	label$434:;
	return fb$result$1;
}
...
void ASTDTORLISTUNSCOPE( int32 COOKIE$1 )
{
	...
	label$437:;
	if( I$1 == (struct $17AST_DTORLIST_ITEM*)0u ) goto label$438;
	{
		if( *(int32*)((uint8*)I$1 + 4) != COOKIE$1 ) goto label$440;
		{
			*(int32*)((uint8*)I$1 + 4) = 0;
		}
		label$440:;
	...
	*(struct $8FBSYMBOL**)((uint8*)N$1 + 8) = SUBTYPE$1;
	{
		...
		if( TMP$130$2 != 15 ) goto label$444;
		label$445:;
		{
			{
				int32 TMP$131$4;
				TMP$131$4 = *(int32*)((uint8*)N$1 + 24);
				if( TMP$131$4 != 1 ) goto label$447;
				label$448:;
				{
		...
		goto label$443;
		label$444:;
		if( TMP$130$2 != 19 ) goto label$451;
		label$452:;
		{
			ASTSETTYPE( *(struct $7ASTNODE**)((uint8*)N$1 + 64), DTYPE$1, SUBTYPE$1 );
		}
		goto label$443;
		label$451:;
		if( TMP$130$2 != 10 ) goto label$453;
		label$454:;
		{
			ASTSETTYPE( *(struct $7ASTNODE**)((uint8*)N$1 + 68), DTYPE$1, SUBTYPE$1 );
		}
		goto label$443;
		label$453:;
		if( TMP$130$2 != 26 ) goto label$455;
		label$456:;
		{
			ASTSETTYPE( *(struct $7ASTNODE**)((uint8*)N$1 + 64), DTYPE$1, SUBTYPE$1 );
		}
...
int64 ASTSIZEOF( struct $7ASTNODE* N$1, int32* IS_FIXLENSTR$1 )
{
	...
	*IS_FIXLENSTR$1 = 0;
	...
	{
		int32 TMP$132$2;
		TMP$132$2 = *(int32*)((uint8*)N$1 + 4) & 511;
		if( TMP$132$2 == 4 ) goto label$461;
		label$462:;
		if( TMP$132$2 == 7 ) goto label$461;
		label$463:;
		if( TMP$132$2 != 18 ) goto label$460;
		label$461:;
		{
			if( *(struct $8FBSYMBOL**)((uint8*)N$1 + 12) == (struct $8FBSYMBOL*)0u ) goto label$465;
			{
				*IS_FIXLENSTR$1 = -1;
...
int32 ASTISACCESSTOLOCAL( struct $7ASTNODE* EXPR$1 )
{
	...
	fb$result$1 = 0;
	{
		...
		if( TMP$133$2 != 17 ) goto label$471;
		label$472:;
		{
		...
		goto label$470;
		label$471:;
		if( TMP$133$2 != 18 ) goto label$473;
		label$474:;
		{
			if( (*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)EXPR$1 + 12) + 4) & 16384) != 0 ) goto label$476;
			{
		...
		goto label$470;
		label$477:;
		if( TMP$133$2 != 19 ) goto label$479;
		label$480:;
		{
			if( *(int32*)*(struct $7ASTNODE**)((uint8*)EXPR$1 + 64) != 20 ) goto label$482;
			{
				if( *(struct $7ASTNODE**)((uint8*)*(struct $7ASTNODE**)((uint8*)EXPR$1 + 64) + 64) == (struct $7ASTNODE*)0u ) goto label$484;
				{
					int32 TMP$134$5;
					if( *(int32*)*(struct $7ASTNODE**)((uint8*)*(struct $7ASTNODE**)((uint8*)EXPR$1 + 64) + 64) != 3 ) goto label$485;
					TMP$134$5 = -(*(int32*)((uint8*)*(struct $7ASTNODE**)((uint8*)*(struct $7ASTNODE**)((uint8*)EXPR$1 + 64) + 64) + 24) == 28);
					goto label$490;
					label$485:;
					TMP$134$5 = 0;
					label$490:;
					if( TMP$134$5 == 0 ) goto label$487;
					{
						if( *(int32*)*(struct $7ASTNODE**)((uint8*)*(struct $7ASTNODE**)((uint8*)*(struct $7ASTNODE**)((uint8*)EXPR$1 + 64) + 64) + 64) != 6 ) goto label$489;
						{
...
int32 ASTISRELATIONALBOP( struct $7ASTNODE* N$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 4 );
	label$491:;
	if( *(int32*)N$1 != 3 ) goto label$494;
	{
		fb$result$1 = -((*(int32*)(((uint8*)AST_OPTB$ + (*(int32*)((uint8*)N$1 + 24) << (4 & 31))) + 4) & 8) != 0);
	}
	label$494:;
	label$493:;
	label$492:;
...
static int32 HHASDTOR( struct $8FBSYMBOL* SYM$1 )
{
	...
	{
		int32 TMP$126$2;
		TMP$126$2 = *(int32*)((uint8*)SYM$1 + 28) & 511;
		if( TMP$126$2 != 17 ) goto label$381;
		label$382:;
		{
			fb$result$1 = -1;
		}
		goto label$380;
		label$381:;
		if( TMP$126$2 != 39 ) goto label$383;
		label$384:;
		{
