...
void CSELCONSTSTMTBEGIN( void )
{
	...
	goto label$45;
	label$20:;
	TMP$94$1 = (*(int32*)((uint8*)EXPR$1 + 4) & 511) & 31;
	label$45:;
	if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$94$1 * 28)) == 0 ) goto label$22;
	{
		ASTDELTREE( EXPR$1 );
	...
	label$22:;
	{
		{
			int32 TMP$95$3;
			TMP$95$3 = *(int32*)((uint8*)EXPR$1 + 4) & 511;
			if( TMP$95$3 == 4 ) goto label$25;
			label$26:;
			if( TMP$95$3 != 7 ) goto label$24;
			label$25:;
			{
	...
	if( DTYPE$1 == 9 ) goto label$32;
	{
		...
		TMP$96$2 = DTYPE$1 & 31;
		label$46:;
		if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$96$2 * 28)) + 4) > *(int32*)((uint8*)SYMB_DTYPETB$ + 256) ) goto label$35;
		{
	...
	label$31:;
	{
		...
		label$38:;
		{
			...
			TMP$97$3 = DTYPE$1 & 31;
			label$47:;
			DTYPE$1 = *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$97$3 * 28)) + 16);
		}
		label$37:;
		label$36:;
	}
