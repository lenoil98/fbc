...
void CNAMESPACESTMTBEGIN( void )
{
	...
	int32 LEVELS$1;
	if( (*(int32*)((uint8*)&ENV$ + 888) & 4) != 0 ) goto label$17;
	{
	...
	PALIAS$1 = (uint8*)0u;
	{
		...
		if( (TMP$93$2 - 256u) > 4u ) goto label$20;
		goto *tmp$95[TMP$93$2 - 256u];
		label$20:;
	}
	LEVELS$1 = 0;
	label$23:;
...
void CUSINGSTMT( void )
{
	label$64:;
	struct $8FBSYMBOL* SYM$1;
	if( (*(int32*)((uint8*)&ENV$ + 888) & 4) != 0 ) goto label$67;
	{
		ERRREPORTNOTALLOWED( 4, 146, (uint8*)0u );
		HSKIPUNTIL( -1, 0, 0, 0 );
		goto label$65;
