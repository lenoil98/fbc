...
struct $7ASTNODE* _Z19ASTBUILDVARDTORCALLP8FBSYMBOLl( struct $8FBSYMBOL* S$1, int32 CHECK_ACCESS$1 )
{
	...
	label$38:;
	{
		{
			int32 TMP$93$3;
			TMP$93$3 = *(int32*)((uint8*)S$1 + 28) & 511;
			if( TMP$93$3 != 17 ) goto label$40;
			label$41:;
			{
			...
			label$42:;
			{
				...
				if( vr$13 == 0 ) goto label$46;
				{
					...
					{
						struct $8FBSYMBOL* vr$15 = SYMBGETCOMPDTOR( *(struct $8FBSYMBOL**)((uint8*)S$1 + 32) );
	...
	if( CNT$1 <= 0 ) goto label$148;
	{
		...
		label$150:;
		{
			DTYPE$1 = (((DTYPE$1 & 31) | ((DTYPE$1 & 480) + -32)) | (((DTYPE$1 & 261632) >> (1 & 31)) & 261632)) | (DTYPE$1 & 32505856);
			{
				...
				label$166:;
				TMP$95$4 = TMP$94$4;
				if( TMP$95$4 == 0 ) goto label$160;
				label$161:;
				if( TMP$95$4 != 23 ) goto label$159;
				label$160:;
				{
...
struct $7ASTNODE* ASTBUILDARRAYDESCINITREE( struct $8FBSYMBOL* DESC$1, struct $8FBSYMBOL* ARRAY$1, struct $7ASTNODE* ARRAY_EXPR$1 )
{
	...
	goto label$187;
	label$175:;
	TMP$96$1 = *(int64*)((uint8*)ARRAY$1 + 72);
	label$187:;
	struct $7ASTNODE* vr$36 = ASTNEWCONSTI( TMP$96$1, 8, (struct $8FBSYMBOL*)0u );
	struct $7ASTNODE* vr$37 = ASTCLONETREE( ARRAY_EXPR$1 );
	struct $7ASTNODE* vr$38 = ASTNEWBOP( 28, vr$37, vr$36, (struct $8FBSYMBOL*)0u, 1 );
	ASTTYPEINIADDASSIGN( TREE$1, vr$38, ELM$1, -2147483648u, (struct $8FBSYMBOL*)0u );
	ELM$1 = *(struct $8FBSYMBOL**)((uint8*)ELM$1 + 176);
	ASTTYPEINIADDASSIGN( TREE$1, ARRAY_EXPR$1, ELM$1, -2147483648u, (struct $8FBSYMBOL*)0u );
	ELM$1 = *(struct $8FBSYMBOL**)((uint8*)ELM$1 + 176);
	...
	TMP$97$1 = vr$43;
	label$188:;
	struct $7ASTNODE* vr$44 = ASTNEWCONSTI( TMP$97$1, 8, (struct $8FBSYMBOL*)0u );
	ASTTYPEINIADDASSIGN( TREE$1, vr$44, ELM$1, -2147483648u, (struct $8FBSYMBOL*)0u );
	ELM$1 = *(struct $8FBSYMBOL**)((uint8*)ELM$1 + 176);
	struct $7ASTNODE* vr$47 = ASTNEWCONSTI( *(int64*)((uint8*)ARRAY$1 + 40), 8, (struct $8FBSYMBOL*)0u );
	ASTTYPEINIADDASSIGN( TREE$1, vr$47, ELM$1, -2147483648u, (struct $8FBSYMBOL*)0u );
	ELM$1 = *(struct $8FBSYMBOL**)((uint8*)ELM$1 + 176);
	...
	ASTTYPEINIADDASSIGN( TREE$1, vr$52, ELM$1, -2147483648u, (struct $8FBSYMBOL*)0u );
	ELM$1 = *(struct $8FBSYMBOL**)((uint8*)ELM$1 + 176);
	FLAGS$1 = FLAGS$1 | (MAX_DIMENSIONS$1 & 15);
	struct $7ASTNODE* vr$57 = ASTNEWCONSTI( (int64)FLAGS$1, 8, (struct $8FBSYMBOL*)0u );
	ASTTYPEINIADDASSIGN( TREE$1, vr$57, ELM$1, -2147483648u, (struct $8FBSYMBOL*)0u );
	ELM$1 = *(struct $8FBSYMBOL**)((uint8*)ELM$1 + 176);
	...
	{
		{
			...
			I$3 = 0;
			int32 TMP$98$3;
			TMP$98$3 = *(int32*)((uint8*)ARRAY$1 + 64) + -1;
			goto label$181;
			label$184:;
			{
				ELM$1 = DIMTB$1;
				...
				ASTTYPEINIADDASSIGN( TREE$1, vr$73, ELM$1, -2147483648u, (struct $8FBSYMBOL*)0u );
				ELM$1 = *(struct $8FBSYMBOL**)((uint8*)ELM$1 + 176);
				struct $7ASTNODE* vr$78 = ASTNEWCONSTI( *(int64*)((uint8*)*(struct $10FBARRAYDIM**)((uint8*)ARRAY$1 + 68) + (I$3 << (4 & 31))), 8, (struct $8FBSYMBOL*)0u );
				ASTTYPEINIADDASSIGN( TREE$1, vr$78, ELM$1, -2147483648u, (struct $8FBSYMBOL*)0u );
				ELM$1 = *(struct $8FBSYMBOL**)((uint8*)ELM$1 + 176);
				...
				ASTTYPEINIADDASSIGN( TREE$1, vr$83, ELM$1, -2147483648u, (struct $8FBSYMBOL*)0u );
...
struct $7ASTNODE* ASTBUILDARRAYBOUND( struct $7ASTNODE* ARRAYEXPR$1, struct $7ASTNODE* DIMEXPR$1, int32 TK$1 )
{
	...
	DIMEXPR$1 = vr$1;
	ERRPOPPARAMLOCATION(  );
	struct $7ASTNODE* vr$3 = HCONSTBOUND( ARRAYEXPR$1, DIMEXPR$1, -(TK$1 == 493) );
	EXPR$1 = vr$3;
	if( EXPR$1 != (struct $7ASTNODE*)0u ) goto label$215;
	{
		struct $7ASTNODE* vr$5 = RTLARRAYBOUND( ARRAYEXPR$1, DIMEXPR$1, -(TK$1 == 493) );
		EXPR$1 = vr$5;
	}
	label$215:;
	label$214:;
...
static struct $7ASTNODE* HCONSTBOUND( struct $7ASTNODE* ARRAYEXPR$1, struct $7ASTNODE* DIMEXPR$1, int32 IS_LBOUND$1 )
{
	...
	fb$result$1 = (struct $7ASTNODE*)0u;
	{
		...
		if( TMP$99$2 == 17 ) goto label$193;
		label$194:;
		if( TMP$99$2 != 19 ) goto label$192;
		label$193:;
		{
		}
		goto label$191;
	...
	label$203:;
	{
		if( DIMENSION$1 != -1 ) goto label$209;
		{
			...
			goto label$220;
			label$210:;
			TMP$100$3 = *(int32*)((uint8*)ARRAY$1 + 64);
			label$220:;
