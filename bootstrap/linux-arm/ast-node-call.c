...
struct $6IRVREG* ASTLOADCALL( struct $7ASTNODE* N$1 )
{
	...
	if( (-(*(int32*)((uint8*)&ENV$ + 104) == 0) & -((*(int32*)((uint8*)&ENV$ + 260) & 32) != 0)) == 0 ) goto label$33;
	{
		ARGBYTES$1 = 0;
		...
		if( ARG$1 == (struct $7ASTNODE*)0u ) goto label$35;
		{
			...
			int64 vr$13 = SYMBCALCARGLEN( *(int32*)((uint8*)L$1 + 4), *(struct $8FBSYMBOL**)((uint8*)L$1 + 8), *(int32*)((uint8*)ARG$1 + 24) );
			ARGBYTES$1 = (int32)((int64)ARGBYTES$1 + vr$13);
			ARG$1 = *(struct $7ASTNODE**)((uint8*)ARG$1 + 68);
		}
		goto label$34;
		label$35:;
		int32 vr$17 = SYMBPROCRETURNSONSTACK( PROC$1 );
		if( vr$17 == 0 ) goto label$37;
		{
			ARGBYTES$1 = ARGBYTES$1 + *(int32*)((uint8*)&ENV$ + 272);
		}
		label$37:;
		label$36:;
		BYTESTOALIGN$1 = (-((TOTALSTACKBYTES$1 + ARGBYTES$1) & 15) + 16) & 15;
		if( BYTESTOALIGN$1 <= 0 ) goto label$39;
		{
			if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$41;
			{
				(*(tmp$45*)((uint8*)&IR$ + 136))( BYTESTOALIGN$1 );
			}
			label$41:;
			label$40:;
	...
	ARG$1 = *(struct $7ASTNODE**)((uint8*)N$1 + 68);
	label$42:;
	if( ARG$1 == (struct $7ASTNODE*)0u ) goto label$43;
	{
		NEXTARG$1 = *(struct $7ASTNODE**)((uint8*)ARG$1 + 68);
		L$1 = *(struct $7ASTNODE**)((uint8*)ARG$1 + 64);
		int64 vr$31 = SYMBCALCARGLEN( *(int32*)((uint8*)L$1 + 4), *(struct $8FBSYMBOL**)((uint8*)L$1 + 8), *(int32*)((uint8*)ARG$1 + 24) );
		ARGBYTES$1 = (int32)vr$31;
		if( *(int32*)((uint8*)PROC$1 + 84) != 3 ) goto label$45;
		{
			BYTESTOPOP$1 = BYTESTOPOP$1 + ARGBYTES$1;
		}
		label$45:;
		label$44:;
		if( *(int32*)L$1 != 5 ) goto label$47;
		{
			ASTUPDATECONVFD2FS( L$1, *(int32*)((uint8*)ARG$1 + 4), 0 );
		}
		label$47:;
		label$46:;
		struct $6IRVREG* vr$37 = ASTLOAD( L$1 );
		V1$1 = vr$37;
		ASTDELNODE( L$1 );
		if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$49;
		{
			(*(tmp$47*)((uint8*)&IR$ + 84))( *(struct $8FBSYMBOL**)((uint8*)ARG$1 + 12), V1$1, *(int64*)((uint8*)ARG$1 + 32), RECLEVEL$1 );
		}
		label$49:;
		label$48:;
	...
	goto label$42;
	label$43:;
	int32 vr$41 = SYMBPROCRETURNSONSTACK( PROC$1 );
	if( vr$41 == 0 ) goto label$51;
	{
		if( (-(*(int32*)((uint8*)PROC$1 + 84) == 3) & -((*(int32*)((uint8*)&ENV$ + 260) & 8) == 0)) == 0 ) goto label$53;
		{
			BYTESTOPOP$1 = BYTESTOPOP$1 + *(int32*)((uint8*)&ENV$ + 272);
		}
		label$53:;
		label$52:;
		if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$55;
		{
			int32 vr$49 = SYMBHASCTOR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 44) );
			if( vr$49 != 0 ) goto label$57;
			{
				struct $7ASTNODE* vr$51 = ASTBUILDTEMPVARCLEAR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 44) );
				ASTLOAD( vr$51 );
			}
			label$57:;
			label$56:;
			struct $7ASTNODE* vr$53 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)N$1 + 44), 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
			L$1 = vr$53;
			struct $7ASTNODE* vr$54 = ASTNEWADDROF( L$1 );
			L$1 = vr$54;
			struct $6IRVREG* vr$55 = ASTLOAD( L$1 );
			V1$1 = vr$55;
			(*(tmp$47*)((uint8*)&IR$ + 84))( (struct $8FBSYMBOL*)0u, V1$1, 0ll, RECLEVEL$1 );
		}
		label$55:;
		label$54:;
		TOTALSTACKBYTES$1 = TOTALSTACKBYTES$1 + *(int32*)((uint8*)&ENV$ + 272);
	}
	label$51:;
	label$50:;
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$59;
	{
		if( (*(int32*)((uint8*)N$1 + 4) & 511) != 0 ) goto label$61;
		{
		...
		label$61:;
		{
			if( ((*(int32*)((uint8*)N$1 + 4) & 32505856) >> (20 & 31)) != 19 ) goto label$63;
			{
			}
			goto label$62;
			label$63:;
			...
			label$62:;
			struct $6IRVREG* vr$64 = (*(tmp$69*)((uint8*)&IR$ + 228))( *(int32*)((uint8*)PROC$1 + 88), *(struct $8FBSYMBOL**)((uint8*)PROC$1 + 92) );
			VR$1 = vr$64;
			if( *(int32*)((uint8*)PROC$1 + 96) == 1 ) goto label$65;
			{
	...
	if( L$1 == (struct $7ASTNODE*)0u ) goto label$67;
	{
		struct $6IRVREG* vr$68 = ASTLOAD( L$1 );
		V1$1 = vr$68;
		ASTDELNODE( L$1 );
		if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$69;
		{
			(*(tmp$55*)((uint8*)&IR$ + 132))( PROC$1, V1$1, VR$1, BYTESTOPOP$1, RECLEVEL$1 );
		}
		label$69:;
		label$68:;
	}
	...
	label$67:;
	{
		if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$71;
		{
			(*(tmp$54*)((uint8*)&IR$ + 128))( PROC$1, BYTESTOPOP$1, VR$1, RECLEVEL$1 );
		}
		label$71:;
		label$70:;
	}
...
void ASTCLONECALL( struct $7ASTNODE* N$1, struct $7ASTNODE* C$1 )
{
	label$74:;
	{
		...
		*(struct $19AST_TMPSTRLIST_ITEM**)((uint8*)C$1 + 40) = (struct $19AST_TMPSTRLIST_ITEM*)0u;
		...
		label$76:;
		if( SN$2 == (struct $19AST_TMPSTRLIST_ITEM*)0u ) goto label$77;
		{
	...
	label$78:;
	if( N$1 == (struct $7ASTNODE*)0u ) goto label$79;
	{
		if( *(struct $7ASTNODE**)((uint8*)N$1 + 68) != (struct $7ASTNODE*)0u ) goto label$81;
		{
			goto label$79;
		}
		label$81:;
...
void ASTDELCALL( struct $7ASTNODE* N$1 )
{
	label$82:;
	{
		...
		label$84:;
		if( S$2 == (struct $19AST_TMPSTRLIST_ITEM*)0u ) goto label$85;
		{
...
{
	label$86:;
	if( *(struct $8FBSYMBOL**)((uint8*)N$1 + 44) != OLD_SYM$1 ) goto label$89;
	{
	...
	label$88:;
	{
		...
		S$2 = *(struct $19AST_TMPSTRLIST_ITEM**)((uint8*)N$1 + 40);
		label$90:;
		if( S$2 == (struct $19AST_TMPSTRLIST_ITEM*)0u ) goto label$91;
		{
			if( *(struct $8FBSYMBOL**)S$2 != OLD_SYM$1 ) goto label$93;
			{
...
struct $7ASTNODE* ASTBUILDBYREFRESULTDEREF( struct $7ASTNODE* EXPR$1 )
{
	...
	int32 DTYPE$1;
	struct $8FBSYMBOL* SUBTYPE$1;
	if( *(int32*)EXPR$1 == 9 ) goto label$103;
	{
		fb$result$1 = EXPR$1;
		goto label$101;
	}
	label$103:;
	label$102:;
	if( (*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)EXPR$1 + 12) + 8) & 2048) != 0 ) goto label$105;
	{
		fb$result$1 = EXPR$1;
		goto label$101;
	}
	...
	if( (DTYPE$1 & 31) != 23 ) goto label$107;
	{
...
int32 ASTISBYREFRESULTDEREF( struct $7ASTNODE* EXPR$1 )
{
	...
	label$108:;
	fb$result$1 = 0;
	if( (struct $7ASTNODE*)-(*(int32*)EXPR$1 == 20) == (struct $7ASTNODE*)0u ) goto label$110;
	TMP$84$1 = -(*(struct $7ASTNODE**)((uint8*)EXPR$1 + 64) != (struct $7ASTNODE*)0u);
	goto label$115;
	label$110:;
	TMP$84$1 = 0;
	label$115:;
	if( TMP$84$1 == 0 ) goto label$112;
	{
		if( *(int32*)*(struct $7ASTNODE**)((uint8*)EXPR$1 + 64) != 9 ) goto label$114;
		{
...
struct $7ASTNODE* ASTIGNORECALLRESULT( struct $7ASTNODE* N$1 )
{
	...
	label$131:;
	label$130:;
	if( *(struct $8FBSYMBOL**)((uint8*)N$1 + 12) == (struct $8FBSYMBOL*)0u ) goto label$133;
	{
		if( (*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 12) + 12) & 64) == 0 ) goto label$135;
		{
	...
	label$132:;
	{
		if( DTYPE$1 == 17 ) goto label$138;
		label$139:;
		if( DTYPE$1 != 7 ) goto label$137;
		label$138:;
		{
			if( DTYPE$1 != 7 ) goto label$141;
			{
...
struct $7ASTNODE* ASTBUILDFAKECALL( struct $8FBSYMBOL* PROC$1 )
{
	...
	label$144:;
	if( PARAM$1 == (struct $8FBSYMBOL*)0u ) goto label$145;
	{
