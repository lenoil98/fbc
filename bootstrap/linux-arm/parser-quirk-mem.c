...
struct $7ASTNODE* COPERATORNEW( void )
{
	...
	label$12:;
	TMP$93$1 = 0ll;
	HSYMBOLTYPE( &DTYPE$1, &SUBTYPE$1, &TMP$93$1, 0, 0 );
	{
		int32 TMP$94$2;
		TMP$94$2 = DTYPE$1 & 511;
		if( TMP$94$2 == 18 ) goto label$20;
		label$21:;
		if( TMP$94$2 == 4 ) goto label$20;
		label$22:;
		if( TMP$94$2 != 7 ) goto label$19;
		label$20:;
		{
