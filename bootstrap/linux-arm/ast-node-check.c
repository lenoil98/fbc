...
struct $6IRVREG* ASTLOADBOUNDCHK( struct $7ASTNODE* N$1 )
{
	...
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$27;
	{
		...
		LABEL$1 = vr$10;
		struct $6IRVREG* vr$11 = (*(tmp$70*)((uint8*)&IR$ + 232))( 8, (struct $8FBSYMBOL*)0u, 0ll );
		(*(tmp$50*)((uint8*)&IR$ + 96))( 45, VR$1, vr$11, (struct $6IRVREG*)0u, LABEL$1 );
		(*(tmp$52*)((uint8*)&IR$ + 140))( VR$1 );
		(*(tmp$41*)((uint8*)&IR$ + 68))( LABEL$1 );
	}
	label$27:;
	label$26:;
...
struct $7ASTNODE* ASTBUILDBOUNDCHK( struct $7ASTNODE* EXPR$1, struct $7ASTNODE* LB$1, struct $7ASTNODE* UB$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 4 );
	label$28:;
	struct $7ASTNODE* vr$3 = ASTNEWBOUNDCHK( EXPR$1, LB$1, UB$1, *(int32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16564), (uint8*)((uint8*)&ENV$ + 280) );
	fb$result$1 = vr$3;
	label$29:;
	return fb$result$1;
}
...
struct $7ASTNODE* ASTBUILDPTRCHK( struct $7ASTNODE* EXPR$1 )
{
	...
	__builtin_memset( &fb$result$1, 0, 4 );
	label$40:;
	struct $7ASTNODE* vr$3 = ASTNEWPTRCHK( EXPR$1, *(int32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16564), (uint8*)((uint8*)&ENV$ + 280) );
	fb$result$1 = vr$3;
	label$41:;
	return fb$result$1;
}
