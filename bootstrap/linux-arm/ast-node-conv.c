...
int32 ASTCHECKCONVNONPTRTOPTR( int32 TO_DTYPE$1, int32 EXPR_DTYPE$1, struct $7ASTNODE* EXPR$1, $11AST_CONVOPT OPTIONS$1 )
{
	...
	goto label$78;
	label$68:;
	TMP$93$1 = EXPR_DTYPE$1 & 31;
	label$78:;
	if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$93$1 * 28)) != 0 ) goto label$70;
	{
		int32 TMP$94$2;
		...
		goto label$79;
		label$75:;
		TMP$94$2 = EXPR_DTYPE$1 & 31;
		label$79:;
		if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$94$2 * 28)) + 4) != *(int32*)((uint8*)&ENV$ + 272) ) goto label$77;
		{
			fb$result$1 = 0;
			goto label$67;
		}
...
int32 ASTCHECKCONV( int32 TO_DTYPE$1, struct $8FBSYMBOL* TO_SUBTYPE$1, struct $7ASTNODE* L$1 )
{
	...
	goto label$143;
	label$123:;
	TMP$97$1 = TO_DTYPE$1 & 31;
	label$143:;
	if( (LDTYPE$1 & 480) == 0 ) goto label$124;
	TMP$98$1 = 24;
	goto label$144;
	label$124:;
	TMP$98$1 = LDTYPE$1 & 31;
	label$144:;
	if( (-(TMP$97$1 == 20) | -(TMP$98$1 == 20)) == 0 ) goto label$126;
	{
		int32 TMP$99$2;
		int32 TMP$100$2;
		...
		goto label$145;
		label$127:;
		TMP$99$2 = TO_DTYPE$1 & 31;
		label$145:;
		if( (LDTYPE$1 & 480) == 0 ) goto label$128;
		TMP$100$2 = 24;
		goto label$146;
		label$128:;
		TMP$100$2 = LDTYPE$1 & 31;
		label$146:;
		if( (-(TMP$99$2 == 20) & -(TMP$100$2 == 20)) == 0 ) goto label$130;
		{
	...
	goto label$147;
	label$131:;
	TMP$101$1 = LDTYPE$1 & 31;
	label$147:;
	if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$101$1 * 28)) != 2 ) goto label$133;
	{
		goto label$122;
	}
	label$133:;
	...
	label$134:;
	{
		...
		goto label$148;
		label$136:;
		TMP$102$2 = LDTYPE$1 & 31;
		label$148:;
		TMP$103$2 = TMP$102$2;
		if( TMP$103$2 == 4 ) goto label$139;
		label$140:;
		if( TMP$103$2 != 7 ) goto label$138;
		label$139:;
		{
...
int32 ASTTRYOVLSTRINGCONV( struct $7ASTNODE** EXPR$1 )
{
	...
	int32 DTYPE$1;
	if( (*(int32*)((uint8*)*EXPR$1 + 4) & 511) != 20 ) goto label$152;
	{
		SYM$1 = *(struct $8FBSYMBOL**)((uint8*)*EXPR$1 + 8);
		if( (*(int32*)((uint8*)SYM$1 + 120) & 131072) == 0 ) goto label$154;
		{
			DTYPE$1 = 4;
		}
		goto label$153;
		label$154:;
		if( (*(int32*)((uint8*)SYM$1 + 120) & 65536) == 0 ) goto label$155;
		{
			DTYPE$1 = 7;
		}
		goto label$153;
		...
		label$153:;
		if( DTYPE$1 == 0 ) goto label$157;
		{
			struct $8FBSYMBOL* vr$12 = SYMBFINDCASTOVLPROC( DTYPE$1, (struct $8FBSYMBOL*)0u, *EXPR$1, &ERR_NUM$1, 0 );
			PROC$1 = vr$12;
			if( PROC$1 == (struct $8FBSYMBOL*)0u ) goto label$159;
			{
				if( (*(int32*)((uint8*)PROC$1 + 28) & 511) != DTYPE$1 ) goto label$161;
				{
...
struct $7ASTNODE* ASTNEWCONV( int32 TO_DTYPE$1, struct $8FBSYMBOL* TO_SUBTYPE$1, struct $7ASTNODE* L$1, $11AST_CONVOPT OPTIONS$1, int32* PERRMSG$1 )
{
	...
	int32 WRNMSG$1;
	int32 DOCONV$1;
	if( PERRMSG$1 == (int32*)0u ) goto label$165;
	{
		*PERRMSG$1 = 0;
	}
	label$165:;
	label$164:;
	LDTYPE$1 = *(int32*)((uint8*)L$1 + 4);
	if( (LDTYPE$1 & 511) != (TO_DTYPE$1 & 511) ) goto label$167;
	{
		if( *(struct $8FBSYMBOL**)((uint8*)L$1 + 8) != TO_SUBTYPE$1 ) goto label$169;
		{
			if( (LDTYPE$1 & 261632) == (TO_DTYPE$1 & 261632) ) goto label$171;
			{
				if( *(int32*)L$1 != 16 ) goto label$173;
				{
				...
				label$173:;
				{
					...
					*(int32*)((uint8*)N$1 + 32) = -1;
					...
					{
						if( (*(int32*)((uint8*)&ENV$ + 196) & 128) == 0 ) goto label$177;
						{
	...
	label$167:;
	label$166:;
	if( (LDTYPE$1 & 480) == 0 ) goto label$178;
	TMP$104$1 = 24;
	goto label$291;
	label$178:;
	TMP$104$1 = LDTYPE$1 & 31;
	label$291:;
	if( TMP$104$1 != 20 ) goto label$180;
	{
		struct $8FBSYMBOL* SUBTYPE$2;
		SUBTYPE$2 = *(struct $8FBSYMBOL**)((uint8*)L$1 + 8);
		if( (-((*(int32*)((uint8*)SUBTYPE$2 + 120) & 131072) != 0) | -((*(int32*)((uint8*)SUBTYPE$2 + 120) & 65536) != 0)) == 0 ) goto label$182;
		{
			struct $8FBSYMBOL* PROC$3;
			PROC$3 = (struct $8FBSYMBOL*)0u;
			$9FB_ERRMSG ERR_NUM$3;
			struct $8FBSYMBOL* vr$27 = SYMBFINDCASTOVLPROC( TO_DTYPE$1, TO_SUBTYPE$1, L$1, &ERR_NUM$3, -1 );
			PROC$3 = vr$27;
			if( PROC$3 == (struct $8FBSYMBOL*)0u ) goto label$184;
			{
			...
			label$184:;
			label$183:;
			if( (*(int32*)((uint8*)SUBTYPE$2 + 120) & 131072) == 0 ) goto label$186;
			{
				struct $8FBSYMBOL* vr$32 = SYMBFINDCASTOVLPROC( 36, (struct $8FBSYMBOL*)0u, L$1, &ERR_NUM$3, -1 );
				PROC$3 = vr$32;
			}
			goto label$185;
			label$186:;
			if( (*(int32*)((uint8*)SUBTYPE$2 + 120) & 65536) == 0 ) goto label$187;
			{
				struct $8FBSYMBOL* vr$36 = SYMBFINDCASTOVLPROC( 39, (struct $8FBSYMBOL*)0u, L$1, &ERR_NUM$3, -1 );
				PROC$3 = vr$36;
			}
			label$187:;
			label$185:;
			if( PROC$3 == (struct $8FBSYMBOL*)0u ) goto label$189;
			{
			...
			label$189:;
			label$188:;
			if( (OPTIONS$1 & 2) == 0 ) goto label$191;
			{
				int32 vr$40 = ASTTRYOVLSTRINGCONV( &L$1 );
				if( vr$40 == 0 ) goto label$193;
				{
					LDTYPE$1 = *(int32*)((uint8*)L$1 + 4);
				}
				label$193:;
	...
	label$179:;
	{
		...
		struct $8FBSYMBOL* vr$43 = SYMBFINDCASTOVLPROC( TO_DTYPE$1, TO_SUBTYPE$1, L$1, &ERR_NUM$2, 0 );
		PROC$2 = vr$43;
		if( PROC$2 == (struct $8FBSYMBOL*)0u ) goto label$195;
		{
			struct $7ASTNODE* vr$44 = ASTBUILDCALL( PROC$2, L$1, (struct $7ASTNODE*)0u, (struct $7ASTNODE*)0u );
			fb$result$1 = vr$44;
			goto label$163;
		}
		goto label$194;
	...
	}
	{
		int32 TMP$105$2;
		uint32 TMP$106$2;
		if( (TO_DTYPE$1 & 480) == 0 ) goto label$198;
		TMP$105$2 = 24;
		goto label$292;
		label$198:;
		TMP$105$2 = TO_DTYPE$1 & 31;
		label$292:;
		TMP$106$2 = (uint32)TMP$105$2;
		goto label$200;
		label$201:;
		{
			goto label$163;
		...
		{
			int32 TMP$107$3;
			if( (LDTYPE$1 & 480) == 0 ) goto label$203;
			TMP$107$3 = 24;
			goto label$293;
			label$203:;
			TMP$107$3 = LDTYPE$1 & 31;
			label$293:;
			if( TMP$107$3 == 20 ) goto label$205;
			{
				goto label$163;
			}
			label$205:;
		...
		label$208:;
		{
			...
			goto label$294;
			label$209:;
			TMP$108$3 = LDTYPE$1 & 31;
			label$294:;
			if( TMP$108$3 != 20 ) goto label$211;
			{
				goto label$163;
			}
			label$211:;
		...
		if( TMP$106$2 > 20u ) goto label$208;
		goto *tmp$126[TMP$106$2 - 0u];
		label$199:;
	}
	if( (LDTYPE$1 & 480) == 0 ) goto label$212;
	TMP$109$1 = 24;
	goto label$295;
	label$212:;
	TMP$109$1 = LDTYPE$1 & 31;
	label$295:;
	LDCLASS$1 = *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$109$1 * 28));
	if( (OPTIONS$1 & 1) == 0 ) goto label$214;
	{
		if( LDCLASS$1 == 0 ) goto label$216;
		{
			goto label$163;
		}
		label$216:;
	...
	label$214:;
	label$213:;
	if( (OPTIONS$1 & 8) != 0 ) goto label$218;
	{
		int32 vr$58 = HCHECKPTR( TO_DTYPE$1, TO_SUBTYPE$1, LDTYPE$1, L$1, OPTIONS$1 );
		ERRMSG$1 = vr$58;
		if( ERRMSG$1 == 0 ) goto label$220;
		{
			if( PERRMSG$1 == (int32*)0u ) goto label$222;
			{
				*PERRMSG$1 = ERRMSG$1;
			}
			label$222:;
	...
	label$218:;
	label$217:;
	if( (OPTIONS$1 & 2) == 0 ) goto label$224;
	{
		{
			int32 TMP$110$3;
			uint32 TMP$111$3;
			if( (LDTYPE$1 & 480) == 0 ) goto label$225;
			TMP$110$3 = 24;
			goto label$296;
			label$225:;
			TMP$110$3 = LDTYPE$1 & 31;
			label$296:;
			TMP$111$3 = (uint32)TMP$110$3;
			goto label$227;
			label$228:;
			{
			...
			if( (TMP$111$3 - 4u) > 14u ) goto label$226;
			goto *tmp$127[TMP$111$3 - 4u];
			label$226:;
		}
	}
	goto label$223;
		...
		{
			{
				int32 TMP$112$4;
				int32 TMP$113$4;
				if( (LDTYPE$1 & 480) == 0 ) goto label$231;
				TMP$112$4 = 24;
				goto label$297;
				label$231:;
				TMP$112$4 = LDTYPE$1 & 31;
				label$297:;
				TMP$113$4 = TMP$112$4;
				if( TMP$113$4 == 4 ) goto label$234;
				label$235:;
				if( TMP$113$4 != 7 ) goto label$233;
				label$234:;
				{
					if( *(int32*)L$1 == 20 ) goto label$237;
					{
						goto label$163;
					}
					label$237:;
	...
	label$223:;
	if( *(int32*)L$1 != 16 ) goto label$239;
	{
	...
	label$238:;
	DOCONV$1 = -1;
	if( (TO_DTYPE$1 & 480) == 0 ) goto label$240;
	TMP$114$1 = 24;
	goto label$298;
	label$240:;
	TMP$114$1 = TO_DTYPE$1 & 31;
	label$298:;
	if( LDCLASS$1 != *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$114$1 * 28)) ) goto label$242;
	{
		{
			int32 TMP$115$3;
			int32 TMP$116$3;
			if( (TO_DTYPE$1 & 480) == 0 ) goto label$243;
			TMP$115$3 = 24;
			goto label$299;
			label$243:;
			TMP$115$3 = TO_DTYPE$1 & 31;
			label$299:;
			TMP$116$3 = TMP$115$3;
			if( TMP$116$3 != 20 ) goto label$245;
			label$246:;
			{
				DOCONV$1 = 0;
			}
			...
			label$245:;
			{
				if( (-(LDTYPE$1 == 1) | -(TO_DTYPE$1 == 1)) == 0 ) goto label$249;
				{
				...
				label$249:;
				{
					int32 TMP$117$5;
					int32 TMP$118$5;
					if( (LDTYPE$1 & 480) == 0 ) goto label$252;
					TMP$117$5 = 24;
					goto label$300;
					label$252:;
					TMP$117$5 = LDTYPE$1 & 31;
					label$300:;
					if( (TO_DTYPE$1 & 480) == 0 ) goto label$253;
					TMP$118$5 = 24;
					goto label$301;
					label$253:;
					TMP$118$5 = TO_DTYPE$1 & 31;
					label$301:;
					if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$117$5 * 28)) + 4) != *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$118$5 * 28)) + 4) ) goto label$255;
					{
						DOCONV$1 = 0;
					}
					label$255:;
	...
	label$242:;
	label$241:;
	if( (*(int32*)((uint8*)&IR$ + 276) & 1) == 0 ) goto label$257;
	{
		int32 TMP$119$2;
		if( (TO_DTYPE$1 & 480) == 0 ) goto label$258;
		TMP$119$2 = 24;
		goto label$302;
		label$258:;
		TMP$119$2 = TO_DTYPE$1 & 31;
		label$302:;
		if( (-(LDCLASS$1 == 1) & -(*(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$119$2 * 28)) == 1)) == 0 ) goto label$260;
		{
			int32 TMP$120$3;
			int32 TMP$121$3;
			if( (LDTYPE$1 & 480) == 0 ) goto label$261;
			TMP$120$3 = 24;
			goto label$303;
			label$261:;
			TMP$120$3 = LDTYPE$1 & 31;
			label$303:;
			if( (TO_DTYPE$1 & 480) == 0 ) goto label$262;
			TMP$121$3 = 24;
			goto label$304;
			label$262:;
			TMP$121$3 = TO_DTYPE$1 & 31;
			label$304:;
			if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$120$3 * 28)) + 4) == *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$121$3 * 28)) + 4) ) goto label$264;
			{
				DOCONV$1 = -1;
			}
			label$264:;
	...
	label$257:;
	label$256:;
	if( *(int32*)L$1 != 5 ) goto label$266;
	{
		if( *(int32*)((uint8*)L$1 + 24) != 0 ) goto label$268;
		{
			if( DOCONV$1 != 0 ) goto label$270;
			{
				*(int32*)((uint8*)L$1 + 4) = TO_DTYPE$1;
				*(struct $8FBSYMBOL**)((uint8*)L$1 + 8) = TO_SUBTYPE$1;
				fb$result$1 = L$1;
	...
	*(int32*)((uint8*)N$1 + 32) = 0;
	if( (-((LDTYPE$1 & 480) != 0) & -((TO_DTYPE$1 & 480) != 0)) == 0 ) goto label$272;
	{
		int32 TMP$122$2;
		WRNMSG$1 = 0;
		TMP$122$2 = 0;
		int32 vr$114 = SYMBCHECKCONSTASSIGN( TO_DTYPE$1, LDTYPE$1, TO_SUBTYPE$1, *(struct $8FBSYMBOL**)((uint8*)L$1 + 8), 0, &TMP$122$2, ($13FB_WARNINGMSG*)&WRNMSG$1 );
		*(int32*)((uint8*)N$1 + 32) = -(vr$114 == 0);
		if( *(int32*)((uint8*)N$1 + 32) == 0 ) goto label$274;
		{
			if( WRNMSG$1 == 0 ) goto label$276;
			{
				if( (OPTIONS$1 & 32) != 0 ) goto label$278;
				{
			...
			label$276:;
			{
				if( (OPTIONS$1 & 16) != 0 ) goto label$280;
				{
					if( (*(int32*)((uint8*)&ENV$ + 196) & 128) == 0 ) goto label$282;
					{
						ERRREPORTWARN( 40, (uint8*)0u, 1, (uint8*)0u );
					}
					label$282:;
	...
	label$272:;
	label$271:;
	if( *(int32*)((uint8*)&ENV$ + 104) != 0 ) goto label$284;
	{
		if( DOCONV$1 == 0 ) goto label$286;
		{
			int32 TMP$124$3;
			if( (LDTYPE$1 & 480) == 0 ) goto label$287;
			TMP$124$3 = 24;
			goto label$305;
			label$287:;
			TMP$124$3 = LDTYPE$1 & 31;
			label$305:;
			if( TMP$124$3 != 16 ) goto label$289;
			{
				int32 TMP$125$4;
				...
				goto label$306;
				label$290:;
				TMP$125$4 = TO_DTYPE$1 & 31;
				label$306:;
				*(int32*)((uint8*)N$1 + 28) = -(TMP$125$4 == 15);
			}
			label$289:;
			label$288:;
		}
...
struct $7ASTNODE* ASTNEWOVLCONV( int32 TO_DTYPE$1, struct $8FBSYMBOL* TO_SUBTYPE$1, struct $7ASTNODE* L$1 )
{
	...
	label$307:;
	{
		struct $8FBSYMBOL* PROC$2;
		$9FB_ERRMSG ERR_NUM$2;
		struct $8FBSYMBOL* vr$2 = SYMBFINDCASTOVLPROC( TO_DTYPE$1, TO_SUBTYPE$1, L$1, &ERR_NUM$2, 0 );
		PROC$2 = vr$2;
		if( PROC$2 == (struct $8FBSYMBOL*)0u ) goto label$310;
		{
			struct $7ASTNODE* vr$3 = ASTBUILDCALL( PROC$2, L$1, (struct $7ASTNODE*)0u, (struct $7ASTNODE*)0u );
			fb$result$1 = vr$3;
			goto label$308;
		}
		goto label$309;
...
void ASTUPDATECONVFD2FS( struct $7ASTNODE* N$1, int32 TO_DTYPE$1, int32 IS_EXPR$1 )
{
	...
	int32 TMP$129$1;
	label$313:;
	if( *(int32*)((uint8*)N$1 + 28) != 0 ) goto label$316;
	{
		goto label$314;
	}
	label$316:;
	label$315:;
	if( (TO_DTYPE$1 & 480) == 0 ) goto label$317;
	TMP$128$1 = 24;
	goto label$321;
	label$317:;
	TMP$128$1 = TO_DTYPE$1 & 31;
	label$321:;
	*(int32*)((uint8*)N$1 + 28) = -(*(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$128$1 * 28)) + 4) >= 4);
	if( (TO_DTYPE$1 & 480) == 0 ) goto label$318;
	TMP$129$1 = 24;
	goto label$322;
	label$318:;
	TMP$129$1 = TO_DTYPE$1 & 31;
	label$322:;
	if( TMP$129$1 != 15 ) goto label$320;
	{
...
struct $6IRVREG* ASTLOADCONV( struct $7ASTNODE* N$1 )
{
	...
	if( L$1 != (struct $7ASTNODE*)0u ) goto label$326;
	{
	...
	VS$1 = vr$2;
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$328;
	{
		*(int32*)((uint8*)VS$1 + 20) = *(int32*)((uint8*)N$1 + 16);
		if( *(int32*)((uint8*)N$1 + 24) == 0 ) goto label$330;
		{
			struct $6IRVREG* vr$8 = (*(tmp$69*)((uint8*)&IR$ + 228))( *(int32*)((uint8*)N$1 + 4), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8) );
			VR$1 = vr$8;
			*(int32*)((uint8*)VR$1 + 20) = *(int32*)((uint8*)N$1 + 16);
			(*(tmp$44*)((uint8*)&IR$ + 60))( VR$1, VS$1 );
			if( *(int32*)((uint8*)N$1 + 28) == 0 ) goto label$332;
			{
				if( *(int32*)((uint8*)VS$1 + 4) != 16 ) goto label$334;
				{
					if( *(int32*)((uint8*)VR$1 + 4) != 15 ) goto label$336;
					{
						if( *(int32*)((uint8*)VR$1 + 16) != 0 ) goto label$338;
						{
							(*(tmp$51*)((uint8*)&IR$ + 100))( 74, VR$1, (struct $6IRVREG*)0u );
						}
						label$338:;
						label$337:;
					}
		...
		{
			VR$1 = VS$1;
			(*(tmp$75*)((uint8*)&IR$ + 256))( VR$1, *(int32*)((uint8*)N$1 + 4), *(struct $8FBSYMBOL**)((uint8*)N$1 + 8) );
		}
		label$329:;
	}
	label$328:;
...
struct $7ASTNODE* ASTSKIPCONSTCASTS( struct $7ASTNODE* N$1 )
{
	...
	label$339:;
	fb$result$1 = N$1;
	if( *(int32*)N$1 != 5 ) goto label$342;
	{
		if( *(int32*)((uint8*)N$1 + 24) != 0 ) goto label$344;
		{
...
struct $7ASTNODE* ASTSKIPNOCONVCAST( struct $7ASTNODE* N$1 )
{
	...
	{
		if( (-(*(int32*)((uint8*)N$1 + 24) == 0) & -(*(int32*)((uint8*)N$1 + 32) == 0)) == 0 ) goto label$350;
		{
			fb$result$1 = *(struct $7ASTNODE**)((uint8*)N$1 + 64);
		}
		label$350:;
...
static void HCONSTCONV( int32 TODTYPE$1, struct $7ASTNODE* L$1 )
{
	...
	goto label$365;
	label$12:;
	TMP$84$1 = LDTYPE$1 & 31;
	label$365:;
	if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$84$1 * 28)) != 1 ) goto label$14;
	{
		{
			int32 TMP$85$3;
			uint32 TMP$86$3;
			...
			goto label$366;
			label$15:;
			TMP$85$3 = TODTYPE$1 & 31;
			label$366:;
			TMP$86$3 = *(uint32*)(((uint8*)SYMB_DTYPETB$ + (TMP$85$3 * 28)) + 20);
			goto label$17;
			label$18:;
			{
			...
			label$30:;
			{
				...
				TMP$87$4 = fb_D2L( *(double*)((uint8*)L$1 + 24) * 0x1.p-1 ) << (1 & 63);
				goto label$367;
				label$31:;
				TMP$87$4 = fb_D2L( *(double*)((uint8*)L$1 + 24) );
				label$367:;
				*(int64*)((uint8*)L$1 + 24) = TMP$87$4;
			}
			goto label$16;
			label$17:;
			...
			if( TMP$86$3 > 10u ) goto label$16;
			goto *tmp$130[TMP$86$3 - 0u];
			label$16:;
		}
	}
	goto label$13;
	...
	goto label$368;
	label$33:;
	TMP$88$1 = LDTYPE$1 & 31;
	label$368:;
	if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$88$1 * 28)) + 8) == 0 ) goto label$32;
	{
		{
			int32 TMP$89$3;
			uint32 TMP$90$3;
			...
			goto label$369;
			label$34:;
			TMP$89$3 = TODTYPE$1 & 31;
			label$369:;
			TMP$90$3 = *(uint32*)(((uint8*)SYMB_DTYPETB$ + (TMP$89$3 * 28)) + 20);
			goto label$36;
			label$37:;
			{
			...
			if( TMP$90$3 > 10u ) goto label$35;
			goto *tmp$131[TMP$90$3 - 0u];
			label$35:;
		}
	}
	goto label$13;
	...
	{
		{
			...
			goto label$370;
			label$48:;
			TMP$91$3 = TODTYPE$1 & 31;
			label$370:;
			TMP$92$3 = *(uint32*)(((uint8*)SYMB_DTYPETB$ + (TMP$91$3 * 28)) + 20);
			goto label$50;
			label$51:;
			{
			...
			if( TMP$92$3 > 10u ) goto label$49;
			goto *tmp$132[TMP$92$3 - 0u];
			label$49:;
		}
	}
	label$13:;
...
static int32 HCHECKPTR( int32 TO_DTYPE$1, struct $8FBSYMBOL* TO_SUBTYPE$1, int32 EXPR_DTYPE$1, struct $7ASTNODE* EXPR$1, $11AST_CONVOPT OPTIONS$1 )
{
	...
	if( (EXPR_DTYPE$1 & 480) == 0 ) goto label$86;
	{
		...
		goto label$371;
		label$87:;
		TMP$95$2 = TO_DTYPE$1 & 31;
		label$371:;
		if( *(int32*)((uint8*)SYMB_DTYPETB$ + (TMP$95$2 * 28)) != 0 ) goto label$89;
		{
			int32 TMP$96$3;
			...
			goto label$372;
			label$94:;
			TMP$96$3 = TO_DTYPE$1 & 31;
			label$372:;
			if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$96$3 * 28)) + 4) != *(int32*)((uint8*)&ENV$ + 272) ) goto label$96;
			{
				goto label$81;
			}
			label$96:;
