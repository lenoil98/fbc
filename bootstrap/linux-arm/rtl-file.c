...
struct $7ASTNODE* RTLFILEOPEN( struct $7ASTNODE* FILENAME$1, struct $7ASTNODE* FMODE$1, struct $7ASTNODE* FACCESS$1, struct $7ASTNODE* FLOCK$1, struct $7ASTNODE* FILENUM$1, struct $7ASTNODE* FLEN$1, struct $7ASTNODE* FENCODING$1, int32 ISFUNC$1, $10FBOPENKIND OPENKIND$1 )
{
	...
	DOENCODING$1 = -1;
	{
		...
		label$18:;
		{
			...
			{
				struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_FileOpen", 223 );
				F$1 = vr$1;
				DOENCODING$1 = 0;
			}
			goto label$19;
			label$20:;
			{
				struct $8FBSYMBOL* vr$2 = RTLPROCLOOKUP( (uint8*)"fb_FileOpenEncod", 224 );
				F$1 = vr$2;
			}
			label$19:;
		}
		...
		label$22:;
		{
			struct $8FBSYMBOL* vr$3 = RTLPROCLOOKUP( (uint8*)"fb_FileOpenCons", 226 );
			F$1 = vr$3;
		}
		goto label$16;
		label$21:;
		...
		label$24:;
		{
			struct $8FBSYMBOL* vr$4 = RTLPROCLOOKUP( (uint8*)"fb_FileOpenErr", 227 );
			F$1 = vr$4;
		}
		goto label$16;
		label$23:;
		...
		label$26:;
		{
			struct $8FBSYMBOL* vr$5 = RTLPROCLOOKUP( (uint8*)"fb_FileOpenPipe", 228 );
			F$1 = vr$5;
		}
		goto label$16;
		label$25:;
		...
		label$28:;
		{
			struct $8FBSYMBOL* vr$6 = RTLPROCLOOKUP( (uint8*)"fb_FileOpenScrn", 229 );
			F$1 = vr$6;
		}
		goto label$16;
		label$27:;
		...
		label$30:;
		{
			struct $8FBSYMBOL* vr$7 = RTLPROCLOOKUP( (uint8*)"fb_FileOpenLpt", 230 );
			F$1 = vr$7;
		}
		goto label$16;
		label$29:;
		...
		label$32:;
		{
			struct $8FBSYMBOL* vr$8 = RTLPROCLOOKUP( (uint8*)"fb_FileOpenCom", 231 );
			F$1 = vr$8;
		}
		goto label$16;
		label$31:;
		{
			struct $8FBSYMBOL* vr$9 = RTLPROCLOOKUP( (uint8*)"fb_FileOpenQB", 232 );
			F$1 = vr$9;
			DOENCODING$1 = 0;
			{
				$13FB_COMPTARGET TMP$173$4;
				TMP$173$4 = *($13FB_COMPTARGET*)((uint8*)&ENV$ + 108);
				if( TMP$173$4 == 0 ) goto label$36;
				label$37:;
				if( TMP$173$4 != 1 ) goto label$35;
				label$36:;
				{
...
struct $7ASTNODE* RTLFILEOPENSHORT( struct $7ASTNODE* FILENAME$1, struct $7ASTNODE* FMODE$1, struct $7ASTNODE* FACCESS$1, struct $7ASTNODE* FLOCK$1, struct $7ASTNODE* FILENUM$1, struct $7ASTNODE* FLEN$1, int32 ISFUNC$1 )
{
	...
	struct $8FBSYMBOL* F$1;
	fb$result$1 = (struct $7ASTNODE*)0u;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_FileOpenShort", 225 );
...
struct $7ASTNODE* RTLFILECLOSE( struct $7ASTNODE* FILENUM$1, int32 ISFUNC$1 )
{
	...
	{
		struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_FileClose", 233 );
		struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0u );
		PROC$1 = vr$2;
	...
	label$77:;
	{
		struct $8FBSYMBOL* vr$4 = RTLPROCLOOKUP( (uint8*)"fb_FileCloseAll", 234 );
...
int32 RTLFILESEEK( struct $7ASTNODE* FILENUM$1, struct $7ASTNODE* NEWPOS$1 )
{
	...
	goto label$91;
	label$84:;
	TMP$176$1 = POS_DTYPE$1 & 31;
	label$91:;
	if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$176$1 * 28)) + 4) != 8 ) goto label$86;
	{
		struct $8FBSYMBOL* vr$6 = RTLPROCLOOKUP( (uint8*)"fb_FileSeekLarge", 261 );
		F$1 = vr$6;
	}
	goto label$85;
	label$86:;
	{
		struct $8FBSYMBOL* vr$7 = RTLPROCLOOKUP( (uint8*)"fb_FileSeek", 260 );
		F$1 = vr$7;
	}
	label$85:;
...
struct $7ASTNODE* RTLFILETELL( struct $7ASTNODE* FILENUM$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	fb$result$1 = (struct $7ASTNODE*)0u;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_FileTell", 259 );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0u );
	PROC$1 = vr$2;
	struct $7ASTNODE* vr$3 = ASTNEWARG( PROC$1, FILENUM$1, -2147483648u, -1 );
...
struct $7ASTNODE* RTLFILEPUT( struct $7ASTNODE* FILENUM$1, struct $7ASTNODE* OFFSET$1, struct $7ASTNODE* SRC$1, struct $7ASTNODE* ELEMENTS$1, int32 ISFUNC$1 )
{
	...
	label$126:;
	ISLARGE$1 = -(*(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$177$1 * 28)) + 4) == 8);
	if( ISSTRING$1 == 0 ) goto label$102;
	{
		if( ISLARGE$1 == 0 ) goto label$104;
		{
			struct $8FBSYMBOL* vr$11 = RTLPROCLOOKUP( (uint8*)"fb_FilePutStrLarge", 238 );
			F$1 = vr$11;
		}
		goto label$103;
		label$104:;
		{
			struct $8FBSYMBOL* vr$12 = RTLPROCLOOKUP( (uint8*)"fb_FilePutStr", 237 );
			F$1 = vr$12;
		}
		label$103:;
	}
	...
	label$102:;
	{
		...
		{
			struct $8FBSYMBOL* vr$13 = RTLPROCLOOKUP( (uint8*)"fb_FilePutLarge", 236 );
			F$1 = vr$13;
		}
		goto label$105;
		label$106:;
		{
			struct $8FBSYMBOL* vr$14 = RTLPROCLOOKUP( (uint8*)"fb_FilePut", 235 );
			F$1 = vr$14;
		}
		label$105:;
	}
...
struct $7ASTNODE* RTLFILEPUTARRAY( struct $7ASTNODE* FILENUM$1, struct $7ASTNODE* OFFSET$1, struct $7ASTNODE* SRC$1, int32 ISFUNC$1 )
{
	...
	label$147:;
	if( *(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$178$1 * 28)) + 4) != 8 ) goto label$133;
	{
		struct $8FBSYMBOL* vr$7 = RTLPROCLOOKUP( (uint8*)"fb_FilePutArrayLarge", 242 );
		F$1 = vr$7;
	}
	goto label$132;
	label$133:;
	{
		struct $8FBSYMBOL* vr$8 = RTLPROCLOOKUP( (uint8*)"fb_FilePutArray", 241 );
		F$1 = vr$8;
	}
	label$132:;
...
struct $7ASTNODE* RTLFILEGET( struct $7ASTNODE* FILENUM$1, struct $7ASTNODE* OFFSET$1, struct $7ASTNODE* DST$1, struct $7ASTNODE* ELEMENTS$1, struct $7ASTNODE* IOBYTES$1, int32 ISFUNC$1 )
{
	...
	label$198:;
	ISLARGE$1 = -(*(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$179$1 * 28)) + 4) == 8);
	if( IOBYTES$1 == (struct $7ASTNODE*)0u ) goto label$154;
	{
		if( ISSTRING$1 == 0 ) goto label$156;
		{
			if( ISLARGE$1 == 0 ) goto label$158;
			{
				...
				{
					struct $8FBSYMBOL* vr$12 = RTLPROCLOOKUP( (uint8*)"fb_FileGetWstrLargeIOB", 256 );
					F$1 = vr$12;
				}
				goto label$159;
				label$160:;
				{
					struct $8FBSYMBOL* vr$13 = RTLPROCLOOKUP( (uint8*)"fb_FileGetStrLargeIOB", 254 );
					F$1 = vr$13;
				}
				label$159:;
			}
			...
			label$158:;
			{
				...
				{
					struct $8FBSYMBOL* vr$14 = RTLPROCLOOKUP( (uint8*)"fb_FileGetWstrIOB", 255 );
					F$1 = vr$14;
				}
				goto label$161;
				label$162:;
				{
					struct $8FBSYMBOL* vr$15 = RTLPROCLOOKUP( (uint8*)"fb_FileGetStrIOB", 253 );
					F$1 = vr$15;
				}
				label$161:;
			}
		...
		label$156:;
		{
			...
			{
				struct $8FBSYMBOL* vr$16 = RTLPROCLOOKUP( (uint8*)"fb_FileGetLargeIOB", 252 );
				F$1 = vr$16;
			}
			goto label$163;
			label$164:;
			{
				struct $8FBSYMBOL* vr$17 = RTLPROCLOOKUP( (uint8*)"fb_FileGetIOB", 251 );
				F$1 = vr$17;
			}
			label$163:;
		}
	...
	label$154:;
	{
		if( ISSTRING$1 == 0 ) goto label$166;
		{
			if( ISLARGE$1 == 0 ) goto label$168;
			{
				...
				{
					struct $8FBSYMBOL* vr$18 = RTLPROCLOOKUP( (uint8*)"fb_FileGetWstrLarge", 248 );
					F$1 = vr$18;
				}
				goto label$169;
				label$170:;
				{
					struct $8FBSYMBOL* vr$19 = RTLPROCLOOKUP( (uint8*)"fb_FileGetStrLarge", 246 );
					F$1 = vr$19;
				}
				label$169:;
			}
			...
			label$168:;
			{
				...
				{
					struct $8FBSYMBOL* vr$20 = RTLPROCLOOKUP( (uint8*)"fb_FileGetWstr", 247 );
					F$1 = vr$20;
				}
				goto label$171;
				label$172:;
				{
					struct $8FBSYMBOL* vr$21 = RTLPROCLOOKUP( (uint8*)"fb_FileGetStr", 245 );
					F$1 = vr$21;
				}
				label$171:;
			}
		...
		label$166:;
		{
			...
			{
				struct $8FBSYMBOL* vr$22 = RTLPROCLOOKUP( (uint8*)"fb_FileGetLarge", 244 );
				F$1 = vr$22;
			}
			goto label$173;
			label$174:;
			{
				struct $8FBSYMBOL* vr$23 = RTLPROCLOOKUP( (uint8*)"fb_FileGet", 243 );
				F$1 = vr$23;
			}
			label$173:;
		}
...
struct $7ASTNODE* RTLFILEGETARRAY( struct $7ASTNODE* FILENUM$1, struct $7ASTNODE* OFFSET$1, struct $7ASTNODE* DST$1, struct $7ASTNODE* IOBYTES$1, int32 ISFUNC$1 )
{
	...
	goto label$227;
	label$203:;
	TMP$180$1 = O_DTYPE$1 & 31;
	label$227:;
	ISLARGE$1 = -(*(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$180$1 * 28)) + 4) == 8);
	if( IOBYTES$1 == (struct $7ASTNODE*)0u ) goto label$205;
	{
		if( ISLARGE$1 == 0 ) goto label$207;
		{
			struct $8FBSYMBOL* vr$8 = RTLPROCLOOKUP( (uint8*)"fb_FileGetArrayLargeIOB", 258 );
			F$1 = vr$8;
		}
		goto label$206;
		label$207:;
		{
			struct $8FBSYMBOL* vr$9 = RTLPROCLOOKUP( (uint8*)"fb_FileGetArrayIOB", 257 );
			F$1 = vr$9;
		}
		label$206:;
	}
	...
	label$205:;
	{
		...
		{
			struct $8FBSYMBOL* vr$10 = RTLPROCLOOKUP( (uint8*)"fb_FileGetArrayLarge", 250 );
			F$1 = vr$10;
		}
		goto label$208;
		label$209:;
		{
			struct $8FBSYMBOL* vr$11 = RTLPROCLOOKUP( (uint8*)"fb_FileGetArray", 249 );
			F$1 = vr$11;
		}
		label$208:;
	}
...
struct $7ASTNODE* RTLFILESTRINPUT( struct $7ASTNODE* BYTESEXPR$1, struct $7ASTNODE* FILENUM$1, int32 TK$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	fb$result$1 = (struct $7ASTNODE*)0u;
	if( TK$1 != 477 ) goto label$230;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_FileWstrInput", 263 );
	TMP$181$1 = vr$1;
	goto label$235;
	label$230:;
	struct $8FBSYMBOL* vr$2 = RTLPROCLOOKUP( (uint8*)"fb_FileStrInput", 262 );
	TMP$181$1 = vr$2;
	label$235:;
	struct $7ASTNODE* vr$3 = ASTNEWCALL( TMP$181$1, (struct $7ASTNODE*)0u );
	PROC$1 = vr$3;
...
int32 RTLFILELINEINPUT( int32 ISFILE$1, struct $7ASTNODE* EXPR$1, struct $7ASTNODE* DSTEXPR$1, int32 ADDQUESTION$1, int32 ADDNEWLINE$1 )
{
	int32 fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$236:;
	...
	{
		struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_FileLineInput", 264 );
		F$1 = vr$1;
		ARGS$1 = 4;
	}
	goto label$238;
	label$239:;
	{
		struct $8FBSYMBOL* vr$2 = RTLPROCLOOKUP( (uint8*)"fb_LineInput", 266 );
		F$1 = vr$2;
		ARGS$1 = 6;
	}
	label$238:;
	...
	if( vr$15 != (struct $7ASTNODE*)0u ) goto label$247;
	{
		goto label$237;
	}
	label$247:;
	label$246:;
	struct $7ASTNODE* vr$18 = ASTNEWCONSTI( (int64)-(DTYPE$1 == 18), 8, (struct $8FBSYMBOL*)0u );
	struct $7ASTNODE* vr$19 = ASTNEWARG( PROC$1, vr$18, -2147483648u, -1 );
	if( vr$19 != (struct $7ASTNODE*)0u ) goto label$249;
	{
		goto label$237;
	}
	label$249:;
	label$248:;
	if( ARGS$1 != 6 ) goto label$251;
	{
		...
		if( vr$22 != (struct $7ASTNODE*)0u ) goto label$253;
		{
			goto label$237;
		}
		label$253:;
		...
		if( vr$25 != (struct $7ASTNODE*)0u ) goto label$255;
		{
			goto label$237;
		}
		label$255:;
...
int32 RTLFILELINEINPUTWSTR( int32 ISFILE$1, struct $7ASTNODE* EXPR$1, struct $7ASTNODE* DSTEXPR$1, int32 ADDQUESTION$1, int32 ADDNEWLINE$1 )
{
	int32 fb$result$1;
	__builtin_memset( &fb$result$1, 0, 4 );
	label$256:;
	...
	int64 LGT$1;
	fb$result$1 = 0;
	if( ISFILE$1 == 0 ) goto label$259;
	{
		struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_FileLineInputWstr", 265 );
		F$1 = vr$1;
		ARGS$1 = 3;
	}
	goto label$258;
	label$259:;
	{
		struct $8FBSYMBOL* vr$2 = RTLPROCLOOKUP( (uint8*)"fb_LineInputWstr", 267 );
		F$1 = vr$2;
		ARGS$1 = 5;
	}
	label$258:;
	struct $7ASTNODE* vr$3 = ASTNEWCALL( F$1, (struct $7ASTNODE*)0u );
	PROC$1 = vr$3;
	if( (-(ISFILE$1 == 0) & -(EXPR$1 == (struct $7ASTNODE*)0u)) == 0 ) goto label$261;
	{
	...
	label$260:;
	struct $7ASTNODE* vr$9 = ASTNEWARG( PROC$1, EXPR$1, -2147483648u, -1 );
	if( vr$9 != (struct $7ASTNODE*)0u ) goto label$263;
	{
		goto label$257;
	}
	label$263:;
	...
	LGT$1 = vr$12;
	struct $7ASTNODE* vr$13 = ASTNEWARG( PROC$1, DSTEXPR$1, -2147483648u, -1 );
	if( vr$13 != (struct $7ASTNODE*)0u ) goto label$265;
	{
		goto label$257;
	}
	label$265:;
	...
	struct $7ASTNODE* vr$14 = ASTNEWCONSTI( LGT$1, 8, (struct $8FBSYMBOL*)0u );
	struct $7ASTNODE* vr$15 = ASTNEWARG( PROC$1, vr$14, -2147483648u, -1 );
	if( vr$15 != (struct $7ASTNODE*)0u ) goto label$267;
	{
		goto label$257;
	}
	label$267:;
	label$266:;
	if( ARGS$1 != 5 ) goto label$269;
	{
		struct $7ASTNODE* vr$17 = ASTNEWCONSTI( (int64)ADDQUESTION$1, 8, (struct $8FBSYMBOL*)0u );
		struct $7ASTNODE* vr$18 = ASTNEWARG( PROC$1, vr$17, -2147483648u, -1 );
		if( vr$18 != (struct $7ASTNODE*)0u ) goto label$271;
		{
			goto label$257;
		}
		label$271:;
		label$270:;
		struct $7ASTNODE* vr$20 = ASTNEWCONSTI( (int64)ADDNEWLINE$1, 8, (struct $8FBSYMBOL*)0u );
...
int32 RTLFILEINPUT( int32 ISFILE$1, struct $7ASTNODE* EXPR$1, int32 ADDQUESTION$1, int32 ADDNEWLINE$1 )
{
	...
	int32 ARGS$1;
	fb$result$1 = 0;
	if( ISFILE$1 == 0 ) goto label$277;
	{
		struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_FileInput", 268 );
		F$1 = vr$1;
		ARGS$1 = 1;
	}
	goto label$276;
	label$277:;
	{
		struct $8FBSYMBOL* vr$2 = RTLPROCLOOKUP( (uint8*)"fb_ConsoleInput", 269 );
		F$1 = vr$2;
		ARGS$1 = 3;
	}
	label$276:;
	struct $7ASTNODE* vr$3 = ASTNEWCALL( F$1, (struct $7ASTNODE*)0u );
	PROC$1 = vr$3;
	if( (-(ISFILE$1 == 0) & -(EXPR$1 == (struct $7ASTNODE*)0u)) == 0 ) goto label$279;
	{
		struct $8FBSYMBOL* vr$7 = SYMBALLOCSTRCONST( (uint8*)"", 0 );
		struct $7ASTNODE* vr$8 = ASTNEWVAR( vr$7, 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
		EXPR$1 = vr$8;
	...
	label$278:;
	struct $7ASTNODE* vr$9 = ASTNEWARG( PROC$1, EXPR$1, -2147483648u, -1 );
	if( vr$9 != (struct $7ASTNODE*)0u ) goto label$281;
	{
		goto label$275;
	}
	label$281:;
	label$280:;
	if( ARGS$1 != 3 ) goto label$283;
	{
		...
		if( vr$12 != (struct $7ASTNODE*)0u ) goto label$285;
		{
			goto label$275;
		}
		label$285:;
		...
		struct $7ASTNODE* vr$15 = ASTNEWARG( PROC$1, vr$14, -2147483648u, -1 );
		if( vr$15 != (struct $7ASTNODE*)0u ) goto label$287;
		{
			goto label$275;
		}
		label$287:;
...
int32 RTLFILEINPUTGET( struct $7ASTNODE* DSTEXPR$1 )
{
	...
	DTYPE$1 = *(int32*)((uint8*)DSTEXPR$1 + 4) & 511;
	{
		int32 TMP$183$2;
		uint32 TMP$184$2;
		if( (DTYPE$1 & 480) == 0 ) goto label$290;
		TMP$183$2 = 24;
		goto label$323;
		label$290:;
		TMP$183$2 = DTYPE$1 & 31;
		label$323:;
		TMP$184$2 = (uint32)TMP$183$2;
		goto label$292;
		label$293:;
		{
			struct $8FBSYMBOL* vr$5 = RTLPROCLOOKUP( (uint8*)"fb_InputString", 281 );
			F$1 = vr$5;
			ARGS$1 = 3;
		}
		goto label$291;
		label$294:;
		{
			struct $8FBSYMBOL* vr$6 = RTLPROCLOOKUP( (uint8*)"fb_InputWstr", 282 );
			F$1 = vr$6;
			ARGS$1 = 2;
		}
		goto label$291;
		label$295:;
		{
			struct $8FBSYMBOL* vr$7 = RTLPROCLOOKUP( (uint8*)"fb_InputBool", 270 );
			F$1 = vr$7;
		}
		goto label$291;
		label$296:;
		{
			{
				...
				label$324:;
				TMP$186$4 = *(uint32*)(((uint8*)SYMB_DTYPETB$ + (TMP$185$4 * 28)) + 20);
				goto label$299;
				label$300:;
				{
					struct $8FBSYMBOL* vr$11 = RTLPROCLOOKUP( (uint8*)"fb_InputByte", 271 );
					F$1 = vr$11;
				}
				goto label$298;
				label$301:;
				{
					struct $8FBSYMBOL* vr$12 = RTLPROCLOOKUP( (uint8*)"fb_InputUbyte", 272 );
					F$1 = vr$12;
				}
				goto label$298;
				label$302:;
				{
					struct $8FBSYMBOL* vr$13 = RTLPROCLOOKUP( (uint8*)"fb_InputShort", 273 );
					F$1 = vr$13;
				}
				goto label$298;
				label$303:;
				{
					struct $8FBSYMBOL* vr$14 = RTLPROCLOOKUP( (uint8*)"fb_InputUshort", 274 );
					F$1 = vr$14;
				}
				goto label$298;
				label$304:;
				{
					struct $8FBSYMBOL* vr$15 = RTLPROCLOOKUP( (uint8*)"fb_InputInt", 275 );
					F$1 = vr$15;
				}
				goto label$298;
				label$305:;
				{
					struct $8FBSYMBOL* vr$16 = RTLPROCLOOKUP( (uint8*)"fb_InputUint", 276 );
					F$1 = vr$16;
				}
				goto label$298;
				label$306:;
				{
					struct $8FBSYMBOL* vr$17 = RTLPROCLOOKUP( (uint8*)"fb_InputLongint", 277 );
					F$1 = vr$17;
				}
				goto label$298;
				label$307:;
				{
					struct $8FBSYMBOL* vr$18 = RTLPROCLOOKUP( (uint8*)"fb_InputUlongint", 278 );
					F$1 = vr$18;
				}
				goto label$298;
				label$299:;
				static const void* tmp$187[8] = {
					&&label$300,
					&&label$301,
					&&label$302,
					&&label$303,
				...
				if( (TMP$186$4 - 1u) > 7u ) goto label$298;
				goto *tmp$187[TMP$186$4 - 1u];
				label$298:;
			}
		}
		goto label$291;
		label$308:;
		{
			struct $8FBSYMBOL* vr$19 = RTLPROCLOOKUP( (uint8*)"fb_InputSingle", 279 );
			F$1 = vr$19;
		}
		goto label$291;
		label$309:;
		{
			struct $8FBSYMBOL* vr$20 = RTLPROCLOOKUP( (uint8*)"fb_InputDouble", 280 );
			F$1 = vr$20;
		}
		goto label$291;
		label$310:;
		...
		if( (TMP$184$2 - 1u) > 23u ) goto label$310;
		goto *tmp$188[TMP$184$2 - 1u];
		label$291:;
	}
	struct $7ASTNODE* vr$21 = ASTNEWCALL( F$1, (struct $7ASTNODE*)0u );
	PROC$1 = vr$21;
	if( ARGS$1 <= 1 ) goto label$312;
	{
	...
	if( vr$23 != (struct $7ASTNODE*)0u ) goto label$314;
	{
		goto label$289;
	}
	label$314:;
	label$313:;
	if( ARGS$1 <= 1 ) goto label$316;
	{
		struct $7ASTNODE* vr$24 = ASTNEWCONSTI( LGT$1, 8, (struct $8FBSYMBOL*)0u );
		struct $7ASTNODE* vr$25 = ASTNEWARG( PROC$1, vr$24, -2147483648u, -1 );
		if( vr$25 != (struct $7ASTNODE*)0u ) goto label$318;
		{
			goto label$289;
		}
		label$318:;
		label$317:;
		if( ARGS$1 <= 2 ) goto label$320;
		{
			...
			if( vr$29 != (struct $7ASTNODE*)0u ) goto label$322;
			{
				goto label$289;
			}
			label$322:;
...
int32 RTLFILELOCK( int32 ISLOCK$1, struct $7ASTNODE* FILENUM$1, struct $7ASTNODE* INIEXPR$1, struct $7ASTNODE* ENDEXPR$1 )
{
	...
	if( (I_DTYPE$1 & 480) == 0 ) goto label$327;
	TMP$189$1 = 24;
	goto label$341;
	label$327:;
	TMP$189$1 = I_DTYPE$1 & 31;
	label$341:;
	if( (E_DTYPE$1 & 480) == 0 ) goto label$328;
	TMP$190$1 = 24;
	goto label$342;
	label$328:;
	TMP$190$1 = E_DTYPE$1 & 31;
	label$342:;
	ISLARGE$1 = -(*(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$189$1 * 28)) + 4) == 8) | -(*(int32*)(((uint8*)SYMB_DTYPETB$ + (TMP$190$1 * 28)) + 4) == 8);
	if( ISLOCK$1 == 0 ) goto label$330;
	{
		if( ISLARGE$1 == 0 ) goto label$332;
		{
			struct $8FBSYMBOL* vr$14 = RTLPROCLOOKUP( (uint8*)"fb_FileLockLarge", 284 );
			F$1 = vr$14;
		}
		goto label$331;
		label$332:;
		{
			struct $8FBSYMBOL* vr$15 = RTLPROCLOOKUP( (uint8*)"fb_FileLock", 283 );
			F$1 = vr$15;
		}
		label$331:;
	}
	...
	label$330:;
	{
		if( ISLARGE$1 == 0 ) goto label$334;
		{
			struct $8FBSYMBOL* vr$16 = RTLPROCLOOKUP( (uint8*)"fb_FileUnlockLarge", 286 );
			F$1 = vr$16;
		}
		goto label$333;
		label$334:;
		{
			struct $8FBSYMBOL* vr$17 = RTLPROCLOOKUP( (uint8*)"fb_FileUnlock", 285 );
			F$1 = vr$17;
		}
		label$333:;
	}
	...
	if( vr$19 != (struct $7ASTNODE*)0u ) goto label$336;
	{
		goto label$326;
	}
	label$336:;
	...
	if( vr$20 != (struct $7ASTNODE*)0u ) goto label$338;
	{
		goto label$326;
	}
	label$338:;
	...
	if( vr$21 != (struct $7ASTNODE*)0u ) goto label$340;
	{
		goto label$326;
	}
	label$340:;
...
struct $7ASTNODE* RTLFILERENAME( struct $7ASTNODE* FILENAME_NEW$1, struct $7ASTNODE* FILENAME_OLD$1, int32 ISFUNC$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	fb$result$1 = (struct $7ASTNODE*)0u;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_rename", 287 );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0u );
	PROC$1 = vr$2;
	struct $7ASTNODE* vr$3 = ASTNEWARG( PROC$1, FILENAME_OLD$1, -2147483648u, -1 );
	if( vr$3 != (struct $7ASTNODE*)0u ) goto label$346;
	{
		goto label$344;
	}
	label$346:;
	...
	if( vr$4 != (struct $7ASTNODE*)0u ) goto label$348;
	{
		goto label$344;
	}
	label$348:;
...
struct $7ASTNODE* RTLWIDTHFILE( struct $7ASTNODE* FNUM$1, struct $7ASTNODE* WIDTH_ARG$1, int32 ISFUNC$1 )
{
	...
	struct $7ASTNODE* PROC$1;
	fb$result$1 = (struct $7ASTNODE*)0u;
	struct $8FBSYMBOL* vr$1 = RTLPROCLOOKUP( (uint8*)"fb_WidthFile", 290 );
	struct $7ASTNODE* vr$2 = ASTNEWCALL( vr$1, (struct $7ASTNODE*)0u );
	PROC$1 = vr$2;
