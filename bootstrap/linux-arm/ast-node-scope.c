...
struct $7ASTNODE* ASTSCOPEBEGIN( void )
{
	...
	if( *(uint32*)((uint8*)&PARSER$ + 96) < 128u ) goto label$13;
	{
	...
	*(uint32*)((uint8*)&PARSER$ + 96) = *(uint32*)((uint8*)&PARSER$ + 96) + 1u;
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 108) = S$1;
...
void ASTSCOPEBREAK( struct $8FBSYMBOL* TARGET$1 )
{
	...
	*(struct $7ASTNODE**)((uint8*)N$1 + 24) = *(struct $7ASTNODE**)((uint8*)&AST$ + 132);
	*(int32*)((uint8*)N$1 + 28) = *(int32*)((uint8*)&PARSER$ + 96);
	*(int32*)((uint8*)N$1 + 32) = *(int32*)((uint8*)*(struct $9LEX_TKCTX**)((uint8*)&LEX$ + 839936) + 16564);
...
void ASTSCOPEEND( struct $7ASTNODE* N$1 )
{
	...
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 108) = *(struct $8FBSYMBOL**)((uint8*)*(struct $7ASTNODE**)((uint8*)&AST$ + 132) + 12);
	*(uint32*)((uint8*)&PARSER$ + 96) = *(uint32*)((uint8*)&PARSER$ + 96) + 4294967295u;
	...
	label$163:;
	{
		...
		if( S$1 == (struct $8FBSYMBOL*)0u ) goto label$169;
		{
			if( (-(*(int32*)S$1 == 1) & -((*(int32*)((uint8*)S$1 + 4) & 3) == 0)) == 0 ) goto label$171;
			{
				...
				{
					(*(tmp$42*)((uint8*)&IR$ + 36))( *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104), S$1 );
				}
				goto label$172;
				label$173:;
				{
...
struct $6IRVREG* ASTLOADSCOPEBEGIN( struct $7ASTNODE* N$1 )
{
	...
	struct $8FBSYMBOL* S$1;
	S$1 = *(struct $8FBSYMBOL**)((uint8*)N$1 + 12);
	*(int32*)((uint8*)S$1 + 88) = *(int32*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 112) + 8);
...
struct $6IRVREG* ASTLOADSCOPEEND( struct $7ASTNODE* N$1 )
{
	...
	label$181:;
	label$180:;
	*(int32*)((uint8*)*(struct $10FB_PROCEXT**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 112) + 8) = *(int32*)((uint8*)S$1 + 88);
	fb$result$1 = (struct $6IRVREG*)0u;
	label$179:;
	return fb$result$1;
}
...
struct $8FBSYMBOL* ASTTEMPSCOPEBEGIN( struct $8FBSYMBOL** LASTSCP$1, struct $7ASTNODE* BACKNODE$1 )
{
	...
	SCP$1 = vr$1;
	*LASTSCP$1 = *(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 108);
	*(uint32*)((uint8*)&PARSER$ + 96) = *(uint32*)((uint8*)&PARSER$ + 96) + 1u;
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 108) = SCP$1;
...
void ASTTEMPSCOPEEND( struct $8FBSYMBOL* SCP$1, struct $8FBSYMBOL* LASTSCP$1 )
{
	...
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 108) = LASTSCP$1;
	*(uint32*)((uint8*)&PARSER$ + 96) = *(uint32*)((uint8*)&PARSER$ + 96) + 4294967295u;
...
static void HBRANCHERROR( int32 ERRNUM$1, struct $7ASTNODE* N$1, struct $8FBSYMBOL* S$1 )
{
	...
	SHOWERROR$1 = *(int32*)((uint8*)&ENV$ + 188);
	*(int32*)((uint8*)&ENV$ + 188) = 0;
	if( *(uint8**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 12) + 16) == (uint8*)0u ) goto label$33;
	{
		FBSTRING TMP$94$2;
		__builtin_memset( &TMP$94$2, 0, 12 );
		FBSTRING* vr$6 = fb_StrConcat( &TMP$94$2, (void*)"to label: ", 11, *(void**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 12) + 16), 0 );
...
static void HBRANCHWARNING( int32 ERRNUM$1, struct $7ASTNODE* N$1, struct $8FBSYMBOL* S$1 )
{
	...
	*(int32*)((uint8*)&ENV$ + 188) = 0;
	if( *(uint8**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 12) + 16) == (uint8*)0u ) goto label$44;
	{
		...
		FBSTRING* vr$6 = fb_StrConcat( &TMP$101$2, (void*)"to label: ", 11, *(void**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)N$1 + 12) + 16), 0 );
		fb_StrAssign( (void*)&MSG$1, -1, (void*)vr$6, -1, 0 );
	...
	if( S$1 == (struct $8FBSYMBOL*)0u ) goto label$48;
	{
		...
		__builtin_memset( &TMP$103$2, 0, 12 );
		FBSTRING* vr$10 = fb_StrConcat( &TMP$103$2, (void*)&MSG$1, -1, *(void**)((uint8*)S$1 + 16), 0 );
...
static void HDELLOCALS( struct $7ASTNODE* N$1, int32 CHECK_BACKWARD$1 )
{
	...
	label$113:;
	{
		...
		TMP$104$2 = -(LABEL_STMT$1 < *(int32*)((uint8*)BLK$1 + 32));
		goto label$200;
		label$118:;
		TMP$104$2 = 0;
		label$200:;
		if( TMP$104$2 == 0 ) goto label$120;
		{
...
static int32 HCHECKBRANCH( struct $7ASTNODE* PROC$1, struct $7ASTNODE* N$1 )
{
	...
	TMP$105$1 = -(LABEL_STMT$1 < *(int32*)((uint8*)BRANCH_PARENT$1 + 32));
	goto label$201;
	label$135:;
	TMP$105$1 = 0;
	label$201:;
	if( TMP$105$1 == 0 ) goto label$137;
	{
