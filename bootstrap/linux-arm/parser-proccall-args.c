...
{
	label$10:;
	LISTINIT( (struct $5TLIST*)((uint8*)&PARSER$ + 112), 128, 12, 6 );
	label$11:;
}
...
{
	label$12:;
	LISTEND( (struct $5TLIST*)((uint8*)&PARSER$ + 112) );
	label$13:;
}
...
struct $7ASTNODE* CPROCARGLIST( struct $8FBSYMBOL* BASE_PARENT$1, struct $8FBSYMBOL* PROC$1, struct $7ASTNODE* PTREXPR$1, struct $16FB_CALL_ARG_LIST* ARG_LIST$1, $12FB_PARSEROPT OPTIONS$1 )
{
	...
	if( vr$5 != 0 ) goto label$143;
	{
		...
		TMP$96$2 = 202;
		label$192:;
		ERRREPORTEX( TMP$96$2, (uint8*)vr$6, 0, 1, (uint8*)0u );
	...
	if( (*(int32*)((uint8*)PROC$1 + 8) & 2) == 0 ) goto label$146;
	{
		...
		{
			if( (-(BASE_PARENT$1 != (struct $8FBSYMBOL*)0u) | -((*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 8) & 2) == 0)) == 0 ) goto label$150;
			{
			...
			label$150:;
			label$149:;
			struct $11FB_CALL_ARG* vr$20 = SYMBALLOCOVLCALLARG( (struct $5TLIST*)((uint8*)&PARSER$ + 112), ARG_LIST$1, -1 );
			ARG$1 = vr$20;
			struct $7ASTNODE* vr$23 = ASTBUILDVARFIELD( *(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 76) + 60), (struct $8FBSYMBOL*)0u, 0ll );
	...
	label$146:;
	{
		if( (OPTIONS$1 & 64) == 0 ) goto label$152;
		{
			...
			*(struct $11FB_CALL_ARG**)((uint8*)ARG_LIST$1 + 4) = *(struct $11FB_CALL_ARG**)((uint8*)ARG$1 + 8);
			...
			LISTDELNODE( (struct $5TLIST*)((uint8*)&PARSER$ + 112), (void*)ARG$1 );
		}
		label$152:;
		label$151:;
	}
...
static int32 HPROCARG( struct $8FBSYMBOL* PROC$1, struct $8FBSYMBOL* PARAM$1, int32 ARGNUM$1, struct $7ASTNODE** EXPR$1, int32* AMODE$1, int32* HAVE_EQ_OUTSIDE_PARENS$1, $12FB_PARSEROPT OPTIONS$1 )
{
	...
	*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 156) = *(struct $8FBSYMBOL**)((uint8*)PARAM$1 + 32);
	*(int32*)((uint8*)&PARSER$ + 152) = *(int32*)((uint8*)PARAM$1 + 28) & 511;
	*(int32*)((uint8*)&PARSER$ + 160) = 0;
	struct $7ASTNODE* vr$9 = CEXPRESSION(  );
	*EXPR$1 = vr$9;
	*HAVE_EQ_OUTSIDE_PARENS$1 = *HAVE_EQ_OUTSIDE_PARENS$1 | *(int32*)((uint8*)&PARSER$ + 160);
	goto label$19;
	{
...
static struct $7ASTNODE* HOVLPROCARGLIST( struct $8FBSYMBOL* BASE_PARENT$1, struct $8FBSYMBOL* PROC$1, struct $16FB_CALL_ARG_LIST* ARG_LIST$1, $12FB_PARSEROPT OPTIONS$1 )
{
	...
	TMP$93$1 = *(struct $11FB_CALL_ARG**)((uint8*)*(struct $11FB_CALL_ARG**)((uint8*)ARG_LIST$1 + 4) + 8);
	goto label$193;
	label$112:;
	TMP$93$1 = *(struct $11FB_CALL_ARG**)((uint8*)ARG_LIST$1 + 4);
	label$193:;
	struct $8FBSYMBOL* vr$25 = SYMBFINDCLOSESTOVLPROC( PROC$1, ARGS$1, TMP$93$1, &ERR_NUM$1, LKUP_OPTIONS$1 );
	OVLPROC$1 = vr$25;
	if( OVLPROC$1 != (struct $8FBSYMBOL*)0u ) goto label$114;
	{
		SYMBFREEOVLCALLARGS( (struct $5TLIST*)((uint8*)&PARSER$ + 112), ARG_LIST$1 );
	...
	if( vr$28 != 0 ) goto label$118;
	{
		...
		TMP$94$2 = 202;
		label$194:;
		ERRREPORTEX( TMP$94$2, (uint8*)vr$29, 0, 1, (uint8*)0u );
	...
	if( (*(int32*)((uint8*)PROC$1 + 8) & 2) == 0 ) goto label$121;
	{
		...
		{
			if( (-(BASE_PARENT$1 != (struct $8FBSYMBOL*)0u) | -((*(int32*)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 8) & 2) == 0)) == 0 ) goto label$125;
			{
				ERRREPORT( 214, -1, (uint8*)0u );
			...
			label$125:;
			label$124:;
			struct $11FB_CALL_ARG* vr$43 = SYMBALLOCOVLCALLARG( (struct $5TLIST*)((uint8*)&PARSER$ + 112), ARG_LIST$1, -1 );
			ARG$1 = vr$43;
			struct $7ASTNODE* vr$46 = ASTBUILDVARFIELD( *(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)*(struct $8FBSYMBOL**)((uint8*)&PARSER$ + 104) + 76) + 60), (struct $8FBSYMBOL*)0u, 0ll );
