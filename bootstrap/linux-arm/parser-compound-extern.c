...
void CEXTERNSTMTBEGIN( void )
{
	...
	int32 MANGLING$1;
	uint8* LITSTR$1;
	if( (*(int32*)((uint8*)&ENV$ + 888) & 8) != 0 ) goto label$13;
	{
	...
	label$16:;
	{
		...
		fb_StrInit( (void*)&TMP$94$2, -1, (void*)vr$5, -1, 0 );
		int32 vr$8 = fb_StrCompare( (void*)&TMP$94$2, -1, (void*)"c", 2 );
		...
		goto label$18;
		label$19:;
		int32 vr$10 = fb_StrCompare( (void*)&TMP$94$2, -1, (void*)"windows", 8 );
		...
		goto label$18;
		label$21:;
		int32 vr$12 = fb_StrCompare( (void*)&TMP$94$2, -1, (void*)"windows-ms", 11 );
		...
		goto label$18;
		label$23:;
		int32 vr$14 = fb_StrCompare( (void*)&TMP$94$2, -1, (void*)"c++", 4 );
		...
		goto label$18;
		label$25:;
		int32 vr$16 = fb_StrCompare( (void*)&TMP$94$2, -1, (void*)"rtlib", 6 );
	...
	STK$1 = vr$18;
	*($11FB_MANGLING*)((uint8*)STK$1 + 16) = *($11FB_MANGLING*)((uint8*)&PARSER$ + 100);
	*($11FB_MANGLING*)((uint8*)&PARSER$ + 100) = MANGLING$1;
	label$11:;
}
...
void CEXTERNSTMTEND( void )
{
	...
	LEXSKIPTOKEN( 2048 );
	LEXSKIPTOKEN( 2048 );
	*($11FB_MANGLING*)((uint8*)&PARSER$ + 100) = *($11FB_MANGLING*)((uint8*)STK$1 + 16);
	CCOMPSTMTPOP( STK$1 );
	label$31:;
}
