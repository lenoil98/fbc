...
struct $6IRVREG* ASTLOADBRANCH( struct $7ASTNODE* N$1 )
{
	...
	if( *(int32*)((uint8*)&AST$ + 136) == 0 ) goto label$19;
	{
		if( *(struct $8FBSYMBOL**)((uint8*)N$1 + 32) != (struct $8FBSYMBOL*)0u ) goto label$21;
		{
			{
				int32 TMP$83$4;
				TMP$83$4 = *(int32*)((uint8*)N$1 + 24);
				if( TMP$83$4 != 104 ) goto label$23;
				label$24:;
				{
					(*(tmp$52*)((uint8*)&IR$ + 140))( VR$1 );
				}
				goto label$22;
				label$23:;
				if( TMP$83$4 != 101 ) goto label$25;
				label$26:;
				{
					(*(tmp$45*)((uint8*)&IR$ + 72))( 0 );
				}
				goto label$22;
				label$25:;
				{
		...
		label$21:;
		{
			(*(tmp$56*)((uint8*)&IR$ + 144))( *(int32*)((uint8*)N$1 + 24), *(struct $8FBSYMBOL**)((uint8*)N$1 + 32) );
		}
		label$20:;
	}
	label$19:;
...
struct $6IRVREG* ASTLOADJMPTB( struct $7ASTNODE* N$1 )
{
	...
	{
		(*(tmp$57*)((uint8*)&IR$ + 148))( V1$1, *(struct $8FBSYMBOL**)((uint8*)N$1 + 12), *(uint64**)((uint8*)N$1 + 24), *(struct $8FBSYMBOL***)((uint8*)N$1 + 28), *(int32*)((uint8*)N$1 + 32), *(struct $8FBSYMBOL**)((uint8*)N$1 + 36), *(uint64*)((uint8*)N$1 + 40), *(uint64*)((uint8*)N$1 + 48) );
	}
	label$39:;
	label$38:;
...
struct $7ASTNODE* ASTBUILDJMPTB( struct $8FBSYMBOL* TEMPVAR$1, uint64* VALUES1$1, struct $8FBSYMBOL** LABELS1$1, int32 LABELCOUNT$1, struct $8FBSYMBOL* DEFLABEL$1, uint64 BIAS$1, uint64 SPAN$1 )
{
	...
	TREE$1 = (struct $7ASTNODE*)0u;
	{
		...
		TMP$86$2 = *($10FB_BACKEND*)((uint8*)&ENV$ + 104);
		if( TMP$86$2 == 0 ) goto label$46;
		label$47:;
		if( TMP$86$2 != 2 ) goto label$45;
		label$46:;
		{
	...
	if( *(int32*)((uint8*)&ENV$ + 104) != 0 ) goto label$51;
	{
		...
		struct $8FBSYMBOL* vr$5 = SYMBADDVAR( (uint8*)vr$4, (uint8*)0u, 32, (struct $8FBSYMBOL*)0u, 0ll, 0, (struct $7FBARRAYI10FBARRAYDIME*)&tmp$85$1, 1, 0 );
		TBSYM$1 = vr$5;
		*($12FB_SYMBSTATS*)((uint8*)TBSYM$1 + 12) = *(int32*)((uint8*)TBSYM$1 + 12) | 32768;
		...
		TREE$1 = vr$14;
		struct $7ASTNODE* vr$16 = ASTNEWCONSTI( (int64)*(int32*)((uint8*)&ENV$ + 272), DTYPE$1, (struct $8FBSYMBOL*)0u );
...
static int64 HPRECALCBIASOFFSET( uint64 BIAS$1, int32 DTYPE$1 )
{
	...
	*(int32*)((uint8*)&AST$ + 232) = *(int32*)((uint8*)&AST$ + 232) + 1;
	...
	T$1 = vr$3;
	struct $7ASTNODE* vr$5 = ASTNEWCONSTI( (int64)*(int32*)((uint8*)&ENV$ + 272), DTYPE$1, (struct $8FBSYMBOL*)0u );
