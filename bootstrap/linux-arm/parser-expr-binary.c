...
struct $7ASTNODE* CEXPRESSIONWITHNIDXARRAY( int32 ALLOW_NIDXARRAY$1 )
{
	...
	OLDCHECKARRAY$1 = -((*(int32*)((uint8*)&PARSER$ + 148) & 2) != 0);
	...
	{
		{
			...
			goto label$29;
			label$30:;
			static const void* tmp$95[2] = {
				&&label$31,
				&&label$32,
			};
			if( (TMP$94$3 - 290u) > 1u ) goto label$33;
			goto *tmp$95[TMP$94$3 - 290u];
			label$29:;
		}
	...
	{
		{
			...
			if( (TMP$96$3 - 292u) > 2u ) goto label$52;
			goto *tmp$97[TMP$96$3 - 292u];
			label$47:;
		}
		int32 vr$3 = LEXGETLOOKAHEAD( 1, 0 );
		int32 vr$4 = HISASSIGNTOKEN( vr$3 );
	...
	{
		{
			uint32 TMP$98$3;
			int32 vr$2 = LEXGETTOKEN( 0 );
			TMP$98$3 = (uint32)vr$2;
			goto label$97;
			label$98:;
			{
				*(int32*)((uint8*)&PARSER$ + 160) = -(*(int32*)((uint8*)&PARSER$ + 144) == 0);
				if( (*(int32*)((uint8*)&PARSER$ + 148) & 256) == 0 ) goto label$100;
				{
					goto label$94;
				}
				label$100:;
			...
			label$101:;
			{
				if( (*(int32*)((uint8*)&PARSER$ + 148) & 512) == 0 ) goto label$103;
				{
					goto label$94;
				}
				label$103:;
			...
			if( (TMP$98$3 - 299u) > 5u ) goto label$108;
			goto *tmp$99[TMP$98$3 - 299u];
			label$96:;
		}
		LEXSKIPTOKEN( 0 );
...
struct $7ASTNODE* CISEXPRESSION( void )
{
	...
	TMP$101$1 = 0;
	TMP$100$1 = 0ll;
	int32 vr$14 = CSYMBOLTYPE( &DTYPE$1, &SUBTYPE$1, &TMP$100$1, &TMP$101$1, 1 );
	...
	label$125:;
	struct $7ASTNODE* EXPR$1;
	struct $7ASTNODE* vr$25 = ASTNEWVAR( *(struct $8FBSYMBOL**)((uint8*)*(struct $12FB_STRUCTEXT**)((uint8*)SUBTYPE$1 + 140) + 148), 0ll, -2147483648u, (struct $8FBSYMBOL*)0u );
	EXPR$1 = vr$25;
	...
	{
		{
			...
			int32 vr$2 = LEXGETTOKEN( 0 );
			TMP$102$3 = vr$2;
			if( TMP$102$3 != 43 ) goto label$155;
			label$156:;
			{
				OP$1 = 28;
			}
			goto label$154;
			label$155:;
			if( TMP$102$3 != 45 ) goto label$157;
			label$158:;
			{
				OP$1 = 29;
			}
	...
	{
		{
			...
			int32 vr$2 = LEXGETTOKEN( 0 );
			TMP$103$3 = vr$2;
			if( TMP$103$3 != 297 ) goto label$174;
			label$175:;
			{
				OP$1 = 41;
			}
			goto label$173;
			label$174:;
			if( TMP$103$3 != 298 ) goto label$176;
			label$177:;
			{
				OP$1 = 42;
			}
	...
	{
		{
			...
			int32 vr$2 = LEXGETTOKEN( 0 );
			TMP$104$3 = vr$2;
			if( TMP$104$3 != 42 ) goto label$223;
			label$224:;
			{
				OP$1 = 30;
			}
			goto label$222;
			label$223:;
			if( TMP$104$3 != 47 ) goto label$225;
			label$226:;
			{
				OP$1 = 31;
			}
